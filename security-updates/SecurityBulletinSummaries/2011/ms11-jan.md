---
TOCTitle: 'MS11-JAN'
Title: Microsoft Güvenlik Bülteni Ocak 2011 Özeti
ms:assetid: 'ms11-jan'
ms:contentKeyID: 61235840
ms:mtpsurl: 'https://technet.microsoft.com/tr-TR/library/ms11-jan(v=Security.10)'
---

Security Bulletin Summary

Microsoft Güvenlik Bülteni Ocak 2011 Özeti
==========================================
...
Microsoft, bu bültenlerle ilgili müşteri soruları için 12 Ocak 2011 günü saat 11:00'de (Pasifik Saati, ABD ve Kanada) bir Web yayını gerçekleştirecektir. [Ocak Güvenlik Bülteni Web Yayını için şimdi kaydolun](https://msevents.microsoft.com/cui/webcasteventdetails.aspx?eventid=1032454958&eventcategory=4&culture=en-us&countrycode=us). Bu tarihten sonra, Web yayını isteğe bağlı olarak kullanılabilecektir. Daha fazla bilgi için, bkz: [Microsoft Güvenlik Bülteni Özetleri ve Web Yayınları](http://technet.microsoft.com/security/bulletin/summary).
...
<td style="border:1px solid black;"><strong>Microsoft Data Access Components'taki Güvenlik Açıkları Uzaktan Kod Yürütülmesine İzin Verebilir (2451910)</strong><br />
<br />
...
|-----------------------------------------------------------|----------------------------------------------------------------------------------|----------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------|--------------------------------------------------|  
| [MS11-001](http://go.microsoft.com/fwlink/?linkid=207795) | Yedekleme Yöneticisi'nde Güvenli Olmayan Şekilde Kitaplık Yükleme Güvenlik Açığı | [CVE-2010-3145](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3145) | [1](http://technet.microsoft.com/en-us/security/cc998259.aspx) - Yararlanma kodu büyük olasılıkla tutarlı | **Bu güvenlik açığı genel olarak duyurulmuştur** |  
| [MS11-002](http://go.microsoft.com/fwlink/?linkid=204803) | DSN'de Taşma Güvenlik Açığı                                                      | [CVE-2011-0026](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0026) | [1](http://technet.microsoft.com/en-us/security/cc998259.aspx) - Yararlanma kodu büyük olasılıkla tutarlı | (Yok)                                            |  
| [MS11-002](http://go.microsoft.com/fwlink/?linkid=204803) | ADO Kaydında Bellek Güvenlik Açığı                                               | [CVE-2011-0027](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0027) | [1](http://technet.microsoft.com/en-us/security/cc998259.aspx) - Yararlanma kodu büyük olasılıkla tutarlı | (Yok)                                            |
...
<td style="border:1px solid black;">
[Windows Vista Service Pack 1 ve Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=4eeaad20-729c-4594-8853-e4ae55e9d491)  
(Önemli)
</td>
</tr>
<tr>
...
<td style="border:1px solid black;">
[Windows Vista x64 Edition Service Pack 1 ve Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=b2839cd0-1958-4a22-9aac-0e0aa8f2b52c)  
(Önemli)
</td>
</tr>
<tr>
...
-   Abdul Aziz Hariri, [TippingPoint](http://www.tippingpoint.com/) *bünyesindeki* [Zero Day Initiative](http://www.zerodayinitiative.com/) ile birlikte çalışarak MS11-002'de açıklanan sorunu bildirdikleri için
-   Peter Vreugdenhil, [TippingPoint](http://www.tippingpoint.com/) *bünyesindeki* [Zero Day Initiative](http://www.zerodayinitiative.com/) ile birlikte çalışarak MS11-002'de açıklanan sorunu bildirdikleri için
...
-   V1.0 (11 Ocak 2011): Bülten Özeti yayımlandı.
