---
TOCTitle: 'MS07-NOV'
Title: Microsoft Güvenlik Bülteni Kasım 2007 Özeti
ms:assetid: 'ms07-nov'
ms:contentKeyID: 61235797
ms:mtpsurl: 'https://technet.microsoft.com/tr-TR/library/ms07-nov(v=Security.10)'
---

Security Bulletin Summary

Microsoft Güvenlik Bülteni Kasım 2007 Özeti
===========================================
...
Microsoft, bu bültenlerle ilgili müşteri soruları için 14 Kasım 2007 günü saat 11:00'de (Pasifik Saati, ABD ve Kanada) bir Web yayını gerçekleştirmektedir. [Kasım Güvenlik Bülteni Web Yayını için şimdi kaydolun](http://msevents.microsoft.com/cui/webcasteventdetails.aspx?eventid=1032344694&eventcategory=4&culture=en-us&countrycode=us). Bu tarihten sonra, Web yayını isteğe bağlı olarak kullanılabilecektir. Daha fazla bilgi için, bkz: [Microsoft Güvenlik Bülteni Özetleri ve Web Yayınları](http://technet.microsoft.com/security/bulletin/summary).
...
<span></span>
| Bülten Tanımlayıcısı         | Microsoft Güvenlik Bülteni MS07-062                                                                                                                                                                                                                                                                                                        |
|------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Bülten Başlığı**           | [**DNS'deki Güvenlik Açığı Kimlik Sahtekarlığına Neden Olabilir (941672)**](http://go.microsoft.com/fwlink/?linkid=99391)                                                                                                                                                                                                                  |
...
| **Algılama**                 | Microsoft Baseline Security Analyzer, bu güncelleştirmenin bilgisayar sisteminiz için gerekli olup olmadığını algılayabilir. Bu güncelleştirme belirli durumlar dışında yeniden başlatma gerektirir.                                                                                                                                       |
| **Etkilenen Yazılımlar**     | **Windows.** Daha fazla bilgi için, Etkilenen Yazılımlar ve Karşıdan Yükleme Konumları bölümlerine bakın.                                                                                                                                                                                                                                  |
...
<td style="border:1px solid black;">
[Önemli](http://www.microsoft.com/downloads/details.aspx?familyid=c80fcd9b-d0f8-44db-96fc-bf2ead054ff4)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[Kritik](http://www.microsoft.com/downloads/details.aspx?familyid=8ba1c2f9-1bde-4e97-b327-21259c5e5104)
</td>
<td style="border:1px solid black;">
** **
</td>
...
<td style="border:1px solid black;">
[Kritik](http://www.microsoft.com/downloads/details.aspx?familyid=4ef7fdd7-8887-4c64-a70c-c6ae734d7c5f)
</td>
<td style="border:1px solid black;">
</td>
</tr>
...
<td style="border:1px solid black;">
[Kritik](http://www.microsoft.com/downloads/details.aspx?familyid=e5d8a866-2c1f-4035-8325-c1be61a75c3b)
</td>
<td style="border:1px solid black;">
[Önemli](http://www.microsoft.com/downloads/details.aspx?familyid=ed8e2cb4-bcd9-40fc-9ad6-46b364d0656d)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[Kritik](http://www.microsoft.com/downloads/details.aspx?familyid=bf26da08-15b8-4d65-ba12-4cc74c7a1326)
</td>
<td style="border:1px solid black;">
[Önemli](http://www.microsoft.com/downloads/details.aspx?familyid=d1323e14-ffa7-4d03-a2a7-9240c192a75e)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[Kritik](http://www.microsoft.com/downloads/details.aspx?familyid=1c055f11-3273-4a4c-a33f-bf61ac9ec4c5)
</td>
<td style="border:1px solid black;">
[Önemli](http://www.microsoft.com/downloads/details.aspx?familyid=f3ad67de-85ad-452d-a1e0-0af3faf969d6)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
-   Jesper Johansson, MS07-061'de açıklanan sorun konusunda bizimle çalıştığı için
-   [Secunia](http://corporate.secunia.com/) için çalışan Carsten H. Eiram, MS07-061'de açıklanan sorun konusunda bizimle çalıştığı için
-   [Finjan](http://www.finjan.com/) için çalışan Aviv Raff, MS07-061'de açıklanan sorun konusunda bizimle çalıştığı için
-   [GNUCITIZEN](http://www.gnucitizen.org/) için çalışan Petko Petkov, MS07-061'de açıklanan sorun konusunda bizimle çalıştığı için
-   [Scanit](http://www.scanit.be/) için çalışan Alla Berzroutchko, MS07-062'de açıklanan sorunu bildirdiği için
-   [Trusteer](http://www.trusteer.com/) için çalışan Amit Klein, MS07-062'de açıklanan sorunu bildirdiği için
...
-   V1.0 (13 Kasım 2007): Bülten özeti yayımlandı.
