---
TOCTitle: 'MS09-027'
Title: 'Microsoft Güvenlik Bülteni MS09-027 - Kritik'
ms:assetid: 'ms09-027'
ms:contentKeyID: 61235488
ms:mtpsurl: 'https://technet.microsoft.com/tr-TR/library/ms09-027(v=Security.10)'
---

Security Bulletin

Microsoft Güvenlik Bülteni MS09-027 - Kritik
============================================
...
Bu güvenlik güncelleştirmesi Microsoft Office Word 2000'in tüm desteklenen sürümleri için Kritik olarak derecelendirilmiştir. Microsoft Office Word 2002, Microsoft Office Word 2003, Microsoft Office Word 2007, Mac için Microsoft Office 2004 ve Mac için Microsoft Office 2008'in tüm desteklenen sürümleri ile Mac için Açık XML Dosya Biçimi Dönüştürücüsü, Microsoft Office Uyumluluk Paketi ve Microsoft Office Word Viewer'ın tüm desteklenen sürümleri için, bu güvenlik güncelleştirmesi Önemli olarak derecelendirilmiştir. Daha fazla bilgi için, bu bölümdeki **Etkilenen ve Etkilenmeyen Yazılımlar** alt bölümüne bakın

Güncelleştirme, Word'ün dosyaları açma ve ayrıştırma biçimini değiştirerek bu güvenlik açıklarını giderir. Bu güvenlik açığı hakkında daha fazla bilgi için, bir sonraki bölüm olan **Güvenlik Açığı Bilgileri** altında, ilgili güvenlik açığı girdisinin Sık Sorulan Sorular (SSS) alt bölümüne bakın.

**Öneri.** Microsoft, müşterilerinin güncelleştirmeyi hemen uygulamasını önerir.

**Bilinen Sorunlar.** [Microsoft Bilgi Bankası makalesi 969514](http://support.microsoft.com/kb/969514), bu güvenlik güncelleştirmesini yükleyen müşterilerin karşılaşabileceği bilinen sorunları belgelemektedir. Bu makale ayrıca, bu sorunlar için önerilen çözümleri de içermektedir. Bilinen sorunlar ve önerilen çözümler bu yazılımın yalnızca belirli sürümlerine yöneliktir, ancak bu makalede başka makalelere bağlantılar da sağlanır.
...
<tr>
<td style="border:1px solid black;">
[Word, Excel ve PowerPoint 2007 Dosya Biçimleri için Microsoft Office Uyumluluk Paketi Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=63bd8f14-e736-46ce-af66-d30f17461e5a)  
(KB969613)
</td>
<td style="border:1px solid black;">
Uygulanamaz
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Word, Excel ve PowerPoint 2007 Dosya Biçimleri için Microsoft Office Uyumluluk Paketi Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=63bd8f14-e736-46ce-af66-d30f17461e5a)  
(KB969613)
</td>
<td style="border:1px solid black;">
Uygulanamaz
...
[Microsoft Bilgi Bankası makalesi 969514](http://support.microsoft.com/kb/969514), bu güvenlik güncelleştirmesini yükleyen müşterilerin karşılaşabileceği bilinen sorunları belgelemektedir. Bu makale ayrıca, bu sorunlar için önerilen çözümleri de içermektedir. Bilinen sorunlar ve önerilen çözümler bu yazılımın yalnızca belirli sürümlerine yöneliktir, ancak bu makalede başka makalelere bağlantılar da sağlanır.

**MS09-017 ve MS09-021'de aynı zamanda Mac için Microsoft Office 2004, Mac için Microsoft Office 2008 ve Mac için Açık XML Dosya Biçimi Dönüştürücüsü'ndeki güvenlik açıkları anlatılmaktadır. MS09-017 ve MS09-021 ile bu bülten (MS09-027) arasında nasıl bir ilişki vardır?**  
Mac için Microsoft Office 2004 (KB969661), Mac için Microsoft Office 2008 (KB971822) ve Mac için Açık XML Dosya Biçimi Dönüştürücüsü (KB971824) için bu bültende (MS09-027) bulunan güvenlik güncelleştirmesi paketleri [MS09-017](http://go.microsoft.com/fwlink/?linkid=141704) ve [MS09-021](http://go.microsoft.com/fwlink/?linkid=147294)'de açıklanan güvenlik açıklarını da giderir. Mac için Microsoft Office 2004, Mac için Microsoft Office 2008 veya Mac için Açık XML Dosya Biçimi Dönüştürücüsü'nü yüklemiş olan kullanıcıların bu güvenlik güncelleştirmesi paketlerini bir kez yüklemeleri yeterlidir.
...
<th style="border:1px solid black;" >
Word'de Arabellek Taşması Güvenlik Açığı - CVE-2009-0563
</th>
<th style="border:1px solid black;" >
Word'de Arabellek Taşması Güvenlik Açığı - CVE-2009-0565
</th>
<th style="border:1px solid black;" >
Toplam Önem Derecesi
</th>
...
Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2009-0563](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0563).

#### Word'de Arabellek Taşması Güvenlik Açığı - CVE-2009-0563 için Azaltıcı Etkenler
...
#### Word'de Arabellek Taşması Güvenlik Açığı - CVE-2009-0563 için Geçici Çözümler
...
#### Word'de Arabellek Taşması Güvenlik Açığı - CVE-2009-0563 Hakkında SSS
...
Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2009-0565](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0565).

#### Word'de Arabellek Taşması Güvenlik Açığı - CVE-2009-0565 için Azaltıcı Etkenler
...
#### Word'de Arabellek Taşması Güvenlik Açığı - CVE-2009-0565 için Geçici Çözümler
...
#### Word'de Arabellek Taşması Güvenlik Açığı - CVE-2009-0565 Hakkında SSS
...
| Microsoft Office Word 2007 Service Pack 1 ve Microsoft Office Word 2007 Service Pack 2                                                                                                                       | Evet     |
...
| Microsoft Office Word Viewer 2003 Service Pack 3                                                                                                                                                             | Evet     |
...
| Microsoft Office Word 2007 Service Pack 1 ve Microsoft Office Excel 2007 Service Pack 2                                                                                                                      | Hayır   | Hayır                       | Evet                       | Evet                       |
...
| Microsoft Office Word Viewer 2003 Service Pack 3                                                                                                                                                             | Evet    | Evet                        | Evet                       | Evet                       |
| Microsoft Office Word Viewer                                                                                                                                                                                 | Evet    | Evet                        | Evet                       | Evet                       |
...
<td style="border:1px solid black;">Office2000-kb969600-fullfile-trk /q:a</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">Office2000-kb969600-fullfile-trk /r:n</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">Bkz: <a href="http://support.microsoft.com/kb/969600">Microsoft Bilgi Bankası makalesi 969600</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;">Kullanıcı araya girmeden yükleme</td>
<td style="border:1px solid black;">OfficeXP-kb969602-fullfile-trk /q:a</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">OfficeXP-kb969602-fullfile-trk /r:n</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Güncelleştirme günlük dosyası</td>
<td style="border:1px solid black;">Uygulanamaz</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Dosya Bilgileri</strong></td>
<td style="border:1px solid black;">Bkz: <a href="http://support.microsoft.com/kb/969602">Microsoft Bilgi Bankası makalesi 969602</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Kayıt Defteri Anahtarı Doğrulaması</strong></td>
<td style="border:1px solid black;">Uygulanamaz</td>
...
#### Word 2003 (tüm sürümler), Word Viewer 2003 ve Word Viewer
...
office2003-KB969603-FullFile-TRK /q:a<br />
<br />
Word Viewer 2003 ve Word Viewer için:<br />
Office2003-kb969614-fullfile-trk /q:a</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">Word 2003:<br />
office2003-KB969603-FullFile-TRK /r:n<br />
<br />
Word Viewer 2003 ve Word Viewer için:<br />
Office2003-kb969614-fullfile-trk /r:n</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Güncelleştirme günlük dosyası</td>
<td style="border:1px solid black;">Uygulanamaz</td>
...
<td style="border:1px solid black;"><strong>Dosya Bilgileri</strong></td>
<td style="border:1px solid black;">Word 2003:<br />
Bkz: <a href="http://support.microsoft.com/kb/969603">Microsoft Bilgi Bankası makalesi 969603</a><br />
<br />
Word Viewer 2003 ve Word Viewer için:<br />
Bkz: <a href="http://support.microsoft.com/kb/969614">Microsoft Bilgi Bankası makalesi 969614</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Kayıt Defteri Anahtarı Doğrulaması</strong></td>
<td style="border:1px solid black;">Uygulanamaz</td>
...
#### Word 2007 (tüm sürümler) ve Word, Excel ve PowerPoint 2007 Dosya Biçimleri için Microsoft Office Uyumluluk Paketi
...
<td style="border:1px solid black;"><strong>Dosya Bilgileri</strong></td>
<td style="border:1px solid black;">Word 2007:<br />
Bkz: <a href="http://support.microsoft.com/kb/969604">Microsoft Bilgi Bankası makalesi 969604</a><br />
<br />
Word, Excel ve PowerPoint 2007 Dosya Biçimleri için Microsoft Office Uyumluluk Paketi:<br />
Bkz: <a href="http://support.microsoft.com/kb/969613">Microsoft Bilgi Bankası makalesi 969613</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Kayıt Defteri Anahtarı Doğrulaması</strong></td>
<td style="border:1px solid black;">Uygulanamaz</td>
...
-   [team509](http://www.team509.com/) için çalışan Wushi, [Zero Day Initiative](http://www.zerodayinitiative.com/) ile birlikte çalışarak Word'de Arabellek Taşması Güvenlik Açığı'nı (CVE-2009-0563) bildirdikleri için  
-   [VUPEN Security](http://www.vupen.com/) için çalışan Nicolas Joly, Word'de Arabellek Taşması Güvenlik Açığı'nı (CVE-2009-0565) bildirdiği için
