---
TOCTitle: 'MS09-038'
Title: 'Microsoft Güvenlik Bülteni MS09-038 - Kritik'
ms:assetid: 'ms09-038'
ms:contentKeyID: 61235499
ms:mtpsurl: 'https://technet.microsoft.com/tr-TR/library/ms09-038(v=Security.10)'
---

Security Bulletin

Microsoft Güvenlik Bülteni MS09-038 - Kritik
============================================

Windows Media Dosyasının İşlenmesindeki Güvenlik Açıkları Uzaktan Kod Yürütülmesine İzin Verebilir (971557)
-----------------------------------------------------------------------------------------------------------
...
Güvenlik güncelleştirmesi, AVI üstbilgilerinin işlenme ve AVI verilerinin doğrulanma biçimini düzelterek bu güvenlik açıklarını giderir. Bu güvenlik açıkları hakkında daha fazla bilgi için, bir sonraki bölüm olan **Güvenlik Açığı Bilgileri** altında, ilgili güvenlik açığı girdisinin Sık Sorulan Sorular (SSS) alt bölümüne bakın.
...
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------|----------------------|---------------------------------------------|
| [Microsoft Windows 2000 Service Pack 4](http://www.microsoft.com/downloads/details.aspx?familyid=5f80bf0b-898c-46ca-b20c-21e0e729c332)                                                                                   | Uzaktan Kod Yürütme       | Kritik               | Yok                                         |
| [Windows XP Service Pack 2 ve Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=2e8a68ee-eb24-424c-b084-450636ccaeec)                                                                  | Uzaktan Kod Yürütme       | Kritik               | Yok                                         |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=a1ff2ace-b9dc-4cf3-a151-ac6959bcb3a6)                                                                      | Uzaktan Kod Yürütme       | Kritik               | Yok                                         |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=cba78658-899c-428f-8b04-cfe14ce3c255)                                                                                      | Uzaktan Kod Yürütme       | Kritik               | Yok                                         |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=58a7c8d9-ec36-46a6-a89b-d8dfd989fda4)                                                                          | Uzaktan Kod Yürütme       | Kritik               | Yok                                         |
| [Itanium Tabanlı Sistemler için Windows Server 2003 SP2](http://www.microsoft.com/downloads/details.aspx?familyid=187b02bd-73d6-4f72-81d1-d9477d495499)                                                                  | Uzaktan Kod Yürütme       | Kritik               | Yok                                         |
| [Windows Vista, Windows Vista Service Pack 1 ve Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=81fce7bd-f33c-4586-949d-ac40d415f755)                                             | Uzaktan Kod Yürütme       | Kritik               | Yok                                         |
| [Windows Vista x64 Edition, Windows Vista x64 Edition Service Pack 1 ve Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=a6cea61a-4ad9-4e18-bf18-348ae4ae51c4)         | Uzaktan Kod Yürütme       | Kritik               | Yok                                         |
| [32-bit sistemler için Windows Server 2008 ve 32-bit sistemler için Windows Server 2008 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=fdc96a07-ed79-4798-8077-b2e9ca64cd0f)\*                 | Uzaktan Kod Yürütme       | Kritik               | Yok                                         |
| [x64 tabanlı sistemler için Windows Server 2008 ve x64 tabanlı sistemler için Windows Server 2008 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=8e3afba4-6761-4b3d-98bb-4b4145e27b7f)\*       | Uzaktan Kod Yürütme       | Kritik               | Yok                                         |
| [Itanium tabanlı sistemler için Windows Server 2008 ve Itanium tabanlı sistemler için Windows Server 2008 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=aa1bb13a-5905-48c4-8e74-a41104593046) | Uzaktan Kod Yürütme       | Kritik               | Yok                                         |
...
<th style="border:1px solid black;" >Hatalı Biçimlendirilmiş AVI Üstbilgisi Güvenlik Açığı - CVE-2009-1545</th>
<th style="border:1px solid black;" >AVI'de Tamsayı Taşması Güvenlik Açığı - CVE-2009-1546</th>
...
Hatalı Biçimlendirilmiş AVI Üstbilgisi Güvenlik Açığı - CVE-2009-1545  
---------------------------------------------------------------------
  
<span></span>
Microsoft Windows'un AVI biçimindeki özel hazırlanmış dosyaları işleme biçiminde bir uzaktan kod yürütme güvenlik açığı bulunmaktadır. Bu güvenlik açığı, kullanıcı özel hazırlanmış bir AVI dosyasını açarsa kod yürütülmesine izin verebilir. Kullanıcı yönetimsel haklarla oturum açtıysa, bu güvenlik açığından başarıyla yararlanan bir saldırgan etkilenen sistemin denetimini tümüyle ele geçirebilir. Saldırgan, program yükleyebilir; verileri görüntüleyebilir, değiştirebilir veya silebilir; tüm kullanıcı haklarına sahip olan yeni hesaplar oluşturabilir. Hesapları, sistemde az sayıda kullanıcı hakkıyla yapılandırılmış olan kullanıcılar, yönetici haklarıyla çalışan kullanıcılardan daha az etkilenebilir.
  
Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2009-1545](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1545).
  
#### Hatalı Biçimlendirilmiş AVI Üstbilgisi Güvenlik Açığı - CVE-2009-1545 için Azaltıcı Etkenler
...
#### Hatalı Biçimlendirilmiş AVI Üstbilgisi Güvenlik Açığı - CVE-2009-1545 için Geçici Çözümler
  
Geçici çözüm, arka plandaki güvenlik açığını gidermeyen ama güvenlik açığı uygulanmadan önceki bilinen saldırı vektörlerinin engellenmesine yardımcı olan bir ayar veya yapılandırma değişikliği anlamına gelir. Microsoft aşağıdaki geçici çözümleri sınamıştır ve bir geçici çözümün işlevselliği azaltıp azaltmadığı ilgili açıklamada belirtilmektedir:
  
-   **Avifil32.dll dosyasına erişimi engelleyin**
...
**Geçici çözümün etkisi:** AVIFile API'sini kullanan uygulamalar AVI video içeriğini düzgün işleyemez
...
-   **HKEY\_CLASSES\_ROOT\\CLSID\\{40C3D757-D6E4-4b49-BB41-0E5BBEA28817} anahtarını kaldırın**
  
Bu kayıt defteri anahtarı kaldırıldığında AVI dosyalarına Windows Gezgini'nde önizleme yapılması engellenir.
...
4.Kayıt Defteri Dosyası Ver iletişim kutusuna **Video\_Media\_Properties\_Handler\_Backup.reg** yazın ve **Kaydet**'i tıklatın.  
...
4.Kayıt Defteri Dosyası Ver iletişim kutusuna **Video\_Media\_Properties\_Handler\_Backup1.reg** yazın ve **Kaydet**'i tıklatın.  
**Not** Bu işlem, varsayılan olarak Belgelerim klasöründe bu kayıt defteri anahtarının bir yedeğini oluşturur.
...
9.Kayıt Defteri Dosyası Ver iletişim kutusuna **Video\_Media\_Properties\_Handler\_Backup2.reg** yazın ve **Kaydet**'i tıklatın.  
**Not** Bu işlem, varsayılan olarak Belgelerim klasöründe bu kayıt defteri anahtarının bir yedeğini oluşturur.
...
**Geçici çözümün etkisi:** Windows Gezgini'nde AVI dosyaları için önizleme görüntüsü sağlanmaz.
...
2.Ardından, aşağıdaki metni .REG uzantılı bir dosyaya kaydedin (örneğin, Disable\_Video\_Media\_Properties\_Handler.reg):  
**32-bit Windows sistemler için:**  
...
#### Hatalı Biçimlendirilmiş AVI Üstbilgisi Güvenlik Açığı - CVE-2009-1545 Hakkında SSS
...
AVI dosyalarını işlemek için kullanılan Windows bileşeni, hatalı biçimlendirilmiş üstbilgileri olan özel hazırlanmış AVI dosyalarını düzgün işlememektedir.
  
**Audio Visual Interleave (AVI) dosyası nedir?**  
Audio Video Interleave (AVI), Kaynak Değişim Dosyası Biçimi'nin (RIFF) özel bir örneğidir. .avi dosya biçimi bilgisayardaki ses ve video verileri için en sık kullanılan kapsayıcı biçimdir. Bu dosya türü, ses-video sıralarını yakalayan, düzenleyen ve kayıttan yürüten uygulamalarla kullanılır. Genel olarak, AVI dosyaları farklı veri türlerinde birden çok akış içerir. Çoğu AVI sırası hem ses hem de video akışı kullanır. AVI sırasının basit bir türevinde video verileri kullanılır ve ses akışı gerekmez.
  
**Windows Media Player bu güvenlik açığından etkileniyor mu?**  
Hayır. Etkilenen bileşen, sistemde yüklü olan Windows Media Player sürümünden bağımsızdır.
...
Bu güvenlik açığından yararlanılabilmesi için, kullanıcının özel hazırlanmış bir AVI dosyasını açması veya Web içeriği sağlayan bir Web sitesinden ya da başka bir uygulamadan özel hazırlanmış akış içeriği alması gerekir.
...
Windows Vista ve Windows Server 2008 üzerinde, saldırgan bir dosya sistemine özel hazırlanmış bir AVI dosyası yerleştirip kullanıcıyı bu dosyanın konumuna gitmeye ikna ederek bu güvenlik açığından yararlanabilir. Bu platformlarda, Windows Gezgini, AVI dosyaları için küçük resimler ve önizleme bilgileri sağlamak üzere etkilenen DLL dosyasını yükler.
...
Güncelleştirme, AVI üstbilgilerinin işlenme biçimini düzelterek bu güvenlik açığını giderir.
...
AVI'de Tamsayı Taşması Güvenlik Açığı - CVE-2009-1546  
-----------------------------------------------------
  
<span></span>
Microsoft Windows'un AVI biçimindeki özel hazırlanmış dosyaları işleme biçiminde bir uzaktan kod yürütme güvenlik açığı bulunmaktadır. Bu güvenlik açığı, kullanıcı özel hazırlanmış bir AVI dosyasını açarsa kod yürütülmesine izin verebilir. Kullanıcı yönetimsel haklarla oturum açtıysa, bu güvenlik açığından başarıyla yararlanan bir saldırgan etkilenen sistemin denetimini tümüyle ele geçirebilir. Saldırgan, program yükleyebilir; verileri görüntüleyebilir, değiştirebilir veya silebilir; tüm kullanıcı haklarına sahip olan yeni hesaplar oluşturabilir. Hesapları, sistemde az sayıda kullanıcı hakkıyla yapılandırılmış olan kullanıcılar, yönetici haklarıyla çalışan kullanıcılardan daha az etkilenebilir.
  
Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2009-1546](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1546).
  
#### AVI'de Tamsayı Taşması Güvenlik Açığı - CVE-2009-1546 için Azaltıcı Etkenler
...
#### AVI'de Tamsayı Taşması Güvenlik Açığı - CVE-2009-1546 için Geçici Çözümler
...
#### AVI'de Tamsayı Taşması Güvenlik Açığı - CVE-2009-1546 Hakkında SSS
  
**Bu güvenlik açığının kapsamı nedir?**  
Bu bir uzaktan kod yürütme güvenlik açığıdır. Bu güvenlik açığından başarıyla yararlanan bir saldırgan, etkilenen sistemin tüm denetimini uzaktan ele geçirebilir. Saldırgan, program yükleyebilir; verileri görüntüleyebilir, değiştirebilir veya silebilir; tüm kullanıcı haklarına sahip olan yeni hesaplar oluşturabilir.
  
**Güvenlik açığına ne neden olmaktadır?**  
AVI dosyalarını işlemek için kullanılan Windows bileşeni, özel hazırlanmış AVI dosyalarının içerdiği verileri düzgün biçimde doğrulamamaktadır.
...
**Güncelleştirme ne yapıyor?**  
Güncelleştirme, AVI verilerinin doğrulanma biçimini düzelterek bu güvenlik açığını giderir.
...
| **Dağıtım**                                  |                                                                                                                                                                       |  
| Kullanıcı araya girmeden yükleme             | Windows2000-kb971557-x86-trk /quiet                                                                                                                                   |  
| Yeniden başlatmadan yükleme                  | Windows2000-kb971557-x86-trk /norestart                                                                                                                               |  
| Güncelleştirme günlük dosyası                | kb971557.log                                                                                                                                                          |  
...
| **Kaldırma Bilgileri**                       | Denetim Masası'ndaki **Program Ekle veya Kaldır** aracını veya %Windir%\\$NTUninstallKB971557$\\Spuninst klasöründe bulunan Spuninst.exe yardımcı programını kullanın |  
| **Dosya Bilgileri**                          | Bkz: [Microsoft Bilgi Bankası makalesi 971557](http://support.microsoft.com/kb/971557)                                                                                |  
| **Kayıt Defteri Anahtarı Doğrulaması**       | HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows 2000\\SP5\\KB971557\\Filelist                                                                             |
...
Windowsxp-kb971557-x86-trk /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
WindowsServer2003.WindowsXP-kb971557-x64-trk /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">Windows XP Service Pack 2 ve Windows XP Service Pack 3:<br />
Windowsxp-kb971557-x86-trk /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition ve Windows XP Professional x64 Edition Service Pack 2 için:<br />
WindowsServer2003.WindowsXP-kb971557-x64-trk /norestart</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">Denetim Masası'ndaki <strong>Program Ekle veya Kaldır</strong> aracını veya %Windir%\$NTUninstallKB971557$\Spuninst klasöründe bulunan Spuninst.exe yardımcı programını kullanın</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Dosya Bilgileri</strong></td>
<td style="border:1px solid black;">Bkz: <a href="http://support.microsoft.com/kb/971557">Microsoft Bilgi Bankası makalesi 971557</a></td>
</tr>
<tr class="even">
...
Windowsserver2003-kb971557-x86-trk /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
Windowsserver2003-KB971557-ia64-trk /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen 32 bit sürümleri:<br />
Windowsserver2003-kb971557-x86-trk /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen x64 tabanlı sürümleri:<br />
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen Itanium tabanlı sürümleri:<br />
Windowsserver2003-KB971557-ia64-trk /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Güncelleştirme günlük dosyası</td>
<td style="border:1px solid black;">KB971557.log</td>
...
-   [Adobe Systems, Inc.](http://www.adobe.com/) için çalışan Vinay Anantharaman, Hatalı Biçimlendirilmiş AVI Üstbilgisi Güvenlik Açığı'nı (CVE-2009-1545) bildirdiği için  
-   [Adobe Systems, Inc.](http://www.adobe.com/) için çalışan Vinay Anantharaman, AVI'de Tamsayı Taşması Güvenlik Açığı'nı (CVE-2009-1546) bildirdiği için
