---
TOCTitle: 'MS09-019'
Title: 'Microsoft Güvenlik Bülteni MS09-019 - Kritik'
ms:assetid: 'ms09-019'
ms:contentKeyID: 61235480
ms:mtpsurl: 'https://technet.microsoft.com/tr-TR/library/ms09-019(v=Security.10)'
---

Security Bulletin

Microsoft Güvenlik Bülteni MS09-019 - Kritik
============================================
...
Bu güvenlik güncelleştirmesi, Microsoft Windows 2000'in desteklenen sürümleri üzerinde çalıştırıldığında Internet Explorer 5.01 için Kritik ve Internet Explorer 6 Service Pack 1 için Önemli; Windows XP'nin ve Windows Vista'nın desteklenen sürümleri üzerinde çalıştırıldığında Internet Explorer 6, Internet Explorer 7 ve Internet Explorer 8 için Kritik; Windows Server 2003'ün ve Windows Server 2008'in desteklenen sürümleri üzerinde çalıştırıldığında Internet Explorer 6, Internet Explorer 7 ve Internet Explorer 8 için Orta olarak derecelendirilmiştir. Daha fazla bilgi için, bu bölümdeki **Etkilenen ve Etkilenmeyen Yazılımlar** alt bölümüne bakın.

Güvenlik güncelleştirmesi, Internet Explorer'ın komut dosyalarını ve önbelleğe alınan içeriği işleme ve belleği başlatma biçimini değiştirerek bu güvenlik açıklarını giderir. Bu güvenlik açıkları hakkında daha fazla bilgi için, bir sonraki bölüm olan **Güvenlik Açığı Bilgileri** altında, Sık Sorulan Sorular (SSS) alt bölümüne bakın.
...
**Bilinen Sorunlar.** [Microsoft Bilgi Bankası makalesi 969897](http://support.microsoft.com/kb/969897), bu güvenlik güncelleştirmesini yükleyen müşterilerin karşılaşabileceği bilinen sorunları belgelemektedir. Bu makale ayrıca, bu sorunlar için önerilen çözümleri de içermektedir. Bilinen sorunlar ve önerilen çözümler bu yazılımın yalnızca belirli sürümlerine yöneliktir, ancak bu makalede başka makalelere bağlantılar da sağlanır.
...
<td style="border:1px solid black;">
[Yok](http://go.microsoft.com/fwlink/?linkid=146659)
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
Dosya bilgileri ayrıntıları [Microsoft Bilgi Bankası makalesi 969897](http://support.microsoft.com/kb/969897)'de bulunabilir.
...
<th style="border:1px solid black;" >
Yarış Durumunda Etki Alanları Arasında Bilginin Açığa Çıkması Güvenlik Açığı - CVE-2007-3091
</th>
<th style="border:1px solid black;" >
Etki Alanları Arasında Bilginin Açığa Çıkması Güvenlik Açığı - CVE-2009-1140
</th>
<th style="border:1px solid black;" >
DHTML Nesnesinde Bellek Bozulması - CVE-2009-1141
</th>
<th style="border:1px solid black;" >
HTML Nesnesinde Bellek Bozulması - CVE-2009-1528
</th>
<th style="border:1px solid black;" >
Başlatılmamış Belleğin Bozulması Güvenlik Açığı - CVE-2009-1529
</th>
<th style="border:1px solid black;" >
HTML Nesnelerinde Bellek Bozulması Güvenlik Açığı - CVE-2009-1530
</th>
<th style="border:1px solid black;" >
HTML Nesnesinde Bellek Bozulması Güvenlik Açığı - CVE-2009-1531
</th>
<th style="border:1px solid black;" >
HTML Nesnelerinde Bellek Bozulması Güvenlik Açığı - CVE-2009-1532
</th>
<th style="border:1px solid black;" >
Toplam Önem Derecesi
</th>
...
<span></span>
Internet Explorer'da, bir komut dosyasının başka bir etki alanındaki veya Internet Explorer bölgesindeki başka bir tarayıcı penceresinde bulunan içeriğe erişim sağlamasına olanak verebilecek bir bilginin açığa çıkması güvenlik açığı bulunmaktadır. Saldırgan, bir kullanıcı Web sayfasını görüntülerse bilginin açığa çıkmasına neden olabilecek özel hazırlanmış bir Web sayfası oluşturmak yoluyla güvenlik açığından yararlanabilir. Bu güvenlik açığından başarıyla yararlanan bir saldırgan, başka bir Internet Explorer etki alanındaki Web sayfasında yer alan verileri görüntüleyebilir.

Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2007-3091](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-3091).

#### Yarış Durumunda Etki Alanları Arasında Bilginin Açığa Çıkması Güvenlik Açığı - CVE-2007-3091 için Azaltıcı Etkenler
...
#### Yarış Durumunda Etki Alanları Arasında Bilginin Açığa Çıkması Güvenlik Açığı - CVE-2007-3091 için Geçici Çözümler
...
#### Yarış Durumunda Etki Alanları Arasında Bilginin Açığa Çıkması Güvenlik Açığı - CVE-2007-3091 Hakkında SSS

**Bu güvenlik açığının kapsamı nedir?**  
Bu, bir bilginin açığa çıkması güvenlik açığıdır. Kullanıcı bir Web sayfasını görüntülediğinde bu güvenlik açığından başarıyla yararlanan bir saldırgan, kendi etki alanından veya Internet Explorer bölgesinden farklı bir etki alanında veya bölgede başka bir tarayıcı penceresindeki içeriği görüntüleyebilir.

**Güvenlik açığına ne neden olmaktadır?**  
Komut dosyası, Internet Explorer'ın aynı kaynak ilkesini ihlal edebilecek ve farklı etki alanlarından içeriğin okumasına neden olabilecek bir yarış durumu oluşturabilir.

**Bir saldırgan bu güvenlik açığından yararlanarak neler yapabilir?**  
Saldırgan, kendi etki alanından veya Internet Explorer bölgesinden farklı bir etki alanında veya bölgede başka bir tarayıcı penceresindeki içeriği görüntüleyebilir.
...
Güncelleştirme, Internet Explorer'ın yürütülen bir komut dosyasının etki alanını tanımlama biçimini değiştirerek komut dosyasını özgün etki alanının bağlamında yürütülecek biçimde kısıtlar.

**Bu güvenlik bülteni yayımlandığında bu güvenlik açığı genel olarak duyurulmuş muydu?**  
Evet. Bu güvenlik açığı genel olarak duyurulmuştur. Ortak Güvenlik Açığı ve Etkilenme (Common Vulnerability and Exposure) numarası olarak [CVE-2007-3091](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-3091) atanmıştır.
...
Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2009-1140](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1140).

#### Etki Alanları Arasında Bilginin Açığa Çıkması Güvenlik Açığı - CVE-2009-1140 için Azaltıcı Etkenler
...
-   Windows Vista veya Windows Server 2008 üzerinde Windows Internet Explorer 7 kullanılması bu güvenlik açığının etkilerini azaltır.

#### Etki Alanları Arasında Bilginin Açığa Çıkması Güvenlik Açığı - CVE-2009-1140 için Geçici Çözümler
...
#### Etki Alanları Arasında Bilginin Açığa Çıkması Güvenlik Açığı - CVE-2009-1140 Hakkında SSS
...
<span></span>
Internet Explorer'ın HTML nesnelerine yönelik bazı beklenmeyen yöntem çağrıları içeren bir Web sayfasını görüntüleme biçiminde bir uzaktan kod yürütme güvenlik açığı bulunmaktadır. Bu nedenle, kullanıcı özel hazırlanmış bir Web sitesini ziyaret ederse sistem belleği bir saldırganın rasgele kod yürütmesine olanak verecek şekilde bozulabilir. Bu güvenlik açığından başarıyla yararlanan bir saldırgan, oturum açan kullanıcı ile aynı haklara sahip olabilir.

Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2009-1141](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1141).

#### DHTML Nesnesinde Bellek Bozulması - CVE-2009-1141 için Azaltıcı Etkenler
...
-   Varsayılan olarak, Microsoft Outlook ve Microsoft Outlook Express'in tüm desteklenen sürümleri HTML e-posta iletilerini Yasak siteler bölgesinde açar. Yasak siteler bölgesi, HTML e-posta iletileri okunurken Active Komut Dizileri ve ActiveX denetimlerinin kullanılmasını engelleyerek, bu güvenlik açığından yararlanmaya çalışacak saldırıların etkilerinin azaltılmasına yardımcı olur. Bununla birlikte, kullanıcı bir e-posta iletisindeki bağlantıyı tıklatırsa, Web tabanlı saldırı senaryosu aracılığıyla bu güvenlik açığından etkilenebilir.
-   Internet Explorer, Windows Server 2003 ve Windows Server 2008'de varsayılan olarak [Artırılmış Güvenlik Yapılandırması](http://go.microsoft.com/fwlink/?linkid=92039) adı verilen kısıtlı bir modda çalışır. Bu mod, Internet bölgesi için güvenlik düzeyini Yüksek olarak ayarlar. Bu, Internet Explorer'ın Güvenilen siteler bölgesine eklenmemiş Web siteleri için bir azaltıcı etkendir. Internet Explorer Artırılmış Güvenlik Yapılandırması hakkında daha fazla bilgi için bu güvenlik açığıyla ilgili bölümün SSS (Sık Sorulan Sorular) alt bölümüne bakın.
-   Microsoft Windows 2000 üzerinde çalıştırıldığında Microsoft Internet Explorer 5.01 Service Pack 4 ve Microsoft Internet Explorer 6 Service Pack 1; Windows Internet Explorer 7 ve Windows Internet Explorer 8 bu güvenlik açığından etkilenmez.

#### DHTML Nesnesinde Bellek Bozulması - CVE-2009-1141 için Geçici Çözümler
...
#### DHTML Nesnesinde Bellek Bozulması - CVE-2009-1141 Hakkında SSS
...
**Güvenlik açığına ne neden olmaktadır?**  
Internet Explorer HTML nesnelerine yönelik beklenmeyen yöntem çağrıları için bir Web sayfasını görüntülediğinde, sistem belleği bir saldırganın rasgele kod yürütmesine olanak verebilecek bir şekilde bozulabilir.
...
**DHTML nedir?**  
Dinamik HTML (DHTML), Microsoft tarafından ilk olarak Internet Explorer 4.0'da sunulan ve yazarların kullanıcı Web sayfasıyla etkileşim kurdukça sayfanın işlenmesini ve içeriğini dinamik olarak değiştirebilmelerini sağlayan bir dizi özelliktir. Daha fazla bilgi için, [DHTML Nesneleri](http://msdn.microsoft.com/en-us/library/ms533054(vs.85).aspx) adlı MSDN makalesine bakın.
...
**Güncelleştirme ne yapıyor?**  
Güncelleştirme, Internet Explorer'ın DHTML nesnelerini işleme biçimini değiştirir.
...
Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2009-1528](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1528).

#### HTML Nesnesinde Bellek Bozulması - CVE-2009-1528 için Azaltıcı Etkenler
...
-   Varsayılan olarak, Microsoft Outlook ve Microsoft Outlook Express'in tüm desteklenen sürümleri HTML e-posta iletilerini Yasak siteler bölgesinde açar. Yasak siteler bölgesi, HTML e-posta iletileri okunurken Active Komut Dizileri ve ActiveX denetimlerinin kullanılmasını engelleyerek, bu güvenlik açığından yararlanmaya çalışacak saldırıların etkilerinin azaltılmasına yardımcı olur. Bununla birlikte, kullanıcı bir e-posta iletisindeki bağlantıyı tıklatırsa, Web tabanlı saldırı senaryosu aracılığıyla bu güvenlik açığından etkilenebilir.
-   Internet Explorer, Windows Server 2003 ve Windows Server 2008'de varsayılan olarak [Artırılmış Güvenlik Yapılandırması](http://go.microsoft.com/fwlink/?linkid=92039) adı verilen kısıtlı bir modda çalışır. Bu mod, Internet bölgesi için güvenlik düzeyini Yüksek olarak ayarlar. Bu, Internet Explorer'ın Güvenilen siteler bölgesine eklenmemiş Web siteleri için bir azaltıcı etkendir. Internet Explorer Artırılmış Güvenlik Yapılandırması hakkında daha fazla bilgi için bu güvenlik açığıyla ilgili bölümün SSS (Sık Sorulan Sorular) alt bölümüne bakın.
-   Microsoft Windows 2000 üzerinde çalıştırıldığında Microsoft Internet Explorer 5.01 Service Pack 4 ve Microsoft Internet Explorer 6.0 Service Pack 1 ile Windows Internet Explorer 8 bu güvenlik açığından etkilenmez.

#### HTML Nesnesinde Bellek Bozulması - CVE-2009-1528 için Geçici Çözümler
...
#### HTML Nesnesinde Bellek Bozulması - CVE-2009-1528 Hakkında SSS
...
Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2009-1529](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1529).

#### Başlatılmamış Belleğin Bozulması Güvenlik Açığı - CVE-2009-1529 için Azaltıcı Etkenler
...
-   Varsayılan olarak, Microsoft Outlook ve Microsoft Outlook Express'in tüm desteklenen sürümleri HTML e-posta iletilerini Yasak siteler bölgesinde açar. Yasak siteler bölgesi, HTML e-posta iletileri okunurken Active Komut Dizileri ve ActiveX denetimlerinin kullanılmasını engelleyerek, bu güvenlik açığından yararlanmaya çalışacak saldırıların etkilerinin azaltılmasına yardımcı olur. Bununla birlikte, kullanıcı bir e-posta iletisindeki bağlantıyı tıklatırsa, Web tabanlı saldırı senaryosu aracılığıyla bu güvenlik açığından etkilenebilir.
-   Internet Explorer, Windows Server 2003 ve Windows Server 2008'de varsayılan olarak [Artırılmış Güvenlik Yapılandırması](http://go.microsoft.com/fwlink/?linkid=92039) adı verilen kısıtlı bir modda çalışır. Bu mod, Internet bölgesi için güvenlik düzeyini Yüksek olarak ayarlar. Bu, Internet Explorer'ın Güvenilen siteler bölgesine eklenmemiş Web siteleri için bir azaltıcı etkendir. Internet Explorer Artırılmış Güvenlik Yapılandırması hakkında daha fazla bilgi için bu güvenlik açığıyla ilgili bölümün SSS (Sık Sorulan Sorular) alt bölümüne bakın.
-   Microsoft Windows 2000 üzerinde çalıştırıldığında Microsoft Internet Explorer 5.01 Service Pack 4 ve Microsoft Internet Explorer 6.0 Service Pack 1; Microsoft Internet Explorer 6.0 ve Windows Internet Explorer 8 bu güvenlik açığından etkilenmez.

#### Başlatılmamış Belleğin Bozulması Güvenlik Açığı - CVE-2009-1529 için Geçici Çözümler
...
#### Başlatılmamış Belleğin Bozulması Güvenlik Açığı - CVE-2009-1529 Hakkında SSS
...
Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2009-1530](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1530).

#### HTML Nesnelerinde Bellek Bozulması Güvenlik Açığı - CVE-2009-1530 için Azaltıcı Etkenler
...
-   Varsayılan olarak, Microsoft Outlook ve Microsoft Outlook Express'in tüm desteklenen sürümleri HTML e-posta iletilerini Yasak siteler bölgesinde açar. Yasak siteler bölgesi, HTML e-posta iletileri okunurken Active Komut Dizileri ve ActiveX denetimlerinin kullanılmasını engelleyerek, bu güvenlik açığından yararlanmaya çalışacak saldırıların etkilerinin azaltılmasına yardımcı olur. Bununla birlikte, kullanıcı bir e-posta iletisindeki bağlantıyı tıklatırsa, Web tabanlı saldırı senaryosu aracılığıyla bu güvenlik açığından etkilenebilir.
-   Internet Explorer, Windows Server 2003 ve Windows Server 2008'de varsayılan olarak [Artırılmış Güvenlik Yapılandırması](http://go.microsoft.com/fwlink/?linkid=92039) adı verilen kısıtlı bir modda çalışır. Bu mod, Internet bölgesi için güvenlik düzeyini Yüksek olarak ayarlar. Bu, Internet Explorer'ın Güvenilen siteler bölgesine eklenmemiş Web siteleri için bir azaltıcı etkendir. Internet Explorer Artırılmış Güvenlik Yapılandırması hakkında daha fazla bilgi için bu güvenlik açığıyla ilgili bölümün SSS (Sık Sorulan Sorular) alt bölümüne bakın.
-   Microsoft Internet Explorer 5.01 Service Pack 4, Microsoft Internet Explorer 6.0, Microsoft Internet Explorer 6.0 Service Pack 1 ve Windows Internet Explorer 8 bu güvenlik açığından etkilenmez.

#### HTML Nesnelerinde Bellek Bozulması Güvenlik Açığı - CVE-2009-1530 için Geçici Çözümler
...
#### HTML Nesnelerinde Bellek Bozulması Güvenlik Açığı - CVE-2009-1530 Hakkında SSS
...
Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2009-1531](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1531).

#### HTML Nesnesinde Bellek Bozulması Güvenlik Açığı - CVE-2009-1531 için Azaltıcı Etkenler
...
#### HTML Nesnesinde Bellek Bozulması Güvenlik Açığı - CVE-2009-1531 için Geçici Çözümler
...
#### HTML Nesnesinde Bellek Bozulması Güvenlik Açığı - CVE-2009-1531 Hakkında SSS
...
HTML Nesnesinde Bellek Bozulması Güvenlik Açığı - CVE-2009-1532
---------------------------------------------------------------

<span></span>
Internet Explorer'ın doğru biçimde başlatılmamış veya silinmiş bir nesneye erişme biçiminde bir uzaktan kod yürütme güvenlik açığı bulunmaktadır. Saldırgan, özel hazırlanmış bir Web sayfası oluşturarak bu güvenlik açığından yararlanabilir. Bir kullanıcı bu Web sayfasını görüntülediğinde, güvenlik açığı uzaktan kod yürütülmesine izin verebilir. Bu güvenlik açığından başarıyla yararlanan bir saldırgan, oturum açan kullanıcı ile aynı haklara sahip olabilir. Kullanıcı yönetimsel haklarla oturum açtıysa, bu güvenlik açığından başarıyla yararlanan bir saldırgan etkilenen sistemin denetimini tümüyle ele geçirebilir. Saldırgan, program yükleyebilir; verileri görüntüleyebilir, değiştirebilir veya silebilir; tüm kullanıcı haklarına sahip olan yeni hesaplar oluşturabilir.

Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2009-1532](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1532).

#### HTML Nesnesinde Bellek Bozulması Güvenlik Açığı - CVE-2009-1532 için Azaltıcı Etkenler
...
-   Varsayılan olarak, Microsoft Outlook ve Microsoft Outlook Express'in tüm desteklenen sürümleri HTML e-posta iletilerini Yasak siteler bölgesinde açar. Yasak siteler bölgesi, HTML e-posta iletileri okunurken Active Komut Dizileri ve ActiveX denetimlerinin kullanılmasını engelleyerek, bu güvenlik açığından yararlanmaya çalışacak saldırıların etkilerinin azaltılmasına yardımcı olur. Bununla birlikte, kullanıcı bir e-posta iletisindeki bağlantıyı tıklatırsa, Web tabanlı saldırı senaryosu aracılığıyla bu güvenlik açığından etkilenebilir.
-   Internet Explorer, Windows Server 2003 ve Windows Server 2008'de varsayılan olarak [Artırılmış Güvenlik Yapılandırması](http://go.microsoft.com/fwlink/?linkid=92039) adı verilen kısıtlı bir modda çalışır. Bu mod, Internet bölgesi için güvenlik düzeyini Yüksek olarak ayarlar. Bu, Internet Explorer'ın Güvenilen siteler bölgesine eklenmemiş Web siteleri için bir azaltıcı etkendir. Internet Explorer Artırılmış Güvenlik Yapılandırması hakkında daha fazla bilgi için bu güvenlik açığıyla ilgili bölümün SSS (Sık Sorulan Sorular) alt bölümüne bakın.
-   Microsoft Internet Explorer 5.01 Service Pack 4, Microsoft Internet Explorer 6.0, Microsoft Internet Explorer 6.0 Service Pack 1 ve Windows Internet Explorer 7 bu güvenlik açığından etkilenmez.

#### HTML Nesnesinde Bellek Bozulması Güvenlik Açığı - CVE-2009-1532 için Geçici Çözümler
...
#### HTML Nesnesinde Bellek Bozulması Güvenlik Açığı - CVE-2009-1532 Hakkında SSS
...
IE5.01sp4-KB969897-Windows2000sp4-x86-trk /quiet<br />
<br />
Windows 2000'in tüm desteklenen sürümleri üzerine yüklendiğinde Internet Explorer 6 Service Pack 1 için:<br />
IE6.0sp1-KB969897-Windows2000-x86-trk /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">Windows 2000'in tüm desteklenen sürümleri üzerinde Internet Explorer 5.01 Service Pack 4 için:<br />
IE5.01sp4-KB969897-Windows2000sp4-x86-trk /norestart<br />
<br />
Windows 2000'in tüm desteklenen sürümleri üzerine yüklendiğinde Internet Explorer 6 Service Pack 1 için:<br />
IE6.0sp1-KB969897-Windows2000-x86-trk /norestart</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">Windows 2000'in tüm desteklenen sürümleri üzerinde Internet Explorer 5.01 Service Pack 4 için:<br />
Denetim Masası'ndaki <strong>Program Ekle veya Kaldır</strong> aracını veya %Windir%\$NTUninstallKB969897-IE501SP4- 20090522.120000$\Spuninst klasöründe bulunan Spuninst.exe yardımcı programını kullanın<br />
<br />
Windows 2000'in tüm desteklenen sürümleri üzerine yüklendiğinde Internet Explorer 6 Service Pack 1 için:<br />
Denetim Masası'ndaki <strong>Program Ekle veya Kaldır</strong> aracını veya %Windir%\$NTUninstallKB969897-IE6SP1-20090501.120000$\Spuninst klasöründe bulunan Spuninst.exe yardımcı programını kullanın</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Dosya Bilgileri</strong></td>
<td style="border:1px solid black;">Bkz: <a href="http://support.microsoft.com/kb/969897">Microsoft Bilgi Bankası makalesi 969897</a></td>
</tr>
<tr class="even">
...
Windowsxp-KB969897-x86-trk /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP'nin tüm desteklenen x64 tabanlı sürümleri için Internet Explorer 6:<br />
WindowsServer2003.WindowsXP-KB969897-x64-trk /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP'nin tüm desteklenen 32 bit sürümleri için Internet Explorer 7:<br />
IE7-WindowsXP-KB969897-x86-trk /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP'nin tüm desteklenen x64 tabanlı sürümleri için Internet Explorer 7:<br />
IE7-WindowsServer2003.WindowsXP-KB969897-x64-trk /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP'nin tüm desteklenen 32 bit sürümleri için Internet Explorer 8:<br />
IE8-WindowsXP-KB969897-x86-trk /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP'nin tüm desteklenen x64 tabanlı sürümleri için Internet Explorer 8:<br />
IE8-WindowsServer2003.WindowsXP-KB969897-x64-trk /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">Windows XP'nin tüm desteklenen 32 bit sürümleri için Internet Explorer 6:<br />
Windowsxp-KB969897-x86-trk /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP'nin tüm desteklenen x64 tabanlı sürümleri için Internet Explorer 6:<br />
WindowsServer2003.WindowsXP-KB969897-x64-trk /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP'nin tüm desteklenen 32 bit sürümleri için Internet Explorer 7:<br />
IE7-WindowsXP-KB969897-x86-trk /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP'nin tüm desteklenen x64 tabanlı sürümleri için Internet Explorer 7:<br />
IE7-WindowsServer2003.WindowsXP-KB969897-x64-trk /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP'nin tüm desteklenen 32 bit sürümleri için Internet Explorer 8:<br />
IE8-WindowsXP-KB969897-x86-trk /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP'nin tüm desteklenen x64 tabanlı sürümleri için Internet Explorer 8:<br />
IE8-WindowsServer2003.WindowsXP-KB969897-x64-trk /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Güncelleştirme günlük dosyası</td>
...
<td style="border:1px solid black;"><strong>Kaldırma Bilgileri</strong></td>
<td style="border:1px solid black;">Windows XP'nin tüm desteklenen sürümleri için Internet Explorer 6:<br />
Denetim Masası'ndaki <strong>Program Ekle veya Kaldır</strong> aracını veya %Windir%\$NTUninstallKB969897$\Spuninst klasöründe bulunan Spuninst.exe yardımcı programını kullanın</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP'nin tüm desteklenen sürümleri için Internet Explorer 7:<br />
Denetim Masası'ndaki <strong>Program Ekle veya Kaldır</strong> aracını veya %Windir%\ie7updates\KB969897-IE7\spuninst klasöründe bulunan Spuninst.exe yardımcı programını kullanın</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP'nin tüm desteklenen sürümleri için Internet Explorer 8:<br />
Denetim Masası'ndaki <strong>Program Ekle veya Kaldır</strong> aracını veya %Windir%\ie8updates\KB969897-IE8\spuninst klasöründe bulunan Spuninst.exe yardımcı programını kullanın</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Dosya Bilgileri</strong></td>
<td style="border:1px solid black;">Bkz: <a href="http://support.microsoft.com/kb/969897">Microsoft Bilgi Bankası makalesi 969897</a></td>
...
Windowsserver2003-KB969897-x86-trk /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen 32-bit sürümleri için Internet Explorer 6:<br />
Windowsserver2003-KB969897-x86-trk /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen x64 tabanlı sürümleri için Internet Explorer 6:<br />
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen Itanium tabanlı sürümleri için Internet Explorer 6:<br />
Windowsserver2003-KB969897-ia64-trk /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen 32-bit sürümleri için Internet Explorer 7:<br />
IE7-WindowsServer2003-KB969897-x86-trk /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen x64 tabanlı sürümleri için Internet Explorer 7:<br />
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen Itanium tabanlı sürümleri için Internet Explorer 7:<br />
IE7-WindowsServer2003-KB969897-ia64-trk /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen 32-bit sürümleri için Internet Explorer 8:<br />
IE8-WindowsServer2003-KB969897-x86-trk /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen x64 tabanlı sürümleri için Internet Explorer 8:<br />
...
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen 32 bit ve x64 tabanlı sürümleri için Internet Explorer 8:
KB969897-IE8.log</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Diğer bilgiler</td>
...
-   [Google Inc.](http://www.google.com/) için çalışan David Bloom, Yarış Durumunda Etki Alanları Arasında Bilginin Açığa Çıkması Güvenlik Açığı (CVE-2007-3091) konusunda bizimle çalıştığı için  
-   [Core Security Technologies](http://www.coresecurity.com/) için çalışan Jorge Luis Alvarez Medina, Etki Alanları Arasında Bilginin Açığa Çıkması Güvenlik Açığı'nı (CVE-2009-1140) bildirdiği için  
-   [Fortinet](http://www.fortinet.com) için çalışan Haifei Li, DHTML Nesnesinde Bellek Bozulması'nı (CVE-2009-1141) bildirdiği için  
-   [Tippingpoint](http://www.tippingpoint.com/) ve [Zero Day Initiative](http://www.zerodayinitiative.com/), HTML Nesnesinde Bellek Bozulması'nı (CVE-2009-1528) bildirdikleri için  
-   [TippingPoint](http://www.tippingpoint.com/) için çalışan Peter Vreugdenhil ve [Zero Day Initiative](http://www.zerodayinitiative.com/), Başlatılmamış Belleğin Bozulması Güvenlik Açığı'nı (CVE-2009-1529) bildirdikleri için  
-   [TippingPoint](http://www.tippingpoint.com/) için çalışan Wushi ve [Zero Day Initiative](http://www.zerodayinitiative.com/), HTML Nesnelerinde Bellek Bozulması Güvenlik Açığı'nı (CVE-2009-1530) bildirdikleri için  
-   [TippingPoint](http://www.tippingpoint.com/) için çalışan Wushi ve [Zero Day Initiative](http://www.zerodayinitiative.com/), HTML Nesnesinde Bellek Bozulması Güvenlik Açığı'nı (CVE-2009-1531) bildirdikleri için  
-   [TippingPoint](http://www.tippingpoint.com/) için çalışan Nils ve [Zero Day Initiative](http://www.zerodayinitiative.com/), HTML Nesnelerinde Bellek Bozulması Güvenlik Açığı'nı (CVE-2009-1532) bildirdikleri için
