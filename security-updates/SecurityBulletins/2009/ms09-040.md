---
TOCTitle: 'MS09-040'
Title: 'Microsoft Güvenlik Bülteni MS09-040 - Önemli'
ms:assetid: 'ms09-040'
ms:contentKeyID: 61235501
ms:mtpsurl: 'https://technet.microsoft.com/tr-TR/library/ms09-040(v=Security.10)'
---

Security Bulletin

Microsoft Güvenlik Bülteni MS09-040 - Önemli
============================================

Message Queuing Hizmetindeki Güvenlik Açığı Ayrıcalık Yükselmesine İzin Verebilir (971032)
------------------------------------------------------------------------------------------

Yayım Tarihi: 11 Ağustos 2009 Salı | Güncelleştirme Tarihi: 30 Haziran 2010 Çarşamba
...
Bu güvenlik güncelleştirmesi, Windows Message Queuing Hizmeti'nde (MSMQ) özel olarak bildirilen bir güvenlik açığını giderir. Güvenlik açığı, bir kullanıcı etkilenen bir MSMQ hizmetinde özel hazırlanmış bir istek alırsa ayrıcalık yükselmesine neden olabilir. Message Queuing bileşeni varsayılan olarak etkilenen işletim sistemi sürümlerinde hiçbirinde yüklü değildir ve yalnızca yönetici ayrıcalıkları olan bir kullanıcı tarafından etkinleştirilebilir. Yalnızca Message Queuing bileşenini el ile yükleyen müşteriler bu sorundan etkilenebilir.

Bu güvenlik güncelleştirmesi Microsoft Windows 2000 Service Pack 4, Windows XP Service Pack 2 ve Windows XP Professional x64 Edition Service Pack 2, Windows Server 2003'ün tüm desteklenen sürümleri, Windows Vista ve Windows Vista x64 Edition için Önemli olarak derecelendirilmiştir. Daha fazla bilgi için, bu bölümdeki **Etkilenen ve Etkilenmeyen Yazılımlar** alt bölümüne bakın.

Güvenlik güncelleştirmesi, MSMQ hizmetinin giriş verilerini ayrılmış arabelleğe geçirmeden önce doğrulama biçimini değiştirerek bu güvenlik açığını ortadan kaldırır. Bu güvenlik açığı hakkında daha fazla bilgi için, bir sonraki bölüm olan **Güvenlik Açığı Bilgileri** altında, ilgili güvenlik açığı girdisinin Sık Sorulan Sorular (SSS) alt bölümüne bakın.
...
**Bilinen Sorunlar.**  [Microsoft Knowledge Base Article 971032](http://support.microsoft.com/kb/971032/tr) dosyaları güvenlik güncellemeleri ile müşterimizin tecrübe kazanmasıonı sağlıyor. Makalemiz çözüm öneren konuları ele alıyor.
...
|---------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------|----------------------|-----------------------------------------------------------|
| [Microsoft Windows 2000 Service Pack 4](http://www.microsoft.com/downloads/details.aspx?familyid=8ed8bad7-2885-452c-9c34-3982cd498be8)                  | Önemli                    | Ayrıcalık Yükselmesi | [MS08-065](http://go.microsoft.com/fwlink/?linkid=128102) |
| [Windows XP Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=93490aa7-9985-4658-b0d7-88fb3f27ada0)                              | Önemli                    | Ayrıcalık Yükselmesi | [MS07-065](http://go.microsoft.com/fwlink/?linkid=94666)  |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=12e6be68-dc87-450e-927b-3c9b6873eb13)     | Önemli                    | Ayrıcalık Yükselmesi | Yok                                                       |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=52f59c56-2aba-4626-a90e-311e0e73c813)                     | Önemli                    | Ayrıcalık Yükselmesi | Yok                                                       |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=2f77ef7b-54f8-4260-b6a6-d62a0f85ef45)         | Önemli                    | Ayrıcalık Yükselmesi | Yok                                                       |
| [Itanium Tabanlı Sistemler için Windows Server 2003 SP2](http://www.microsoft.com/downloads/details.aspx?familyid=ad55c653-ee6b-4c92-b7f4-3923bb916546) | Önemli                    | Ayrıcalık Yükselmesi | Yok                                                       |
| [Windows Vista](http://www.microsoft.com/downloads/details.aspx?familyid=00afd94c-b483-4155-884f-b617acca6e7d)                                          | Önemli                    | Ayrıcalık Yükselmesi | Yok                                                       |
| [Windows Vista x64 Edition](http://www.microsoft.com/downloads/details.aspx?familyid=a0c698aa-a913-4981-8798-6bbb8cacfb86)                              | Önemli                    | Ayrıcalık Yükselmesi | Yok                                                       |
...
<th style="border:1px solid black;" >MSMQ'de Boş İşaretçi Güvenlik Açığı - CVE-2009-1922</th>
...
MSMQ'de Boş İşaretçi Güvenlik Açığı - CVE-2009-1922  
---------------------------------------------------
  
<span></span>
Windows Message Queuing hizmetinde (MSMQ), bir IOCTL isteğinin Message Queuing hizmetine ayrıştırılmasındaki belirli bir açık nedeniyle bir ayrıcalık yükselmesi güvenlik açığı bulunmaktadır. MSMQ hizmeti giriş verilerini arabelleğe geçirmeden önce düzgün denetlememektedir. Bu güvenlik açığından başarıyla yararlanan bir saldırgan rasgele kod yürütebilir ve etkilenen sistemin tüm denetimini ele geçirebilir. Saldırgan, program yükleyebilir; verileri görüntüleyebilir, değiştirebilir veya silebilir; tüm kullanıcı haklarına sahip olan yeni hesaplar oluşturabilir.
  
Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2009-1922](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1922).
  
#### MSMQ'de Boş İşaretçi Güvenlik Açığı - CVE-2009-1922 için Azaltıcı Etkenler
  
Azaltıcı etken, varolan bir durumda bulunan ve güvenlik açığından yararlanılmasının önem derecesini azaltabilecek bir ayar, genel yapılandırma ya da en iyi uygulama anlamına gelir. Sizin durumunuzda aşağıdaki azaltıcı etkenler işinize yarayabilir:
  
-   Message Queuing bileşeni varsayılan olarak etkilenen işletim sistemi sürümlerinde hiçbirinde yüklü değildir ve yalnızca yönetici ayrıcalıkları olan bir kullanıcı tarafından etkinleştirilebilir. Yalnızca Message Queuing bileşenini el ile etkinleştirmiş olan müşteriler bu sorundan etkilenebilir.  
...
#### MSMQ'de Boş İşaretçi Güvenlik Açığı - CVE-2009-1922 için Geçici Çözümler
...
-   **Message Queuing hizmetini devre dışı bırakma:**
    ...
    -   Etkileşimli olarak  
        ...
        4. **Message Queuing** hizmetini çift tıklatın.  
    ...
    -   Grup İlkesi ile:  
        ...
        **Not:** Windows Server 2003 Güvenlik Kılavuzu'nu da inceleyebilirsiniz. Bu kılavuz, hizmetlerin devre dışı bırakılması hakkında bilgi içerir.  
        Grup İlkesi hakkında daha fazla bilgi için, şu Microsoft Web sitesini ziyaret edin:  
        [Grup İlkesi Özelliği Ayarını Anlayabilmek için Kapsamlı Kılavuz](http://technet.microsoft.com/en-us/library/bb742376.aspx)  
...
#### MSMQ'de Boş İşaretçi Güvenlik Açığı - CVE-2009-1922 Hakkında SSS
...
MSMQ hizmeti kullanıcı modundan çekirdek moduna geçirilen verileri düzgün biçimde doğrulamadığı için, bir saldırganın LOCAL SYSTEM bağlamında rasgele kod yürütmesine olanak verir.
  
**Message Queuing nedir?**  
Microsoft Message Queuing teknolojisi, farklı zamanlarda çalışan uygulamaların, farklı yapılardaki ağlar ve geçici olarak çevrimdışı olan sistemler üzerinden iletişim kurmasına olanak sağlar. Uygulamalar, iletileri sıralara gönderir ve sıralardaki iletileri okur. Message Queuing, ileti tesliminin garanti edilmesini ve yönlendirme, güvenlik ve öncelik tabanlı iletilerin verimli şekilde gönderilip alınmasını sağlar. Zaman uyumlu olan ve olmayan ileti senaryoları için çözümler geliştirmek amacıyla kullanılabilir. Message Queuing hakkında daha fazla bilgi için Message Queuing ürün belgelerine bakın.
  
**Giriş Çıkış Denetimi (IOCTL) nedir?**  
Windows, aygıt sürücülerinin sağladığı hizmetlerin uygulamalar tarafından doğrudan istenebilmesini sağlar. Bu işlemin gerçekleştirildiği arabirime Giriş Çıkış Denetimi veya kısaca IOCTL adı verilir.
...
Saldırgan, MSMQ hizmetine özel hazırlanmış bir IOCTL isteği göndererek bu güvenlik açığından yararlanabilir. Bu güvenlik açığından başarıyla yararlanılması, etkilenen sisteme LOCAL SYSTEM bağlamı altında tam erişim sağlanmasına neden olabilir.
  
**Bu güvenlik açığından birincil derecede hangi sistemler etkileniyor?**  
Message Queuing hizmetinin çalıştırıldığı iş istasyonları ve sunucular bu güvenlik açığından birincil derecede etkilenir.
  
**Güncelleştirme ne yapıyor?**  
Güncelleştirme, MSMQ hizmetinin giriş verilerini ayrılmış arabelleğe geçirmeden önce doğrulama biçimini değiştirerek bu güvenlik açığını ortadan kaldırır.
...
| Windows Vista                                          | Evet     |  
| Windows Vista x64 Edition                              | Evet     |
...
**Windows** **Vista için Not** Microsoft Systems Management Server 2003 Service Pack 3, Windows Vista için destek içerir.
...
| **Dağıtım**                                  |                                                                                                                                                                       |  
| Kullanıcı araya girmeden yükleme             | Windows2000-kb971032-x86-trk /quiet                                                                                                                                   |  
| Yeniden başlatmadan yükleme                  | Windows2000-kb971032-x86-trk /norestart                                                                                                                               |  
| Güncelleştirme günlük dosyası                | kb971032.log                                                                                                                                                          |  
...
| **Kaldırma Bilgileri**                       | Denetim Masası'ndaki **Program Ekle veya Kaldır** aracını veya %Windir%\\$NTUninstallKB971032$\\Spuninst klasöründe bulunan Spuninst.exe yardımcı programını kullanın |  
| **Dosya Bilgileri**                          | Bkz: [Microsoft Bilgi Bankası makalesi 971032](http://support.microsoft.com/kb/971032)                                                                                |  
| **Kayıt Defteri Anahtarı Doğrulaması**       | HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows 2000\\SP5\\KB971032\\Filelist                                                                             |
...
#### Windows XP Service Pack 2 ve Windows XP Professional x64 Edition Service Pack 2
...
Windowsxp-kb971032-x86-trk /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
WindowsServer2003.WindowsXP-kb971032-x64-trk /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">Windows XP Service Pack 2 için:<br />
Windowsxp-kb971032-x86-trk /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition ve Windows XP Professional x64 Edition Service Pack 2 için:<br />
WindowsServer2003.WindowsXP-kb971032-x64-trk /norestart</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">Denetim Masası'ndaki <strong>Program Ekle veya Kaldır</strong> aracını veya %Windir%\$NTUninstallKB971032$\Spuninst klasöründe bulunan Spuninst.exe yardımcı programını kullanın</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Dosya Bilgileri</strong></td>
<td style="border:1px solid black;">Bkz: <a href="http://support.microsoft.com/kb/971032">Microsoft Bilgi Bankası makalesi 971032</a></td>
</tr>
<tr class="even">
...
Windowsserver2003-kb971032-x86-trk /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
Windowsserver2003-KB971032-ia64-trk /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen 32 bit sürümleri:<br />
Windowsserver2003-kb971032-x86-trk /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen x64 tabanlı sürümleri:<br />
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen Itanium tabanlı sürümleri:<br />
Windowsserver2003-KB971032-ia64-trk /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Güncelleştirme günlük dosyası</td>
<td style="border:1px solid black;">KB971032.log</td>
...
#### Windows Vista ve Window Vista x64 Edition
...
<tr class="odd">
<td style="border:1px solid black;">Kullanıcı araya girmeden yükleme</td>
<td style="border:1px solid black;">Windows Vista için:<br />
Windows6.0-KB971032-x86 /quiet<br />
<br />
Windows Vista x64 Edition için:<br />
...
-   [Positive Technologies Research Team](http://en.securitylab.ru/lab/) için çalışan Nikita Tarakanov, MSMQ'de Boş İşaretçi Güvenlik Açığı'nı (CVE-2009-1922) bildirdiği için
...
-   V1.1 (30 Haziran 2010): Microsoft Knowledge Base Article 971032 Bilinen Konular altına bulabilirsiniz.
