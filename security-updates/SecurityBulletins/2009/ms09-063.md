---
TOCTitle: 'MS09-063'
Title: 'Microsoft Güvenlik Bülteni MS09-063 - Kritik'
ms:assetid: 'ms09-063'
ms:contentKeyID: 61235524
ms:mtpsurl: 'https://technet.microsoft.com/tr-TR/library/ms09-063(v=Security.10)'
---

Security Bulletin

Microsoft Güvenlik Bülteni MS09-063 - Kritik
============================================

Aygıtlar için Web Hizmetleri API'sindeki Güvenlik Açığı Uzaktan Kod Yürütülmesine İzin Verebilir (973565)
---------------------------------------------------------------------------------------------------------
...
Bu güvenlik güncelleştirmesi Windows işletim sistemindeki Aygıtlar için Web Hizmetleri Uygulama Programı Arabirimi'nde (WSDAPI) özel olarak bildirilen bir güvenlik açığını giderir. Güvenlik açığı, etkilenen bir Windows sistemi özel hazırlanmış bir paket alırsa uzaktan kod yürütülmesine izin verebilir. Yalnızca yerel alt ağdaki saldırganlar bu güvenlik açığından yararlanabilir.

Bu güvenlik güncelleştirmesi, Windows Vista ve Windows Server 2008'in tüm desteklenen sürümleri için Kritik olarak derecelendirilmiştir. Daha fazla bilgi için, bu bölümdeki **Etkilenen ve Etkilenmeyen Yazılımlar** alt bölümüne bakın.

Güvenlik güncelleştirmesi, WSD iletilerindeki üstbilgilerin işlenme biçimini düzelterek bu güvenlik açığını giderir. Bu güvenlik açığı hakkında daha fazla bilgi için, bir sonraki bölüm olan **Güvenlik Açığı Bilgileri** altında, ilgili güvenlik açığı girdisinin Sık Sorulan Sorular (SSS) alt bölümüne bakın.
...
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------|----------------------|---------------------------------------------|
| [Windows Vista, Windows Vista Service Pack 1 ve Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=ebf0c294-cd99-445a-a741-78253e47189f)                                             | Uzaktan Kod Yürütme       | Kritik               | Yok                                         |
| [Windows Vista x64 Edition, Windows Vista x64 Edition Service Pack 1 ve Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=d9645fc9-f524-43f1-8b8c-94b3b4312158)         | Uzaktan Kod Yürütme       | Kritik               | Yok                                         |
| [32-bit sistemler için Windows Server 2008 ve 32-bit sistemler için Windows Server 2008 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=d6a60883-b103-459a-a91b-cd6ed946cefe)\*                 | Uzaktan Kod Yürütme       | Kritik               | Yok                                         |
| [x64 tabanlı sistemler için Windows Server 2008 ve x64 tabanlı sistemler için Windows Server 2008 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=3dde1587-42d3-438f-8344-696a5657b9b1)\*       | Uzaktan Kod Yürütme       | Kritik               | Yok                                         |
| [Itanium tabanlı sistemler için Windows Server 2008 ve Itanium tabanlı sistemler için Windows Server 2008 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=841a027f-22fa-42de-93b3-57a3fe92a1d3) | Uzaktan Kod Yürütme       | Kritik               | Yok                                         |
...
<span></span>
**Microsoft Aygıtlar için Web Hizmetleri nedir?**  
Aygıtlar için Web Hizmetleri, bir Windows istemcisinin kişisel dijital yardımcılar (PDA) gibi uzak aygıtların ve yazıcılar ya da kameralar gibi bilgisayar çevrebirimlerinin yanı sıra son kullanıcıya yönelik elektronik aygıtları ve bunlarla ilişkili hizmetleri ağ üzerinden bulmasına ve bu öğelere erişmesine olanak verir. Aygıt bulma, tanımlama ve denetleme işlevlerini destekler. Geliştiriciler, WSDAPI istemci proxy'leri ve aygıt ana bilgisayarları için karşılık gelen saplamalar oluşturabilirler.

Aygıtlar için Web Hizmetleri API'si (WSDAPI), Windows Vista ve Windows Server 2008 için Web Hizmetleri için Aygıtlar Profili'ni (DPWS) kullanır. DPWS, Windows istemcilerinin aygıtları kolayca bulabilmesi için Web Hizmetleri belirtimlerini kısıtlar. Bir aygıt bulunduğunda, istemci bu aygıtta barındırılan hizmetlerin açıklamasını alabilir ve bu hizmetleri kullanabilir.
...
<th style="border:1px solid black;" >Aygıtlar için Web Hizmetleri API'sinde Bellek Bozulması Güvenlik Açığı - CVE-2009-2512</th>
...
Aygıtlar için Web Hizmetleri API'sinde Bellek Bozulması Güvenlik Açığı - CVE-2009-2512  
--------------------------------------------------------------------------------------
  
<span></span>
Windows sistemlerindeki Aygıtlar için Web Hizmetleri API'sinde (WSDAPI) bir uzaktan kod yürütme güvenlik açığı bulunmaktadır. Bu güvenlik açığı, hizmetin özel hazırlanmış bir bilgiye sahip olan WSDAPI iletisini düzgün işlememesi nedeniyle oluşur. Bu açığı başarıyla kullanan bir saldırgan, etkilenen sistemin tüm denetimini ele geçirebilir.
  
Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2009-2512](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2512).
  
#### Aygıtlar için Web Hizmetleri API'sinde Bellek Bozulması Güvenlik Açığı - CVE-2009-2512 için Azaltıcı Etkenler
...
-   Yalnızca yerel alt ağdaki saldırganlar etkileşim olmadan bu güvenlik açığından yararlanabilir. Özel ağlarda bile, güvenlik açığından etkilenen hizmet yalnızca Windows güvenlik duvarındaki yerel alt ağdan gelen bağlantılardan etkilenir.
  
#### Aygıtlar için Web Hizmetleri API'sinde Bellek Bozulması Güvenlik Açığı - CVE-2009-2512 için Geçici Çözümler
  
Geçici çözüm, arka plandaki güvenlik açığını gidermeyen ama güvenlik açığı uygulanmadan önceki bilinen saldırı vektörlerinin engellenmesine yardımcı olan bir ayar veya yapılandırma değişikliği anlamına gelir. Microsoft aşağıdaki geçici çözümleri sınamıştır ve bir geçici çözümün işlevselliği azaltıp azaltmadığı ilgili açıklamada belirtilmektedir:
  
-   **Gelen trafik için 5357 ve 5358 numaralı TCP bağlantı noktaları ile giden trafik için 3702 numaralı UDP bağlantı noktasını engelleyin**
  
    Windows Güvenlik Duvarı'nı, gelen trafik için 5357 ve 5358 numaralı TCP bağlantı noktaları ile giden trafik için 3702 numaralı UDP bağlantı noktası engellenecek biçimde yapılandırın.
  
    Gelen trafiğin bağlantı noktaları engellendiğinde, kötü amaçlı uzak ana bilgisayarların etkilenen bileşene özel hazırlanmış üstbilgiler göndermesi önlenir. Kullanıcı alt ağdaki aygıtlara gözatmayı seçtiğinde, etkilenen bilgisayar, kötü amaçlı olabilecek uzak ana bilgisayarlarla bir bağlantı da oluşturabilir. Giden trafiğin bağlantı noktaları engellendiğinde, kötü amaçlı ana bilgisayarların bu senaryoda özel hazırlanmış yanıtlar göndermesi önlenir.
  
    Ancak kullanıcı yine de kötü amaçlı bir aygıtın URL'sini el ile girip, sistem güvenliğinin kötü amaçlı aygıt tarafından aşılmasına neden olabilir. Bu saldırı, önemli ölçüde sosyal mühendislik gerektirmektedir.
  
    **Geçici çözümün etkisi.** Bu geçici çözüm etkinleştirilmiş durumdayken aygıt bulma işlevi çalışmaz.
  
#### Aygıtlar için Web Hizmetleri API'sinde Bellek Bozulması Güvenlik Açığı - CVE-2009-2512 Hakkında SSS
...
Bu güvenlik açığı, hem istemcilerde hem de sunuculardaki WSD Uygulama Programı Arabirimi'nin (API) aldığı bir WSD iletisindeki belirli üstbilgileri düzgün doğrulamaması nedeniyle oluşur.
...
**Aygıtlar için Web Hizmetleri varsayılan olarak etkinleştirilmiş durumda mı?**  
Aygıtlar için Web Hizmetleri, çeşitli sistem bileşenleri tarafından kullanılabilen bir Uygulama Programı Arabirimi'dir (API). Bu API, tüm etkilenen platformlarda varsayılan olarak kullanılabilir. Ancak bu güvenlik açığından yalnızca, bir hizmet ya da uygulama bu API'yi kullanıyorsa ve 5357 ya da 5358 numaralı TCP bağlantı noktasını açarsa veya uzaktan aygıt bulma işlemi gerçekleştirirse, uzaktan ve kullanıcı etkileşimi olmadan yararlanılabilir. Bu durum, yazıcılar ve video aygıtları gibi desteklenen aygıtların ağ bağlantısının oluşturulduğu genel senaryolarda oluşabilir.
  
**Bir saldırgan bu güvenlik açığından yararlanarak neler yapabilir?**  
Bu güvenlik açığından başarıyla yararlanan bir saldırgan, etkilenen Windows sisteminin tüm denetimini ele geçirebilir. Saldırgan, program yükleyebilir; verileri görüntüleyebilir, değiştirebilir veya silebilir; tüm kullanıcı haklarına sahip olan yeni hesaplar oluşturabilir.
  
**Bir saldırgan güvenlik açığından nasıl yararlanabilir?**  
Saldırgan, etkilenen sistemde WSD 5357 ve 5358 numaralı TCP bağlantı noktalarına özel hazırlanmış bir ileti göndererek bu güvenlik açığından yararlanmaya çalışabilir. Alternatif olarak, saldırgan, Windows istemcisi tarafından aygıtların sorgulandığı bir WSD iletisine özel hazırlanmış bir yanıt gönderebilir. WSDAPI kullanan uygulamaların 5357 ve 5358 numaralı varsayılan TCP bağlantı noktaları dışındaki bağlantı noktalarını kullanabileceğini unutmayın.
  
**Bu güvenlik açığından birincil derecede hangi sistemler etkileniyor?**  
DPWS tabanlı aygıtlarla veya hizmetlerle ağ üzerinden iletişim kurmak için WSDAPI kullanan tüm sistemler bu güvenlik açığından etkilenir. Özellikle de Windows güvenlik duvarı yapılandırmaları için "ortak" dışındaki herhangi bir ayar belirlenmiş olan iş istasyonları risk altındadır.
  
**Güncelleştirme ne yapıyor?**  
Güncelleştirme, WSD iletisi üstbilgilerini doğru şekilde işleyerek bu güvenlik açığını giderir.
...
<td style="border:1px solid black;">Bkz: <a href="http://support.microsoft.com/kb/973565">Microsoft Bilgi Bankası makalesi 973565</a></td>
</tr>
<tr class="odd">
...
-   [Google Inc.](http://www.google.com/) için çalışan Neel Mehta, Aygıtlar için Web Hizmetleri API'sinde Bellek Bozulması Güvenlik Açığı'nı (CVE-2009-2512) bildirdiği için
