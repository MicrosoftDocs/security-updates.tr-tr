---
TOCTitle: 'MS09-024'
Title: 'Microsoft Güvenlik Bülteni MS09-024 - Kritik'
ms:assetid: 'ms09-024'
ms:contentKeyID: 61235485
ms:mtpsurl: 'https://technet.microsoft.com/tr-TR/library/ms09-024(v=Security.10)'
---

Security Bulletin

Microsoft Güvenlik Bülteni MS09-024 - Kritik
============================================

Microsoft Works Dönüştürücüleri'ndeki Güvenlik Açığı Uzaktan Kod Yürütülmesine İzin Verebilir (957632)
------------------------------------------------------------------------------------------------------

Yayım Tarihi: 9 Haziran 2009 Salı | Güncelleştirme Tarihi: 13 Ekim 2009 Salı
...
Bu güvenlik güncelleştirmesi Microsoft Office Word 2000'in desteklenen sürümleri için Kritik olarak derecelendirilmiştir. Güvenlik güncelleştirmesi ayrıca Microsoft Office Word 2002'nin, Microsoft Works 6–9 Dosya Dönüştürücüsü yüklü olarak Microsoft Office Word 2003'ün ve Microsoft Office Word 2007 Service Pack 1'in desteklenen sürümleri; Microsoft Works 8.5 ve Microsoft Works 9 için Önemli olarak derecelendirilmiştir. Daha fazla bilgi için, bu bölümdeki **Etkilenen ve Etkilenmeyen Yazılımlar** alt bölümüne bakın.

Güvenlik güncelleştirmesi, Works dosyalarının Microsoft Office tarafından açılma biçimini değiştirerek bu güvenlik açığını giderir. Bu güvenlik açığı hakkında daha fazla bilgi için, bir sonraki bölüm olan **Güvenlik Açığı Bilgileri** altında, ilgili güvenlik açığı girdisinin Sık Sorulan Sorular (SSS) alt bölümüne bakın.
...
<span></span>
**Bu bülten 13 Ekim 2009'da neden yeniden düzenlendi?**  
Microsoft bu bülteni, Works 9 güncelleştirmesine dil yerelleştirmeleri eklendiğini duyurmak üzere yeniden düzenledi. Hırvatça, Çekçe, Estonya dili, Letonca, Litvanya dili, Makedonca, Slovakça, Slovence ve Ukrayna dili eklenmiştir. Bu bülten ilk yayımlandığında Works 9 bu dillerde kullanılamıyordu. Özgün güncelleştirmeyi Works 9'a başarıyla uygulamış olan müşteriler bu düzenlemeden etkilenmezler.
...
**MS09-017'de aynı zamanda Microsoft Works 8.5 ve Microsoft Works 9'daki güvenlik açıkları da anlatılmaktadır. MS09-017 ile bu bülten (MS09-024) arasında nasıl bir ilişki vardır?**  
Microsoft Works 8.5 (KB967043) ve Microsoft Works 9 (KB967044) için bu bültende (MS09-024) açıklanan güvenlik güncelleştirmesi paketleri, [MS09-017](http://go.microsoft.com/fwlink/?linkid=141704)'de açıklanan güvenlik açıklarını da giderir. Microsoft Works 8.5 veya Microsoft Works 9 yüklemiş olan müşterilerin güncelleştirme paketlerini bir kez yüklemeleri yeterlidir.

**Microsoft Works 6-9 Dosya Dönüştürücüsü nedir?**  
Microsoft Works 6-9 Dönüştürücüsü, Works 6, 7, 8 ve 9 sürümleri tarafından desteklenen Works Sözcük İşlemci biçimindeki dosyaların Microsoft Office Word 2003 tarafından açılmasını, düzenlenmesini ve kaydedilmesini sağlar. Daha fazla bilgi için, bkz: [Microsoft Works 6–9 Dosya Dönüştürücüsü](http://www.microsoft.com/downloads/details.aspx?familyid=bf41401e-70fa-465d-ae2e-cf44dbf05297&displaylang=tr).
...
<th style="border:1px solid black;" >
Dosya Dönüştürücüsünde Arabellek Taşması Güvenlik Açığı - CVE-2009-1533
</th>
<th style="border:1px solid black;" >
Toplam Önem Derecesi
</th>
...
<span></span>
Windows için Works belge dönüştürücülerinin özel hazırlanmış Works dosyalarını işleme biçiminde bir uzaktan kod yürütme güvenlik açığı bulunmaktadır. Bu güvenlik açığı, bir kullanıcı özel hazırlanmış bir .wps dosyasını açarsa uzaktan kod yürütülmesine izin verebilir. Hesapları, sistemde az sayıda kullanıcı hakkıyla yapılandırılmış olan kullanıcılar, yönetici haklarıyla çalışan kullanıcılardan daha az etkilenebilir.

Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2009-1533](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1533).

#### Dosya Dönüştürücüsünde Arabellek Taşması Güvenlik Açığı - CVE-2009-1533 için Azaltıcı Etkenler

Azaltıcı etken, varolan bir durumda bulunan ve güvenlik açığından yararlanılmasının önem derecesini azaltabilecek bir ayar, genel yapılandırma ya da en iyi uygulama anlamına gelir. Sizin durumunuzda aşağıdaki azaltıcı etkenler işinize yarayabilir:

-   2007 Microsoft Office Sistemi Service Pack 2 bu güvenlik açığından etkilenmez.
-   Microsoft Office Word 2003 yalnızca Works dönüştürücüsü yüklüyse etkilenir. Daha fazla bilgi için, bkz: [Microsoft Works 6–9 Dosya Dönüştürücüsü](http://www.microsoft.com/downloads/details.aspx?familyid=bf41401e-70fa-465d-ae2e-cf44dbf05297&displaylang=tr).
...
#### Dosya Dönüştürücüsünde Arabellek Taşması Güvenlik Açığı - CVE-2009-1533 için Geçici Çözümler

Geçici çözüm, arka plandaki güvenlik açığını gidermeyen ama güvenlik açığı uygulanmadan önceki bilinen saldırı vektörlerinin engellenmesine yardımcı olan bir ayar veya yapılandırma değişikliği anlamına gelir. Microsoft aşağıdaki geçici çözümleri sınamıştır ve bir geçici çözümün işlevselliği azaltıp azaltmadığı ilgili açıklamada belirtilmektedir:

-   **Word 2000 ve Word 2002'de, Works 4.x dönüştürücüsüne erişimi kısıtlayarak dönüştürücüyü devre dışı bırakın**

    Yönetici etkilenen dönüştürücülere bir erişim denetim listesi uygulayarak, dönüştürücülerin bundan sonra Works ve Office tarafından yüklenmemelerini sağlayabilir. Böylece, bu saldırı vektörü kullanılarak bu güvenlik açığından yararlanılması etkin şekilde önlenmiş olur.
    ...
    **Geçici çözümün etkisi.** Geçici çözüm uygulandıktan sonra, kullanıcı Works 4.x belgelerini açamaz veya kaydedemez. Works 4.x belgesi açılmaya çalışıldığında, "Dosya bozuk görünüyor" iletisi döndürülür.

-   **Microsoft Works 6–9 Dosya Dönüştürücüsü** [**yüklü olarak Word 2003**](http://www.microsoft.com/downloads/details.aspx?familyid=bf41401e-70fa-465d-ae2e-cf44dbf05297&displaylang=tr) **ve Word 2007 için, Works 6-9 dönüştürücüsüne erişimi kısıtlayarak dönüştürücüyü devre dışı bırakın**
    ...
    **Geçici çözümün etkisi.** Geçici çözüm uygulandıktan sonra, kullanıcı Works 6-9 belgelerini açamaz veya kaydedemez. Works 6-9 belgesi açılmaya çalışıldığında, "Dosya bozuk görünüyor" iletisi döndürülür.

#### Dosya Dönüştürücüsünde Arabellek Taşması Güvenlik Açığı - CVE-2009-1533 Hakkında SSS
...
Bir kullanıcı özel hazırlanmış bir Works dosyasını açtığında, sistem belleğini bir saldırganın rasgele kod yürütmesine olanak verecek şekilde bozabilir.
...
Bu güvenlik açığı, kullanıcının özel hazırlanmış bir Works dosyasını uygulamanın etkilenen bir sürümünde açmasını gerektirir.

E-posta tabanlı saldırı senaryosunda, saldırgan kullanıcıya özel hazırlanmış bir Works dosyası gönderip bu dosyayı açmaya ikna ederek güvenlik açığından yararlanabilir.

Web tabanlı saldırı senaryosunda, bir Web sitesi bu güvenlik açığından yararlanmak için kullanılan bir Works dosyası içerebilir. Saldırganın, kullanıcıları genelde bir e-posta iletisindeki veya Instant Messenger iletisindeki kendi Web sitesine götüren bir bağlantıyı tıklatmaya ikna ederek onları bu Web sitesine çekmesi ve özel hazırlanmış Works dosyasını açmaya ikna etmesi gerekir.
...
Güncelleştirme, Works dosyalarının Microsoft Office tarafından açılma biçimini değiştirerek bu güvenlik açığını giderir.
...
| Microsoft Office 2007 Service Pack 1 | Evet     |
...
| Office 2003 Service Pack 3           | Evet    | Evet                        | Evet                       | Evet                       |
| Microsoft Office 2007 Service Pack 1 | Hayır   | Hayır                       | Evet                       | Evet                       |
...
<td style="border:1px solid black;">Office2000-kb957838-fullfile-trk /q:a</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">Office2000-kb957838-fullfile-trk /r:n</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">Bkz: <a href="http://support.microsoft.com/kb/957838">Microsoft Bilgi Bankası makalesi 957838</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;">Kullanıcı araya girmeden yükleme</td>
<td style="border:1px solid black;">OfficeXP-kb957646-fullfile-trk /q:a</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">OfficeXP-kb957646-fullfile-trk /r:n</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Güncelleştirme günlük dosyası</td>
<td style="border:1px solid black;">Uygulanamaz</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Dosya Bilgileri</strong></td>
<td style="border:1px solid black;">Bkz: <a href="http://support.microsoft.com/kb/957646">Microsoft Bilgi Bankası makalesi 957646</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Kayıt Defteri Anahtarı Doğrulaması</strong></td>
<td style="border:1px solid black;">Uygulanamaz</td>
...
#### Microsoft Works 6–9 Dosya Dönüştürücüsü yüklü olarak Word 2003 (tüm sürümler)
...
<tr class="even">
<td style="border:1px solid black;">Kullanıcı araya girmeden yükleme</td>
<td style="border:1px solid black;">Microsoft Works 6-9 Dosya Dönüştürücüsü yüklü olarak Microsoft Office Word 2003:<br />
Works9Conv_KB968326_tr-TR /passive</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">Microsoft Works 6-9 Dosya Dönüştürücüsü yüklü olarak Microsoft Office Word 2003:<br />
Works9Conv_KB968326_tr-TR /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Güncelleştirme günlük dosyası</td>
<td style="border:1px solid black;">Uygulanamaz</td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>Dosya Bilgileri</strong></td>
<td style="border:1px solid black;">Bkz: <a href="http://support.microsoft.com/kb/968326">Microsoft Bilgi Bankası makalesi 968326</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Kayıt Defteri Anahtarı Doğrulaması</strong></td>
<td style="border:1px solid black;">Uygulanamaz</td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>Dosya Bilgileri</strong></td>
<td style="border:1px solid black;">Bkz: <a href="http://support.microsoft.com/kb/969559">Microsoft Bilgi Bankası makalesi 969559</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Kayıt Defteri Anahtarı Doğrulaması</strong></td>
<td style="border:1px solid black;">Uygulanamaz</td>
...
-   [NGS Software](http://www.ngssoftware.com/) için çalışan Shaun Colley ve [Fourteenforty Research Institute, Inc.](http://www.fourteenforty.jp/) için çalışan Yuji Ukai, Dosya Dönüştürücüsünde Arabellek Taşması Güvenlik Açığı'nı (CVE-2009-1533) bildirdikleri için
...
-   V1.1 (13 Ekim 2009): Bülten, Works 9 güncelleştirmesine dil yerelleştirmeleri eklendiğini duyurmak üzere yeniden düzenlendi. Özgün güncelleştirmeyi Works 9'a başarıyla uygulamış olan müşteriler bu düzenlemeden etkilenmezler.
