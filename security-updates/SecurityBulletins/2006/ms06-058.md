---
TOCTitle: 'MS06-058'
Title: 'Microsoft Güvenlik Bülteni MS06-058 - Kritik'
ms:assetid: 'ms06-058'
ms:contentKeyID: 61235293
ms:mtpsurl: 'https://technet.microsoft.com/tr-TR/library/ms06-058(v=Security.10)'
---

Security Bulletin

Microsoft Güvenlik Bülteni MS06-058 - Kritik
============================================

Microsoft PowerPoint'teki Güvenlik Açıkları Uzaktan Kod Yürütülmesine İzin Verebilir (924163)
---------------------------------------------------------------------------------------------

Yayım Tarihi: 10 Ekim 2006 Salı | Güncelleştirme Tarihi: 21 Şubat 2007 Çarşamba

**Sürüm:** 1.1

#### Özet

**Bu Belge Kimler İçindir:** Microsoft PowerPoint kullanan müşteriler
...
-   Microsoft Office 2000 Service Pack 3 — [Güncelleştirmeyi karşıdan yükle (KB923093)](http://www.microsoft.com/downloads/details.aspx?familyid=14a61fda-bfe2-47ca-8313-40b772359994)
    -   Microsoft PowerPoint 2000
-   Microsoft Office XP Service Pack 3 — [Güncelleştirmeyi karşıdan yükle (KB923092)](http://www.microsoft.com/downloads/details.aspx?familyid=0fbd66fb-28bb-4587-9425-ad4a3f10651d)
    -   Microsoft PowerPoint 2002
-   Microsoft Office 2003 Service Pack 1 veya Service Pack 2 — [Güncelleştirmeyi karşıdan yükle (KB923091)](http://www.microsoft.com/downloads/details.aspx?familyid=d0e30f77-b48f-4b8b-a6fa-105a354b1a4e)
    -   Microsoft Office PowerPoint 2003
-   Mac için Microsoft Office 2004
    -   Mac için Microsoft PowerPoint 2004 - [Güncelleştirmeyi karşıdan yükle (KB924999)](http://www.microsoft.com/mac/)
-   Mac için Microsoft Office v. X
    -   Mac için Microsoft PowerPoint v. X - [Güncelleştirmeyi karşıdan yükle (KB924998)](http://www.microsoft.com/mac/)
...
PowerPoint'in güvenlik açığı bulunan sürümlerinde, kullanıcı yönetimsel haklarla oturum açtıysa, bu güvenlik açıklarından başarıyla yararlanan bir saldırgan sistemin denetimini tümüyle ele geçirebilir. Saldırgan, program yükleyebilir; verileri görüntüleyebilir, değiştirebilir veya silebilir; tüm kullanıcı haklarına sahip olan yeni hesaplar oluşturabilir. Hesapları, sistemde az sayıda kullanıcı hakkıyla yapılandırılmış olan kullanıcılar, yönetici haklarıyla çalışan kullanıcılardan daha az etkilenebilir.

Müşterilerin güncelleştirmeyi hemen uygulaması önerilir.

**Önem Dereceleri ve Güvenlik Açığı Tanımlayıcıları:**

| Güvenlik Açığı Tanımlayıcıları                                                                                                                                           | Güvenlik Açığının Etkisi | Microsoft PowerPoint 2000 | Microsoft PowerPoint 2002 | Microsoft Office PowerPoint 2003 | Mac için Microsoft PowerPoint 2004 ve Mac için PowerPoint v.X |
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------|---------------------------|---------------------------|----------------------------------|---------------------------------------------------------------|
| PowerPoint'te Hatalı Biçimlendirilmiş Nesne İşaretçisi Güvenlik Açığı - [CVE-2006-3435](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3435)                 | Uzaktan Kod Yürütme      | Yok                       | Yok                       | Önemli                           | Yok                                                           |
| PowerPoint'te Hatalı Biçimlendirilmiş Veri Kaydı Güvenlik Açığı - [CVE-2006-3876](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3876)                       | Uzaktan Kod Yürütme      | Kritik                    | Önemli                    | Önemli                           | Önemli                                                        |
...
| PowerPoint'te Hatalı Biçimlendirilmiş Kayıt Güvenlik Açığı - [CVE-2006-4694](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-4694)                            | Uzaktan Kod Yürütme      | Kritik                    | Önemli                    | Önemli                           | Önemli                                                        |
...
| Bülten Kimliği                                                          | Microsoft PowerPoint 2000 | Microsoft PowerPoint 2002 | Microsoft Office PowerPoint 2003 | Mac için Microsoft PowerPoint 2004 ve Mac için PowerPoint v.X |
|-------------------------------------------------------------------------|---------------------------|---------------------------|----------------------------------|---------------------------------------------------------------|
| [**MS06-028**](http://technet.microsoft.com/security/bulletin/ms06-028) | Değişti                   | Değişti                   | Değişti                          | Değişti                                                       |
...
|------------------------------------|------------|----------|
| Microsoft PowerPoint 2000          | Evet       | Hayır    |
| Microsoft PowerPoint 2002          | Evet       | Evet     |
| Microsoft Office PowerPoint 2003   | Evet       | Evet     |
| Mac için Microsoft PowerPoint 2004 | Hayır      | Hayır    |
| Mac için Microsoft PowerPoint v. X | Hayır      | Hayır    |
...
|------------------------------------|---------|----------|
| Microsoft PowerPoint 2000          | Evet    | Evet     |
| Microsoft PowerPoint 2002          | Evet    | Evet     |
| Microsoft Office PowerPoint 2003   | Evet    | Evet     |
| Mac için Microsoft PowerPoint 2004 | Hayır   | Hayır    |
| Mac için Microsoft PowerPoint v. X | Hayır   | Hayır    |
...
<span></span>
#### PowerPoint'te Hatalı Biçimlendirilmiş Nesne İşaretçisi Güvenlik Açığı - CVE-2006-3435:

PowerPoint'te uzaktan kod yürütülmesine neden olabilecek bir güvenlik açığı bulunmaktadır. PowerPoint hatalı biçimlendirilmiş nesne işaretçisi içeren bir dosyayı ayrıştırdığında saldırgan bu güvenlik açığından yararlanabilir.
...
#### PowerPoint'te Hatalı Biçimlendirilmiş Nesne İşaretçisi Güvenlik Açığı - CVE-2006-3435 için Azaltıcı Etkenler:
...
#### PowerPoint'te Hatalı Biçimlendirilmiş Nesne İşaretçisi Güvenlik Açığı - CVE-2006-3435 için Geçici Çözümler:
...
#### PowerPoint'te Hatalı Biçimlendirilmiş Nesne İşaretçisi Güvenlik Açığı - CVE-2006-3435 Hakkında SSS:
...
PowerPoint bir .ppt dosyasının içeriğini işlerken yeterli veri doğrulaması gerçekleştirmez. PowerPoint özel hazırlanmış bir PowerPoint dosyasını açıp hatalı biçimlendirilmiş bir nesneyi ayrıştırdığında, sistem belleğini bir saldırganın rasgele kod yürütmesine olanak verecek şekilde bozabilir.
...
Güncelleştirme, PowerPoint'in dosyayı ayrıştırmak ve nesne işaretçisini ayrılmış arabelleğe geçirmeden önce nesne işaretçisini doğrulamak için kullandığı yöntemi değiştirerek bu güvenlik açığını ortadan kaldırır.
...
#### PowerPoint'te Hatalı Biçimlendirilmiş Veri Kaydı Güvenlik Açığı - CVE-2006-3876:

PowerPoint'te uzaktan kod yürütülmesine neden olabilecek bir güvenlik açığı bulunmaktadır. PowerPoint hatalı biçimlendirilmiş Veri kaydı içeren bir dosyayı ayrıştırdığında saldırgan bu güvenlik açığından yararlanabilir.

Kullanıcı yönetimsel haklarla oturum açtıysa, bu güvenlik açığından başarıyla yararlanan bir saldırgan etkilenen sistemin denetimini tümüyle ele geçirebilir. Saldırgan, program yükleyebilir; verileri görüntüleyebilir, değiştirebilir veya silebilir; tüm kullanıcı haklarına sahip olan yeni hesaplar oluşturabilir. Hesapları, sistemde az sayıda kullanıcı hakkıyla yapılandırılmış olan kullanıcılar, yönetici haklarıyla çalışan kullanıcılardan daha az etkilenebilir.

#### PowerPoint'te Hatalı Biçimlendirilmiş Veri Kaydı Güvenlik Açığı - CVE-2006-3876 için Azaltıcı Etkenler:
...
#### PowerPoint'te Hatalı Biçimlendirilmiş Veri Kaydı Güvenlik Açığı - CVE-2006-3876 için Geçici Çözümler:

-   Güvenilmeyen kaynaklardan gelen veya güvenilen kaynaklardan beklemediğiniz halde gelen Microsoft PowerPoint dosyalarını açmayın ve kaydetmeyin. Kullanıcı özel hazırlanmış bir dosyayı açtığında bu güvenlik açığından yararlanılabilir.

#### PowerPoint'te Hatalı Biçimlendirilmiş Veri Kaydı Güvenlik Açığı - CVE-2006-3876 Hakkında SSS:
...
**Güvenlik açığına ne neden olmaktadır?**  
PowerPoint bir .ppt dosyasının içeriğini işlerken yeterli veri doğrulaması gerçekleştirmez. PowerPoint özel hazırlanmış bir PowerPoint dosyasını açıp hatalı biçimlendirilmiş bir veri kaydını ayrıştırdığında, sistem belleğini bir saldırganın rasgele kod yürütmesine olanak verecek şekilde bozabilir.
...
**Güncelleştirme ne yapıyor?**  
Güncelleştirme, PowerPoint'in dosyayı ayrıştırmak ve bir tarih kaydını ayrılmış arabelleğe geçirmeden önce tarih kaydının uzunluğunu doğrulamak için kullandığı yöntemi değiştirerek bu güvenlik açığını ortadan kaldırır.
...
#### PowerPoint'te Hatalı Biçimlendirilmiş Kayıt Nedeniyle Bellek Bozulması Güvenlik Açığı - CVE-2006-3877 Hakkında SSS:
...
#### PowerPoint'te Hatalı Biçimlendirilmiş Kayıt Güvenlik Açığı - CVE-2006-4694:

PowerPoint'te bir uzaktan kod yürütme güvenlik açığı bulunmaktadır ve PowerPoint özel hazırlanmış bir dosyayı açtığında bu güvenlik açığından yararlanılabilir. Bu tür bir dosya bir e-posta ekinde bulunabilir veya kötü amaçlı bir Web sitesi tarafından barındırılabilir. Saldırgan, uzaktan kod yürütülmesine olanak sağlayabilecek özel hazırlanmış bir PowerPoint dosyası oluşturarak güvenlik açığından yararlanabilir.

Kullanıcı yönetimsel haklarla oturum açtıysa, bu güvenlik açığından başarıyla yararlanan bir saldırgan etkilenen sistemin denetimini tümüyle ele geçirebilir. Saldırgan, program yükleyebilir; verileri görüntüleyebilir, değiştirebilir veya silebilir; tüm kullanıcı haklarına sahip olan yeni hesaplar oluşturabilir. Hesapları, sistemde az sayıda kullanıcı hakkıyla yapılandırılmış olan kullanıcılar, yönetici haklarıyla çalışan kullanıcılardan daha az etkilenebilir.

#### PowerPoint'te Hatalı Biçimlendirilmiş Kayıt Güvenlik Açığı - CVE-2006-4694 için Azaltıcı Etkenler:
...
#### PowerPoint'te Hatalı Biçimlendirilmiş Kayıt Güvenlik Açığı - CVE-2006-4694 için Geçici Çözümler:

-   Güvenilmeyen kaynaklardan gelen veya güvenilen kaynaklardan beklemediğiniz halde gelen Microsoft PowerPoint dosyalarını açmayın ve kaydetmeyin. Kullanıcı özel hazırlanmış bir dosyayı açtığında bu güvenlik açığından yararlanılabilir.

#### PowerPoint'te Hatalı Biçimlendirilmiş Kayıt Güvenlik Açığı - CVE-2006-4694 Hakkında SSS:
...
**Güvenlik açığına ne neden olmaktadır?**  
Güvenlik açığına, PowerPoint'in özel hazırlanmış bir PowerPoint dosyasını açma biçimindeki bir hata neden olur. Bu hata, PowerPoint yertutucu verilerini ayrıştırırken belleğe amaçlanan bölgeler dışında erişilmesine yol açabilir.
...
1.  [PowerPoint 2000 güvenlik güncelleştirmesini karşıdan yükleyin.](http://download.microsoft.com/download/3/6/d/36d75630-5526-404e-aea4-24fb5c8cce1f/office2000-kb923090-fullfile-trk.exe)
...
|--------------|--------------|-------------|------|-----------|
| Powerpnt.exe | 9.00.00.8952 | 27 Eyl 2006 | 5:08 | 4.259.892 |
...
-   Office XP Service Pack 3 (SP3) yüklenmiş olmalıdır. Bu güncelleştirmeyi yüklemeden önce [Office XP SP3](http://www.microsoft.com/downloads/details.aspx?familyid=85af7bfd-6f69-4289-8bd1-eb966bcdfb5e)'ü yükleyin.
...
1.  [PowerPoint 2002 güvenlik güncelleştirmesini karşıdan yükleyin](http://download.microsoft.com/download/2/c/5/2c56edfe-dfd3-4ec1-86c4-2f5c57879076/officexp-kb923092-fullfile-trk.exe).
2.  **Bu programı diske kaydet**'i tıklatın ve **Tamam**'ı tıklatın.
3.  **Kaydet**'i tıklatın.
4.  Windows Gezgini'ni kullanarak, kaydedilen dosyayı içeren klasörü bulun ve dosyayı çift tıklatın.
5.  Güncelleştirmeyi yüklemeniz istenirse **Evet**'i tıklatın.
...
| Dosya Adı    | Sürüm           | Tarih       | Saat | Boyut     |
|--------------|-----------------|-------------|------|-----------|
| Powerpnt.exe | 10.00.6819.0000 | 28 Eyl 2006 | 2:05 | 6.093.584 |
...
1.  [PowerPoint 2003 güvenlik güncelleştirmesini karşıdan yükleyin](http://download.microsoft.com/download/b/a/d/bada0a94-ed11-48ae-b2e2-1d52f6796370/office2003-kb923088-fullfile-trk.exe).
2.  **Bu programı diske kaydet**'i tıklatın ve **Tamam**'ı tıklatın.
3.  **Kaydet**'i tıklatın.
4.  Windows Gezgini'ni kullanarak, kaydedilen dosyayı içeren klasörü bulun ve dosyayı çift tıklatın.
5.  Güncelleştirmeyi yüklemeniz istenirse **Evet**'i tıklatın.
...
| Dosya Adı    | Sürüm           | Tarih       | Saat | Boyut     |
|--------------|-----------------|-------------|------|-----------|
| Powerpnt.exe | 11.00.8110.0000 | 27 Eyl 2006 | 1:27 | 6.396.688 |
...
-   [Zero Day Initiative](http://www.zerodayinitiative.com/) ve [TippingPoint](http://tippingpoint.com) için çalışan Arnaud Dovi, PowerPoint'te Hatalı Biçimlendirilmiş Nesne İşaretçisi Güvenlik Açığı'nı - [CVE-2006-3435](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3435) bildirdiği için.
-   [Fortinet Inc.](http://www.fortinet.com/) için çalışan Dejun Meng, PowerPoint'te Hatalı Biçimlendirilmiş Veri Kaydı Güvenlik Açığı'nı - [CVE-2006-3876](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3876) bildirdiği için.
-   [VigilantMinds Inc.](http://www.vigilantminds.com) için çalışan Chris Ries, PowerPoint'te Hatalı Biçimlendirilmiş Kayıt Nedeniyle Bellek Bozulması Güvenlik Açığı'nı - [CVE-2006-3877](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3877) bildirdiği için.
...
-   V1.1 (21 Şubat 2007): Bülten güncelleştirildi: CVE-2006-3877'ye yönelik yeni araştırmalar, güncelleştirmenin güvenlik açığını etkilenen sistemlerden etkin biçimde kaldırmadığını göstermiştir. Microsoft Güvenlik Bülteni MS07-015, CVE-2006-3877'de açıklanan açığı gidermek için yayımlanmıştır ve müşteriler bu bültendeki güncelleştirmeleri hemen uygulamalıdır.
