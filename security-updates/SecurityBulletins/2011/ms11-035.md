---
TOCTitle: 'MS11-035'
Title: 'Microsoft Güvenlik Bülteni MS11-035 - Kritik'
ms:assetid: 'ms11-035'
ms:contentKeyID: 61235676
ms:mtpsurl: 'https://technet.microsoft.com/tr-TR/library/ms11-035(v=Security.10)'
---

Security Bulletin

Microsoft Güvenlik Bülteni MS11-035 - Kritik
============================================

WINS'deki Güvenlik Açığı Uzaktan Kod Yürütülmesine İzin Verebilir (2524426)
---------------------------------------------------------------------------

Yayım Tarihi: 10 Mayıs 2011 Salı
...
Bu güvenlik güncelleştirmesi Windows Server 2003, Windows Server 2008 (Itanium dışında) ve Windows Server 2008 R2'nin (Itanium dışında) desteklenen sürümlerini çalıştıran ve WINS'nin yüklü olduğu sunucular için Kritik olarak derecelendirilmiştir. Daha fazla bilgi için, bu bölümdeki **Etkilenen ve Etkilenmeyen Yazılımlar** alt bölümüne bakın.

Güvenlik güncelleştirmesi, arabellekleri parametre olarak geçirirken oluşan bir mantık hatasını düzelterek bu güvenlik açığını giderir. Bu güvenlik açığı hakkında daha fazla bilgi için, bir sonraki bölüm olan **Güvenlik Açığı Bilgileri** altında, ilgili güvenlik açığı girdisinin Sık Sorulan Sorular (SSS) alt bölümüne bakın.
...
**Bilinen Sorunlar.** [Microsoft Bilgi Bankası makalesi 2524426](http://support.microsoft.com/kb/2524426), bu güvenlik güncelleştirmesini yükleyen müşterilerin karşılaşabileceği bilinen sorunları belgelemektedir. Bu makale ayrıca, bu sorunlar için önerilen çözümleri de içermektedir.
...
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------|----------------------|-----------------------------------------------------------|
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=0d289146-8470-45dd-a886-d1b35a2c6d4b)                                                                                      | Uzaktan Kod Yürütme       | Kritik               | [MS09-039](http://go.microsoft.com/fwlink/?linkid=155974) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=0d3e85a9-42ff-447b-ab8c-095a1c0b224c)                                                                          | Uzaktan Kod Yürütme       | Kritik               | [MS09-039](http://go.microsoft.com/fwlink/?linkid=155974) |
| [Itanium tabanlı sistemler için Windows Server 2003 SP2](http://www.microsoft.com/downloads/details.aspx?familyid=4c388fe8-883a-4118-a7ff-50f1e9d0a071)                                                                  | Uzaktan Kod Yürütme       | Kritik               | [MS09-039](http://go.microsoft.com/fwlink/?linkid=155974) |
| [32-bit sistemler için Windows Server 2008 ve 32-bit sistemler için Windows Server 2008 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=9019a3ff-d953-4b0b-8c7a-05aa9cf65c92)\*                 | Uzaktan Kod Yürütme       | Kritik               | Yok                                                       |
| [x64 tabanlı sistemler için Windows Server 2008 ve x64 tabanlı sistemler için Windows Server 2008 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=841130fa-4522-4079-b7eb-f8466ac3ef12)\*       | Uzaktan Kod Yürütme       | Kritik               | Yok                                                       |
| [x64 tabanlı sistemler için Windows Server 2008 R2 ve x64 tabanlı sistemler için Windows Server 2008 R2 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=8732b41e-2f25-4ee1-a8b7-a8b8b9e22d08)\* | Uzaktan Kod Yürütme       | Kritik               | Yok                                                       |
...
Güncelleştirme yalnızca WINS hizmeti Etkilenen Yazılımlar tablosunda listelenen bir işletim sistemine yüklenmiş durumdaysa yüklenebilir. WINS bu işletim sistemlerinde varsayılan olarak yüklenmiş olmadığından, WINS yüklü değilse güncelleştirme sunulmaz.
...
<th style="border:1px solid black;" >WINS Hizmeti'nde Yanıtın Başarısız Olması Güvenlik Açığı - CVE-2011-1248</th>
...
WINS Hizmeti'nde Yanıtın Başarısız Olması Güvenlik Açığı - CVE-2011-1248  
------------------------------------------------------------------------
  
<span></span>
Windows Internet Ad Hizmeti'ne (WINS) gönderilen özel hazırlanmış WINS ağ paketlerinin içinde bulunan veri yapılarının yeterli düzeyde doğrulanmaması nedeniyle bir uzaktan kod yürütme güvenlik açığı bulunmaktadır.
  
Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2011-1248](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1248).
  
#### WINS Hizmeti'nde Yanıtın Başarısız Olması Güvenlik Açığı - CVE-2011-1248 için Azaltıcı Etkenler
  
Azaltıcı etken, varolan bir durumda bulunan ve güvenlik açığından yararlanılmasının önem derecesini azaltabilecek bir ayar, genel yapılandırma ya da en iyi uygulama anlamına gelir. Sizin durumunuzda aşağıdaki azaltıcı etkenler işinize yarayabilir:
  
-   WINS varsayılan olarak, etkilenen işletim sistemlerine yüklenmemektedir. Bu bileşeni yalnızca el ile yüklemiş olan müşteriler bu sorundan etkilenir.
  
#### WINS Hizmeti'nde Yanıtın Başarısız Olması Güvenlik Açığı - CVE-2011-1248 için Geçici Çözümler
...
#### WINS Hizmeti'nde Yanıtın Başarısız Olması Güvenlik Açığı - CVE-2011-1248 Hakkında SSS
...
WINS'nin bir yuva gönderme özel durumunu işlemesi sırasında oluşan mantık hatası nedeniyle, kullanıcı tarafından sağlanan belirli değerler yığın çerçevesi içinde kalır ve başka bir bağlamda yeniden kullanılır. Bu güvenlik açığından başarıyla yararlanan bir uzak saldırgan, belleği uzaktan kod yürütülebilecek şekilde bozabilir. Böylece saldırgan Windows Server 2003 için Sistem bağlamında veya Windows Server 2008 ve Windows Server 2008 R2 için Yerel Hizmet bağlamında sistemin denetimini ele geçirebilir.
  
**WINS nedir?**  
Windows Internet Ad Hizmeti (WINS) özellikle TCP/IP üzerinden NetBIOS (NetBT) desteği sağlayacak şekilde tasarlanmıştır. WINS, kullanıcıların NetBIOS adları olan kaynaklara eriştiği tüm ortamlarda gereklidir. Bu tür bir ağda WINS hizmetini kullanmıyorsanız, LMHOSTS dosyalarını kullanmadığınız sürece, NetBIOS adını kullanarak bir uzak ağ kaynağına bağlanamazsınız ve dosya ve yazıcı paylaşımı bağlantıları oluşturamayabilirsiniz. Daha fazla bilgi için, [WINS Nedir?](http://technet.microsoft.com/en-us/library/cc784180.aspx) adlı TechNet makalesine bakın.
  
**Bir saldırgan bu güvenlik açığından yararlanarak neler yapabilir?**  
Bu güvenlik açığından başarıyla yararlanan bir saldırgan rasgele kod çalıştırabilir. Saldırgan, program yükleyebilir; verileri görüntüleyebilir, değiştirebilir veya silebilir; WINS hizmetinin izinleriyle yeni hesaplar oluşturabilir.
  
**Bir saldırgan güvenlik açığından nasıl yararlanabilir?**  
Saldırgan, özel hazırlanmış paketler oluşturmak ve bu paketleri etkilenen WINS sistemine göndermek yoluyla bu açıktan yararlanabilir.
  
**Bu güvenlik açığından birincil derecede hangi sistemler etkileniyor?**  
Windows Server 2003, Windows Server 2008 veya Windows Server 2008 R2 üzerinde çalıştırılan WINS sunucuları bu güvenlik açığından birincil derecede etkilenir.
  
**Güncelleştirme ne yapıyor?**  
Güncelleştirme, arabellekleri parametre olarak geçirirken işlevler arasında sözleşme ihlaline neden olan mantık hatasını düzeltir.
...
WindowsServer2003-KB2524426-x86-trk.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen x64 tabanlı sürümleri:<br />
WindowsServer2003.WindowsXP-KB2524426-x64-trk.exe /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen Itanium tabanlı sürümleri:<br />
WindowsServer2003-KB2524426-ia64-trk.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen 32 bit sürümleri:<br />
WindowsServer2003-KB2524426-x86-trk.exe /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen x64 tabanlı sürümleri:<br />
WindowsServer2003.WindowsXP-KB2524426-x64-trk.exe /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen Itanium tabanlı sürümleri:<br />
WindowsServer2003-KB2524426-ia64-trk.exe /norestart</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">Denetim Masası'ndaki <strong>Program Ekle veya Kaldır</strong> aracını veya %Windir%\$NTUninstallKB2524426$\Spuninst klasöründe bulunan Spuninst.exe yardımcı programını kullanın</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Dosya Bilgileri</strong></td>
<td style="border:1px solid black;">Bkz: <a href="http://support.microsoft.com/kb/2524426">Microsoft Bilgi Bankası makalesi 2524426</a></td>
</tr>
<tr class="even">
...
-   Luigi Auriemma, [TippingPoint](http://www.tippingpoint.com/) bünyesindeki [Zero Day Initiative](http://www.zerodayinitiative.com/) ile birlikte çalışarak WINS Hizmeti'nde Yanıtın Başarısız Olması Güvenlik Açığı'nı (CVE-2011-1248) bildirdikleri için
