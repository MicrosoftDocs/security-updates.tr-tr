---
TOCTitle: 'MS11-096'
Title: 'Microsoft Güvenlik Bülteni MS11-096 - Önemli'
ms:assetid: 'ms11-096'
ms:contentKeyID: 61235737
ms:mtpsurl: 'https://technet.microsoft.com/tr-TR/library/ms11-096(v=Security.10)'
---

Security Bulletin

Microsoft Güvenlik Bülteni MS11-096 - Önemli
============================================

Microsoft Excel'deki Güvenlik Açığı Uzaktan Kod Yürütülmesine İzin Verebilir (2640241)
--------------------------------------------------------------------------------------
...
Bu güvenlik güncelleştirmesi Microsoft Excel 2003 ve Mac için Microsoft Office 2004'ün tüm desteklenen sürümleri için Önemli olarak derecelendirilmiştir. Daha fazla bilgi için, bu bölümdeki **Etkilenen ve Etkilenmeyen Yazılımlar** alt bölümüne bakın.

Güvenlik güncelleştirmesi, Microsoft Excel'in bellekteki nesneleri yönetme biçimini düzelterek bu güvenlik açığını giderir. Bu güvenlik açıkları hakkında daha fazla bilgi için, bir sonraki bölüm olan **Güvenlik Açığı Bilgileri** altında, ilgili güvenlik açığı girdisinin Sık Sorulan Sorular (SSS) alt bölümüne bakın.
...
**Bilinen Sorunlar.**[Microsoft Bilgi Bankası makalesi 2640241](http://support.microsoft.com/kb/2640241), bu güvenlik güncelleştirmesini yükleyen müşterilerin karşılaşabileceği bilinen sorunları belgelemektedir. Bu makale ayrıca, bu sorunlar için önerilen çözümleri de içermektedir.
...
|------------------------------------------------------------------------------------------------------|
| Microsoft Excel 2007 Service Pack 2 ve Microsoft Excel 2007 Service Pack 3                           |
...
Microsoft Excel 2003'te Office Dosya Doğrulaması özelliği etkinleştirildiğinde, CVE-2011-3403'te açıklanan güvenlik açıklarından yararlanmak için kullanılabilecek şekilde özel olarak hazırlanmış dosyalar otomatik olarak açılmaz; bunun yerine varsayılan olarak, kullanıcıya bu tür bir dosyayı açmak isteyip istemediği sorulur. Güvenlik açıklarından yararlanılabilmesi için öncelikle kullanıcının uyarıyı tıklatarak dosyayı açması gerekir. Microsoft Excel 2003'teki Office Dosya Doğrulaması hakkında daha fazla bilgi için, bkz. [Microsoft Güvenlik Danışma Belgesi 2501584](http://www.microsoft.com/technet/security/advisory/2501584.mspx).

**Excel 2003'te dosya doğrulamasını geçemeyen dosyaların açılmasını devre dışı bırakmanın faydası nedir?**  
[Microsoft Bilgi Bankası makalesi 2501584](http://support.microsoft.com/kb/2501584)'te sunulan "Excel 2003 ve 2003'te belgelerin açılmasını devre dışı bırakma" adlı **Microsoft Düzelt** çözümü, Excel 2007'de şüpheli dosyaların açılmasına Office Dosya Doğrulaması tarafından izin verilmeyecek şekilde ayarlayarak CVE-2011-3403'te açıklanan güvenlik açıklarından yararlanmak için kullanılabilecek saldırı vektörlerini engeller.
...
<th style="border:1px solid black;" >
Kayıt Belleğinin Bozulması Güvenlik Açığı - CVE-2011-3403
</th>
<th style="border:1px solid black;" >
Toplam Önem Derecesi
</th>
...
Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2011-3403](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-3403).

#### Kayıt Belleğinin Bozulması Güvenlik Açığı – CVE-2011-3403 için Azaltıcı Etkenler
...
#### Kayıt Belleğinin Bozulması Güvenlik Açığı – CVE-2011-3403 için Geçici Çözümler
...
#### Kayıt Belleğinin Bozulması Güvenlik Açığı – CVE-2011-3403 Hakkında SSS
...
<td style="border:1px solid black;">Office2003-kb2596954-fullfile-trk.exe /q:a</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">Office2003-kb2596954-fullfile-trk.exe /r:n</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">Bkz: <a href="http://support.microsoft.com/kb/2596954">Microsoft Bilgi Bankası Makalesi 2596954</a></td>
</tr>
<tr class="even">
...
Mac 11.6.6 için Microsoft Office 2004 Güncelleştirmesi'nin uygun dil sürümünü [Microsoft Yükleme Merkezi](http://www.microsoft.com/downloads/details.aspx?familyid=ef3b559c-0bd2-45dd-8049-6946f6431a2a)'nden yükleyip kurun.
...
-   Masaüstünüzde Mac 11.6.6 için Microsoft Office 2004 Güncelleştirmesi birimini açın. Bu adım sizin adınıza gerçekleştirilmiş olabilir.  
-   Güncelleştirme işlemini başlatmak için, Mac 11.6.6 için Microsoft Office 2004 Güncelleştirmesi birimi penceresinde, Mac 11.6.6 için Microsoft Office 2004 Güncelleştirmesi uygulamasını çift tıklatın ve ekrandaki yönergeleri izleyin.  
-   Yükleme başarıyla tamamlanırsa, güncelleştirme yükleyicisini sabit diskinizden kaldırabilirsiniz. Yüklemenin başarıyla tamamlandığını doğrulamak için, aşağıdaki "Güncelleştirme Yüklemesini Doğrulama" başlığına bakın. Güncelleştirme yükleyicisini kaldırmak için, Mac 11.6.6 için Microsoft Office 2004 Güncelleştirmesi birimini ve ardından karşıdan yüklediğiniz dosyayı Trash (Çöp Kutusu) klasörüne sürükleyin.
...
Sürüm numarası **11.6.6** ise, güncelleştirme başarıyla yüklenmiştir.
...
-   Anonim bir araştırmacı, [VeriSign iDefense Labs](http://labs.idefense.com/) ile birlikte çalışarak Kayıt Belleğinin Bozulması Güvenlik Açığı'nı (CVE-2011-3403) bildirdikleri için
...
-   V1.1 (21 Aralık 2011): Etkilenmeyen Yazılımlar tablosuna Microsoft Office Uyumluluk Paketi Service Pack 3 eklendi. Bu yalnızca bilgilendirme amaçlı bir değişikliktir. Algılama mantığında veya güncelleştirme dosyalarında herhangi bir değişiklik yapılmamıştır.
