---
TOCTitle: 'MS11-042'
Title: 'Microsoft Güvenlik Bülteni MS11-042 - Kritik'
ms:assetid: 'ms11-042'
ms:contentKeyID: 61235683
ms:mtpsurl: 'https://technet.microsoft.com/tr-TR/library/ms11-042(v=Security.10)'
---

Security Bulletin

Microsoft Güvenlik Bülteni MS11-042 - Kritik
============================================

Dağıtılmış Dosya Sistemi'ndeki Güvenlik Açıkları Uzaktan Kod Yürütülmesine İzin Verebilir (2535512)
---------------------------------------------------------------------------------------------------

Yayım Tarihi: 14 Haziran 2011 Salı | Güncelleştirme Tarihi: 14 Haziran 2011 Salı
...
Bu güvenlik güncelleştirmesi Windows XP ve Windows Server 2003'ün tüm desteklenen sürümleri için Kritik; Windows Vista ve Windows Server 2008'in tüm desteklenen sürümleri için Önemli; 32-bit sistemler için Windows 7, x64 tabanlı sistemler için Windows 7, x64 tabanlı sistemler için Windows Server 2008 R2 ve Itanium tabanlı sistemler için Windows Server 2008 R2 için Önemli olarak derecelendirilmiştir. Daha fazla bilgi için, bu bölümdeki **Etkilenen ve Etkilenmeyen Yazılımlar** alt bölümüne bakın.

Güvenlik güncelleştirmesi, DFS istemcisinin özel hazırlanmış DFS başvurusu yanıtlarındaki alanları doğrulama ve DFS hizmetinin özel hazırlanmış DFS başvurusu yanıtlarını işleme biçimini düzelterek bu güvenlik açıklarını giderir. Bu güvenlik açıkları hakkında daha fazla bilgi için, bir sonraki bölüm olan **Güvenlik Açığı Bilgileri** altında, ilgili güvenlik açığı girdisinin Sık Sorulan Sorular (SSS) alt bölümüne bakın.
...
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------|----------------------|---------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=67a25abd-f43c-4b01-b507-a109b739238f)                                                                                               | Uzaktan Kod Yürütme       | Kritik               | Yok                                         |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=af6b7627-c462-45fe-8948-70da37e60659)                                                                      | Uzaktan Kod Yürütme       | Kritik               | Yok                                         |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=3aa8f1bc-07de-451a-8244-1733247e6f2e)                                                                                      | Uzaktan Kod Yürütme       | Kritik               | Yok                                         |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=e9018258-5a72-47a1-8584-3d1aa52317c3)                                                                          | Uzaktan Kod Yürütme       | Kritik               | Yok                                         |
| [Itanium tabanlı sistemler için Windows Server 2003 SP2](http://www.microsoft.com/downloads/details.aspx?familyid=96309c49-4822-4c47-b364-2ba65327cac5)                                                                  | Uzaktan Kod Yürütme       | Kritik               | Yok                                         |
| [Windows Vista Service Pack 1 ve Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=aded8f20-479d-40c1-9560-c0581c6f77a2)                                                            | Hizmet Reddi              | Önemli               | Yok                                         |
| [Windows Vista x64 Edition Service Pack 1 ve Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=962cb40c-680c-4c37-98d4-ca9789ca7270)                                    | Hizmet Reddi              | Önemli               | Yok                                         |
| [32-bit sistemler için Windows Server 2008 ve 32-bit sistemler için Windows Server 2008 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=8ebfa067-0236-4454-8605-df1b99742f90)\*                 | Hizmet Reddi              | Önemli               | Yok                                         |
| [x64 tabanlı sistemler için Windows Server 2008 ve x64 tabanlı sistemler için Windows Server 2008 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=f1d76b82-9996-4d08-894b-9c16a4b3bb1e)\*       | Hizmet Reddi              | Önemli               | Yok                                         |
| [Itanium tabanlı sistemler için Windows Server 2008 ve Itanium tabanlı sistemler için Windows Server 2008 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=f80c89c6-27ab-4f6a-afad-9c8e92cbbce4) | Hizmet Reddi              | Önemli               | Yok                                         |
| [32-bit sistemler için Windows 7](http://www.microsoft.com/downloads/details.aspx?familyid=9de1bf5d-6f25-496d-bc44-a32c5e8920fe)                                                                                         | Hizmet Reddi              | Önemli               | Yok                                         |
| [x64 tabanlı sistemler için Windows 7](http://www.microsoft.com/downloads/details.aspx?familyid=50d1c677-57aa-4e3f-bdfc-6f01b5d3bfe2)                                                                                    | Hizmet Reddi              | Önemli               | Yok                                         |
| [x64 tabanlı sistemler için Windows Server 2008 R2](http://www.microsoft.com/downloads/details.aspx?familyid=9d66b1e7-dbf9-4475-a973-49fb85557eca)\*                                                                     | Hizmet Reddi              | Önemli               | Yok                                         |
| [Itanium tabanlı sistemler için Windows Server 2008 R2](http://www.microsoft.com/downloads/details.aspx?familyid=3c8455f1-b8a0-4ba2-84a2-043d25ef75c5)                                                                   | Hizmet Reddi              | Önemli               | Yok                                         |
...
<th style="border:1px solid black;" >DFS'de Bellek Bozulması Güvenlik Açığı - CVE-2011-1868</th>
<th style="border:1px solid black;" >DFS Başvurusu Yanıtında Güvenlik Açığı - CVE-2011-1869</th>
...
DFS'de Bellek Bozulması Güvenlik Açığı - CVE-2011-1868  
------------------------------------------------------
  
<span></span>
Dağıtılmış Dosya Sistemi (DFS) istemcisinin özel hazırlanmış DFS yanıtlarını ayrıştırma biçiminde, kimlik doğrulaması olmadan uzaktan kod yürütme güvenlik açığı bulunmaktadır. Bu güvenlik açığından yararlanmaya yönelik girişimler kimlik doğrulaması gerektirir; saldırgan, istemci tarafından başlatılan bir DFS isteğine özel hazırlanmış bir DFS yanıtı göndererek bu güvenlik açığından yararlanabilir. Bu güvenlik açığından başarıyla yararlanan bir saldırgan rasgele kod yürütebilir ve etkilenen sistemin tüm denetimini ele geçirebilir. Saldırgan, program yükleyebilir; verileri görüntüleyebilir, değiştirebilir veya silebilir; tüm kullanıcı haklarına sahip olan yeni hesaplar oluşturabilir.
  
Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2011-1868](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1868).
  
#### DFS'de Bellek Bozulması Güvenlik Açığı - CVE-2011-1868 için Azaltıcı Etkenler
...
#### DFS'de Bellek Bozulması Güvenlik Açığı - CVE-2011-1868 için Geçici Çözümler
  
Microsoft bu güvenlik açığı için herhangi bir geçici çözüm belirleyememiştir.
  
#### DFS'de Bellek Bozulması Güvenlik Açığı - CVE-2011-1868 Hakkında SSS
...
Güvenlik açığı, Microsoft Dağıtılmış Dosya Sistemi (DFS) uygulamasının özel hazırlanmış DFS yanıtları içindeki tüm alanları düzgün doğrulamaması nedeniyle ortaya çıkar.
  
**Dağıtılmış Dosya Sistemi (DFS) nedir?**  
Dağıtılmış Dosya Sistemi (DFS), yöneticilerin farklı sunucularda bulunan paylaşılan klasörleri bir veya daha fazla DFS ad alanına bağlayarak gruplandırmalarına olanak verir. DFS ad alanı, bir kuruluştaki paylaşılan klasörlerin sanal görünümüdür. Bir yönetici ad alanında sunulacak paylaşılan klasörleri seçmek, bu klasörlerin görüneceği hiyerarşiyi tasarlamak ve paylaşılan klasörlerin ad alanında görünen adlarını belirlemek için DFS araçlarını kullanabilir. Bir kullanıcı bu ad alanını görüntülediğinde, klasörler yüksek kapasiteli tek bir sabit sürücüde bulunuyormuş gibi görünür. Kullanıcılar verilerin bulunduğu sunucuların veya paylaşılan klasörlerin adlarını bilmelerine gerek kalmadan ad alanındaki klasörler arasında gezinebilirler. Daha fazla bilgi için, [DFS Teknik Başvurusu](http://technet.microsoft.com/en-us/library/cc757042(ws.10).aspx)'na bakın.
...
Saldırgan, bu güvenlik açığından yararlanılacak şekilde özel olarak tasarlanmış bir sunucu barındırabilir ve daha sonra kullanıcıyı bu sunucuya bir DFS bağlantısı oluşturmaya ikna edebilir. Yerel ağdaki bir saldırgan ayrıca bir ortadaki adam saldırısı gerçekleştirerek, meşru bir DFS isteğine hatalı biçimlendirilmiş bir DFS yanıtı gönderebilir.
  
**Bu güvenlik açığından birincil derecede hangi sistemler etkileniyor?**  
Windows XP'nin ve Windows Server 2003'ün tüm desteklenen sürümleri bu güvenlik açığına karşı risk altındadır.
  
**Güncelleştirme ne yapıyor?**  
Güvenlik güncelleştirmesi, DFS istemcisinin özel hazırlanmış DFS yanıtları içindeki alanları doğrulama biçimini düzelterek bu güvenlik açığını giderir.
...
DFS Başvurusu Yanıtında Güvenlik Açığı - CVE-2011-1869  
------------------------------------------------------
  
<span></span>
Microsoft Dağıtılmış Dosya Sistemi'nin (DFS) özel hazırlanmış DFS başvurusu yanıtlarını işleme biçiminde bir hizmet reddi güvenlik açığı bulunmaktadır. Bu güvenlik açığından yararlanmaya yönelik girişimler kimlik doğrulaması gerektirir; saldırgan, Sunucu hizmetini çalıştıran bir bilgisayara özel hazırlanmış bir ağ iletisi göndererek bu güvenlik açığından yararlanabilir.
  
Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2011-1869](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1869).
  
#### DFS Başvurusu Yanıtında Güvenlik Açığı - CVE-2011-1869 için Azaltıcı Etkenler
...
#### DFS Başvurusu Yanıtında Güvenlik Açığı - CVE-2011-1869 için Geçici Çözümler
  
Microsoft bu güvenlik açığı için herhangi bir geçici çözüm belirleyememiştir.
  
#### DFS Başvurusu Yanıtında Güvenlik Açığı - CVE-2011-1869 Hakkında SSS
...
**Güvenlik açığına ne neden olmaktadır?**  
Güvenlik açığı, Dağıtılmış Dosya Sistemi (DFS) uygulamasının özel hazırlanmış DFS başvurusu yanıtlarını hatalı işlemesi nedeniyle ortaya çıkar.
...
**Bu güvenlik açığından birincil derecede hangi sistemler etkileniyor?**  
Windows'un tüm desteklenen sürümleri bu güvenlik açığına karşı risk altındadır.
  
**Güncelleştirme ne yapıyor?**  
Güvenlik güncelleştirmesi, DFS hizmetinin özel hazırlanmış DFS başvurusu yanıtlarını işleme biçimini düzelterek bu güvenlik açığını giderir.
...
| 32-bit sistemler için Windows 7                                                                                         | Evet                       | Evet                       |  
| x64 tabanlı sistemler için Windows 7                                                                                    | Evet                       | Evet                       |  
| x64 tabanlı sistemler için Windows Server 2008 R2                                                                       | Evet                       | Evet                       |  
| Itanium tabanlı sistemler için Windows Server 2008 R2                                                                   | Evet                       | Evet                       |
...
WindowsXP-KB2535512-x86-trk.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition Service Pack 2:<br />
WindowsServer2003.WindowsXP-KB2535512-x64-trk.exe /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">Windows XP Service Pack 3 için:<br />
WindowsXP-KB2535512-x86-trk.exe /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition Service Pack 2:<br />
WindowsServer2003.WindowsXP-KB2535512-x64-trk.exe /norestart</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">Denetim Masası'ndaki <strong>Program Ekle veya Kaldır</strong> aracını veya %Windir%\$NTUninstallKB2535512$\Spuninst klasöründe bulunan Spuninst.exe yardımcı programını kullanın</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Dosya Bilgileri</strong></td>
<td style="border:1px solid black;">Bkz: <a href="http://support.microsoft.com/kb/2535512">Microsoft Bilgi Bankası makalesi 2535512</a></td>
</tr>
<tr class="even">
...
WindowsServer2003-KB2535512-x86-trk.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
WindowsServer2003-KB2535512-ia64-trk.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen 32 bit sürümleri:<br />
WindowsServer2003-KB2535512-x86-trk.exe /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen x64 tabanlı sürümleri:<br />
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen Itanium tabanlı sürümleri:<br />
WindowsServer2003-KB2535512-ia64-trk.exe /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Güncelleştirme günlük dosyası</td>
<td style="border:1px solid black;">KB2535512.log</td>
...
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">x64 tabanlı sistemler için Windows 7:<br />
...
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">x64 tabanlı sistemler için tüm Windows 7 sürümleri:<br />
...
-   [NGS Software](http://www.ngssoftware.com/) için çalışan Laurent Gaffié, DFS Başvurusu Yanıtında Güvenlik Açığı'nı (CVE-2011-1869) bildirdiği için
