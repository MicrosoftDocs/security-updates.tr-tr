---
TOCTitle: 'MS11-014'
Title: 'Microsoft Güvenlik Bülteni MS11-014 - Önemli'
ms:assetid: 'ms11-014'
ms:contentKeyID: 61235655
ms:mtpsurl: 'https://technet.microsoft.com/tr-TR/library/ms11-014(v=Security.10)'
---

Security Bulletin

Microsoft Güvenlik Bülteni MS11-014 - Önemli
============================================

Yerel Güvenlik Yetkilisi Alt Sistem Hizmeti'ndeki Güvenlik Açığı Yerel Olarak Ayrıcalık Yükselmesine İzin Verebilir (2478960)
-----------------------------------------------------------------------------------------------------------------------------

Yayım Tarihi: 8 Şubat 2011 Salı | Güncelleştirme Tarihi: 28 Nisan 2011 Perşembe
...
Güvenlik güncelleştirmesi, LSASS'nin kimlik doğrulaması işleminde kullanılan belirli değerleri işleme biçimini düzelterek bu güvenlik açığını giderir. Bu güvenlik açığı hakkında daha fazla bilgi için, bir sonraki bölüm olan **Güvenlik Açığı Bilgileri** altında, ilgili güvenlik açığı girdisinin Sık Sorulan Sorular (SSS) alt bölümüne bakın.
...
**Bilinen Sorunlar.** [Microsoft Bilgi Bankası makalesi 2478960](http://support.microsoft.com/kb/2478960), bu güvenlik güncelleştirmesini yükleyen müşterilerin karşılaşabileceği bilinen sorunları belgelemektedir. Bu makale ayrıca, bu sorunlar için önerilen çözümleri de içermektedir.
...
|---------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------|----------------------|-----------------------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=541f228f-79b3-402a-8ff9-366c1e595227)                              | Ayrıcalık Yükseltmesi     | Önemli               | Yok                                                       |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=82189bf2-3f34-4949-92da-eea98036d18e)     | Ayrıcalık Yükseltmesi     | Önemli               | [MS08-002](http://go.microsoft.com/fwlink/?linkid=104921) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=4e31e6b1-577e-468e-9c94-67227d2273c2)                     | Ayrıcalık Yükseltmesi     | Önemli               | [MS08-002](http://go.microsoft.com/fwlink/?linkid=104921) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=76e3c229-d812-433c-ad05-7cbd1f9c6a6d)         | Ayrıcalık Yükseltmesi     | Önemli               | [MS08-002](http://go.microsoft.com/fwlink/?linkid=104921) |
| [Itanium tabanlı sistemler için Windows Server 2003 SP2](http://www.microsoft.com/downloads/details.aspx?familyid=a0cde8d8-7c85-4fcb-bcf7-205064970b41) | Ayrıcalık Yükseltmesi     | Önemli               | [MS08-002](http://go.microsoft.com/fwlink/?linkid=104921) |
...
<th style="border:1px solid black;" >LSASS'de Uzunluğu Doğrulama Güvenlik Açığı - CVE-2011-0039</th>
...
LSASS'de Uzunluğu Doğrulama Güvenlik Açığı - CVE-2011-0039  
----------------------------------------------------------
  
<span></span>
Microsoft Windows Yerel Güvenlik Yetkilisi Alt Sistemi Hizmeti'nin (LSASS) özel hazırlanmış kimlik doğrulaması isteklerini işleme biçiminde bir ayrıcalık yükselmesi güvenlik açığı bulunmaktadır. Güvenlik açığı bir saldırganın yükseltilmiş ayrıcalıklarla kod çalıştırılmasına izin verebilir. Bu açığı başarıyla kullanan bir saldırgan, etkilenen sistemin tüm denetimini ele geçirebilir. Saldırgan, program yükleyebilir; verileri görüntüleyebilir, değiştirebilir veya silebilir; tüm yönetici haklarına sahip olan yeni hesaplar oluşturabilir.
  
Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2011-0039](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0039).
  
#### LSASS'de Uzunluğu Doğrulama Güvenlik Açığı - CVE-2011-0039 için Azaltıcı Etkenler
...
#### LSASS'de Uzunluğu Doğrulama Güvenlik Açığı - CVE-2011-0039 için Geçici Çözümler
  
Microsoft bu güvenlik açığı için herhangi bir geçici çözüm belirleyememiştir.
  
#### LSASS'de Uzunluğu Doğrulama Güvenlik Açığı - CVE-2011-0039 Hakkında SSS
...
Güvenlik açığı, Windows LSASS özel hazırlanmış bir kimlik doğrulaması isteğini işlediğinde ortaya çıkar.
...
Güncelleştirme, LSASS'nin kimlik doğrulaması işleminde kullanılan belirli değerleri işleme biçimini düzelterek bu güvenlik açığını giderir.
...
WindowsXP-KB2478960-x86-trk.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition Service Pack 2:<br />
WindowsServer2003.WindowsXP-KB2478960-x64-trk.exe /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">Windows XP Service Pack 3 için:<br />
WindowsXP-KB2478960-x86-trk.exe /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition Service Pack 2:<br />
WindowsServer2003.WindowsXP-KB2478960-x64-trk.exe /norestart</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">Denetim Masası'ndaki <strong>Program Ekle veya Kaldır</strong> aracını veya %Windir%\$NTUninstallKB2478960$\Spuninst klasöründe bulunan Spuninst.exe yardımcı programını kullanın</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Dosya Bilgileri</strong></td>
<td style="border:1px solid black;">Bkz: <a href="http://support.microsoft.com/kb/2478960">Microsoft Bilgi Bankası makalesi 2478960</a></td>
</tr>
<tr class="even">
...
WindowsServer2003-KB2478960-x86-trk.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
WindowsServer2003-KB2478960-ia64-trk.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen 32 bit sürümleri:<br />
WindowsServer2003-KB2478960-x86-trk.exe /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen x64 tabanlı sürümleri:<br />
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen Itanium tabanlı sürümleri:<br />
WindowsServer2003-KB2478960-ia64-trk.exe /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Güncelleştirme günlük dosyası</td>
<td style="border:1px solid black;">KB2478960.log</td>
...
-   Primavera BSS için çalışan güvenlik sınayıcısı Jorge Moura, LSASS'de Uzunluğu Doğrulama Güvenlik Açığı'nı (CVE-2011-0039) bildirdiği için
...
-   V1.1 (28 Nisan 2011): Yürütmeyle İlgili Özet altındaki Bilinen Sorunlar bölümüne Microsoft Bilgi Bankası makalesi 2478960 için bir bağlantı eklendi.
