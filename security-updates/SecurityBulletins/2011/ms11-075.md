---
TOCTitle: 'MS11-075'
Title: 'Microsoft Güvenlik Bülteni MS11-075 - Önemli'
ms:assetid: 'ms11-075'
ms:contentKeyID: 61235716
ms:mtpsurl: 'https://technet.microsoft.com/tr-TR/library/ms11-075(v=Security.10)'
---

Security Bulletin

Microsoft Güvenlik Bülteni MS11-075 - Önemli
============================================

Microsoft Active Accessibility'deki Güvenlik Açığı Uzaktan Kod Yürütülmesine İzin Verebilir (2623699)
-----------------------------------------------------------------------------------------------------

Yayım Tarihi: 11 Ekim 2011 Salı | Güncelleştirme Tarihi: 25 Ekim 2011 Salı
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=82653b8c-0e58-440d-9702-8847f599caed">Itanium Tabanlı Sistemler için Windows Server 2003 SP2</a><br />
(KB2605295)</td>
<td style="border:1px solid black;">Uzaktan Kod Yürütme</td>
<td style="border:1px solid black;">Önemli</td>
<td style="border:1px solid black;">Yok</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=7cd1ecec-8a3f-4cb2-833c-a177c9602ff5">32-bit sistemler için Windows Server 2008 Service Pack 2</a>*<br />
(KB2564958)</td>
<td style="border:1px solid black;">Uzaktan Kod Yürütme</td>
<td style="border:1px solid black;">Önemli</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=212284">MS11-038</a></td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=456e450c-3928-4130-8127-e4d3f482c1ca">x64 tabanlı sistemler için Windows Server 2008 Service Pack 2</a>*<br />
(KB2564958)</td>
<td style="border:1px solid black;">Uzaktan Kod Yürütme</td>
<td style="border:1px solid black;">Önemli</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=212284">MS11-038</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=2e9930d3-ba13-446d-bfa0-60720c48203b">Itanium tabanlı sistemler için Windows Server 2008 Service Pack 2</a><br />
(KB2564958)</td>
<td style="border:1px solid black;">Uzaktan Kod Yürütme</td>
<td style="border:1px solid black;">Önemli</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=212284">MS11-038</a></td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=02d28e59-b38f-433a-a568-e86f9d43dd42">32-bit sistemler için Windows 7 ve 32-bit sistemler için Windows 7 Service Pack 1</a><br />
(KB2564958)</td>
<td style="border:1px solid black;">Uzaktan Kod Yürütme</td>
<td style="border:1px solid black;">Önemli</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=212284">MS11-038</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=904dec69-e8b9-4b23-a5ea-d3e7e9b9df07">x64 tabanlı sistemler için Windows 7 ve x64 tabanlı sistemler için Windows 7 Service Pack 1</a><br />
(KB2564958)</td>
<td style="border:1px solid black;">Uzaktan Kod Yürütme</td>
<td style="border:1px solid black;">Önemli</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=212284">MS11-038</a></td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=c7bd50b7-03f1-4ea4-ad71-d428822c62f8">x64 tabanlı sistemler için Windows Server 2008 R2 ve x64 tabanlı sistemler için Windows Server 2008 R2 Service Pack 1</a>*<br />
(KB2564958)</td>
<td style="border:1px solid black;">Uzaktan Kod Yürütme</td>
<td style="border:1px solid black;">Önemli</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=212284">MS11-038</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=aa816682-9652-433c-b1b4-5d0bc17b6a87">Itanium tabanlı sistemler için Windows Server 2008 R2 ve Itanium tabanlı sistemler için Windows Server 2008 R2 Service Pack 1</a><br />
(KB2564958)</td>
<td style="border:1px solid black;">Uzaktan Kod Yürütme</td>
<td style="border:1px solid black;">Önemli</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=212284">MS11-038</a></td>
...
<th style="border:1px solid black;" >Active Accessibility'de Güvenli Olmayan Şekilde Kitaplık Yükleme Güvenlik Açığı - CVE-2011-1247</th>
<th style="border:1px solid black;" >Toplam Önem Derecesi</th>
</tr>
</thead>
<tbody>
...
Active Accessibility'de Güvenli Olmayan Şekilde Kitaplık Yükleme Güvenlik Açığı - CVE-2011-1247  
-----------------------------------------------------------------------------------------------
  
<span></span>
Microsoft Active Accessibility bileşeninin DLL dosyalarını yükleme biçiminde bir uzaktan kod yürütme güvenlik açığı bulunmaktadır. Bu açığı başarıyla kullanan bir saldırgan, etkilenen sistemin tüm denetimini ele geçirebilir. Saldırgan, program yükleyebilir; verileri görüntüleyebilir, değiştirebilir veya silebilir; tüm kullanıcı haklarına sahip olan yeni hesaplar oluşturabilir. Hesapları, sistemde az sayıda kullanıcı hakkıyla yapılandırılmış olan kullanıcılar, yönetici haklarıyla çalışan kullanıcılardan daha az etkilenebilir.
  
Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2011-1247](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1247).
  
#### Active Accessibility'de Güvenli Olmayan Şekilde Kitaplık Yükleme Güvenlik Açığı - CVE-2011-1247 için Azaltıcı Etkenler
...
#### Active Accessibility'de Güvenli Olmayan Şekilde Kitaplık Yükleme Güvenlik Açığı - CVE-2011-1247 için Geçici Çözümler
...
#### Active Accessibility'de Güvenli Olmayan Şekilde Kitaplık Yükleme Güvenlik Açığı - CVE-2011-1247 Hakkında SSS
...
Güvenlik açığı, Microsoft Active Accessibility bileşeninin dış kitaplıkları yüklemek için kullanılan yolu hatalı şekilde kısıtlaması nedeniyle ortaya çıkar.
  
**Microsoft Active Accessibility bileşeni nedir?**  
Microsoft Active Accessibility bileşeni, erişilebilirlik yardımcı programlarının Microsoft Windows üzerinde çalıştırılan uygulamalarla birlikte çalışmasını iyileştiren Bileşen Nesne Modeli (COM) tabanlı bir teknolojidir. İşletim sistemiyle tümleştirilmiş dinamik bağlantı kitaplıklarının yanı sıra, kullanıcı arabirimi öğeleriyle ilgili bilgileri sunmaya yönelik güvenilir yöntemler sağlayan COM arabirimini ve API öğelerini de sağlar. Daha fazla bilgi için, [Microsoft Active Accessibility](http://msdn.microsoft.com/en-us/library/ms971350.aspx) adlı MSDN makalesine bakın.
...
Saldırgan bir kullanıcıyı özel hazırlanmış bir dinamik bağlantı kitaplığı (DLL) dosyasıyla aynı ağ dizininde bulunan meşru bir dosyayı açmaya ikna edebilir. Daha sonra, meşru dosyanın açıldığı sırada Microsoft Active Accessibility bileşeni bu DLL dosyasını yüklemeyi ve içerdiği kodu yürütmeyi deneyebilir.
  
E-posta tabanlı saldırı senaryosunda, saldırgan bir kullanıcıya meşru bir dosya eki gönderip kullanıcıyı bu eki özel hazırlanmış bir DLL dosyası içeren bir dizine yerleştirmeye ve meşru dosyayı açmaya ikna ederek bu güvenlik açığından yararlanabilir. Daha sonra, meşru dosyanın açıldığı sırada Microsoft Active Accessibility bileşeni bu DLL dosyasını yüklemeyi ve içerdiği kodu yürütmeyi deneyebilir.
...
Güncelleştirme, Microsoft Active Accessibility bileşeninin dış kitaplıkları yükleme biçimini düzelterek bu güvenlik açığını giderir.
...
WindowsXP-KB2564958-x86-trk.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition Service Pack 2:<br />
WindowsServer2003.WindowsXP-KB2564958-x64-trk.exe /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">Windows XP Service Pack 3 için:<br />
WindowsXP-KB2564958-x86-trk.exe /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition Service Pack 2:<br />
WindowsServer2003.WindowsXP-KB2564958-x64-trk.exe /norestart</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">Denetim Masası'ndaki <strong>Program Ekle veya Kaldır</strong> aracını veya %Windir%\$NTUninstallKB2564958$\Spuninst klasöründe bulunan Spuninst.exe yardımcı programını kullanın</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Dosya Bilgileri</strong></td>
<td style="border:1px solid black;">Bkz: <a href="http://support.microsoft.com/kb/2564958">Microsoft Bilgi Bankası makalesi 2564958</a></td>
</tr>
<tr class="even">
...
WindowsServer2003-KB2564958-x86-trk.exe /quiet
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
WindowsServer2003.WindowsXP-KBKB2564958-x64-trk.exe /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
WindowsServer2003-KB2605295-ia64-trk.exe /quiet
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
Windows Server 2003'ün tüm desteklenen 32 bit sürümleri:  
WindowsServer2003-KB2564958-x86-trk.exe /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
Windows Server 2003'ün tüm desteklenen x64 tabanlı sürümleri:  
WindowsServer2003.WindowsXP-KBKB2564958-x64-trk.exe /norestart
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
Windows Server 2003'ün tüm desteklenen Itanium tabanlı sürümleri:  
WindowsServer2003-KB2605295-ia64-trk.exe /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
Windows Server 2003'ün tüm desteklenen 32-bit ve x64 tabanlı sürümleri:  
KB2564958.log
</td>
</tr>
<tr class="alternateRow">
...
<td style="border:1px solid black;" colspan="2">
Windows Server 2003'ün tüm desteklenen 32-bit ve x64 tabanlı sürümleri:  
Denetim Masası'ndaki **Program Ekle veya Kaldır** aracını veya %Windir%\\$NTUninstallKB2564958$\\Spuninst klasöründe bulunan Spuninst.exe yardımcı programını kullanın
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
Windows Server 2003'ün tüm desteklenen Itanium tabanlı sürümleri:  
Denetim Masası'ndaki **Program Ekle veya Kaldır** aracını veya %Windir%\\$NTUninstallKB2605295$\\Spuninst klasöründe bulunan Spuninst.exe yardımcı programını kullanın
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
Windows Server 2003'ün tüm desteklenen 32-bit ve x64 tabanlı sürümleri:  
Bkz: [Microsoft Bilgi Bankası makalesi 2564958](http://support.microsoft.com/kb/2564958)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
Windows Server 2003'ün tüm desteklenen Itanium tabanlı sürümleri:  
Bkz: [Microsoft Bilgi Bankası makalesi 2605295](http://support.microsoft.com/kb/2605295)
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
-   [Mila Parkour](http://contagiodump.com), [Adobe Systems, Inc.](http://www.adobe.com) için çalışan Anshul Kothari ve Nishant Kaushik ile birlikte çalışarak Active Accessibility'de Güvenli Olmayan Şekilde Kitaplık Yükleme Güvenlik Açığı'nı (CVE-2011-1247) bildirdikleri için
...
-   V1.1 (12 Ekim 2011): Windows Vista, Windows Server 2008, Windows 7 ve Windows Server 2008 R2'nin tüm desteklenen sürümleri için bülten değişikliği bilgileri düzeltildi. Bu yalnızca bilgilendirme amaçlı bir değişikliktir. Algılama mantığında veya güncelleştirme dosyalarında herhangi bir değişiklik yapılmamıştır.  
-   V1.2 (25 Ekim 2011): Windows XP ve Windows Server 2003'ün 32-bit ve x64 tabanlı sürümleri için güncelleştirme dosya adları, Microsoft Bilgi Bankası makalesi KB816915'te belgelenen şemaya göre yeniden düzenlendi. Bu yalnızca dosya adlarında yapılan bir değişikliktir. Algılama mantığında veya güncelleştirme içeriğinde herhangi bir değişiklik yapılmamıştır. Bu güncelleştirmeyi başarıyla yüklemiş olan müşterilerin herhangi bir işlem gerçekleştirmeleri gerekmez.
