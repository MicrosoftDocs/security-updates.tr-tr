---
TOCTitle: 'MS11-052'
Title: 'Microsoft Güvenlik Bülteni MS11-052 - Kritik'
ms:assetid: 'ms11-052'
ms:contentKeyID: 61235693
ms:mtpsurl: 'https://technet.microsoft.com/tr-TR/library/ms11-052(v=Security.10)'
---

Security Bulletin

Microsoft Güvenlik Bülteni MS11-052 - Kritik
============================================

Vektör İşaretleme Dilindeki Güvenlik Açığı Uzaktan Kod Yürütülmesine İzin Verebilir (2544521)
---------------------------------------------------------------------------------------------

Yayım Tarihi: 14 Haziran 2011 Salı | Güncelleştirme Tarihi: 12 Temmuz 2011 Salı
...
Güvenlik açığı, Internet Explorer kullanan bir kullanıcı özel hazırlanmış bir Web sayfasını görüntülerse uzaktan kod yürütülmesine olanak verebilir. Hesapları, sistemde az sayıda kullanıcı hakkıyla yapılandırılmış olan kullanıcılar, yönetici haklarıyla çalışan kullanıcılardan daha az etkilenebilir.

Güvenlik güncelleştirmesi, Internet Explorer'ın bellekteki nesneleri işleme biçimini değiştirerek bu güvenlik açığını giderir. Bu güvenlik açığı hakkında daha fazla bilgi için, bir sonraki bölüm olan **Güvenlik Açığı Bilgileri** altında, ilgili güvenlik açığı girdisinin Sık Sorulan Sorular (SSS) alt bölümüne bakın.
...
<span></span>
**Bu bülten 12 Temmuz 2011'de neden yeniden düzenlendi?**  
Microsoft bu bülteni, algılama mantığında yapılan bir değişiklik duyurmak ve bazı etkilenen yapılandırmalar için bülten değişikliği bilgilerini düzeltmek üzere yeniden düzenledi.

Windows XP'nin tüm desteklenen x64 tabanlı sürümleri ve Windows Server 2003'ün tüm desteklenen sürümleri üzerinde Internet Explorer 6 çalıştıran müşteriler için, algılama mantığında bir değişiklik yapılmış ve bülten değişikliği bilgileri düzeltilmiştir. Güvenlik güncelleştirmesinin dosyalarında değişiklik yapılmamıştır. Sistemlerini daha önce başarıyla güncelleştirmiş olan müşterilerin herhangi bir işlem gerçekleştirmeleri gerekmez.

Windows XP'nin ve Windows Server 2003'ün tüm desteklenen sürümleri üzerinde Internet Explorer 7 çalıştıran müşteriler için yalnızca bülten değişikliği bilgilerinde bir düzeltme yapılmıştır. Algılama mantığında veya güvenlik güncelleştirmesi dosyalarında herhangi bir değişiklik yapılmamıştır. Sistemlerini daha önce başarıyla güncelleştirmiş olan müşterilerin herhangi bir işlem gerçekleştirmeleri gerekmez.
...
Evet. Güncel VML güvenlik güncelleştirmesini Internet Explorer 6 bulunan sistemlere yüklemiş olan ve daha sonra Internet Explorer 7'yi yükleyen müşterilere Internet Explorer 7 için bu güncelleştirme sunulur. Windows Internet Explorer 7 ile yüklenen vgx.dll sürümü, Windows XP veya Windows Server 2003 ile gelen vgx.dll sürümünden daha yüksek bir ana sürümdür. Internet Explorer 7 yüklendiğinde, bu güvenlik güncelleştirmesinde sağlanan ve Internet Explorer 6 tarafından güncelleştirilen vgx.dll dosyasının yerini alır.
...
<th style="border:1px solid black;" >
VML'de Bellek Bozulması Güvenlik Açığı - CVE-2011-1266
</th>
<th style="border:1px solid black;" >
Toplam Önem Derecesi
</th>
...
Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2011-1266](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1266).

#### VML'de Bellek Bozulması Güvenlik Açığı - CVE-2011-1266 için Azaltıcı Etkenler
...
#### VML'de Bellek Bozulması Güvenlik Açığı - CVE-2011-1266 için Geçici Çözümler
...
#### VML'de Bellek Bozulması Güvenlik Açığı - CVE-2011-1266 Hakkında SSS
...
WindowsXP-KB2544521-x86-TRK.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP'nin tüm desteklenen x64 tabanlı sürümleri için Internet Explorer 6:<br />
WindowsServer2003.WindowsXP-KB2544521-x64-TRK.exe /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP'nin tüm desteklenen 32 bit sürümleri için Internet Explorer 7:<br />
IE7-WindowsXP-KB2544521-x86-TRK.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP'nin tüm desteklenen x64 tabanlı sürümleri için Internet Explorer 7:<br />
IE7-WindowsServer2003.WindowsXP-KB2544521-x64-TRK.exe /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP'nin tüm desteklenen 32 bit sürümleri için Internet Explorer 8:<br />
IE8-WindowsXP-KB2544521-x86-TRK.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP'nin tüm desteklenen x64 tabanlı sürümleri için Internet Explorer 8:<br />
IE8-WindowsServer2003.WindowsXP-KB2544521-x64-TRK.exe /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">Windows XP'nin tüm desteklenen 32 bit sürümleri için Internet Explorer 6:<br />
WindowsXP-KB2544521-x86-TRK.exe /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP'nin tüm desteklenen x64 tabanlı sürümleri için Internet Explorer 6:<br />
WindowsServer2003.WindowsXP-KB2544521-x64-TRK.exe /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP'nin tüm desteklenen 32 bit sürümleri için Internet Explorer 7:<br />
IE7-WindowsXP-KB2544521-x86-TRK.exe /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP'nin tüm desteklenen x64 tabanlı sürümleri için Internet Explorer 7:<br />
IE7-WindowsServer2003.WindowsXP-KB2544521-x64-TRK.exe /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP'nin tüm desteklenen 32 bit sürümleri için Internet Explorer 8:<br />
IE8-WindowsXP-KB2544521-x86-TRK.exe /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP'nin tüm desteklenen x64 tabanlı sürümleri için Internet Explorer 8:<br />
IE8-WindowsServer2003.WindowsXP-KB2544521-x64-TRK.exe /norestart</td>
</tr>
<tr class="odd">
...
Denetim Masası'ndaki <strong>Program Ekle veya Kaldır</strong> aracını veya %Windir%\$NTUninstallKB2544521$\Spuninst klasöründe bulunan Spuninst.exe yardımcı programını kullanın</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP'nin tüm desteklenen sürümleri için Internet Explorer 7:<br />
Denetim Masası'ndaki <strong>Program Ekle veya Kaldır</strong> aracını veya %Windir%\ie7updates\KB2544521-IE7\spuninst klasöründe bulunan Spuninst.exe yardımcı programını kullanın</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP'nin tüm desteklenen sürümleri için Internet Explorer 8:<br />
Denetim Masası'ndaki <strong>Program Ekle veya Kaldır</strong> aracını veya %Windir%\ie8updates\KB2544521-IE8\spuninst klasöründe bulunan Spuninst.exe yardımcı programını kullanın</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Dosya Bilgileri</strong></td>
<td style="border:1px solid black;">Bkz: <a href="http://support.microsoft.com/kb/2544521">Microsoft Bilgi Bankası makalesi 2544521</a></td>
</tr>
<tr class="even">
...
WindowsServer2003-KB2544521-x86-TRK.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen 32-bit sürümleri için Internet Explorer 6:<br />
WindowsServer2003-KB2544521-x86-TRK.exe /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen x64 tabanlı sürümleri için Internet Explorer 6:<br />
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen Itanium tabanlı sürümleri için Internet Explorer 6:<br />
WindowsServer2003-KB2544521-ia64-TRK.exe /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen 32-bit sürümleri için Internet Explorer 7:<br />
IE7-WindowsServer2003-KB2544521-x86-TRK.exe /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen x64 tabanlı sürümleri için Internet Explorer 7:<br />
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen Itanium tabanlı sürümleri için Internet Explorer 7:<br />
IE7-WindowsServer2003-KB2544521-ia64-TRK.exe /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen 32-bit sürümleri için Internet Explorer 8:<br />
IE8-WindowsServer2003-KB2544521-x86-TRK.exe /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen x64 tabanlı sürümleri için Internet Explorer 8:<br />
...
-   Anonim bir araştırmacı, [TippingPoint](http://www.tippingpoint.com/) bünyesindeki [Zero Day Initiative](http://www.zerodayinitiative.com/) ile birlikte çalışarak VML'de Bellek Bozulması Güvenlik Açığı'nı (CVE-2011-1266) bildirdikleri için
...
-   V1.1 (12 Temmuz 2011): Algılama mantığında yapılan bir değişiklik duyuruldu ve bazı etkilenen yapılandırmalar için bülten değişikliği bilgileri düzeltildi. Güvenlik güncelleştirmesinin dosyalarında değişiklik yapılmamıştır. Ayrıntılı bilgi için, Güncelleştirme Hakkında SSS bölümüne bakın.
