---
TOCTitle: 'MS11-030'
Title: 'Microsoft Güvenlik Bülteni MS11-030 - Kritik'
ms:assetid: 'ms11-030'
ms:contentKeyID: 61235671
ms:mtpsurl: 'https://technet.microsoft.com/tr-TR/library/ms11-030(v=Security.10)'
---

Security Bulletin

Microsoft Güvenlik Bülteni MS11-030 - Kritik
============================================

DNS Çözümlemedeki Güvenlik Açığı Uzaktan Kod Yürütülmesine İzin Verebilir (2509553)
-----------------------------------------------------------------------------------
...
**Bilinen Sorunlar.**[Microsoft Bilgi Bankası makalesi 2509553](http://support.microsoft.com/kb/2509553), bu güvenlik güncelleştirmesini yükleyen müşterilerin karşılaşabileceği bilinen sorunları belgelemektedir. Bu makale ayrıca, bu sorunlar için önerilen çözümleri de içermektedir.
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=f5ad6963-2d6a-4d59-9e25-4fc088647fcd">Itanium Tabanlı Sistemler için Windows Server 2003 SP2</a></td>
<td style="border:1px solid black;">Ayrıcalık Yükseltmesi</td>
<td style="border:1px solid black;">Önemli</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=108231">MS08-020</a>,<br />
<a href="http://go.microsoft.com/fwlink/?linkid=119620">MS08-037</a>,<br />
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=2a17e44f-54aa-423d-b3c7-a4f404f7c28b">Windows Vista Service Pack 1 ve Windows Vista Service Pack 2</a></td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=e708d24f-e348-4c4d-99ed-e78dd1689d01">Windows Vista x64 Edition Service Pack 1 ve Windows Vista x64 Edition Service Pack 2</a></td>
<td style="border:1px solid black;">Uzaktan Kod Yürütme</td>
<td style="border:1px solid black;">Kritik</td>
<td style="border:1px solid black;">Yok</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=9894be38-a582-4c15-ad0e-cc3afab2aebc">32-bit sistemler için Windows Server 2008 ve 32-bit sistemler için Windows Server 2008 Service Pack 2</a>*</td>
<td style="border:1px solid black;">Uzaktan Kod Yürütme</td>
<td style="border:1px solid black;">Kritik</td>
<td style="border:1px solid black;">Yok</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=2d7d2021-020f-4cc9-a027-258d7e5faec9">x64 tabanlı sistemler için Windows Server 2008 ve x64 tabanlı sistemler için Windows Server 2008 Service Pack 2</a>*</td>
<td style="border:1px solid black;">Uzaktan Kod Yürütme</td>
<td style="border:1px solid black;">Kritik</td>
<td style="border:1px solid black;">Yok</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=c0275df0-10ac-4500-ab86-b7e9a34f8e1d">Itanium tabanlı sistemler için Windows Server 2008 ve Itanium tabanlı sistemler için Windows Server 2008 Service Pack 2</a></td>
<td style="border:1px solid black;">Uzaktan Kod Yürütme</td>
<td style="border:1px solid black;">Kritik</td>
<td style="border:1px solid black;">Yok</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=8fdae09b-d1bb-4ef5-aa45-2a05f2a5e12d">32-bit sistemler için Windows 7 ve 32-bit sistemler için Windows 7 Service Pack 1</a></td>
<td style="border:1px solid black;">Uzaktan Kod Yürütme</td>
<td style="border:1px solid black;">Kritik</td>
<td style="border:1px solid black;">Yok</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=40879dfb-efa4-41ba-8d5c-22e926a55eef">x64 tabanlı sistemler için Windows 7 ve x64 tabanlı sistemler için Windows 7 Service Pack 1</a></td>
<td style="border:1px solid black;">Uzaktan Kod Yürütme</td>
<td style="border:1px solid black;">Kritik</td>
<td style="border:1px solid black;">Yok</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=2084c726-187e-41f9-9bea-da18f490d29e">x64 tabanlı sistemler için Windows Server 2008 R2 ve x64 tabanlı sistemler için Windows Server 2008 R2 Service Pack 1</a>*</td>
<td style="border:1px solid black;">Uzaktan Kod Yürütme</td>
<td style="border:1px solid black;">Kritik</td>
<td style="border:1px solid black;">Yok</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=34d2793e-a2cd-49f6-b524-6598ea86175f">Itanium tabanlı sistemler için Windows Server 2008 R2 ve Itanium tabanlı sistemler için Windows Server 2008 R2 Service Pack 1</a></td>
<td style="border:1px solid black;">Uzaktan Kod Yürütme</td>
<td style="border:1px solid black;">Kritik</td>
<td style="border:1px solid black;">Yok</td>
</tr>
...
<th style="border:1px solid black;" >DNS Sorgusu Güvenlik Açığı - CVE-2011-0657</th>
<th style="border:1px solid black;" >Toplam Önem Derecesi</th>
</tr>
</thead>
<tbody>
...
DNS Sorgusu Güvenlik Açığı - CVE-2011-0657  
------------------------------------------
  
<span></span>
DNS istemcisinin özel hazırlanmış LLMNR sorgularını işleme biçiminde bir uzaktan kod yürütme güvenlik açığı bulunmaktadır. Bu güvenlik açığından başarıyla yararlanan bir saldırgan, NetworkService hesabının bağlamında rasgele kod çalıştırabilir. Saldırgan, program yükleyebilir; verileri görüntüleyebilir, değiştirebilir veya silebilir; tüm kullanıcı haklarına sahip olan yeni hesaplar oluşturabilir.
  
Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2011-0657](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0657).
  
#### DNS Sorgusu Güvenlik Açığı - CVE-2011-0657 için Azaltıcı Etkenler
...
-   En iyi güvenlik duvarı uygulamaları ve standart varsayılan güvenlik duvarı yapılandırmaları, ağ yapılarının kuruluş dışından gerçekleştirilen saldırılardan korunmasına yardımcı olabilir. En iyi uygulamalar, Internet'e bağlı sistemlerde olabildiğince az sayıda bağlantı noktasının açılmasını önerir. Bu durumda, LLMNR bağlantı noktalarına Internet'ten erişim engellenmelidir. Güvenlik duvarında 5355 numaralı TCP ve UDP bağlantı noktalarını engelleme konusunda bilgi için, aşağıdaki SSS girdisine bakın.
  
#### DNS Sorgusu Güvenlik Açığı - CVE-2011-0657 için Geçici Çözümler
  
Geçici çözüm, arka plandaki güvenlik açığını gidermeyen ama güvenlik açığı uygulanmadan önceki bilinen saldırı vektörlerinin engellenmesine yardımcı olan bir ayar veya yapılandırma değişikliği anlamına gelir. Microsoft aşağıdaki geçici çözümleri sınamıştır ve bir geçici çözümün işlevselliği azaltıp azaltmadığı ilgili açıklamada belirtilmektedir:
  
-   **Güvenlik duvarında 5355 numaralı TCP ve UDP bağlantı noktalarını engelleyin**
    ...
    **Geçici çözümün etkisi.** Bu bağlantı noktalarına erişimin engellenmesi, güvenlik duvarının arkasındaki sistemleri bu açıktan yararlanma girişimlerinden engellemeye yardımcı olur.
  
    **Geçici çözüm nasıl geri alınır.** Güvenlik duvarında 5355 numaralı TCP ve UDP bağlantı noktalarını engellemesini kaldırın. Bağlantı noktaları hakkında daha fazla bilgi için, bkz. [TCP ve UDP Bağlantı Noktası Atamaları](http://go.microsoft.com/fwlink/?linkid=21312).
  
-   **Grup İlkesi kullanarak Bağlantı Yerel Çok Noktaya Yayın Adı Çözümleme'yi devre dışı bırakın**
  
    Grup İlkesi'ni kullanarak bağlantı yerel çok noktaya yayın adı çözümlemeyi devre dışı bırakmak için, aşağıdaki adımları gerçekleştirin:
  
    1.  Grup İlkesi Düzenleyicisi'ni açın.  
    2.  Sırasıyla **Bilgisayar Yapılandırması**'nı, **Yönetimsel Şablonlar**'ı, **Ağ**'ı ve sonra da **DNS İstemcisi**'ni genişletin.  
    3.  **Çok Noktaya Ad Çözümlemesini Kapat**'ı çift tıklatın, **Etkin**'i tıklatın ve ardından **Tamam**'ı tıklatın.
  
    **Geçici çözümün etkisi.** Bilgisayar, ağ üzerindeki diğer bilgisayarlar tarafından görülemeyebilir.
  
    **Geçici çözüm nasıl geri alınır.**
  
    Grup İlkesi'ni kullanarak bağlantı yerel çok noktaya yayın adı çözümlemeyi yeniden etkinleştirmek için, aşağıdaki adımları gerçekleştirin:
  
    1.  Grup İlkesi Düzenleyicisi'ni açın.  
    2.  Sırasıyla **Bilgisayar Yapılandırması**'nı, **Yönetimsel Şablonlar**'ı, **Ağ**'ı ve sonra da **DNS İstemcisi**'ni genişletin.  
    3.  **Çok Noktaya Ad Çözümlemesini Kapat**'ı çift tıklatın, **Devre Dışı**'nı tıklatın ve ardından **Tamam**'ı tıklatın.
  
-   **Ağ Bulma'yı kapatın**
  
    Ağ Bulma'yı kapatmak için, aşağıdaki adımları gerçekleştirin:
  
    1.  Denetim Masası'nı açın.  
    2.  Sırasıyla **Ağ ve Internet**'i, **Ağ ve Paylaşım Merkezi**'ni ve sonra da **Gelişmiş paylaşım ayarlarını değiştir**'i tıklatın.  
    3.  Ağ Bulma altında, **Ağ bulmayı kapat**'ı ve ardından **Değişiklikleri kaydet**'i tıklatın.
  
    **Geçici çözümün etkisi.** Bilgisayar, ağ üzerindeki diğer bilgisayarlar tarafından görülemeyebilir.
  
    **Geçici çözüm nasıl geri alınır.**
  
    Ağ Bulma'yı yeniden etkinleştirmek için, aşağıdaki adımları gerçekleştirin:
  
    1.  Denetim Masası'nı açın.  
    2.  Sırasıyla **Ağ ve Internet**'i, **Ağ ve Paylaşım Merkezi**'ni ve sonra da **Gelişmiş paylaşım ayarlarını değiştir**'i tıklatın.  
    3.  Ağ Bulma altında, **Ağ bulmayı aç**'ı ve ardından **Değişiklikleri kaydet**'i tıklatın.
  
#### DNS Sorgusu Güvenlik Açığı - CVE-2011-0657 Hakkında SSS
  
**Bu güvenlik açığının kapsamı nedir?**  
Windows Vista, Windows Server 2008, Windows 7 ve Windows Server 2008 R2 tabanlı sistemlerde, bu bir uzaktan kod yürütme güvenlik açığıdır. Bu güvenlik açığından başarıyla yararlanan bir saldırgan, NetworkService hesabının güvenlik bağlamında kod yürütebilir.
  
Windows XP ve Windows Server 2003'te, bu bir ayrıcalık yükselmesi güvenlik açığıdır. Kullanıcı kimlik bilgilerini ele geçiren bir saldırgan bu güvenlik açığından yararlanarak, NetworkService hesabının bağlamında kod yürütmesine olanak verebilecek bir ayrıcalık yükselmesine neden olabilir.
  
**Güvenlik açığına ne neden olmaktadır?**  
Güvenlik açığı, DNS istemcisinin özel hazırlanmış LLMNR sorgularını işleme biçimi nedeniyle ortaya çıkar.
  
**Güvenlik açığından hangi bileşen etkilenmektedir?**  
Etkilenen bileşen DNSAPI.dll dosyasıdır.
  
**Bir saldırgan bu güvenlik açığından yararlanarak neler yapabilir?**  
Bu güvenlik açığından başarıyla yararlanan bir saldırgan, NetworkService hesabının bağlamında rasgele kod çalıştırabilir. Saldırgan, program yükleyebilir; verileri görüntüleyebilir, değiştirebilir veya silebilir; tüm kullanıcı haklarına sahip olan yeni hesaplar oluşturabilir.
  
**Bir saldırgan bu güvenlik açığından nasıl yararlanabilir?**  
Windows Vista, Windows Server 2008, Windows 7 ve Windows Server 2008 R2 tabanlı sistemlerde, bu güvenlik açığından başarıyla yararlanan bir saldırganın ağa erişebilmesi gerekir. Saldırgan daha sonra hedef sistemlere özel hazırlanmış LLMNR yayını sorguları göndermek üzere özel bir program oluşturabilir.
  
Windows XP ve Windows Server 2003 çalıştırılan sistemlerde, saldırganın bu güvenlik açığından yararlanabilmesi için öncelikle sistemde oturum açması gerekir. Böylece saldırgan, güvenlik açığından yararlanan ve kendi ayrıcalıklarını NetworkService hesabı bağlamına yükselten özel hazırlanmış bir uygulama çalıştırabilir.
  
**Windows XP veya Windows Server 2003'te bu güvenlik açığından uzaktan yararlanılabiliyor mu?**  
Hayır. LLMNR, Windows XP'de veya Windows Server 2003'te desteklenmemektedir. DNS istemcisindeki güvenlik açığı bu sistemlerde yine de bulunmaktadır ve yalnızca özel hazırlanmış bir uygulama çalıştırılarak bu açıktan yararlanılabilir.
  
**LLMNR nedir?**  
Bağlantı Yerel Çok Noktaya Yayın Adı Çözümleme (LLMNR), yakındaki bilgisayarların adlarını çözümlemek için ek bir yöntem sunan yeni bir protokoldür. LLMNR özellikle Etki Alanı Adı Sistemi (DNS) sunucusu bulunmayan ağlarda kullanışlıdır. LLMNR basit bir istek alışverişi ve yanıt iletileri kullanarak, bilgisayar adlarını Internet Protokolü sürüm 6 (IPv6) veya IP sürüm 4 (IPv4) adreslerine çözümler. LLMNR hakkında daha fazla bilgi için, [Bağlantı Yerel Çok Noktaya Yayın Adı Çözümleme](http://technet.microsoft.com/en-us/library/bb878128.aspx) adlı Microsoft TechNet makalesine bakın.
...
Güncelleştirme, DNS istemcisinin özel hazırlanmış DNS sorgularını işleme biçimini düzelterek bu güvenlik açığını giderir.
...
WindowsXP-KB2509553-x86-trk.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition Service Pack 2:<br />
WindowsServer2003.WindowsXP-KB2509553-x64-trk.exe /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">Windows XP Service Pack 3 için:<br />
WindowsXP-KB2509553-x86-trk.exe /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition Service Pack 2:<br />
WindowsServer2003.WindowsXP-KB2509553-x64-trk.exe /norestart</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">Denetim Masası'ndaki <strong>Program Ekle veya Kaldır</strong> aracını veya %Windir%\$NTUninstallKB2509553$\Spuninst klasöründe bulunan Spuninst.exe yardımcı programını kullanın</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Dosya Bilgileri</strong></td>
<td style="border:1px solid black;">Bkz: <a href="http://support.microsoft.com/kb/2509553">Microsoft Bilgi Bankası makalesi 2509553</a></td>
</tr>
<tr class="even">
...
WindowsServer2003-KB2509553-x86-trk.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
WindowsServer2003-KB2509553-ia64-trk.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen 32 bit sürümleri:<br />
WindowsServer2003-KB2509553-x86-trk.exe /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen x64 tabanlı sürümleri:<br />
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen Itanium tabanlı sürümleri:<br />
WindowsServer2003-KB2509553-ia64-trk.exe /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Güncelleştirme günlük dosyası</td>
<td style="border:1px solid black;">KB2509553.log</td>
...
-   [Google Inc.](http://www.google.com/) için çalışan Neel Mehta, DNS Sorgusu Güvenlik Açığı'nı (CVE-2011-0657) bildirdiği için
...
-   V1.1 (13 Mart 2012): Yürütmeyle İlgili Özet altındaki Bilinen Sorunlar bölümüne Microsoft Bilgi Bankası makalesi 2509553 için bir bağlantı eklendi.
