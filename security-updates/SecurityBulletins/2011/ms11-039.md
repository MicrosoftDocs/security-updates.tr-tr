---
TOCTitle: 'MS11-039'
Title: 'Microsoft Güvenlik Bülteni MS11-039 - Kritik'
ms:assetid: 'ms11-039'
ms:contentKeyID: 61235680
ms:mtpsurl: 'https://technet.microsoft.com/tr-TR/library/ms11-039(v=Security.10)'
---

Security Bulletin

Microsoft Güvenlik Bülteni MS11-039 - Kritik
============================================
...
Güvenlik güncelleştirmesi Windows XP, Windows Server 2003, Windows Vista, Windows Server 2008, Windows 7 ve Windows Server 2008 R2'nin tüm desteklenen sürümleri üzerinde Microsoft .NET Framework'ün tüm etkilenen sürümleri ve Microsoft Silverlight 4 için Kritik olarak derecelendirilmiştir. Daha fazla bilgi için, bu bölümdeki **Etkilenen ve Etkilenmeyen Yazılımlar** alt bölümüne bakın.

Güvenlik güncelleştirmesi, .NET Framework'ün güvenilen API'lere geçirilen değerleri doğrulama biçimini düzelterek bu güvenlik açığını giderir. Bu güvenlik açığı hakkında daha fazla bilgi için, bir sonraki bölüm olan **Güvenlik Açığı Bilgileri** altında, ilgili güvenlik açığı girdisinin Sık Sorulan Sorular (SSS) alt bölümüne bakın.
...
**Bilinen Sorunlar.**[Microsoft Bilgi Bankası makalesi 2514842](http://support.microsoft.com/kb/2514842), bu güvenlik güncelleştirmesini yükleyen müşterilerin karşılaşabileceği bilinen sorunları belgelemektedir. Bu makale ayrıca, bu sorunlar için önerilen çözümleri de içermektedir.
...
<td style="border:1px solid black;">
[Microsoft .NET Framework 2.0 Service Pack 1 ve Microsoft .NET Framework 3.5](http://www.microsoft.com/downloads/details.aspx?familyid=2eabacce-394f-4b9a-8306-0875ca19a3a9)  
(KB2478657)  
[Microsoft .NET Framework 2.0 Service Pack 2 ve Microsoft .NET Framework 3.5 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=55fd3254-7e59-4cf9-afa8-45ae66bc7390)  
(KB2478659)  
[Microsoft .NET Framework 4.0](http://www.microsoft.com/downloads/details.aspx?familyid=c72635e4-c733-4fa1-9db0-75de6ead9e1c)<sup>[1]</sup>
(KB2478663)
</td>
...
<td style="border:1px solid black;">
[Microsoft .NET Framework 2.0 Service Pack 2 ve Microsoft .NET Framework 3.5 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=afa11dda-a543-42a7-b997-5292fd869a8b)  
(KB2478660)  
[Microsoft .NET Framework 4.0](http://www.microsoft.com/downloads/details.aspx?familyid=c72635e4-c733-4fa1-9db0-75de6ead9e1c)<sup>[1]</sup>
(KB2478663)
</td>
...
<tr>
<td style="border:1px solid black;">
[Tüm Microsoft Windows](http://www.microsoft.com/downloads/details.aspx?familyid=2f71b104-b66f-4146-9d70-fcde766c91b8)sunucu sürümleri üzerine yüklendiğinde Microsoft Silverlight 4\*\*  
(KB2512827)
</td>
<td style="border:1px solid black;">
Uzaktan Kod Yürütme
...
**Bu güvenlik güncelleştirmesi MS11-044, .NET Framework'teki Güvenlik Açığı Uzaktan Kod Yürütülmesine İzin** **Verebilir ile ilişkili midir?**  
...
Bu bültenin ilk yayımlandığı tarihteki güncel Microsoft Silverlight yapısı olan Microsoft Silverlight yapı 4.0.60531.0 bu güvenlik açığını giderir ve sorundan etkilenmez. 4.0.60531.0 öncesindeki Microsoft Silverlight yapıları sorundan etkilenir.
...
Bu güvenlik güncelleştirmesi ile birlikte yüklenen sürüm 4.0.60531.0 sürümüdür. Sürüm numaranız bundan büyük veya buna eşitse sisteminizden bu açıktan etkilenmez.
...
<th style="border:1px solid black;" >
.NET Framework'te Dizi Kaydırma Güvenlik Açığı - CVE-2011-0664
</th>
<th style="border:1px solid black;" >
Toplam Önem Derecesi
</th>
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows XP Professional x64 Edition Service Pack 2 üzerine yüklendiğinde Microsoft .NET Framework 4.0<sup>[1]</sup>
</td>
<td style="border:1px solid black;">
**Kritik**  
Uzaktan Kod Yürütme
...
<tr>
<td style="border:1px solid black;">
Windows Vista x64 Edition Service Pack 1 ve Windows Vista x64 Edition Service Pack 2 üzerine yüklendiğinde Microsoft .NET Framework 4.0<sup>[1]</sup>
</td>
<td style="border:1px solid black;">
**Kritik**  
Uzaktan Kod Yürütme
...
Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz [CVE-2011-0664](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0664).

#### .NET Framework'te Dizi Kaydırma Güvenlik Açığı - CVE-2011-0664 için Azaltıcı Etkenler
...
#### .NET Framework'te Dizi Kaydırma Güvenlik Açığı - CVE-2011-0664 için Geçici Çözümler
...
-   **Internet Explorer'da** **XAML tarayıcı uygulamalarını devre dışı bırakın**
    ...
    5.  **Güvenlik** sekmesinde, **Özel düzey**'i tıklatın. **.NET Framework bağımlı bileşenleri** altında, **Authenticode ile imzalanmayan bileşenleri çalıştır** ayarını **Sor** veya **Devre Dışı Bırak** olarak belirleyin ve sonra **Tamam**'ı tıklatın. Bu adımı **Authenticode ile imzalanan bileşenleri çal**ıştır**** için de yineleyin ve sonra **Tamam**'ı tıklatın.
...
#### .NET Framework'te Dizi Kaydırma Güvenlik Açığı - CVE-2011-0664 Hakkında SSS
...
Güvenlik açığı, .NET Framework ve Microsoft Silverlight'ın yerleşik ağ işlevlerine geçirilen bağımsız değişkenleri düzgün doğrulamaması nedeniyle ortaya çıkar.
...
**Windows Server 2008 veya Windows Server 2008 R2 için Internet Explorer çalıştırıyorum. Bu durum, bu güvenlik açığının etkisini azaltır m**ı**?**  
...
Güncelleştirme, .NET Framework'ün güvenilen API'lere geçirilen değerleri doğrulama biçimini düzelterek bu güvenlik açığını giderir.
...
| Mac üzerine yüklendiğinde Microsoft Silverlight 3                                                                             | Evet |
| Tüm Microsoft Windows istemci sürümlerine yüklendiğinde Microsoft Silverlight 3                                               | Evet |
| Tüm Microsoft Windows sunucu sürümleri üzerine yüklendiğinde Microsoft Silverlight 3                                          | Evet |
| Mac üzerine yüklendiğinde Microsoft Silverlight 4                                                                             | Evet |
...
| Mac üzerine yüklendiğinde Microsoft Silverlight 3                                                                             | Evet                       | Evet                       |
| Tüm Microsoft Windows istemci sürümlerine yüklendiğinde Microsoft Silverlight 3                                               | Evet                       | Evet                       |
| Tüm Microsoft Windows sunucu sürümleri üzerine yüklendiğinde Microsoft Silverlight 3                                          | Evet                       | Evet                       |
| Mac üzerine yüklendiğinde Microsoft Silverlight 4                                                                             | Evet                       | Evet                       |
...
<td style="border:1px solid black;">Bkz: <a href="http://support.microsoft.com/kb/2514842">Microsoft Bilgi Bankası makalesi 2514842</a></td>
</tr>
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">32-bit sistemler üzerinde Microsoft .NET Framework 4.0:<br />
HKEY_LOCAL_MACHINE\SOFTWARE\ Microsoft\Updates\Microsoft .NET Framework 4 Client Profile\KB2478663<br />
&quot;ThisVersionInstalled&quot; = &quot;Y&quot;</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">x64 tabanlı sistemler üzerinde Microsoft .NET Framework 4.0:<br />
...
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">32-bit sistemler için Windows Server 2003 üzerine yüklendiğinde Microsoft .NET Framework 4.0:<br />
NDP40-KB2478663-x86.exe /q</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">x64 tabanlı sistemler için Windows Server 2003 üzerine yüklendiğinde Microsoft .NET Framework 4.0:<br />
NDP40-KB2478663-x64.exe /q</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Itanium tabanlı sistemler için Windows Server 2003 üzerinde Microsoft .NET Framework 3.5:<br />
...
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Itanium tabanlı sistemler için Windows Server 2003 üzerine yüklendiğinde Microsoft .NET Framework 4.0:<br />
...
Microsoft .NET Framework 4.0 güvenlik güncelleştirmesi aşağıdaki kurulum anahtarlarını destekler:
...
Microsoft .NET Framework 3.5.1 güvenlik güncelleştirmesi aşağıdaki kurulum anahtarlarını destekler:
...
-   Michael J. Liu, .NET Framework'te Dizi Kaydırma Güvenlik Açığı'nı (CVE-2011-0664) bildirdiği için
