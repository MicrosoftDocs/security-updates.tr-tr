---
TOCTitle: 'MS12-013'
Title: 'Microsoft Güvenlik Bülteni MS12-013 - Kritik'
ms:assetid: 'ms12-013'
ms:contentKeyID: 61235754
ms:mtpsurl: 'https://technet.microsoft.com/tr-TR/library/ms12-013(v=Security.10)'
---

Security Bulletin

Microsoft Güvenlik Bülteni MS12-013 - Kritik
============================================

C Çalışma Zamanı Kitaplığı'ndaki Güvenlik Açığı Uzaktan Kod Yürütülmesine İzin Verebilir (2654428)
--------------------------------------------------------------------------------------------------
...
**Bilinen Sorunlar.**[Microsoft Bilgi Bankası makalesi 2654428](http://support.microsoft.com/kb/2654428), bu güvenlik güncelleştirmesini yükleyen müşterilerin karşılaşabileceği bilinen sorunları belgelemektedir. Bu makale ayrıca, bu sorunlar için önerilen çözümleri de içermektedir.
...
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------|----------------------|---------------------------------------------|
| [Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=c503c7b1-24f8-40a4-8283-c1e4abf90b57)                                                                                                  | Kritik                    | Uzaktan Kod Yürütme  | Yok                                         |
| [Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=ddbd9fcf-10c4-4089-88c0-c2a6c288222b)                                                                                      | Kritik                    | Uzaktan Kod Yürütme  | Yok                                         |
| [32-bit sistemler için Windows Server 2008 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=0c1812af-f57d-455d-a81d-5e03db99b2f7)\*                                                                    | Kritik                    | Uzaktan Kod Yürütme  | Yok                                         |
| [x64 tabanlı sistemler için Windows Server 2008 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=e1b66bb5-ea12-44a5-807a-f21ede0dc76d)\*                                                               | Kritik                    | Uzaktan Kod Yürütme  | Yok                                         |
| [Itanium tabanlı sistemler için Windows Server 2008 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=3a96ab34-8f45-48bf-a98b-9e683b50aaa0)                                                             | Kritik                    | Uzaktan Kod Yürütme  | Yok                                         |
| [32-bit sistemler için Windows 7 ve 32-bit sistemler için Windows 7 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=403f355c-2273-42ac-8263-d662f5d7740c)                                             | Kritik                    | Uzaktan Kod Yürütme  | Yok                                         |
| [x64 tabanlı sistemler için Windows 7 ve x64 tabanlı sistemler için Windows 7 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=8bd8e804-ca4d-4326-bc60-345e2975b7aa)                                   | Kritik                    | Uzaktan Kod Yürütme  | Yok                                         |
| [x64 tabanlı sistemler için Windows Server 2008 R2 ve x64 tabanlı sistemler için Windows Server 2008 R2 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=d868c5ef-165a-46a0-b832-e6ca55a910f9)\*       | Kritik                    | Uzaktan Kod Yürütme  | Yok                                         |
| [Itanium tabanlı sistemler için Windows Server 2008 R2 ve Itanium tabanlı sistemler için Windows Server 2008 R2 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=e5416371-495b-4dc7-a239-f9185f968969) | Kritik                    | Uzaktan Kod Yürütme  | Yok                                         |
...
Evet. KB güncelleştirmesi Windows Geliştirici Önizlemesi sürümüne yöneliktir. Windows Geliştirici Önizlemesi'ni kullanan müşterilerin bu güncelleştirmeyi sistemlerine uygulamaları önerilir. Bu güncelleştirme yalnızca [Windows Update](http://go.microsoft.com/fwlink/?linkid=21130) aracılığıyla sunulmaktadır.
...
<th style="border:1px solid black;" >Msvcrt.dll Dosyasında Arabellek Taşması Güvenlik Açığı - CVE-2012-0150</th>
...
Msvcrt.dll Dosyasında Arabellek Taşması Güvenlik Açığı - CVE-2012-0150  
----------------------------------------------------------------------
  
<span></span>
msvcrt adlı DLL dosyasının bellekteki bir arabellek boyutunu hesaplama biçiminde, verilerin düzgün ayrılmamış belleğe kopyalanmasına olanak verebilecek bir uzaktan kod yürütme güvenlik açığı bulunmaktadır. Bu güvenlik açığı, bir kullanıcı özel hazırlanmış bir medya dosyasını açarsa uzaktan kod yürütülmesine izin verebilir. Kullanıcı yönetimsel haklarla oturum açtıysa, bu güvenlik açığından başarıyla yararlanan bir saldırgan etkilenen sistemin denetimini tümüyle ele geçirebilir. Saldırgan, program yükleyebilir; verileri görüntüleyebilir, değiştirebilir veya silebilir; tüm kullanıcı haklarına sahip olan yeni hesaplar oluşturabilir. Hesapları, sistemde az sayıda kullanıcı hakkıyla yapılandırılmış olan kullanıcılar, yönetici haklarıyla çalışan kullanıcılardan daha az etkilenebilir.
  
Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2012-0150](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0150).
  
#### Msvcrt.dll Dosyasında Arabellek Taşması Güvenlik Açığı - CVE-2012-0150 için Azaltıcı Etkenler
...
#### Msvcrt.dll Dosyasında Arabellek Taşması Güvenlik Açığı - CVE-2012-0150 için Geçici Çözümler
  
Microsoft bu güvenlik açığı için herhangi bir geçici çözüm belirleyememiştir.
  
#### Msvcrt.dll Dosyasında Arabellek Taşması Güvenlik Açığı - CVE-2012-0150 Hakkında SSS
  
**Bu güvenlik açığının kapsamı nedir?**  
Bu, yerel kullanıcının bağlamında bir uzaktan kod yürütme güvenlik açığıdır.
  
**Güvenlik açığına ne neden olmaktadır?**  
Güvenlik açığı, msvcrt.dll dosyasının bir arabellek boyutunu yanlış hesaplaması nedeniyle verilerin düzgün ayrılmamış belleğe kopyalanmasına olanak verebilir.
  
**m** **svcrt.dll nedir?**  
Msvcrt.dll dosyası sistem düzeyinde bileşenler tarafından kullanılan, çok iş parçacıklı, C çalışma zamanı dinamik bağlantı kitaplığıdır. msvcrt.dll dosyasıyla ilgili daha fazla bilgi için, [C Çalışma Zamanı Kitaplıkları](http://msdn.microsoft.com/en-us/library/abx4dbyh.aspx) adlı MSDN makalesine bakın.
  
**Bir saldırgan bu güvenlik açığından yararlanarak neler yapabilir?**  
Bu açığı başarıyla kullanan kimliği doğrulanmamış bir saldırgan, etkilenen sistemin tüm denetimini ele geçirebilir. Saldırgan, program yükleyebilir; verileri görüntüleyebilir, değiştirebilir veya silebilir; tüm kullanıcı haklarına sahip olan yeni hesaplar oluşturabilir. Hesapları, sistemde az sayıda kullanıcı hakkıyla yapılandırılmış olan kullanıcılar, yönetici haklarıyla çalışan kullanıcılardan daha az etkilenebilir.
  
**Bir saldırgan bu güvenlik açığından** **nasıl yararlanabilir?**  
E-posta tabanlı saldırı senaryosunda, kimliği doğrulanmamış bir saldırgan bir kullanıcıya özel hazırlanmış bir medya dosyası içeren bir e-posta iletisi gönderip kullanıcıyı bu medya dosyasını açmaya ikna ederek bu güvenlik açığından yararlanabilir.
...
**Üçüncü taraf uygulamalar bu güvenlik açığından etkileniyor mu?**  
Evet, msvcrt.dll dosyasını kullanan uygulamalar bu güvenlik açığından etkilenebilir. Microsoft etkilenen Microsoft Windows sürümlerinde bu güvenlik açığının giderilmesine yardımcı olmak için bu güvenlik güncelleştirmesinin uygulanmasını önerir. Bu sorunla ilgili daha fazla bilgi için, [Microsoft Bilgi Bankası makalesi 2654428](http://support.microsoft.com/kb/2654428)'deki Bu güvenlik güncelleştirmesiyle ilgili olduğu bilinen sorunlar bölümüne bakın.
  
**Güncelleştirme ne yapıyor?**  
Güncelleştirme, msvcrt adlı DLL dosyasının bellekteki veri yapılarının boyutunu hesaplama biçimini değiştirerek bu güvenlik açığını giderir.
...
<td style="border:1px solid black;">Bkz: <a href="http://support.microsoft.com/kb/2654428">Microsoft Bilgi Bankası makalesi 2654428</a></td>
</tr>
<tr class="odd">
...
-   Alexander Gavrun, [TippingPoint](http://www.tippingpoint.com/) bünyesindeki [Zero Day Initiative](http://www.zerodayinitiative.com/) ile birlikte çalışarak Msvcrt.dll Dosyasında Arabellek Taşması Güvenlik Açığı'nı (CVE-2012-0150) bildirdikleri için
