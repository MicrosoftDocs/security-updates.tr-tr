---
TOCTitle: 'MS10-099'
Title: 'Microsoft Güvenlik Bülteni MS10-099 - Önemli'
ms:assetid: 'ms10-099'
ms:contentKeyID: 61235634
ms:mtpsurl: 'https://technet.microsoft.com/tr-TR/library/ms10-099(v=Security.10)'
---

Security Bulletin

Microsoft Güvenlik Bülteni MS10-099 - Önemli
============================================

Yönlendirme ve Uzaktan Erişim'deki Güvenlik Açığı Ayrıcalık Yükselmesine İzin Verebilir (2440591)
-------------------------------------------------------------------------------------------------
...
|---------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------|----------------------|---------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=4d0ae558-a4f2-4048-b5fd-ba072ca35e48)                              | Ayrıcalık Yükselmesi      | Önemli               | Yok                                         |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=238bb885-eae6-464a-bb3d-679025f1cb50)     | Ayrıcalık Yükselmesi      | Önemli               | Yok                                         |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=c87af292-a068-4089-aab8-115c18b4b024)                     | Ayrıcalık Yükselmesi      | Önemli               | Yok                                         |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=e17b8878-d065-49cc-bdba-0f24cdf35ea3)         | Ayrıcalık Yükselmesi      | Önemli               | Yok                                         |
| [Itanium tabanlı sistemler için Windows Server 2003 SP2](http://www.microsoft.com/downloads/details.aspx?familyid=ad896d80-167f-4e8f-a448-cac93516f4d0) | Ayrıcalık Yükselmesi      | Önemli               | Yok                                         |
...
<th style="border:1px solid black;" >Çekirdek NDProxy'de Arabellek Taşması Güvenlik Açığı - CVE-2010-3963</th>
...
Çekirdek NDProxy'de Arabellek Taşması Güvenlik Açığı - CVE-2010-3963  
--------------------------------------------------------------------
  
<span></span>
Windows çekirdeğinin Yönlendirme ve Uzaktan Erişim NDProxy bileşeninde, kullanıcı modundan çekirdeğe geçirilen girişin düzgün doğrulanmaması nedeniyle bir ayrıcalık yükselmesi güvenlik açığı bulunmaktadır. Güvenlik açığı bir saldırganın yükseltilmiş ayrıcalıklarla kod çalıştırılmasına izin verebilir. Bu güvenlik açığından yerel olarak başarıyla yararlanan bir saldırgan rasgele kod yürütebilir ve etkilenen sistemin tüm denetimini ele geçirebilir. Saldırgan, program yükleyebilir; verileri görüntüleyebilir, değiştirebilir veya silebilir; tüm kullanıcı haklarına sahip olan yeni hesaplar oluşturabilir.
  
Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2010-3963](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3963).
  
#### Çekirdek NDProxy'de Arabellek Taşması Güvenlik Açığı - CVE-2010-3963 için Azaltıcı Etkenler
...
#### Çekirdek NDProxy'de Arabellek Taşması Güvenlik Açığı - CVE-2010-3963 için Geçici Çözümler
  
Microsoft bu güvenlik açığı için herhangi bir geçici çözüm belirleyememiştir.
  
#### Çekirdek NDProxy'de Arabellek Taşması Güvenlik Açığı - CVE-2010-3963 Hakkında SSS
...
Yönlendirme ve Uzaktan Erişim NDProxy bileşeni, verileri kullanıcı modundan çekirdeğe geçirirken kullanıcı tarafından sağlanan girişi düzgün şekilde doğrulamaz.
  
**RRAS nedir?**  
RRAS, bir bilgisayarın ağ yönlendiricisi olarak çalışmasına olanak tanır. RRAS ayrıca Windows için Uzaktan Erişim Hizmeti (RAS) için sonraki nesil sunucu işlevlerini sağlar. RRAS sunucu işlevleri, önceki işletim sistemlerinde bulunan Uzaktan Erişim Hizmeti (RAS) üzerine oluşturulmuştur.
  
Uzaktan Erişim Hizmeti, kullanıcıların telefon hatları üzerinden bir uzak bilgisayara bağlanarak, sistemleri uzak ağa fiziksel olarak bağlıymış gibi çalışabilmelerini sağlar. Bu hizmetler, uzak kullanıcıların e-posta gönderip alma, belgeleri faks ile gönderme, dosya alma ve belgeleri bir ofis yazıcısında yazdırma gibi etkinlikleri gerçekleştirmelerine olanak verir.
  
Uzaktan Erişim Hizmeti, Windows XP ve Windows Server 2003'te bulunan bir özgün hizmettir.
  
**NDProxy nedir?**  
NDPROXY, sistem tarafından sağlanan ve WAN miniport sürücüler, çağrı yöneticileri ve miniport çağrı yöneticileri ile Telefon Uygulamaları Programlama Arabirimi (TAPI) hizmetleri arasındaki arabirimi oluşturan bir sürücüdür. Ek bilgi için, [NDPROXY'ye Genel Bakış](http://msdn.microsoft.com/en-us/library/ff568322(vs.85).aspx) adlı MSDN makalesine bakın.
...
Güncelleştirme, kullanıcı modundan Yönlendirme ve Uzaktan Erişim bileşeni aracılığıyla Windows Çekirdeği'ne geçirilen girişi düzgün biçimde doğrulayarak bu güvenlik açığını giderir.
...
WindowsXP-KB2440591-x86-trk.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition Service Pack 2:<br />
WindowsServer2003.WindowsXP-KB2440591-x64-trk.exe /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">Windows XP Service Pack 3 için:<br />
WindowsXP-KB2440591-x86-trk.exe /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition Service Pack 2:<br />
WindowsServer2003.WindowsXP-KB2440591-x64-trk.exe /norestart</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">Denetim Masası'ndaki <strong>Program Ekle veya Kaldır</strong> aracını veya %Windir%\$NTUninstallKB2440591$\Spuninst klasöründe bulunan Spuninst.exe yardımcı programını kullanın</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Dosya Bilgileri</strong></td>
<td style="border:1px solid black;">Bkz: <a href="http://support.microsoft.com/kb/2440591">Microsoft Bilgi Bankası makalesi 2440591</a></td>
</tr>
<tr class="even">
...
WindowsServer2003-KB2440591-x86-trk.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
WindowsServer2003-KB2440591-ia64-trk.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen 32 bit sürümleri:<br />
WindowsServer2003-KB2440591-x86-trk.exe /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen x64 tabanlı sürümleri:<br />
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen Itanium tabanlı sürümleri:<br />
WindowsServer2003-KB2440591-ia64-trk.exe /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Güncelleştirme günlük dosyası</td>
<td style="border:1px solid black;">KB2440591.log</td>
...
-   [Fortinet bünyesindeki FortiGuard Labs](http://www.fortiguard.com/) için çalışan Honggang Ren, Çekirdek NDProxy'de Arabellek Taşması Güvenlik Açığı'nı (CVE-2010-3963) bildirdiği için
