---
TOCTitle: 'MS10-082'
Title: 'Microsoft Güvenlik Bülteni MS10-082 - Önemli'
ms:assetid: 'ms10-082'
ms:contentKeyID: 61235617
ms:mtpsurl: 'https://technet.microsoft.com/tr-TR/library/ms10-082(v=Security.10)'
---

Security Bulletin

Microsoft Güvenlik Bülteni MS10-082 - Önemli
============================================

Windows Media Player'daki Güvenlik Açığı Uzaktan Kod Yürütülmesine İzin Verebilir (2378111)
-------------------------------------------------------------------------------------------
...
Bu güvenlik güncelleştirmesi Microsoft Windows'un Windows Server 2008 ve Windows Server 2008 R2 dışındaki desteklenen sürümleri üzerine yüklendiğinde Windows Media Player 9 Series, Windows Media Player 10, Windows Media Player 11 ve Windows Media Player 12 için Önemli olarak derecelendirilmiştir. Windows Server 2008 ve Windows Server 2008 R2'nin desteklenen sürümleri üzerine yüklendiğinde Windows Media Player 11 ve Windows Media Player 12 için, bu güvenlik güncelleştirmesi Orta olarak derecelendirilmiştir. Windows Server 2003, Windows Server 2008 ve Windows Server 2008 R2'nin desteklenen Itanium tabanlı sürümleri bu güvenlik açığından etkilenmez. Daha fazla bilgi için, bu bölümdeki **Etkilenen ve Etkilenmeyen Yazılımlar** alt bölümüne bakın.

Güvenlik güncelleştirmesi, Windows Media Player'ın yeniden yükleme işlemi sırasında nesneleri serbest bırakma biçimini düzelterek bu güvenlik açığını giderir. Bu güvenlik açığı hakkında daha fazla bilgi için, bir sonraki bölüm olan **Güvenlik Açığı Bilgileri** altında, ilgili güvenlik açığı girdisinin Sık Sorulan Sorular (SSS) alt bölümüne bakın.
...
<th style="border:1px solid black;" >
Windows Media Player'da Bellek Bozulması Güvenlik Açığı - CVE-2010-2745  
</th>
<th style="border:1px solid black;" >
...
Windows XP Service Pack 3 üzerinde Windows Media Player 9
</td>
<td style="border:1px solid black;">
**Önemli**   
Uzaktan Kod Yürütme
...
<td style="border:1px solid black;">
Windows XP Service Pack 3 üzerinde Windows Media Player 10
</td>
<td style="border:1px solid black;">
**Önemli**   
Uzaktan Kod Yürütme
...
<tr>
<td style="border:1px solid black;">
Windows XP Professional x64 Edition Service Pack 2 üzerinde Windows Media Player 10
</td>
<td style="border:1px solid black;">
**Önemli**   
Uzaktan Kod Yürütme
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Server 2003 Service Pack 2 üzerinde Windows Media Player 10
</td>
<td style="border:1px solid black;">
**Önemli**   
Uzaktan Kod Yürütme
...
<tr>
<td style="border:1px solid black;">
Windows Server 2003 x64 Edition Service Pack 2 üzerinde Windows Media Player 10
</td>
<td style="border:1px solid black;">
**Önemli**   
Uzaktan Kod Yürütme
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows XP Service Pack 3 üzerinde Windows Media Player 11
</td>
<td style="border:1px solid black;">
**Önemli**   
Uzaktan Kod Yürütme
...
<tr>
<td style="border:1px solid black;">
Windows XP Professional x64 Edition Service Pack 2 üzerinde Windows Media Player 11
</td>
<td style="border:1px solid black;">
**Önemli**   
Uzaktan Kod Yürütme
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Vista Service Pack 1 ve Windows Vista Service Pack 2 üzerinde Windows Media Player 11
</td>
<td style="border:1px solid black;">
**Önemli**   
Uzaktan Kod Yürütme
...
<tr>
<td style="border:1px solid black;">
Windows Vista x64 Edition Service Pack 1 ve Windows Vista x64 Edition Service Pack 2 üzerinde Windows Media Player 11
</td>
<td style="border:1px solid black;">
**Önemli**   
Uzaktan Kod Yürütme
...
<tr class="alternateRow">
<td style="border:1px solid black;">
32-bit sistemler için Windows Server 2008 ve 32-bit sistemler için Windows Server 2008 Service Pack 2 üzerinde Windows Media Player 11\*\*
</td>
<td style="border:1px solid black;">
**Orta**   
Uzaktan Kod Yürütme
...
<tr>
<td style="border:1px solid black;">
x64 tabanlı sistemler için Windows Server 2008 ve x64 tabanlı sistemler için Windows Server 2008 Service Pack 2 üzerinde Windows Media Player 11\*\*
</td>
<td style="border:1px solid black;">
**Orta**   
Uzaktan Kod Yürütme
...
<tr class="alternateRow">
<td style="border:1px solid black;">
32-bit sistemler için Windows 7 üzerinde Windows Media Player 12
</td>
<td style="border:1px solid black;">
**Önemli**   
Uzaktan Kod Yürütme
...
<tr>
<td style="border:1px solid black;">
x64 tabanlı sistemler için Windows 7 üzerinde Windows Media Player 12
</td>
<td style="border:1px solid black;">
**Önemli**   
Uzaktan Kod Yürütme
...
<tr class="alternateRow">
<td style="border:1px solid black;">
x64 tabanlı sistemler için Windows Server 2008 R2 üzerinde Windows Media Player 12\*\*
</td>
<td style="border:1px solid black;">
**Orta**   
Uzaktan Kod Yürütme
...
<span></span>
Windows Media Player'ın bir Web tarayıcısı aracılığıyla yeniden yükleme işlemi sırasında nesneleri serbest bırakma biçiminde, bir uzaktan kod yürütme güvenlik açığı bulunmaktadır. Bu güvenlik açığı, bir kullanıcı özel hazırlanmış bir Web sayfasını ziyaret ederse kod yürütülmesine olanak verebilir. Kullanıcı yönetimsel haklarla oturum açtıysa, bu güvenlik açığından başarıyla yararlanan bir saldırgan etkilenen sistemin denetimini tümüyle ele geçirebilir. Saldırgan, program yükleyebilir; verileri görüntüleyebilir, değiştirebilir veya silebilir; tüm kullanıcı haklarına sahip olan yeni hesaplar oluşturabilir. Hesapları, sistemde az sayıda kullanıcı hakkıyla yapılandırılmış olan kullanıcılar, yönetici haklarıyla çalışan kullanıcılardan daha az etkilenebilir.

Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2010-2745](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2745).

#### Windows Media Player'da Bellek Bozulması Güvenlik Açığı - CVE-2010-2745 için Azaltıcı Etkenler
...
-   Windows Server 2008'in ve Windows Server 2008 R2'nin desteklenen sürümleri, Masaüstü Deneyimi özelliği yüklü değilse bu sorundan etkilenmezler. Varsayılan olarak, bu platformlar etkilenen Windows Media Player bileşenini yüklemez. Masaüstü Deneyimi özelliği hakkında daha fazla bilgi için, [Masaüstü Deneyimi'ne Genel Bakış](http://technet.microsoft.com/en-us/library/cc772567.aspx) adlı TechNet makalesine bakın.

#### Windows Media Player'da Bellek Bozulması Güvenlik Açığı - CVE-2010-2745 için Geçici Çözümler

Geçici çözüm, arka plandaki güvenlik açığını gidermeyen ama güvenlik açığı uygulanmadan önceki bilinen saldırı vektörlerinin engellenmesine yardımcı olan bir ayar veya yapılandırma değişikliği anlamına gelir. Microsoft aşağıdaki geçici çözümleri sınamıştır ve bir geçici çözümün işlevselliği azaltıp azaltmadığı ilgili açıklamada belirtilmektedir:

-   **Wmp.dll dosyasının kaydını kaldırın**

    Bu DLL dosyasının kaydını kaldırmak için, ayrıcalığı yükseltilmiş bir komut isteminde aşağıdaki komutları çalıştırın.
    ...
    **Geçici çözümün etkisi.** Windows Media Player desteklenen dosya biçimlerini yürütemez.
...
#### Windows Media Player'da Bellek Bozulması Güvenlik Açığı - CVE-2010-2745 Hakkında SSS
...
Windows Media Player bir Web tarayıcısı aracılığıyla yeniden yükleme işlemi sırasında nesneleri düzgün şekilde serbest bırakmaz.
...
**Sistemimde hangi Windows Media Player sürümünün yüklü olduğunu nasıl belirlerim?**  
Sisteminizde yüklü olan Windows Media Player sürümünü belirleme ile ilgili yönergeler için, bkz: [Microsoft Bilgi Bankası makalesi 190990](http://support.microsoft.com/kb/190990).

**Bu güvenlik açığından yararlanılabilmesi için kullanıcı etkileşimi gerekiyor mu?**  
Evet. Bir saldırının başarılı olabilmesi için, kullanıcının bir Web sayfasına gözatarken bir veya daha fazla açılır iletişim kutusundaki öğeleri tıklatması gerekir. Bu güvenlik açığından, özel hazırlanmış bir Web sayfası ziyaret edilirken otomatik olarak yararlanılamaz.
...
Bir saldırgan, bu güvenlik açığından Windows Media Player yardımıyla yararlanacak ve kullanıcıyı Web sitesini görüntülemeye ikna edecek biçimde özel olarak tasarlanmış bir Web sitesi barındırabilir. Yararlanma girişiminin başarılı olması için, kullanıcının bir veya daha fazla açılır iletişim kutusundaki öğeleri tıklatması gerekir. Ayrıca, kullanıcı tarafından sağlanan içeriği kabul eden ya da barındıran güvenliği aşılmış Web sitelerinde, bu güvenlik açığından yararlanılabilecek özel hazırlanmış içerik bulunabilir. Saldırganın, bir kullanıcıyı özel hazırlanmış bir Web sitesini ziyaret etmeye zorlama yolu yoktur. Bunun yerine, saldırganın kullanıcıları bir e-posta iletisindeki veya Instant Messenger iletisindeki kendi Web sitesine götüren bir bağlantıyı tıklatmaya ikna ederek onları bu siteye çekmesi gerekir.
...
Güncelleştirme, Windows Media Player'ın yeniden yükleme işlemi sırasında nesneleri serbest bırakma biçimini düzelterek bu sorunu giderir.
...
<td style="border:1px solid black;">Windows XP Service Pack 3 üzerinde Windows Media Player 9, Windows Media Player 10 ve Windows Media Player 11:<br />
windowsxp-windowsmedia-kb2378111-x86-trk.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition Service Pack 2 üzerinde Windows Media Player 10:<br />
windowsserver2003.windowsxp-kb2378111-x64-trk.exe /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition Service Pack 2 üzerinde Windows Media Player 11:<br />
windowsmedia11-kb2378111-x64-trk.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">Windows XP Service Pack 3 üzerinde Windows Media Player 9:<br />
windowsxp-windowsmedia-kb2378111-x86-trk.exe /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Service Pack 3 üzerinde Windows Media Player 10 ve Windows Media Player 11:<br />
windowsxp-windowsmedia-kb2378111-x86-trk.exe /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition Service Pack 2 üzerinde Windows Media Player 10:<br />
windowsserver2003.windowsxp-kb2378111-x64-trk.exe /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition Service Pack 2 üzerinde Windows Media Player 11:<br />
windowsmedia11-kb2378111-x64-trk.exe /norestart</td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;">Denetim Masası'ndaki <strong>Program Ekle veya Kaldır</strong> aracını veya aşağıdaki konumlarda bulunan Spuninst.exe yardımcı programını kullanın:<br />
<br />
Windows XP Service Pack 3 üzerinde Windows Media Player 9, Windows Media Player 10 ve Windows Media Player 11:<br />
%Windir%\$NTUninstallKB2378111_WM9$\Spuninst klasörü<br />
<br />
Windows XP Professional x64 Edition Service Pack 2 üzerinde Windows Media Player 10:<br />
%Windir%\$NTUninstallKB2378111$\Spuninst klasörü<br />
<br />
Windows XP Professional x64 Edition Service Pack 2 üzerinde Windows Media Player 11:<br />
%Windir%\$NTUninstallKB2378111_WM11x64$\Spuninst klasörü</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Dosya Bilgileri</strong></td>
<td style="border:1px solid black;">Bkz: <a href="http://support.microsoft.com/kb/2378111">Microsoft Bilgi Bankası makalesi 2378111</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Kayıt Defteri Anahtarı Doğrulaması</strong></td>
<td style="border:1px solid black;">Windows XP'nin desteklenen 32-bit sürümleri üzerinde Windows Media Player 9, Media Player 10 ve Windows Media Player 11:<br />
...
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP'nin tüm desteklenen x64 tabanlı sürümleri üzerinde Windows Media Player 10:<br />
...
windowsserver2003-kb2378111-x86-trk.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen 32 bit sürümleri:<br />
windowsserver2003-kb2378111-x86-trk.exe /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen x64 tabanlı sürümleri:<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>Kaldırma Bilgileri</strong></td>
<td style="border:1px solid black;">Denetim Masası'ndaki <strong>Program Ekle veya Kaldır</strong> aracını veya %Windir%\$NTUninstallKB2378111$\Spuninst klasöründe bulunan Spuninst.exe yardımcı programını kullanın</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Dosya Bilgileri</strong></td>
<td style="border:1px solid black;">Bkz: <a href="http://support.microsoft.com/kb/2378111">Microsoft Bilgi Bankası makalesi 2378111</a></td>
...
-   [Google Inc.](http://www.google.com/) bünyesindeki Skylined, Windows Media Player'da Bellek Bozulması Güvenlik Açığı'nı (CVE-2010-2745) bildirdikleri için
...
-   V1.1 (13 Ekim 2010): Windows XP Professional x64 Edition Service Pack 2 üzerinde Windows Media Player 11 için **Etkilenen Yazılımlar** tablosundaki karşıdan yükleme bağlantısı düzeltildi. Otomatik güncelleştirme özelliğiyle bu paketi zaten yüklemiş olan müşterilerin herhangi bir işlem gerçekleştirmeleri gerekmez. Bu paketi Microsoft Yükleme Merkezi'nden el ile yüklemiş olan müşteriler bu yeni paketi el ile yüklemelidir.
