---
TOCTitle: 'MS10-097'
Title: 'Microsoft Güvenlik Bülteni MS10-097 - Önemli'
ms:assetid: 'ms10-097'
ms:contentKeyID: 61235632
ms:mtpsurl: 'https://technet.microsoft.com/tr-TR/library/ms10-097(v=Security.10)'
---

Security Bulletin

Microsoft Güvenlik Bülteni MS10-097 - Önemli
============================================

Internet Bağlantısı Oturum Açma Sihirbazı'nda Güvenli Olmayan Şekilde Kitaplık Yükleme Uzaktan Kod Yürütülmesine İzin Verebilir (2443105)
-----------------------------------------------------------------------------------------------------------------------------------------
...
|---------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------|----------------------|---------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=fa9a1aac-b9c5-4d4e-9083-a080ad4ccc6f)                              | Uzaktan Kod Yürütme       | Önemli               | Yok                                         |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=6dabc306-c858-46b1-815c-cd8d011ff62e)     | Uzaktan Kod Yürütme       | Önemli               | Yok                                         |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=8fa2cfa4-a01d-4910-b69f-736aeb585bab)                     | Uzaktan Kod Yürütme       | Önemli               | Yok                                         |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=17b0b340-73b2-42a7-9d86-1297c63dcc2b)         | Uzaktan Kod Yürütme       | Önemli               | Yok                                         |
| [Itanium tabanlı sistemler için Windows Server 2003 SP2](http://www.microsoft.com/downloads/details.aspx?familyid=04a178cc-1afd-4e47-8cab-05e402e5a568) | Uzaktan Kod Yürütme       | Önemli               | Yok                                         |
...
<th style="border:1px solid black;" >Internet Bağlantısı Oturum Açma Sihirbazı'nda Güvenli Olmayan Şekilde Kitaplık Yükleme Güvenlik Açığı - CVE-2010-3144</th>
...
Internet Bağlantısı Oturum Açma Sihirbazı'nda Güvenli Olmayan Şekilde Kitaplık Yükleme Güvenlik Açığı - CVE-2010-3144  
---------------------------------------------------------------------------------------------------------------------
  
<span></span>
Microsoft Windows'un bir bileşeni olan Internet Bağlantısı Oturum Açma Sihirbazı'nın DLL dosyalarını yükleme biçiminde bir uzaktan kod yürütme güvenlik açığı bulunmaktadır. Bu açığı başarıyla kullanan bir saldırgan, etkilenen sistemin tüm denetimini ele geçirebilir. Saldırgan, program yükleyebilir; verileri görüntüleyebilir, değiştirebilir veya silebilir; tüm kullanıcı haklarına sahip olan yeni hesaplar oluşturabilir. Hesapları, sistemde az sayıda kullanıcı hakkıyla yapılandırılmış olan kullanıcılar, yönetici haklarıyla çalışan kullanıcılardan daha az etkilenebilir.
  
Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2010-3144](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3144).
  
#### Internet Bağlantısı Oturum Açma Sihirbazı'nda Güvenli Olmayan Şekilde Kitaplık Yükleme Güvenlik Açığı - CVE-2010-3144 için Azaltıcı Etkenler
...
#### Internet Bağlantısı Oturum Açma Sihirbazı'nda Güvenli Olmayan Şekilde Kitaplık Yükleme Güvenlik Açığı - CVE-2010-3144 için Geçici Çözümler
...
#### Internet Bağlantısı Oturum Açma Sihirbazı'nda Güvenli Olmayan Şekilde Kitaplık Yükleme Güvenlik Açığı - CVE-2010-3144 Hakkında SSS
...
Bu güvenlik açığı, Internet Bağlantısı Oturum Açma Sihirbazı'nın dış kitaplıkları yüklemek için kullanılan yolu hatalı şekilde kısıtlaması nedeniyle ortaya çıkar.
  
**Internet Bağlantısı Oturum Açma Sihirbazı nedir?**  
Internet Bağlantısı Oturum Açma Sihirbazı, kullanıcıların yeni bir bilgisayarda bir bağlantıyı yapılandırmalarına veya daha eski bir bilgisayarda kullandıkları varolan bir Internet hizmeti hesabını kullanmalarına olanak verir. Bu sihirbaz ayrıca Internet ayarları bozulmuş olan kullanıcılara da yardım eder. Otomatik yapılandırma özelliği, ayarları geri yükler; kullanıcının yalnızca kullanıcı kimliğini, parolayı ve iletişim noktası (POP) sunucusunun adını sağlaması yeterlidir.
...
Saldırgan bir kullanıcıyı özel hazırlanmış bir dinamik bağlantı kitaplığı (DLL) dosyasıyla aynı ağ dizininde bulunan meşru bir .ins veya .isp dosyasını açmaya ikna edebilir. Daha sonra, dosyanın açıldığı sırada Internet Bağlantısı Oturum Açma Sihirbazı bu DLL dosyasını yüklemeyi ve içerdiği kodu yürütmeyi deneyebilir.
  
E-posta tabanlı saldırı senaryosunda, saldırgan bir kullanıcıya meşru bir .ins veya .isp eki gönderip kullanıcıyı bu eki özel hazırlanmış bir DLL dosyası içeren bir dizine yerleştirmeye ve .ins veya .isp dosyasını açmaya ikna ederek bu güvenlik açığından yararlanabilir. Daha sonra, .ins veya .isp dosyasının açıldığı sırada Internet Bağlantısı Oturum Açma Sihirbazı bu DLL dosyasını yüklemeyi ve içerdiği kodu yürütmeyi deneyebilir.
  
Ağ senaryosunda, saldırgan bir UNC veya WebDAV konumuna meşru bir .ins veya .isp dosyası ve özel hazırlanmış bir DLL dosyası yerleştirebilir ve kullanıcıyı bu meşru dosyayı açmaya ikna edebilir. Saldırgan ayrıca bir Web sitesi barındırabilir ve meşru dosyaya bu Web sitesinden başvurarak güvenlik açığının bir Web tarayıcısı aracılığıyla tetiklenmesini sağlayabilir.
...
Güncelleştirme, Internet Bağlantısı Oturum Açma Sihirbazı'nın dış kitaplıkları yükleme biçimini düzelterek bu güvenlik açığını giderir.
  
**Bu güvenlik bülteni yayımlandığında bu güvenlik açığı genel olarak duyurulmuş muydu?**  
Evet. Bu güvenlik açığı genel olarak duyurulmuştur. Ortak Güvenlik Açığı ve Etkilenme (Common Vulnerability and Exposure) numarası olarak [CVE-2010-3144](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3144) atanmıştır.
...
WindowsXP-KB2443105-x86-trk.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition Service Pack 2:<br />
WindowsServer2003.WindowsXP-KB2443105-x64-trk.exe /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">Windows XP Service Pack 3 için:<br />
WindowsXP-KB2443105-x86-trk.exe /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition Service Pack 2:<br />
WindowsServer2003.WindowsXP-KB2443105-x64-trk.exe /norestart</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">Denetim Masası'ndaki <strong>Program Ekle veya Kaldır</strong> aracını veya %Windir%\$NTUninstallKB2443105$\Spuninst klasöründe bulunan Spuninst.exe yardımcı programını kullanın</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Dosya Bilgileri</strong></td>
<td style="border:1px solid black;">Bkz: <a href="http://support.microsoft.com/kb/2443105">Microsoft Bilgi Bankası makalesi 2443105</a></td>
</tr>
<tr class="even">
...
WindowsServer2003-KB2443105-x86-trk.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
WindowsServer2003-KB2443105-ia64-trk.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen 32 bit sürümleri:<br />
WindowsServer2003-KB2443105-x86-trk.exe /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen x64 tabanlı sürümleri:<br />
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen Itanium tabanlı sürümleri:<br />
WindowsServer2003-KB2443105-ia64-trk.exe /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Güncelleştirme günlük dosyası</td>
<td style="border:1px solid black;">KB2443105.log</td>
...
-   [NGS Software](http://www.ngssoftware.com/) için çalışan Muhaimin Dzulfakar, Internet Bağlantısı Oturum Açma Sihirbazı'nda Güvenli Olmayan Şekilde Kitaplık Yükleme Güvenlik Açığı'nı (CVE-2010-3144) bildirdiği için
