---
TOCTitle: 'MS10-056'
Title: 'Microsoft Güvenlik Bülteni MS10-056 - Kritik'
ms:assetid: 'ms10-056'
ms:contentKeyID: 61235591
ms:mtpsurl: 'https://technet.microsoft.com/tr-TR/library/ms10-056(v=Security.10)'
---

Security Bulletin

Microsoft Güvenlik Bülteni MS10-056 - Kritik
============================================

Microsoft Office Word'deki Güvenlik Açıkları Uzaktan Kod Yürütülmesine İzin Verebilir (2269638)
-----------------------------------------------------------------------------------------------
...
Bu güvenlik güncelleştirmesi Microsoft Office Word 2007'nin tüm desteklenen sürümleri için Kritik olarak derecelendirilmiştir. Güvenlik güncelleştirmesi ayrıca Microsoft Office Word 2002, Microsoft Office Word 2003, Mac için Microsoft Office 2004, Mac için Microsoft Office 2008, Mac için Açık XML Dosya Biçimi Dönüştürücüsü, Works 9 ve Microsoft Office Word Viewer'ın ve Microsoft Office Uyumluluk Paketi'nin tüm desteklenen sürümleri için Önemli olarak derecelendirilmiştir. Daha fazla bilgi için, bu bölümdeki **Etkilenen ve Etkilenmeyen Yazılımlar** alt bölümüne bakın.

Güncelleştirme, Microsoft Office Word'ün özel hazırlanmış Word dosyalarını açma ve zengin metin biçimindeki verilerin belirli özelliklerini işleme biçimini değiştirerek bu güvenlik açıklarını giderir. Bu güvenlik açığı hakkında daha fazla bilgi için, bir sonraki bölüm olan **Güvenlik Açığı Bilgileri** altında, ilgili güvenlik açığı girdisinin Sık Sorulan Sorular (SSS) alt bölümüne bakın.

**Öneri.** Microsoft, müşterilerinin güncelleştirmeyi hemen uygulamasını önerir.

**Bilinen Sorunlar.** [Microsoft Bilgi Bankası makalesi 2269638](http://support.microsoft.com/kb/2269638), bu güvenlik güncelleştirmesini yükleyen müşterilerin karşılaşabileceği bilinen sorunları belgelemektedir. Bu makale ayrıca, bu sorunlar için önerilen çözümleri de içermektedir.
...
<sup>[1]</sup>Microsoft Office Word 2007 Service Pack 2 için, müşterilerin bu bültende açıklanan güvenlik açıklarına karşı korunmak üzere güvenlik güncelleştirmesi paketi KB2251419'nin yanı sıra, Word, Excel ve PowerPoint 2007 Dosya Biçimleri için Microsoft Office Uyumluluk Paketi Service Pack 2 (KB2277947) güvenlik güncelleştirmesini de yüklemeleri gerekmektedir.

**Etkilenmeyen Yazılımlar**

| Office ve Diğer Etkilenen Yazılımlar         |
|----------------------------------------------|
| Microsoft Office Word 2010 (32-bit sürümler) |
| Microsoft Office Word 2010 (64-bit sürümler) |
...
Güvenlik açıkları Microsoft Office Word'de bulunduğu için Outlook doğrudan etkilenmez. Ancak e-posta okuyucusu olarak Word seçildiyse (Microsoft Office Outlook 2007'deki varsayılan ayar bu şekildedir), saldırgan hedeflenen kullanıcıya RTF olarak özel hazırlanmış bir e-posta iletisi göndermek yoluyla, e-postayla saldırı vektörü olarak Outlook'tan yararlanabilir.
...
Microsoft Office Word Viewer, Word Viewer 2003'ün ve önceki tüm Word Viewer sürümlerinin yerini almıştır. Word Viewer ile, sisteminizde Word yüklü olmasa da Word belgelerini görüntüleyebilir, yazdırabilir ve kopyalayabilirsiniz. Günümüzde desteklenen Office görüntüleyicileri hakkında daha ayrıntılı bilgi için, bkz. [Office görüntüleyicilerinin desteklenen sürümleri](http://support.microsoft.com/kb/979860/en-us).

**Office tek başına programları bu güvenlik açığından nasıl etkileniyor?**  
Office tek başına programları, Office Paketi'ndeki karşılık gelen bileşen ile aynı önem derecesiyle etkilenmektedir. Örneğin Microsoft Office Word'ün tek başına yüklemesi, bir Office Paketi ile birlikte gelen Microsoft Office Word yüklemesi ile aynı önem derecesiyle etkilenir.
...
<th style="border:1px solid black;" >
Word'de Kayıt Ayrıştırma Güvenlik Açığı - CVE-2010-1900
</th>
<th style="border:1px solid black;" >
Word'de RTF Ayrıştırma Altyapısında Bellek Bozulması Güvenlik Açığı - CVE-2010-1901
</th>
<th style="border:1px solid black;" >
Word'de RTF Ayrıştırma Sırasında Arabellek Taşması Güvenlik Açığı - CVE-2010-1902
</th>
<th style="border:1px solid black;" >
Word'de HTML Bağlı Nesnelerinde Bellek Bozulması Güvenlik Açığı - CVE-2010-1903
</th>
<th style="border:1px solid black;" >
Toplam Önem Derecesi
</th>
...
<span></span>
Microsoft Office Word'ün özel hazırlanmış bir Word dosyasının içindeki hatalı biçimlendirilmiş kayıtları işleme biçiminde bir uzaktan kod yürütme güvenlik açığı bulunmaktadır. Bu açığı başarıyla kullanan bir saldırgan, etkilenen sistemin tüm denetimini ele geçirebilir. Saldırgan, program yükleyebilir; verileri görüntüleyebilir, değiştirebilir veya silebilir; tüm kullanıcı haklarına sahip olan yeni hesaplar oluşturabilir. Hesapları, sistemde az sayıda kullanıcı hakkıyla yapılandırılmış olan kullanıcılar, yönetici haklarıyla çalışan kullanıcılardan daha az etkilenebilir.

Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2010-1900](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1900).

#### Word'de Kayıt Ayrıştırma Güvenlik Açığı - CVE-2010-1900 için Azaltıcı Etkenler
...
#### Word'de Kayıt Ayrıştırma Güvenlik Açığı - CVE-2010-1900 için Geçici Çözümler
...
-   **Güvenilmeyen kaynaklardan gelen veya güvenilen kaynaklardan beklemediğiniz halde gelen Word dosyalarını açmayın**

    Güvenilmeyen kaynaklardan gelen veya güvenilen kaynaklardan beklemediğiniz halde gelen Word dosyalarını açmayın. Kullanıcı özel hazırlanmış bir dosyayı açtığında bu güvenlik açığından yararlanılabilir.

#### Word'de Kayıt Ayrıştırma Güvenlik Açığı - CVE-2010-1900 Hakkında SSS
...
Microsoft Office Word özel hazırlanmış bir Word dosyasını açtığında, sistem belleğini bir saldırganın rasgele kod yürütmesine olanak verecek şekilde bozabilir.
...
Güncelleştirme, Microsoft Office Word'ün özel hazırlanmış Word dosyalarını açma biçimini değiştirerek bu güvenlik açığını giderir.
...
<span></span>
Microsoft Office Word'ün zengin metin biçimindeki verileri ayrıştırma biçiminde bir uzaktan kod yürütme güvenlik açığı bulunmaktadır. Bu güvenlik açığından başarıyla yararlanan bir saldırgan, yerel kullanıcı ile aynı haklara sahip olabilir. Hesapları, sistemde az sayıda kullanıcı hakkıyla yapılandırılmış olan kullanıcılar, yönetici haklarıyla çalışan kullanıcılardan daha az etkilenebilir.

Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2010-1901](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1901).

#### Word'de RTF Ayrıştırma Altyapısında Bellek Bozulması Güvenlik Açığı - CVE-2010-1901 için Azaltıcı Etkenler

Azaltıcı etken, varolan bir durumda bulunan ve güvenlik açığından yararlanılmasının önem derecesini azaltabilecek bir ayar, genel yapılandırma ya da en iyi uygulama anlamına gelir. Sizin durumunuzda aşağıdaki azaltıcı etkenler işinize yarayabilir

-   Bu güvenlik açığından başarıyla yararlanan bir saldırgan, yerel kullanıcı ile aynı haklara sahip olabilir. Hesapları, sistemde az sayıda kullanıcı hakkıyla yapılandırılmış olan kullanıcılar, yönetici haklarıyla çalışan kullanıcılardan daha az etkilenebilir.

#### Word'de RTF Ayrıştırma Altyapısında Bellek Bozulması Güvenlik Açığı - CVE-2010-1901 için Geçici Çözümler
...
#### Word'de RTF Ayrıştırma Altyapısında Bellek Bozulması Güvenlik Açığı - CVE-2010-1901 Hakkında SSS

**Bu güvenlik açığının kapsamı nedir?**  
Bu bir uzaktan kod yürütme güvenlik açığıdır. Bu güvenlik açığından başarıyla yararlanan bir saldırgan, etkilenen sistemin tüm denetimini uzaktan ele geçirebilir. Saldırgan, program yükleyebilir; verileri görüntüleyebilir, değiştirebilir veya silebilir; tüm kullanıcı haklarına sahip olan yeni hesaplar oluşturabilir.

**Güvenlik açığına ne neden olmaktadır?**  
Microsoft Office Word zengin metin biçimindeki verileri işlerken yeterli veri doğrulaması gerçekleştirmez. Word, RTF biçiminde özel hazırlanmış bir e-posta iletisini veya dosyayı açıp ayrıştırdığında, sistem belleğini bir saldırganın rasgele kod yürütmesine olanak verecek şekilde bozabilir.
...
**Bir saldırgan güvenlik açığından nasıl yararlanabilir?**  
E-posta tabanlı saldırı senaryosunda, e-posta görüntüleyicisi olarak Word kullanılıyorsa, saldırgan kullanıcıya özel hazırlanmış bir RTF dosyasını ek olarak veya bir e-posta iletisinin içeriği olarak gönderip kullanıcıyı RTF biçiminde özel hazırlanmış e-posta iletisini Outlook'ta görüntülemeye ikna ederek bu güvenlik açığından yararlanabilir.
...
**Bu güvenlik açığından birincil derecede hangi sistemler etkileniyor?**  
Microsoft Office Word'ün yüklü olduğu iş istasyonları ve terminal sunucuları birincil derecede risk altındadır. Yöneticiler kullanıcıların sunucularda oturum açmalarına ve program çalıştırmalarına izin verirse sunucular daha fazla etkilenebilir. Ancak, en iyi uygulamalarda buna izin verilmesi kesinlikle önerilmemektedir.

**Güncelleştirme ne yapıyor?**  
Güncelleştirme, Word'ün zengin metin biçimindeki verilerin belirli özelliklerini işleme biçimini değiştirerek bu güvenlik açığını giderir.
...
<span></span>
Microsoft Office Word'ün zengin metin biçimindeki belirli verileri ayrıştırma biçiminde bir uzaktan kod yürütme güvenlik açığı bulunmaktadır. Bu güvenlik açığından başarıyla yararlanan bir saldırgan, yerel kullanıcı ile aynı haklara sahip olabilir. Hesapları, sistemde az sayıda kullanıcı hakkıyla yapılandırılmış olan kullanıcılar, yönetici haklarıyla çalışan kullanıcılardan daha az etkilenebilir.

Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2010-1902](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1902).

#### Word'de RTF Ayrıştırma Sırasında Arabellek Taşması Güvenlik Açığı - CVE-2010-1902 için Azaltıcı Etkenler

Azaltıcı etken, varolan bir durumda bulunan ve güvenlik açığından yararlanılmasının önem derecesini azaltabilecek bir ayar, genel yapılandırma ya da en iyi uygulama anlamına gelir. Sizin durumunuzda aşağıdaki azaltıcı etkenler işinize yarayabilir:

-   Bu güvenlik açığından başarıyla yararlanan bir saldırgan, yerel kullanıcı ile aynı haklara sahip olabilir. Hesapları, sistemde az sayıda kullanıcı hakkıyla yapılandırılmış olan kullanıcılar, yönetici haklarıyla çalışan kullanıcılardan daha az etkilenebilir.

#### Word'de RTF Ayrıştırma Sırasında Arabellek Taşması Güvenlik Açığı - CVE-2010-1902 için Geçici Çözümler
...
#### Word'de RTF Ayrıştırma Sırasında Arabellek Taşması Güvenlik Açığı - CVE-2010-1902 Hakkında SSS

**Bu güvenlik açığının kapsamı nedir?**  
Bu bir uzaktan kod yürütme güvenlik açığıdır. Bu güvenlik açığından başarıyla yararlanan bir saldırgan, etkilenen sistemin tüm denetimini uzaktan ele geçirebilir. Saldırgan, program yükleyebilir; verileri görüntüleyebilir, değiştirebilir veya silebilir; tüm kullanıcı haklarına sahip olan yeni hesaplar oluşturabilir.

**Güvenlik açığına ne neden olmaktadır?**  
Microsoft Office Word zengin metin biçimindeki verileri işlerken yeterli veri doğrulaması gerçekleştirmez. Word, özel hazırlanmış bir e-posta iletisini veya dosyayı açıp ayrıştırdığında, sistem belleğini bir saldırganın rasgele kod yürütmesine olanak verecek şekilde bozabilir.
...
<span></span>
Microsoft Office Word'ün hatalı biçimlendirilmiş bir kayıt içeren özel hazırlanmış bir Word dosyasını işleme biçiminde bir uzaktan kod yürütme güvenlik açığı bulunmaktadır. Bu açığı başarıyla kullanan bir saldırgan, etkilenen sistemin tüm denetimini ele geçirebilir. Saldırgan, program yükleyebilir; verileri görüntüleyebilir, değiştirebilir veya silebilir; tüm kullanıcı haklarına sahip olan yeni hesaplar oluşturabilir. Hesapları, sistemde az sayıda kullanıcı hakkıyla yapılandırılmış olan kullanıcılar, yönetici haklarıyla çalışan kullanıcılardan daha az etkilenebilir.

Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2010-1903](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1903).

#### Word'de HTML Bağlı Nesnelerinde Bellek Bozulması Güvenlik Açığı - CVE-2010-1903 için Azaltıcı Etkenler
...
#### Word'de HTML Bağlı Nesnelerinde Bellek Bozulması Güvenlik Açığı - CVE-2010-1903 için Geçici Çözümler
...
#### Word'de HTML Bağlı Nesnelerinde Bellek Bozulması Güvenlik Açığı - CVE-2010-1903 Hakkında SSS
...
| 2007 Microsoft Office Sistemi Service Pack 2                                                         | Evet       |
...
| Microsoft Office Word Viewer                                                                         | Evet       |
...
| 2007 Microsoft Office Sistemi Service Pack 2                                                         | Hayır   | Hayır                      | Evet                       | Evet                       |
...
| Microsoft Office Word Viewer                                                                         | Hayır   | Hayır                      | Evet                       | Evet                       |
...
<td style="border:1px solid black;">OfficeXP-kb2251389-fullfile-trk.exe /q:a</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">OfficeXP-kb2251389-fullfile-trk.exe /r:n</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">Bkz: <a href="http://support.microsoft.com/kb/2251389">Microsoft Bilgi Bankası makalesi 2251389</a></td>
</tr>
<tr class="even">
...
#### Word 2003 (tüm sürümler) ve Word Viewer
...
Office2003-kb2251399-fullfile-trk.exe /q:a</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Word Viewer:<br />
Office-kb2251437-fullfile-trk.exe /q:a</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">Word 2003:<br />
Office2003-kb2251399-fullfile-trk.exe /r:n</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Word Viewer:<br />
Office-kb2251437-fullfile-trk.exe /r:n</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Güncelleştirme günlük dosyası</td>
<td style="border:1px solid black;">Uygulanamaz</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Dosya Bilgileri</strong></td>
<td style="border:1px solid black;">Word 2003 için, bkz. <a href="http://support.microsoft.com/kb/2251399">Microsoft Bilgi Bankası makalesi 2251399</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Word Viewer için, bkz. <a href="http://support.microsoft.com/kb/2251437">Microsoft Bilgi Bankası makalesi 2251437</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Kayıt Defteri Anahtarı Doğrulaması</strong></td>
<td style="border:1px solid black;">Uygulanamaz</td>
...
#### Word 2007 (tüm sürümler) ve Word, Excel ve PowerPoint 2007 Dosya Biçimleri için Microsoft Office Uyumluluk Paketi (tüm sürümler)
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Dosya Bilgileri</strong></td>
<td style="border:1px solid black;">Word 2007 için, bkz. <a href="http://support.microsoft.com/kb/2251419">Microsoft Bilgi Bankası makalesi 2251419</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Word, Excel ve PowerPoint 2007 Dosya Biçimleri için Microsoft Office Uyumluluk Paketi için, bkz. <a href="http://support.microsoft.com/kb/2277947">Microsoft Bilgi Bankası makalesi 2277947</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Kayıt Defteri Anahtarı Doğrulaması</strong></td>
<td style="border:1px solid black;">Uygulanamaz</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Dosya Bilgileri</strong></td>
<td style="border:1px solid black;">Bkz: <a href="http://support.microsoft.com/kb/2092914">Microsoft Bilgi Bankası makalesi 2092914</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Kayıt Defteri Anahtarı Doğrulaması</strong></td>
<td style="border:1px solid black;">Uygulanamaz</td>
...
-   [team509](http://www.team509.com/) için çalışan L.W.Z, [TippingPoint](http://www.tippingpoint.com/) bünyesindeki [Zero Day Initiative](http://www.zerodayinitiative.com/) ile birlikte çalışarak Word'de Kayıt Ayrıştırma Güvenlik Açığı'nı (CVE-2010-1900) bildirdikleri için  
-   [team509](http://www.team509.com/) için çalışan Wushi, [VeriSign iDefense Labs](http://labs.idefense.com/) ile birlikte çalışarak Word'de RTF Ayrıştırma Altyapısında Bellek Bozulması Güvenlik Açığı'nı (CVE-2010-1901) bildirdikleri için  
-   [team509](http://www.team509.com/), [VeriSign iDefense Labs](http://labs.idefense.com/) ile birlikte çalışarak Word'de RTF Ayrıştırma Sırasında Arabellek Taşması Güvenlik Açığı'nı (CVE-2010-1902) bildirdikleri için  
-   [Check Point](http://www.checkpoint.com/) IPS Research Team için çalışan Rodrigo Rubira Branco, Word'de HTML Bağlı Nesnelerinde Bellek Bozulması Güvenlik Açığı'nı (CVE-2010-1903) bildirdiği için  
-   Anonim bir araştırmacı, [TippingPoint](http://www.tippingpoint.com/) bünyesindeki [Zero Day Initiative](http://www.zerodayinitiative.com/) ile birlikte çalışarak Word'de HTML Bağlı Nesnelerinde Bellek Bozulması Güvenlik Açığı'nı (CVE-2010-1903) bildirdikleri için
...
-   V1.1 (11 Ağustos 2010): Microsoft Office Word Viewer ve Microsoft Office Uyumluluk Paketi için dağıtım başvuru tablolarındaki güncelleştirme paketi adları düzeltildi. Bu yalnızca bilgilendirme amaçlı bir değişikliktir. Güvenlik güncelleştirmesi dosyalarında veya algılama mantığında herhangi bir değişiklik yapılmamıştır.  
-   V1.2 (25 Ağustos 2010): Yürütmeyle İlgili Özet altındaki Bilinen Sorunlar bölümüne Microsoft Bilgi Bankası makalesi 2269638 için bir bağlantı eklendi.  
-   V1.3 (1 Eylül 2010): Etkilenen yazılımlar tablosuna, Word 2007 kullanan müşterilerin bu bültende açıklanan güvenlik açıklarına karşı korunabilmeleri için güvenlik güncelleştirmesi paketi KB2251419'un yanı sıra güvenlik güncelleştirmesi paketi KB2277947'yi de yüklemeleri gerektiğine yönelik bir not eklendi.
