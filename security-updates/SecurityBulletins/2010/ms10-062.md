---
TOCTitle: 'MS10-062'
Title: 'Microsoft Güvenlik Bülteni MS10-062 - Kritik'
ms:assetid: 'ms10-062'
ms:contentKeyID: 61235597
ms:mtpsurl: 'https://technet.microsoft.com/tr-TR/library/ms10-062(v=Security.10)'
---

Security Bulletin

Microsoft Güvenlik Bülteni MS10-062 - Kritik
============================================

MPEG-4 Codec Bileşeni'ndeki Güvenlik Açığı Uzaktan Kod Yürütülmesine İzin Verebilir (975558)
--------------------------------------------------------------------------------------------
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------|----------------------|---------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=2084a01c-2a91-4650-8665-7053015f2083)                                                                                           | Uzaktan Kod Yürütme       | Kritik               | Yok                                         |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=284a0e80-fd03-4909-b354-0478f04585a1)                                                                  | Uzaktan Kod Yürütme       | Kritik               | Yok                                         |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=0a942985-081f-455c-bf9d-4345392c91b0)                                                                                  | Uzaktan Kod Yürütme       | Kritik               | Yok                                         |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=284a0e80-fd03-4909-b354-0478f04585a1)                                                                      | Uzaktan Kod Yürütme       | Kritik               | Yok                                         |
| [Windows Vista Service Pack 1 ve Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=84629c25-7827-40c1-86fb-7ffa247202a0)                                                        | Uzaktan Kod Yürütme       | Kritik               | Yok                                         |
| [Windows Vista x64 Edition Service Pack 1 ve Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=36e2a74b-e5c6-47d5-9cd9-b9171be63c7d)                                | Uzaktan Kod Yürütme       | Kritik               | Yok                                         |
| [32-bit sistemler için Windows Server 2008 ve 32-bit sistemler için Windows Server 2008 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=fdfc393e-a54d-44dd-ba45-c2a550ffd2a1)\*\*           | Uzaktan Kod Yürütme       | Kritik               | Yok                                         |
| [x64 tabanlı sistemler için Windows Server 2008 ve x64 tabanlı sistemler için Windows Server 2008 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=1b7af424-6286-4a80-827c-c4df4f92fe43)\*\* | Uzaktan Kod Yürütme       | Kritik               | Yok                                         |
...
<th style="border:1px solid black;" >MPEG-4 Codec Bileşeni Güvenlik Açığı - CVE-2010-0818</th>
...
#### MPEG-4 Codec Bileşeni Güvenlik Açığı - CVE-2010-0818 için Geçici Çözümler
  
Geçici çözüm, arka plandaki güvenlik açığını gidermeyen ama güvenlik açığı uygulanmadan önceki bilinen saldırı vektörlerinin engellenmesine yardımcı olan bir ayar veya yapılandırma değişikliği anlamına gelir. Microsoft aşağıdaki geçici çözümleri sınamıştır ve bir geçici çözümün işlevselliği azaltıp azaltmadığı ilgili açıklamada belirtilmektedir:
  
-   **MPEG-4 sürüm 1 codec bileşenine erişimi kısıtlayın**
  
    MPEG-4 sürüm 1 codec bileşenine erişimi kısıtlamak için şu adımları gerçekleştirin:
    ...
    **Not** Kayıt Defteri Düzenleyicisi'nin yanlış kullanılması, işletim sisteminizi yeniden yüklemenizi gerektirebilecek ciddi sorunlara neden olabilir. Microsoft, Kayıt Defteri Düzenleyicisi'nin yanlış kullanılmasından kaynaklanan sorunların çözülebileceğini garanti etmemektedir. Kayıt Defteri Düzenleyicisi'ni kullanmak kendi sorumluluğunuzdadır. Kayıt defterini düzenlemeyle ilgili bilgi için, Kayıt Defteri Düzenleyicisi'ndeki (Regedit.exe) "Anahtarları ve Değerleri Değiştirmek " veya Regedt32.exe'deki "Kayıt Defterine Bilgi Eklemek veya Bilgileri Silmek " ve "Kayıt Defteri Verilerini Düzenlemek" adlı Yardım konularına bakın.
    ...
    1.  Aşağıdaki komutları içeren bir yönetilen dağıtım komut dosyası kullanarak kayıt defteri anahtarlarının bir yedek kopyasını oluşturun:  
        ...
        **Not** MPEG-4 codec bileşeninin sisteminizde yüklü olan sürümlerine bağlı olarak, yukarıdaki kayıt defteri anahtarlarından bazıları bulunmayabilir. Sistemde bulunmayan kayıt defteri anahtarları için yedekleme dosyası oluşturulmayacaktır.  
    2.  Aşağıdaki metni .REG uzantılı bir dosyaya kaydedin (örneğin, Restrict\_MPEG-4\_Workaround.reg):  
    ...
    **Geçici çözümün etkisi. **MPEG-4 sürüm 1 biçiminde kodlanmış dosyalar, MPEG-4 codec bileşenini kullanan Windows Media Player gibi uygulamalarda yürütülmez.
    ...
    **Not** Yukarıdaki kayıt defteri yedekleme dosyalarından bazıları bulunmayabilir. Bu geçici çözüm uygulanmadan önce sistemde bulunmayan kayıt defteri anahtarları için yedekleme dosyası oluşturulmamıştır.
  
#### MPEG-4 Codec Bileşeni Güvenlik Açığı - CVE-2010-0818 Hakkında SSS
...
Windows Media codec bileşenleriyle birlikte gelen MPEG-4 codec bileşeni, MPEG-4 video kodlaması kullanan özel hazırlanmış medya dosyalarını düzgün işlemez.
  
**Hangi MPEG-4 codec bileşeni bu güvenlik açığından etkilenen kodu içeriyor?**  
MPEG-4 sıkıştırma, yazma ve teslim de dahil multimedya sunumun birçok özelliklerini kapsayan bir Uluslararası Standartlar Kuruluşu (ISO) belirtimidir. MPEG-4 video kodunu açmak için kullanılan MPEG-4 codec bileşeni, güvenlik açığından etkilenen kodu içerir.
...
Codec, iki bileşenden oluşur: bir kodlayıcı ve bir kod çözücü. Kodlayıcı sıkıştırma (kodlama) işlevini, kod çözücü ise sıkıştırmayı açma (kod çözme) işlevini gerçekleştirir. Bazı codec bileşenlerinde bunların her ikisi de, bazılarında ise yalnızca biri bulunur. Örneğin ses CD'sindeki bir şarkıyı bilgisayarınıza aktardığınızda, Windows Media Player bu şarkıyı küçük bir WMA dosyası olarak sıkıştırmak için varsayılan olarak Windows Media Ses codec bileşenini kullanır. WMA dosyasını (veya bir Web sitesinden akış sağlanmış olabilecek herhangi bir WMA dosyasını) yürüttüğünüzde, Oynatıcı bu dosyanın sıkıştırmasını açmak için Windows Media Ses codec bileşenini kullanarak müziğin hoparlörlerinizden çalınmasını sağlar.
...
E-posta tabanlı saldırı senaryosunda, saldırgan kullanıcıya özel hazırlanmış bir MPEG-4 dosyasının katıştırılmış olduğu bir medya dosyası gönderip kullanıcıyı bu belgeyi açmaya ikna ederek bu güvenlik açığından yararlanabilir.
  
Saldırgan, bu güvenlik açığından bir Internet tarayıcısı aracılığıyla yararlanılacak şekilde özel olarak tasarlanmış medya içeriği bulunan kötü amaçlı bir Web sitesi barındırabilir ve daha sonra bir kullanıcıyı bu Web sitesini görüntüleyip özel hazırlanmış medya içeriğini açmaya ikna edebilir.
  
**Bu güvenlik açığından birincil derecede hangi sistemler etkileniyor?**  
Etkilenen yazılımların çalıştırıldığı sistemler birincil derecede risk altındadır.
  
**Güncelleştirme ne yapıyor?**  
Güncelleştirme, MPEG-4 codec bileşeninin özel hazırlanmış medya içeriğini işleme biçimini değiştirerek bu güvenlik açığını giderir.
...
WindowsXP-WindowsMedia-KB975558-x86-TRK.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition Service Pack 2:<br />
WindowsXP-SP2-X64-WindowsMedia-KB975558-x64-TRK.exe /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">Windows XP Service Pack 3 için:<br />
WindowsXP-WindowsMedia-KB975558-x86-TRK.exe /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition Service Pack 2:<br />
WindowsXP-SP2-X64-WindowsMedia-KB975558-x64-TRK.exe /norestart</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">Denetim Masası'ndaki <strong>Program Ekle veya Kaldır</strong> aracını veya %Windir%\$NTUninstallKB975558$\Spuninst klasöründe bulunan Spuninst.exe yardımcı programını kullanın</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Dosya Bilgileri</strong></td>
<td style="border:1px solid black;">Bkz: <a href="http://support.microsoft.com/kb/975558">Microsoft Bilgi Bankası makalesi 975558</a></td>
</tr>
<tr class="even">
...
Windows2003-SP2-WindowsMedia-KB975558-x86-TRK.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen 32 bit sürümleri:<br />
Windows2003-SP2-WindowsMedia-KB975558-x86-TRK.exe /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen x64 tabanlı sürümleri:<br />
...
-   [Sourcefire VRT](http://www.sourcefire.com/services/sf_vrt.html) için çalışan Matthew Watchinski, MPEG-4 Codec Bileşeni Güvenlik Açığı'nı (CVE-2010-0818) bildirdiği için
