---
TOCTitle: 'MS10-002'
Title: 'Microsoft Güvenlik Bülteni MS10-002 - Kritik'
ms:assetid: 'ms10-002'
ms:contentKeyID: 61235537
ms:mtpsurl: 'https://technet.microsoft.com/tr-TR/library/ms10-002(v=Security.10)'
---

Security Bulletin

Microsoft Güvenlik Bülteni MS10-002 - Kritik
============================================

Internet Explorer için Toplu Güvenlik Güncelleştirmesi (978207)
---------------------------------------------------------------

Yayım Tarihi: 21 Ocak 2010 Perşembe | Güncelleştirme Tarihi: 10 Şubat 2010 Çarşamba
...
Bu güvenlik güncelleştirmesi, Internet Explorer'ın tüm desteklenen sürümleri için Kritik olarak derecelendirilmiştir: Internet Explorer 5.01, Internet Explorer 6, Internet Explorer 6 Service Pack 1, Internet Explorer 7 ve Internet Explorer 8 (Windows Server 2003'ün desteklenen sürümleri üzerinde Internet Explorer 6 dışında). Windows Server 2003'ün desteklenen sürümleri üzerinde Internet Explorer 6 için, bu güncelleştirme Orta olarak derecelendirilmiştir. Daha fazla bilgi için, bu bölümdeki **Etkilenen ve Etkilenmeyen Yazılımlar** alt bölümüne bakın.

Bu güvenlik güncelleştirmesi Internet Explorer'ın bellekteki nesneleri işleme, giriş parametrelerini doğrulama ve HTML özniteliklerine filtre uygulama biçimini değiştirerek güvenlik açıklarını giderir. Bu güvenlik açıkları hakkında daha fazla bilgi için, bir sonraki bölüm olan **Güvenlik Açığı Bilgileri** altında, Sık Sorulan Sorular (SSS) alt bölümüne bakın.

Bu güvenlik güncelleştirmesi ilk olarak [Microsoft Güvenlik Danışma Belgesi 979352](http://technet.microsoft.com/security/advisory/979352)'de açıklanan güvenlik açığını da giderir.
...
<span></span>
**Bu güvenlik güncelleştirmesi MS10-007'de açıklanan CVE-2010-0027 ile nasıl ilişkilidir?**  
URL Doğrulaması Güvenlik Açığı (CVE-2010-0027), kullanıcının sisteminde yüklü olan Microsoft Windows sürümüne ve Internet Explorer sürümüne bağlı olarak, hem bu güncelleştirme (MS10-002) hem de [Windows Kabuğu İşleyicisi'ndeki Güvenlik Açığı Uzaktan Kod Yürütülmesine İzin Verebilir (MS10-007)](http://go.microsoft.com/fwlink/?linkid=179067) tarafından giderilmektedir.

Internet Explorer 6 Service Pack 1, Internet Explorer 7 ve Internet Explorer 8'de kullanılmaya başlanan ve güvenlik açığından etkilenen kodun erişildiği yerleri etkileyen mimari bir değişiklik nedeniyle iki farklı güncelleştirme bulunmaktadır.

Çalışma ortamınıza hangi güncelleştirmelerin uygulanacağını belirlemek için aşağıdaki tabloya başvurun.
...
<strong>Internet Explorer</strong> <br />
(MS10-002)</td>
<td style="border:1px solid black;">Hem<br />
<strong>Windows</strong> <br />
(<a href="http://go.microsoft.com/fwlink/?linkid=179067">MS10-007</a>)<br />
hem de<br />
<strong>Internet Explorer</strong> <br />
...
<tr class="odd">
<td style="border:1px solid black;">Windows XP Service Pack 3 ve Windows XP Professional x64 Edition Service Pack 2</td>
<td style="border:1px solid black;">Uygulanamaz</td>
<td style="border:1px solid black;">Uygulanamaz</td>
...
<tr class="even">
<td style="border:1px solid black;">Windows Server 2003, Windows Server 2003 x64 Edition ve Itanium tabanlı sistemler için Windows Server 2003'ün tüm desteklenen sürümleri</td>
<td style="border:1px solid black;">Uygulanamaz</td>
<td style="border:1px solid black;">Uygulanamaz</td>
<td style="border:1px solid black;"><strong>Windows</strong> <br />
(<a href="http://go.microsoft.com/fwlink/?linkid=179067">MS10-007</a>)</td>
...
<tr class="odd">
<td style="border:1px solid black;">Tüm desteklenen Windows Vista ve Windows Vista x64 Edition sürümleri</td>
<td style="border:1px solid black;">Uygulanamaz</td>
<td style="border:1px solid black;">Uygulanamaz</td>
<td style="border:1px solid black;">Uygulanamaz</td>
<td style="border:1px solid black;"><strong>Internet Explorer</strong> <br />
...
<tr class="even">
<td style="border:1px solid black;">32-bit sistemler için Windows Server 2008, x64 tabanlı sistemler için Windows Server 2008 ve Itanium tabanlı sistemler için Windows Server 2008'in tüm desteklenen sürümleri</td>
<td style="border:1px solid black;">Uygulanamaz</td>
<td style="border:1px solid black;">Uygulanamaz</td>
<td style="border:1px solid black;">Uygulanamaz</td>
<td style="border:1px solid black;"><strong>Internet Explorer</strong> <br />
...
<tr class="odd">
<td style="border:1px solid black;">32-bit sistemler için Windows 7 ve x64 tabanlı sistemler için Windows 7'nin tüm desteklenen sürümleri</td>
<td style="border:1px solid black;">Uygulanamaz</td>
<td style="border:1px solid black;">Uygulanamaz</td>
<td style="border:1px solid black;">Uygulanamaz</td>
<td style="border:1px solid black;">Uygulanamaz</td>
...
<tr class="even">
<td style="border:1px solid black;">x64 tabanlı sistemler için Windows Server 2008 R2 ve Itanium tabanlı sistemler için Windows Server 2008 R2'nin tüm desteklenen sürümleri</td>
<td style="border:1px solid black;">Uygulanamaz</td>
<td style="border:1px solid black;">Uygulanamaz</td>
<td style="border:1px solid black;">Uygulanamaz</td>
<td style="border:1px solid black;">Uygulanamaz</td>
...
Dosya bilgileri ayrıntıları [Microsoft Bilgi Bankası makalesi 978207](http://support.microsoft.com/kb/978207)'de bulunabilir.
...
<th style="border:1px solid black;" >
XSS Filtresi'nde Komut Dosyası İşleme Güvenlik Açığı - CVE-2009-4074
</th>
<th style="border:1px solid black;" >
URL Doğrulaması Güvenlik Açığı - CVE-2010-0027
</th>
<th style="border:1px solid black;" >
Başlatılmamış Belleğin Bozulması Güvenlik Açığı - CVE-2010-0244
</th>
<th style="border:1px solid black;" >
Başlatılmamış Belleğin Bozulması Güvenlik Açığı - CVE-2010-0245
</th>
<th style="border:1px solid black;" >
Başlatılmamış Belleğin Bozulması Güvenlik Açığı - CVE-2010-0246
</th>
<th style="border:1px solid black;" >
Başlatılmamış Belleğin Bozulması Güvenlik Açığı - CVE-2010-0247
</th>
<th style="border:1px solid black;" >
HTML Nesnesinde Bellek Bozulması Güvenlik Açığı - CVE-2010-0248
</th>
<th style="border:1px solid black;" >
HTML Nesnesinde Bellek Bozulması Güvenlik Açığı - CVE-2010-0249
</th>
<th style="border:1px solid black;" >
Toplam Önem Derecesi
</th>
...
<span></span>
Internet Explorer 8'in HTML özniteliğini devre dışı bırakma biçiminde, XSS filtresi atlanarak HTTP yanıt verilerinin düzgün filtrelenmemesine yol açabilecek bir güvenlik açığı bulunmaktadır. Bu güvenlik açığı, başlangıçta devre dışı bırakılan komut dosyalarını yanlış güvenlik bağlamında çalıştırarak bilginin açığa çıkmasına neden olabilir.

Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2009-4074](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-4074).

#### XSS Filtresi'nde Komut Dosyası İşleme Güvenlik Açığı - CVE-2009-4074 için Azaltıcı Etkenler

Azaltıcı etken, varolan bir durumda bulunan ve güvenlik açığından yararlanılmasının önem derecesini azaltabilecek bir ayar, genel yapılandırma ya da en iyi uygulama anlamına gelir. Sizin durumunuzda aşağıdaki azaltıcı etkenler işinize yarayabilir:

-   Internet Explorer 5.01 Service Pack 4, Internet Explorer 6.0, Internet Explorer 6 Service Pack 1 ve Internet Explorer 7 bu güvenlik açığından etkilenmez.

#### XSS Filtresi'nde Komut Dosyası İşleme Güvenlik Açığı - CVE-2009-4074 için Geçici Çözümler

Microsoft bu güvenlik açığı için herhangi bir geçici çözüm belirleyememiştir.

#### XSS Filtresi'nde Komut Dosyası İşleme Güvenlik Açığı - CVE-2009-4074 Hakkında SSS

**Bu güvenlik açığının kapsamı nedir?**  
Bu, bir bilginin açığa çıkması güvenlik açığıdır. Saldırgan, özel hazırlanmış bir Web sayfası oluşturarak veya meşru bir Web sitesine özel hazırlanmış içerik göndererek bu güvenlik açığından yararlanabilir. Bu güvenlik açığından başarıyla yararlanan bir saldırgan, komut dosyası kodunun üçüncü tarafa ait bir Web sitesi gibi davranarak başka bir kullanıcının makinesinde çalıştırılmasına neden olabilir. Bu türde bir komut dosyası kodu, üçüncü tarafa ait Web sitesi ziyaret edilirken tarayıcının içinde çalıştırılır ve kullanıcının bilgisayarında üçüncü tarafa ait Web sitesinin gerçekleştirmesine izin verilen tüm işlemleri gerçekleştirebilir. Bu güvenlik açığından yalnızca, kullanıcı bir HTML e-postasındaki köprü metnini tıklatırsa veya saldırganın Web sitesini ya da saldırganın denetimindeki içeriğin bulunduğu bir Web sitesini ziyaret ederse yararlanılabilir.

**Güvenlik açığına ne neden olmaktadır?**  
Internet Explorer belirli durumlarda, HTTP yanıt verilerini normalde düzgün filtreleyen bir HTML özniteliğini devre dışı bırakır. Sonuçta, bir saldırganın farklı bir Internet etki alanında oturum açmış kullanıcının bağlamında kod yürütmesine olanak verecek biçimde özel hazırlanmış bir Web sayfası yüklenebilir.

**Bir saldırgan bu güvenlik açığından yararlanarak neler yapabilir?**  
Bu güvenlik açığından başarıyla yararlanan bir saldırgan, komut dosyası kodunun üçüncü tarafa ait bir Web sitesi gibi davranarak başka bir kullanıcının makinesinde çalıştırılmasına neden olabilir. Bu türde bir komut dosyası kodu, üçüncü tarafa ait Web sitesi ziyaret edilirken tarayıcının içinde çalıştırılır ve kullanıcının bilgisayarında üçüncü tarafa ait Web sitesinin gerçekleştirmesine izin verilen tüm işlemleri gerçekleştirebilir. Bu güvenlik açığından yalnızca, kullanıcı bir HTML e-postasındaki köprü metnini tıklatırsa veya saldırganın Web sitesini ya da saldırganın denetimindeki içeriğin bulunduğu bir Web sitesini ziyaret ederse yararlanılabilir.

**Bir saldırgan güvenlik açığından nasıl yararlanabilir?**  
Saldırgan, bu güvenlik açığından yararlanılacak şekilde özel olarak tasarlanmış içeriği etkilenen bir Web sitesine gönderebilir. Saldırganın daha sonra kullanıcıyı bu Web sitesindeki içeriği görüntülemeye ikna etmesi gerekir. Kullanıcı meşru Web sitesine gözattığında, XSS filtresi özel hazırlanmış içeriğin HTML özniteliklerini devre dışı bırakarak, kötü amaçlı komut dosyalarının yanlış güvenlik bağlamında çalışmasına ve dolayısıyla bilginin açığa çıkmasına neden olabilecek bir koşul oluşturabilir.
...
Güncelleştirme, Internet Explorer'daki XSS filtresinin HTML özniteliklerini hatalı şekilde devre dışı bırakmasını engelleyerek bu güvenlik açığını giderir.
...
<span></span>
Internet Explorer'ın girişi hatalı şekilde doğrulaması nedeniyle bir uzaktan kod yürütme güvenlik açığı bulunmaktadır. Saldırgan, özel hazırlanmış bir URL oluşturarak bu güvenlik açığından yararlanabilir. Bir kullanıcı bu URL'yi tıklattığında, güvenlik açığı uzaktan kod yürütülmesine izin verebilir. Bu güvenlik açığından başarıyla yararlanan bir saldırgan, oturum açan kullanıcı ile aynı haklara sahip olabilir. Kullanıcı yönetimsel haklarla oturum açtıysa, bu güvenlik açığından başarıyla yararlanan bir saldırgan etkilenen sistemin denetimini tümüyle ele geçirebilir. Saldırgan, program yükleyebilir; verileri görüntüleyebilir, değiştirebilir veya silebilir; tüm kullanıcı haklarına sahip olan yeni hesaplar oluşturabilir.

Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2010-0027](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0027).

#### URL Doğrulaması Güvenlik Açığı - CVE-2010-0027 için Azaltıcı Etkenler
...
-   Internet Explorer 5.01 Service Pack 4, Internet Explorer 6.0 ve Internet Explorer 6 Service Pack 1 bu güvenlik açığından etkilenmez.

#### URL Doğrulaması Güvenlik Açığı - CVE-2010-0027 için Geçici Çözümler
...
#### URL Doğrulaması Güvenlik Açığı - CVE-2010-0027 Hakkında SSS
...
**Güvenlik açığına ne neden olmaktadır?**  
Internet Explorer özel hazırlanmış bir URL'yi işlediğinde, URL'yi doğrulamak için çağrılan kod, yerel istemci sisteminden bir ikili dosyayı yürütebilir.
...
**Bir saldırgan güvenlik açığından nasıl yararlanabilir?**  
Saldırgan, bir kullanıcıyı Internet Explorer tarafından düzgün şekilde doğrulanmayabilecek özel hazırlanmış bir bağlantıyı tıklatmaya ikna ederse sistemde kod yürütülebilir. Ancak bu durumların hiçbirinde, saldırganın kullanıcıyı bu URL'yi tıklatmaya zorlama yolu yoktur. Bunun yerine saldırgan, kullanıcıları bir e-posta iletisindeki veya Instant Messenger iletisindeki URL'yi tıklatmaya ikna etmesi gerekir. Etkilenen sistemlere Web içeriği ulaştırmak için başlık reklamları veya başka yöntemler kullanılarak da özel olarak oluşturulmuş Web içeriği görüntülenebilir.
...
**Güncelleştirme ne yapıyor?**  
Güncelleştirme, Internet Explorer'ın davranışını düzeltip giriş parametrelerinin yeterli düzeyde doğrulanmasını sağlayarak bu güvenlik açığını giderir.
...
Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2010-0244](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0244).

#### Başlatılmamış Belleğin Bozulması Güvenlik Açığı - CVE-2010-0244 için Azaltıcı Etkenler
...
#### Başlatılmamış Belleğin Bozulması Güvenlik Açığı - CVE-2010-0244 için Geçici Çözümler
...
-   **Internet Explorer 6 veya Internet Explorer 7 için DEP'yi etkinleştirin**
    ...
    3.  **Tamam**'ı tıklatın ve sonra da Internet Explorer'ı yeniden başlatın.

    -   **Internet Explorer 6 veya Internet Explorer 7 için DEP'yi otomatik Microsoft Düzelt aracılığıyla etkinleştirin**

        Bu geçici çözümü **etkinleştirmek** veya devre dışı bırakmak üzere otomatik **Microsoft Düzelt** çözümünü kullanmak için, bkz. [Microsoft Bilgi Bankası makalesi 978207](http://support.microsoft.com/kb/978207).
...
#### Başlatılmamış Belleğin Bozulması Güvenlik Açığı - CVE-2010-0244 Hakkında SSS
...
Araştırmamıza göre, Internet bölgesi güvenlik ayarının **Yüksek** olarak ayarlanması kullanıcıları bu danışma belgesinde açıklanan sorunlardan koruyacaktır.

**Internet bölgesi güvenlik ayarını Yüksek olarak ayarlamak bu güvenlik açığından beni nasıl korur?**  
Internet bölgesi güvenlik ayarının **Yüksek** olarak ayarlanması, komut dosyalarını devre dışı bırakarak, Internet Explorer'daki fazla güvenli olmayan özellikleri devre dışı bırakarak ve Veri Yürütme Engellemesi'ni (DEP) atlamak için kullanıldığı bilinen yöntemleri engelleyerek bu güvenlik açığına karşı koruma sağlar.

**Windows** **Vista** **ve sonraki Windows işletim sistemleri üzerinde Internet Explorer'daki Korumalı Mod, bu güvenlik açığının etkisini nasıl sınırlamaktadır?**  
Windows Vista ve sonraki Windows işletim sistemleri üzerinde Internet Explorer, varsayılan olarak Internet güvenlik bölgesi için [Korumalı Modda](http://www.microsoft.com/windows/windows-vista/features/ie7-protected-mode.aspx) çalışır. (İntranet bölgesinde Korumalı Mod varsayılan olarak kapalıdır.) Korumalı Mod bir saldırganın kullanıcının makinesine veri yazma, makinedeki verileri değiştirme veya yok etme ya da kötü amaçlı kod yükleme olanağını önemli ölçüde azaltır. Bu, Windows Vista'nın işlemlere, dosyalara ve kayıt defteri anahtarlarına daha yüksek bütünlük düzeyleriyle erişmeyi kısıtlayan bütünlük mekanizmaları kullanılarak sağlanır.

**Adres Alanı Düzen Rasgele Seçimi (ASLR) nedir?**  
Adres Alanı Düzen Rasgele Seçimi'nin kullanıldığı sistemler, normalde öngörülebilir olan işlev girdi noktalarını bellekte sözde rasgele biçimde yeniden konumlandırır. Windows ASLR, DLL veya EXE dosyalarını bellekte 256 rasgele konumdan birine yerleştirir. Bu nedenle, sabit kodlu adresler kullanan saldırganların "doğru tahmin etme" olasılıkları 256'da bire düşürülmüştür. ASLR ile ilgili daha fazla bilgi için, TechNet dergisindeki [Windows Vista Çekirdeği: Bölüm 3](http://technet.microsoft.com/en-us/magazine/2007.04.vistakernel.aspx?pr=blog) adlı makaleye bakın.

**Veri Yürütme Engellemesi (DEP) nedir?**  
Internet Explorer'a eklenmiş olan Veri Yürütme Koruması, Internet Explorer 8 için varsayılan olarak etkinleştirilmiş durumdayken, Internet Explorer'ın daha eski sürümleri için varsayılan olarak devre dışı bırakılmıştır. DEP, bellekte yürütülemez olarak işaretlenmiş kodun çalışmasını engelleyerek saldırıları bertaraf edecek şekilde tasarlanmıştır. Internet Explorer'daki DEP hakkında daha fazla bilgi için, [IE8 Güvenliği Bölüm I: DEP/NX Bellek Koruması](http://blogs.msdn.com/ie/archive/2008/04/08/ie8-security-part-i_3a00_-dep-nx-memory-protection.aspx) adlı MSDN Web günlüğü postasına bakın.

**Internet Explorer 8'de Veri Yürütme Engellemesi (DEP) atlanabilir mi?**  
Veri Yürütme Engellemesi'nden (DEP) yararlanıldığına dair yeni bir bildirim bulunmaktadır. Açıktan yararlanılabileceğini kanıtlayan örnek kodu inceledik ve Windows Vista ve sonraki Windows sürümlerinde Adres Alanı Düzen Rasgele Seçimi (ASLR) aracılığıyla gerçekleştirilen yararlanma girişimlerini engellemeye yönelik daha etkin koruma sağlandığını belirledik. Windows XP'de, saldırganlar atlama tekniklerini daha güvenilir şekilde uygulayabilmektedir.
...
Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2010-0245](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0245).

#### Başlatılmamış Belleğin Bozulması Güvenlik Açığı - CVE-2010-0245 için Azaltıcı Etkenler
...
#### Başlatılmamış Belleğin Bozulması Güvenlik Açığı - CVE-2010-0245 için Geçici Çözümler
...
#### Başlatılmamış Belleğin Bozulması Güvenlik Açığı - CVE-2010-0245 Hakkında SSS
...
Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2010-0246](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0246).

#### Başlatılmamış Belleğin Bozulması Güvenlik Açığı - CVE-2010-0246 için Azaltıcı Etkenler
...
#### Başlatılmamış Belleğin Bozulması Güvenlik Açığı - CVE-2010-0246 için Geçici Çözümler
...
#### Başlatılmamış Belleğin Bozulması Güvenlik Açığı - CVE-2010-0246 Hakkında SSS
...
Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2010-0247](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0247).

#### Başlatılmamış Belleğin Bozulması Güvenlik Açığı - CVE-2010-0247 için Azaltıcı Etkenler
...
#### Başlatılmamış Belleğin Bozulması Güvenlik Açığı - CVE-2010-0247 için Geçici Çözümler
...
#### Başlatılmamış Belleğin Bozulması Güvenlik Açığı - CVE-2010-0247 Hakkında SSS
...
Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2010-0248](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0248).

#### HTML Nesnesinde Bellek Bozulması Güvenlik Açığı - CVE-2010-0248 için Azaltıcı Etkenler
...
#### HTML Nesnesinde Bellek Bozulması Güvenlik Açığı - CVE-2010-0248 için Geçici Çözümler
...
#### HTML Nesnesinde Bellek Bozulması Güvenlik Açığı - CVE-2010-0248 Hakkında SSS
...
Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2010-0249](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0249).

#### HTML Nesnesinde Bellek Bozulması Güvenlik Açığı - CVE-2010-0249 için Azaltıcı Etkenler
...
#### HTML Nesnesinde Bellek Bozulması Güvenlik Açığı - CVE-2010-0249 için Geçici Çözümler
...
#### HTML Nesnesinde Bellek Bozulması Güvenlik Açığı - CVE-2010-0249 Hakkında SSS
...
**Bu güvenlik bülteni yayımlandığında bu güvenlik açığı genel olarak duyurulmuş muydu?**  
Evet. Bu güvenlik açığı genel olarak duyurulmuştur. Ortak Güvenlik Açığı ve Etkilenme (Common Vulnerability and Exposure) numarası olarak [CVE-2010-0249](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0249) atanmıştır.
...
IE5.01sp4-KB978207-Windows2000sp4-x86-trk /quiet<br />
<br />
Windows 2000'in tüm desteklenen sürümleri üzerine yüklendiğinde Internet Explorer 6 Service Pack 1 için:<br />
IE6.0sp1-KB978207-Windows2000-x86-trk /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">Windows 2000'in tüm desteklenen sürümleri üzerinde Internet Explorer 5.01 Service Pack 4 için:<br />
IE5.01sp4-KB978207-Windows2000sp4-x86-trk /norestart<br />
<br />
Windows 2000'in tüm desteklenen sürümleri üzerine yüklendiğinde Internet Explorer 6 Service Pack 1 için:<br />
IE6.0sp1-KB978207-Windows2000-x86-trk /norestart</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">Windows 2000'in tüm desteklenen sürümleri üzerinde Internet Explorer 5.01 Service Pack 4 için:<br />
Denetim Masası'ndaki <strong>Program Ekle veya Kaldır</strong> aracını veya %Windir%\$NTUninstallKB978207-IE5SP4-20091216.120000$\Spuninst klasöründe bulunan Spuninst.exe yardımcı programını kullanın<br />
<br />
Windows 2000'in tüm desteklenen sürümleri üzerine yüklendiğinde Internet Explorer 6 Service Pack 1 için:<br />
Denetim Masası'ndaki <strong>Program Ekle veya Kaldır</strong> aracını veya %Windir%\$NTUninstallKB978207-IE6SP1-20091216.120000$\Spuninst klasöründe bulunan Spuninst.exe yardımcı programını kullanın</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Dosya Bilgileri</strong></td>
<td style="border:1px solid black;">Bkz: <a href="http://support.microsoft.com/kb/978207">Microsoft Bilgi Bankası makalesi 978207</a></td>
</tr>
<tr class="even">
...
WindowsXP-KB978207-x86-trk /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP'nin tüm desteklenen x64 tabanlı sürümleri için Internet Explorer 6:<br />
WindowsServer2003.WindowsXP-KB978207-x64-trk /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP'nin tüm desteklenen 32 bit sürümleri için Internet Explorer 7:<br />
IE7-WindowsXP-KB978207-x86-trk /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP'nin tüm desteklenen x64 tabanlı sürümleri için Internet Explorer 7:<br />
IE7-WindowsServer2003.WindowsXP-KB978207-x64-trk /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP'nin tüm desteklenen 32 bit sürümleri için Internet Explorer 8:<br />
IE8-WindowsXP-KB978207-x86-trk /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP'nin tüm desteklenen x64 tabanlı sürümleri için Internet Explorer 8:<br />
IE8-WindowsServer2003.WindowsXP-KB978207-x64-trk /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">Windows XP'nin tüm desteklenen 32 bit sürümleri için Internet Explorer 6:<br />
WindowsXP-KB978207-x86-trk /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP'nin tüm desteklenen x64 tabanlı sürümleri için Internet Explorer 6:<br />
WindowsServer2003.WindowsXP-KB978207-x64-trk /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP'nin tüm desteklenen 32 bit sürümleri için Internet Explorer 7:<br />
IE7-WindowsXP-KB978207-x86-trk /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP'nin tüm desteklenen x64 tabanlı sürümleri için Internet Explorer 7:<br />
IE7-WindowsServer2003.WindowsXP-KB978207-x64-trk /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP'nin tüm desteklenen 32 bit sürümleri için Internet Explorer 8:<br />
IE8-WindowsXP-KB978207-x86-trk /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP'nin tüm desteklenen x64 tabanlı sürümleri için Internet Explorer 8:<br />
IE8-WindowsServer2003.WindowsXP-KB978207-x64-trk /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Güncelleştirme günlük dosyası</td>
...
<td style="border:1px solid black;"><strong>Kaldırma Bilgileri</strong></td>
<td style="border:1px solid black;">Windows XP'nin tüm desteklenen sürümleri için Internet Explorer 6:<br />
Denetim Masası'ndaki <strong>Program Ekle veya Kaldır</strong> aracını veya %Windir%\$NTUninstallKB978207$\Spuninst klasöründe bulunan Spuninst.exe yardımcı programını kullanın</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP'nin tüm desteklenen sürümleri için Internet Explorer 7:<br />
Denetim Masası'ndaki <strong>Program Ekle veya Kaldır</strong> aracını veya %Windir%\ie7updates\KB978207-IE7\spuninst klasöründe bulunan Spuninst.exe yardımcı programını kullanın</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP'nin tüm desteklenen sürümleri için Internet Explorer 8:<br />
Denetim Masası'ndaki <strong>Program Ekle veya Kaldır</strong> aracını veya %Windir%\ie8updates\KB978207-IE8\spuninst klasöründe bulunan Spuninst.exe yardımcı programını kullanın</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Dosya Bilgileri</strong></td>
<td style="border:1px solid black;">Bkz: <a href="http://support.microsoft.com/kb/978207">Microsoft Bilgi Bankası makalesi 978207</a></td>
...
WindowsServer2003-KB978207-x86-trk /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen 32-bit sürümleri için Internet Explorer 6:<br />
WindowsServer2003-KB978207-x86-trk /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen x64 tabanlı sürümleri için Internet Explorer 6:<br />
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen Itanium tabanlı sürümleri için Internet Explorer 6:<br />
WindowsServer2003-KB978207-ia64-trk /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen 32-bit sürümleri için Internet Explorer 7:<br />
IE7-WindowsServer2003-KB978207-x86-trk /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen x64 tabanlı sürümleri için Internet Explorer 7:<br />
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen Itanium tabanlı sürümleri için Internet Explorer 7:<br />
IE7-WindowsServer2003-KB978207-ia64-trk /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen 32-bit sürümleri için Internet Explorer 8:<br />
IE8-WindowsServer2003-KB978207-x86-trk /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen x64 tabanlı sürümleri için Internet Explorer 8:<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>Dosya Bilgileri</strong></td>
<td style="border:1px solid black;">Bkz: <a href="http://support.microsoft.com/kb/976325">Microsoft Bilgi Bankası makalesi 978207</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Kayıt Defteri Anahtarı Doğrulaması</strong></td>
<td style="border:1px solid black;"><strong>Not</strong> Bu güncelleştirmenin varlığını doğrulayan bir kayıt defteri anahtarı yoktur.</td>
...
-   ["thornmaker" takma adlı David Lindsay](http://p42.us/) ve ["sirdarckcat" takma adlı Eduardo A. Vela Nava](http://www.sirdarckcat.net/), XSS Filtresi'nde Komut Dosyası İşleme Güvenlik Açığı'nı (CVE-2009-4074) bildirdikleri için  
-   [Lostmon Lords](http://lostmon.blogspot.com/), URL Doğrulaması Güvenlik Açığı'nı (CVE-2010-0027) bildirdiği için  
-   Brett Moore, [TippingPoint](http://www.tippingpoint.com/) ve [Zero Day Initiative](http://www.zerodayinitiative.com/) ile birlikte çalışarak URL Doğrulaması Güvenlik Açığı'nı (CVE-2010-0027) bildirdikleri için  
-   [team509](http://www.team509.com/) için çalışan Wushi, [TippingPoint](http://www.tippingpoint.com/) ve [Zero Day Initiative](http://www.zerodayinitiative.com/) ile birlikte çalışarak Başlatılmamış Belleğin Bozulması Güvenlik Açığı'nı (CVE-2010-0244) bildirdikleri için  
-   eshu.co.uk için çalışan Sam Thomas, [TippingPoint](http://www.tippingpoint.com/) ve [Zero Day Initiative](http://www.zerodayinitiative.com/) ile birlikte çalışarak Başlatılmamış Belleğin Bozulması Güvenlik Açığı'nı (CVE-2010-0245) bildirdikleri için  
-   eshu.co.uk için çalışan Sam Thomas, [TippingPoint](http://www.tippingpoint.com/) ve [Zero Day Initiative](http://www.zerodayinitiative.com/) ile birlikte çalışarak Başlatılmamış Belleğin Bozulması Güvenlik Açığı'nı (CVE-2010-0246) bildirdikleri için  
-   Fortinet bünyesindeki [FortiGuard Labs](http://www.fortiguard.com/) için çalışan Haifei Li, Başlatılmamış Belleğin Bozulması Güvenlik Açığı'nı (CVE-2010-0247) bildirdiği için  
-   Peter Vreugdenhil, [TippingPoint](http://www.tippingpoint.com/) ve [Zero Day Initiative](http://www.zerodayinitiative.com/) ile birlikte çalışarak HTML Nesnesinde Bellek Bozulması Güvenlik Açığı'nı (CVE-2010-0248) bildirdikleri için  
-   [BugSec](http://www.bugsec.com/) için çalışan Meron Sellem, HTML Nesnesinde Bellek Bozulması Güvenlik Açığı'nı (CVE-2010-0249) bildirdiği için
  
Microsoft, bizimle çalıştıkları ve Internet Explorer 6 kullanıcılarına yönelik olarak hedefe yönelik sınırlı saldırılar ile ilgili ayrıntıları sağladıkları için aşağıdaki şirketlere [teşekkür eder](http://go.microsoft.com/fwlink/?linkid=21127):
...
-   V1.0 (21 Ocak 2010): Bülten yayımlandı.  
-   V1.1 (27 Ocak 2010): Windows 2000'in tüm desteklenen sürümleri üzerinde Internet Explorer 5.01 Service Pack 4 için Başvuru tablosundaki bir günlük dosyası girdisi düzeltildi.  
-   V1.2 (9 Şubat 2010): URL Doğrulaması Güvenlik Açığı'nın (CVE-2010-0027) hem bu güncelleştirme (MS10-002) hem de MS10-007 numaralı güncelleştirme ile giderildiğini açıklığa kavuşturmak üzere Güncelleştirme Hakkında SSS bölümüne girdi eklendi. Ayrıca CVE-2010-0027 için Microsoft Windows 2000 Service Pack 4 üzerinde yüklendiğinde Internet Explorer 6 Service Pack 1 önem derecesi düzeltildi.  
-   V1.3 (10 Şubat 2010): CVE-2010-0027 için Microsoft Windows 2000 Service Pack 4 üzerine yüklendiğinde Internet Explorer 5.01 Service Pack 4 ve Windows XP Service Pack 2 üzerine yüklendiğinde Internet Explorer 6 önem dereceleri düzeltildi.
