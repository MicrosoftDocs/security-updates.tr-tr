---
TOCTitle: 'MS10-068'
Title: 'Microsoft Güvenlik Bülteni MS10-068 - Önemli'
ms:assetid: 'ms10-068'
ms:contentKeyID: 61235603
ms:mtpsurl: 'https://technet.microsoft.com/tr-TR/library/ms10-068(v=Security.10)'
---

Security Bulletin

Microsoft Güvenlik Bülteni MS10-068 - Önemli
============================================

Yerel Güvenlik Yetkilisi Alt Sistem Hizmeti'ndeki Güvenlik Açığı Ayrıcalık Yükselmesine İzin Verebilir (983539)
---------------------------------------------------------------------------------------------------------------
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=6554f98f-4dc5-4784-b92c-b0aae1fa22ca">Active Directory Uygulama Modu (ADAM)</a><br />
(KB982000)</td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=5bc00f9a-3028-4c9d-be06-f2b78fa444c4">Active Directory Uygulama Modu (ADAM)</a><br />
(KB982000)</td>
<td style="border:1px solid black;">Ayrıcalık Yükselmesi</td>
<td style="border:1px solid black;">Önemli</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=157862">MS09-066</a></td>
...
(KB981550)<br />
<br />
<a href="http://www.microsoft.com/downloads/details.aspx?familyid=c42731f1-6393-42ed-b59f-5310c832fdc4">Active Directory Uygulama Modu (ADAM)</a><br />
(KB982000)</td>
<td style="border:1px solid black;">Ayrıcalık Yükselmesi</td>
<td style="border:1px solid black;">Önemli</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=157862">MS09-066</a></td>
...
(KB981550)<br />
<br />
<a href="http://www.microsoft.com/downloads/details.aspx?familyid=79fb639d-2cc1-4bea-9df6-c67ed95890e3">Active Directory Uygulama Modu (ADAM)</a><br />
(KB982000)</td>
<td style="border:1px solid black;">Ayrıcalık Yükselmesi</td>
<td style="border:1px solid black;">Önemli</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=157862">MS09-066</a></td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=853a71f3-fb0d-43af-a2b8-45bf8ca1a588">Active Directory Basit Dizin Hizmeti (AD LDS)</a><br />
(KB981550)</td>
<td style="border:1px solid black;">Ayrıcalık Yükselmesi</td>
<td style="border:1px solid black;">Önemli</td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=566f468b-22b6-400a-a656-ae64cfcb52df">Active Directory Basit Dizin Hizmeti (AD LDS)</a><br />
(KB981550)</td>
<td style="border:1px solid black;">Ayrıcalık Yükselmesi</td>
<td style="border:1px solid black;">Önemli</td>
<td style="border:1px solid black;">Yok</td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=1452befe-b7b8-4131-b36f-dded2bd16d5e">Active Directory ve Active Directory Basit Dizin Hizmeti (AD LDS)</a>*<br />
(KB981550)</td>
<td style="border:1px solid black;">Ayrıcalık Yükselmesi</td>
<td style="border:1px solid black;">Önemli</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=157862">MS09-066</a></td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=38eb875f-1869-401b-b7d3-9f18f4ba4f24">Active Directory ve Active Directory Basit Dizin Hizmeti (AD LDS)</a>*<br />
(KB981550)</td>
<td style="border:1px solid black;">Ayrıcalık Yükselmesi</td>
<td style="border:1px solid black;">Önemli</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=157862">MS09-066</a></td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=454fc025-bfa2-4552-9522-3585f523ecb2">Active Directory Basit Dizin Hizmeti (AD LDS)</a><br />
(KB981550)</td>
<td style="border:1px solid black;">Ayrıcalık Yükselmesi</td>
<td style="border:1px solid black;">Önemli</td>
<td style="border:1px solid black;">Yok</td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=b15ad533-3cf1-4dcf-847c-05ebffb84e26">Active Directory Basit Dizin Hizmeti (AD LDS)</a><br />
(KB981550)</td>
<td style="border:1px solid black;">Ayrıcalık Yükselmesi</td>
<td style="border:1px solid black;">Önemli</td>
<td style="border:1px solid black;">Yok</td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=54f36389-8be4-4a0c-9640-dc32addac9d7">Active Directory ve Active Directory Basit Dizin Hizmeti (AD LDS)</a>*<br />
(KB981550)</td>
<td style="border:1px solid black;">Ayrıcalık Yükselmesi</td>
<td style="border:1px solid black;">Önemli</td>
<td style="border:1px solid black;">Yok</td>
...
| Itanium tabanlı sistemler için Windows Server 2008 ve Itanium tabanlı sistemler için Windows Server 2008 Service Pack 2<sup>[1]</sup> |  
| Itanium tabanlı sistemler için Windows Server 2008 R2<sup>[1]</sup>                                                                 |
...
<th style="border:1px solid black;" >
LSASS'de Öbek Taşması Güvenlik Açığı - CVE-2010-0820  
</th>
<th style="border:1px solid black;" >
...
<span></span>
Microsoft Windows'da, Yerel Güvenlik Yetkilisi Alt Sistemi Hizmeti'nin (LSASS) belirli Basit Dizin Erişim Protokolü (LDAP) iletilerini düzgün işlememesi nedeniyle kimliği doğrulanmış bir ayrıcalık yükselmesi güvenlik açığı bulunmaktadır. Güvenlik açığı Active Directory, Active Directory Uygulama Modu (ADAM) ve Active Directory Basit Dizin Hizmeti (AD LDS) uygulamalarında bulunmaktadır. Saldırganın bu sorundan yararlanmadan önce LSASS sunucusunda kimliğini doğrulaması gerekir. Bu güvenlik açığından başarıyla yararlanan bir saldırgan rasgele kod yürütebilir ve etkilenen sistemin tüm denetimini ele geçirebilir. Saldırgan, program yükleyebilir; verileri görüntüleyebilir, değiştirebilir veya silebilir; tüm kullanıcı haklarına sahip olan yeni hesaplar oluşturabilir.

Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2010-0820](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0820).

#### LSASS'de Öbek Taşması Güvenlik Açığı - CVE-2010-0820 için Azaltıcı Etkenler
...
-   Saldırganın bu güvenlik açığından başarıyla yararlanabilmesi için, hedeflenen Windows etki alanında bir üye hesabı olması gerekir. Ancak saldırganın iş istasyonunun Windows etki alanına katılmış olması gerekmez.

#### LSASS'de Öbek Taşması Güvenlik Açığı - CVE-2010-0820 için Geçici Çözümler

Geçici çözüm, arka plandaki güvenlik açığını gidermeyen ama güvenlik açığı uygulanmadan önceki bilinen saldırı vektörlerinin engellenmesine yardımcı olan bir ayar veya yapılandırma değişikliği anlamına gelir. Microsoft aşağıdaki geçici çözümleri sınamıştır ve bir geçici çözümün işlevselliği azaltıp azaltmadığı ilgili açıklamada belirtilmektedir:

-   **Güvenlik duvarında 389 numaralı TCP bağlantı noktasını engelleyin**

    Güvenlik duvarında 389 numaralı TCP bağlantı noktasını engelleyin. Bu bağlantı noktası, etkilenen bileşenle bir bağlantı oluşturmak için kullanılır.
...
#### LSASS'de Öbek Taşması Güvenlik Açığı - CVE-2010-0820 Hakkında SSS
...
Güvenlik açığı, Windows LSASS uygulamasının LDAP iletilerindeki hatalı biçimlendirilmiş belirli paketleri düzgün biçimde işlememesi nedeniyle ortaya çıkar.
...
**Active Directory Basit Dizin Hizmeti nedir?**  
Active Directory Basit Dizin Hizmeti (AD LDS), uygulamalar için adanmış dizin hizmetleri sağlayan bağımsız bir Active Directory modudur. AD LDS; Windows Vista, Windows Server 2008, Windows 7 ve Windows Server 2008 R2 üzerinde kullanılabilir. AD LDS, Windows XP ve Windows Server 2003'te kullanılan Active Directory Uygulama Modu'nun (ADAM) yerini almıştır.

**Active Directory kullanıyorsam sunucumda LDAP hizmetinin çalışıp çalışmadığını nasıl öğrenebilirim?**  
Bir sunucunun LDAP veya LDAPS sorgularını dinlediğini onaylamak için, aşağıdaki komutu bir yönetici komut isteminden çalıştırın ve sistemin LDAP bağlantı noktasını (389), LDAPS bağlantı noktasını (636) ya da Genel Katalog hizmeti bağlantı noktalarından birini (3268 veya 3269) dinleyip dinlemediğine bakın:
netstat –a
...
Saldırgan, dinleyen bir LSASS sunucusuna özel hazırlanmış LDAP iletileri göndererek bu güvenlik açığından yararlanabilir. Saldırganın bu sorundan yararlanmadan önce LSASS sunucusunda kimliğini doğrulaması gerekir.

**Bu güvenlik açığından birincil derecede hangi sistemler etkileniyor?**  
Active Directory hizmetlerinin yüklü olduğu etkilenen bir işletim sistemini çalıştıran tüm sistemler bu güvenlik açığından etkilenir. Bu güvenlik açığı yalnızca istemci olan sistemleri doğrudan etkilemez.

**Güncelleştirme ne yapıyor?**  
Güvenlik güncelleştirmesi, LSASS'nin belirli LDAP iletilerini işleme biçimini düzelterek bu güvenlik açığını giderir.
...
| Windows Vista Service Pack 2                                                                                    | Hayır   | Hayır                      | Evet                       | Evet                       |
| Windows Vista x64 Edition Service Pack 2                                                                        | Hayır   | Hayır                      | Evet                       | Evet                       |
...
WindowsXP-KB982000-x86-TRK.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
WindowsServer2003.WindowsXP-KB982000-x64-TRK.exe /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">Windows XP Service Pack 3 üzerinde Active Directory Uygulama Modu (ADAM):<br />
WindowsXP-KB982000-x86-TRK.exe /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition Service Pack 2 üzerinde Active Directory Uygulama Modu (ADAM):<br />
WindowsServer2003.WindowsXP-KB982000-x64-TRK.exe /norestart</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">Denetim Masası'ndaki <strong>Program Ekle veya Kaldır</strong> aracını veya %Windir%\$NTUninstallKB982000$\Spuninst klasöründe bulunan Spuninst.exe yardımcı programını kullanın</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Dosya Bilgileri</strong></td>
<td style="border:1px solid black;">Bkz: <a href="http://support.microsoft.com/kb/982000">Microsoft Bilgi Bankası makalesi 982000</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;">Kullanıcı araya girmeden yükleme</td>
<td style="border:1px solid black;">Windows Server 2003 Service Pack 2 üzerinde Active Directory:<br />
WindowsServer2003-KB981550-x86-TRK.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003 Service Pack 2 üzerinde Active Directory Uygulama Modu (ADAM):<br />
WindowsServer2003-KB982000-x86-TRK.exe /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003 x64 Edition Service Pack 2 üzerinde Active Directory:<br />
WindowsServer2003.WindowsXP-KB981550-x64-TRK.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003 x64 Edition Service Pack 2 üzerinde Active Directory Uygulama Modu (ADAM):<br />
WindowsServer2003.WindowsXP-KB982000-x64-TRK.exe /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Itanium tabanlı sistemler için Windows Server 2003 SP2 üzerinde Active Directory:<br />
WindowsServer2003-KB981550-ia64-TRK.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">Windows Server 2003 Service Pack 2 üzerinde Active Directory:<br />
WindowsServer2003-KB981550-x86-TRK.exe /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003 Service Pack 2 üzerinde Active Directory Uygulama Modu (ADAM):<br />
WindowsServer2003-KB982000-x86-TRK.exe /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003 x64 Edition Service Pack 2 üzerinde Active Directory:<br />
WindowsServer2003.WindowsXP-KB981550-x64-TRK.exe /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003 x64 Edition Service Pack 2 üzerinde Active Directory Uygulama Modu (ADAM):<br />
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Itanium tabanlı sistemler için Windows Server 2003 SP2 üzerinde Active Directory:<br />
WindowsServer2003-KB981550-ia64-TRK.exe /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Güncelleştirme günlük dosyası</td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>Kaldırma Bilgileri</strong></td>
<td style="border:1px solid black;">Active Directory için, Denetim Masası'ndaki <strong>Program Ekle veya Kaldır</strong> aracını veya %Windir%\$NTUninstallKB981550$\Spuninst klasöründe bulunan Spuninst.exe yardımcı programını kullanın</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Active Directory Uygulama Modu (ADAM) için, Denetim Masası'ndaki <strong>Program Ekle veya Kaldır</strong> aracını veya %Windir%\$NTUninstallKB982000$\Spuninst klasöründe bulunan Spuninst.exe yardımcı programını kullanın</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Dosya Bilgileri</strong></td>
<td style="border:1px solid black;">Windows Server 2003 üzerinde Active Directory için, bkz. <a href="http://support.microsoft.com/kb/981550">Microsoft Bilgi Bankası makalesi 981550</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003 üzerinde Active Directory Uygulama Modu (ADAM) için, bkz. <a href="http://support.microsoft.com/kb/982000">Microsoft Bilgi Bankası makalesi 982000</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Kayıt Defteri Anahtarı Doğrulaması</strong></td>
<td style="border:1px solid black;">Windows Server 2003 üzerinde Active Directory:<br />
HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Updates\Windows Server 2003\SP3\KB981550\Filelist</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003 üzerinde Active Directory Uygulama Modu (ADAM):<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>Dosya Bilgileri</strong></td>
<td style="border:1px solid black;">Bkz: <a href="http://support.microsoft.com/kb/981550">Microsoft Bilgi Bankası makalesi 981550</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Kayıt Defteri Anahtarı Doğrulaması</strong></td>
