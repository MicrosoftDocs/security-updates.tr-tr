---
TOCTitle: 'MS10-067'
Title: 'Microsoft Güvenlik Bülteni MS10-067 - Önemli'
ms:assetid: 'ms10-067'
ms:contentKeyID: 61235602
ms:mtpsurl: 'https://technet.microsoft.com/tr-TR/library/ms10-067(v=Security.10)'
---

Security Bulletin

Microsoft Güvenlik Bülteni MS10-067 - Önemli
============================================

WordPad Metin Dönüştürücüleri'ndeki Güvenlik Açığı Uzaktan Kod Yürütülmesine İzin Verebilir (2259922)
-----------------------------------------------------------------------------------------------------
...
|---------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------|----------------------|---------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=fc4369ec-864a-42ae-a850-b006872241fe)                              | Uzaktan Kod Yürütme       | Önemli               | Yok                                         |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=7567986a-261d-4def-9fa5-c667994c7844)     | Uzaktan Kod Yürütme       | Önemli               | Yok                                         |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=3290e7ee-1e4a-464c-abfd-17fc4108601e)                     | Uzaktan Kod Yürütme       | Önemli               | Yok                                         |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=b21570cc-4f90-4ed8-b901-a34584d44a63)         | Uzaktan Kod Yürütme       | Önemli               | Yok                                         |
| [Itanium Tabanlı Sistemler için Windows Server 2003 SP2](http://www.microsoft.com/downloads/details.aspx?familyid=c9c4427d-54c8-4f3c-9a94-818196cd5180) | Uzaktan Kod Yürütme       | Önemli               | Yok                                         |
...
<th style="border:1px solid black;" >WordPad Word 97 Metin Dönüştürücüsü'nde Bellek Bozulması Güvenlik Açığı - CVE-2010-2563</th>
...
WordPad Word 97 Metin Dönüştürücüsü'nde Bellek Bozulması Güvenlik Açığı - CVE-2010-2563  
---------------------------------------------------------------------------------------
...
Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2010-2563](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2563).
  
#### WordPad Word 97 Metin Dönüştürücüsü'nde Bellek Bozulması Güvenlik Açığı - CVE-2010-2563 için Azaltıcı Etkenler
...
#### WordPad Word 97 Metin Dönüştürücüsü'nde Bellek Bozulması Güvenlik Açığı - CVE-2010-2563 için Geçici Çözümler
...
#### WordPad Word 97 Metin Dönüştürücüsü'nde Bellek Bozulması Güvenlik Açığı - CVE-2010-2563 Hakkında SSS
...
Güvenlik açığı, WordPad metin dönüştürücüsünün bir Word 97 belgesindeki belirli alanları hatalı şekilde ayrıştırması nedeniyle ortaya çıkar.
...
Web tabanlı saldırı senaryosunda, saldırganın, bu açıktan yararlanma girişimi için kullanılan Word 97 belgesini içeren bir Web sitesi barındırması gerekir. Ayrıca, kullanıcı tarafından sağlanan içeriği kabul eden ya da barındıran güvenliği aşılmış Web sitelerinde, bu güvenlik açığından yararlanılabilecek özel hazırlanmış içerik bulunabilir. Saldırganın, bir kullanıcıyı özel hazırlanmış bir Web sitesini ziyaret etmeye zorlama yolu yoktur. Bunun yerine, saldırganın kullanıcıları kendi Web sitesine götüren bir bağlantıyı tıklatmalarını sağlayarak onları bu Web sitesini ziyaret etmeye ikna etmesi gerekir. Kullanıcıya sorulur ve belgenin açılmasını kullanıcının el ile kabul etmesi gerekir.
  
**Bu güvenlik açığından birincil derecede hangi sistemler etkileniyor?**  
İş istasyonları veya terminal sunucuları gibi, güvenilir olmayan kaynaklardan gelen Word belgelerini açmak için WordPad'in kullanıldığı etkilenen sistemler birincil derecede risk altındadır. Yöneticiler kullanıcıların sunucularda oturum açmalarına ve program çalıştırmalarına izin verirse sunucular daha fazla etkilenebilir. Ancak, en iyi uygulamalarda buna izin verilmesi kesinlikle önerilmemektedir. Microsoft Word'ün yüklü olduğu sistemler Word belgelerini varsayılan olarak WordPad yerine Microsoft Office ile açar.
...
WindowsXP-KB2259922-x86-trk.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition Service Pack 2:<br />
WindowsServer2003.WindowsXP-KB2259922-x64-trk.exe /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">Windows XP Service Pack 3 için:<br />
WindowsXP-KB2259922-x86-trk.exe /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition Service Pack 2:<br />
WindowsServer2003.WindowsXP-KB2259922-x64-trk.exe /norestart</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">Denetim Masası'ndaki <strong>Program Ekle veya Kaldır</strong> aracını veya %Windir%\$NTUninstallKB2259922$\Spuninst klasöründe bulunan Spuninst.exe yardımcı programını kullanın</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Dosya Bilgileri</strong></td>
<td style="border:1px solid black;">Bkz: <a href="http://support.microsoft.com/kb/2259922">Microsoft Bilgi Bankası makalesi 2259922</a></td>
</tr>
<tr class="even">
...
WindowsServer2003-KB2259922-x86-trk.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
WindowsServer2003-KB2259922-ia64-trk.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen 32 bit sürümleri:<br />
WindowsServer2003-KB2259922-x86-trk.exe /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen x64 tabanlı sürümleri:<br />
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen Itanium tabanlı sürümleri:<br />
WindowsServer2003-KB2259922-ia64-trk.exe /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Güncelleştirme günlük dosyası</td>
<td style="border:1px solid black;">KB2259922.log</td>
...
-   [iDefense Labs](http://labs.idefense.com/) için çalışan S0lute, WordPad Word 97 Metin Dönüştürücüsü'nde Bellek Bozulması Güvenlik Açığı'nı (CVE-2010-2563) bildirdiği için
