---
TOCTitle: 'MS10-055'
Title: 'Microsoft Güvenlik Bülteni MS10-055 - Kritik'
ms:assetid: 'ms10-055'
ms:contentKeyID: 61235590
ms:mtpsurl: 'https://technet.microsoft.com/tr-TR/library/ms10-055(v=Security.10)'
---

Security Bulletin

Microsoft Güvenlik Bülteni MS10-055 - Kritik
============================================

Cinepak Codec Bileşenindeki Güvenlik Açığı Uzaktan Kod Yürütülmesine İzin Verebilir (982665)
--------------------------------------------------------------------------------------------

Yayım Tarihi: 10 Ağustos 2010 Salı | Güncelleştirme Tarihi: 12 Ağustos 2010 Perşembe
...
Bu güvenlik güncelleştirmesi, Windows XP, Windows Vista ve Windows 7'nin tüm desteklenen sürümleri için Kritik olarak derecelendirilmiştir. Daha fazla bilgi için, bu bölümdeki **Etkilenen ve Etkilenmeyen Yazılımlar** alt bölümüne bakın.

Güvenlik güncelleştirmesi, Cinepak kodunun medya dosyalarının sıkıştırmasını açma biçimini düzelterek bu güvenlik açığını giderir. Bu güvenlik açığı hakkında daha fazla bilgi için, bir sonraki bölüm olan **Güvenlik Açığı Bilgileri** altında, ilgili güvenlik açığı girdisinin Sık Sorulan Sorular (SSS) alt bölümüne bakın.
...
**Bilinen Sorunlar.** [Microsoft Bilgi Bankası makalesi 982665](http://support.microsoft.com/kb/982665), bu güvenlik güncelleştirmesini yükleyen müşterilerin karşılaşabileceği bilinen sorunları belgelemektedir. Bu makale ayrıca, bu sorunlar için önerilen çözümleri de içermektedir.
...
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------|----------------------|---------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=5ddb5e34-f97a-47c6-96c8-ba2ed06ccb77)                                                            | Uzaktan Kod Yürütme       | Kritik               | Yok                                         |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=5cff5d6e-11a5-40ed-92ac-e12d287919e6)                                   | Uzaktan Kod Yürütme       | Kritik               | Yok                                         |
| [Windows Vista Service Pack 1 ve Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=60c81415-b61e-44a4-8dd9-cedec99eb70f)                         | Uzaktan Kod Yürütme       | Kritik               | Yok                                         |
| [Windows Vista x64 Edition Service Pack 1 ve Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=469b732d-ca62-4a48-bb55-99f2ae4ddcf5) | Uzaktan Kod Yürütme       | Kritik               | Yok                                         |
| [32-bit sistemler için Windows 7](http://www.microsoft.com/downloads/details.aspx?familyid=2e782ac9-b5d5-490e-a01a-7d4481eab224)                                                      | Uzaktan Kod Yürütme       | Kritik               | Yok                                         |
| [x64 tabanlı sistemler için Windows 7](http://www.microsoft.com/downloads/details.aspx?familyid=24751193-592f-4c44-a8d6-f4112d4f011b)                                                 | Uzaktan Kod Yürütme       | Kritik               | Yok                                         |
...
<th style="border:1px solid black;" >Cinepak Codec Bileşeninde Sıkıştırma Açma Güvenlik Açığı - CVE-2010-2553</th>
...
Cinepak Codec Bileşeninde Sıkıştırma Açma Güvenlik Açığı - CVE-2010-2553  
------------------------------------------------------------------------
  
<span></span>
Cinepak codec bileşeninin desteklenen dosya biçimlerini işleme biçiminde bir uzaktan kod yürütme güvenlik açığı bulunmaktadır. Bu güvenlik açığı, kullanıcı özel hazırlanmış bir medya dosyasını açarsa kod yürütülmesine izin verebilir. Kullanıcı yönetimsel haklarla oturum açtıysa, bu güvenlik açığından başarıyla yararlanan bir saldırgan etkilenen sistemin denetimini tümüyle ele geçirebilir. Saldırgan, program yükleyebilir; verileri görüntüleyebilir, değiştirebilir veya silebilir; tüm kullanıcı haklarına sahip olan yeni hesaplar oluşturabilir. Hesapları, sistemde az sayıda kullanıcı hakkıyla yapılandırılmış olan kullanıcılar, yönetici haklarıyla çalışan kullanıcılardan daha az etkilenebilir.
  
Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz. [CVE-2010-2553](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2553).
  
#### Cinepak Codec Bileşeninde Sıkıştırma Açma Güvenlik Açığı - CVE-2010-2553 için Azaltıcı Etkenler
...
#### Cinepak Codec Bileşeninde Sıkıştırma Açma Güvenlik Açığı - CVE-2010-2553 için Geçici Çözümler
  
Geçici çözüm, arka plandaki güvenlik açığını gidermeyen ama güvenlik açığı uygulanmadan önceki bilinen saldırı vektörlerinin engellenmesine yardımcı olan bir ayar veya yapılandırma değişikliği anlamına gelir. Microsoft aşağıdaki geçici çözümleri sınamıştır ve bir geçici çözümün işlevselliği azaltıp azaltmadığı ilgili açıklamada belirtilmektedir:
  
-   **iccvid.dll dosyasına uygulanan Erişim Denetim Listesi'ni (ACL) değiştirin**
  
    iccvid.dll dosyasına uygulanan ACL'yi daha kısıtlayıcı olacak şekilde değiştirin.
  
    Windows XP'nin 32-bit sürümleri için, komut isteminde şu komutları çalıştırın (yönetimsel ayrıcalıklar gerektirir):  
    `cacls %WINDIR%\SYSTEM32\iccvid.DLL /E /P everyone:N`
  
    Windows XP'nin 64-bit sürümleri için, komut isteminde şu komutları çalıştırın (yönetimsel ayrıcalıklar gerektirir):  
    `cacls %WINDIR%\SYSWOW64\iccvid.DLL /E /P everyone:N `
  
    `Windows Vista ve Windows 7'nin 32-bit sürümleri` için, aşağıdaki komutları ayrıcalığı yükseltilmiş bir komut isteminden çalıştırın:  
    ...
    **Geçici çözümün etkisi.** Cinepak codec bileşeni kullanılarak kodlanan medya dosyaları multimedya olarak oynatılamaz.
...
-   **Cinepac kullanılarak kodlanmış dosyaların DirectShow'da ayrıştırılmasını devre dışı bırakın**
  
    Cinepac codec bileşeni kullanılarak kodlanmış dosyaların DirectShow içinden ayrıştırılmasını devre dışı bırakın.
    ...
    **Etkileşimli Yöntemi Kullanma**
    ...
    4.  Kayıt Defteri Dosyası Ver iletişim kutusuna **Drivers32\_Backup.reg** yazın ve **Kaydet**'i tıklatın.  
        **Not** Bu işlem, varsayılan olarak Belgelerim klasöründe bu kayıt defteri anahtarının bir yedeğini oluşturur.  
    5.  Ad olarak **vidc.cvid** dize değerini ve Veri olarak **iccvid.dll** dosyasını bulup seçin.  
    6.  Klavyede **Delete** tuşuna basarak kayıt defteri anahtarını silin. Anahtar Silinmesini Onayla iletişim kutusunda kayıt defteri anahtarını silmeniz istendiğinde **Evet**'i tıklatın.
    ...
    **Yönetilen Dağıtım Komut Dosyası Kullanma**
    ...
    2.  Ardından, aşağıdaki metni .REG uzantılı bir dosyaya kaydedin (örneğin, Disable\_Cinepak\_Parser.reg:  
        **32-bit Windows sistemleri**:  
    ...
    **Geçici çözüm nasıl geri alınır.**
    ...
    3.  Kayıt Defteri Dosyası Al iletişim kutusunda, **Drivers32\_Backup.reg** dosyasını seçin ve **Aç**'ı tıklatın.
...
#### Cinepak Codec Bileşeninde Sıkıştırma Açma Güvenlik Açığı - CVE-2010-2553 Hakkında SSS
...
Microsoft Windows ile birlikte gelen Cinepak codec bileşeni özel hazırlanmış medya dosyalarını düzgün işlemez.
  
**Cinepak codec bileşeni nedir?**  
Cinepak codec bileşeni, Windows Media Player tarafından desteklenen bir medya kodlayıcısı ve kod çözücüdür. Bu codec bileşeni, medya dosyalarının bit akışı biçiminde kodlanmasına ve kodunun çözülmesine olanak verir. Cinepak, vektör nicelemeye dayalı görüntü sıkıştırma ve çerçeve farklılaştırma kullanır.
...
Güncelleştirme, Cinepak codec bileşeninin medya dosyalarının sıkıştırmasını açma biçimini düzelterek bu sorunu giderir.
...
WindowsXP-KB982665-x86-TRK.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition Service Pack 2:<br />
WindowsServer2003.WindowsXP-KB982665-x64-TRK.exe /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">Windows XP Service Pack 3 için:<br />
WindowsXP-KB982665-x86-TRK.exe /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition Service Pack 2:<br />
WindowsServer2003.WindowsXP-KB982665-x64-TRK.exe /norestart</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">Denetim Masası'ndaki <strong>Program Ekle veya Kaldır</strong> aracını veya %Windir%\$NTUninstallKB982665$\Spuninst klasöründe bulunan Spuninst.exe yardımcı programını kullanın</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Dosya Bilgileri</strong></td>
<td style="border:1px solid black;">Bkz: <a href="http://support.microsoft.com/kb/982665">Microsoft Bilgi Bankası makalesi 982665</a></td>
</tr>
<tr class="even">
...
-   Anonim bir araştırmacı, [Tipping Point](http://www.tippingpoint.com/) bünyesindeki [Zero Day Initiative](http://www.zerodayinitiative.com/) ile birlikte çalışarak Cinepak Codec Bileşeninde Sıkıştırma Açma Güvenlik Açığı'nı (CVE-2010-2553) bildirdikleri için
...
-   V1.1 (12 Ağustos 2010): Etkilenmeyen yazılımlar tablosuna 32-bit sistemler için Windows Server 2008 ve 32-bit sistemler için Windows Server 2008 Service Pack 2 eklendi.
