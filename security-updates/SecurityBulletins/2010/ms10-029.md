---
TOCTitle: 'MS10-029'
Title: 'Microsoft Güvenlik Bülteni MS10-029 - Orta'
ms:assetid: 'ms10-029'
ms:contentKeyID: 61235564
ms:mtpsurl: 'https://technet.microsoft.com/tr-TR/library/ms10-029(v=Security.10)'
---

Security Bulletin

Microsoft Güvenlik Bülteni MS10-029 - Orta
==========================================

Windows ISATAP Bileşenindeki Güvenlik Açığı Kimlik Sahtekarlığına Neden Olabilir (978338)
-----------------------------------------------------------------------------------------
...
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------|----------------------|-----------------------------------------------------------|
| [Windows XP Service Pack 2 ve Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=9dc3e1c2-2e9d-4d86-9fce-446c409ad613)                                                                  | Sızdırma                  | Orta                 | Yok                                                       |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=d872bd77-f491-4706-8ff5-081ac0bf3d6f)                                                                      | Sızdırma                  | Orta                 | Yok                                                       |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=cd007a6c-04b3-490c-aff4-d5af3e69d477)                                                                                      | Sızdırma                  | Orta                 | Yok                                                       |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=19cfddfe-e8da-4564-9730-babfae4a3ebb)                                                                          | Sızdırma                  | Orta                 | Yok                                                       |
| [Itanium Tabanlı Sistemler için Windows Server 2003 SP2](http://www.microsoft.com/downloads/details.aspx?familyid=916f1b09-e79e-4347-9fbc-c0cf07de397d)                                                                  | Sızdırma                  | Orta                 | Yok                                                       |
| [Windows Vista, Windows Vista Service Pack 1 ve Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=196055a6-15d1-4da8-b33d-501e69bf5176)                                             | Sızdırma                  | Orta                 | [MS10-009](http://go.microsoft.com/fwlink/?linkid=167190) |
| [Windows Vista x64 Edition, Windows Vista x64 Edition Service Pack 1 ve Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=7c1d1622-1b67-438d-aae4-1a3954974a36)         | Sızdırma                  | Orta                 | [MS10-009](http://go.microsoft.com/fwlink/?linkid=167190) |
| [32-bit sistemler için Windows Server 2008 ve 32-bit sistemler için Windows Server 2008 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=61ece7bc-e9fa-4ede-ba7d-9e5a4c64b9be)\*                 | Sızdırma                  | Orta                 | [MS10-009](http://go.microsoft.com/fwlink/?linkid=167190) |
| [x64 tabanlı sistemler için Windows Server 2008 ve x64 tabanlı sistemler için Windows Server 2008 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=72e7c7ea-55ef-457b-a03a-49aa9dea2e84)\*       | Sızdırma                  | Orta                 | [MS10-009](http://go.microsoft.com/fwlink/?linkid=167190) |
| [Itanium tabanlı sistemler için Windows Server 2008 ve Itanium tabanlı sistemler için Windows Server 2008 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=8c48302c-a1d6-41bc-ad24-7ce7332d4842) | Sızdırma                  | Orta                 | [MS10-009](http://go.microsoft.com/fwlink/?linkid=167190) |
...
Bu güvenlik güncelleştirmesi iki yeni güvenlik özelliği sunar:

-   **ISATAP istemcilerinde Olası Yönlendirici Listesi (PRL):** PRL, istemcilerin gelen ISATAP tünel oluşturulmuş paketleri için kaynak adresi denetimi gerçekleştirmesine olanak verir. PRL varsayılan olarak bu güvenlik güncelleştirmesi yüklendikten sonra etkinleştirilir ve CVE-2010-0812'de açıklanan ISATAP IPv6'da Kaynak Adresi Sızdırma Güvenlik Açığı'nın giderilmesine yardımcı olur. PRL hakkında daha fazla bilgiyi [Microsoft Bilgi Bankası makalesi 978338](http://support.microsoft.com/kb/978338)'de bulabilirsiniz.
-   **ISATAP arabirimlerinde Komşuya Erişememe Algılaması (NUD):** NUD bir komşunun erişilebilir olup olmadığını doğrulamak için kullanılır. NUD, ISATAP paketleri gönderilmeden önce ISATAP düğümleri tarafından gerçekleştirilir. NUD varsayılan olarak etkinleştirilmiş değildir, ağ yöneticileri tarafından el ile yapılandırılması gerekir. NUD ve nasıl etkinleştirileceği hakkında daha fazla bilgi [Microsoft Bilgi Bankası makalesi 978338](http://support.microsoft.com/kb/978338)'de bulunabilir.

**Microsoft Windows 2000 bu güvenlik açığından neden etkilenmiyor?**  
Microsoft Windows 2000'de IPv6 desteği yoktur ve bu nedenle de bu işletim sistemi güvenlik açığından etkilenmez.

**Windows 7 ve Windows Server 2008 R2 bu güvenlik açığından neden etkilenmiyor?**  
Bu güvenlik güncelleştirmesi tarafından dağıtılan Olası Yönlendirici Listesi (PRL) ve Komşuya Erişememe Algılaması (NUD) özellikleri Windows 7 ve Windows Server 2008 R2'de zaten bulunmaktadır.

**Not** Bu platformlarda PRL varsayılan olarak etkinleştirilmiş durumdadır; ancak NUD etkin değildir ve ağ yöneticisi tarafından el ile yapılandırılması gerekir. Bu özellik hakkında ek bilgi için [Microsoft Bilgi Bankası makalesi 978338](http://support.microsoft.com/kb/978338)'i inceleyin.

**IPv6 etkinleştirilmemiş olsa da bu güncelleştirme sunulacak mı?**  
Evet; güvenlik açığından etkilenen kod bu sistemlerde bulunduğu için, bu güvenlik güncelleştirmesi Otomatik Güncelleştirmeler aracılığıyla sunulacaktır. Müşteriler ileride IPv6'yı dağıtmayı planlıyorlarsa bu güvenlik güncelleştirmesini yüklemeleri önerilir.
...
<th style="border:1px solid black;" >ISATAP IPv6'da Kaynak Adresi Sızdırma Güvenlik Açığı - CVE-2010-0812</th>
...
ISATAP IPv6'da Kaynak Adresi Sızdırma Güvenlik Açığı - CVE-2010-0812  
--------------------------------------------------------------------
  
<span></span>
Microsoft Windows IPv6 yığınında, Windows'un tünel oluşturulan bir ISATAP paketinde yer alan iç paketin IPv6 kaynak adresini denetleme biçiminde bir sızdırma güvenlik açığı bulunmaktadır. Bu güvenlik açığından başarıyla yararlanan saldırgan bir adresi taklit ederek kenar veya ana bilgisayar güvenlik duvarlarını atlayabilir. Bunun yanı sıra, hedeflenen bilgisayar saldırgan tarafından belirtilen kaynak IPv6 adresini kullanan iletiyi yanıtladığında bilgi açığa çıkabilir.
  
Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2010-0812](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0812).
  
#### ISATAP IPv6'da Kaynak Adresi Sızdırma Güvenlik Açığı - CVE-2010-0812 için Azaltıcı Etkenler
  
Azaltıcı etken, varolan bir durumda bulunan ve güvenlik açığından yararlanılmasının önem derecesini azaltabilecek bir ayar, genel yapılandırma ya da en iyi uygulama anlamına gelir. Sizin durumunuzda aşağıdaki azaltıcı etkenler işinize yarayabilir:
  
-   Bu güvenlik açığı yalnızca ISATAP arabiriminin yapılandırılmış olduğu Windows sistemlerini etkiler.
  
#### ISATAP IPv6'da Kaynak Adresi Sızdırma Güvenlik Açığı - CVE-2010-0812 için Geçici Çözümler
...
-   **ISATAP IPv6 arabirimini devre dışı bırakın**
  
    ISATAP IPv6 arabirimini devre dışı bırakmak için, ayrıcalığı yükseltilmiş bir komut isteminde şu komutu çalıştırın:
    ...
    **Geçici çözümün etkisi.** ISATAP arabirimi devre dışı bırakıldığında, sistemin IPv6 tünel oluşturma mekanizması olarak ISATAP kullanması engellenir.
  
    **Geçici çözüm nasıl geri alınır.**
  
    ISATAP IPv6 arabirimini yeniden etkinleştirmek için, ayrıcalığı yükseltilmiş bir komut isteminde şu komutu çalıştırın:
...
#### ISATAP IPv6'da Kaynak Adresi Sızdırma Güvenlik Açığı - CVE-2010-0812 Hakkında SSS
  
**Bu güvenlik açığının kapsamı nedir?**  
Bu, bir sızdırma güvenlik açığıdır. Bu güvenlik açığı, saldırganın bir IPv4 adresini sızdırarak kaynak IPv4 adresini kullanan filtreleme aygıtlarını atlamasına olanak verebilir.
  
**Güvenlik açığına ne neden olmaktadır?**  
Güvenlik açığı, Windows TCP/IP yığınının tünel oluşturulan bir ISATAP paketindeki kaynak IPv6 adresini düzgün şekilde denetlememesi nedeniyle ortaya çıkar.
  
**ISATAP nedir?**  
Site İçi Otomatik Tünel Adres Protokolü (ISATAP), IPv4 Intranet'i içinde IPv6 bağlantısı sağlar. ISATAP hakkında bilgi için, bkz. [RFC5214: Site İçi Otomatik Tünel Adres Protokolü (ISATAP)](http://www.ietf.org/rfc/rfc5214.txt).
  
**Bir saldırgan bu güvenlik açığından yararlanarak neler yapabilir?**  
Saldırgan başka bir kullanıcıyı veya sistemi taklit ederek, kenar veya ana bilgisayar güvenlik duvarları gibi kaynak adresi filtrelerinin atlanmasını sağlayabilir.
  
**Bir saldırgan güvenlik açığından nasıl yararlanabilir?**  
Saldırgan, karşılık gelen IPv4 kaynak adresiyle eşleşmeyen bir ISATAP bağlantısında özel hazırlanmış IPv6 kaynak adresine sahip özel ağ paketleri oluşturarak bu güvenlik açığından yararlanmaya çalışabilir.
  
**Bu güvenlik açığından birincil derecede hangi sistemler etkileniyor?**  
IPv6 ISATAP özelliklerinin etkinleştirilmiş olduğu tüm işletim sistemleri bu güvenlik açığına karşı risk altındadır.
  
**Güncelleştirme ne yapıyor?**  
Güncelleştirme, Windows TCP/IP yığınının tünel oluşturulan bir ISATAP paketindeki kaynak IPv6 adresini denetleme biçimini değiştirerek bu güvenlik açığını giderir.
...
WindowsXP-KB978338-x86-trk /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition Service Pack 2:<br />
WindowsServer2003.WindowsXP-KB978338-x64-trk /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">Windows XP Service Pack 2 ve Windows XP Service Pack 3:<br />
WindowsXP-KB978338-x86-trk /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition Service Pack 2:<br />
WindowsServer2003.WindowsXP-KB978338-x64-trk /norestart</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">Denetim Masası'ndaki <strong>Program Ekle veya Kaldır</strong> aracını veya %Windir%\$NTUninstallKB978338$\Spuninst klasöründe bulunan Spuninst.exe yardımcı programını kullanın</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Dosya Bilgileri</strong></td>
<td style="border:1px solid black;">Bkz: <a href="http://support.microsoft.com/kb/978338">Microsoft Bilgi Bankası makalesi 978338</a></td>
</tr>
<tr class="even">
...
WindowsServer2003-KB978338-x86-trk /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
WindowsServer2003-KB978338-ia64-trk /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen 32 bit sürümleri:<br />
WindowsServer2003-KB978338-x86-trk /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen x64 tabanlı sürümleri:<br />
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen Itanium tabanlı sürümleri:<br />
WindowsServer2003-KB978338-ia64-trk /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Güncelleştirme günlük dosyası</td>
<td style="border:1px solid black;">KB978338.log</td>
...
National EW Research & Simulation Center (Rafael'de) için çalışan Gabi Nakibly, ISATAP IPv6'da Kaynak Adresi Sızdırma Güvenlik Açığı'nı (CVE-2010-0812) bildirdiği için
...
-   V1.1 (21 Nisan 2010): Windows Vista ve Windows Server 2008'e yönelik tüm güncelleştirme paketleri için bülten değişikliği bilgileri düzeltildi.
