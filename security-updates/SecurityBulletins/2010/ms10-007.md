---
TOCTitle: 'MS10-007'
Title: 'Microsoft Güvenlik Bülteni MS10-007 - Kritik'
ms:assetid: 'ms10-007'
ms:contentKeyID: 61235542
ms:mtpsurl: 'https://technet.microsoft.com/tr-TR/library/ms10-007(v=Security.10)'
---

Security Bulletin

Microsoft Güvenlik Bülteni MS10-007 - Kritik
============================================

Windows Kabuğu İşleyicisi'ndeki Güvenlik Açığı Uzaktan Kod Yürütülmesine İzin Verebilir (975713)
------------------------------------------------------------------------------------------------
...
|---------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------|----------------------|---------------------------------------------|
| [Microsoft Windows 2000 Service Pack 4](http://www.microsoft.com/downloads/details.aspx?familyid=92234237-a8eb-4ce4-bc5e-cd86feb7dbd3)                  | Uzaktan Kod Yürütme       | Kritik               | Yok                                         |
| [Windows XP Service Pack 2 ve Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=b8e7bf17-a037-4200-9ae2-2280b19766a4) | Uzaktan Kod Yürütme       | Kritik               | Yok                                         |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=b8d83f30-9cd7-4d6b-b2b9-65d0a483cb9c)     | Uzaktan Kod Yürütme       | Kritik               | Yok                                         |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=5cb2e203-18fb-4887-a1c9-289d86b8ba11)                     | Uzaktan Kod Yürütme       | Kritik               | Yok                                         |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=90360537-9311-45e2-8047-9a971f90c3c3)         | Uzaktan Kod Yürütme       | Kritik               | Yok                                         |
| [Itanium Tabanlı Sistemler için Windows Server 2003 SP2](http://www.microsoft.com/downloads/details.aspx?familyid=d695ca9f-a1db-4c0f-94b6-7112861c28da) | Uzaktan Kod Yürütme       | Kritik               | Yok                                         |
...
**Bu güvenlik güncelleştirmesi MS10-002'de açıklanan CVE-2010-0027 ile nasıl ilişkilidir?**  
URL Doğrulaması Güvenlik Açığı (CVE-2010-0027), kullanıcının sisteminde yüklü olan Microsoft Windows sürümüne ve Internet Explorer sürümüne bağlı olarak, bu güncelleştirme (MS10-007) ve [Internet Explorer Toplu Güvenlik Güncelleştirmesi (MS10-002)](http://go.microsoft.com/fwlink/?linkid=179104) tarafından giderilir.
...
<th style="border:1px solid black;" >URL Doğrulaması Güvenlik Açığı - CVE-2010-0027</th>
...
<span></span>
Microsoft Windows'un etkilenen sürümlerinde uzaktan kod yürütülmesine neden olabilecek bir güvenlik açığı bulunmaktadır. Güvenlik açığı, ShellExecute API işlevine gönderilen girişin hatalı şekilde doğrulanması nedeniyle ortaya çıkar. Bu açığı başarıyla kullanan bir saldırgan, etkilenen sistemin tüm denetimini ele geçirebilir.
...
Bu bir uzaktan kod yürütme güvenlik açığıdır. Bu güvenlik açığından başarıyla yararlanan bir saldırgan, oturum açmış kullanıcı ile aynı haklara sahip olarak işlem gerçekleştirebilir.
  
**Güvenlik açığına ne neden olmaktadır?**  
Web tarayıcısı gibi bir uygulama özel hazırlanmış verileri işlemek üzere ShellExecute API işlevini kullandığında, ShellExecute bu veri akışını hatalı biçimde doğrulayabilir ve yerel istemci sisteminden bir ikili dosya yürütebilir.
...
**ShellExecute nedir?**  
ShellExecute, Windows Kabuğu uygulama programı arabirimi (API) işlevlerinin bir parçasıdır. Belirtilen dosyada bir işlem gerçekleştirir. Bu işlem, örneğin ilgili dosya türü için doğru işleyicinin çağrılması anlamına gelebilir. ShellExecute işleviyle ilgili daha fazla bilgi, [ShellExecute İşlevi](http://msdn.microsoft.com/en-us/library/bb762153(vs.85).aspx) adlı MSDN makalesinde bulunabilir.
  
**Uygulama Programı Arabirimi (API) nedir?**  
API bir bileşen, uygulama veya işletim sistemiyle çalışmak üzere kullanabileceğiniz bir dizi işlevdir. API genellikle bazı temel işlevleri sağlayan bir veya daha fazla DLL dosyasından oluşur.
  
**Bir saldırgan bu güvenlik açığından yararlanarak neler yapabilir?**  
Bu güvenlik açığından başarıyla yararlanan bir saldırgan oturum açan kullanıcının bağlamında rasgele kod çalıştırabilir. Kullanıcı yönetimsel haklarla oturum açtıysa, saldırgan etkilenen sistemin denetimini tümüyle ele geçirebilir. Saldırgan, program yükleyebilir; verileri görüntüleyebilir, değiştirebilir veya silebilir; tüm kullanıcı haklarına sahip olan yeni hesaplar oluşturabilir. Hesapları, sistemde az sayıda kullanıcı hakkıyla yapılandırılmış olan kullanıcılar, yönetici haklarıyla çalışan kullanıcılardan daha az etkilenebilir.
  
**Bir saldırgan güvenlik açığından nasıl yararlanabilir?**  
Saldırgan, uygulamanın hatalı biçimlendirilmiş bir dizeyi ayrıştırmasına neden olabilecek özel hazırlanmış bir Web sayfası benzeri bir içerik sağlayabilir. Bu içerik örneğin bir köprü olarak ShellExecute API çağrısına gönderildiğinde, saldırgan, oturum açmış kullanıcının bilgisi olmadan istemci sisteminden bir ikili dosya yürütebilir.
  
**Bu güvenlik açığından birincil derecede hangi sistemler etkileniyor?**  
Güvenilir olmayan Internet içeriğine gözatılan istemci sistemleri, oturum açmış kullanıcının bağlamında açıktan yararlanılmasına olanak veren bu güvenlik açığına karşı birincil derecede risk altındadır.
  
**Güncelleştirme ne yapıyor?**  
Güncelleştirme, Microsoft Windows 2000, Windows XP ve Windows Server 2003'ün desteklenen sürümlerinde ShellExecute API'sının giriş parametrelerini doğrulama biçimini düzelterek bu güvenlik açığını giderir.
...
| **Dağıtım**                                  |                                                                                                                                                                       |  
| Kullanıcı araya girmeden yükleme             | Windows2000-KB975713-x86-TRK /quiet                                                                                                                                   |  
| Yeniden başlatmadan yükleme                  | Windows2000-KB975713-x86-TRK /norestart                                                                                                                               |  
| Güncelleştirme günlük dosyası                | kb975713.log                                                                                                                                                          |  
...
| **Kaldırma Bilgileri**                       | Denetim Masası'ndaki **Program Ekle veya Kaldır** aracını veya %Windir%\\$NTUninstallKB975713$\\Spuninst klasöründe bulunan Spuninst.exe yardımcı programını kullanın |  
| **Dosya Bilgileri**                          | Bkz: [Microsoft Bilgi Bankası makalesi 975713](http://support.microsoft.com/kb/975713)                                                                                |  
| **Kayıt Defteri Anahtarı Doğrulaması**       | HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows 2000\\SP5\\KB975713\\Filelist                                                                             |
...
WindowsXP-KB975713-x86-TRK /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition Service Pack 2:<br />
WindowsServer2003.WindowsXP-KB975713-x64-TRK /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">Windows XP Service Pack 2 ve Windows XP Service Pack 3:<br />
WindowsXP-KB975713-x86-TRK /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition Service Pack 2:<br />
WindowsServer2003.WindowsXP-KB975713-x64-TRK /norestart</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">Denetim Masası'ndaki <strong>Program Ekle veya Kaldır</strong> aracını veya %Windir%\$NTUninstallKB975713$\Spuninst klasöründe bulunan Spuninst.exe yardımcı programını kullanın</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Dosya Bilgileri</strong></td>
<td style="border:1px solid black;">Bkz: <a href="http://support.microsoft.com/kb/975713">Microsoft Bilgi Bankası makalesi 975713</a></td>
</tr>
<tr class="even">
...
WindowsServer2003-KB975713-x86-TRK /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
WindowsServer2003-KB975713-ia64-TRK /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen 32 bit sürümleri:<br />
WindowsServer2003-KB975713-x86-TRK /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen x64 tabanlı sürümleri:<br />
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen Itanium tabanlı sürümleri:<br />
WindowsServer2003-KB975713-ia64-TRK /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Güncelleştirme günlük dosyası</td>
<td style="border:1px solid black;">KB975713.log</td>
