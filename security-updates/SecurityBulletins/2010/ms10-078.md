---
TOCTitle: 'MS10-078'
Title: 'Microsoft Güvenlik Bülteni MS10-078 - Önemli'
ms:assetid: 'ms10-078'
ms:contentKeyID: 61235613
ms:mtpsurl: 'https://technet.microsoft.com/tr-TR/library/ms10-078(v=Security.10)'
---

Security Bulletin

Microsoft Güvenlik Bülteni MS10-078 - Önemli
============================================

OpenType Yazı Tipi (OTF) Biçimi Sürücüsündeki Güvenlik Açıkları Ayrıcalık Yükselmesine İzin Verebilir (2279986)
---------------------------------------------------------------------------------------------------------------
...
Güvenlik güncelleştirmesi OpenType Yazı Tipi (OTF) biçimi sürücüsünün OpenType yazı tiplerini işlerken belleği ayırma ve tamsayı hesaplamaları gerçekleştirme biçimini düzelterek bu güvenlik açıklarını giderir. Bu güvenlik açıkları hakkında daha fazla bilgi için, bir sonraki bölüm olan **Güvenlik Açığı Bilgileri** altında, ilgili güvenlik açığı girdisinin Sık Sorulan Sorular (SSS) alt bölümüne bakın.
...
|---------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------|----------------------|-----------------------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=0553fc7c-deed-4594-a133-d621551310dc)                              | Ayrıcalık Yükselmesi      | Önemli               | [MS10-037](http://go.microsoft.com/fwlink/?linkid=190508) |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=1ad30596-bac6-4d48-8b15-0245960c443b)     | Ayrıcalık Yükselmesi      | Önemli               | [MS10-037](http://go.microsoft.com/fwlink/?linkid=190508) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=f94763e7-b1db-4043-aa79-d5be1a42307d)                     | Ayrıcalık Yükselmesi      | Önemli               | [MS10-037](http://go.microsoft.com/fwlink/?linkid=190508) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=6fca5cab-7e11-4911-a6a8-f73f113b2963)         | Ayrıcalık Yükselmesi      | Önemli               | [MS10-037](http://go.microsoft.com/fwlink/?linkid=190508) |
| [Itanium Tabanlı Sistemler için Windows Server 2003 SP2](http://www.microsoft.com/downloads/details.aspx?familyid=e8f297e2-0dfd-421a-b598-a78199ad6baa) | Ayrıcalık Yükselmesi      | Önemli               | [MS10-037](http://go.microsoft.com/fwlink/?linkid=190508) |
...
<th style="border:1px solid black;" >OpenType Yazı Tipini Ayrıştırma Güvenlik Açığı - CVE-2010-2740</th>
<th style="border:1px solid black;" >OpenType Yazı Tipini Doğrulama Güvenlik Açığı - CVE-2010-2741</th>
...
OpenType Yazı Tipini Ayrıştırma Güvenlik Açığı - CVE-2010-2740  
--------------------------------------------------------------
  
<span></span>
Windows OpenType Yazı Tipi (OTF) biçimi sürücüsünün özel hazırlanmış OpenType yazı tiplerini hatalı biçimde ayrıştırması nedeniyle bir ayrıcalık yükselmesi güvenlik açığı bulunmaktadır. Bu güvenlik açığından başarıyla yararlanan bir saldırgan çekirdek modunda rasgele kod çalıştırabilir. Saldırgan, program yükleyebilir; verileri görüntüleyebilir, değiştirebilir veya silebilir; tüm kullanıcı haklarına sahip olan yeni hesaplar oluşturabilir.
  
Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2010-2740](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2740).
  
#### OpenType Yazı Tipini Ayrıştırma Güvenlik Açığı - CVE-2010-2740 için Azaltıcı Etkenler
...
#### OpenType Yazı Tipini Ayrıştırma Güvenlik Açığı - CVE-2010-2740 için Geçici Çözümler
  
Microsoft bu güvenlik açığı için herhangi bir geçici çözüm belirleyememiştir.
  
#### OpenType Yazı Tipini Ayrıştırma Güvenlik Açığı - CVE-2010-2740 Hakkında SSS
...
Güvenlik açığı, OpenType Yazı Tipi (OTF) biçimi sürücüsünün özel hazırlanmış bir yazı tipini ayrıştırırken belleği düzgün şekilde ayırmaması nedeniyle ortaya çıkar.
  
**OpenType Yazı Tipi biçimi nedir?**  
OpenType, Apple'ın TrueType yazı tipi biçiminin bir uzantısı olarak Microsoft ve Adobe işbirliğiyle geliştirilen bir yazı tipi biçimidir. OpenType yazı tipi dosyası, TrueType veya PostScript dış çizgili yazı tipini barındıran tablo biçiminde veriler içerir. Piksel görüntüleyiciler TrueType veya PostScript karakter anahat bilgilerini işlemek üzere yazı tipinin içerdiği tablolarda yer alan veri bileşimlerini kullanır. Bu destekleyici verilerin bir bölümü anahat biçiminden bağımsız olarak kullanılır; bir bölümü ise TrueType veya PostScript yazı tipi biçimine özeldir. Daha fazla bilgi için, bkz: [Microsoft Tipografisi OpenType Hakkında SSS](http://www.microsoft.com/typography/opentypefaq.mspx).
...
Evet. Üçüncü taraf Web tarayıcılar OpenType Yazı Tipi'ni (OTF) özgün olarak işliyorlarsa bu güvenlik açığından etkilenirler. Bu uygulamalar özel olarak katıştırılmış bir yazı tipinin kullanıldığı bir Web sitesini görüntülemek için kullanıldığında, bu güvenlik açığı oturum açmış kullanıcının güvenlik bağlamında kod yürütülmesine izin verebilir. Varsayılan olarak, Internet Explorer bu sorundan etkilenmez.
  
**Güncelleştirme ne yapıyor?**  
Güncelleştirme, OpenType Yazı Tipi (OTF) biçimi sürücüsünün bir yazı tipini ayrıştırırken belleği ayırma biçimini düzelterek bu güvenlik açığını giderir.
...
OpenType Yazı Tipini Doğrulama Güvenlik Açığı - CVE-2010-2741  
-------------------------------------------------------------
  
<span></span>
Windows OpenType Yazı Tipi (OTF) biçimi sürücüsünün özel hazırlanmış OpenType yazı tiplerini hatalı biçimde ayrıştırması nedeniyle bir ayrıcalık yükselmesi güvenlik açığı bulunmaktadır. Bu güvenlik açığından başarıyla yararlanan bir saldırgan çekirdek modunda rasgele kod çalıştırabilir. Saldırgan, program yükleyebilir; verileri görüntüleyebilir, değiştirebilir veya silebilir; tüm kullanıcı haklarına sahip olan yeni hesaplar oluşturabilir.
  
Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2010-2741](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2741).
  
#### OpenType Yazı Tipini Doğrulama Güvenlik Açığı - CVE-2010-2741 için Azaltıcı Etkenler
  
Azaltıcı etken, varolan bir durumda bulunan ve güvenlik açığından yararlanılmasının önem derecesini azaltabilecek bir ayar, genel yapılandırma ya da en iyi uygulama anlamına gelir. Sizin durumunuzda aşağıdaki azaltıcı etkenler işinize yarayabilir:
  
-   Saldırganın bu güvenlik açığından yararlanabilmesi için geçerli oturum açma kimlik bilgilerine sahip olması ve yerel olarak oturum açabilmesi gerekir. Bu güvenlik açığı uzaktan veya anonim kullanıcılar tarafından kullanılamaz.
  
#### OpenType Yazı Tipini Doğrulama Güvenlik Açığı - CVE-2010-2741 için Geçici Çözümler
  
Microsoft bu güvenlik açığı için herhangi bir geçici çözüm belirleyememiştir.
  
#### OpenType Yazı Tipini Doğrulama Güvenlik Açığı - CVE-2010-2741 Hakkında SSS
  
**Bu güvenlik açığının kapsamı nedir?**  
Bu bir ayrıcalık yükselmesi güvenlik açığıdır. Bu güvenlik açığından başarıyla yararlanan bir saldırgan rasgele kod yürütebilir ve etkilenen sistemin tüm denetimini ele geçirebilir. Saldırgan, program yükleyebilir; verileri görüntüleyebilir, değiştirebilir veya silebilir; tüm kullanıcı haklarına sahip olan yeni hesaplar oluşturabilir.
  
**Güvenlik açığına ne neden olmaktadır?**  
Güvenlik açığı, OpenType Yazı Tipi (OTF) biçimi sürücüsünün özel hazırlanmış OpenType yazı tiplerini işlerken tamsayı hesaplamasını düzgün yapmaması nedeniyle ortaya çıkar.
...
**Güncelleştirme ne yapıyor?**  
Güncelleştirme, OpenType Yazı Tipi (OTF) biçimi sürücüsünün OpenType yazı tiplerini işlerken tamsayı hesaplamaları yapma biçimini düzelterek bu güvenlik açığını giderir.
...
WindowsXP-KB2279986-x86-trk.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition Service Pack 2:<br />
WindowsServer2003.WindowsXP-KB2279986-x64-trk.exe /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">Windows XP Service Pack 3 için:<br />
WindowsXP-KB2279986-x86-trk.exe /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition Service Pack 2:<br />
WindowsServer2003.WindowsXP-KB2279986-x64-trk.exe /norestart</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">Denetim Masası'ndaki <strong>Program Ekle veya Kaldır</strong> aracını veya %Windir%\$NTUninstallKB2279986$\Spuninst klasöründe bulunan Spuninst.exe yardımcı programını kullanın</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Dosya Bilgileri</strong></td>
<td style="border:1px solid black;">Bkz: <a href="http://support.microsoft.com/kb/2279986">Microsoft Bilgi Bankası makalesi 2279986</a></td>
</tr>
<tr class="even">
...
WindowsServer2003-KB2279986-x86-trk.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
WindowsServer2003-KB2279986-ia64-trk.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen 32 bit sürümleri:<br />
WindowsServer2003-KB2279986-x86-trk.exe /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen x64 tabanlı sürümleri:<br />
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen Itanium tabanlı sürümleri:<br />
WindowsServer2003-KB2279986-ia64-trk.exe /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Güncelleştirme günlük dosyası</td>
<td style="border:1px solid black;">KB2279986.log</td>
...
-   [Siberas](http://www.siberas.de/) için çalışan Sebastian Apelt, OpenType Yazı Tipini Ayrıştırma Güvenlik Açığı'nı (CVE-2010-2740) bildirdiği için
-   [Core Security Technologies](http://www.coresecurity.com) için çalışan Diego Juarez, OpenType Yazı Tipini Doğrulama Güvenlik Açığı'nı (CVE-2010-2741) bildirdiği için
