---
TOCTitle: 'MS08-053'
Title: 'Microsoft Güvenlik Bülteni MS08-053 - Kritik'
ms:assetid: 'ms08-053'
ms:contentKeyID: 61235436
ms:mtpsurl: 'https://technet.microsoft.com/tr-TR/library/ms08-053(v=Security.10)'
---

Security Bulletin

Microsoft Güvenlik Bülteni MS08-053 - Kritik
============================================

Windows Media Encoder 9'daki Güvenlik Açığı Uzaktan Kod Yürütülmesine İzin Verebilir (954156)
---------------------------------------------------------------------------------------------
...
Bu güvenlik güncelleştirmesi Windows Media Encoder 9 Series'deki özel olarak bildirilen bir güvenlik açığını giderir. Bu güvenlik açığı, bir kullanıcı özel olarak hazırlanmış bir Web sayfasını görüntülerse uzaktan kod yürütülmesine olanak verebilir. Kullanıcı yönetimsel haklarla oturum açtıysa, bu güvenlik açığından başarıyla yararlanan bir saldırgan etkilenen sistemin denetimini tümüyle ele geçirebilir. Saldırgan, program yükleyebilir; verileri görüntüleyebilir, değiştirebilir veya silebilir; tüm kullanıcı haklarına sahip olan yeni hesaplar oluşturabilir. Hesapları, sistemde az sayıda kullanıcı hakkıyla yapılandırılmış olan kullanıcılar, yönetici haklarıyla çalışan kullanıcılardan daha az etkilenebilir.

Bu güvenlik güncelleştirmesi Microsoft Windows 2000, Windows XP ve Windows Vista'nın tüm desteklenen ve etkilenen sürümleri için Kritik ve Windows Server 2003 ve Windows Server 2008'in tüm desteklenen ve etkilenen sürümleri için Orta olarak derecelendirilmiştir. Daha fazla bilgi için, bu bölümdeki **Etkilenen ve Etkilenmeyen Yazılımlar** alt bölümüne bakın.

Güvenlik güncelleştirmesi, ek parametre doğrulaması gerçekleştirerek ve Windows Media Encoder'daki denetimlerin Internet Explorer ile etkileşim kurma biçimini değiştirerek güvenlik açığını ortadan kaldırır. Bu güvenlik açığı hakkında daha fazla bilgi için, bir sonraki bölüm olan **Güvenlik Açığı Bilgileri** altında, ilgili güvenlik açığı girdisinin Sık Sorulan Sorular (SSS) alt bölümüne bakın.
...
|------------------------------------------------------------------------------------------------------------------|--------------------------------|  
| Itanium tabanlı sistemler için Windows Server 2003 SP1 ve Itanium tabanlı sistemler için Windows Server 2003 SP2 | Windows Media Encoder 9 Series |  
| Itanium tabanlı sistemler için Windows Server 2008                                                               | Windows Media Encoder 9 Series |
...
Microsoft bu bülteni, Microsoft Windows 2000 Service Pack 4 üzerinde çalıştırıldığında Windows Media Encoder 9 Series, Windows XP Service Pack 2 ve Windows XP Service Pack 3 üzerinde çalıştırıldığında Windows Media Encoder 9 Series, Windows Server 2003 Service Pack 1 ve Windows Server 2003 Service Pack 2 üzerinde çalıştırıldığında Windows Media Encoder 9 Series yüklemelerinin başarısız olmasına neden olan bir kalite sorununu gidermek amacıyla Norveççe dil güncelleştirmelerinin yeniden yayımlandığını duyurmak üzere yeniden düzenledi. Norveççe dil güncelleştirmelerini karşıdan yüklemiş ve kurmaya çalışmış olan müşterilerin bu bültende açıklanan güvenlik açığından korunmaları için yeniden yayımlanan güncelleştirmeleri karşıdan yükleyip kurmaları gerekmektedir. x64 tabanlı işletim sistemleri üzerine yüklendiğinde Windows Media Encoder 9 Series x64 Edition ve Windows Media Encoder 9 Series, bu yeniden yayımlanan açıktan etkilenmez. Bu yeniden yayımlanan açıktan başka bir güncelleştirme, sürüm veya yerel ayar etkilenmemektedir.
  
**Dosya bilgileri ayrıntılarını nerede bulabilirim?**  
Dosya bilgileri ayrıntıları [Microsoft Bilgi Bankası makalesi 954156](http://support.microsoft.com/kb/954156)'da bulunabilir.
  
**Bir paketin parçası olarak Windows Media Encoder 9 Series'i de yükleyen ürünler var mı?**  
Evet. Windows Media Encoder 9 Series bir Windows sürümüyle birlikte gelmez; ancak Windows Media Encoder 9'un 32-bit sürümü, [Microsoft Yükleme Merkezi](http://www.microsoft.com/downloads/details.aspx?displaylang=en&familyid=fbcd4987-86c6-4fe0-8a6d-f19ddf89217e)'nden edinilebilen Adobe Premier 6.5 için Gelişmiş Windows Media Eklentisi (Beta) ile birlikte gelir. Adobe Premier 6.5 için Gelişmiş Windows Media Eklentisi (Beta) ürününü yüklemiş olanlar bu güncelleştirmeyi de yüklemelidir.
...
<th style="border:1px solid black;" >Windows Media Encoder'da Arabellek Taşması Güvenlik Açığı - CVE-2008-3008</th>
<th style="border:1px solid black;" >Toplam Önem Derecesi</th>
</tr>
</thead>
<tbody>
...
Windows Media Encoder'da Arabellek Taşması Güvenlik Açığı - CVE-2008-3008  
-------------------------------------------------------------------------
  
<span></span>
Windows Media Encoder 9 Series tarafından yüklenen WMEX.DLL adlı ActiveX denetiminde uzaktan kod yürütülmesine neden olabilecek bir güvenlik açığı bulunmaktadır. Bu güvenlik açığı, bir kullanıcı özel olarak hazırlanmış bir Web sayfasını görüntülerse uzaktan kod yürütülmesine olanak verebilir. Kullanıcı yönetimsel haklarla oturum açtıysa, bu güvenlik açığından başarıyla yararlanan bir saldırgan etkilenen sistemin denetimini tümüyle ele geçirebilir. Saldırgan, program yükleyebilir; verileri görüntüleyebilir, değiştirebilir veya silebilir; tüm kullanıcı haklarına sahip olan yeni hesaplar oluşturabilir. Hesapları, sistemde az sayıda kullanıcı hakkıyla yapılandırılmış olan kullanıcılar, yönetici haklarıyla çalışan kullanıcılardan daha az etkilenebilir.
  
Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2008-3008](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-3008).
  
#### Windows Media Encoder'da Arabellek Taşması Güvenlik Açığı - CVE-2008-3008 için Azaltıcı Etkenler
  
Azaltıcı etken, varolan bir durumda bulunan ve güvenlik açığından yararlanılmasının önem derecesini azaltabilecek bir ayar, genel yapılandırma ya da en iyi uygulama anlamına gelir. Sizin durumunuzda aşağıdaki azaltıcı etkenler işinize yarayabilir:
  
-   Windows Media Encoder 9 Series varsayılan olarak Windows'un herhangi bir sürümüyle birlikte yüklenmez. Windows Media Encoder 9 Series'in x86 veya x64 tabanlı sistemlere yüklenebilen 32-bit sürümü, Microsoft Yükleme Merkezi'ndeki [Windows Media Encoder 9 Series](http://www.microsoft.com/downloads/details.aspx?familyid=5691ba02-e496-465a-bba9-b2f1182cdf24) bölümünden yüklenmelidir. Windows Media Encoder 9 Series'in x64 tabanlı sistemlere yüklenebilen 64-bit sürümü, Microsoft Yükleme Merkezi'ndeki [Windows Media Encoder 9 Series x64 Edition](http://www.microsoft.com/downloads/details.aspx?familyid=cc41218d-7e37-4546-bf0b-1276959ee3ef) bölümünden yüklenmelidir. Windows Media Encoder 9 Series veya Windows Media Encoder 9 Series x64 Edition'ın yüklü olmadığı sistemler bu güvenlik açığından etkilenmez.  
-   Bu ActiveX denetimi varsayılan olarak Internet Bölgesi'ndeki ActiveX katılımı özelliği aracılığıyla açıkça etkinleştirilmedikçe, Internet Explorer 7 çalışan sistemlerde etkinleştirilmez. Ancak müşteri bu ActiveX denetimini Internet Explorer'ın önceki bir sürümünde kullandıysa, ActiveX katılımı özelliği kullanılarak açıkça onaylanmamış olsa da ActiveX denetimi Internet Explorer 7'de çalışacak biçimde etkinleştirilir.  
-   Internet Explorer, Windows Server 2003 ve Windows Server 2008'de varsayılan olarak [Artırılmış Güvenlik Yapılandırması](http://go.microsoft.com/fwlink/?linkid=92039) adı verilen kısıtlı bir modda çalışır. Artırılmış Güvenlik Yapılandırması, bir kullanıcının veya yöneticinin bir sunucudaki özel hazırlanmış Web içeriğini yükleme ve çalıştırma olasılığını azaltan, bir grup önceden yapılandırılmış Internet Explorer ayarıdır. Bu, Internet Explorer'ın Güvenilen siteler bölgesine eklenmemiş Web siteleri için bir azaltıcı etkendir. Microsoft Yükleme Merkezi'ndeki [Internet Explorer Artırılmış Güvenlik Yapılandırmasını Yönetme](http://go.microsoft.com/fwlink/?linkid=92055) adlı teknik incelemeye de bakın.
  
#### Windows Media Encoder'da Arabellek Taşması Güvenlik Açığı - CVE-2008-3008 için Geçici Çözümler
  
Geçici çözüm, arka plandaki güvenlik açığını gidermeyen ama güvenlik açığı uygulanmadan önceki bilinen saldırı vektörlerinin engellenmesine yardımcı olan bir ayar veya yapılandırma değişikliği anlamına gelir. Microsoft aşağıdaki geçici çözümleri sınamıştır ve bir geçici çözümün işlevselliği azaltıp azaltmadığı ilgili açıklamada belirtilmektedir:
  
-   **WMEX.DLL dosyasının Internet Explorer'da çalışmasını engelleyin**
  
    Kayıt defterinde WMEX.DLL dosyasının kill bitini ayarlayarak Internet Explorer'da bu dosyanın örneğini oluşturma girişimlerini devre dışı bırakabilirsiniz.
    ...
    **Uyarı** Kayıt Defteri Düzenleyicisi'ni yanlış kullanırsanız, işletim sisteminizi yeniden yüklemenizi gerektirebilecek ciddi sorunlara neden olabilirsiniz. Microsoft, Kayıt Defteri Düzenleyicisi'nin yanlış kullanılmasından kaynaklanan sorunların çözülebileceğini garanti etmez. Kayıt Defteri Düzenleyicisi'ni kullanmak kendi sorumluluğunuzdadır.
    ...
    Internet Explorer'da bir denetimin çalışmasını durdurmak için kullanabileceğiniz ayrıntılı adımlar için, bkz: [Microsoft Bilgi Bankası makalesi 240797](http://support.microsoft.com/kb/240797). Bu makaledeki adımları izleyin ve Internet Explorer'da WMEX.DLL dosyasının örneğinin oluşturulmasını engellemek için bir Compatibility Flags kayıt defteri değeri oluşturun.
  
    WMEX.DLL dosyasının kill bitini ayarlamak için, aşağıdaki metni Not Defteri gibi bir metin düzenleyicisine yapıştırın. Ardından, dosyayı .reg dosya adı uzantısıyla kaydedin.
  
    **Windows Registry Editor Version 5.00**
  
    32-bit sistemlerde çalışan Windows Media Encoder 9 Series veya 64-bit sistemlerde çalışan Windows Media Encoder 9 Series x64 Edition için:
    ...
    64-bit sistemlerde çalışan Windows Media Encoder 9 Series için:
    ...
    **Geçici çözümün etkisi.**Bu denetimin Internet Explorer'da kullanılması amaçlanmadığı için etkisi yoktur.
  
    **Geçici çözüm nasıl geri alınır.**
  
    Geçici çözümü geri almak için, aşağıdaki metni Not Defteri gibi bir metin düzenleyicisine yapıştırın. Ardından, dosyayı .reg dosya adı uzantısıyla kaydedin.
...
-   **WMEX.DLL kaydını silin**
  
    Not: Bu bölümde belirtilen yollar varsayılan yükleme yollarıdır. Windows Media Encoder 9 varsayılan konuma yüklenmemişse, Windows Media Encoder'ın yüklü olduğu dizini doğrulayın ve aşağıdaki örneklerde belirtilen yolu uygun şekilde değiştirin.
  
    Yönetici haklarına sahip bir komut istemine aşağıdaki komutu yazın:
  
    `regsvr32.exe -u "%programfiles%\Windows Media Components\Encoder\wmex.dll"`
  
    **Geçici çözümün etkisi.** Windows Media Encoder'ı kullanan uygulamalar düzgün çalışmayabilir.
...
-   **WMEX.DLL dosyasına erişimi engelleyin**
    ...
    **Windows** **Vista** **ve Windows Server 2008:**
    ...
    Yönetici haklarına sahip bir komut istemine aşağıdaki komutları yazın:
    ...
    **Geçici çözüm nasıl geri alınır.**
    ...
    -   **Windows 2000, Windows XP ve Windows Server 2003:**
        ...
        Şu BB makalesinde özetlenen adımları kullanarak, dosyayı, izinlerini üst klasörden alacak şekilde yapılandırın: [Microsoft Bilgi Bankası makalesi 308419](http://support.microsoft.com/kb/308419) veya ayrıcalığı yükseltilmiş bir komut isteminde şu komutu çalıştırarak 'everyone' hesabı ACE'sini kaldırın:
...
#### Windows Media Encoder'da Arabellek Taşması Güvenlik Açığı - CVE-2008-3008 Hakkında SSS
...
Windows Media Encoder 9 Series, wmex.dll adlı bir ActiveX denetimi yükler. Bu denetim, Komut Dosyası Oluşturma için Güvenli (SFS) olarak işaretlenmiştir. Ancak bu denetim, Internet Explorer'da örneği oluşturulacak biçimde tasarlanmamıştır.
  
**ActiveX denetimi nedir?**  
ActiveX denetimi, [IUnknown](http://msdn.microsoft.com/en-us/library/ms680509(vs.85).aspx) arabirimini destekleyen basit bir OLE nesnesidir. Daha fazla bilgi için, [ActiveX Denetimleri](http://msdn.microsoft.com/en-us/library/aa751968(vs.85).aspx) adlı MSDN makalesine bakın.
  
**Komut Dosyası Oluşturma için Güvenli (SFS) nedir?**  
Birçok ActiveX denetimi, yerel olarak veya uzaktan kalıcı verilerle başlatılır ve çoğu ActiveX denetimi komut dosyası çalıştırabilir (bir dizi yöntemi, olayı ve özelliği desteklerler). Başlatma (kalıcı verilerle) ve komut dosyası çalıştırma özellikleri, güvenlik ihlali olmaması için belirli önlemlerin alınmasını gerektirir. Bir geliştirici bir ActiveX denetimi yazdığında, bu denetimin Web siteleri tarafından kullanılmak için güvenli olup olmadığını gösterecek biçimde işaretlenmesi gerekir. Bir denetimi “komut dosyası oluşturma için güvenli” olarak işaretlemek, denetimin kötü amaçla kullanılarak zararlı bir eylem gerçekleştirilemeyeceğine dair yazar tarafından yapılan bir beyanattır. Web siteleri normalde yalnızca “komut dosyası oluşturma için güvenli” olarak işaretlenmiş ActiveX denetimlerini kullanabilir. Daha fazla bilgi için, [ActiveX Denetimleri için Güvenli Başlatma ve Komut Dosyası Çalıştırma](http://msdn.microsoft.com/en-us/library/aa751977(vs.85).aspx) adlı MSDN makalesine bakın.
...
<td style="border:1px solid black;">Bu sorunla ilgili güncelleştirme, gelecekteki bir güncelleştirme toplamasına eklenmeyecektir</td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;">Microsoft Windows 2000 Service Pack 4 üzerinde çalıştırıldığında Windows Media Encoder 9 Series:<br />
WindowsMedia9-KB954156-x86-TRK /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">Microsoft Windows 2000 Service Pack 4 üzerinde çalıştırıldığında Windows Media Encoder 9 Series:<br />
WindowsMedia9-KB954156-x86-TRK /norestart</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">Microsoft Windows 2000 Service Pack 4 üzerinde çalıştırıldığında Windows Media Encoder 9 Series:<br />
Denetim Masası'ndaki Program Ekle veya Kaldır aracını veya %Windir%\$NtUninstallKB954156_WM9L$\Spuninst klasöründe bulunan Spuninst.exe yardımcı programını kullanın</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Dosya Bilgileri</strong></td>
<td style="border:1px solid black;">Bkz: <a href="http://support.microsoft.com/kb/954156">Microsoft Bilgi Bankası makalesi 954156</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Kayıt Defteri Anahtarı Doğrulaması</strong></td>
<td style="border:1px solid black;">Microsoft Windows Service Pack 4 üzerinde çalıştırıldığında Windows Media Encoder 9 Series: 
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Gelecekteki Hizmet Paketlerine Eklenmesi</strong></td>
<td style="border:1px solid black;">Bu sorunla ilgili güncelleştirme, gelecekteki bir hizmet paketine veya güncelleştirme toplamasına eklenmeyecektir</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Dağıtım</strong></td>
<td style="border:1px solid black;"></td>
...
<tr class="odd">
<td style="border:1px solid black;">Kullanıcı araya girmeden yükleme</td>
<td style="border:1px solid black;">Windows XP Service Pack 2 ve Windows XP Service Pack 3 üzerinde çalıştırıldığında Windows Media Encoder 9 Series:<br />
WindowsMedia9-KB954156-x86-TRK /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition ve Windows XP Professional x64 Edition Service Pack 2 üzerinde çalıştırıldığında Windows Media Encoder 9 Series x64 Edition:<br />
WindowsMedia9-KB954156-x64-TRK /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition ve Windows XP Professional x64 Edition Service Pack 2 üzerinde çalıştırıldığında Windows Media Encoder 9 Series:
WindowsMedia9-KB954156-32bit-x64-TRK /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">Windows XP Service Pack 2 ve Windows XP Service Pack 3 üzerinde çalıştırıldığında Windows Media Encoder 9 Series:<br />
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition ve Windows XP Professional x64 Edition Service Pack 2 üzerinde çalıştırıldığında Windows Media Encoder 9 Series x64 Edition:<br />
WindowsMedia9-KB954156-x64-TRK /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition ve Windows XP Professional x64 Edition Service Pack 2 üzerinde çalıştırıldığında Windows Media Encoder 9 Series:
WindowsMedia9-KB954156-32bit-x64-TRK /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Güncelleştirme günlük dosyası</td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>Kaldırma Bilgileri</strong></td>
<td style="border:1px solid black;">Windows Media Encoder 9 Series için, Denetim Masası'ndaki Program Ekle veya Kaldır aracını veya %Windir%\$NtUninstallKB954156_WM9L$\Spuninst klasöründe bulunan Spuninst.exe yardımcı programını kullanın</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Media Encoder 9 Series x64 Edition için, Denetim Masası'ndaki Program Ekle veya Kaldır aracını veya %Windir%\$NtUninstallKB954156_WM10L$\Spuninst klasöründe bulunan Spuninst.exe yardımcı programını kullanın</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Dosya Bilgileri</strong></td>
<td style="border:1px solid black;">Bkz: <a href="http://support.microsoft.com/kb/954156">Microsoft Bilgi Bankası makalesi 954156</a></td>
...
<tr class="odd">
<td style="border:1px solid black;">Kullanıcı araya girmeden yükleme</td>
<td style="border:1px solid black;">Windows Server 2003 Service Pack 1 ve Windows Server 2003 Service Pack 2 üzerinde çalıştırıldığında Windows Media Encoder 9 Series:<br />
WindowsMedia9-KB954156-x86-TRK /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003 x64 Edition ve Windows Server 2003 x64 Edition Service Pack 2 üzerinde çalıştırıldığında Windows Media Encoder 9 Series x64 Edition:<br />
WindowsMedia9-KB954156-x64-TRK /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003 x64 Edition ve Windows Server 2003 x64 Edition Service Pack 2 üzerinde çalıştırıldığında Windows Media Encoder 9 Series:
WindowsMedia9-KB954156-32bit-x64-TRK /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Kayıt Defteri Anahtarı Doğrulaması</strong></td>
<td style="border:1px solid black;">Windows Server 2003 Service Pack 1 ve Windows Server 2003 Service Pack 2 üzerinde çalıştırıldığında Windows Media Encoder 9 Series:
HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Updates\Windows Media Encoder\SP0\KB954156_WM9L</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003 x64 Edition ve Windows Server 2003 x64 Edition Service Pack 2 üzerinde çalıştırıldığında Windows Media Encoder 9 Series x64 Edition:
HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Updates\Windows Media Encoder\SP0\KB954156_WM10L</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
...
<tr class="odd">
<td style="border:1px solid black;">Kullanıcı araya girmeden yükleme</td>
<td style="border:1px solid black;">Windows Vista ve Windows Vista Service Pack 1 üzerinde çalıştırıldığında Windows Media Encoder 9 Series:<br />
WindowsMedia9-KB954156-INTL /q:a<br />
<br />
Windows Vista x64 Edition ve Windows Vista x64 Edition Service Pack 1 üzerinde çalıştırıldığında Windows Media Encoder 9 Series x64 Edition:<br />
WindowsMedia9-KB954156-x64-INTL /q:a  
Windows Vista x64 Edition ve Windows Vista x64 Edition Service Pack 1 üzerinde çalıştırıldığında Windows Media Encoder 9 Series:
...
<td style="border:1px solid black;">Yeniden başlatma gerekiyor mu?</td>
<td style="border:1px solid black;">Bazı durumlarda, bu güncelleştirme bilgisayarın yeniden başlatılmasını gerektirmez. Ancak, gereken dosyalar o sırada kullanılıyorsa, bu güncelleştirme için bilgisayarın yeniden başlatılması gerekir. Bu durumda, yeniden başlatmanızı öneren bir ileti görüntülenir.
Yeniden başlatma gereksinimi olasılığını azaltmak için, güvenlik güncelleştirmesini yüklemeden önce, etkilenen tüm hizmetleri durdurun ve etkilenen dosyaları kullanabilecek tüm uygulamaları kapatın. Yeniden başlatmanızın istenmesinin olası nedenleri hakkında daha fazla bilgi için.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Anında Düzeltme</td>
...
| **/c**     | Dosyaları yüklemeden ayıklar. **/t:yol** belirtilmezse, hedef klasör sorulur.                                                |  
...
<tr class="odd">
<td style="border:1px solid black;">Kullanıcı araya girmeden yükleme</td>
<td style="border:1px solid black;">32-bit sistemler için Windows Server 2008 üzerinde çalıştırıldığında Windows Media Encoder 9 Series:<br />
WindowsMedia9-KB954156-INTL /q:a<br />
<br />
x64 tabanlı sistemler için Windows Server 2008 üzerinde çalıştırıldığında Windows Media Encoder 9 Series x64 Edition:<br />
WindowsMedia9-KB954156-x64-INTL /q:a<br />
  
x64 tabanlı sistemler için Windows Server 2008 üzerinde çalıştırıldığında Windows Media Encoder 9 Series:
WindowsMedia9-KB954156-INTL /q:a</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">Windows Server 2008 üzerinde çalıştırıldığında Windows Media Encoder 9 Series:<br />
WindowsMedia9-KB954156-INTL /r:n<br />
<br />
x64 tabanlı sistemler için Windows Server 2008 üzerinde çalıştırıldığında Windows Media Encoder 9 Series x64 Edition:<br />
...
<tr class="odd">
<td style="border:1px solid black;">Yeniden başlatma gerekiyor mu?</td>
<td style="border:1px solid black;">Bu güncelleştirme genelde yeniden başlatma gerektirmez. Ancak, gereken dosyalar o sırada kullanılıyorsa, bu güncelleştirme için bilgisayarın yeniden başlatılması gerekir. Bu durumda, yeniden başlatmanızı öneren bir ileti görüntülenir.
Yeniden başlatma gereksinimi olasılığını azaltmak için, güvenlik güncelleştirmesini yüklemeden önce, etkilenen tüm hizmetleri durdurun ve etkilenen dosyaları kullanabilecek tüm uygulamaları kapatın. Yeniden başlatmanızın istenmesinin olası nedenleri hakkında daha fazla bilgi için.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Anında Düzeltme</td>
...
**Not** Wusa.exe yükleyicisi hakkında daha fazla bilgi için, bkz: [Microsoft Bilgi Bankası makalesi 197147](http://support.microsoft.com/kb/197147).
...
-   [Bach Khoa Internetwork Security Center (BKIS) Hanoi University of Technology (Vietnam)](http://security.bkis.vn/) için çalışan Nguyen Minh Duc ve Le Manh Tung, Windows Media Encoder Güvenlik Açığı'nı (CVE-2008-3008) bildirdikleri için
...
-   V1.1 (10 Eylül 2008): Windows Vista ve Windows Server 2008 için **Güvenlik Güncelleştirmesi Dağıtımı** bölümlerindeki "Kullanıcı araya girmeden yükleme" ve "Yeniden başlatmadan yükleme" anahtarları düzeltildi. Ayrıca, **Windows Media Encoder'da Arabellek Taşması Güvenlik Açığı - CVE-2008-3008 için Geçici Çözümler** komutlarındaki "C:\\Program Files" öğesi "%programfiles%" olarak değiştirildi.  
-   V2.0 (15 Eylül 2008): Microsoft Windows 2000 Service Pack 4 üzerinde çalıştırıldığında Windows Media Encoder 9 Series, Windows XP Service Pack 2 ve Windows XP Service Pack 3 üzerinde çalıştırıldığında Windows Media Encoder 9 Series, Windows Server 2003 Service Pack 1 ve Windows Server 2003 Service Pack 2 üzerinde çalıştırıldığında Windows Media Encoder 9 Series için Norveççe dil güncelleştirmesinin yeniden yayımlandığını duyurmak üzere **Bu Güvenlik Güncelleştirmesi İle İlgili Sık Sorulan Sorular (SSS)** bölümüne bir girdi eklendi. Norveççe dil güncelleştirmelerine gereksinim duyan müşterilerin yeniden yayımlanan güncelleştirmeleri karşıdan yükleyip kurmaları gerekmektedir.
