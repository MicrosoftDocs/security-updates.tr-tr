---
TOCTitle: 'MS08-003'
Title: 'Microsoft Güvenlik Bülteni MS08-003 - Önemli'
ms:assetid: 'ms08-003'
ms:contentKeyID: 61235385
ms:mtpsurl: 'https://technet.microsoft.com/tr-TR/library/ms08-003(v=Security.10)'
---
...
Yayım Tarihi: 12 Şubat 2008 Salı | Güncelleştirme Tarihi: 26 Mart 2008 Çarşamba
...
Bu önemli güvenlik güncelleştirmesi, Microsoft Windows 2000 Server ve Windows Server 2003 üzerinde Active Directory ve Windows XP ve Windows Server 2003 üzerinde Active Directory Uygulama Modu (ADAM) uygulamalarında özel olarak bildirilen bir güvenlik açığını giderir. Güvenlik açığı hizmet reddi durumuna neden olabilir. Windows Server 2003 ve Windows XP'de bir saldırganın bu açıktan yararlanabilmesi için, geçerli oturum açma kimlik bilgilerine sahip olması gerekir. Bu güvenlik açığından başarıyla yararlanan bir saldırgan, sistemin yanıt vermemesine veya otomatik olarak yeniden başlatılmasına neden olabilir.

Bu güncelleştirme, Microsoft Windows 2000'in desteklenen tüm sürümleri için önemli, Windows XP ve Windows Server 2003 için orta düzeyde bir güvenlik güncelleştirmesidir. Daha fazla bilgi için, bu bölümdeki **Etkilenen ve Etkilenmeyen Yazılımlar** alt bölümüne bakın.

Bu güvenlik güncelleştirmesi istemci LDAP isteklerini doğrulayarak güvenlik açığını ortadan kaldırır. Bu güvenlik açığı hakkında daha fazla bilgi için, bir sonraki bölüm olan **Güvenlik Açığı Bilgileri** altında, ilgili güvenlik açığı girdisinin Sık Sorulan Sorular (SSS) alt bölümüne bakın.

**Öneri.** Microsoft, müşterilerin güncelleştirmeyi ilk fırsatta uygulamalarını önerir.

**Bilinen Sorunlar.**  [Microsoft Bilgi Bankası makalesi 946538](http://support.microsoft.com/kb/946538) bu güvenlik güncelleştirmesini yükleyen müşterilerin karşılaşabileceği bilinen sorunları belgelemektedir. Bu makale ayrıca, bu sorunlar için önerilen çözümleri de içermektedir.
...
<tr class="odd">
<td style="border:1px solid black;">Windows XP Professional x64 Edition ve Windows XP Professional Edition Service Pack 2</td>
...
<span></span>
**Müşterilerin bu güvenlik güncelleştirmesini yüklerken karşılaşabilecekleri bilinen sorun nedir?**  
Microsoft, Microsoft Exchange Server'ın Exchange Yönetim Konsolu'nda çok büyük boyutlu posta kutusu listelerini görüntülemeye çalışırken LDAP sorgularının başarısız olabileceğinin farkındadır. Bu sorun hakkında daha fazla bilgi için, [Microsoft Bilgi Bankası makalesi 946538](http://support.microsoft.com/kb/946538)'in bilinen sorunlar bölümüne bakın.
...
<th style="border:1px solid black;" >Active Directory Güvenlik Açığı - CVE-2008-0088</th>
<th style="border:1px solid black;" >Toplam Önem Derecesi</th>
</tr>
</thead>
<tbody>
...
<tr class="even">
<td style="border:1px solid black;">Windows XP Professional Service Pack 2 üzerine yüklendiğinde ADAM</td>
<td style="border:1px solid black;"><strong>Orta </strong><br />
Hizmet Reddi</td>
<td style="border:1px solid black;"><strong>Orta</strong></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Windows XP Professional x64 Edition ve Windows XP Professional Edition Service Pack 2 üzerine yüklendiğinde ADAM</td>
<td style="border:1px solid black;"><strong>Orta </strong><br />
Hizmet Reddi</td>
<td style="border:1px solid black;"><strong>Orta</strong></td>
</tr>
...
Active Directory Güvenlik Açığı - CVE-2008-0088  
-----------------------------------------------
  
<span></span>
Microsoft Windows 2000 ve Windows Server 2003 üzerine yüklendiğinde Active Directory'de bir hizmet reddi güvenlik açığı bulunmaktadır. Güvenlik açığı, Windows XP ve Windows Server 2003 üzerine yüklendiğinde Active Directory Uygulama Modu (ADAM) uygulamalarında da bulunmaktadır. Bu güvenlik açığı, özel hazırlanmış LDAP isteklerinin hatalı doğrulanması nedeniyle oluşur. Bu güvenlik açığından başarıyla yararlanan bir saldırgan, bilgisayarın yanıt vermemesine ve yeniden başlatılmasına neden olabilir.
  
Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2008-0088](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0088).
  
#### Active Directory Güvenlik Açığı - CVE-2008-0088 için Azaltıcı Etkenler
...
#### Active Directory Güvenlik Açığı - CVE-2008-0088 Hakkında SSS
...
[ADAM](http://technet2.microsoft.com/windowsserver/en/library/29fb059e-544c-4577-bf7c-ba4b08df48431033.mspx?mfr=true) bir sistem hizmeti olarak değil, bir kullanıcı hizmeti olarak çalışan bir Basit Dizin Erişim Protokolü (LDAP) dizin hizmetidir.
...
#### Active Directory yüklenmiş olarak Windows 2000 Server (KB943484)
...
Windows2000-kb943484-x86-trk /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">Windows 2000 Service Pack 4:<br />
Windows2000- kb943484-x86-trk /norestart</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">Windows 2000 Service Pack 4:<br />
Denetim Masası'ndaki Program Ekle veya Kaldır aracını veya %Windir%\$NTUninstall kb943484$\Spuninst klasöründe bulunan Spuninst.exe yardımcı programını kullanın</td>
</tr>
<tr class="odd">
...
|------------|---------------|-------------|-------|-----------|
| ntdsa.dll  | 5.0.2195.7147 | 16 Eki 2007 | 00:46 | 939.280   |
...
#### ADAM yüklenmiş olarak Windows XP (KB931374)
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Gelecekteki Hizmet Paketlerine Eklenmesi</strong></td>
<td style="border:1px solid black;">Bu isteğe bağlı bir bileşen olduğu için, bu sorunla ilgili güncelleştirme gelecekteki bir hizmet paketine veya güncelleştirme toplamasına eklenmeyecektir</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Dağıtım</strong></td>
<td style="border:1px solid black;"></td>
...
WindowsXP-KB931374-x86-TRK /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
WindowsServer2003.WindowsXP- KB931374-x64-TRK.exe /quite</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">Windows XP Service Pack 2:<br />
WindowsXP- KB931374-x86-TRK.exe /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition ve Windows XP Professional x64 Edition Service Pack 2:<br />
WindowsServer2003.WindowsXP- KB931374-x64-TRK.exe /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Güncelleştirme günlük dosyası</td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>Kaldırma Bilgileri</strong></td>
<td style="border:1px solid black;">Denetim Masası'ndaki Program Ekle veya Kaldır aracını veya %Windir%\$NTUninstallKB931374$\Spuninst klasöründe bulunan Spuninst.exe yardımcı programını kullanın</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Dosya Bilgileri</strong></td>
<td style="border:1px solid black;">Tam dosya listesi için aşağıdaki <strong>Dosya Bilgileri</strong> alt bölümüne bakın</td>
...
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP'nin tüm desteklenen sürümleri:
...
**Not:** Windows XP Home Service Pack 2, Windows XP Tablet Edition Service Pack 2 ve Windows XP Media Center Edition Service Pack 2'de ADAM veya Active Directory sunucu bileşeni olmadığından, bu işletim sistemlerinin desteklenen sürümleri bu açıktan etkilenmez.
...
|-------------|---------------|-------------|-------|-----------|--------|
| adamdsa.dll | 1.1.3790.4188 | 06 Oca 2008 | 17:35 | 1.631.744 | SP2GDR |
| adamdsa.dll | 1.1.3790.4188 | 06 Oca 2008 | 17:50 | 1.632.768 | SP2QFE |

Windows XP'nin tüm desteklenen 64-bit sürümleri:

| Dosya Adı   | Sürüm         | Tarih       | Saat  | Boyut     | CPU | Klasör |
|-------------|---------------|-------------|-------|-----------|-----|--------|
| adamdsa.dll | 1.1.3790.3043 | 10 Oca 2008 | 15:48 | 2.953.216 | X64 | SP1GDR |
| adamdsa.dll | 1.1.3790.3043 | 10 Oca 2008 | 15:48 | 2.956.288 | X64 | SP1QFE |
| adamdsa.dll | 1.1.3790.4188 | 10 Oca 2008 | 16:02 | 2.957.824 | X64 | SP2GDR |
| adamdsa.dll | 1.1.3790.4188 | 10 Oca 2008 | 15:46 | 2.959.360 | X64 | SP2QFE |
...
#### Active Directory yüklenmiş olarak Windows Server 2003 (tüm sürümler) (KB943484)
...
Windowsserver2003-kb943484-x86-trk /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen Itanium tabanlı sürümleri:
WindowsServer2003-kb943484-ia64-trk /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen x64 tabanlı sürümleri:
WindowsServer2003.WindowsXP-kb943484-x64-trk /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen 32 bit sürümleri:<br />
Windowsserver2003-kb943484-x86-trk /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen Itanium tabanlı sürümleri:<br />
WindowsServer2003-kb943484-ia64-trk /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen x64 tabanlı sürümleri:
WindowsServer2003.WindowsXP-kb943484-x64-trk /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Güncelleştirme günlük dosyası</td>
...
Denetim Masası'ndaki Program Ekle veya Kaldır aracını veya %Windir%\$NTUninstallKB943484$\Spuninst klasöründe bulunan Spuninst.exe yardımcı programını kullanın</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Dosya Bilgileri</strong></td>
<td style="border:1px solid black;">Tam dosya listesi için aşağıdaki <strong>Dosya Bilgileri</strong> alt bölümüne bakın</td>
...
| Dosya Adı    | Sürüm         | Tarih       | Saat  | Boyut     | Klasör |
|--------------|---------------|-------------|-------|-----------|--------|
| ntdsa.dll    | 5.2.3790.3043 | 13 Kas 2007 | 21:33 | 1.515.520 | SP1GDR |
| ntdsa.dll    | 5.2.3790.3043 | 13 Kas 2007 | 22:03 | 1.524.224 | SP1QFE |
| w03a2409.dll | 5.2.3790.3057 | 11 Ara 2007 | 21:40 | 28.672    | SP1QFE |
| ntdsa.dll    | 5.2.3790.4188 | 13 Kas 2007 | 21:43 | 1.522.176 | SP2GDR |
| ntdsa.dll    | 5.2.3790.4188 | 13 Kas 2007 | 21:36 | 1.525.248 | SP2QFE |

Windows Server 2003'ün tüm desteklenen Itanium tabanlı sürümleri:

| Dosya Adı     | Sürüm         | Tarih       | Saat  | Boyut     | CPU   | Klasör      |
|---------------|---------------|-------------|-------|-----------|-------|-------------|
| ntdsa.dll     | 5.2.3790.3043 | 19 Ara 2007 | 07:38 | 4.237.312 | IA-64 | SP1GDR      |
| wntdsa.dll    | 5.2.3790.3043 | 19 Ara 2007 | 07:38 | 1.515.520 | X86   | SP1GDR\\wow |
| ntdsa.dll     | 5.2.3790.3043 | 19 Ara 2007 | 07:38 | 4.257.280 | IA-64 | SP1QFE      |
| w03a2409.dll  | 5.2.3790.3057 | 19 Ara 2007 | 07:38 | 27.648    | IA-64 | SP1QFE      |
| wntdsa.dll    | 5.2.3790.3043 | 19 Ara 2007 | 07:38 | 1.524.224 | X86   | SP1QFE\\wow |
| ww03a2409.dll | 5.2.3790.3057 | 19 Ara 2007 | 07:38 | 28.672    | X86   | SP1QFE\\wow |
| ntdsa.dll     | 5.2.3790.4188 | 19 Ara 2007 | 07:47 | 4.253.184 | IA-64 | SP2GDR      |
| wntdsa.dll    | 5.2.3790.4188 | 19 Ara 2007 | 07:47 | 1.522.176 | X86   | SP2GDR\\wow |
| ntdsa.dll     | 5.2.3790.4188 | 19 Ara 2007 | 07:35 | 4.260.352 | IA-64 | SP2QFE      |
| wntdsa.dll    | 5.2.3790.4188 | 19 Ara 2007 | 07:35 | 1.525.248 | X86   | SP2QFE\\wow |

Windows Server 2003'ün tüm desteklenen x64 tabanlı sürümleri:

| Dosya Adı     | Sürüm         | Tarih       | Saat  | Boyut     | CPU | Klasör      |
|---------------|---------------|-------------|-------|-----------|-----|-------------|
| ntdsa.dll     | 5.2.3790.3043 | 19 Ara 2007 | 07:34 | 2.947.072 | X64 | SP1GDR      |
| wntdsa.dll    | 5.2.3790.3043 | 19 Ara 2007 | 07:34 | 1.515.520 | X86 | SP1GDR\\wow |
| ntdsa.dll     | 5.2.3790.3043 | 19 Ara 2007 | 07:34 | 2.968.576 | X64 | SP1QFE      |
| w03a2409.dll  | 5.2.3790.3057 | 19 Ara 2007 | 07:34 | 29.184    | X64 | SP1QFE      |
| wntdsa.dll    | 5.2.3790.3043 | 19 Ara 2007 | 07:34 | 1.524.224 | X86 | SP1QFE\\wow |
| ww03a2409.dll | 5.2.3790.3057 | 19 Ara 2007 | 07:34 | 28.672    | X86 | SP1QFE\\wow |
| ntdsa.dll     | 5.2.3790.4188 | 19 Ara 2007 | 07:47 | 2.967.040 | X64 | SP2GDR      |
| wntdsa.dll    | 5.2.3790.4188 | 19 Ara 2007 | 07:47 | 1.522.176 | X86 | SP2GDR\\wow |
| ntdsa.dll     | 5.2.3790.4188 | 19 Ara 2007 | 07:35 | 2.970.112 | X64 | SP2QFE      |
| wntdsa.dll    | 5.2.3790.4188 | 19 Ara 2007 | 07:35 | 1.525.248 | X86 | SP2QFE\\wow |
...
#### ADAM yüklenmiş olarak Windows Server 2003 (tüm sürümler) (KB931374)
...
<td style="border:1px solid black;">Kullanıcı araya girmeden yükleme</td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen 32 bit sürümleri:<br />
Windowsserver2003-kb931374-x86-trk /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen x64 tabanlı sürümleri:
WindowsServer2003.WindowsXP-KB931374-x64-trk /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen 32 bit sürümleri:<br />
Windowsserver2003-kb931374-x86-trk /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen x64 tabanlı sürümleri:
WindowsServer2003.WindowsXP-KB931374-x64-trk /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Güncelleştirme günlük dosyası</td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>Kaldırma Bilgileri</strong></td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen 32-bit ve x64 tabanlı sürümleri:
Denetim Masası'ndaki Program Ekle veya Kaldır aracını veya %Windir%\$NTUninstallKB931374$\Spuninst klasöründe bulunan Spuninst.exe yardımcı programını kullanın</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Dosya Bilgileri</strong></td>
<td style="border:1px solid black;">Tam dosya listesi için aşağıdaki <strong>Dosya Bilgileri</strong> alt bölümüne bakın</td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>Kayıt Defteri Anahtarı Doğrulaması</strong></td>
<td style="border:1px solid black;">Windows Server 2003 Service Pack 1 ve Windows Server 2003 Service Pack 2'nin tüm desteklenen 32-bit sürümleri ve x64 tabanlı sürümleri:<br />
...
| Dosya Adı   | Sürüm         | Tarih       | Saat  | Boyut     | Klasör |
|-------------|---------------|-------------|-------|-----------|--------|
| adamdsa.dll | 1.1.3790.3043 | 13 Kas 2007 | 21:33 | 1.630.720 | SP1GDR |
| adamdsa.dll | 1.1.3790.3043 | 13 Kas 2007 | 22:03 | 1.631.232 | SP1QFE |
| adamdsa.dll | 1.1.3790.4188 | 13 Kas 2007 | 21:43 | 1.631.744 | SP2GDR |
| adamdsa.dll | 1.1.3790.4188 | 13 Kas 2007 | 21:36 | 1.632.768 | SP2QFE |
...
-   [SkyRecon](http://www.skyrecon.com/) için çalışan Thomas Garnier, Active Directory Güvenlik Açığı'nı – (CVE-2008-0088) bildirdiği için.
...
-   V1.2 (26 Mart 2008): Bülten, bilinen sorunlar bölümüne BB bağlantısı eklenerek güncelleştirildi.
-   
