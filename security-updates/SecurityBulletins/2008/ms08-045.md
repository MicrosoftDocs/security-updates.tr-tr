---
TOCTitle: 'MS08-045'
Title: 'Microsoft Güvenlik Bülteni MS08-045 - Kritik'
ms:assetid: 'ms08-045'
ms:contentKeyID: 61235428
ms:mtpsurl: 'https://technet.microsoft.com/tr-TR/library/ms08-045(v=Security.10)'
---

Security Bulletin

Microsoft Güvenlik Bülteni MS08-045 - Kritik
============================================

Internet Explorer için Toplu Güvenlik Güncelleştirmesi (953838)
---------------------------------------------------------------

Yayım Tarihi: 12 Ağustos 2008 Salı | Güncelleştirme Tarihi: 20 Ağustos 2008 Çarşamba
...
Bu güvenlik güncelleştirmesi, Internet Explorer'ın tüm desteklenen sürümleri için Kritik olarak derecelendirilmiştir. Daha fazla bilgi için, bu bölümdeki **Etkilenen ve Etkilenmeyen Yazılımlar** alt bölümüne bakın.
...
Microsoft bu bülteni, Windows XP için bir kayıt defteri anahtarı doğrulama girdisini düzeltmek ve CVE-2008-2256 için bir azaltıcı etken eklemek üzere yeniden düzenledi.

**Dosya bilgileri ayrıntılarını nerede bulabilirim?**  
Dosya bilgileri ayrıntıları [Microsoft Bilgi Bankası makalesi 953838](http://support.microsoft.com/kb/953838)'de bulunabilir.
...
<th style="border:1px solid black;" >HTML Nesnesinde Bellek Bozulması Güvenlik Açığı – CVE-2008-2254</th>
<th style="border:1px solid black;" >HTML Nesnelerinde Bellek Bozulması Güvenlik Açığı - CVE-2008-2255</th>
<th style="border:1px solid black;" >Başlatılmamış Belleğin Bozulması Güvenlik Açığı - CVE-2008-2256</th>
<th style="border:1px solid black;" >HTML Nesnelerinde Bellek Bozulması Güvenlik Açığı - CVE-2008-2257</th>
<th style="border:1px solid black;" >HTML Nesnelerinde Bellek Bozulması Güvenlik Açığı - CVE-2008-2258</th>
<th style="border:1px solid black;" >HTML Bileşenini İşleme Güvenlik Açığı - CVE-2008-2259</th>
...
HTML Nesnelerinde Bellek Bozulması Güvenlik Açığı – CVE-2008-2254  
-----------------------------------------------------------------
...
Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2008-2254](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2254).
  
#### HTML Nesnelerinde Bellek Bozulması Güvenlik Açığı – CVE-2008-2254 için Azaltıcı Etkenler
...
-   Internet Explorer, Windows Server 2003 ve Windows Server 2008 üzerinde varsayılan olarak [Artırılmış Güvenlik Yapılandırması](http://go.microsoft.com/fwlink/?linkid=92039) adı verilen kısıtlı bir modda çalışır. Bu mod, Internet bölgesi için güvenlik düzeyini Yüksek olarak ayarlar. Bu, Internet Explorer'ın Güvenilen siteler bölgesine eklenmemiş Web siteleri için bir azaltıcı etkendir. Internet Explorer Artırılmış Güvenlik Yapılandırması hakkında daha fazla bilgi için bu güvenlik açığıyla ilgili bölümün SSS (Sık Sorulan Sorular) alt bölümüne bakın.
  
#### HTML Nesnelerinde Bellek Bozulması Güvenlik Açığı – CVE-2008-2254 için Geçici Çözümler
...
-   **Microsoft Outlook 2002 veya sonraki bir sürümünü ya da Outlook Express 6 SP1 veya sonraki bir sürümünü kullanıyorsanız, HTML e-posta saldırı vektöründen korunmak için e-postaları düz metin biçiminde okuyun.**
...
#### HTML Nesnelerinde Bellek Bozulması Güvenlik Açığı – CVE-2008-2254 Hakkında SSS
...
Güncelleştirme, Internet Explorer'ın yararlanma durumuna neden olan hatayı işleme biçimini değiştirerek güvenlik açığını giderir.
...
HTML Nesnelerinde Bellek Bozulması Güvenlik Açığı – CVE-2008-2255  
-----------------------------------------------------------------
  
<span></span>
Internet Explorer'da, belirli durumlarda başlatılmamış belleğe erişim girişimleri nedeniyle uzaktan kod yürütülmesine neden olabilecek bir güvenlik açığı bulunmaktadır. Saldırgan, özel hazırlanmış bir Web sayfası oluşturarak bu güvenlik açığından yararlanabilir. Bir kullanıcı bu Web sayfasını görüntülediğinde, güvenlik açığı uzaktan kod yürütülmesine izin verebilir. Bu güvenlik açığından başarıyla yararlanan bir saldırgan, oturum açan kullanıcı ile aynı haklara sahip olabilir.
  
Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2008-2255](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2255).
  
#### HTML Nesnelerinde Bellek Bozulması Güvenlik Açığı – CVE-2008-2255 için Azaltıcı Etkenler
...
#### HTML Nesnelerinde Bellek Bozulması Güvenlik Açığı – CVE-2008-2255 için Geçici Çözümler
...
#### HTML Nesnelerinde Bellek Bozulması Güvenlik Açığı – CVE-2008-2255 Hakkında SSS
...
**Bu güvenlik bülteni yayımlandığında bu güvenlik açığı genel olarak duyurulmuş muydu?**  
Evet. Bu güvenlik açığı genel olarak duyurulmuştur. Ortak Güvenlik Açığı ve Etkilenme (Common Vulnerability and Exposure) numarası olarak CVE-2008-2255 atanmıştır.
  
**Bu güvenlik bülteni yayımlandığında, Microsoft bu güvenlik açığından yararlanıldığına dair herhangi bir rapor almış mıydı?**  
Hayır. Microsoft, bu güvenlik açığının müşterilere saldırmak amacıyla açıkça kullanıldığına dair herhangi bir bilgi almadı. Ayrıca, bu güvenlik bülteni ilk yayımlandığında, açığın kanıtı olabilecek kod örneği yayımlandığını görmedi.
  
Başlatılmamış Belleğin Bozulması Güvenlik Açığı – CVE-2008-2256  
---------------------------------------------------------------
...
Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2008-2256](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2256).
  
#### Başlatılmamış Belleğin Bozulması Güvenlik Açığı – CVE-2008-2256 için Azaltıcı Etkenler
  
-   Bu güvenlik açığından başarıyla yararlanan bir saldırgan, yerel kullanıcı ile aynı haklara sahip olabilir. Hesapları, sistemde az sayıda kullanıcı hakkıyla yapılandırılmış olan kullanıcılar, yönetici haklarıyla çalışan kullanıcılardan daha az etkilenebilir.
  
#### Başlatılmamış Belleğin Bozulması Güvenlik Açığı – CVE-2008-2256 için Geçici Çözümler
  
-   Yok
  
#### Başlatılmamış Belleğin Bozulması Güvenlik Açığı – CVE-2008-2256 Hakkında SSS
...
HTML Nesnelerinde Bellek Bozulması Güvenlik Açığı – CVE-2008-2257 ve CVE-2008-2258  
----------------------------------------------------------------------------------
  
<span></span>
Internet Explorer'da, belirli durumlarda başlatılmamış belleğe erişim girişimleri nedeniyle uzaktan kod yürütülmesine neden olabilecek bir güvenlik açığı bulunmaktadır. Saldırgan, özel hazırlanmış bir Web sayfası oluşturarak bu güvenlik açığından yararlanabilir. Bir kullanıcı bu Web sayfasını görüntülediğinde, güvenlik açığı uzaktan kod yürütülmesine izin verebilir. Bu güvenlik açığından başarıyla yararlanan bir saldırgan, oturum açan kullanıcı ile aynı haklara sahip olabilir.
  
Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2008-2257](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2257) ve [CVE-2008-2258](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2258).
  
#### HTML Nesnelerinde Bellek Bozulması Güvenlik Açığı – CVE-2008-2257 ve CVE-2008-2258 için Azaltıcı Etkenler
...
#### HTML Nesnelerinde Bellek Bozulması Güvenlik Açığı – CVE-2008-2257 ve CVE-2008-2258 için Geçici Çözümler
...
#### HTML Nesnelerinde Bellek Bozulması Güvenlik Açığı – CVE-2008-2257 ve CVE-2008-2258 Hakkında SSS
...
HTML Bileşenini İşleme Güvenlik Açığı – CVE-2008-2259  
-----------------------------------------------------
  
<span></span>
Internet Explorer'ın baskı önizleme işlemlerini gerçekleştirirken bağımsız değişken doğrulaması yapma biçiminde uzaktan kod yürütülmesine neden olabilecek bir güvenlik açığı bulunmaktadır. Saldırgan, özel hazırlanmış bir Web sayfası oluşturarak bu güvenlik açığından yararlanabilir. Bir kullanıcı bu Web sayfasını görüntülediğinde, güvenlik açığı uzaktan kod yürütülmesine izin verebilir. Bu güvenlik açığından başarıyla yararlanan bir saldırgan, oturum açan kullanıcı ile aynı haklara sahip olabilir.
  
Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2008-2259](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2259).
  
#### HTML Bileşenini İşleme Güvenlik Açığı – CVE-2008-2259 için Azaltıcı Etkenler
  
-   Web tabanlı saldırı senaryosunda, bir saldırganın bu açıktan yararlanmak için kullanılan bir Web sayfası içeren bir Web sitesi barındırabilir. Ayrıca, kullanıcı tarafından sağlanan içeriği veya reklamları kabul eden ya da barındıran güvenliği aşılmış Web sitelerinde, bu güvenlik açığından yararlanılabilecek özel hazırlanmış içerik bulunabilir. Ancak bu durumların hiçbirinde, saldırganın, bu Web sitelerini ziyaret etmek için kullanıcıyı zorlama yolu yoktur. Bunun yerine, saldırganın kullanıcıları bir e-posta iletisindeki veya Instant Messenger iletisindeki kendi Web sitesine götüren bir bağlantıyı tıklatmalarını sağlayarak onları bu Web sitesini ziyaret etmeye ikna etmesi gerekir.  
-   Bu güvenlik açığından başarıyla yararlanan bir saldırgan, yerel kullanıcı ile aynı haklara sahip olabilir. Hesapları, sistemde az sayıda kullanıcı hakkıyla yapılandırılmış olan kullanıcılar, yönetici haklarıyla çalışan kullanıcılardan daha az etkilenebilir.  
-   Internet Explorer, Windows Server 2003 ve Windows Server 2008 üzerinde varsayılan olarak [Artırılmış Güvenlik Yapılandırması](http://go.microsoft.com/fwlink/?linkid=92039) adı verilen kısıtlı bir modda çalışır. Bu mod, Internet bölgesi için güvenlik düzeyini Yüksek olarak ayarlar. Bu, Internet Explorer'ın Güvenilen siteler bölgesine eklenmemiş Web siteleri için bir azaltıcı etkendir. Internet Explorer Artırılmış Güvenlik Yapılandırması hakkında daha fazla bilgi için bu güvenlik açığıyla ilgili bölümün SSS (Sık Sorulan Sorular) alt bölümüne bakın.
  
#### HTML Bileşenini İşleme Güvenlik Açığı – CVE-2008-2259 için Geçici Çözümler
...
#### HTML Bileşenini İşleme Güvenlik Açığı – CVE-2008-2259 Hakkında SSS
...
**Güvenlik açığına ne neden olmaktadır?**  
Internet Explorer belirli durumlarda baskı önizleme işlemlerini gerçekleştirirken bağımsız değişkenleri hatalı biçimde doğrular. Sonuçta, bir saldırganın oturum açan kullanıcının bağlamında rasgele kod yürütmesine olanak verecek biçimde özel hazırlanmış bir Web sayfası görüntülenebilir. Hesapları, sistemde az sayıda kullanıcı hakkıyla yapılandırılmış olan kullanıcılar, yönetici haklarıyla çalışan kullanıcılardan daha az etkilenebilir.
...
**Güncelleştirme ne yapıyor?**  
Güncelleştirme, Internet Explorer'ın baskı önizlemeye geçirilen bağımsız değişkenleri işleme biçimini değiştirerek güvenlik açığını giderir.
...
\* SMS 2.0 ve SUSFP ile birlikte SMS 2003, Internet Explorer'ın IE7 dışındaki tüm etkilenen sürümlerini destekler. Daha fazla bilgi için, bkz. [Microsoft Bilgi Bankası makalesi 924178](http://support.microsoft.com/kb/924178).
...
IE5.01sp4-KB953838-Windows2000sp4-x86-trk /quiet<br />
<br />
Windows 2000'in tüm desteklenen sürümleri üzerine yüklendiğinde Internet Explorer 6 Service Pack 1 için:<br />
IE6.0sp1-KB953838-Windows2000-x86-trk /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">Windows 2000'in tüm desteklenen sürümleri üzerinde Internet Explorer 5.01 Service Pack 4 için:<br />
IE5.01sp4-KB953838-Windows2000sp4-x86-trk /norestart<br />
<br />
Windows 2000'in tüm desteklenen sürümleri üzerine yüklendiğinde Internet Explorer 6 Service Pack 1 için:<br />
IE6.0sp1-KB953838-Windows2000-x86-trk /norestart</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">Windows 2000'in tüm desteklenen sürümleri üzerinde Internet Explorer 5.01 Service Pack 4 için:<br />
Denetim Masası'ndaki Program Ekle veya Kaldır aracını veya %Windir%\$NTUninstallKB953838-IE501SP4-20080620.120000$\Spuninst klasöründe bulunan Spuninst.exe yardımcı programını kullanın<br />
<br />
Windows 2000'in tüm desteklenen sürümleri üzerine yüklendiğinde Internet Explorer 6 Service Pack 1 için:<br />
Denetim Masası'ndaki Program Ekle veya Kaldır aracını veya %Windir%\$NTUninstallKB953838-IE6SP1-20080620.120000$\Spuninst klasöründe bulunan Spuninst.exe yardımcı programını kullanın</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Dosya Bilgileri</strong></td>
<td style="border:1px solid black;">Bkz: <a href="http://support.microsoft.com/kb/953838">Microsoft Bilgi Bankası makalesi 953838</a></td>
</tr>
<tr class="even">
...
Windowsxp-KB953838-x86-trk /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
IE7-WindowsServer2003.WindowsXP-KB953838-x64-trk /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">Windows XP Service Pack 2 ve Windows XP Service Pack 3 için Internet Explorer 6:<br />
Windowsxp-KB953838-x86-trk /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition ve Windows XP Professional x64 Edition Service Pack 2 için Internet Explorer 6:<br />
WindowsServer2003.WindowsXP-KB953838-x64-trk / norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Service Pack 2 ve Windows XP Service Pack 3 için Internet Explorer 7:<br />
IE7-WindowsXP-KB953838-x86-trk /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition ve Windows XP Professional x64 Edition Service Pack 2 için Internet Explorer 7:<br />
IE7-WindowsServer2003.WindowsXP-KB953838-x64-trk /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Güncelleştirme günlük dosyası</td>
...
Denetim Masası'ndaki Program Ekle veya Kaldır aracını veya %Windir%\$NTUninstal\KB953838$\Spuninst klasöründe bulunan Spuninst.exe yardımcı programını kullanın</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP için Internet Explorer 7:<br />
Denetim Masası'ndaki Program Ekle veya Kaldır aracını veya %Windir%\ie7updates\KB953838-IE7\spuninst klasöründe bulunan Spuninst.exe yardımcı programını kullanın</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Dosya Bilgileri</strong></td>
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/953838">Bkz: Microsoft Bilgi Bankası makalesi 953838</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Kayıt Defteri Anahtarı Doğrulaması</strong></td>
...
Windowsserver2003-KB953838-x86-trk /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
IE7-WindowsServer2003-KB953838-ia64-trk /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen 32-bit sürümleri için Internet Explorer 6:<br />
Windowsserver2003-KB953838-x86-trk /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen x64 tabanlı sürümleri için Internet Explorer 6:<br />
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen Itanium tabanlı sürümleri için Internet Explorer 6:<br />
Windowsserver2003-KB953838-ia64-trk /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen 32-bit sürümleri için Internet Explorer 7:<br />
IE7-WindowsServer2003-KB953838-x86-trk /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen x64 tabanlı sürümleri için Internet Explorer 7:<br />
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen Itanium tabanlı sürümleri için Internet Explorer 7:<br />
IE7-WindowsServer2003-KB953838-ia64-trk /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Güncelleştirme günlük dosyası</td>
...
Denetim Masası'ndaki Program Ekle veya Kaldır aracını veya %Windir%\$NTUninstallKB953838$\Spuninst klasöründe bulunan Spuninst.exe yardımcı programını kullanın</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
-   [Palo Alto Networks](http://www.paloaltonetworks.com/) için çalışan Yamata Li, HTML Nesnesinde Bellek Bozulması Güvenlik Açığı'nı CVE-2008-2254 bildirdiği için.  
-   [Google Security Team](http://www.google.com/) için çalışan Tavis Ormandy, Başlatılmamış Belleğin Bozulması Güvenlik Açığı'nı CVE-2008-2256 bildirdiği için.  
-   [TippingPoint](http://www.tippingpoint.com/) için çalışan Sam Thomas ve [Zero Day Initiative](http://www.zerodayinitiative.com/), HTML Nesnelerinde Bellek Bozulması Güvenlik Açığı'nı CVE-2008-2257 bildirdikleri için.  
-   [TippingPoint](http://www.tippingpoint.com/) ve [Zero Day Initiative](http://www.zerodayinitiative.com/), HTML Nesnelerinde Bellek Bozulması Güvenlik Açığı'nı CVE-2008-2258 bildirdikleri için.
...
-   V1.1 (20 Ağustos 2008): Windows XP için bir kayıt defteri anahtarı doğrulama girdisi düzeltildi ve CVE-2008-2256 için bir geçici çözüm eklendi.
