---
TOCTitle: 'MS08-049'
Title: 'Microsoft Güvenlik Bülteni MS08-049 - Önemli'
ms:assetid: 'ms08-049'
ms:contentKeyID: 61235432
ms:mtpsurl: 'https://technet.microsoft.com/tr-TR/library/ms08-049(v=Security.10)'
---

Security Bulletin

Microsoft Güvenlik Bülteni MS08-049 - Önemli
============================================

Olay Sistemi'ndeki Güvenlik Açıkları Uzaktan Kod Yürütülmesine İzin Verebilir (950974)
--------------------------------------------------------------------------------------
...
Bu güvenlik güncelleştirmesi Microsoft Windows Olay Sistemi'nde uzaktan kod yürütülmesine neden olabileceği özel olarak bildirilen iki güvenlik açığını giderir. Bu açıkları başarıyla kullanan bir saldırgan, etkilenen sistemin tüm denetimini ele geçirebilir. Saldırgan, program yükleyebilir; verileri görüntüleyebilir, değiştirebilir veya silebilir; tüm yönetici haklarına sahip olan yeni hesaplar oluşturabilir.

Güvenlik güncelleştirmesi Windows 2000, Windows XP, Windows Server 2003, Windows Vista ve Windows Server 2008'in tüm desteklenen sürümleri için Önemli olarak derecelendirilmiştir. Daha fazla bilgi için, bu bölümdeki **Etkilenen ve Etkilenmeyen Yazılımlar** alt bölümüne bakın.

Bu güvenlik güncelleştirmesi, Olay Sistemi'nin kullanıcı başına abonelikleri işleme biçimini değiştirerek güvenlik açıklarını ortadan kaldırır. Bu güvenlik açıkları hakkında daha fazla bilgi için, bir sonraki bölüm olan **Güvenlik Açığı Bilgileri** altında, ilgili güvenlik açığı girdisinin Sık Sorulan Sorular (SSS) alt bölümüne bakın.

**Öneri.**  Microsoft, müşterilerin güncelleştirmeyi ilk fırsatta uygulamalarını önerir.

**Bilinen Sorunlar.** [Microsoft Bilgi Bankası makalesi 950974](http://support.microsoft.com/kb/950974) bu güvenlik güncelleştirmesini yükleyen müşterilerin karşılaşabileceği bilinen sorunları belgelemektedir. Bu makale ayrıca, bu sorunlar için önerilen çözümleri de içermektedir. Bu güncelleştirmeleri yükleme hakkında daha fazla bilgi için, bu bölümdeki **Bu Güvenlik Güncelleştirmesi İle İlgili Sık Sorulan Sorular (SSS)** alt bölümüne bakın.
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------|----------------------|---------------------------------------------|
| [Microsoft Windows 2000 Service Pack 4](http://www.microsoft.com/downloads/details.aspx?familyid=1b2ad648-7dc9-407a-99f6-f39922746027)                                                                            | Uzaktan Kod Yürütme       | Önemli               | Yok                                         |
| [Windows XP Service Pack 2 ve Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=01a34aa4-a456-4efc-a93a-c3c682b0181c)                                                           | Uzaktan Kod Yürütme       | Önemli               | Yok                                         |
| [Windows XP Professional x64 Edition ve Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=246b2686-e330-47a2-b4d4-68f218ad4021)                        | Uzaktan Kod Yürütme       | Önemli               | Yok                                         |
| [Windows Server 2003 Service Pack 1 ve Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=92a3d08f-c117-4b24-bc78-2b913d270df6)                                         | Uzaktan Kod Yürütme       | Önemli               | Yok                                         |
| [Windows Server 2003 x64 Edition ve Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=6bfbb6d8-5106-4adf-83cb-35ffc6e8eaf8)                                | Uzaktan Kod Yürütme       | Önemli               | Yok                                         |
| [Itanium tabanlı sistemler için Windows Server 2003 SP1 ve Itanium tabanlı sistemler için Windows Server 2003 SP2](http://www.microsoft.com/downloads/details.aspx?familyid=45356565-697f-41b3-9879-3edd11dbcb7e) | Uzaktan Kod Yürütme       | Önemli               | Yok                                         |
| [Windows Vista ve Windows Vista Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=6418c78f-f008-4028-beb1-5a5ea8e797a1)                                                                    | Uzaktan Kod Yürütme       | Önemli               | Yok                                         |
| [Windows Vista x64 Edition ve Windows Vista x64 Edition Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=e03ccfb0-3ea3-4c59-adcf-9882d7086013)                                            | Uzaktan Kod Yürütme       | Önemli               | Yok                                         |
| [32-bit sistemler için Windows Server 2008](http://www.microsoft.com/downloads/details.aspx?familyid=0640f95e-1eee-4dd1-b4dd-2b82b7e984b9)\*                                                                      | Uzaktan Kod Yürütme       | Önemli               | Yok                                         |
| [x64 tabanlı sistemler için Windows Server 2008](http://www.microsoft.com/downloads/details.aspx?familyid=51a93538-5e94-4f81-a6e0-d497a7b4899d)\*                                                                 | Uzaktan Kod Yürütme       | Önemli               | Yok                                         |
| [Itanium tabanlı sistemler için Windows Server 2008](http://www.microsoft.com/downloads/details.aspx?familyid=390da130-749d-4890-aad7-be91e15b32bb)                                                               | Uzaktan Kod Yürütme       | Önemli               | Yok                                         |
...
<span></span>
**Bu bültende sunulan güncelleştirmeyi Windows** **Vista** **RTM sistemleri üzerine yüklemek için herhangi bir önkoşul var mıdır?**  
Evet; Windows Vista RTM sistemleri için Microsoft Güvenlik Bülteni [MS08-008](http://go.microsoft.com/fwlink/?linkid=108277)'de veya [Microsoft Bilgi Bankası makalesi 938371](http://support.microsoft.com/kb/938371)'de sunulan güncelleştirmelerin, bu bültende sunulan güncelleştirmelerden önce yüklenmeleri gerekir. Bu güncelleştirmeler, Windows Vista RTM sistemleri için bu güncelleştirmenin yükleme güvenilirliğini geliştirmek üzere önkoşul olarak gerekmektedir. Windows Vista Service Pack 1 çalışan sistemler ve Etkilenen Yazılımlar tablosunda belirtilen diğer tüm sistemler benzer şekilde etkilenmez ve bu SSS girdisinde tanımlanan önkoşullar geçerli değildir.
...
<th style="border:1px solid black;" >Olay Sistemi Güvenlik Açığı - CVE-2008-1457</th>
<th style="border:1px solid black;" >Olay Sistemi Güvenlik Açığı - CVE-2008-1456</th>
...
Olay Sistemi Güvenlik Açığı - CVE-2008-1457  
-------------------------------------------
  
<span></span>
Microsoft Windows Olay Sistemi'nin kullanıcı aboneliklerini oluşturuldukları sırada düzgün biçimde doğrulamaması nedeniyle bir uzaktan kod yürütme güvenlik açığı bulunmaktadır. Bu güvenlik açığı, uzaktan kod yürütülmesine olanak verebilir. Bu açığı başarıyla kullanan bir saldırgan, etkilenen sistemin tüm denetimini ele geçirebilir. Saldırgan, program yükleyebilir; verileri görüntüleyebilir, değiştirebilir veya silebilir; tüm yönetici haklarına sahip olan yeni hesaplar oluşturabilir.
  
Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2008-1457](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-1457).
  
#### Olay Sistemi Güvenlik Açığı - CVE-2008-1457 için Azaltıcı Etkenler
  
Azaltıcı etken, varolan bir durumda bulunan ve güvenlik açığından yararlanılmasının önem derecesini azaltabilecek bir ayar, genel yapılandırma ya da en iyi uygulama anlamına gelir. Sizin durumunuzda aşağıdaki azaltıcı etkenler işinize yarayabilir:
  
-   Saldırganın bu güvenlik açığından yararlanabilmesi için kimliğinin doğrulanmış olması gerekir.
  
#### Olay Sistemi Güvenlik Açığı - CVE-2008-1457 için Geçici Çözümler
  
Geçici çözüm, arka plandaki güvenlik açığını gidermeyen ama güvenlik açığı uygulanmadan önceki bilinen saldırı vektörlerinin engellenmesine yardımcı olan bir ayar veya yapılandırma değişikliği anlamına gelir. Microsoft aşağıdaki geçici çözümleri sınamıştır ve bir geçici çözümün işlevselliği azaltıp azaltmadığı ilgili açıklamada belirtilmektedir:
  
-   **es.dll kaydını kaldırın**
    ...
    **Geçici çözümün etkisi:** Olay Sistemi bundan sonra çalışmaz.
  
    **Geçici çözüm nasıl geri alınır.** es.dll dosyasını yeniden kaydettirin. Komut istemine şu komutu yazın:
  
    regsvr 32 %WINDIR%\\SYSTEM32\\es.dll
  
-   **Sistem Olay Bildirimi ve COM+ Olay Sistemi hizmetlerini durdurun ve devre dışı bırakın**
  
    Bu hizmetlerin devre dışı bırakılması, etkilenen sistemlerin bu güvenlik açığından yararlanma girişimlerine karşı korunmasına yardımcı olur.
    ...
    -   Etkileşimli olarak
        ...
        4.  **Sistem Olay Bildirimi**'ni çift tıklatın.  
        5.  **Başlangıç türü** listesinde, **Devre Dışı** seçeneğini tıklatın.  
        6.  **Durdur**'u, ardından **Tamam**'ı tıklatın.
  
        Ayrıca, komut satırında aşağıdaki komutu kullanarak **Sistem Olay Bildirimi** hizmetini durdurabilir ve devre dış bırakabilirsiniz (Windows XP ve Microsoft Windows 2000 Kaynak Seti'nde bulunmaktadır):
  
        sc stop sens & sc config sens start= disabled
  
        Ardından, yukarıdaki adımları **COM+ Olay Sistemi** için de yineleyin.
  
        Ayrıca, komut satırında aşağıdaki komutu kullanarak **COM+ Olay Sistemi** hizmetini durdurabilir ve devre dış bırakabilirsiniz (Windows XP ve Microsoft Windows 2000 Kaynak Seti'nde bulunmaktadır):
  
        sc stop eventsystem & sc config eventsystem start= disabled
  
    -   Grup İlkesi ile:
  
        Grup İlkesi ayarlarını kullanarak bu hizmetleri devre dışı bırakın. Bu hizmetin başlatılmasını, Microsoft Windows 2000 veya Windows Server 2003 etki alanı ortamlarındaki Grup İlkesi nesne işlevselliğini kullanarak yerel, site, etki alanı veya kuruluş birimi düzeyinde devre dışı bırakabilirsiniz.
    ...
    **Geçici çözümün etkisi.** Bu hizmetleri gerektiren programlar çalışmaz.
  
    **Geçici çözüm nasıl geri alınır:** Yukarıdaki adımları kullanarak **Başlangıç Türü** ayarını **Otomatik** olarak belirleyin ve hizmeti başlatın.
  
-   **es.dll dosyasına uygulanan Erişim Denetim Listesi'ni değiştirin**
  
    es.dll dosyasına uygulanan Erişim Denetim Listesi'ni (ACL) daha kısıtlayıcı olacak şekilde değiştirmek için şu adımları izleyin:
    ...
    **Geçici çözümün etkisi:** Olay Sistemi hizmetini gerektiren programlar çalışmaz.
  
    **Geçici çözüm nasıl geri alınır:** Komut istemine şu komutu yazın:
  
    echo y| cacls %WINDIR%\\SYSTEM32\\es.DLL /E /R everyone  
    es.dll dosyasına uygulanan Erişim Denetim Listesi'ni (ACL) daha az kısıtlayıcı olacak şekilde değiştirmek için şu adımları izleyin:
  
    1.  Yönetici ayrıcalıkları olan bir kullanıcı olarak oturum açın.  
    2.  **Başlat**'ı tıklatın, **Çalıştır**'ı tıklatın, **cmd** yazın ve **Tamam**'ı tıklatın.  
    3.  Dosyanın geçerli ACL'lerini (devralma ayarlarıyla birlikte) ileride bu değişikliği geri almanız gerekirse başvurmak üzere belgeleyin. ACL'leri görüntülemek için şu komutu yazın:  
        cacls %WINDIR%\\SYSTEM32\\es.DLL  
    4.  "everyone" grubunun dosyaya erişimine izin vermek için, komut istemine şu komutu yazın:  
...
#### Olay Sistemi Güvenlik Açığı - CVE-2008-1457 Hakkında SSS
  
**Bu güvenlik açığının kapsamı nedir?**    
Microsoft Windows Olay Sistemi'nde uzaktan kod yürütülmesine neden olabilecek bir güvenlik açığı bulunmaktadır. Bu açığı başarıyla kullanan bir saldırgan, etkilenen sistemin tüm denetimini ele geçirebilir. Saldırgan, program yükleyebilir; verileri görüntüleyebilir, değiştirebilir veya silebilir; tüm yönetici haklarına sahip olan yeni hesaplar oluşturabilir.
  
**Güvenlik açığına ne neden olmaktadır?**    
Microsoft Windows Olay Sistemi kullanıcı aboneliklerini düzgün biçimde doğrulamadığı için, yerel sistemin bağlamında rasgele kod çalıştırılabilmesine neden olabilir.
  
**Microsoft Windows Olay Sistemi nedir?**    
Microsoft Windows Olay Sistemi, Windows ile sistemdeki uygulamalar arasındaki yöntem çağrılarını ve olay aboneliklerini yöneten bir hizmettir.
...
Saldırganın bu güvenlik açığından yararlanması için kimliğinin doğrulanmış olması gerekir. Böylece saldırgan, Microsoft Windows Olay Sistemi'ne özel hazırlanmış bir olay aboneliği isteği göndererek, sistem ayrıcalıklarıyla kod çalıştırabilir ve etkilenen sistemin denetimini tümüyle ele geçirebilir.
  
**Bu güvenlik açığından birincil derecede hangi sistemler etkileniyor?**    
Microsoft Windows Olay Sistemi'nin etkilenen sürümlerini çalıştıran tüm sistemler bu güvenlik açığı nedeniyle risk altındadır.
  
**Güncelleştirme ne yapıyor?**    
Güncelleştirme, Microsoft Windows Olay Sistemi'nin kullanıcı aboneliklerini işleme biçimini değiştirip, aboneliklerin bir olay yayımcısının güvenlik bağlamında çalışmamasını sağlayarak bu güvenlik açığını giderir.
...
Olay Sistemi Güvenlik Açığı - CVE-2008-1456  
-------------------------------------------
  
<span></span>
Microsoft Windows Olay Sistemi'nin bir işlev işaretçileri dizisini çağırırken dizin aralığını düzgün biçimde doğrulamaması nedeniyle bir uzaktan kod yürütme güvenlik açığı bulunmaktadır. Bu güvenlik açığı, uzaktan kod yürütülmesine olanak verebilir. Bu açığı başarıyla kullanan bir saldırgan, etkilenen sistemin tüm denetimini ele geçirebilir. Saldırgan, program yükleyebilir; verileri görüntüleyebilir, değiştirebilir veya silebilir; tüm yönetici haklarına sahip olan yeni hesaplar oluşturabilir.
  
Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2008-1456](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-1456).
  
#### Olay Sistemi Güvenlik Açığı - CVE-2008-1456 için Azaltıcı Etkenler
  
Azaltıcı etken, varolan bir durumda bulunan ve güvenlik açığından yararlanılmasının önem derecesini azaltabilecek bir ayar, genel yapılandırma ya da en iyi uygulama anlamına gelir. Sizin durumunuzda aşağıdaki azaltıcı etkenler işinize yarayabilir:
  
-   Saldırganın bu güvenlik açığından yararlanabilmesi için kimliğinin doğrulanmış olması gerekir.
  
#### Olay Sistemi Güvenlik Açığı - CVE-2008-1456 için Geçici Çözümler
...
#### Olay Sistemi Güvenlik Açığı - CVE-2008-1456 Hakkında SSS
  
**Bu güvenlik açığının kapsamı nedir?**    
Microsoft Windows Olay Sistemi'nde uzaktan kod yürütülmesine neden olabilecek bir güvenlik açığı bulunmaktadır. Bu açığı başarıyla kullanan bir saldırgan, etkilenen sistemin tüm denetimini ele geçirebilir. Saldırgan, program yükleyebilir; verileri görüntüleyebilir, değiştirebilir veya silebilir; tüm yönetici haklarına sahip olan yeni hesaplar oluşturabilir.
  
**Güvenlik açığına ne neden olmaktadır?**    
Microsoft Windows Olay Sistemi, işlev işaretçilerinin statik dizisine dize olarak bir yöntem parametresi kullanır. Dizin aralığı düzgün biçimde doğrulanmadığı için, yerel sistemin bağlamında rasgele kod çalıştırılabilmesine neden olabilir.
...
**Bir saldırgan güvenlik açığından nasıl yararlanabilir?**    
Saldırganın bu güvenlik açığından yararlanması için kimliğinin doğrulanmış olması gerekir. Daha sonra saldırganın, Microsoft Windows Olay Sistemi'ne çağrı göndermesi ve özel hazırlanmış bir isteği dizi sınırlarının dışında sağlaması gerekir. Saldırgan, diziye göreli olarak öngörülebilen bir konuma bir işaretçi bularak, yükseltilmiş ayrıcalıklarla kod çalıştırabilir ve etkilenen sistemin tüm denetimini ele geçirebilir.
  
**Bu güvenlik açığından birincil derecede hangi sistemler etkileniyor?**    
Microsoft Windows Olay Sistemi'nin etkilenen sürümlerini çalıştıran tüm sistemler bu güvenlik açığı nedeniyle risk altındadır.
  
**Güncelleştirme ne yapıyor?**    
Güncelleştirme, Microsoft Windows Olay Sistemi'nin dizin aralıklarını doğrulama biçimini değiştirip, aboneliklerin bir olay yayımcısının güvenlik bağlamında çalışmamasını sağlayarak bu güvenlik açığını giderir.
...
Windows2000-kb950974-x86-trk /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">Windows 2000 Service Pack 4:<br />
Windows2000-kb950974-x86-trk /norestart</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">Windows 2000 Service Pack 4:<br />
Denetim Masası'ndaki Program Ekle veya Kaldır aracını veya %Windir%\$NTUninstallKB950974$\Spuninst klasöründe bulunan Spuninst.exe yardımcı programını kullanın</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Dosya Bilgileri</strong></td>
<td style="border:1px solid black;">Bkz: <a href="http://support.microsoft.com/kb/950974">Microsoft Bilgi Bankası makalesi 950974</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Dosya Bilgileri</strong></td>
...
Windowsxp-kb950974-x86-trk /quiet  
Windows XP Professional x64 Edition ve Windows XP Professional x64 Edition Service Pack 2:
Windowsserver-2003.Windows XP-KB950974-x64-TRK.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">Windows XP Service Pack 2 ve Windows XP Service Pack 3:
WindowsXP-KB950974-x86-TRK.exe /norestart  
Windows XP Professional x64 Edition ve Windows XP Professional x64 Edition Service Pack 2:
Windowsserver-2003.Windows XP-KB950974-x64-TRK.exe /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Güncelleştirme günlük dosyası</td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>Kaldırma Bilgileri</strong></td>
<td style="border:1px solid black;">Denetim Masası'ndaki Program Ekle veya Kaldır aracını veya %Windir%\$NTUninstallKB950974$\Spuninst klasöründe bulunan Spuninst.exe yardımcı programını kullanın</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Dosya Bilgileri</strong></td>
<td style="border:1px solid black;">Bkz: <a href="http://support.microsoft.com/kb/950974">Microsoft Bilgi Bankası makalesi 950974</a></td>
...
Windowsserver2003-kb950974-x86-trk /quiet  
Windows Server 2003 x64 Edition ve Windows Server 2003 x64 Edition Service Pack 2:  
Windowsserver2003.WindowsXP-kb950974-x64-trk /quiet  
<br />
Itanium tabanlı sistemler için Windows Server 2003 SP1 ve Itanium tabanlı sistemler için Windows Server 2003 SP2:
Windowsserver2003-kb950974-ia64-trk /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">Windows Server 2003 Service Pack 1 ve Windows Server 2003 Service Pack 2:
Windowsserver2003-kb950974-x86-trk /norestart  
Windows Server 2003 x64 Edition ve Windows Server 2003 x64 Edition Service Pack 2:  
Windowsserver2003.WindowsXP-kb950974-x64-trk / norestart  
<br />
Itanium tabanlı sistemler için Windows Server 2003 SP1 ve Itanium tabanlı sistemler için Windows Server 2003 SP2:
Windowsserver2003-kb950974-ia64-trk / norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Güncelleştirme günlük dosyası</td>
<td style="border:1px solid black;">KB950974.log</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Dosya Bilgileri</strong></td>
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/950974">Microsoft Bilgi Bankası makalesi 950974</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Kayıt Defteri Anahtarı Doğrulaması</strong></td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen sürümleri:<br />
...
<tr class="odd">
<td style="border:1px solid black;">Kullanıcı araya girmeden yükleme</td>
<td style="border:1px solid black;">Windows Vista ve Windows Vista Service Pack 1:
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Kayıt Defteri Anahtarı Doğrulaması</strong></td>
<td style="border:1px solid black;"><strong>Not</strong>: Bu güncelleştirmenin varlığını doğrulayan bir kayıt defteri anahtarı yoktur. Güncelleştirmenin var olup olmadığını belirlemek için, WMI Veri Okuyucusu Görevi'nde gösterildiği şekilde QFE güncelleştirmeleri için bir WQL sorgusu kullanın. Daha fazla bilgi için, bkz. <a href="http://msdn2.microsoft.com/en-us/library/aa384642.aspx">Windows Yönetim Araçları (WMI)</a>.</td>
</tr>
</tbody>
</table>
...
-   [Palo Alto Networks](http://www.paloaltonetworks.com/index.html) için çalışan Yamata Li, Microsoft Olay Sistemi Güvenlik Açığı'nı (CVE-2008-1456) bildirdiği için
...
-   V1.1 (10 Eylül 2008): Windows XP için bir kayıt defteri anahtarı doğrulama girdisi düzeltildi.
