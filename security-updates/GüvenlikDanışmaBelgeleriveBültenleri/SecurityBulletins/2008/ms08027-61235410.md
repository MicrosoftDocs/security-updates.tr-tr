---
TOCTitle: 'MS08-027'
Title: 'Microsoft Güvenlik Bülteni MS08-027 - Kritik'
ms:assetid: 'ms08-027'
ms:contentKeyID: 61235410
ms:mtpsurl: 'https://technet.microsoft.com/tr-TR/library/ms08-027(v=Security.10)'
---

Security Bulletin

Microsoft Güvenlik Bülteni MS08-027 - Kritik
============================================

Microsoft Publisher'daki Güvenlik Açığı Uzaktan Kod Yürütülmesine İzin Verebilir (951208)
-----------------------------------------------------------------------------------------

Yayım Tarihi: 13 Mayıs 2008 Salı | Güncelleştirme Tarihi: 4 Haziran 2008 Çarşamba
...
Güvenlik güncelleştirmesi, Microsoft Office Publisher 2000 Service Pack 3 için Kritik ve Microsoft Office Publisher 2002, Microsoft Office Publisher 2003 ve Microsoft Office Publisher 2007'nin desteklenen sürümleri için Önemli olarak derecelendirilmiştir. Daha fazla bilgi için, bu bölümdeki **Etkilenen ve Etkilenmeyen Yazılımlar** alt bölümüne bakın.
...
**Bilinen Sorunlar.** [Microsoft Bilgi Bankası makalesi 951208](http://support.microsoft.com/kb/951208), müşterilerin bu güvenlik güncelleştirmesini yüklerken karşılaşabileceği bilinen sorunları ve önerilen çözümleri belgelemektedir. Bilinen sorunlar ve önerilen çözümler bu yazılımın yalnızca belirli sürümlerine yöneliktir, ancak bu makalede başka makalelere bağlantılar da sağlanır.
...
Dosya bilgileri ayrıntıları [Microsoft Bilgi Bankası makalesi 951208](http://support.microsoft.com/kb/951208)'de bulunabilir.
...
**Bu güncelleştirme neden Microsoft Office Publisher 2000 için Kritik ama diğer tüm etkilenen Publisher sürümleri için Önemli olarak derecelendirilmiştir?**  
Microsoft Office Publisher 2002 ve sonrasını çalıştıran kullanıcılar bir belgeyi açmadan önce Aç, Kaydet veya İptal istemleri görüntülenen yerleşik bir özelliğe sahiptir. Bu azaltıcı etken, güvenlik açığından yararlanılabilmesi için tek bir kullanıcı eyleminden fazlasını gerektirdiğinden açığın Kritik olarak belirlenen derecelendirmesini Önemli düzeyine indirir.
...
<th style="border:1px solid black;" >Publisher'da Nesne İşleyicisini Doğrulama Güvenlik Açığı - CVE-2008-0119</th>
<th style="border:1px solid black;" >Toplam Önem Derecesi</th>
</tr>
</thead>
<tbody>
...
Publisher'da Nesne İşleyicisini Doğrulama Güvenlik Açığı - CVE-2008-0119  
------------------------------------------------------------------------
  
<span></span>
Microsoft Office Publisher'ın nesne üstbilgisi verilerini doğrulama biçiminde bir uzaktan kod yürütme güvenlik açığı bulunmaktadır. Bir saldırgan, bir e-posta ekinde bulunan veya özel hazırlanmış ya da güvenliği aşılmış bir Web sitesinde barındırılan özel hazırlanmış bir Publisher dosyası göndererek güvenlik açığından yararlanabilir.
...
Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2008-0119](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0119).
  
#### Publisher'da Nesne İşleyicisini Doğrulama Güvenlik Açığı - CVE-2008-0119 için Azaltıcı Etkenler
...
-   Office 2000 için Office Belgesi Açma Onaylama Aracı'nı yükleyip kullananlara bir belgeyi açmadan önce Aç, Kaydet veya İptal istemleri görüntülenir. [Office Belgesi Açma Onaylama Aracı](http://www.microsoft.com/downloads/details.aspx?familyid=8b5762d2-077f-4031-9ee6-c9538e9f2a2f)'nın özellikleri Office XP ve Office'in sonraki sürümlerinde bulunmaktadır.
  
#### Publisher'da Nesne İşleyicisini Doğrulama Güvenlik Açığı - CVE-2008-0119 için Geçici Çözümler
...
#### Publisher'da Nesne İşleyicisini Doğrulama Güvenlik Açığı - CVE-2008-0119 Hakkında SSS
...
**Nesne işleyicisi nedir ve ne işe yarar?**  
Nesne işleyicisi, bir OLE sunucu uygulaması için dinamik bağlantı kitaplığıdır (DLL). Bu DLL, örneğin bir nesnenin istemci uygulaması penceresinde yeniden çizilmesi gerektiğinde performansı artırmak amacıyla, istemci ve sunucu uygulamaları arasında bir arabulucu olarak çalışır.
...
Microsoft Office Publisher'ın kullanıldığı sistemler birincil derecede risk altındadır. Yöneticiler kullanıcıların sunucularda oturum açmalarına ve program çalıştırmalarına izin verirse sunucular daha fazla etkilenebilir. Ancak, en iyi uygulamalarda buna izin verilmesi kesinlikle önerilmemektedir.
  
**Güncelleştirme ne yapıyor?**  
Güncelleştirme, Publisher dosyaları açılırken nesne işleyicisi verilerini düzgün biçimde doğrulayarak güvenlik açığını giderir.
...
| Yazılım                                        | MBSA 2.1 |  
|------------------------------------------------|----------|  
| Microsoft Office Publisher 2000 Service Pack 3 | Hayır    |  
| Microsoft Office Publisher 2002 Service Pack 3 | Evet     |  
| Microsoft Office Publisher 2003 Service Pack 2 | Evet     |  
| Microsoft Office Publisher 2003 Service Pack 3 | Evet     |  
| Microsoft Office Publisher 2007                | Evet     |  
...
|------------------------------------------------|---------|-----------------------------|----------------------------|-----------|  
| Microsoft Office Publisher 2000 Service Pack 3 | Evet    | Evet                        | Hayır                      | Hayır     |  
| Microsoft Office Publisher 2002 Service Pack 3 | Evet    | Evet                        | Evet                       | Evet      |  
| Microsoft Office Publisher 2003 Service Pack 2 | Evet    | Evet                        | Evet                       | Evet      |  
| Microsoft Office Publisher 2003 Service Pack 3 | Evet    | Evet                        | Evet                       | Evet      |  
| Microsoft Office Publisher 2007                | Hayır   | Hayır                       | Evet                       | Evet      |  
...
<td style="border:1px solid black;">office2000-kb950682-fullfile-trk/q:a</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">office2000-kb950682-fullfile-trk /r:n</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">Bkz: <a href="http://support.microsoft.com/kb/951208">Microsoft Bilgi Bankası makalesi 951208</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;">Kullanıcı araya girmeden yükleme</td>
<td style="border:1px solid black;">officeXP-kb950129-fullfile-trk /q:a</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">officeXP-kb950129-fullfile-trk /r:n</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Güncelleştirme günlük dosyası</td>
<td style="border:1px solid black;">Uygulanamaz</td>
...
<tr class="odd">
<td style="border:1px solid black;">Kullanıcı araya girmeden yükleme</td>
<td style="border:1px solid black;">office2003-kb950213-fullfile-trk /q:a</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">office2003-kb950213-fullfile-trk /r:n</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Güncelleştirme günlük dosyası</td>
<td style="border:1px solid black;">Uygulanamaz</td>
...
| **Dağıtım**                                  |                                                                                                                                                                                           |  
| Kullanıcı araya girmeden yükleme             | publisher2007-kb950114-fullfile-x86-glb /passive                                                                                                                                          |  
| Yeniden başlatmadan yükleme                  | publisher2007-kb950114-fullfile-x86-glb /norestart                                                                                                                                        |  
| Güncelleştirme günlük dosyası                | Kullanıcılar /log anahtarını kullanarak kapsamlı günlüğü etkinleştirebilir. Ayrıntılı bilgi için, bkz: [Microsoft Bilgi Bankası makalesi 912203](http://support.microsoft.com/kb/912203). |  
...
| **Dosya Bilgileri**                          | Bkz: [Microsoft Bilgi Bankası makalesi 951208](http://support.microsoft.com/kb/951208)                                                                                                    |  
...
-   [Fortinet Security Research](http://www.fortinet.com/) için çalışan Cocoruder, Publisher'da Nesne İşleyicisini Doğrulama Güvenlik Açığı'nı - CVE-2008-0119 bildirdiği için.
...
-   V1.1 4 Haziran 2008: Yürütmeyle İlgili Özet altındaki Bilinen Sorunlar bölümüne Microsoft Bilgi Bankası makalesi 951208 için bir bağlantı eklendi.
