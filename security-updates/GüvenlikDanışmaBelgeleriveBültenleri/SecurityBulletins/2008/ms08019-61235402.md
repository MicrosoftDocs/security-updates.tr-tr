---
TOCTitle: 'MS08-019'
Title: 'Microsoft Güvenlik Bülteni MS08-019 - Önemli'
ms:assetid: 'ms08-019'
ms:contentKeyID: 61235402
ms:mtpsurl: 'https://technet.microsoft.com/tr-TR/library/ms08-019(v=Security.10)'
---

Security Bulletin

Microsoft Güvenlik Bülteni MS08-019 - Önemli
============================================

Microsoft Visio'daki Güvenlik Açıkları Uzaktan Kod Yürütülmesine İzin Verebilir (949032)
----------------------------------------------------------------------------------------
...
<span></span>
**Microsoft bu bülteni 18 Nisan 2008'de neden yeniden düzenledi?**    
Bu bülten, Microsoft Office 2007 bileşenlerini kullananları etkileyen algılama ve yükleme sorunlarını gidermek üzere yeniden düzenlendi. Güncelleştirme daha önce sistemlerinde Visio 2007 bulunmayan kullanıcılara Visio 2007 güncelleştirmesini sunup yüklüyordu. Microsoft bu sorunu düzeltti ve bu değişiklik belirtilecek şekilde bu bülteni güncelleştirdi. Bu değişiklik, ilk güncelleştirmenin içerdiği dosyaları etkilemeyen bir algılama değişikliğiydi. Visio 2007'nin çalıştırıldığı ve güncelleştirmenin uygulanmış olduğu sistemlere bu güncelleştirme yeniden sunulmayacaktır ve güncelleştirmeyi daha önce yüklemiş olan kullanıcıların sistemlerine yeniden uygulamaları gerekmez.
  
**Visio 2007 sistemimde yüklü değilse bu güncelleştirmenin önceden yüklenmiş olmasının güvenliğe etkisi nedir? Ne yapmalıyım?**    
Yok. Visio 2007'nin yüklü olmadığı bir sisteme bu güncelleştirmenin yanlışlıkla yüklenmiş olması sistemin güvenlik riskini artırmaz. Güncelleştirme zaten uygulanmışsa kullanıcılar güncelleştirmeyi kaldırabilir. Ancak güncelleştirme, sistemin güvenliği veya performansı üzerinde olumsuz bir etkiye sahip olmadığı için güncelleştirmenin kaldırılması gerekmez.
...
Dosya bilgileri ayrıntıları [Microsoft Bilgi Bankası makalesi 949032](http://support.microsoft.com/kb/949032)'de bulunabilir.
...
<th style="border:1px solid black;" >Visio'da Nesne Üstbilgisi Güvenlik Açığı CVE-2008-1089</th>
<th style="border:1px solid black;" >Visio'da Bellek Doğrulaması Güvenlik Açığı CVE-2008-1090</th>
<th style="border:1px solid black;" >Toplam Önem Derecesi</th>
</tr>
</thead>
<tbody>
...
Visio'da Nesne Üstbilgisi Güvenlik Açığı CVE-2008-1089  
------------------------------------------------------
  
<span></span>
Microsoft Visio'nun özel hazırlanmış dosyalardaki nesne üstbilgisi verilerini doğrulama biçiminde bir uzaktan kod yürütme güvenlik açığı bulunmaktadır. Bir saldırgan, bir e-posta ekinde bulunan veya özel hazırlanmış ya da güvenliği aşılmış bir Web sitesinde barındırılan hatalı biçimlendirilmiş bir dosya göndererek güvenlik açığından yararlanabilir.
...
Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2008-1089](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-1089).
  
#### Visio'da Nesne Üstbilgisi Güvenlik Açığı - CVE-2008-1089 için Azaltıcı Etkenler
...
#### Visio'da Nesne Üstbilgisi Güvenlik Açığı - CVE-2008-1089 için Geçici Çözümler
  
Geçici çözüm, arka plandaki güvenlik açığını gidermeyen ama güvenlik açığı uygulanmadan önceki bilinen saldırı vektörlerinin engellenmesine yardımcı olan bir ayar veya yapılandırma değişikliği anlamına gelir. Microsoft aşağıdaki geçici çözümleri sınamıştır ve bir geçici çözümün işlevselliği azaltıp azaltmadığı ilgili açıklamada belirtilmektedir:
  
-   Visio dosyalarını açmak ve görüntülemek için Microsoft Visio 2003 Viewer veya Microsoft Visio 2007 Viewer kullanın. Microsoft Visio 2003 Viewer ve Microsoft Visio 2007 Viewer bu sorundan etkilenmez.  
-   Güvenilmeyen kaynaklardan gelen veya güvenilen kaynaklardan beklemediğiniz halde gelen Visio dosyalarını açmayın ve kaydetmeyin. Kullanıcı özel hazırlanmış bir dosyayı açtığında bu güvenlik açığından yararlanılabilir.
  
#### Visio'da Nesne Üstbilgisi Güvenlik Açığı - CVE-2008-1089 Hakkında SSS
...
Microsoft Visio tarafından Visio dosyaları açılırken nesne üstbilgisi verileri düzgün biçimde doğrulanmaz.
...
Bu güvenlik güncelleştirmesi, kullanıcının Microsoft Visio'nun etkilenen sürümünde hatalı biçimlendirilmiş bir Visio dosyasını açmasını gerektirir.
  
E-posta tabanlı saldırı senaryosunda, saldırgan kullanıcıya hatalı biçimlendirilmiş bir Visio dosyası göndererek ve bu dosyayı açmaya ikna ederek güvenlik açığından yararlanabilir.
...
Microsoft Visio'nun kullanıldığı sistemler birincil derecede risk altındadır. Yöneticiler kullanıcıların sunucularda oturum açmalarına ve program çalıştırmalarına izin verirse sunucular daha fazla etkilenebilir. Ancak, en iyi uygulamalarda buna izin verilmesi kesinlikle önerilmemektedir.
  
**Güncelleştirme ne yapıyor?**    
Güncelleştirme, Visio dosyalarını açarken nesne üstbilgisi verileri için alan ayırma sırasında doğrulama gerçekleştirerek güvenlik açığını giderir.
...
Visio'da Bellek Doğrulaması Güvenlik Açığı - CVE-2008-1090  
----------------------------------------------------------
  
<span></span>
Microsoft Visio'nun özel hazırlanmış .DXF dosyalarını diskten belleğe yüklerken bellek ayırmalarını doğrulama biçiminde bir uzaktan kod yürütme güvenlik açığı bulunmaktadır. Bir saldırgan, bir e-posta ekinde bulunan veya özel hazırlanmış ya da güvenliği aşılmış bir Web sitesinde barındırılan hatalı biçimlendirilmiş bir dosya göndererek güvenlik açığından yararlanabilir.
  
Kullanıcı yönetimsel haklarla oturum açtıysa, bu güvenlik açığından başarıyla yararlanan bir saldırgan etkilenen sistemin denetimini tümüyle ele geçirebilir. Saldırgan, program yükleyebilir; verileri görüntüleyebilir, değiştirebilir veya silebilir; tüm kullanıcı haklarına sahip olan yeni hesaplar oluşturabilir. Hesapları, sistemde az sayıda kullanıcı hakkıyla yapılandırılmış olan kullanıcılar, yönetici haklarıyla çalışan kullanıcılardan daha az etkilenebilir.
  
Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2008-1090](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-1090).
  
#### Visio'da Bellek Doğrulaması Güvenlik Açığı - CVE-2008-1090 için Azaltıcı Etkenler
  
Azaltıcı etken, varolan bir durumda bulunan ve güvenlik açığından yararlanılmasının önem derecesini azaltabilecek bir ayar, genel yapılandırma ya da en iyi uygulama anlamına gelir. Sizin durumunuzda aşağıdaki azaltıcı etkenler işinize yarayabilir:
  
-   AutoCAD çizim dosyaları (.DXF dosya uzantısı) varsayılan olarak Visio tarafından kaydettirilmez ve özel hazırlanmış bir .DXF dosyası çift tıklatılarak açılamaz. Saldırganın bir kullanıcıyı Visio'yu açıp Aç'ı seçtikten sonra "Tüm Visio Dosyaları" olan varsayılan dosya türünü "AutoCAD Çizimi" olarak değiştirmeye ikna etmesi gerekir.  
-   Web tabanlı saldırı senaryosunda, bir saldırganın bu açıktan yararlanmak için kullanılan bir Web sayfası içeren bir Web sitesi barındırabilir. Ayrıca, kullanıcı tarafından sağlanan içeriği veya reklamları kabul eden ya da barındıran güvenliği aşılmış Web sitelerinde, bu güvenlik açığından yararlanılabilecek özel hazırlanmış içerik bulunabilir. Ancak bu durumların hiçbirinde, saldırganın, bu Web sitelerini ziyaret etmek için kullanıcıyı zorlama yolu yoktur. Bunun yerine, saldırganın kullanıcıları bir e-posta iletisindeki veya Instant Messenger iletisindeki kendi Web sitesine götüren bir bağlantıyı tıklatmalarını sağlayarak onları bu Web sitesini ziyaret etmeye ikna etmesi gerekir.  
-   Bu güvenlik açığından başarıyla yararlanan bir saldırgan, yerel kullanıcı ile aynı haklara sahip olabilir. Hesapları, sistemde az sayıda kullanıcı hakkıyla yapılandırılmış olan kullanıcılar, yönetici haklarıyla çalışan kullanıcılardan daha az etkilenebilir.  
-   Güvenlik açığından, e-posta yoluyla otomatik olarak yararlanılamaz. Saldırının başarılı olması için, kullanıcının e-posta iletisiyle gönderilen bir eki açması gerekir.
  
#### Visio'da Bellek Doğrulaması Güvenlik Açığı - CVE-2008-1090 için Geçici Çözümler
  
Geçici çözüm, arka plandaki güvenlik açığını gidermeyen ama güvenlik açığı uygulanmadan önceki bilinen saldırı vektörlerinin engellenmesine yardımcı olan bir ayar veya yapılandırma değişikliği anlamına gelir. Microsoft aşağıdaki geçici çözümleri sınamıştır ve bir geçici çözümün işlevselliği azaltıp azaltmadığı ilgili açıklamada belirtilmektedir:
  
-   **DWGDP.DLL dosyasına erişimi kısıtlayarak Visio'nun .DXF dosyasını açamamasını sağlayın.**  
    DWGDP.DLL dosyasına erişimi kısıtlamak için, komut istemine şunu yazın:  
    **Not** Vista'da bu geçici çözümü uygulamak için yönetici ayrıcalıkları olan bir hesap gerekir.  
    **Windows XP için**  
    ...
    **Geçici Çözümün Etkisi:** Bu geçici çözüm uygulandığında, Visio artık AutoCAD çizim dosyalarını (.DXF) açamaz. AutoCAD çizim dosyalarını açmanız gerekmiyorsa, bu geçici çözümün sistem işlevselliği üzerine olumsuz bir etkisi olmamalıdır.  
...
#### Visio'da Bellek Doğrulaması Güvenlik Açığı - CVE-2008-1090 Hakkında SSS
  
**Bu güvenlik açığının kapsamı nedir?**    
Bu bir uzaktan kod yürütme güvenlik açığıdır. Bu güvenlik açığından başarıyla yararlanan bir saldırgan, etkilenen sistemin tüm denetimini uzaktan ele geçirebilir. Saldırgan, program yükleyebilir; verileri görüntüleyebilir, değiştirebilir veya silebilir; tüm kullanıcı haklarına sahip olan yeni hesaplar oluşturabilir.
  
**Güvenlik açığına ne neden olmaktadır?**    
Microsoft Visio özel hazırlanmış .DXF dosyalarını diskten belleğe yüklerken bellek ayırmalarını düzgün biçimde doğrulamaz.
  
**Bir saldırgan bu güvenlik açığından yararlanarak neler yapabilir?**    
Bu güvenlik açığından başarıyla yararlanan bir saldırgan oturum açan kullanıcının bağlamında rasgele kod çalıştırabilir. Kullanıcı yönetimsel haklarla oturum açtıysa, saldırgan etkilenen sistemin denetimini tümüyle ele geçirebilir. Saldırgan, program yükleyebilir; verileri görüntüleyebilir, değiştirebilir veya silebilir; tüm kullanıcı haklarına sahip olan yeni hesaplar oluşturabilir. Hesapları, sistemde az sayıda kullanıcı hakkıyla yapılandırılmış olan kullanıcılar, yönetici haklarıyla çalışan kullanıcılardan daha az etkilenebilir.
  
**Bir saldırgan güvenlik açığından nasıl yararlanabilir?**    
Bu güvenlik güncelleştirmesi, kullanıcının Microsoft Visio'nun etkilenen sürümünde hatalı biçimlendirilmiş bir .DXF dosyasını açmasını gerektirir.
...
**Güncelleştirme ne yapıyor?**    
Güncelleştirme, Visio dosyalarını diskten belleğe yüklerken bellek ayırmalarını düzgün biçimde doğrulayarak güvenlik açığını giderir.
...
| Microsoft Visio 2003 Service Pack 2 | Evet       |  
| Microsoft Visio 2003 Service Pack 3 | Evet       |  
| Microsoft Visio 2007                | Evet       |  
| Microsoft Visio 2007 Service Pack 1 | Evet       |
...
|-------------------------------------|---------|-----------------------------|----------------------------|-----------|  
| Microsoft Visio 2002 Service Pack 2 | Evet    | Evet                        | Evet                       | Evet      |  
| Microsoft Visio 2003 Service Pack 2 | Evet    | Evet                        | Evet                       | Evet      |  
| Microsoft Visio 2003 Service Pack 3 | Evet    | Evet                        | Evet                       | Evet      |  
| Microsoft Visio 2007                | Hayır   | Hayır                       | Evet                       | Evet      |  
| Microsoft Visio 2007 Service Pack 1 | Hayır   | Hayır                       | Evet                       | Evet      |
...
<td style="border:1px solid black;">Visio2002-KB947896-FullFile-TRK/q:a</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">Visio2002-KB947896-FullFile-TRK /r:n</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">Bkz: <a href="http://support.microsoft.com/kb/949032">Microsoft Bilgi Bankası makalesi 949032</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;">Kullanıcı araya girmeden yükleme</td>
<td style="border:1px solid black;">Visio2003-KB947650-FullFile-TRK /q:a</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">Visio2003-KB947650-FullFile-TRK /r:n</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Güncelleştirme günlük dosyası</td>
<td style="border:1px solid black;">Uygulanamaz</td>
...
-   Anonim bir kullanıcı, Visio'da Nesne Üstbilgisi Güvenlik Açığı'nı - CVE-2008-1089 bildirdiği için.  
-   Anonim bir kullanıcı, Visio'da Bellek Doğrulaması Güvenlik Açığı'nı - CVE-2008-1090 bildirdiği için.
...
-   V1.1 (9 Nisan 2008): Bilinen Sorunlar bölümü güncelleştirildi.  
-   V1.2 (11 Nisan 2008): Bülten güncelleştirildi. Visio 2007'deki bilinen bir algılama sorunu ile ilgili SSS girdisi eklendi.  
-   V1.3 (16 Nisan 2008): Bülten güncelleştirildi: Microsoft Office 2003 Service Pack 2'ye yönelik ek güvenlik özelliklerini açıklamak üzere Güncelleştirme Hakkında SSS bölümüne girdi eklendi. Etkilenen Yazılımlar tablosu açıklığa kavuşturuldu.  
-   V1.4 (18 Nisan 2008): Visio 2007'deki bilinen bir algılama sorunu ile ilgili SSS girdisi güncelleştirildi.  
-   V1.5 (23 Nisan 2008): Güncelleştirme Hakkında SSS girdisinde 18 Nisan tarihli son düzenleme açıklığa kavuşturuldu. Bu değişiklik, ilk güncelleştirmenin içerdiği dosyaları etkilemeyen bir algılama değişikliğiydi.
