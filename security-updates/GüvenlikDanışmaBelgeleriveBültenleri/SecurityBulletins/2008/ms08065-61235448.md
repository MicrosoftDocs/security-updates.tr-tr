---
TOCTitle: 'MS08-065'
Title: 'Microsoft Güvenlik Bülteni MS08-065 - Önemli'
ms:assetid: 'ms08-065'
ms:contentKeyID: 61235448
ms:mtpsurl: 'https://technet.microsoft.com/tr-TR/library/ms08-065(v=Security.10)'
---

Security Bulletin

Microsoft Güvenlik Bülteni MS08-065 - Önemli
============================================

Message Queuing Hizmeti'ndeki Güvenlik Açığı Uzaktan Kod Yürütülmesine İzin Verebilir (951071)
----------------------------------------------------------------------------------------------
...
Bu güvenlik güncelleştirmesi, Microsoft Windows 2000 çalışan sistemlerdeki Message Queuing Hizmeti'nde (MSMQ) özel olarak bildirilen bir güvenlik açığını giderir. Güvenlik açığı, MSMQ hizmetinin etkinleştirilmiş olduğu Microsoft Windows 2000 çalışan sistemlerde uzaktan kod yürütülmesine izin verebilir.

Bu güvenlik güncelleştirmesi, Microsoft Windows 2000'in tüm desteklenen sürümleri için Önemli olarak derecelendirilmiştir. Daha fazla bilgi için, bu bölümdeki **Etkilenen ve Etkilenmeyen Yazılımlar** alt bölümüne bakın.

Güvenlik güncelleştirmesi, MSMQ tarafından işlenen ve güvenlik açığından etkilenen dize API'lerini değiştirerek bu güvenlik açığını giderir. Bu güvenlik açığı hakkında daha fazla bilgi için, bir sonraki bölüm olan **Güvenlik Açığı Bilgileri** altında, ilgili güvenlik açığı girdisinin Sık Sorulan Sorular (SSS) alt bölümüne bakın.
...
|----------------------------------------------------------------------------------------------------------------------------------------|---------------------------|----------------------|----------------------------------------------------------|
| [Microsoft Windows 2000 Service Pack 4](http://www.microsoft.com/downloads/details.aspx?familyid=899e2728-2433-4ccb-a195-05b5d65e5469) | Uzaktan Kod Yürütme       | Önemli               | [MS07-065](http://go.microsoft.com/fwlink/?linkid=94666) |
...
Dosya bilgileri ayrıntıları [Microsoft Bilgi Bankası makalesi 951071](http://support.microsoft.com/kb/951071)'de bulunabilir.
...
<th style="border:1px solid black;" >Message Queuing Hizmeti'nde Uzaktan Kod Yürütme Güvenlik Açığı - CVE-2008-3479</th>
...
Message Queuing Hizmeti'nde Uzaktan Kod Yürütme Güvenlik Açığı - CVE-2008-3479  
------------------------------------------------------------------------------
  
<span></span>
Message Queuing Hizmeti'nde, bir RPC isteğinin Message Queuing hizmetine ayrıştırılmasındaki belirli bir açık nedeniyle bir uzaktan kod yürütme güvenlik açığı bulunmaktadır.
  
Saldırgan, özel hazırlanmış bir RPC isteği göndererek bu güvenlik açığından yararlanabilir. Denetlenmeyen bir dize kopyalama işlemi sırasında öbek isteği denetlenebilir ve daha sonra taşırılabilir. Bu açıktan başarıyla yararlanılması, etkilenen sisteme SYSTEM bağlamı altında tam erişim sağlanmasına neden olabilir. Bu açığı başarıyla kullanan bir saldırgan, etkilenen sistemin tüm denetimini ele geçirebilir.
  
Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2008-3479](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-3479).
  
#### Message Queuing Hizmeti'nde Uzaktan Kod Yürütme Güvenlik Açığı - CVE-2008-3479 için Azaltıcı Etkenler
...
#### Message Queuing Hizmeti'nde Uzaktan Kod Yürütme Güvenlik Açığı - CVE-2008-3479 için Geçici Çözümler
  
Geçici çözüm, arka plandaki güvenlik açığını gidermeyen ama güvenlik açığı uygulanmadan önceki bilinen saldırı vektörlerinin engellenmesine yardımcı olan bir ayar veya yapılandırma değişikliği anlamına gelir. Microsoft aşağıdaki geçici çözümleri sınamıştır ve bir geçici çözümün işlevselliği azaltıp azaltmadığı ilgili açıklamada belirtilmektedir:
  
-   **Çevre güvenlik duvarında aşağıdaki öğeleri engelleyin**  
...
#### Message Queuing Hizmeti'nde Uzaktan Kod Yürütme Güvenlik Açığı - CVE-2008-3479 Hakkında SSS
  
**Bu güvenlik açığının kapsamı nedir?**    
Bu, MSMQ hizmetinin etkinleştirilmiş olduğu Microsoft Windows 2000 çalışan sistemlerde bir uzaktan kod yürütme güvenlik açığıdır. Bu güvenlik açığından başarıyla yararlanan bir saldırgan, etkilenen sistemin tüm denetimini uzaktan ele geçirebilir. Böylece saldırgan program yükleyebilir ya da verileri görüntüleyebilir, değiştirebilir veya silebilir.
  
**Güvenlik açığına ne neden olmaktadır?**    
MSMQ hizmeti özel hazırlanmış RPC isteklerini doğru şekilde ayrıştırmaz.
...
**RPC nedir?**    
Microsoft RPC, dağıtılmış bilgisayar ortamında kullanılan bir programlama modelidir. RPC'nin amacı, şeffaf bir iletişim sayesinde istemcinin doğrudan sunucuyla iletişim kuruyormuş gibi görünmesini sağlamaktır. Microsoft'un RPC uygulamaları Open Software Foundation (OSF) Distributed Computing Environment (DCE) RPC ile uyumludur. RPC hakkında daha fazla bilgi için [RPC MSDN sitesine](http://msdn.microsoft.com/en-us/library/ms691207(vs.85).aspx) bakın.
  
**Bir saldırgan bu güvenlik açığından yararlanarak neler yapabilir?**    
Kimliği doğrulanmamış bir saldırgan, MSMQ hizmetine özel hazırlanmış bir RPC isteği göndererek, SYSTEM bağlamında uzaktan rasgele kod çalıştırılmasına neden olabilir. Saldırgan, program yükleyebilir; verileri görüntüleyebilir, değiştirebilir veya silebilir; tüm kullanıcı haklarına sahip olan yeni hesaplar oluşturabilir.
  
**Bir saldırgan güvenlik açığından nasıl yararlanabilir?**    
Saldırgan, MSMQ hizmetine özel hazırlanmış bir RPC isteği göndererek bu güvenlik açığından yararlanabilir. Denetlenmeyen bir dize kopyalama işlemi sırasında öbek isteği denetlenebilir ve daha sonra taşırılabilir. Bu güvenlik açığından başarıyla yararlanılması, etkilenen sisteme SYSTEM bağlamı altında tam erişim sağlanmasına neden olabilir.
  
**Bu güvenlik açığından birincil derecede hangi sistemler etkileniyor?**    
MSMQ hizmetinin etkinleştirilmiş olduğu Microsoft Windows 2000 çalışan sistemler bu açıktan etkilenir.
  
**Güncelleştirme ne yapıyor?**    
Güncelleştirme, MSMQ hizmetinin çağırdığı dize API'lerine parametreleri doğrulama biçimini değiştirerek bu güvenlik açığını ortadan kaldırır.
...
Windows2000-kb951071-x86-trk /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">Microsoft Windows 2000 Service Pack 4:<br />
Windows2000-kb951071-x86-trk /norestart</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">Microsoft Windows 2000 Service Pack 4:<br />
Denetim Masası'ndaki Program Ekle veya Kaldır aracını veya %Windir%\$NTUninstallKB951071$\Spuninst klasöründe bulunan Spuninst.exe yardımcı programını kullanın</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Dosya Bilgileri</strong></td>
<td style="border:1px solid black;">Bkz: <a href="http://support.microsoft.com/kb/951071">Microsoft Bilgi Bankası makalesi 951071</a></td>
</tr>
<tr class="even">
...
-   [TippingPoint DVLabs](http://dvlabs.tippingpoint.com) için çalışan Cody Pierce ve Aaron Portnoy, MSMQ uzaktan kod yürütme güvenlik açığını (CVE-2008-3479) bildirdikleri için
...
-   V1.1 (15 Ekim 2008): Etkilenen Yazılımlar tablosuna, bu güncelleştirmenin yerini aldığı bülten olan MS07-065 için bir bağlantı eklendi.
