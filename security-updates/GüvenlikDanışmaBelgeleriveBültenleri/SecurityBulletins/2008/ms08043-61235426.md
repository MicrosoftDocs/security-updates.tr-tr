---
TOCTitle: 'MS08-043'
Title: 'Microsoft Güvenlik Bülteni MS08-043 - Kritik'
ms:assetid: 'ms08-043'
ms:contentKeyID: 61235426
ms:mtpsurl: 'https://technet.microsoft.com/tr-TR/library/ms08-043(v=Security.10)'
---

Security Bulletin

Microsoft Güvenlik Bülteni MS08-043 - Kritik
============================================

Microsoft Excel'deki Güvenlik Açıkları Uzaktan Kod Yürütülmesine İzin Verebilir (954066)
----------------------------------------------------------------------------------------

Yayım Tarihi: 12 Ağustos 2008 Salı | Güncelleştirme Tarihi: 1 Ekim 2008 Çarşamba
...
Bu güvenlik güncelleştirmesi Microsoft Office Excel 2000 Service Pack 3 için Kritik ve Excel 2002 Service Pack 3, Excel 2003 Service Pack 2, Excel 2003 Service Pack 3, Excel Viewer 2003, Excel Viewer 2003 Service Pack 3, Excel 2007, Excel 2007 Service Pack 1, Word, Excel ve PowerPoint 2007 Dosya Biçimleri için Microsoft Office Uyumluluk Paketi, Word, Excel ve PowerPoint 2007 Dosya Biçimleri için Microsoft Office Uyumluluk Paketi Service Pack 1, Microsoft Office Excel Viewer ve Microsoft Office SharePoint Server 2007 için Önemli olarak derecelendirilmiştir. Daha fazla bilgi için, bu bölümdeki **Etkilenen ve Etkilenmeyen Yazılımlar** alt bölümüne bakın.
...
<tr>
<th colspan="5">
Microsoft Office Paketleri, Bileşenleri ve Diğer Office Yazılımları
</th>
</tr>
<tr>
...
Microsoft bu bülteni, bu güncelleştirmenin Microsoft Office SharePoint Server 2007 Enterprise sürümünün varsayılan yapılandırması ve Internet Siteleri için Microsoft Office SharePoint Server 2007 gibi Excel Hizmetleri'nin yüklü olduğu sunuculara uygulandığını açıklığa kavuşturmak üzere yeniden düzenledi. Microsoft Office SharePoint Server 2007 Standard sürümü Excel Hizmetleri'ni içermemektedir.

**Bu bülten 13 Ağustos 2008'de neden yeniden düzenlendi?**  
Bu bülten, ilgili [Microsoft Bilgi Bankası makalesi 954066](http://support.microsoft.com/kb/954066)'daki dosya bilgilerinin güncelleştirilmiş olduğunu bildirmek üzere yeniden düzenlendi. Microsoft ayrıca, Word, Excel ve PowerPoint 2007 Dosya Biçimleri için Microsoft Office Uyumluluk Paketi ve Word, Excel ve PowerPoint 2007 Dosya Biçimleri için Microsoft Office Uyumluluk Paketi Service Pack 1 için bülten değişikliği bilgilerini yeniden düzenledi.

**Dosya bilgileri ayrıntılarını nerede bulabilirim?**  
Dosya bilgileri ayrıntıları [Microsoft Bilgi Bankası makalesi 954066](http://support.microsoft.com/kb/954066)'da bulunabilir.

**Microsoft Office 2003 Service Pack 2 kullanıyorum. Bu güncelleştirmenin içerdiği başka güvenlik özellikleri var mı**?
Evet, Microsoft Office 2003 hizmet modelinin bir parçası olarak, Microsoft Office 2003 Service Pack 2 kullanıcıları bu güncelleştirmeyi yüklediklerinde, sistemleri Microsoft Office 2003 Service Pack 3 ile birlikte yayımlanan güvenlik işlevselliğine yükseltilir. Microsoft Office 2003 Service Pack 2 için 1 Ocak 2008'den sonra yayımlanan tüm güncelleştirmeler, Microsoft Office 2003 Service Pack 3'te kullanılmaya başlanan bu güvenlik özelliklerini içerir. Bu güncelleştirmeyi kapsamlı olarak sınadık, ancak tüm güncelleştirmelerde olduğu gibi kullanıcıların çalışma ortamlarına ve yapılandırmalarına uygun sınamaları gerçekleştirmelerini öneririz. Bu sorun hakkında daha fazla bilgi için, bkz: Microsoft Bilgi Bankası makalesi 951646.
...
<th style="border:1px solid black;" >Excel'de Dizin Doğrulaması Güvenlik Açığı - CVE-2008-3004</th>
<th style="border:1px solid black;" >Excel'de Dize Dizini Güvenlik Açığı - CVE-2008-3005</th>
<th style="border:1px solid black;" >Excel'de Kayıt Ayrıştırma Güvenlik Açığı - CVE-2008-3006</th>
<th style="border:1px solid black;" >Excel'de Kimlik Bilgilerini Önbelleğe Alma Güvenlik Açığı - CVE-2008-3003</th>
...
<tr class="even">
<td style="border:1px solid black;">Microsoft Office SharePoint Server 2007 ve Microsoft Office SharePoint Server 2007 Service Pack 1</td>
<td style="border:1px solid black;">Yok</td>
<td style="border:1px solid black;">Yok</td>
<td style="border:1px solid black;"><strong>Önemli</strong><br />
Ayrıcalık Yükselmesi</td>
...
Excel'de Dizin Doğrulaması Güvenlik Açığı - CVE-2008-3004  
---------------------------------------------------------
  
<span></span>
Excel dosyaları belleğe yüklenirken Excel'in dizin değerlerini işleme biçiminde bir uzaktan kod yürütme güvenlik açığı bulunmaktadır. Saldırgan, bir Web sitesinde barındırılan ya da bir e-posta ekinde bulunan özel hazırlanmış bir dosyayı açarak bu güvenlik açığından yararlanabilir.
  
Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2008-3004](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-3004).
  
#### Excel'de Dizin Doğrulaması Güvenlik Açığı - CVE-2008-3004 için Azaltıcı Etkenler
...
#### Excel'de Dizin Doğrulaması Güvenlik Açığı - CVE-2008-3004 için Geçici Çözümler
...
#### Excel'de Dizin Doğrulaması Güvenlik Açığı - CVE-2008-3004 Hakkında SSS
...
Microsoft Excel, Excel dosyalarını belleğe yüklerken dizin değerleri için yeterli doğrulama gerçekleştirmez.
...
Microsoft Office SharePoint Server 2007 saldırı senaryosu, Web tabanlı saldırı senaryosuna benzer. Saldırganın, Office SharePoint Server 2007'de özel hazırlanmış Excel dosyasını işlemek (açmak) için kullanılan bir Excel Hizmetleri Bölümü barındırması gerekir. Saldırgan Excel Hizmetleri Web Bölümü'nü oluşturma izinlerine sahip olmalı ve daha sonra kullanıcıları bu Web Bölümü'nü içeren Web sitesini ziyaret etmeye ikna etmelidir.
...
Güncelleştirme, Microsoft Excel'in dosyaları belleğe yüklerken dizin değerlerini doğrulama biçimini değiştirerek güvenlik açığını giderir.
...
Excel'de Dize Dizini Güvenlik Açığı - CVE-2008-3005  
---------------------------------------------------
  
<span></span>
Excel dosyaları belleğe yüklenirken Excel'in dize dizisini işleme biçiminde bir uzaktan kod yürütme güvenlik açığı bulunmaktadır. Saldırgan, bir Web sitesinde barındırılan ya da bir e-posta ekinde bulunan özel hazırlanmış bir dosyayı açarak bu güvenlik açığından yararlanabilir.
  
Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2008-3005](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-3005).
  
#### Excel'de Dize Dizini Güvenlik Açığı - CVE-2008-3005 için Azaltıcı Etkenler
...
#### Excel'de Dize Dizini Güvenlik Açığı - CVE-2008-3005 için Geçici Çözümler
  
Geçici çözüm, arka plandaki güvenlik açığını gidermeyen ama güvenlik açığı uygulanmadan önceki bilinen saldırı vektörlerinin engellenmesine yardımcı olan bir ayar veya yapılandırma değişikliği anlamına gelir. Microsoft aşağıdaki geçici çözümleri sınamıştır ve bir geçici çözümün işlevselliği azaltıp azaltmadığı ilgili açıklamada belirtilmektedir.
  
-   Güvenilmeyen kaynaklardan gelen veya güvenilen kaynaklardan beklemediğiniz halde gelen Microsoft Office dosyalarını açmayın ve kaydetmeyin. Kullanıcı özel hazırlanmış bir dosyayı açtığında bu güvenlik açığından yararlanılabilir.
  
#### Excel'de Dize Dizini Güvenlik Açığı - CVE-2008-3005 Hakkında SSS
  
**Bu güvenlik açığının kapsamı nedir?**  
Bu bir uzaktan kod yürütme güvenlik açığıdır. Bu güvenlik açığından başarıyla yararlanan bir saldırgan, etkilenen sistemin tüm denetimini uzaktan ele geçirebilir. Saldırgan, program yükleyebilir; verileri görüntüleyebilir, değiştirebilir veya silebilir; tüm kullanıcı haklarına sahip olan yeni hesaplar oluşturabilir.
  
**Güvenlik açığına ne neden olmaktadır?**  
Microsoft Excel, Excel dosyalarını belleğe yüklerken dize dizini için yeterli doğrulama gerçekleştirmez.
...
**Güncelleştirme ne yapıyor?**  
Güncelleştirme, Microsoft Excel'in dosyaları belleğe yüklerken dize dizinini doğrulama biçimini değiştirerek güvenlik açığını giderir.
...
Excel'de Kayıt Ayrıştırma Güvenlik Açığı - CVE-2008-3006  
--------------------------------------------------------
  
<span></span>
Excel dosyaları belleğe yüklenirken Excel'in kayıt değerlerini ayrıştırma biçiminde bir güvenlik açığı bulunmaktadır. Saldırı senaryosuna bağlı olarak, güvenlik açığı bir kullanıcının yerel Excel istemcisinde uzaktan kod yürütülmesine veya bir SharePoint Server içinde ayrıcalık yükselmesine neden olabilir.
  
Kullanıcının yerel Excel istemcisine yönelik bir saldırıda, saldırgan, kullanıcıyı bir Web sitesinde barındırılan ya da bir e-posta ekinde bulunan özel hazırlanmış bir dosyayı açarak bu güvenlik açığından yararlanabilir.
  
SharePoint sitesine yönelik bir saldırıda, saldırganın ilk önce özel hazırlanmış Excel dosyasını SharePoint sitesine yüklemek için yeterli haklara sahip bir hesabının olması ve daha sonra bu dosyayı SharePoint sitesinde kullanarak bir Web bölümü oluşturması gerekir.
  
Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2008-3006](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-3006).
  
#### Excel'de Kayıt Ayrıştırma Güvenlik Açığı - CVE-2008-3006 için Azaltıcı Etkenler
  
Azaltıcı etken, varolan bir durumda bulunan ve güvenlik açığından yararlanılmasının önem derecesini azaltabilecek bir ayar, genel yapılandırma ya da en iyi uygulama anlamına gelir. Sizin durumunuzda aşağıdaki azaltıcı etkenler işinize yarayabilir:
  
-   Excel istemci sistemlerinde bu güvenlik açığından başarıyla yararlanan bir saldırgan, yerel kullanıcı ile aynı haklara sahip olabilir. Hesapları, sistemde az sayıda kullanıcı hakkıyla yapılandırılmış olan kullanıcılar, yönetici haklarıyla çalışan kullanıcılardan daha az etkilenebilir.  
-   Excel istemci sistemlerinde, güvenlik açığından e-posta yoluyla otomatik olarak yararlanılamaz. Saldırının başarılı olması için, kullanıcının e-posta iletisiyle gönderilen bir eki açması gerekir.  
-   Excel istemci sistemlerinde, Office 2000 için [Office Belgesi Açma Onaylama Aracı'nı](http://www.microsoft.com/downloads/details.aspx?familyid=8b5762d2-077f-4031-9ee6-c9538e9f2a2f) yükleyip kullananlara bir belgeyi açmadan önce Aç, Kaydet veya İptal istemleri görüntülenir. Office Belgesi Açma Onaylama Aracı'nın özellikleri Office XP ve Office'in sonraki sürümlerinde bulunmaktadır.
  
#### Excel'de Kayıt Ayrıştırma Güvenlik Açığı - CVE-2008-3006 için Geçici Çözümler
  
Geçici çözüm, arka plandaki güvenlik açığını gidermeyen ama güvenlik açığı uygulanmadan önceki bilinen saldırı vektörlerinin engellenmesine yardımcı olan bir ayar veya yapılandırma değişikliği anlamına gelir. Microsoft aşağıdaki geçici çözümleri sınamıştır ve bir geçici çözümün işlevselliği azaltıp azaltmadığı ilgili açıklamada belirtilmektedir.
  
-   **Excel istemci sistemlerinde, bilinmeyen veya güvenilir olmayan kaynaklardan gelen dosyaları açarken Microsoft Office Yalıtılmış Dönüştürme Ortamı'nı (MOICE) kullanın**
...
-   **Excel istemci sistemlerinde, bilinmeyen veya güvenilmeyen kaynaklardan gelen Office 2003 veya önceki sürümlerinde oluşturulmuş belgelerin açılmasını engellemek üzere Microsoft Office Dosya Engelleme ilkesini kullanın**
...
-   **Excel istemci sistemlerinde, güvenilmeyen kaynaklardan gelen veya güvenilen kaynaklardan beklemediğiniz halde gelen Microsoft Office dosyalarını açmayın ve kaydetmeyin. Kullanıcı özel hazırlanmış bir dosyayı açtığında bu güvenlik açığından yararlanılabilir.**
  
#### Excel'de Kayıt Ayrıştırma Güvenlik Açığı - CVE-2008-3006 Hakkında SSS
  
**Bu güvenlik açığının kapsamı nedir?**  
Güvenlik açığının kapsamı, saldırı senaryosuna göre belirlenir.
  
Kullanıcının yerel Excel istemcisine yönelik bir saldırı, uzaktan kod yürütülmesine neden olabilir. Bu güvenlik açığından başarıyla yararlanan bir saldırgan, etkilenen sistemin tüm denetimini uzaktan ele geçirebilir. Saldırgan, program yükleyebilir; verileri görüntüleyebilir, değiştirebilir veya silebilir; tüm kullanıcı haklarına sahip olan yeni hesaplar oluşturabilir.
  
Microsoft Office SharePoint Server 2007 sitesine yönelik bir saldırı, ayrıcalık yükselmesine neden olabilir. Bu güvenlik açığından başarıyla yararlanan bir saldırgan iş istasyonu ve sunucu ortamından farklı olarak, SharePoint sunucusu içinde ayrıcalık yükselmesi sağlayabilir.
  
**Güvenlik açığına ne neden olmaktadır?**  
Microsoft Excel, Excel dosyalarını belleğe yüklerken kayıt değerlerini ayrıştırmak için yeterli doğrulama gerçekleştirmez.
  
**Bir saldırgan bu güvenlik açığından yararlanarak neler yapabilir?**  
Kullanıcının yerel Excel istemcisine yönelik bir saldırıda, bu güvenlik açığından başarıyla yararlanan bir saldırgan oturum açan kullanıcının bağlamında rasgele kod çalıştırabilir. Kullanıcı yönetimsel haklarla oturum açtıysa, saldırgan etkilenen sistemin denetimini tümüyle ele geçirebilir. Saldırgan, program yükleyebilir; verileri görüntüleyebilir, değiştirebilir veya silebilir; tüm kullanıcı haklarına sahip olan yeni hesaplar oluşturabilir. Hesapları, sistemde az sayıda kullanıcı hakkıyla yapılandırılmış olan kullanıcılar, yönetici haklarıyla çalışan kullanıcılardan daha az etkilenebilir.
  
SharePoint sitesine yönelik bir saldırıda, saldırganın özel hazırlanmış Excel dosyasını SharePoint sitesine yüklemek için yeterli haklara sahip bir hesabının olması ve daha sonra bu dosyayı SharePoint sitesinde kullanarak bir Web bölümü oluşturması gerekir. SharePoint sitesi Web bölümünü Excel dosyasındaki özel hazırlanmış kayıtlara dayalı olarak oluşturacağından, bu güvenlik açığı, saldırganın SharePoint sunucusu içinden yükseltilmiş ayrıcalıklarla kod çalıştırmasına olanak verebilir.
  
**Bir saldırgan güvenlik açığından nasıl yararlanabilir?**  
Kullanıcının yerel Excel istemcisine yönelik bir saldırıda, saldırganın bu güvenlik açığından yararlanmak üzere kullanabileceği yerel saldırı, e-posta saldırısı veya Web tabanlı saldırı gibi birkaç senaryo bulunmaktadır.
  
Yerel saldırı senaryosunda bu güvenlik açığı, kullanıcının Microsoft Excel'in etkilenen sürümünde hatalı biçimlendirilmiş bir Excel dosyasını açmasını gerektirir.
...
**Bu güvenlik açığından birincil derecede hangi sistemler etkileniyor?**  
Yerel Excel istemcileri için, Microsoft Excel'in kullanıldığı sistemler birincil derecede risk altındadır. Yöneticiler kullanıcıların sunucularda oturum açmalarına ve program çalıştırmalarına izin verirse sunucular daha fazla etkilenebilir. Ancak, en iyi uygulamalarda buna izin verilmesi kesinlikle önerilmemektedir.
  
SharePoint siteleri için, SharePoint Server 2007'nin çalıştırıldığı sistemler birincil derecede risk altındadır.
  
**Güncelleştirme ne yapıyor?**  
Güncelleştirme, Excel dosyaları belleğe yüklenirken Microsoft Excel'in kayıt değerlerini doğrulama biçimini değiştirerek hem Excel istemcisindeki hem de SharePoint Server'daki güvenlik açığını giderir.
...
Excel'de Kimlik Bilgilerini Önbelleğe Alma Güvenlik Açığı - CVE-2008-3003  
-------------------------------------------------------------------------
  
<span></span>
Excel 2007'nin bir uzak veri kaynağına veri bağlantıları gerçekleştirme biçiminde bir ayrıcalık yükselmesi güvenlik açığı bulunmaktadır. Bu güvenlik açığından yararlanan bir saldırgan, uzak veri kaynağına kimlik bilgilerini saklamayacak şekilde yapılandırılmış bir .xlsx dosyasını açarak güvenli bir uzak veri kaynağına erişim sağlayabilir.
  
Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2008-3003](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-3003).
  
#### Excel'de Kimlik Bilgilerini Önbelleğe Alma Güvenlik Açığı - CVE-2008-3003 için Azaltıcı Etkenler
  
Azaltıcı etken, varolan bir durumda bulunan ve güvenlik açığından yararlanılmasının önem derecesini azaltabilecek bir ayar, genel yapılandırma ya da en iyi uygulama anlamına gelir. Sizin durumunuzda aşağıdaki azaltıcı etkenler işinize yarayabilir:
  
-   Excel 97-2003 Çalışma Kitapları olarak kaydedilen dosyalar bu güvenlik açığından etkilenmez  
-   Excel 2007'yi kullanarak Çalışma Kitapları'nı Excel 97-2003 dosya biçimlerinde kaydeden müşteriler bu güvenlik açığından etkilenmez
  
#### Excel'de Kimlik Bilgilerini Önbelleğe Alma Güvenlik Açığı - CVE-2008-3003 için Geçici Çözümler
  
Geçici çözüm, arka plandaki güvenlik açığını gidermeyen ama güvenlik açığı uygulanmadan önceki bilinen saldırı vektörlerinin engellenmesine yardımcı olan bir ayar veya yapılandırma değişikliği anlamına gelir. Microsoft aşağıdaki geçici çözümleri sınamıştır ve bir geçici çözümün işlevselliği azaltıp azaltmadığı ilgili açıklamada belirtilmektedir.
  
-   **.xlsx dosyasının içerdiği connections.xml dosyasını düzenleyin ve parolayı el ile kaldırın**
  
    **Windows Kabuğu yöntemi:**
  
    1.  Düzenlemelerinizi yapmadan önce, etkilenen .xlsx dosyasının yedek bir kopyasını oluşturun.  
    2.  Windows XP veya Windows Vista tabanlı bir bilgisayarda, etkilenen .xlsx dosyasının uzantısını .zip olarak değiştirin.  
    3.  Windows Gezgini'ni kullanarak, ZIP dosyasını çift tıklatın ve ardından içerdiği **xl** klasörünü çift tıklatarak dosyayı açın.  
    4.  **xl** klasöründe, 'connections.xml' dosyasını tıklatın ve ZIP dosyasından masaüstünüzdeki bir yerel klasöre sürükleyin.  
    5.  Farenin sağ düğmesini kullanarak **connections.xml** dosyasını tıklatıp kısayol menüsünü açın. Menüde, **Birlikte Aç**'ı tıklatın ve ardından **Not Defteri**'ni seçin.  
    6.  Not Defteri'nde, "connection=" dizesini bulun ve bu dizede "PWD=" öğesini arayın. “PWD=” ile “;” arasındaki tüm karakterleri kaldırın, çünkü bu karakterler bağlantı için hatalı olarak kaydedilmiş kimlik bilgileridir.  
    7.  connections.xml dosyasını kaydedin ve Not Defteri'ni kapatın.  
    8.  connections.xml dosyasını ZIP klasöründe, **xl** klasörünün içine sürükleyin.  
        **NOT**: Winzip gibi bazı uygulamalar varsayılan olarak dosyayı ZIP arşivinin kök dizinine yerleştirir ve 'xl' klasöründeki dosyanın üzerine yazmaz. Winzip uygulamasını kullanarak dosyayı güncelleştirme yönergeleri için, aşağıdaki **WinZip yöntemi** bölümüne bakın.  
    9.  ZIP dosyasının uzantısını yeniden .xlsx olarak değiştirin.  
    10. Belgeyi Excel 2007'de açın, **Veri** menüsünü tıklatın ve şeridin bağlantılar bölümünde **tümünü yenile**'yi tıklatın. Parola istendiğini doğrulayın.
    ...
    **WinZip yöntemi:**
    ...
    1.  Düzenlemelerinizi yapmadan önce, etkilenen .xlsx dosyasının yedek bir kopyasını oluşturun.  
    2.  WinZip uygulamasının yüklü olduğu bir bilgisayarda, etkilenen .xlsx dosyasının uzantısını .zip olarak değiştirin.  
    3.  Windows Gezgini'ni kullanarak, ZIP dosyasını çift tıklatıp WinZip uygulamasında açın.  
    4.  **\\xl** klasöründeki **connections.xml** dosyasını bulun. Farenin sağ düğmesini kullanarak **connections.xml** dosyasını tıklatıp kısayol menüsünü açın. Menüde, **Birlikte Aç**'ı tıklatın ve ardından **Not Defteri**'ni seçin.  
    5.  Not Defteri'nde, "connection=" dizesini bulun ve bu dizede "PWD=" öğesini arayın. "PWD=" ile ";" arasındaki tüm karakterleri kaldırın, çünkü bu karakterler bağlantı için hatalı olarak kaydedilmiş kimlik bilgileridir.  
    6.  connections.xml dosyasını kaydedin ve Not Defteri'ni kapatın. Not Defteri kapatıldıktan sonra, WinZip, arşivi güncelleştirilmiş dosyanın içeriğiyle güncelleştirmek isteyip istemediğinizi sorar. Winzip'in arşivi güncelleştirmesine izin vermek için **Evet**'i tıklatın.  
    7.  ZIP dosyasının uzantısını yeniden .xlsx olarak değiştirin.  
    8.  Belgeyi Excel 2007'de açın, **Veri** menüsünü tıklatın ve şeridin bağlantılar bölümünde **tümünü yenile**'yi tıklatın. Parola istendiğini doğrulayın.
  
    **Geçici Çözümün Etkisi**: Yok
  
    **Geri alma:** Düzenlenmiş dosyanın yedek kopyasını geri yükleyin.
  
-   **Excel 2007'yi kullanarak, veri bağlantıları içeren dosyayı şifreleyin**
  
    1.  Veri bağlantılarının kaydedilmiş olduğu .xlsx dosyasını Excel 2007'de açın  
    2.  [Microsoft Office Düğmesi](http://office.microsoft.com/en-gb/help/ha101828951033.aspx)'ni tıklatın, Hazırla'nın üzerine gelin ve sonra da **Belgeyi Şifrele**'yi tıklatın.  
    3.  En fazla 255 karakter uzunluğunda bir parola yazın. Bu parolada varsayılan olarak AES 128 bit şifreleme kullanılır ve şifreleme anahtarı olarak bu parola kullanılarak belge içeriği şifrelenir
  
    **Geçici Çözümün Etkisi:** Kullanıcılar dosyayı açtıklarında şifrenin kaldırılması için bu parolayı girmeleri istenir
  
    **Geri alma:**
  
    1.  Veri bağlantılarını içeren .xlsx dosyasını Excel 2007'de açın ve belgeyi şifrelemek için kullanılan parolayı girin  
    2.  [Microsoft Office Düğmesi](http://office.microsoft.com/en-gb/help/ha101828951033.aspx)'ni tıklatın, **Hazırla**'nın üzerine gelin ve sonra da **Belgeyi Şifrele**'yi tıklatın.  
    3.  Parola alanındaki tüm karakterleri vurgulayıp silin ve ardından **Tamam** düğmesine basın  
    4.  Dosyayı kaydettiğinizde, şifreleme kaldırılır
  
-   **Excel 2007 içinden, dosyayı Excel 97-2003 dosya biçiminde kaydedin.**
  
    1.  Veri bağlantılarının kaydedilmiş olduğu .xlsx dosyasını Excel 2007'de açın  
    2.  [Microsoft Office Düğmesi](http://office.microsoft.com/en-gb/help/ha101828951033.aspx)'ni tıklatın, **Farklı Kaydet**'in üzerine gelin ve ardından **Excel 97-2003 Çalışma Kitabı**'nı tıklatın  
    3.  Çalışma kitabı için bir dosya adı yazıp **Kaydet** düğmesine basın
  
    **Geri alma:**
  
    1.  Veri bağlantılarını içeren .xlsx dosyasını Excel 2007'de açın ve belgeyi şifrelemek için kullanılan parolayı girin  
    2.  **Microsoft Office Düğmesi**'ni tıklatın, **Hazırla**'nın üzerine gelin ve sonra da **Belgeyi Şifrele**'yi tıklatın  
    3.  Parola alanındaki tüm karakterleri vurgulayıp silin ve ardından **Tamam** düğmesine basın  
    4.  Dosyayı kaydettiğinizde, şifreleme kaldırılır
  
#### Excel'de Kimlik Bilgilerini Önbelleğe Alma Güvenlik Açığı - CVE-2008-3003 Hakkında SSS
  
**Bu güvenlik açığının kapsamı nedir?**  
Bu bir ayrıcalık yükselmesi güvenlik açığıdır. Bu güvenlik açığından başarıyla yararlanan bir saldırgan, parola korumalı verilere erişim sağlayabilir.
  
**Güvenlik açığına ne neden olmaktadır?**  
.xlsx dosyası uzak veri oturumu parolasını kaydetmeyecek biçimde yapılandırıldığında, Microsoft Excel, parola dizesini düzgün biçimde silmez.
  
**Bir saldırgan bu güvenlik açığından yararlanarak neler yapabilir?**  
Bu güvenlik açığından başarıyla yararlanan bir saldırgan, uzak veri kaynağındaki parola korumalı verilere erişim sağlayabilir.
  
**Bir saldırgan güvenlik açığından nasıl yararlanabilir?**  
Bu güvenlik açığı, bir saldırganın daha önce yetkili bir kullanıcı tarafından parola korumalı bir veri kaynağına kaydedilmiş bir dosyaya erişmesini gerektirir.
  
**Bu güvenlik açığından birincil derecede hangi sistemler etkileniyor?**  
İş istasyonları ve terminal sunucuları da dahil olmak üzere Microsoft Excel'in kullanıldığı sistemler birincil derecede risk altındadır. Yöneticiler kullanıcıların sunucularda oturum açmalarına ve program çalıştırmalarına izin verirse sunucular daha fazla etkilenebilir. Ancak, en iyi uygulamalarda buna izin verilmesi kesinlikle önerilmemektedir.
  
**Güncelleştirme ne yapıyor?**  
Güncelleştirme, uzak veri bağlantısını parolasını düzgün şekilde silerek bu güvenlik açığını giderir.
...
MBSA 2.1 hakkında daha fazla bilgi için, bkz: [MBSA 2.0 Hakkında Sık Sorulan Sorular](http://www.microsoft.com/technet/security/tools/mbsa2/qa.mspx).
...
| Microsoft Office Excel Viewer 2003                                                                   | Evet    | Evet                        | Hayır                                                                               | Hayır                                                                               |  
| Microsoft Office Excel Viewer 2003 Service Pack 3                                                    | Evet    | Evet                        | Hayır                                                                               | Hayır                                                                               |  
...
<td style="border:1px solid black;">office2000-kb951582-fullfile-trk /q:a</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">office2000-kb951582-fullfile-trk /r:n</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">Bkz: <a href="http://support.microsoft.com/kb/954066">Microsoft Bilgi Bankası makalesi 954066</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;">Kullanıcı araya girmeden yükleme</td>
<td style="border:1px solid black;">officeXP-kb951551-fullfile-trk /q:a</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">officeXP-kb951551-fullfile-trk /r:n</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Güncelleştirme günlük dosyası</td>
<td style="border:1px solid black;">Uygulanamaz</td>
...
office2003-KB951548-FullFile-trk /q:a<br />
<br />
Excel Viewer 2003 için:<br />
office2003-KB951589-FullFile-TRK /q:a</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">Excel 2003 için:<br />
office2003-KB951548-FullFile-trk / r:n<br />
<br />
Excel Viewer 2003 için:<br />
office2003-KB951589-FullFile-TRK / r:n</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Güncelleştirme günlük dosyası</td>
<td style="border:1px solid black;">Uygulanamaz</td>
...
#### Excel 2007, Excel Viewer ve Excel Uyumluluk Paketi (tüm sürümler)
...
<tr class="even">
<td style="border:1px solid black;">Yeniden başlatma gerekiyor mu?</td>
<td style="border:1px solid black;">Bu güncelleştirme çoğu durumda bilgisayarın yeniden başlatılmasını gerektirmez. Ancak, gereken dosyalar o sırada kullanılıyorsa, bu güncelleştirme için bilgisayarın yeniden başlatılması gerekir. Yeniden başlatma gereksinimi olasılığını azaltmak için, güvenlik güncelleştirmesini yüklemeden önce, etkilenen tüm hizmetleri durdurun ve etkilenen dosyaları kullanabilecek tüm uygulamaları kapatın. Yeniden başlatmanızın istenmesinin nedenleri hakkında daha fazla bilgi için, bkz: Microsoft Bilgi Bankası makalesi 887012.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Anında düzeltme</td>
<td style="border:1px solid black;">Uygulanamaz</td>
...
**Not** Tek başına ve birden çok sunucu yapılandırmalarında güncelleştirmeleri dağıtma hakkında daha fazla bilgi için, bkz: [Office SharePoint Server 2007 için yazılım güncelleştirmelerini dağıtma.](http://technet2.microsoft.com/office/en-us/library/f484f5f2-35bb-4d70-bf56-dd1c4c287c721033.mspx)
...
Mac 12.1.2 için Microsoft Office 2008 Güncelleştirmesi'nin uygun dil sürümünü [Microsoft Yükleme Merkezi](http://www.microsoft.com/downloads/details.aspx?familyid=9515c70d-be80-4ade-856a-ea542f7d84e1)'nden yükleyip kurun.
  
-   Virüsten koruma uygulamaları, tüm Microsoft Office uygulamaları, Mac için Microsoft Messenger ve Office Bildirimleri de dahil çalışan tüm uygulamalardan çıkın, çünkü yükleme işlemini kesintiye uğratabilirler.  
-   Masaüstünüzde Mac 12.1.2 için Microsoft Office 2008 Güncelleştirmesi birimini açın. Bu adım sizin adınıza gerçekleştirilmiş olabilir.  
-   Güncelleştirme işlemini başlatmak için, Mac 12.1.2 için Microsoft Office 2008 Güncelleştirmesi birimi penceresinde, Mac 12.1.2 için Microsoft Office 2008 Güncelleştirmesi uygulamasını çift tıklatın ve ekrandaki yönergeleri izleyin.  
-   Yükleme başarıyla tamamlanırsa, güncelleştirme yükleyicisini sabit diskinizden kaldırabilirsiniz. Yüklemenin başarıyla tamamlandığını doğrulamak için, aşağıdaki “Güncelleştirme Yüklemesini Doğrulama” başlığına bakın. Güncelleştirme yükleyicisini kaldırmak için, Mac 12.1.2 için Microsoft Office 2008 Güncelleştirmesi birimini ve ardından karşıdan yüklediğiniz dosyayı Trash (Çöp Kutusu) klasörüne sürükleyin.
...
Sürüm numarası **12.1.2** ise, güncelleştirme başarıyla yüklenmiştir.
...
-   [VeriSign iDefense VCP](http://www.idefense.com/vcp), Excel'de Dizin Doğrulaması Güvenlik Açığı'nı (CVE-2008-3004) ve Excel'de Dize Dizini Güvenlik Açığı'nı (CVE-2008-3005) bildirdikleri için.  
-   [TippingPoint](http://www.tippingpoint.com/) ve [Zero Day Initiative](http://www.zerodayinitiative.com/), Excel'de Kayıt Ayrıştırma Güvenlik Açığı'nı (CVE-2008-3006) bildirdikleri için.  
-   Jeremy Funk, Excel'de Kimlik Bilgilerini Önbelleğe Alma Güvenlik Açığı'nı (CVE-2008-3003) bildirdiği için.
...
-   V1.1 (13 Ağustos 2008): İlgili Microsoft Bilgi Bankası makalesi 954066'daki dosya bilgilerinin güncelleştirildiğini duyurmak üzere Bu Güvenlik Güncelleştirmesi İle İlgili Sık Sorulan Sorular (SSS) bölümüne bir girdi eklendi. Ayrıca, Word, Excel ve PowerPoint 2007 Dosya Biçimleri için Microsoft Office Uyumluluk Paketi ve Word, Excel ve PowerPoint 2007 Dosya Biçimleri için Microsoft Office Uyumluluk Paketi Service Pack 1 için bülten değişikliği bilgileri yeniden düzenlendi.  
-   V1.2 (20 Ağustos 2008): Bu güncelleştirmenin, Microsoft Office SharePoint Server 2007 Enterprise sürümünün varsayılan yapılandırması ve Internet Siteleri için Microsoft Office SharePoint Server 2007 gibi Excel Hizmetleri'nin yüklü olduğu sunuculara uygulandığını açıklığa kavuşturmak üzere Etkilenen Yazılımlar tablosuna bir not ve bir SSS girdisi eklendi. Microsoft Office SharePoint Server 2007 Standard sürümü Excel Hizmetleri'ni içermemektedir.  
-   V1.3 (1 Ekim 2008): Word, Excel ve PowerPoint 2007 Dosya Biçimleri için Microsoft Office Uyumluluk Paketi'nin bu bülten tarafından güncelleştirilen bileşenlerini açıklamak üzere **Bu Güvenlik Güncelleştirmesi İle İlgili Sık Sorulan Sorular (SSS)** bölümüne girdi eklendi. Ayrıca, Microsoft Office Uyumluluk Paketi için Etkilenen Yazılımlar tablosundaki "Değiştirilen Bültenler" adlı iki bağlantı MS08-014'e işaret edecek şekilde düzeltildi. Bu yalnızca bilgilendirme amaçlı bir değişikliktir. Güvenlik güncelleştirmesinin ikili dosyalarında değişiklik yapılmamıştır.
