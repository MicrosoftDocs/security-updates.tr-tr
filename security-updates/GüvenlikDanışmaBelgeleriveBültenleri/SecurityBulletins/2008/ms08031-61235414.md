---
TOCTitle: 'MS08-031'
Title: 'Microsoft Güvenlik Bülteni MS08-031 - Kritik'
ms:assetid: 'ms08-031'
ms:contentKeyID: 61235414
ms:mtpsurl: 'https://technet.microsoft.com/tr-TR/library/ms08-031(v=Security.10)'
---

Security Bulletin

Microsoft Güvenlik Bülteni MS08-031 - Kritik
============================================
...
Bu güvenlik güncelleştirmesi, Microsoft Windows 2000 Service Pack 4 üzerinde Internet Explorer 6 Service Pack 1; Windows XP'nin desteklenen sürümleri üzerinde Internet Explorer 6; Windows XP ve Windows Vista'nın desteklenen sürümleri üzerinde Internet Explorer 7 için Kritik olarak derecelendirilmiştir. Güvenlik güncelleştirmesi ayrıca Microsoft Windows 2000 Service Pack 4 üzerinde Internet Explorer 5.01 için Önemli ve Internet Explorer'ın desteklenen tüm diğer sürümleri için Orta olarak derecelendirilmiştir. Daha fazla bilgi için, bu bölümdeki **Etkilenen ve Etkilenmeyen Yazılımlar** alt bölümüne bakın.

Güvenlik güncelleştirmesi, Internet Explorer'ın HTML nesnelerine çağrıları işleme ve verileri doğrulama biçimini değiştirerek bu güvenlik açıklarını giderir. Bu güvenlik açıkları hakkında daha fazla bilgi için, bir sonraki bölüm olan **Güvenlik Açığı Bilgileri** altında, Sık Sorulan Sorular (SSS) alt bölümüne bakın.
...
<span></span>
**Bu bülten 11 Haziran 2008'de neden yeniden düzenlendi?**  
Bu bülten, ilgili [Microsoft Bilgi Bankası makalesi 950759](http://support.microsoft.com/kb/950759)'daki dosya bilgilerinin güncelleştirilmiş olduğunu bildirmek üzere yeniden düzenlendi.

**Dosya bilgileri ayrıntılarını nerede bulabilirim?**  
Dosya bilgileri ayrıntıları [Microsoft Bilgi Bankası makalesi 950759](http://support.microsoft.com/kb/950759)'da bulunabilir.
...
<th style="border:1px solid black;" >HTML Nesnelerinde Bellek Bozulması Güvenlik Açığı – CVE-2008-1442</th>
<th style="border:1px solid black;" >İstek Üstbilgisinde Etki Alanları Arasında Bilginin Açığa Çıkması Güvenlik Açığı - CVE-2008-2243</th>
...
HTML Nesnelerinde Bellek Bozulması Güvenlik Açığı – CVE-2008-1442  
-----------------------------------------------------------------
  
<span></span>
Internet Explorer'ın HTML nesnelerine yönelik bazı beklenmeyen yöntem çağrıları içeren bir Web sayfasını görüntüleme biçiminde bir uzaktan kod yürütme güvenlik açığı bulunmaktadır. Saldırgan, özel hazırlanmış bir Web sayfası oluşturarak bu güvenlik açığından yararlanabilir. Bir kullanıcı bu Web sayfasını görüntülediğinde, güvenlik açığı uzaktan kod yürütülmesine izin verebilir. Bu güvenlik açığından başarıyla yararlanan bir saldırgan, oturum açan kullanıcı ile aynı haklara sahip olabilir.
  
Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2008-1442](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-1442).
  
#### HTML Nesnelerinde Bellek Bozulması Güvenlik Açığı – CVE-2008-1442 için Azaltıcı Etkenler
...
#### HTML Nesnelerinde Bellek Bozulması Güvenlik Açığı – CVE-2008-1442 için Geçici Çözümler
...
#### HTML Nesnelerinde Bellek Bozulması Güvenlik Açığı – CVE-2008-1442 Hakkında SSS
...
Internet Explorer HTML nesnelerine yönelik bazı beklenmeyen yöntem çağrıları için bir Web sayfasını görüntülediğinde, sistem belleğini bir saldırganın rasgele kod yürütmesine olanak verecek şekilde bozabilir.
...
Güncelleştirme, Internet Explorer'ın HTML nesnelerini işleme biçimini değiştirerek bu güvenlik açığını giderir.
...
İstek Üstbilgisinde Etki Alanları Arasında Bilginin Açığa Çıkması Güvenlik Açığı – CVE-2008-1544  
------------------------------------------------------------------------------------------------
  
<span></span>
Internet Explorer'ın belirli istek üstbilgilerini işleme biçiminde bilginin açığa çıkması güvenlik açığı bulunmaktadır. Saldırgan, özel hazırlanmış bir Web sayfası oluşturarak bu güvenlik açığından yararlanabilir. Bir kullanıcı Web sayfasını görüntülediğinde, güvenlik açığı, saldırganın başka bir Internet Explorer etki alanındaki verileri okumasına olanak verebilir.
  
Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2008-1544](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-1544).
  
#### İstek Üstbilgisinde Etki Alanları Arasında Bilginin Açığa Çıkması Güvenlik Açığı – CVE-2008-1544 için Azaltıcı Etkenler
  
-   Web tabanlı saldırı senaryosunda, bir saldırganın bu açıktan yararlanmak için kullanılan bir Web sayfası içeren bir Web sitesi barındırabilir. Ayrıca, kullanıcı tarafından sağlanan içeriği veya reklamları kabul eden ya da barındıran güvenliği aşılmış Web sitelerinde, bu güvenlik açığından yararlanılabilecek özel hazırlanmış içerik bulunabilir. Ancak bu durumların hiçbirinde, saldırganın, bu Web sitelerini ziyaret etmek için kullanıcıyı zorlama yolu yoktur. Bunun yerine, saldırganın kullanıcıları bir e-posta iletisindeki veya Instant Messenger iletisindeki kendi Web sitesine götüren bir bağlantıyı tıklatmalarını sağlayarak onları bu Web sitesini ziyaret etmeye ikna etmesi gerekir.  
-   Varsayılan olarak, Microsoft Outlook ve Microsoft Outlook Express'in tüm desteklenen sürümleri HTML e-posta iletilerini Yasak siteler bölgesinde açar. Yasak siteler bölgesi, HTML e-posta iletileri okunurken Active Komut Dizileri ve ActiveX denetimlerinin kullanılmasını engelleyerek, bu güvenlik açığından yararlanmaya çalışacak saldırıların etkilerinin azaltılmasına yardımcı olur. Bununla birlikte, kullanıcı bir e-posta iletisindeki bağlantıyı tıklatırsa, Web tabanlı saldırı senaryosu aracılığıyla bu güvenlik açığından etkilenebilir.  
-   Internet Explorer, Windows Server 2003 ve Windows Server 2008 üzerinde varsayılan olarak [Artırılmış Güvenlik Yapılandırması](http://go.microsoft.com/fwlink/?linkid=92039) adı verilen kısıtlı bir modda çalışır. Bu mod, Internet bölgesi için güvenlik düzeyini Yüksek olarak ayarlar. Bu, Internet Explorer'ın Güvenilen siteler bölgesine eklenmemiş Web siteleri için bir azaltıcı etkendir. Internet Explorer Artırılmış Güvenlik Yapılandırması hakkında daha fazla bilgi için bu güvenlik açığıyla ilgili bölümün SSS (Sık Sorulan Sorular) alt bölümüne bakın.
  
#### İstek Üstbilgisinde Etki Alanları Arasında Bilginin Açığa Çıkması Güvenlik Açığı – CVE-2008-1544 için Geçici Çözümler
...
#### İstek Üstbilgisinde Etki Alanları Arasında Bilginin Açığa Çıkması Güvenlik Açığı – CVE-2008-1544 Hakkında SSS
...
**Güvenlik açığına ne neden olmaktadır?**    
Internet Explorer, özel hazırlanmış bir istek üstbilgisini hatalı biçimde ayrıştırarak, aynı kaynak ilkesinin ihlal edilmesine neden olur.
...
**Güncelleştirme ne yapıyor?**    
Güncelleştirme, Web sunucularından üstbilgileri isterken aynı kaynak ilkesini zorlar.
  
**Aynı kaynak ilkesi nedir?**  
Aynı kaynak ilkesi (SOP), günümüzün tarayıcılarında erişim denetimi sağlar. Bir kaynaktan yüklenen belgelerin veya komut dosyalarının farklı bir kaynaktan alınan belgelerin özelliklerini almasını veya ayarlamasını engelleyerek tam bir yalıtım sağlar. [JScript Web Günlüğü: ECMAScript, İçerik Birleştirmeleri ve Güvenlik](http://blogs.msdn.com/jscript/archive/2007/11/29/ecmascript-mashups-and-security.aspx) konusuna da bakın.
  
**Bu güvenlik bülteni yayımlandığında bu güvenlik açığı genel olarak duyurulmuş muydu?**    
Evet. Bu güvenlik açığı genel olarak duyurulmuştur. Ortak Güvenlik Açığı ve Etkilenme (Common Vulnerability and Exposure) numarası olarak CVE-2008-1544 atanmıştır.
...
IE5.01sp4-KB950759-Windows2000sp4-x86-trk /quiet<br />
<br />
Windows 2000'in tüm desteklenen sürümleri üzerine yüklendiğinde Internet Explorer 6 Service Pack 1 için:<br />
IE6.0sp1-KB950759-Windows2000-x86-trk /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">Windows 2000'in tüm desteklenen sürümleri üzerinde Internet Explorer 5.01 Service Pack 4 için:<br />
IE5.01sp4-KB950759-Windows2000sp4-x86-trk /norestart<br />
<br />
Windows 2000'in tüm desteklenen sürümleri üzerine yüklendiğinde Internet Explorer 6 Service Pack 1 için:<br />
IE6.0sp1-KB950759-Windows2000-x86-trk /norestart</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">Windows 2000'in tüm desteklenen sürümleri üzerinde Internet Explorer 5.01 Service Pack 4 için:<br />
Denetim Masası'ndaki Program Ekle veya Kaldır aracını veya %Windir%\$NTUninstallKB950759-IE501SP4-20080418.120000$\Spuninst klasöründe bulunan Spuninst.exe yardımcı programını kullanın<br />
<br />
Windows 2000'in tüm desteklenen sürümleri üzerine yüklendiğinde Internet Explorer 6 Service Pack 1 için:<br />
Denetim Masası'ndaki Program Ekle veya Kaldır aracını veya %Windir%\$NTUninstallKB950759-IE6SP1-20080418.120000$\Spuninst klasöründe bulunan Spuninst.exe yardımcı programını kullanın</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Dosya Bilgileri</strong></td>
<td style="border:1px solid black;">Bkz: <a href="http://support.microsoft.com/kb/950759">Microsoft Bilgi Bankası makalesi 950759</a></td>
</tr>
<tr class="even">
...
Windowsxp-kb950759-x86-trk /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
IE7-WindowsServer2003.WindowsXP-KB950759-x64-trk /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">Windows XP Service Pack 2 ve Windows XP Service Pack 3 için Internet Explorer 6:<br />
Windowsxp-KB950759-x86-trk /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition ve Windows XP Professional x64 Edition Service Pack 2 için Internet Explorer 6:<br />
WindowsServer2003.WindowsXP-KB950759-x64-trk / norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Service Pack 2 ve Windows XP Service Pack 3 için Internet Explorer 7:<br />
IE7-WindowsXP-KB950759-x86-trk /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition ve Windows XP Professional x64 Edition Service Pack 2 için Internet Explorer 7:<br />
IE7-WindowsServer2003.WindowsXP-KB950759-x64-trk /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Güncelleştirme günlük dosyası</td>
...
Denetim Masası'ndaki Program Ekle veya Kaldır aracını veya %Windir%\$NTUninstal\KB950759$\Spuninst klasöründe bulunan Spuninst.exe yardımcı programını kullanın</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP için Internet Explorer 7:<br />
Denetim Masası'ndaki Program Ekle veya Kaldır aracını veya %Windir%\ie7updates\KB950759-IE7\spuninst klasöründe bulunan Spuninst.exe yardımcı programını kullanın</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Dosya Bilgileri</strong></td>
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/950759">Bkz: Microsoft Bilgi Bankası makalesi 950759</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Kayıt Defteri Anahtarı Doğrulaması</strong></td>
...
Windowsserver2003-KB950759-x86-trk /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
IE7-WindowsServer2003-KB950759-ia64-trk /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen 32-bit sürümleri için Internet Explorer 6:<br />
Windowsserver2003-KB950759-x86-trk /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen x64 tabanlı sürümleri için Internet Explorer 6:<br />
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen Itanium tabanlı sürümleri için Internet Explorer 6:<br />
Windowsserver2003-KB950759-ia64-trk /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen 32-bit sürümleri için Internet Explorer 7:<br />
IE7-WindowsServer2003-KB950759-x86-trk /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen x64 tabanlı sürümleri için Internet Explorer 7:<br />
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen Itanium tabanlı sürümleri için Internet Explorer 7:<br />
IE7-WindowsServer2003-KB950759-ia64-trk /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Güncelleştirme günlük dosyası</td>
...
Denetim Masası'ndaki Program Ekle veya Kaldır aracını veya %Windir%\$NTUninstallKB950759$\Spuninst klasöründe bulunan Spuninst.exe yardımcı programını kullanın</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
-   [TippingPoint](http://www.tippingpoint.com/) için çalışan Sebastian Apelt, Peter Vreugdenhil ve anonim bir araştırmacı ile [Zero Day Initiative](http://www.zerodayinitiative.com/), HTML Nesnelerinde Bellek Bozulması Güvenlik Açığı'nı – (CVE-2008-1442) bildirdikleri için.
...
-   V1.1 (11 Haziran 2008): İlgili Microsoft Bilgi Bankası makalesi 950759'daki dosya bilgilerinin güncelleştirilmiş olduğunu bildirmek üzere Güncelleştirme Hakkında SSS bölümüne bir girdi eklendi.
