---
TOCTitle: 'MS06-062'
Title: 'Microsoft Güvenlik Bülteni MS06-062 - Kritik'
ms:assetid: 'ms06-062'
ms:contentKeyID: 61235297
ms:mtpsurl: 'https://technet.microsoft.com/tr-TR/library/ms06-062(v=Security.10)'
---

Security Bulletin

Microsoft Güvenlik Bülteni MS06-062 - Kritik
============================================

Microsoft Office'teki Güvenlik Açıkları Uzaktan Kod Yürütülmesine İzin Verebilir (922581)
-----------------------------------------------------------------------------------------
...
-   Microsoft Office 2000 Service Pack 3 - [Güncelleştirmeyi karşıdan yükle (KB923274)](http://www.microsoft.com/downloads/details.aspx?familyid=e0c7e1e4-7859-4c7e-898e-1cf05014885b)
    ...
    -   Microsoft Word 2000
-   Microsoft Office XP Service Pack 3 - [Güncelleştirmeyi karşıdan yükle (KB923273)](http://www.microsoft.com/downloads/details.aspx?familyid=958ee063-d88d-4e45-8555-4d1c4730f5c8)
    ...
    -   Microsoft Word 2002
-   Microsoft Office 2003 Service Pack 1 veya Service Pack 2 - [Güncelleştirmeyi karşıdan yükle (KB923272)](http://www.microsoft.com/downloads/details.aspx?familyid=0d399f68-ec0d-4768-9846-b16b3dadf247)
...
-   Microsoft Project 2000 Service Release 1 - [Güncelleştirmeyi karşıdan yükle (KB923274)](http://www.microsoft.com/downloads/details.aspx?familyid=266a9870-cd03-45ca-877b-b5ad2c873fe5)
-   Microsoft Project 2002 Service Pack 1 - [Güncelleştirmeyi karşıdan yükle (KB923273)](http://www.microsoft.com/downloads/details.aspx?familyid=a77dea18-d237-4bb0-9464-ce31b6ae52d6)
-   Microsoft Visio 2002 Service Pack 2 - [Güncelleştirmeyi karşıdan yükle (KB923273)](http://www.microsoft.com/downloads/details.aspx?familyid=fd4b7660-0fc5-43e5-9683-b6dae96136bb)
...
Bu güncelleştirme, yeni keşfedilen ve genel ve özel olarak bildirilen birkaç güvenlik açığını giderir. Her bir güvenlik açığı, bu bültende "Güvenlik Açığı Ayrıntıları" başlığında belgelenmektedir.
...
| Güvenlik Açığı Tanımlayıcıları                                                                                                                                       | Güvenlik Açığının Etkisi | Microsoft Office 2000 | Microsoft Office XP | Microsoft Office 2003 | Mac için Microsoft Office 2004 veya Mac için Microsoft Office v. X |
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------|-----------------------|---------------------|-----------------------|--------------------------------------------------------------------|
| Office'te Hatalı Bellek Erişimi Güvenlik Açığı - [CVE-2006-3434](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3434)                                    | Uzaktan Kod Yürütme      | Kritik                | Önemli              | Önemli                | Önemli                                                             |
| Office'te Hatalı Biçimlendirilmiş Grafik Kaydı Güvenlik Açığı - [CVE-2006-3650](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3650)                     | Uzaktan Kod Yürütme      | Kritik                | Önemli              | Önemli                | Önemli                                                             |
| Office'te Hatalı Biçimlendirilmiş Kayıt Nedeniyle Bellek Bozulması Güvenlik Açığı - [CVE-2006-3864](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3864) | Uzaktan Kod Yürütme      | Kritik                | Önemli              | Önemli                | Önemli                                                             |
| Microsoft Office'te Akıllı Etiket Ayrıştırma Güvenlik Açığı - [CVE-2006-3868](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3868)                       | Uzaktan Kod Yürütme      | Yok                   | Önemli              | Önemli                | Yok                                                                |
...
<span></span>
**Yönetimsel yükleme noktalarını güncelleştiriyorum ve iki .msp dosyası bulunduğunu fark ettim. Neden?**Düzeltme eki algılama mantığımızdaki kısıtlamalar iki ayrı düzeltme eki kullanma gereksinimini ortaya çıkarmıştır. Bunun nedeni, güncelleştirilmekte olan mso.dll dosyası çok fazla ürünle birlikte geldiği için, tümüne yönelik tek bir .MSP dosyası kullanılırsa MSP dosyasındaki algılama mantığının algılama araçları tarafından kullanılamayacak kadar büyük olmasıdır. Bu kısıtlamayı çözümlemek için etkin biçimde çalışılmaktadır.

**Yönetimsel yükleme noktalarında mso.msp ve pvmso.msp listeleniyor. Her iki paketi de yüklemem gerekiyor mu?**Evet, mso.msp dosyası Word ve Excel gibi çoğu Office ürününü hedefler. Pvmso.msp dosyası Visio, Project ve OneNote gibi ek Office ürünlerini hedefler. Güvenliğinizin sağlanabilmesi için her iki paketi de yüklemeniz gerekmektedir.
...
| Bülten Kimliği                                                          | Microsoft Office 2000 | Microsoft Office XP, Project 2002 Service Pack 1 veya Visio 2002 Service Pack 2 | Microsoft Office 2003 | Mac için Microsoft Office 2004 veya Mac için Microsoft Office v. X |
|-------------------------------------------------------------------------|-----------------------|---------------------------------------------------------------------------------|-----------------------|--------------------------------------------------------------------|
| [**MS06-048**](http://technet.microsoft.com/security/bulletin/ms06-048) | Değişti               | Değişti                                                                         | Değişti               | Değişti                                                            |
...
| Project 2000 Service Pack 2    | Evet       | Evet     |
| Project 2002 Service Pack 1    | Evet       | Evet     |
| Visio 2002 Service Pack 2      | Evet       | Evet     |
| Microsoft Office 2003          | Evet       | Evet     |
| Mac için Microsoft Office 2004 | Hayır      | Hayır    |
| Mac için Microsoft Office v. X | Hayır      | Hayır    |
...
<span></span>
#### Office'te Hatalı Bellek Erişimi Güvenlik Açığı - CVE-2006-3434:

Office'te uzaktan kod yürütmeye neden olabilecek bir güvenlik açığı bulunmaktadır. Office hatalı biçimlendirilmiş dize içeren bir dosyayı ayrıştırdığında saldırgan bu güvenlik açığından yararlanabilir.
...
#### Office'te Hatalı Bellek Erişimi Güvenlik Açığı - CVE-2006-3634 için Azaltıcı Etkenler:
...
#### Office'te Hatalı Bellek Erişimi Güvenlik Açığı - CVE-2006-3634 için Geçici Çözümler:
...
#### Office'te Hatalı Bellek Erişimi Güvenlik Açığı - CVE-2006-3634 Hakkında SSS:

**Bu güvenlik açığının kapsamı nedir?**
Office'te uzaktan kod yürütülmesine neden olabilecek bir güvenlik açığı bulunmaktadır. Office hatalı biçimlendirilmiş dize içeren bir dosyayı ayrıştırdığında saldırgan bu güvenlik açığından yararlanabilir.

Kullanıcı yönetimsel haklarla oturum açtıysa, bu güvenlik açığından başarıyla yararlanan bir saldırgan etkilenen sistemin denetimini tümüyle ele geçirebilir. Saldırgan, program yükleyebilir; verileri görüntüleyebilir, değiştirebilir veya silebilir; tüm kullanıcı haklarına sahip olan yeni hesaplar oluşturabilir. Hesapları, sistemde az sayıda kullanıcı hakkıyla yapılandırılmış olan kullanıcılar, yönetici haklarıyla çalışan kullanıcılardan daha az etkilenebilir.

**Güvenlik açığına ne neden olmaktadır?**
Office bir dosyanın içeriğini işlerken yeterli veri doğrulaması gerçekleştirmez. Office özel hazırlanmış bir dosyayı açıp hatalı biçimlendirilmiş bir dizeyi ayrıştırdığında, sistem belleğinin bir saldırganın rasgele kod yürütmesine olanak sağlayacak biçimde bozulmasına neden olabilir.
...
**Word'ün Microsoft Works Suites ile birlikte geldiğini sanıyordum, ancak Etkilenmeyen Yazılımlar altında Microsoft Works Suites'in de listelendiğini görüyorum. Neden?**
Microsoft Works Suites, Word'ün tam sürümünü içermediği için bu güvenlik açıklarından etkilenmez.

**Güncelleştirme ne yapıyor?**
Güncelleştirme, Office'in dosyayı ayrıştırmak ve bir dizeyi ayrılmış arabelleğe geçirmeden önce dizenin uzunluğunu doğrulamak için kullandığı yöntemi değiştirerek bu güvenlik açığını ortadan kaldırır.
...
#### Office'te Hatalı Biçimlendirilmiş Grafik Kaydı Güvenlik Açığı - CVE-2006-3650:

Office'te uzaktan kod yürütmeye neden olabilecek bir güvenlik açığı bulunmaktadır. Office hatalı biçimlendirilmiş grafik kaydı içeren bir dosyayı ayrıştırdığında saldırgan bu güvenlik açığından yararlanabilir.

Kullanıcı yönetimsel haklarla oturum açtıysa, bu güvenlik açığından başarıyla yararlanan bir saldırgan etkilenen sistemin denetimini tümüyle ele geçirebilir. Saldırgan, program yükleyebilir; verileri görüntüleyebilir, değiştirebilir veya silebilir; tüm kullanıcı haklarına sahip olan yeni hesaplar oluşturabilir. Hesapları, sistemde az sayıda kullanıcı hakkıyla yapılandırılmış olan kullanıcılar, yönetici haklarıyla çalışan kullanıcılardan daha az etkilenebilir.

#### Office'te Hatalı Biçimlendirilmiş Grafik Kaydı Güvenlik Açığı - CVE-2006-3650 için Azaltıcı Etkenler:
...
#### Office'te Hatalı Biçimlendirilmiş Grafik Kaydı Güvenlik Açığı - CVE-2006-3650 için Geçici Çözümler:

-   Güvenilmeyen kaynaklardan gelen veya güvenilen kaynaklardan beklemediğiniz halde gelen Microsoft Office dosyalarını açmayın ve kaydetmeyin. Kullanıcı özel hazırlanmış bir dosyayı açtığında bu güvenlik açığından yararlanılabilir.

#### Office'te Hatalı Biçimlendirilmiş Grafik Kaydı Güvenlik Açığı - CVE-2006-3650 Hakkında SSS:

**Bu güvenlik açığının kapsamı nedir?**
Office'te uzaktan kod yürütülmesine neden olabilecek bir güvenlik açığı bulunmaktadır. Office hatalı biçimlendirilmiş grafik kaydı içeren bir dosyayı ayrıştırdığında saldırgan bu güvenlik açığından yararlanabilir.

Kullanıcı yönetimsel haklarla oturum açtıysa, bu güvenlik açığından başarıyla yararlanan bir saldırgan etkilenen sistemin denetimini tümüyle ele geçirebilir. Saldırgan, program yükleyebilir; verileri görüntüleyebilir, değiştirebilir veya silebilir; tüm kullanıcı haklarına sahip olan yeni hesaplar oluşturabilir. Hesapları, sistemde az sayıda kullanıcı hakkıyla yapılandırılmış olan kullanıcılar, yönetici haklarıyla çalışan kullanıcılardan daha az etkilenebilir.

**Güvenlik açığına ne neden olmaktadır?**
Office bir dosyanın içeriğini işlerken yeterli veri doğrulaması gerçekleştirmez. Office özel hazırlanmış bir dosyayı açıp hatalı biçimlendirilmiş bir grafik kaydını ayrıştırdığında, sistem belleğinin bir saldırganın rasgele kod yürütmesine olanak sağlayacak biçimde bozulmasına neden olabilir.
...
**Güncelleştirme ne yapıyor?**
Güncelleştirme, Office'in bir iletiyi ayrılmış arabelleğe geçirmeden önce kaydın uzunluğunu ayrıştırmak için kullandığı yöntemi değiştirerek bu güvenlik açığını ortadan kaldırır.
...
#### Office'te Hatalı Biçimlendirilmiş Kayıt Nedeniyle Bellek Bozulması Güvenlik Açığı - CVE-2006-3864:

Office'te uzaktan kod yürütmeye neden olabilecek bir güvenlik açığı bulunmaktadır. Office hatalı biçimlendirilmiş kayıt içeren bir dosyayı ayrıştırdığında saldırgan bu güvenlik açığından yararlanabilir.

Kullanıcı yönetimsel haklarla oturum açtıysa, bu güvenlik açığından başarıyla yararlanan bir saldırgan etkilenen sistemin denetimini tümüyle ele geçirebilir. Saldırgan, program yükleyebilir; verileri görüntüleyebilir, değiştirebilir veya silebilir; tüm kullanıcı haklarına sahip olan yeni hesaplar oluşturabilir. Hesapları, sistemde az sayıda kullanıcı hakkıyla yapılandırılmış olan kullanıcılar, yönetici haklarıyla çalışan kullanıcılardan daha az etkilenebilir.

#### Office'te Hatalı Biçimlendirilmiş Kayıt Nedeniyle Bellek Bozulması Güvenlik Açığı - CVE-2006-3864 için Azaltıcı Etkenler:
...
#### Office'te Hatalı Biçimlendirilmiş Kayıt Nedeniyle Bellek Bozulması Güvenlik Açığı - CVE-2006-3864 için Geçici Çözümler:

-   Güvenilmeyen kaynaklardan gelen veya güvenilen kaynaklardan beklemediğiniz halde gelen Microsoft Office dosyalarını açmayın ve kaydetmeyin. Kullanıcı özel hazırlanmış bir dosyayı açtığında bu güvenlik açığından yararlanılabilir.

#### Office'te Hatalı Biçimlendirilmiş Kayıt Nedeniyle Bellek Bozulması Güvenlik Açığı - CVE-2006-3864 Hakkında SSS:

**Bu güvenlik açığının kapsamı nedir?**
Office'te uzaktan kod yürütülmesine neden olabilecek bir güvenlik açığı bulunmaktadır. Office hatalı biçimlendirilmiş kayıt içeren bir dosyayı ayrıştırdığında saldırgan bu güvenlik açığından yararlanabilir.
...
#### Microsoft Office'te Akıllı Etiket Ayrıştırma Güvenlik Açığı - CVE-2006-3868:

Microsoft Office'te bir uzaktan kod yürütme güvenlik açığı bulunmaktadır ve Office özel hazırlanmış bir dosyayı açıp hatalı biçimlendirilmiş bir Akıllı Etiket'i ayrıştırırsa bu güvenlik açığından yararlanılabilir. Bu şekilde özel hazırlanmış bir dosya bir e-posta ekinde bulunabilir veya kötü amaçlı bir Web sitesi tarafından barındırılabilir. Outlook'ta hatalı biçimlendirilmiş e-posta iletisini görüntülemek veya iletiye önizleme yapmak, bu açıktan yararlanılmasına olanak tanımaz. Saldırgan, uzaktan kod yürütülmesine olanak sağlayabilecek özel hazırlanmış bir Office dosyası oluşturarak güvenlik açığından yararlanabilir.

Kullanıcı yönetimsel haklarla oturum açtıysa, bu güvenlik açığından başarıyla yararlanan bir saldırgan etkilenen sistemin denetimini tümüyle ele geçirebilir. Saldırgan, program yükleyebilir; verileri görüntüleyebilir, değiştirebilir veya silebilir; tüm kullanıcı haklarına sahip olan yeni hesaplar oluşturabilir. Hesapları, sistemde az sayıda kullanıcı hakkıyla yapılandırılmış olan kullanıcılar, yönetici haklarıyla çalışan kullanıcılardan daha az etkilenebilir.

#### Microsoft Office'te Akıllı Etiket Ayrıştırma Güvenlik Açığı - CVE-2006-3868 için Azaltıcı Etkenler:

-   Bu güvenlik açığından başarıyla yararlanan bir saldırgan, yerel kullanıcı ile aynı haklara sahip olabilir. Hesapları, sistemde az sayıda kullanıcı hakkıyla yapılandırılmış olan kullanıcılar, yönetici haklarıyla çalışan kullanıcılardan daha az etkilenebilir.
-   Web tabanlı saldırı senaryosunda, saldırganın, bu açıktan yararlanma girişimi için kullanılan Office dosyasını içeren bir Web sitesini barındırması gerekir. Ayrıca, kullanıcı tarafından sağlanan içeriği kabul eden ya da barındıran güvenliği aşılmış Web sitelerinde, bu güvenlik açığından yararlanılabilecek özel hazırlanmış içerik bulunabilir. Bir saldırganın bir kullanıcıyı kötü amaçlı bir Web sitesini ziyaret etmeye zorlama yolu yoktur. Bunun yerine, saldırganın kullanıcıları kendi Web sitesine götüren bir bağlantıyı tıklatmalarını sağlayarak onları bu siteye çekmesi gerekmektedir.
-   Güvenlik açığından, e-posta yoluyla otomatik olarak yararlanılamaz. Saldırının başarılı olması için, kullanıcının e-posta iletisiyle gönderilen bir eki açması gerekir.

#### Microsoft Office'te Akıllı Etiket Ayrıştırma Güvenlik Açığı - CVE-2006-3868 için Geçici Çözümler:

-   Güvenilmeyen kaynaklardan gelen veya güvenilen kaynaklardan beklemediğiniz halde gelen Microsoft Office dosyalarını açmayın ve kaydetmeyin. Kullanıcı özel hazırlanmış bir dosyayı açtığında bu güvenlik açığından yararlanılabilir.

#### Microsoft Office'te Akıllı Etiket Ayrıştırma Güvenlik Açığı - CVE-2006-3868 Hakkında SSS:
...
**Güvenlik açığına ne neden olmaktadır?**
Microsoft Office özel hazırlanmış bir Office dosyasını açıp hatalı biçimlendirilmiş bir Akıllı Etiket'i işlediğinde, sistem belleğini bir saldırganın rasgele kod yürütmesine olanak verecek şekilde bozabilir.
...
**Güncelleştirme ne yapıyor?**
Güncelleştirme, Microsoft Office'in bir iletiyi ayrılmış arabelleğe geçirmeden önce Akıllı Etiket'in uzunluğunu ayrıştırmak için kullandığı yöntemi değiştirerek bu güvenlik açığını ortadan kaldırır.

**Bu güvenlik bülteni yayımlandığında bu güvenlik açığı genel olarak duyurulmuş muydu?**
Evet. Bu güvenlik açığı genel olarak duyurulmuştur. Ortak Güvenlik Açığı ve Etkilenme (Common Vulnerability and Exposure) numarası olarak CVE-2006-3868 atanmıştır.
...
1.  [Bu Office 2000 güvenlik güncelleştirmesini](http://download.microsoft.com/download/5/a/a/5aa36269-5b5a-4597-b91d-a0e213f656e3/office2000-kb923274-fullfile-trk.exe) ve/veya [Project 2000 Service Pack 1 güvenlik güncelleştirmesini](http://download.microsoft.com/download/0/0/f/00f68131-54bc-4e69-bfb7-fd66170cc33d/project2000-kb923274-fullfile-trk.exe) karşıdan yükleyin.
...
|-----------|------------|-------------|-------|-----------|
| Mso9.dll  | 9.0.0.8950 | 06 Eyl 2006 | 05:58 | 5.595.185 |
...
1.  [Bu Office XP güvenlik güncelleştirmesini](http://download.microsoft.com/download/08.04.2004/4842fc39-5d06-4eeb-8293-ac84074106ac/officexp-kb923273-fullfile-trk.exe) ve/veya [Project 2002 Service Pack 1 güvenlik güncelleştirmesini](http://download.microsoft.com/download/0/6/7/067865cf-7805-4933-bc3c-f9ed874e008e/officexp-kb923273-fullfile-trk.exe) ve/veya [Visio Service Pack 2 güvenlik güncelleştirmesini](http://download.microsoft.com/download/e/3/0/e30ee874-8089-4bb9-bb44-a655e5e1017f/visio2002-kb923273-fullfile-trk.exe) karşıdan yükleyin.
2.  **Bu programı diske kaydet**'i tıklatın ve **Tamam**'ı tıklatın.
3.  **Kaydet**'i tıklatın.
4.  Windows Gezgini'ni kullanarak, kaydedilen dosyayı içeren klasörü bulun ve dosyayı çift tıklatın.
5.  Güncelleştirmeyi yüklemeniz istenirse **Evet**'i tıklatın.
...
| Dosya Adı | Sürüm       | Tarih       | Saat  | Boyut     |
|-----------|-------------|-------------|-------|-----------|
| Mso.dll   | 10.0.6817.0 | 01 Eyl 2006 | 23:02 | 9.816.840 |
...
1.  [Office 2003 güvenlik güncelleştirmesini karşıdan yükleyin](http://download.microsoft.com/download/0/a/c/0ac9daa9-5d89-4613-a28e-de1e0c39c22d/office2003-kb923272-fullfile-trk.exe).
2.  **Bu programı diske kaydet**'i tıklatın ve **Tamam**'ı tıklatın.
3.  **Kaydet**'i tıklatın.
4.  Windows Gezgini'ni kullanarak, kaydedilen dosyayı içeren klasörü bulun ve dosyayı çift tıklatın.
5.  Güncelleştirmeyi yüklemeniz istenirse **Evet**'i tıklatın.
...
| Mso.dll   | 11.0.8107.0 | 08 Eyl 2006 | 02:07 | 12.256.008 |
...
-   [Fortinet Inc.](http://www.fortinet.com/) için çalışan Dejun Meng, Office'te Hatalı Bellek Erişimi Güvenlik Açığı'nı - [CVE-2006-3434](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3434) bildirdiği için
-   [TippingPoint](http://www.tippingpoint.com/) ve [Zero Day Initiative](http://www.zerodayinitiative.com/) için çalışan Arnaud Dovi, Office'te Hatalı Biçimlendirilmiş Grafik Kaydı Güvenlik Açığı'nı - [CVE-2006-3650](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3650) bildirdiği için
-   [Nevis Labs](http://www.nevisnetworks.com/) için çalışan Sowhat, Office'te Hatalı Biçimlendirilmiş Kayıt Nedeniyle Bellek Bozulması Güvenlik Açığı'nı - [CVE-2006-3864](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3864) bildirdiği için
...
-   V1.1 (11 Ekim 2006): Bülten, “Bu Güvenlik Güncelleştirmesi İle İlgili Sık Sorulan Sorular (SSS)” bölümündeki “Yönetimsel yükleme noktalarını güncelleştiriyorum ve iki .msp dosyası bulunduğunu fark ettim. Neden?” ve “Yönetimsel yükleme noktalarında mso.msp ve pvmso.msp listeleniyor. Her iki paketi de yüklemem gerekiyor mu?” sorularını açıklığa kavuşturmak amacıyla güncelleştirildi.
