---
TOCTitle: 'MS10-092'
Title: 'Microsoft Güvenlik Bülteni MS10-092 - Önemli'
ms:assetid: 'ms10-092'
ms:contentKeyID: 61235627
ms:mtpsurl: 'https://technet.microsoft.com/tr-TR/library/ms10-092(v=Security.10)'
---

Security Bulletin

Microsoft Güvenlik Bülteni MS10-092 - Önemli
============================================

Görev Zamanlayıcısı'ndaki Güvenlik Açığı Ayrıcalık Yükselmesine İzin Verebilir (2305420)
----------------------------------------------------------------------------------------

Yayım Tarihi: 14 Aralık 2010 Salı | Güncelleştirme Tarihi: 2 Mart 2011 Çarşamba
...
Güvenlik güncelleştirmesi, Görev Zamanlayıcısı'nın bütünlük denetimleri gerçekleştirerek görevlerin hedeflenen kullanıcı ayrıcalıklarıyla çalıştırıldığını doğrulama biçimini düzelterek bu güvenlik açığını giderir. Bu güvenlik açığı hakkında daha fazla bilgi için, bir sonraki bölüm olan **Güvenlik Açığı Bilgileri** altında, ilgili güvenlik açığı girdisinin Sık Sorulan Sorular (SSS) alt bölümüne bakın.
...
**Bilinen Sorunlar.** [Microsoft Bilgi Bankası makalesi 2305420](http://support.microsoft.com/?kbid=2305420), bu güvenlik güncelleştirmesini yükleyen müşterilerin karşılaşabileceği bilinen sorunları belgelemektedir. Bu makale ayrıca, bu sorunlar için önerilen çözümleri de içermektedir.
...
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------|----------------------|---------------------------------------------|
| [Windows Vista Service Pack 1 ve Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=48f10251-34d8-4149-b4b2-bf3ec28f5846)                                                            | Ayrıcalık Yükseltmesi     | Önemli               | Yok                                         |
| [Windows Vista x64 Edition Service Pack 1 ve Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=099ccc5f-b92f-4d06-bcb5-92e35c49f613)                                    | Ayrıcalık Yükseltmesi     | Önemli               | Yok                                         |
| [32-bit sistemler için Windows Server 2008 ve 32-bit sistemler için Windows Server 2008 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=bdc9564a-4091-4cde-963a-239513db6c17)\*                 | Ayrıcalık Yükseltmesi     | Önemli               | Yok                                         |
| [x64 tabanlı sistemler için Windows Server 2008 ve x64 tabanlı sistemler için Windows Server 2008 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=dff39bfe-0799-4912-ae22-392562178ae6)\*       | Ayrıcalık Yükseltmesi     | Önemli               | Yok                                         |
| [Itanium tabanlı sistemler için Windows Server 2008 ve Itanium tabanlı sistemler için Windows Server 2008 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=cf341a35-32ea-4ff7-aca9-1a4683c100ee) | Ayrıcalık Yükseltmesi     | Önemli               | Yok                                         |
| [32-bit sistemler için Windows 7](http://www.microsoft.com/downloads/details.aspx?familyid=cf85cdb6-58c7-4144-82f6-f01a6a4f9c3a)                                                                                         | Ayrıcalık Yükseltmesi     | Önemli               | Yok                                         |
| [x64 tabanlı sistemler için Windows 7](http://www.microsoft.com/downloads/details.aspx?familyid=0597018d-39f5-4ca9-b437-63d9e68f264d)                                                                                    | Ayrıcalık Yükseltmesi     | Önemli               | Yok                                         |
| [x64 tabanlı sistemler için Windows Server 2008 R2](http://www.microsoft.com/downloads/details.aspx?familyid=28c832fb-4937-4652-8799-eab6c76d05fb)\*                                                                     | Ayrıcalık Yükseltmesi     | Önemli               | Yok                                         |
| [Itanium tabanlı sistemler için Windows Server 2008 R2](http://www.microsoft.com/downloads/details.aspx?familyid=3ad64d5c-2d81-4ac8-934e-8917b2fcf961)                                                                   | Ayrıcalık Yükseltmesi     | Önemli               | Yok                                         |
...
<th style="border:1px solid black;" >Görev Zamanlayıcısı Güvenlik Açığı - CVE-2010-3338</th>
...
Görev Zamanlayıcısı Güvenlik Açığı - CVE-2010-3338  
--------------------------------------------------
  
<span></span>
Zamanlanmış görevlerin hedeflenen güvenlik bağlamında çalıştırılıp çalıştırılmadığının Windows Görev Zamanlayıcısı tarafından hatalı doğrulanması nedeniyle bir ayrıcalık yükselmesi güvenlik açığı bulunmaktadır. Bu güvenlik açığından başarıyla yararlanan bir saldırgan, yerel sistemin güvenlik bağlamında rasgele kod çalıştırabilir. Saldırgan, program yükleyebilir; verileri görüntüleyebilir, değiştirebilir veya silebilir; tüm kullanıcı haklarına sahip olan yeni hesaplar oluşturabilir.
  
Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2010-3338](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3338).
  
#### Görev Zamanlayıcısı Güvenlik Açığı CVE-2010-3338 için Azaltıcı Etkenler
...
#### Görev Zamanlayıcısı Güvenlik Açığı - CVE-2010-3338 için Geçici Çözümler
  
Geçici çözüm, arka plandaki güvenlik açığını gidermeyen ama güvenlik açığı uygulanmadan önceki bilinen saldırı vektörlerinin engellenmesine yardımcı olan bir ayar veya yapılandırma değişikliği anlamına gelir. Microsoft aşağıdaki geçici çözümleri sınamıştır ve bir geçici çözümün işlevselliği azaltıp azaltmadığı ilgili açıklamada belirtilmektedir:
  
-   **Görev Zamanlayıcısı hizmetini kapatın**
    ...
    **Not** Kayıt Defteri Düzenleyicisi'nin yanlış kullanılması, işletim sisteminizi yeniden yüklemenizi gerektirebilecek ciddi sorunlara neden olabilir. Microsoft, Kayıt Defteri Düzenleyicisi'nin yanlış kullanılmasından kaynaklanan sorunların çözülebileceğini garanti etmemektedir. Kayıt Defteri Düzenleyicisi'ni kullanmak kendi sorumluluğunuzdadır. Kayıt defterini düzenlemeyle ilgili bilgi için, Kayıt Defteri Düzenleyicisi'ndeki (Regedit.exe) "Anahtarları ve Değerleri Değiştirmek" veya Regedt32.exe'deki "Kayıt Defterine Bilgi Eklemek veya Bilgileri Silmek " ve "Kayıt Defteri Verilerini Düzenleme" adlı Yardım konularına bakın.
    ...
    3.  **Start** anahtarını çift tıklatın, **2** olan değerini **4** olarak değiştirin ve sonra **Tamam**'ı tıklatın.  
    4.  Kayıt Defteri Düzenleyicisi'nden çıkın ve bilgisayarı yeniden başlatın.
  
    **Geçici çözümün etkisi.** Kullanıcı, bilgisayarda zamanlanmış görevler çalıştıramaz.
    ...
    **Geçici çözüm nasıl geri alınır.**
    ...
    2.  Aşağıdaki kayıt defteri anahtarını bulun ve seçin:  
        HKEY\_LOCAL\_MACHINE\\SYSTEM\\CurrentControlSet\\services\\Schedule  
    3.  **Start** anahtarını çift tıklatın, **4** olan değerini **2** olarak değiştirin ve sonra **Tamam**'ı tıklatın.  
    4.  Kayıt Defteri Düzenleyicisi'nden çıkın ve bilgisayarı yeniden başlatın.
  
#### Görev Zamanlayıcısı Güvenlik Açığı - CVE-2010-3338 Hakkında SSS
...
Güvenlik açığı, zamanlanmış görevlerin hedeflenen güvenlik bağlamında çalıştırılıp çalıştırılmadığının Windows Görev Zamanlayıcısı tarafından hatalı doğrulanması nedeniyle ortaya çıkar ve yerel bir saldırganın Sistem veya Yönetici hesapları bağlamında çalışacak biçimde bir görev zamanlamasına izin verebilir.
  
**Windows Görev Zamanlayıcısı nedir?**    
Görev Zamanlayıcısı, seçilen bir bilgisayarda günlük görevlerin otomasyonuna olanak veren bir Windows hizmetidir. Görev Zamanlayıcısı bunu, kullanıcının görevleri başlatmak için seçtiği ölçütleri (tetikleyiciler olarak bilinir) izleyip, bu ölçütler karşılandığında görevleri yürüterek gerçekleştirir. Daha fazla bilgi için, MSDN Kitaplığı'ndaki [Görev Zamanlayıcısı](http://msdn.microsoft.com/en-us/library/aa383614(vs.85).aspx) adlı girdiye bakın.
...
Güncelleştirme, Görev Zamanlayıcısı'nın bütünlük denetimleri gerçekleştirerek görevlerin hedeflenen kullanıcı ayrıcalıklarıyla çalıştırıldığını doğrulama biçimini düzelterek bu güvenlik açığını giderir.
  
**Bu güvenlik bülteni yayımlandığında bu güvenlik açığı genel olarak duyurulmuş muydu?**    
Evet. Bu güvenlik açığı genel olarak duyurulmuştur. Ortak Güvenlik Açığı ve Etkilenme (Common Vulnerability and Exposure) numarası olarak [CVE-2010-3338](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3338) atanmıştır.
...
Evet. Bu güvenlik güncelleştirmesi, kanıtı yayımlanmış kod örneği kullanılarak yararlanılabilecek güvenlik açığını giderir. Güvenlik açığı giderilmiş, ayrıca [CVE-2010-3338](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3338) Ortak Güvenlik Açığı ve Etkilenme numarası atanmıştır.
...
<td style="border:1px solid black;">Bkz: <a href="http://support.microsoft.com/kb/2305420">Microsoft Bilgi Bankası makalesi 2305420</a></td>
</tr>
<tr class="odd">
...
-   [Kaspersky Lab](http://usa.kaspersky.com/) için çalışan Sergey Golovanov, Alexander Gostev, Maxim Golovkin ve Alexey Monastyrsky ile [Design and Test Lab](http://www.dnt-lab.com/) için çalışan Vitaly Kiktenko ve Alexander Saprykin, Görev Zamanlayıcısı Güvenlik Açığı'nı (CVE-2010-3338) bildirdikleri için  
-   [Symantec](http://www.symantec.com/index.jsp) için çalışan Liam O Murchu, Görev Zamanlayıcısı Güvenlik Açığı'nı (CVE-2010-3338) bildirdiği için  
-   [ESET](http://www.eset.com/) için çalışan Alexandr Matrosov, Eugene Rodionov, Juraj Malcho ve David Harley, Görev Zamanlayıcısı Güvenlik Açığı'nı (CVE-2010-3338) bildirdiği için
...
-   V1.1 (2 Mart 2011): Yürütmeyle İlgili Özet altındaki Bilinen Sorunlar bölümüne Microsoft Bilgi Bankası makalesi 2305420 için bir bağlantı eklendi.
