---
TOCTitle: 'MS10-028'
Title: 'Microsoft Güvenlik Bülteni MS10-028 - Önemli'
ms:assetid: 'ms10-028'
ms:contentKeyID: 61235563
ms:mtpsurl: 'https://technet.microsoft.com/tr-TR/library/ms10-028(v=Security.10)'
---

Security Bulletin

Microsoft Güvenlik Bülteni MS10-028 - Önemli
============================================

Microsoft Visio'daki Güvenlik Açıkları Uzaktan Kod Yürütülmesine İzin Verebilir (980094)
----------------------------------------------------------------------------------------
...
Bu güvenlik güncelleştirmesi Microsoft Office Visio 2002 Service Pack 2, Microsoft Office Visio 2003 Service Pack 3, Microsoft Office Visio 2007 Service Pack 1 ve Microsoft Office Visio 2007 Service Pack 2 için Önemli olarak derecelendirilmiştir. Daha fazla bilgi için, bu bölümdeki **Etkilenen ve Etkilenmeyen Yazılımlar** alt bölümüne bakın.

Güvenlik güncelleştirmesi, Microsoft Office Visio'nun özel hazırlanmış Visio dosyalarını açarken öznitelikleri doğrulama ve dizinleri hesaplama biçimini düzelterek bu güvenlik açıklarını giderir. Bu güvenlik açığı hakkında daha fazla bilgi için, bir sonraki bölüm olan **Güvenlik Açığı Bilgileri** altında, ilgili güvenlik açığı girdisinin Sık Sorulan Sorular (SSS) alt bölümüne bakın.
...
Microsoft Office Visio 2002 ve sonraki sürümlerinde, kullanıcılar bir belgeyi açmadan önce Aç, Kaydet veya İptal istemleri görüntülenen yerleşik bir özellik bulunmaktadır. Bu azaltıcı etken, güvenlik açığından yararlanılabilmesi için tek bir kullanıcı eyleminden fazlasını gerektirdiğinden uzaktan kod yürütme güvenlik açığının Kritik olarak belirlenen derecelendirmesini Önemli düzeyine indirir.
  
**Microsoft Office Viewer hakkında daha fazla bilgiyi nereden bulabilirim?**    
Microsoft Office Viewer'ın geçerli ve eski sürümleri hakkında bilgi için, bkz: [Microsoft Bilgi Bankası makalesi 979860](http://support.microsoft.com/?id=979860).
...
<th style="border:1px solid black;" >Visio'da Öznitelik Doğrulaması Sırasında Bellek Bozulması Güvenlik Açığı - CVE-2010-0254</th>
<th style="border:1px solid black;" >Visio'da Dizin Hesaplama Sırasında Bellek Bozulması Güvenlik Açığı - CVE-2010-0256</th>
<th style="border:1px solid black;" >Toplam Önem Derecesi</th>
</tr>
</thead>
<tbody>
...
<tr class="odd">
<td style="border:1px solid black;">Microsoft Office Visio 2007 Service Pack 1 ve Microsoft Office Visio 2007 Service Pack 2</td>
<td style="border:1px solid black;"><strong>Önemli</strong> <br />
Uzaktan Kod Yürütme</td>
<td style="border:1px solid black;"><strong>Önemli</strong> <br />
Uzaktan Kod Yürütme</td>
...
Visio'da Öznitelik Doğrulaması Sırasında Bellek Bozulması Güvenlik Açığı - CVE-2010-0254  
----------------------------------------------------------------------------------------
  
<span></span>
Microsoft Office Visio'nun özel hazırlanmış Visio dosyalarını işlerken öznitelikleri doğrulama biçiminde bir uzaktan kod yürütme güvenlik açığı bulunmaktadır.
...
Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2010-0254](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0254).
  
#### Visio'da Öznitelik Doğrulaması Sırasında Bellek Bozulması Güvenlik Açığı - CVE-2010-0254 için Azaltıcı Etkenler
  
Azaltıcı etken, varolan bir durumda bulunan ve güvenlik açığından yararlanılmasının önem derecesini azaltabilecek bir ayar, genel yapılandırma ya da en iyi uygulama anlamına gelir. Sizin durumunuzda aşağıdaki azaltıcı etkenler işinize yarayabilir:
  
-   Microsoft Office Visio 2002 ve sonraki Visio sürümlerini kullananlara bir belgeyi açmadan önce Aç, Kaydet veya İptal istemleri görüntülenir. Bu azaltıcı bir etkendir, çünkü güvenlik açığından yararlanılabilmesi için tek bir kullanıcı eyleminden fazlası gerekir.  
...
#### Visio'da Öznitelik Doğrulaması Sırasında Bellek Bozulması Güvenlik Açığı - CVE-2010-0254 için Geçici Çözümler
  
Geçici çözüm, arka plandaki güvenlik açığını gidermeyen ama güvenlik açığı uygulanmadan önceki bilinen saldırı vektörlerinin engellenmesine yardımcı olan bir ayar veya yapılandırma değişikliği anlamına gelir. Microsoft aşağıdaki geçici çözümleri sınamıştır ve bir geçici çözümün işlevselliği azaltıp azaltmadığı ilgili açıklamada belirtilmektedir:
  
-   Güvenilmeyen kaynaklardan gelen veya güvenilen kaynaklardan beklemediğiniz halde gelen Visio dosyalarını açmayın. Kullanıcı özel hazırlanmış bir dosyayı açtığında bu güvenlik açığından yararlanılabilir. .vsd dosya uzantısı genellikle Visio dosyalarıyla ilişkilendirilir.
  
#### Visio'da Öznitelik Doğrulaması Sırasında Bellek Bozulması Güvenlik Açığı - CVE-2010-0254 Hakkında SSS
...
Güvenlik açığı, Microsoft Office Visio'nun özel hazırlanmış Visio dosyalarını açarken belleği işleme biçimi nedeniyle ortaya çıkar.
...
Güncelleştirme, Microsoft Office Visio'nun özel hazırlanmış Visio dosyalarını açarken öznitelikleri doğrulama biçimini düzelterek bu güvenlik açığını giderir.
...
Visio'da Dizin Hesaplama Sırasında Bellek Bozulması Güvenlik Açığı - CVE-2010-0256  
----------------------------------------------------------------------------------
  
<span></span>
Microsoft Office Visio'nun özel hazırlanmış Visio dosyalarını işlerken dizinleri hesaplama biçiminde bir uzaktan kod yürütme güvenlik açığı bulunmaktadır.
  
Bu açığı başarıyla kullanan bir saldırgan, etkilenen sistemin tüm denetimini ele geçirebilir. Saldırgan, program yükleyebilir; verileri görüntüleyebilir, değiştirebilir veya silebilir; tüm kullanıcı haklarına sahip olan yeni hesaplar oluşturabilir. Hesapları, sistemde az sayıda kullanıcı hakkıyla yapılandırılmış olan kullanıcılar, yönetici haklarıyla çalışan kullanıcılardan daha az etkilenebilir.
  
Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2010-0256](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0256).
  
#### Visio'da Dizin Hesaplama Sırasında Bellek Bozulması Güvenlik Açığı - CVE-2010-0256 için Azaltıcı Etkenler
  
Azaltıcı etken, varolan bir durumda bulunan ve güvenlik açığından yararlanılmasının önem derecesini azaltabilecek bir ayar, genel yapılandırma ya da en iyi uygulama anlamına gelir. Sizin durumunuzda aşağıdaki azaltıcı etkenler işinize yarayabilir:
  
-   Microsoft Office Visio 2002 ve sonraki Visio sürümlerini kullananlara bir belgeyi açmadan önce Aç, Kaydet veya İptal istemleri görüntülenir. Bu azaltıcı bir etkendir, çünkü güvenlik açığından yararlanılabilmesi için tek bir kullanıcı eyleminden fazlası gerekir.  
-   Güvenlik açığından, e-posta yoluyla otomatik olarak yararlanılamaz. Saldırının başarılı olması için, kullanıcının e-posta iletisiyle gönderilen bir eki açması gerekir. Saldırganın bu güvenlik açığından yararlanabilmesi için, kullanıcıyı bu eki açmaya ikna etmesi gerekir.  
-   Web tabanlı saldırı senaryosunda, saldırganın, bu açıktan yararlanma girişimi için kullanılan özel hazırlanmış Visio dosyasını içeren bir Web sitesini barındırması gerekir. Ayrıca, kullanıcı tarafından sağlanan içeriği kabul eden ya da barındıran güvenliği aşılmış Web sitelerinde, bu güvenlik açığından yararlanılabilecek özel hazırlanmış içerik bulunabilir. Saldırganın, bir kullanıcıyı özel hazırlanmış bir Web sitesini ziyaret etmeye zorlama yolu yoktur. Bunun yerine, saldırganın kullanıcıları kendi sitesine götüren bir bağlantıyı tıklatarak onları bu siteyi ziyaret etmeye ve daha sonra özel hazırlanmış bir Visio dosyasını açmaya ikna etmesi gerekir.  
-   Bu güvenlik açığından başarıyla yararlanan bir saldırgan, yerel kullanıcı ile aynı haklara sahip olabilir. Hesapları, sistemde az sayıda kullanıcı hakkıyla yapılandırılmış olan kullanıcılar, yönetici haklarıyla çalışan kullanıcılardan daha az etkilenebilir.
  
#### Visio'da Dizin Hesaplama Sırasında Bellek Bozulması Güvenlik Açığı - CVE-2010-0256 için Geçici Çözümler
...
#### Visio'da Dizin Hesaplama Sırasında Bellek Bozulması Güvenlik Açığı - CVE-2010-0256 Hakkında SSS
...
**Güncelleştirme ne yapıyor?**    
Güncelleştirme, Microsoft Office Visio'nun özel hazırlanmış Visio dosyalarını açarken dizinleri hesaplama biçimini düzelterek bu güvenlik açığını giderir.
...
| Microsoft Office Visio 2007 Service Pack 2 | Evet       |
...
| Microsoft Office Visio 2003 Service Pack 3 | Hayır   | Hayır                      | Evet                       | Evet                       |  
| Microsoft Office Visio 2007 Service Pack 1 | Hayır   | Hayır                      | Evet                       | Evet                       |  
| Microsoft Office Visio 2007 Service Pack 2 | Hayır   | Hayır                      | Evet                       | Evet                       |
...
<td style="border:1px solid black;">visio2002-kb979364-fullfile-trk /q:a</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">visio2002-kb979364-fullfile-trk /r:n</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">Bkz: <a href="http://support.microsoft.com/kb/979364/tr">Microsoft Bilgi Bankası makalesi 979364</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;">Kullanıcı araya girmeden yükleme</td>
<td style="border:1px solid black;">visio2003-kb979356-fullfile-trk /q:a</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">visio2003-kb979356-fullfile-trk /r:n</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Güncelleştirme günlük dosyası</td>
<td style="border:1px solid black;">Uygulanamaz</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Dosya Bilgileri</strong></td>
<td style="border:1px solid black;">Bkz: <a href="http://support.microsoft.com/kb/979356/tr">Microsoft Bilgi Bankası makalesi 979356</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Kayıt Defteri Anahtarı Doğrulaması</strong></td>
<td style="border:1px solid black;">Uygulanamaz</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Dosya Bilgileri</strong></td>
<td style="border:1px solid black;">Bkz: <a href="http://support.microsoft.com/kb/979365/tr">Microsoft Bilgi Bankası makalesi 979365</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Kayıt Defteri Anahtarı Doğrulaması</strong></td>
<td style="border:1px solid black;">Uygulanamaz</td>
...
-   [Fortinet bünyesindeki FortiGuard Labs](http://www.fortiguard.com/) için çalışan Bing Liu, Visio'da Öznitelik Doğrulaması Sırasında Bellek Bozulması Güvenlik Açığı'nı (CVE-2010-0254) bildirdiği için  
-   [Fortinet bünyesindeki FortiGuard Labs](http://www.fortiguard.com/) için çalışan Bing Liu, Visio'da Dizin Hesaplama Sırasında Bellek Bozulması Güvenlik Açığı'nı (CVE-2010-0256) bildirdiği için
