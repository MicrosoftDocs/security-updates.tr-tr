...
<th style="border:1px solid black;" >
Word'de Ayrıştırma Güvenlik Açığı - CVE-2010-3220  
</th>
<th style="border:1px solid black;" >
...
Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2010-2747](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2747).
...
#### Word'de Sınır Denetimi Güvenlik Açığı - CVE-2010-2748 için Geçici Çözümler
...
Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2010-3215](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3215).
...
#### Word'de Yer İşaretleri Güvenlik Açığı - CVE-2010-3216 için Geçici Çözümler
...
Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2010-3218](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3218).

#### Word'de Öbek Taşması Güvenlik Açığı - CVE-2010-3218 için Azaltıcı Etkenler
...
#### Word'de Öbek Taşması Güvenlik Açığı - CVE-2010-3218 için Geçici Çözümler
...
#### Word'de Öbek Taşması Güvenlik Açığı - CVE-2010-3218 Hakkında SSS
...
<span></span>
Microsoft Word'ün özel hazırlanmış bir Word dosyasını ayrıştırırken dizinleri işleme biçiminde bir uzaktan kod yürütme güvenlik açığı bulunmaktadır. Bu açığı başarıyla kullanan bir saldırgan, etkilenen sistemin tüm denetimini ele geçirebilir. Saldırgan, program yükleyebilir; verileri görüntüleyebilir, değiştirebilir veya silebilir; tüm kullanıcı haklarına sahip olan yeni hesaplar oluşturabilir. Hesapları, sistemde az sayıda kullanıcı hakkıyla yapılandırılmış olan kullanıcılar, yönetici haklarıyla çalışan kullanıcılardan daha az etkilenebilir.

Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2010-3219](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3219).

#### Word'de Dizin Ayrıştırma Güvenlik Açığı - CVE-2010-3219 için Azaltıcı Etkenler
...
#### Word'de Dizin Ayrıştırma Güvenlik Açığı - CVE-2010-3219 için Geçici Çözümler
...
#### Word'de Dizin Ayrıştırma Güvenlik Açığı - CVE-2010-3219 Hakkında SSS
...
<span></span>
Microsoft Word'ün özel hazırlanmış bir Word dosyasını ayrıştırma biçiminde bir uzaktan kod yürütme güvenlik açığı bulunmaktadır. Bu açığı başarıyla kullanan bir saldırgan, etkilenen sistemin tüm denetimini ele geçirebilir. Saldırgan, program yükleyebilir; verileri görüntüleyebilir, değiştirebilir veya silebilir; tüm kullanıcı haklarına sahip olan yeni hesaplar oluşturabilir. Hesapları, sistemde az sayıda kullanıcı hakkıyla yapılandırılmış olan kullanıcılar, yönetici haklarıyla çalışan kullanıcılardan daha az etkilenebilir.

Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2010-3220](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3220).

#### Word'de Ayrıştırma Güvenlik Açığı - CVE-2010-3220 için Azaltıcı Etkenler
...
#### Word'de Ayrıştırma Güvenlik Açığı - CVE-2010-3220 için Geçici Çözümler
...
#### Word'de Ayrıştırma Güvenlik Açığı - CVE-2010-3220 Hakkında SSS
...
<span></span>
Microsoft Word'ün özel hazırlanmış bir Word dosyasını ayrıştırırken hatalı biçimlendirilmiş bir kaydı işleme biçiminde bir uzaktan kod yürütme güvenlik açığı bulunmaktadır. Bu açığı başarıyla kullanan bir saldırgan, etkilenen sistemin tüm denetimini ele geçirebilir. Saldırgan, program yükleyebilir; verileri görüntüleyebilir, değiştirebilir veya silebilir; tüm kullanıcı haklarına sahip olan yeni hesaplar oluşturabilir. Hesapları, sistemde az sayıda kullanıcı hakkıyla yapılandırılmış olan kullanıcılar, yönetici haklarıyla çalışan kullanıcılardan daha az etkilenebilir.

Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2010-3221](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3221).

#### Word'de Ayrıştırma Güvenlik Açığı - CVE-2010-3221 için Azaltıcı Etkenler
...
#### Word'de Ayrıştırma Güvenlik Açığı - CVE-2010-3221 için Geçici Çözümler
...
#### Word'de Ayrıştırma Güvenlik Açığı - CVE-2010-3221 Hakkında SSS
...
| Microsoft Word Viewer                                                                                | Hayır   | Hayır                      | Evet                       | Evet                       |
...
| Microsoft Word Web Apps                                                                              | Hayır   | Hayır                      | Evet                       | Evet                       |
...
<td style="border:1px solid black;">officexp-KB2328360-FullFile-TRK.exe /q:a</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">officexp-KB2328360-FullFile-TRK.exe /r:n</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">Bkz: <a href="http://support.microsoft.com/kb/2328360">Microsoft Bilgi Bankası makalesi 2328360</a></td>
</tr>
<tr class="even">
...
#### Word 2003 (tüm sürümler) ve Word Viewer (tüm sürümler)
...
Office2003-kb2344911-fullfile-trk.exe /q:a</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Word Viewer:<br />
Office-kb2345009-fullfile-trk.exe /q:a</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">Word 2003:<br />
Office2003-kb2344911-fullfile-trk.exe /r:n</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Word Viewer:<br />
Office-kb2345009-fullfile-trk.exe /r:n</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Güncelleştirme günlük dosyası</td>
<td style="border:1px solid black;">Uygulanamaz</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Dosya Bilgileri</strong></td>
<td style="border:1px solid black;">Bkz: <a href="http://support.microsoft.com/kb/2344911">Microsoft Bilgi Bankası makalesi 2344911</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Kayıt Defteri Anahtarı Doğrulaması</strong></td>
<td style="border:1px solid black;">Uygulanamaz</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Dosya Bilgileri</strong></td>
<td style="border:1px solid black;">Word 2007 için, bkz. <a href="http://support.microsoft.com/kb/2344993">Microsoft Bilgi Bankası makalesi 2344993</a><br />
<br />
Word, Excel ve PowerPoint 2007 Dosya Biçimleri için Microsoft Office Uyumluluk Paketi için, bkz. <a href="http://support.microsoft.com/kb/2345043">Microsoft Bilgi Bankası makalesi 2345043</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Kayıt Defteri Anahtarı Doğrulaması</strong></td>
<td style="border:1px solid black;">Uygulanamaz</td>
...
#### Word 2010 (tüm sürümler), Office Web Apps ve Word Web App
...
<tr class="odd">
<td style="border:1px solid black;">Kullanıcı araya girmeden yükleme</td>
<td style="border:1px solid black;">Microsoft Word 2010 (32-bit sürümler):<br />
Word2010-kb2345000-fullfile-x86-glb.exe /passive</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Word 2010 (64-bit sürümler):<br />
...
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Office Web Apps için:<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>Dosya Bilgileri</strong></td>
<td style="border:1px solid black;">Microsoft Office 2010 için, bkz. <a href="http://support.microsoft.com/kb/2345000">Microsoft Bilgi Bankası makalesi 2345000</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Word Web App için, bkz. <a href="http://support.microsoft.com/kb/2345015">Microsoft Bilgi Bankası makalesi 2345015</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Office Web Apps için, bkz. <a href="http://support.microsoft.com/kb/2346411">Microsoft Bilgi Bankası makalesi 2346411</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Kayıt Defteri Anahtarı Doğrulaması</strong></td>
<td style="border:1px solid black;">Uygulanamaz</td>
...
-   [VUPEN Vulnerability Research Team](http://www.vupen.com/) için çalışan Chaouki Bekrar, Word'de Başlatılmamış İşaretçi Güvenlik Açığı'nı (CVE-2010-2747) bildirdiği için  
-   [VUPEN Vulnerability Research Team](http://www.vupen.com/) için çalışan Chaouki Bekrar, Word'de Sınır Denetimi Güvenlik Açığı'nı (CVE-2010-2748) bildirdiği için  
-   [VUPEN Vulnerability Research Team](http://www.vupen.com/) için çalışan Chaouki Bekrar, Word'de Dizin Güvenlik Açığı'nı (CVE-2010-2750) bildirdiği için  
-   [VUPEN Vulnerability Research Team](http://www.vupen.com/) için çalışan Nicolas Joly, Word'de Yığın Taşması Güvenlik Açığı'nı (CVE-2010-3214) bildirdiği için  
-   [VUPEN Vulnerability Research Team](http://www.vupen.com/) için çalışan Chaouki Bekrar, Word'de Döndürülen Değer Güvenlik Açığı'nı (CVE-2010-3215) bildirdiği için  
-   [VUPEN Vulnerability Research Team](http://www.vupen.com/) için çalışan Chaouki Bekrar, Word'de Yer İşaretleri Güvenlik Açığı'nı (CVE-2010-3216) bildirdiği için  
-   [VUPEN Vulnerability Research Team](http://www.vupen.com/) için çalışan Chaouki Bekrar, Word'de İşaretçi Güvenlik Açığı'nı (CVE-2010-3217) bildirdiği için  
-   [VUPEN Vulnerability Research Team](http://www.vupen.com/) için çalışan Chaouki Bekrar, Word'de Öbek Taşması Güvenlik Açığı'nı (CVE-2010-3218) bildirdiği için  
-   [VUPEN Vulnerability Research Team](http://www.vupen.com/) için çalışan Chaouki Bekrar, Word'de Dizin Ayrıştırma Güvenlik Açığı'nı (CVE-2010-3219) bildirdiği için  
-   [VUPEN Vulnerability Research Team](http://www.vupen.com/) için çalışan Chaouki Bekrar, Word'de Ayrıştırma Güvenlik Açığı'nı (CVE-2010-3220) bildirdiği için  
-   [VUPEN Vulnerability Research Team](http://www.vupen.com/) için çalışan Chaouki Bekrar, Word'de Ayrıştırma Güvenlik Açığı'nı (CVE-2010-3221) bildirdiği için
...
-   V1.1 (13 Ekim 2010): Microsoft Office Uyumluluk Paketi (KB2345043) güncelleştirmesinin paket adı düzeltildi. Bu yalnızca bilgilendirme amaçlı bir değişikliktir. Sistemlerini daha önce başarıyla güncelleştirmiş olan müşterilerin herhangi bir işlem gerçekleştirmeleri gerekmez.  
-   V1.2 (3 Kasım 2010): Microsoft Word Viewer güncelleştirmesi (KB2345009) için bülten değişikliği bilgileri düzeltildi. Bu yalnızca bilgilendirme amaçlı bir değişikliktir. Algılama mantığında veya güncelleştirme dosyalarında herhangi bir değişiklik yapılmamıştır.
