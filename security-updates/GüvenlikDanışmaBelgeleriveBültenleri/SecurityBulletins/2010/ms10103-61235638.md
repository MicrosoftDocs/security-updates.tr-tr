---
TOCTitle: 'MS10-103'
Title: 'Microsoft Güvenlik Bülteni MS10-103 - Önemli'
ms:assetid: 'ms10-103'
ms:contentKeyID: 61235638
ms:mtpsurl: 'https://technet.microsoft.com/tr-TR/library/ms10-103(v=Security.10)'
---

Security Bulletin

Microsoft Güvenlik Bülteni MS10-103 - Önemli
============================================

Microsoft Publisher'daki Güvenlik Açıkları Uzaktan Kod Yürütülmesine İzin Verebilir (2292970)
---------------------------------------------------------------------------------------------
...
Bu güvenlik güncelleştirmesi Microsoft Publisher 2002, Microsoft Publisher 2003, Microsoft Publisher 2007 ve Microsoft Publisher 2010'un desteklenen sürümleri için Önemli olarak derecelendirilmiştir. Daha fazla bilgi için, bu bölümdeki **Etkilenen ve Etkilenmeyen Yazılımlar** alt bölümüne bakın.

Güncelleştirme, Microsoft Publisher'ın özel hazırlanmış Publisher dosyalarını ayrıştırma biçimini düzelterek bu güvenlik açıklarını giderir. Bu güvenlik açığı hakkında daha fazla bilgi için, bir sonraki bölüm olan **Güvenlik Açığı Bilgileri** altında, ilgili güvenlik açığı girdisinin Sık Sorulan Sorular (SSS) alt bölümüne bakın.

**Öneri.** Microsoft, müşterilerin güncelleştirmeyi ilk fırsatta uygulamalarını önerir.

**Bilinen Sorunlar.** [Microsoft Bilgi Bankası makalesi 2292970](http://support.microsoft.com/kb/2292970), bu güvenlik güncelleştirmesini yükleyen müşterilerin karşılaşabileceği bilinen sorunları belgelemektedir. Bu makale ayrıca, bu sorunlar için önerilen çözümleri de içermektedir. Bilinen sorunlar ve önerilen çözümler bu yazılımın yalnızca belirli sürümlerine yöneliktir, ancak bu makalede başka makalelere bağlantılar da sağlanır.
...
<tr class="even">
<td style="border:1px solid black;">Microsoft Office 2010 (32-bit sürümler)</td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=99e18990-75e9-497e-9b4f-5d7ef8656ab2">Microsoft Publisher 2010 (32-bit sürümler)</a><br />
(KB2409055)</td>
<td style="border:1px solid black;">Uzaktan Kod Yürütme</td>
<td style="border:1px solid black;">Önemli</td>
...
<tr class="odd">
<td style="border:1px solid black;">Microsoft Office 2010 (64-bit sürümler)</td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=9b27ee11-e563-4152-9691-25eec1ee9966">Microsoft Publisher 2010 (64-bit sürümler)</a><br />
(KB2409055)</td>
<td style="border:1px solid black;">Uzaktan Kod Yürütme</td>
<td style="border:1px solid black;">Önemli</td>
<td style="border:1px solid black;">Yok</td>
...
<th style="border:1px solid black;" >pubconv.dll Dosyasındaki Boyut Değerinde Öbek Bozulması Güvenlik Açığı - CVE-2010-2569</th>
<th style="border:1px solid black;" >pubconv.dll Dosyasında Öbek Taşması Güvenlik Açığı - CVE-2010-2570</th>
<th style="border:1px solid black;" >Pubconv.dll Dosyasında Dize Dizininin Geçersiz Olması Nedeniyle Bellek Bozulması Güvenlik Açığı - CVE-2010-2571</th>
<th style="border:1px solid black;" >Microsoft Publisher'da Bellek Bozulması Güvenlik Açığı - CVE-2010-3954</th>
<th style="border:1px solid black;" >Dize Dizininde Bellek Bozulması Güvenlik Açığı - CVE-2010-3955</th>
<th style="border:1px solid black;" >Toplam Önem Derecesi</th>
</tr>
</thead>
<tbody>
...
<tr class="even">
<td style="border:1px solid black;">Microsoft Publisher 2010 (32-bit sürümler)</td>
<td style="border:1px solid black;">Uygulanamaz</td>
<td style="border:1px solid black;"><strong>Önemli</strong> <br />
Uzaktan Kod Yürütme</td>
<td style="border:1px solid black;">Uygulanamaz</td>
...
<tr class="odd">
<td style="border:1px solid black;">Microsoft Publisher 2010 (64-bit sürümler)</td>
<td style="border:1px solid black;">Uygulanamaz</td>
<td style="border:1px solid black;"><strong>Önemli</strong> <br />
Uzaktan Kod Yürütme</td>
<td style="border:1px solid black;">Uygulanamaz</td>
...
pubconv.dll Dosyasındaki Boyut Değerinde Öbek Bozulması Güvenlik Açığı - CVE-2010-2569  
--------------------------------------------------------------------------------------
...
Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2010-2569](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2569).
  
#### pubconv.dll Dosyasındaki Boyut Değerinde Öbek Bozulması Güvenlik Açığı - CVE-2010-2569 için Azaltıcı Etkenler
...
#### pubconv.dll Dosyasındaki Boyut Değerinde Öbek Bozulması Güvenlik Açığı - CVE-2010-2569 için Geçici Çözümler
...
-   **Publisher Dönüştürücüsü DLL dosyasını devre dışı bırakın**
    ...
    **Windows XP ve Windows Server 2003'ün 32-bit sürümleri:**
    ...
    `cacls "c:\program files\Microsoft Office\<office sürümü>\pubconv.dll" /E /P everyone:N`
  
    **Not** &lt;office sürümü&gt; yerine, sisteminizdeki uygun Microsoft Office bileşeninin sürümünü girin; örneğin Microsoft Publisher 2002 için "Office10", Microsoft Publisher 2003 için "Office11" ve Microsoft Publisher 2007 için "Office12". Sürümü doğrulamak için, bu Microsoft Office bileşenini açın ve **Yardım**'ı tıklatın.
  
    **Windows XP ve Windows Server 2003'ün 64-bit sürümleri:**
  
    `cacls "%ProgramFiles(86)%\Microsoft Office\<office sürümü>\pubconv.dll" /E /P everyone:N`
  
    **Not** &lt;office sürümü&gt; yerine, sisteminizdeki uygun Microsoft Office bileşeninin sürümünü girin; örneğin Microsoft Publisher 2002 için "Office10", Microsoft Publisher 2003 için "Office11" ve Microsoft Publisher 2007 için "Office12". Sürümü doğrulamak için, bu Microsoft Office bileşenini açın ve **Yardım**'ı tıklatın.
  
    **Windows** **Vista, Windows Server 2008 ve Windows 7'nin 32-bit sürümleri:**
  
    `takeown /f "c:\program files\Microsoft Office\<office sürümü>\pubconv.dll"icacls "c:\program files\Microsoft Office\<office sürümü>\pubconv.dll" /save %TEMP%\PUBCONV_ACL.TXTicacls "c:\program files\Microsoft Office\<office sürümü>\pubconv.dll" /deny everyone(F)`
  
    **Not** &lt;office sürümü&gt; yerine, sisteminizdeki uygun Microsoft Office bileşeninin sürümünü girin; örneğin Microsoft Publisher 2002 için "Office10", Microsoft Publisher 2003 için "Office11" ve Microsoft Publisher 2007 için "Office12". Sürümü doğrulamak için, bu Microsoft Office bileşenini açın ve **Yardım**'ı tıklatın.
  
    **Windows** **Vista, Windows Server 2008, Windows 7 ve Windows Server 2008 R2'nin 64-bit sürümleri:**
  
    `takeown /f "%ProgramFiles(86)%\Microsoft Office\<office sürümü>\pubconv.dll"icacls "%ProgramFiles(86)%\Microsoft Office\<office sürümü>\pubconv.dll" /save %TEMP%\PUBCONV_ACL.TXTicacls "%ProgramFiles(86)%\Microsoft Office\<office sürümü>\pubconv.dll" /deny everyone (F)`
  
    **Not** &lt;office sürümü&gt; yerine, sisteminizdeki uygun Microsoft Office bileşeninin sürümünü girin; örneğin Microsoft Publisher 2002 için "Office10", Microsoft Publisher 2003 için "Office11" ve Microsoft Publisher 2007 için "Office12". Sürümü doğrulamak için, bu Microsoft Office bileşenini açın ve **Yardım**'ı tıklatın.
  
    **Geçici çözümün etkisi.** Publisher Dönüştürücüsü adlı DLL dosyasını devre dışı bırakan kullanıcılar Microsoft Publisher 2007'den önceki sürümlerde oluşturulan Publisher dosyalarını açamaz.
    ...
    **Geçici çözüm nasıl geri alınır:**
    ...
    `cacls "c:\program files\Microsoft Office\<office sürümü>\pubconv.dll" /E /R everyone`
  
    **Not** &lt;office sürümü&gt; yerine, sisteminizdeki uygun Microsoft Office bileşeninin sürümünü girin; örneğin Microsoft Publisher 2002 için "Office10", Microsoft Publisher 2003 için "Office11" ve Microsoft Publisher 2007 için "Office12". Sürümü doğrulamak için, bu Microsoft Office bileşenini açın ve **Yardım**'ı tıklatın.
  
    Windows XP ve Windows Server 2003'ün 64-bit sürümleri:
  
    `cacls "%ProgramFiles(86)%\Microsoft Office\<office sürümü>\pubconv.dll" /E /R everyone`
  
    **Not** &lt;office sürümü&gt; yerine, sisteminizdeki uygun Microsoft Office bileşeninin sürümünü girin; örneğin Microsoft Publisher 2002 için "Office10", Microsoft Publisher 2003 için "Office11" ve Microsoft Publisher 2007 için "Office12". Sürümü doğrulamak için, bu Microsoft Office bileşenini açın ve **Yardım**'ı tıklatın.
  
    Windows Vista, Windows Server 2008 ve Windows 7'nin 32-bit sürümleri:
  
    `icacls "c:\program files\Microsoft Office\<office sürümü>\" /restore %TEMP%\PUBCONV_ACL.TXT`
  
    **Not** &lt;office sürümü&gt; yerine, sisteminizdeki uygun Microsoft Office bileşeninin sürümünü girin; örneğin Microsoft Publisher 2002 için "Office10", Microsoft Publisher 2003 için "Office11" ve Microsoft Publisher 2007 için "Office12". Sürümü doğrulamak için, bu Microsoft Office bileşenini açın ve **Yardım**'ı tıklatın.
  
    Windows Vista, Windows Server 2008, Windows 7 ve Windows Server 2008 R2'nin 64-bit sürümleri:
  
    `icacls "%ProgramFiles(86)%\Microsoft Office\<office sürümü>\" /restore %TEMP%\PUBCONV_ACL.TXT`
...
#### pubconv.dll Dosyasındaki Boyut Değerinde Öbek Bozulması Güvenlik Açığı - CVE-2010-2569 Hakkında SSS
...
Güvenlik açığı, Microsoft Publisher'ın özel hazırlanmış Publisher dosyalarını ayrıştırma biçimi nedeniyle ortaya çıkar.
  
**pubconv.dll nedir?**    
Publisher Dönüştürücüsü adlı DLL dosyası, Microsoft Publisher 2007'den önceki sürümlerde oluşturulmuş Publisher dosyalarını açmak üzere Microsoft Publisher tarafından kullanılır.
...
pubconv.dll Dosyasında Öbek Taşması Güvenlik Açığı - CVE-2010-2570  
------------------------------------------------------------------
  
<span></span>
Publisher dosyalarının Microsoft Publisher tarafından ayrıştırılma biçiminde bir uzaktan kod yürütme güvenlik açığı bulunmaktadır. Saldırgan, bir e-posta ekinde bulunan veya özel hazırlanmış ya da güvenliği aşılmış bir Web sitesinde barındırılan özel hazırlanmış bir Publisher dosyası oluşturmak ve daha sonra kullanıcıyı özel hazırlanmış bir Publisher dosyasını açmaya ikna etmek yoluyla bu güvenlik açığından yararlanabilir. Kullanıcı yönetimsel haklarla oturum açtıysa, bu güvenlik açığından başarıyla yararlanan bir saldırgan etkilenen sistemin denetimini tümüyle ele geçirebilir. Saldırgan, program yükleyebilir; verileri görüntüleyebilir, değiştirebilir veya silebilir; tüm kullanıcı haklarına sahip olan yeni hesaplar oluşturabilir. Hesapları, sistemde az sayıda kullanıcı hakkıyla yapılandırılmış olan kullanıcılar, yönetici haklarıyla çalışan kullanıcılardan daha az etkilenebilir.
  
Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2010-2570](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2570).
  
#### pubconv.dll Dosyasında Öbek Taşması Güvenlik Açığı - CVE-2010-2570 için Azaltıcı Etkenler
...
#### pubconv.dll Dosyasında Öbek Taşması Güvenlik Açığı - CVE-2010-2570 için Geçici Çözümler
...
-   **Publisher Dönüştürücüsü DLL dosyasını devre dışı bırakın**
    ...
    **Not** Sisteminizdeki uygun Microsoft Office yazılımının sürümünü kullanın; örneğin Microsoft Publisher 2002 için "Office10", Microsoft Publisher 2003 için "Office11", Microsoft Publisher 2007 için "Office12" ve Microsoft Publisher 2010 için "Office14".
...
#### pubconv.dll Dosyasında Öbek Taşması Güvenlik Açığı - CVE-2010-2570 Hakkında SSS
...
**Bir saldırgan güvenlik açığından nasıl yararlanabilir?**    
Bu güvenlik güncelleştirmesi, kullanıcının özel hazırlanmış bir Publisher dosyasını Microsoft Publisher ile açmasını gerektirir.
...
Pubconv.dll Dosyasında Dize Dizininin Geçersiz Olması Nedeniyle Bellek Bozulması Güvenlik Açığı - CVE-2010-2571  
---------------------------------------------------------------------------------------------------------------
...
Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2010-2571](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2571).
  
#### Pubconv.dll Dosyasında Dize Dizininin Geçersiz Olması Nedeniyle Bellek Bozulması Güvenlik Açığı - CVE-2010-2571 için Azaltıcı Etkenler
...
#### Pubconv.dll Dosyasında Dize Dizininin Geçersiz Olması Nedeniyle Bellek Bozulması Güvenlik Açığı - CVE-2010-2571 için Geçici Çözümler
...
-   **Publisher Dönüştürücüsü DLL dosyasını devre dışı bırakın**
    ...
    **Windows** **Vista, Windows Server 2008, Windows 7 ve Windows Server 2008 R2'nin 64-bit sürümleri:**
    ...
    `takeown /f "<64BIT_YOLU_VE_DOSYAADI>"icacls "%ProgramFiles(86)%\Microsoft Office\<office sürümü>\pubconv.dll" /save %TEMP%\ PUBCONV_ACL.TXTicacls "%ProgramFiles(86)%\Microsoft Office\<office sürümü>\pubconv.dll" /deny everyone (F)`
    ...
    **Not** Sisteminizdeki uygun Microsoft Office yazılımının sürümünü kullanın; örneğin Microsoft Publisher 2002 için "Office10" ve Microsoft Publisher 2003 için "Office11".
...
#### Pubconv.dll Dosyasında Dize Dizininin Geçersiz Olması Nedeniyle Bellek Bozulması Güvenlik Açığı - CVE-2010-2571 Hakkında SSS
  
**Bu güvenlik açığının kapsamı nedir?**    
Bu bir uzaktan kod yürütme güvenlik açığıdır. Bu açığı başarıyla kullanan bir saldırgan, etkilenen sistemin tüm denetimini ele geçirebilir. Saldırgan, program yükleyebilir; verileri görüntüleyebilir, değiştirebilir veya silebilir; tüm kullanıcı haklarına sahip olan yeni hesaplar oluşturabilir.
  
**Güvenlik açığına ne neden olmaktadır?**    
Güvenlik açığı, Publisher 97 biçimindeki dosyaların Microsoft Publisher tarafından ayrıştırılma biçimi nedeniyle ortaya çıkar.
...
**Güncelleştirme ne yapıyor?**    
Güncelleştirme, Publisher 97 biçimindeki dosyaların Microsoft Publisher tarafından dönüştürülme biçimini düzelterek bu güvenlik açığını ortadan kaldırır.
...
Microsoft Publisher'da Bellek Bozulması Güvenlik Açığı - CVE-2010-3954  
----------------------------------------------------------------------
  
<span></span>
Publisher dosyalarının Microsoft Publisher tarafından açılma biçiminde bir uzaktan kod yürütme güvenlik açığı bulunmaktadır. Saldırgan, bir e-posta ekinde bulunan veya özel hazırlanmış ya da güvenliği aşılmış bir Web sitesinde barındırılan özel hazırlanmış bir Publisher dosyası oluşturmak ve daha sonra kullanıcıyı özel hazırlanmış bir Publisher dosyasını açmaya ikna etmek yoluyla bu güvenlik açığından yararlanabilir. Kullanıcı yönetimsel haklarla oturum açtıysa, bu güvenlik açığından başarıyla yararlanan bir saldırgan etkilenen sistemin denetimini tümüyle ele geçirebilir. Saldırgan, program yükleyebilir; verileri görüntüleyebilir, değiştirebilir veya silebilir; tüm kullanıcı haklarına sahip olan yeni hesaplar oluşturabilir. Hesapları, sistemde az sayıda kullanıcı hakkıyla yapılandırılmış olan kullanıcılar, yönetici haklarıyla çalışan kullanıcılardan daha az etkilenebilir.
  
Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2010-3954](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3954).
  
#### Microsoft Publisher'da Bellek Bozulması Güvenlik Açığı - CVE-2010-3954 için Azaltıcı Etkenler
...
#### Microsoft Publisher'da Bellek Bozulması Güvenlik Açığı - CVE-2010-3954 için Geçici Çözümler
...
#### Microsoft Publisher'da Bellek Bozulması Güvenlik Açığı - CVE-2010-3954 Hakkında SSS
...
Dize Dizininde Bellek Bozulması Güvenlik Açığı - CVE-2010-3955  
--------------------------------------------------------------
  
<span></span>
Publisher dosyalarının Microsoft Publisher tarafından açılma biçiminde bir uzaktan kod yürütme güvenlik açığı bulunmaktadır. Saldırgan, bir e-posta ekinde bulunan veya özel hazırlanmış ya da güvenliği aşılmış bir Web sitesinde barındırılan özel hazırlanmış bir Publisher dosyası oluşturmak ve daha sonra kullanıcıyı özel hazırlanmış bir Publisher dosyasını açmaya ikna etmek yoluyla bu güvenlik açığından yararlanabilir. Kullanıcı yönetimsel haklarla oturum açtıysa, bu güvenlik açığından başarıyla yararlanan bir saldırgan etkilenen sistemin denetimini tümüyle ele geçirebilir. Saldırgan, program yükleyebilir; verileri görüntüleyebilir, değiştirebilir veya silebilir; tüm kullanıcı haklarına sahip olan yeni hesaplar oluşturabilir. Hesapları, sistemde az sayıda kullanıcı hakkıyla yapılandırılmış olan kullanıcılar, yönetici haklarıyla çalışan kullanıcılardan daha az etkilenebilir.
  
Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2010-3955](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3955).
  
#### Dize Dizininde Bellek Bozulması Güvenlik Açığı - CVE-2010-3955 için Azaltıcı Etkenler
...
#### Dize Dizininde Bellek Bozulması Güvenlik Açığı - CVE-2010-3955 için Geçici Çözümler
...
-   **Publisher Dönüştürücüsü DLL dosyasını devre dışı bırakın**
    ...
    **Windows** **Vista, Windows Server 2008, Windows 7 ve Windows Server 2008 R2'nin 64-bit sürümleri:**
    ...
    `takeown /f "<64BIT_YOLU_VE_DOSYAADI>"icacls "%ProgramFiles(86)%\Microsoft Office\office10\pubconv.dll" /save %TEMP%\ PUBCONV_ACL.TXTicacls "%ProgramFiles(86)%\Microsoft Office\office10\pubconv.dll" /deny everyone (F)`
    ...
    **Geçici çözüm nasıl geri alınır:**
    ...
    Windows Vista, Windows Server 2008 ve Windows 7'nin 32-bit sürümlerinde, ayrıcalığı yükseltilmiş bir komut isteminde şu komutu çalıştırın:
...
#### Dize Dizininde Bellek Bozulması Güvenlik Açığı - CVE-2010-3955 Hakkında SSS
...
<td style="border:1px solid black;">officeXP-KB2284692-FullFile-TRK.exe /q:a</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">officeXP-KB2284692-FullFile-TRK.exe /r:n</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">Bkz: <a href="http://support.microsoft.com/kb/2284692">Microsoft Bilgi Bankası makalesi 2284692</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;">Kullanıcı araya girmeden yükleme</td>
<td style="border:1px solid black;">office2003-KB2284695-FullFile-TRK.exe /q:a</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">office2003-KB2284695-FullFile-TRK.exe /r:n</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Güncelleştirme günlük dosyası</td>
<td style="border:1px solid black;">Uygulanamaz</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Dosya Bilgileri</strong></td>
<td style="border:1px solid black;">Bkz: <a href="http://support.microsoft.com/kb/2284695">Microsoft Bilgi Bankası makalesi 2284695</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Kayıt Defteri Anahtarı Doğrulaması</strong></td>
<td style="border:1px solid black;">Uygulanamaz</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Dosya Bilgileri</strong></td>
<td style="border:1px solid black;">Bkz: <a href="http://support.microsoft.com/kb/2284697">Microsoft Bilgi Bankası makalesi 2284697</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Kayıt Defteri Anahtarı Doğrulaması</strong></td>
<td style="border:1px solid black;">Uygulanamaz</td>
...
<tr class="odd">
<td style="border:1px solid black;">Kullanıcı araya girmeden yükleme</td>
<td style="border:1px solid black;">Microsoft Publisher 2010 (32-bit sürümler):<br />
Publisher2010-kb2409055-fullfile-x86-glb.exe /passive</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Publisher 2010 (64-bit sürümler):<br />
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Dosya Bilgileri</strong></td>
<td style="border:1px solid black;">Bkz: <a href="http://support.microsoft.com/kb/2409055">Microsoft Bilgi Bankası makalesi 2409055</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Kayıt Defteri Anahtarı Doğrulaması</strong></td>
<td style="border:1px solid black;">Uygulanamaz</td>
...
-   [VUPEN Vulnerability Research Team](http://www.vupen.com/) için çalışan Chaouki Bekrar, pubconv.dll Dosyasındaki Boyut Değerinde Öbek Bozulması Güvenlik Açığı'nı (CVE-2010-2569) bildirdiği için  
-   [VUPEN Vulnerability Research Team](http://www.vupen.com/) için çalışan Chaouki Bekrar, pubconv.dll Dosyasında Öbek Taşması Güvenlik Açığı'nı (CVE-2010-2570) bildirdiği için  
-   [VUPEN Vulnerability Research Team](http://www.vupen.com/) için çalışan Chaouki Bekrar, Pubconv.dll Dosyasında Dize Dizininin Geçersiz Olması Nedeniyle Bellek Bozulması Güvenlik Açığı'nı (CVE-2010-2571) bildirdiği için  
-   [VUPEN Vulnerability Research Team](http://www.vupen.com/) için çalışan Chaouki Bekrar, Microsoft Publisher'da Bellek Bozulması Güvenlik Açığı'nı (CVE-2010-3954) bildirdiği için  
-   [VUPEN Vulnerability Research Team](http://www.vupen.com/) için çalışan Chaouki Bekrar, Dize Dizininde Bellek Bozulması Güvenlik Açığı'nı (CVE-2010-3955) bildirdiği için
