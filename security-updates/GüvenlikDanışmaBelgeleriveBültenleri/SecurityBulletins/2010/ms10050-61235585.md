---
TOCTitle: 'MS10-050'
Title: 'Microsoft Güvenlik Bülteni MS10-050 - Önemli'
ms:assetid: 'ms10-050'
ms:contentKeyID: 61235585
ms:mtpsurl: 'https://technet.microsoft.com/tr-TR/library/ms10-050(v=Security.10)'
---

Security Bulletin

Microsoft Güvenlik Bülteni MS10-050 - Önemli
============================================

Windows Movie Maker'daki Güvenlik Açığı Uzaktan Kod Yürütülmesine İzin Verebilir (981997)
-----------------------------------------------------------------------------------------

Yayım Tarihi: 10 Ağustos 2010 Salı | Güncelleştirme Tarihi: 15 Eylül 2010 Çarşamba
...
Bu güvenlik güncelleştirmesi Windows Movie Maker 2.1, Windows Movie Maker 2.6 ve Windows Movie Maker 6.0 için Önemli olarak derecelendirilmiştir. Daha fazla bilgi için, bu bölümdeki **Etkilenen ve Etkilenmeyen Yazılımlar** alt bölümüne bakın.

Güvenlik güncelleştirmesi, Movie Maker proje dosyalarının Windows Movie Maker tarafından ayrıştırılma biçimini değiştirerek bu güvenlik açığını giderir. Bu güvenlik açığı hakkında daha fazla bilgi için, bir sonraki bölüm olan **Güvenlik Açığı Bilgileri** altında, ilgili güvenlik açığı girdisinin Sık Sorulan Sorular (SSS) alt bölümüne bakın.
...
**Bilinen Sorunlar.** [Microsoft Bilgi Bankası makalesi 981997](http://support.microsoft.com/kb/981997), bu güvenlik güncelleştirmesini yükleyen müşterilerin karşılaşabileceği bilinen sorunları belgelemektedir. Bu makale ayrıca, bu sorunlar için önerilen çözümleri de içermektedir.
...
<span></span>
**Windows 7 üzerinde Windows Movie Maker bu sorundan nasıl etkileniyor?**  
Windows Movie Maker, Windows 7'de desteklenmemektedir. Ancak Windows Vista'dan Windows 7'ye yükseltme veya başka bir senaryo gereğince, güvenlik açığından etkilenen Windows Movie Maker 2.6 yazılımı Windows 7 tabanlı bir sistemde bulunabilir. Bununla birlikte, Windows Movie Maker'ın Windows 7 tabanlı bir sistemde çalıştırılması desteklenmez ve bu güvenlik güncelleştirmesi Windows 7 tabanlı sistemlere sunulmaz.
  
Windows Movie Maker'ın desteklenmeyen yapılandırmasını Windows 7 üzerinde çalıştıran kullanıcıların Windows Movie Maker'ı kaldırmaları önerilir. Windows Movie Maker'ı kaldıramayan kullanıcılar bu güvenlik açığından etkilenme riskini azaltmak üzere bu güvenlik bülteninde açıklanan geçici çözümü uygulayabilirler.
  
Windows 7 kullanıcıları için, Microsoft, Windows Live Movie Maker'ı önerir. Windows Live Movie Maker, [Microsoft Yükleme Merkezi](http://www.microsoft.com/downloads/details.aspx?familyid=741ce3ed-baa2-4610-9f7d-42ab694e2b15)'nden edinilebilir ve bu bültende açıklanan güvenlik açığından etkilenmez.
...
<th style="border:1px solid black;" >Movie Maker'da Bellek Bozulması Güvenlik Açığı - CVE-2010-2564</th>
<th style="border:1px solid black;" >Toplam Önem Derecesi</th>
</tr>
</thead>
<tbody>
<tr class="odd">
<td style="border:1px solid black;">Windows XP Service Pack 3 üzerinde Windows Movie Maker 2.1</td>
...
<tr class="odd">
<td style="border:1px solid black;">Windows Vista Service Pack 1 ve Windows Vista Service Pack 2 üzerinde Windows Movie Maker 6.0</td>
<td style="border:1px solid black;"><strong>Önemli</strong> <br />
Uzaktan Kod Yürütme</td>
<td style="border:1px solid black;"><strong>Önemli</strong></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Windows Vista x64 Edition Service Pack 1 ve Windows Vista x64 Edition Service Pack 2 üzerinde Windows Movie Maker 6.0</td>
<td style="border:1px solid black;"><strong>Önemli</strong> <br />
Uzaktan Kod Yürütme</td>
<td style="border:1px solid black;"><strong>Önemli</strong></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Windows Vista Service Pack 1 ve Windows Vista Service Pack 2 üzerine yüklendiğinde Windows Movie Maker 2.6</td>
<td style="border:1px solid black;"><strong>Önemli</strong> <br />
Uzaktan Kod Yürütme</td>
<td style="border:1px solid black;"><strong>Önemli</strong></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Windows Vista x64 Edition Service Pack 1 ve Windows Vista x64 Edition Service Pack 2 üzerine yüklendiğinde Windows Movie Maker 2.6</td>
<td style="border:1px solid black;"><strong>Önemli</strong> <br />
Uzaktan Kod Yürütme</td>
<td style="border:1px solid black;"><strong>Önemli</strong></td>
</tr>
...
Movie Maker'da Bellek Bozulması Güvenlik Açığı - CVE-2010-2564  
--------------------------------------------------------------
  
<span></span>
Windows Movie Maker'ın özel hazırlanmış proje dosyalarını işleme biçiminde bir uzaktan kod yürütme güvenlik açığı bulunmaktadır. Bu açığı başarıyla kullanan bir saldırgan, etkilenen sistemin tüm denetimini ele geçirebilir. Saldırgan, program yükleyebilir; verileri görüntüleyebilir, değiştirebilir veya silebilir; tüm kullanıcı haklarına sahip olan yeni hesaplar oluşturabilir.
  
Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2010-2564](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2564).
  
#### Movie Maker'da Bellek Bozulması Güvenlik Açığı - CVE-2010-2564 için Azaltıcı Etkenler
...
#### Movie Maker'da Bellek Bozulması Güvenlik Açığı - CVE-2010-2564 Hakkında SSS
...
Güvenlik açığı, Windows Movie Maker'ın proje dosyası biçimlerini ayrıştırma biçimi nedeniyle oluşur. Bu güvenlik açığı, kötü amaçlı bir kullanıcının özel hazırlanmış bir Movie Maker dosyası göndermesini ve kullanıcıyı bu özel hazırlanmış dosyayı açmaya ikna etmesini gerektirir.
  
**Windows Movie Maker nedir?**  
Windows Movie Maker, kullanıcıların evde çektikleri videolar oluşturmalarına, bunları düzenlemelerine ve özel efektler eklemelerine olanak veren bir uygulamadır. Windows Movie Maker, Windows XP ve Windows Vista sürümlerinde bulunur.
...
Bu güvenlik açığından yararlanılabilmesi için, kullanıcının Windows Movie Maker'ın etkilenen bir sürümünde özel hazırlanmış bir Movie Maker proje dosyasını açması gerekir.
  
E-posta tabanlı saldırı senaryosunda, saldırgan kullanıcıya özel hazırlanmış bir Movie Maker proje dosyası gönderip bu dosyayı açmaya ikna ederek güvenlik açığından yararlanabilir.
  
Web tabanlı saldırı senaryosunda, saldırganın, bu açıktan yararlanma girişimi için kullanılan özel hazırlanmış Movie Maker proje dosyasını içeren bir Web sitesini barındırması gerekir. Ayrıca, kullanıcı tarafından sağlanan içeriği kabul eden ya da barındıran güvenliği aşılmış Web sitelerinde, bu güvenlik açığından yararlanılabilecek özel hazırlanmış içerik bulunabilir. Saldırganın, bir kullanıcıyı özel hazırlanmış bir Web sitesini ziyaret etmeye zorlama yolu yoktur. Bunun yerine, saldırganın kullanıcıları kendi Web sitesine götüren bir bağlantıyı tıklatmaya ikna ederek onları bu siteye çekmesi ve daha sonra özel hazırlanmış Movie Maker proje dosyasını açmalarını sağlaması gerekir.
  
**Bu güvenlik açığından birincil derecede hangi sistemler etkileniyor?**  
Windows Movie Maker'ın kullanıldığı Windows tabanlı sistemler birincil derecede risk altındadır.
  
**Güncelleştirme ne yapıyor?**  
Güncelleştirme, Movie Maker proje dosyalarının Windows Movie Maker tarafından ayrıştırılma biçimini değiştirerek bu güvenlik açığını giderir.
...
WindowsXP-KB981997-x86-TRK.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition Service Pack 2:<br />
WindowsServer2003.WindowsXP-KB981997-x64-TRK.exe /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">Windows XP Service Pack 3 için:<br />
WindowsXP-KB981997-x86-TRK.exe /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition Service Pack 2:<br />
WindowsServer2003.WindowsXP-KB981997-x64-TRK.exe /norestart</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">Denetim Masası'ndaki <strong>Program Ekle veya Kaldır</strong> aracını veya %Windir%\$NTUninstallKB981997$\Spuninst klasöründe bulunan Spuninst.exe yardımcı programını kullanın</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Dosya Bilgileri</strong></td>
<td style="border:1px solid black;">Bkz: <a href="http://support.microsoft.com/kb/981997">Microsoft Bilgi Bankası makalesi 981997</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Vista'nın tüm desteklenen 32-bit ve x64 tabanlı sürümleri üzerine yüklendiğinde Movie Maker 2.6:
...
-   [Secunia](http://secunia.com/) için çalışan Dyon Balding, Movie Maker'da Bellek Bozulması Güvenlik Açığı'nı (CVE-2010-2564) bildirdiği için
...
-   V1.1 (11 Ağustos 2010): Yürütmeyle İlgili Özet altındaki Bilinen Sorunlar bölümüne Microsoft Bilgi Bankası makalesi 981997 için bir bağlantı eklendi.  
-   V1.2 (15 Eylül 2010): Geçici çözüm (Movie Maker .MSWMM dosya ilişkilendirmesini kaldırma) için otomatik bir **Microsoft Fix it** çözümü sağlamak üzere Microsoft Bilgi Bankası makalesi 981997'ye ilişkin bir bağlantı eklendi.
