---
TOCTitle: 'MS10-011'
Title: 'Microsoft Güvenlik Bülteni MS10-011 - Önemli'
ms:assetid: 'ms10-011'
ms:contentKeyID: 61235546
ms:mtpsurl: 'https://technet.microsoft.com/tr-TR/library/ms10-011(v=Security.10)'
---

Security Bulletin

Microsoft Güvenlik Bülteni MS10-011 - Önemli
============================================

Windows İstemci Sunucu Çalışma Zamanı Alt Sistemi'ndeki Güvenlik Açığı Ayrıcalık Yükselmesine İzin Verebilir (978037)
---------------------------------------------------------------------------------------------------------------------

Yayım Tarihi: 9 Şubat 2010 Salı | Güncelleştirme Tarihi: 9 Haziran 2010 Çarşamba
...
**Bilinen Sorunlar.** [Microsoft Bilgi Bankası makalesi 978037](http://support.microsoft.com/kb/978037), bu güvenlik güncelleştirmesini yükleyen müşterilerin karşılaşabileceği bilinen sorunları belgelemektedir. Bu makale ayrıca, bu sorunlar için önerilen çözümleri de içermektedir.
...
|---------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------|----------------------|---------------------------------------------|
| [Microsoft Windows 2000 Service Pack 4](http://www.microsoft.com/downloads/details.aspx?familyid=456185b5-57d1-4fa5-a4a9-5b2006ede3ad)                  | Ayrıcalık Yükselmesi      | Önemli               | Yok                                         |
| [Windows XP Service Pack 2 ve Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=b9234b40-1b1c-498b-90d4-0bff347b36ee) | Ayrıcalık Yükselmesi      | Önemli               | Yok                                         |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=1f83bf7a-e16c-404a-89bd-f65843938299)     | Ayrıcalık Yükselmesi      | Önemli               | Yok                                         |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=2c8c4eec-255e-41d5-b1e6-f0204edcb46f)                     | Ayrıcalık Yükselmesi      | Önemli               | Yok                                         |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=de0186f6-27a2-4226-b8eb-f2912710f072)         | Ayrıcalık Yükselmesi      | Önemli               | Yok                                         |
| [Itanium Tabanlı Sistemler için Windows Server 2003 SP2](http://www.microsoft.com/downloads/details.aspx?familyid=87732f7a-9339-43bc-a4e8-3da849f35b70) | Ayrıcalık Yükselmesi      | Önemli               | Yok                                         |
...
<th style="border:1px solid black;" >CSRSS'de Yerel Ayrıcalık Yükselmesi Güvenlik Açığı – CVE-2010-0023</th>
...
CSRSS'de Yerel Ayrıcalık Yükselmesi Güvenlik Açığı - CVE-2010-0023  
------------------------------------------------------------------
  
<span></span>
Bir kullanıcı oturumunu kapattığında Windows İstemci Sunucu Çalışma Zamanı Alt Sistemi'nin (CSRSS) kullanıcı işlemlerini düzgün şekilde sonlandırmaması nedeniyle bir ayrıcalık yükselmesi güvenlik açığı bulunmaktadır. Bu güvenlik açığından başarıyla yararlanan bir saldırgan çekirdek modunda rasgele kod çalıştırabilir. Saldırgan, program yükleyebilir; verileri görüntüleyebilir, değiştirebilir veya silebilir; tüm kullanıcı haklarına sahip olan yeni hesaplar oluşturabilir.
  
Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2010-0023](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0023).
  
#### CSRSS'de Yerel Ayrıcalık Yükselmesi Güvenlik Açığı - CVE-2010-0023 için Azaltıcı Etkenler
  
Azaltıcı etken, varolan bir durumda bulunan ve güvenlik açığından yararlanılmasının önem derecesini azaltabilecek bir ayar, genel yapılandırma ya da en iyi uygulama anlamına gelir. Sizin durumunuzda aşağıdaki azaltıcı etkenler işinize yarayabilir:
  
-   Saldırganın bu güvenlik açığından yararlanabilmesi için geçerli oturum açma kimlik bilgilerine sahip olması ve yerel olarak oturum açabilmesi gerekir. Bu güvenlik açığı anonim kullanıcılar tarafından kullanılamaz.
  
#### CSRSS'de Yerel Ayrıcalık Yükselmesi Güvenlik Açığı - CVE-2010-0023 için Geçici Çözümler
  
Microsoft bu güvenlik açığı için herhangi bir geçici çözüm belirleyememiştir.
  
#### CSRSS'de Yerel Ayrıcalık Yükselmesi Güvenlik Açığı - CVE-2010-0023 Hakkında SSS
...
Bir kullanıcı oturumunu kapattığında Windows İstemci Sunucu Çalışma Zamanı Alt Sistemi (CSRSS) kullanıcı işlemlerini düzgün şekilde sonlandırmaz.
  
**İstemci/Sunucu Çalışma Zamanı Alt Sistemi nedir?**    
CSRSS, Win32 alt sisteminin kullanıcı modu kısmıdır. CSRSS (İstemci Sunucu Çalışma Zamanı Alt Sistemi), sürekli çalışması gereken önemli bir alt sistemdir. CSRSS, konsol pencerelerinin yanı sıra iş parçacıklarını oluşturma ve/veya silme işlemlerinden sorumludur.
  
**Bir saldırgan bu güvenlik açığından yararlanarak neler yapabilir?**    
Bu güvenlik açığından başarıyla yararlanan bir saldırgan, sistemde oturum açmış bir kullanıcının ayrıcalık düzeyinde kod çalıştırabilir. Sistemde bir yönetici oturum açmışsa, saldırganın kodu yükseltilmiş ayrıcalıklarla yürütülecektir. Bu güvenlik açığından başarıyla yararlanan bir saldırgan ayrıca sistemde oturum açmış kullanıcının gerçekleştirdiği işlemleri izleyecek biçimde tasarlanmış kod çalıştırabilir. Bu durum, önemli bilgilerin açığa çıkmasına veya etkilenen sistemlerde oturum açmış kullanıcının erişebildiği verilere erişim sağlanmasına olanak verir.
...
| **Dağıtım**                                  |                                                                                                                                                                       |  
| Kullanıcı araya girmeden yükleme             | Windows2000-KB978037-x86-trk /quiet                                                                                                                                   |  
| Yeniden başlatmadan yükleme                  | Windows2000-KB978037-x86-trk /norestart                                                                                                                               |  
| Güncelleştirme günlük dosyası                | KB978037.log                                                                                                                                                          |  
...
| **Kaldırma Bilgileri**                       | Denetim Masası'ndaki **Program Ekle veya Kaldır** aracını veya %Windir%\\$NTUninstallKB978037$\\Spuninst klasöründe bulunan Spuninst.exe yardımcı programını kullanın |  
| **Dosya Bilgileri**                          | Bkz: [Microsoft Bilgi Bankası makalesi 978037](http://support.microsoft.com/kb/978037)                                                                                |  
| **Kayıt Defteri Anahtarı Doğrulaması**       | HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows 2000\\SP5\\KB978037\\Filelist                                                                             |
...
WindowsXP-KB978037-x86-trk /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition Service Pack 2:<br />
WindowsServer2003.WindowsXP-KB978037-x64-trk /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">Windows XP Service Pack 2 ve Windows XP Service Pack 3:<br />
WindowsXP-KB978037-x86-trk /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition Service Pack 2:<br />
WindowsServer2003.WindowsXP-KB978037-x64-trk /norestart</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">Denetim Masası'ndaki <strong>Program Ekle veya Kaldır</strong> aracını veya %Windir%\$NTUninstallKB978037$\Spuninst klasöründe bulunan Spuninst.exe yardımcı programını kullanın</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Dosya Bilgileri</strong></td>
<td style="border:1px solid black;">Bkz: <a href="http://support.microsoft.com/kb/978037">Microsoft Bilgi Bankası makalesi 978037</a></td>
</tr>
<tr class="even">
...
WindowsServer2003-KB978037-x86-trk /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
WindowsServer2003-KB978037-ia64-trk /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen 32 bit sürümleri:<br />
WindowsServer2003-KB978037-x86-trk /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen x64 tabanlı sürümleri:<br />
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen Itanium tabanlı sürümleri:<br />
WindowsServer2003-KB978037-ia64-trk /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Güncelleştirme günlük dosyası</td>
<td style="border:1px solid black;">KB978037.log</td>
...
-   [Hispasec](http://www.hispasec.com/) için çalışan Matthew 'j00ru' Jurczyk ve Gynvael Coldwind, CSRSS'de Yerel Ayrıcalık Yükselmesi Güvenlik Açığı'nı (CVE-2010-0023) bildirdikleri için
...
-   V1.2 (9 Haziran 2010): Yürütmeyle İlgili Özet altındaki Bilinen Sorunlar bölümüne Microsoft Bilgi Bankası makalesi 978037 için bir bağlantı eklendi.
