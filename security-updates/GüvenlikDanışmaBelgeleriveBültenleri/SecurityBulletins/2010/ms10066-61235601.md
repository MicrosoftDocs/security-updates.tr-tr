---
TOCTitle: 'MS10-066'
Title: 'Microsoft Güvenlik Bülteni MS10-066 - Önemli'
ms:assetid: 'ms10-066'
ms:contentKeyID: 61235601
ms:mtpsurl: 'https://technet.microsoft.com/tr-TR/library/ms10-066(v=Security.10)'
---

Security Bulletin

Microsoft Güvenlik Bülteni MS10-066 - Önemli
============================================

Uzaktan Yordam Çağrısı'ndaki Güvenlik Açığı Uzaktan Kod Yürütülmesine İzin Verebilir (982802)
---------------------------------------------------------------------------------------------
...
Güvenlik açığı, bir saldırgan istemci tarafından başlatılan bir RPC isteğine özel hazırlanmış bir RPC yanıtı gönderirse uzaktan kod yürütülmesine izin verebilir. Bu güvenlik açığından başarıyla yararlanan bir saldırgan rasgele kod yürütebilir ve etkilenen sistemin tüm denetimini ele geçirebilir. Saldırganın kullanıcıyı kendi denetimindeki kötü amaçlı bir sunucuya RPC bağlantısı oluşturmaya ikna etmesi gerekir. Saldırgan, kullanıcı etkileşimi olmadan bu güvenlik açığından uzaktan yararlanamaz.

Güvenlik güncelleştirmesi, RPC istemcisinin bir uzak sunucu tarafından geçirilen RPC yanıtlarını yüklemeden önce belleği ayırma biçimini düzelterek bu güvenlik açığını ortadan kaldırır. Bu güvenlik açığı hakkında daha fazla bilgi için, bir sonraki bölüm olan **Güvenlik Açığı Bilgileri** altında, ilgili güvenlik açığı girdisinin Sık Sorulan Sorular (SSS) alt bölümüne bakın.
...
|---------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------|----------------------|-----------------------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=7ad0f2cf-03dc-49a0-a16e-17fed0c01cc6)                              | Uzaktan Kod Yürütme       | Önemli               | [MS09-026](http://go.microsoft.com/fwlink/?linkid=150174) |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=3349b12b-621e-48bc-9c57-489c7a56920d)     | Uzaktan Kod Yürütme       | Önemli               | [MS09-026](http://go.microsoft.com/fwlink/?linkid=150174) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=f8b3004b-07db-4638-a9b7-224ff829081c)                     | Uzaktan Kod Yürütme       | Önemli               | [MS09-026](http://go.microsoft.com/fwlink/?linkid=150174) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=612b2096-bd82-47ca-8b99-454c2f158d39)         | Uzaktan Kod Yürütme       | Önemli               | [MS09-026](http://go.microsoft.com/fwlink/?linkid=150174) |
| [Itanium Tabanlı Sistemler için Windows Server 2003 SP2](http://www.microsoft.com/downloads/details.aspx?familyid=1f04f151-330a-4b6c-826e-76def35daa73) | Uzaktan Kod Yürütme       | Önemli               | [MS09-026](http://go.microsoft.com/fwlink/?linkid=150174) |
...
<th style="border:1px solid black;" >RPC'de Bellek Bozulması Güvenlik Açığı - CVE-2010-2567</th>
...
RPC'de Bellek Bozulması Güvenlik Açığı - CVE-2010-2567  
------------------------------------------------------
  
<span></span>
Uzaktan Yordam Çağrısı (RPC) istemcisinin özel hazırlanmış RPC yanıtlarını ayrıştırırken belleği ayırma biçiminde, kimlik doğrulaması olmadan uzaktan kod yürütme güvenlik açığı bulunmaktadır. Bu güvenlik açığından yararlanmaya yönelik girişimler kimlik doğrulaması gerektirir; saldırgan, istemci tarafından başlatılan bir RPC isteğine özel hazırlanmış bir RPC yanıtı göndererek bu güvenlik açığından yararlanabilir. Bu güvenlik açığından başarıyla yararlanan bir saldırgan rasgele kod yürütebilir ve etkilenen sistemin tüm denetimini ele geçirebilir. Saldırgan, program yükleyebilir; verileri görüntüleyebilir, değiştirebilir veya silebilir; tüm kullanıcı haklarına sahip olan yeni hesaplar oluşturabilir.
  
Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2010-2567](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2567).
  
#### RPC'de Bellek Bozulması Güvenlik Açığı - CVE-2010-2567 için Azaltıcı Etkenler
...
-   Saldırganın kullanıcıyı kendi denetimindeki kötü amaçlı bir sunucuya RPC bağlantısı oluşturmaya ikna etmesi gerekir. Saldırgan, kullanıcı etkileşimi olmadan bu güvenlik açığından uzaktan yararlanamaz.  
...
#### RPC'de Bellek Bozulması Güvenlik Açığı - CVE-2010-2567 için Geçici Çözümler
...
#### RPC'de Bellek Bozulması Güvenlik Açığı - CVE-2010-2567 Hakkında SSS
...
Güvenlik açığı, Microsoft Uzaktan Yordam Çağrısı (RPC) istemci uygulamasının özel hazırlanmış RPC yanıtlarını ayrıştırırken belleği hatalı şekilde ayrıştırması nedeniyle ortaya çıkar.
  
**Uzak Yordam Çağrısı (RPC) nedir?**  
Microsoft Uzaktan Yordam Çağrısı (RPC), 1980'lerin başında geliştirilen bir ağ programlama standardıdır. RPC hizmeti, bir programcının bazıları yerel olarak yürütülen ve bazıları da ağ üzerinden uzak bilgisayarlarda yürütülen çok sayıda yordam içeren bir uygulama geliştirmesine olanak verir.
  
**Bir saldırgan bu güvenlik açığından yararlanarak neler yapabilir?**  
Bu güvenlik açığından başarıyla yararlanan bir saldırgan, RPC istemci uygulamasının güvenlik bağlamında kod yürütebilir. RPC istemci uygulaması LocalSystem veya yönetici ayrıcalıkları olan başka bir hesabın altında çalışıyorsa, saldırgan etkilenen sistemin tüm denetimini ele geçirebilir.
  
**Bir saldırgan güvenlik açığından nasıl yararlanabilir?**  
Saldırgan, bu güvenlik açığından yararlanılacak şekilde özel olarak tasarlanmış bir RPC sunucusu barındırabilir ve daha sonra kullanıcıyı bu sunucuya bir RPC çağrısı göndermeye ikna edebilir. Yerel ağdaki bir saldırgan ayrıca bir ortadaki adam saldırısı gerçekleştirerek, meşru bir RPC çağrısına hatalı biçimlendirilmiş bir RPC yanıtı gönderebilir.
  
**Bu güvenlik açığından birincil derecede hangi sistemler etkileniyor?**  
Windows XP'nin ve Windows Server 2003'ün desteklenen sürümlerini çalıştıran tüm sistemler risk altındadır.
  
**Güncelleştirme ne yapıyor?**  
Güncelleştirme, RPC istemcisinin bir uzak sunucu tarafından geçirilen RPC yanıtlarını yüklemeden önce belleği ayırma biçimini düzelterek bu güvenlik açığını ortadan kaldırır.
...
WindowsXP-KB982802-x86-trk.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition Service Pack 2:<br />
WindowsServer2003.WindowsXP-KB982802-x64-trk.exe /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">Windows XP Service Pack 3 için:<br />
WindowsXP-KB982802-x86-trk.exe /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition Service Pack 2:<br />
WindowsServer2003.WindowsXP-KB982802-x64-trk.exe /norestart</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">Denetim Masası'ndaki <strong>Program Ekle veya Kaldır</strong> aracını veya %Windir%\$NTUninstallKB982802$\Spuninst klasöründe bulunan Spuninst.exe yardımcı programını kullanın</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Dosya Bilgileri</strong></td>
<td style="border:1px solid black;">Bkz: <a href="http://support.microsoft.com/kb/982802">Microsoft Bilgi Bankası makalesi 982802</a></td>
</tr>
<tr class="even">
...
WindowsServer2003-KB982802-x86-trk.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
WindowsServer2003-KB982802-ia64-trk.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen 32 bit sürümleri:<br />
WindowsServer2003-KB982802-x86-trk.exe /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen x64 tabanlı sürümleri:<br />
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen Itanium tabanlı sürümleri:<br />
WindowsServer2003-KB982802-ia64-trk.exe /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Güncelleştirme günlük dosyası</td>
<td style="border:1px solid black;">KB982802.log</td>
...
-   [Palo Alto Networks](http://www.paloaltonetworks.com/) için çalışan Yamata Li, RPC'de Bellek Bozulması Güvenlik Açığı'nı (CVE-2010-2567) bildirdiği için
