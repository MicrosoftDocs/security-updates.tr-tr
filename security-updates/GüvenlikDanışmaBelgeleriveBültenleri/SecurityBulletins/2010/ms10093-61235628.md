---
TOCTitle: 'MS10-093'
Title: 'Microsoft Güvenlik Bülteni MS10-093 - Önemli'
ms:assetid: 'ms10-093'
ms:contentKeyID: 61235628
ms:mtpsurl: 'https://technet.microsoft.com/tr-TR/library/ms10-093(v=Security.10)'
---

Security Bulletin

Microsoft Güvenlik Bülteni MS10-093 - Önemli
============================================

Windows Movie Maker'daki Güvenlik Açığı Uzaktan Kod Yürütülmesine İzin Verebilir (2424434)
------------------------------------------------------------------------------------------
...
Bu güvenlik güncelleştirmesi Windows Vista'nın tüm desteklenen sürümleri üzerinde Windows Movie Maker 2.6 için Önemli olarak derecelendirilmiştir. Daha fazla bilgi için, bu bölümdeki **Etkilenen ve Etkilenmeyen Yazılımlar** alt bölümüne bakın.

Güvenlik güncelleştirmesi, Windows Movie Maker'ın dış kitaplıkları yükleme biçimini düzelterek bu güvenlik açığını giderir. Bu güvenlik açığı hakkında daha fazla bilgi için, bir sonraki bölüm olan **Güvenlik Açığı Bilgileri** altında, ilgili güvenlik açığı girdisinin Sık Sorulan Sorular (SSS) alt bölümüne bakın.
...
|--------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------|---------------------------|----------------------|-----------------------------------------------------------|
| Windows Vista Service Pack 1 ve Windows Vista Service Pack 2                         | [Movie Maker 2.6](http://www.microsoft.com/downloads/details.aspx?familyid=55141a02-3ad3-4691-98b9-80dd8ecb14c5)<sup>[1]</sup> | Uzaktan Kod Yürütme       | Önemli               | [MS10-050](http://go.microsoft.com/fwlink/?linkid=197103) |
| Windows Vista x64 Edition Service Pack 1 ve Windows Vista x64 Edition Service Pack 2 | [Movie Maker 2.6](http://www.microsoft.com/downloads/details.aspx?familyid=5b078136-a492-4a2e-939d-82799f774d82)<sup>[1]</sup> | Uzaktan Kod Yürütme       | Önemli               | [MS10-050](http://go.microsoft.com/fwlink/?linkid=197103) |
...
<th style="border:1px solid black;" >Güvenli Olmayan Şekilde Kitaplık Yükleme Güvenlik Açığı - CVE-2010-3967</th>
...
Güvenli Olmayan Şekilde Kitaplık Yükleme Güvenlik Açığı - CVE-2010-3967  
-----------------------------------------------------------------------
  
<span></span>
Windows Movie Maker'ın DLL dosyalarını yükleme biçiminde bir uzaktan kod yürütme güvenlik açığı bulunmaktadır. Bu açığı başarıyla kullanan bir saldırgan, etkilenen sistemin tüm denetimini ele geçirebilir. Saldırgan, program yükleyebilir; verileri görüntüleyebilir, değiştirebilir veya silebilir; tüm kullanıcı haklarına sahip olan yeni hesaplar oluşturabilir. Hesapları, sistemde az sayıda kullanıcı hakkıyla yapılandırılmış olan kullanıcılar, yönetici haklarıyla çalışan kullanıcılardan daha az etkilenebilir.
  
Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2010-3967](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3967).
  
#### Güvenli Olmayan Şekilde Kitaplık Yükleme Güvenlik Açığı - CVE-2010-3967 için Azaltıcı Etkenler
...
#### Güvenli Olmayan Şekilde Kitaplık Yükleme Güvenlik Açığı - CVE-2010-3967 için Geçici Çözümler
...
#### Güvenli Olmayan Şekilde Kitaplık Yükleme Güvenlik Açığı - CVE-2010-3967 Hakkında SSS
...
Güvenlik açığı, Windows Movie Maker'ın dış kitaplıkları yüklemek için kullanılan yolu hatalı şekilde kısıtlaması nedeniyle ortaya çıkar.
  
**Windows Movie Maker nedir?**    
Windows Movie Maker, kullanıcıların evde çektikleri videolar oluşturmalarına, bunları düzenlemelerine ve özel efektler eklemelerine olanak veren bir uygulamadır. Windows Movie Maker, Windows XP ve Windows Vista sürümlerinde bulunur. Bu güvenlik açığı yalnızca Movie Maker 2.6'yı etkiler; bu sürüm, etkilenen işletim sistemlerine yüklenebilen isteğe bağlı bir karşıdan yüklemedir.
...
Saldırgan bir kullanıcıyı özel hazırlanmış bir dinamik bağlantı kitaplığı (DLL) dosyasıyla aynı ağ dizininde bulunan meşru bir Windows Movie Maker (.mswmm) dosyasını açmaya ikna edebilir. Daha sonra, .mswmm dosyasının açıldığı sırada Windows Movie Maker bu DLL dosyasını yüklemeyi ve içerdiği kodu yürütmeyi deneyebilir.
  
E-posta tabanlı saldırı senaryosunda, saldırgan bir kullanıcıya meşru bir .mswmm eki gönderip kullanıcıyı bu eki özel hazırlanmış bir DLL dosyası içeren bir dizine yerleştirmeye ve .mswmm dosyasını açmaya ikna ederek bu güvenlik açığından yararlanabilir. Daha sonra, .mswmm dosyasının açıldığı sırada Windows Movie Maker bu DLL dosyasını yüklemeyi ve içerdiği kodu yürütmeyi deneyebilir.
  
Ağ senaryosunda, saldırgan bir UNC veya WebDAV konumuna meşru bir .mswmm dosyasıyla birlikte özel hazırlanmış bir DLL dosyası yerleştirebilir ve kullanıcıyı bu .mswmm dosyasını açmaya ikna edebilir.
  
**Bu güvenlik açığından birincil derecede hangi sistemler etkileniyor?**    
Bu güvenlik açığı temelde kullanıcıların güvenilir olmayan ağ konumlarından ekleri açabildikleri iş istasyonlarını etkiler.
  
**Güncelleştirme ne yapıyor?**    
Güncelleştirme, Windows Movie Maker'ın dış kitaplıkları yükleme biçimini düzelterek bu güvenlik açığını giderir.
  
**Bu güvenlik bülteni yayımlandığında bu güvenlik açığı genel olarak duyurulmuş muydu?**    
Evet. Bu güvenlik açığı genel olarak duyurulmuştur. Ortak Güvenlik Açığı ve Etkilenme (Common Vulnerability and Exposure) numarası olarak [CVE-2010-3967](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3967) atanmıştır.
...
<td style="border:1px solid black;">Windows Vista'nın tüm desteklenen 32-bit sürümleri üzerine yüklendiğinde Movie Maker 2.6:<br />
WindowsMovieMaker2.6-KB2424434.exe /q:a</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Vista'nın tüm desteklenen x64 tabanlı sürümleri üzerine yüklendiğinde Movie Maker 2.6:<br />
WindowsMovieMaker2.6-KB2424434.exe /q:a</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">Bkz: <a href="http://support.microsoft.com/kb/2424434">Microsoft Bilgi Bankası makalesi 2424434</a></td>
</tr>
<tr class="odd">
