---
TOCTitle: 'MS10-019'
Title: 'Microsoft Güvenlik Bülteni MS10-019 - Kritik'
ms:assetid: 'ms10-019'
ms:contentKeyID: 61235554
ms:mtpsurl: 'https://technet.microsoft.com/tr-TR/library/ms10-019(v=Security.10)'
---

Security Bulletin

Microsoft Güvenlik Bülteni MS10-019 - Kritik
============================================

Windows'daki Güvenlik Açıkları Uzaktan Kod Yürütülmesine İzin Verebilir (981210)
--------------------------------------------------------------------------------

Yayım Tarihi: 13 Nisan 2010 Salı | Güncelleştirme Tarihi: 21 Nisan 2010 Çarşamba
...
Güvenlik güncelleştirmesi, taşınabilir bir yürütülebilir dosya veya dolap dosyası imzalanırken ve doğrulanırken ek doğrulama işlemleri gerçekleştirerek bu güvenlik açıklarını giderir. Bu güvenlik açıkları hakkında daha fazla bilgi için, bir sonraki bölüm olan **Güvenlik Açığı Bilgileri** altında, ilgili güvenlik açığı girdisinin Sık Sorulan Sorular (SSS) alt bölümüne bakın.
...
**Bilinen Sorunlar.** [Microsoft Bilgi Bankası makalesi 981210](http://support.microsoft.com/kb/981210), bu güvenlik güncelleştirmesini yükleyen müşterilerin karşılaşabileceği bilinen sorunları belgelemektedir. Bu makale ayrıca, bu sorunlar için önerilen çözümleri de içermektedir.
...
Microsoft, bir algılama değişikliğini duyurmak amacıyla bu güvenlik bültenini yeniden düzenledi. Düzeltilen algılama, Sunucu Çekirdeği yükleme seçeneği kullanılarak yüklenmiş etkilenen Windows Server 2008 ve Windows Server 2008 R2 tabanlı sistemlere daha önce bu güvenlik güncelleştirmesi tarafından önerilmeyen Authenticode Signature Verification güvenlik güncelleştirmesini sunar. Düzeltilen algılama ayrıca tüm platformlarda daha önce KB979309 numaralı güncelleştirme yüklenmemişse KB978601 numaralı güncelleştirmenin yüklenememesine neden olabilecek bir yükleme sorununu düzeltir. Bu, yalnızca bir algılama değişikliğidir. Bu bültendeki güvenlik güncelleştirmesi dosyalarında hiçbir değişiklik yapılmamıştır. Güncelleştirmeyi başarıyla yüklemiş olan müşterilerin yeniden yüklemeleri gerekmez.

**Her iki güncelleştirme de sistemim için gerekiyor mu?**  
Evet; Authenticode Signature Verification ve Cabinet File Viewer Shell Extension bileşenlerine yönelik her iki güncelleştirme de her işletim sistemi için gerekmektedir. Kullandığınız işletim sistemi için geçerli olan her iki güncelleştirmeyi de yüklemelisiniz.
...
Evet. Bu bültenin Güvenlik Açığı Bilgileri bölümünde listelenen değişikliklerin yanı sıra, bu güncelleştirme, taşınabilir yürütülebilir dosyalarda Authenticode sürüm 1 imzasını devre dışı bırakan ve dolap dosyalarında ek doğrulama gerçekleştiren bir değişiklik de içerir.
...
<th style="border:1px solid black;" >
WinVerifyTrust'ta İmza Doğrulaması Güvenlik Açığı - CVE-2010-0486
</th>
<th style="border:1px solid black;" >
Cabview'de Bozulma Doğrulaması Güvenlik Açığı - CVE-2010-0487
</th>
<th style="border:1px solid black;" >
Toplam Önem Derecesi
</th>
...
<span></span>
Taşınabilir yürütülebilir (PE) ve dolap dosyası biçimleri için kullanılan Windows Authenticode Signature Verification işlevinde bir uzaktan kod yürütme güvenlik açığı bulunmaktadır. Anonim bir saldırgan, varolan bir imzalanmış yürütülebilir dosyayı değiştirip imzanın ve dosyanın doğrulanmamış bölümlerini yöneterek imzayı geçersiz kılmadan dosyaya kötü amaçlı kod eklemek yoluyla bu güvenlik açığından yararlanabilir. Bu açığı başarıyla kullanan bir saldırgan, etkilenen sistemin tüm denetimini ele geçirebilir. Saldırgan, program yükleyebilir; verileri görüntüleyebilir, değiştirebilir veya silebilir; tüm kullanıcı haklarına sahip olan yeni hesaplar oluşturabilir.

Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2010-0486](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0486).

#### WinVerifyTrust'ta İmza Doğrulaması Güvenlik Açığı - CVE-2010-0486 için Azaltıcı Etkenler
...
#### WinVerifyTrust'ta İmza Doğrulaması Güvenlik Açığı - CVE-2010-0486 için Geçici Çözümler

Microsoft bu güvenlik açığı için herhangi bir geçici çözüm belirleyememiştir.

#### WinVerifyTrust'ta İmza Doğrulaması Güvenlik Açığı - CVE-2010-0486 Hakkında SSS
...
Güvenlik açığı, Windows Authenticode Signature Verification işlevinin bir PE veya dolap dosyası imzalanırken veya doğrulanırken dosya özetindeki alanları atlaması nedeniyle ortaya çıkar.

**Windows Authenticode Signature Verification işlevi nedir?**  
Windows Authenticode Signature Verification işlevi veya kısaca WinVerifyTrust, belirtilen nesnede bir güven doğrulaması eylemi gerçekleştirir. İşlev bu sorguyu, varsa eylem tanımlayıcısını destekleyen bir güven sağlayıcısına geçirir. WinVerifyTrust işlevi iki eylem gerçekleştirir: belirtilen nesnede imza denetimi ve güven doğrulaması eylemi. Daha fazla bilgi için, [WinVerifyTrust İşlevi](http://msdn.microsoft.com/en-us/library/aa388208(vs.85).aspx) adlı MSDN makalesine bakın.
...
**Dolap dosyası nedir?**  
Dolap dosyası, genelde .CAB uzantılı olan ve dosya kitaplığındaki sıkıştırılmış dosyaları depolayan tek bir dosyadır. Sıkıştırılmış dosya birkaç dolap dosyasına yayılabilir. Yükleme sırasında, kurulum uygulaması dolap dosyasında depolanan dosyaların sıkıştırmasını açar ve bunları kullanıcının sistemine kopyalar. Daha fazla bilgi için, [Dolap Dosyaları](http://msdn.microsoft.com/en-us/library/aa376906(v=vs.85).aspx) adlı MSDN makalesine bakın.

**Bir saldırgan bu güvenlik açığından yararlanarak neler yapabilir?**  
Bu güvenlik açığından başarıyla yararlanan bir saldırgan Windows'un rasgele kod yüklemesine veya çalıştırmasına neden olabilir. Saldırgan, program yükleyebilir; verileri görüntüleyebilir, değiştirebilir veya silebilir; tüm kullanıcı haklarına sahip olan yeni hesaplar oluşturabilir.

**Bir saldırgan güvenlik açığından nasıl yararlanabilir?**  
Bu güvenlik açığından yararlanılabilmesi için bir kullanıcının, Windows özelliğinin veya uygulamanın özel hazırlanmış, imzalı bir PE ya da dolap dosyasını çalıştırması gerekir. Saldırgan varolan bir imzalı dosyayı değiştirerek, imzayı geçersiz kılmadan kötü amaçlı kod ekleyebilir. Bu kod, başlatıldığı ayrıcalık düzeyinin bağlamında yürütülür.

**Bu güvenlik açığından birincil derecede hangi sistemler etkileniyor?**  
Tüm etkilenen işletim sistemleri risk altındadır.

**Güncelleştirme ne yapıyor?**  
Güncelleştirme, taşınabilir bir yürütülebilir dosya veya dolap dosyası imzalanırken ve doğrulanırken ek doğrulama gerçekleştirerek bu güvenlik açıklarını giderir.
...
<span></span>
Dolap (.cab) dosyası biçimleri için Windows Authenticode Signature Verification işlevinde bir uzaktan kod yürütme güvenlik açığı bulunmaktadır. Anonim bir saldırgan, varolan bir imzalı dolap dosyasını imzanın doğrulanmamış bölümleri kötü amaçlı koda işaret edecek şekilde değiştirip daha sonra bir kullanıcıyı bu özel hazırlanmış dolap dosyasını açmaya veya görüntülemeye ikna ederek bu güvenlik açığından yararlanabilir. Bu açığı başarıyla kullanan bir saldırgan, etkilenen sistemin tüm denetimini ele geçirebilir. Saldırgan, program yükleyebilir; verileri görüntüleyebilir, değiştirebilir veya silebilir; tüm kullanıcı haklarına sahip olan yeni hesaplar oluşturabilir.

Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2010-0487](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0487).

#### Cabview'de Bozulma Doğrulaması Güvenlik Açığı - CVE-2010-0487 için Azaltıcı Etkenler

Azaltıcı etken, varolan bir durumda bulunan ve güvenlik açığından yararlanılmasının önem derecesini azaltabilecek bir ayar, genel yapılandırma ya da en iyi uygulama anlamına gelir. Sizin durumunuzda aşağıdaki azaltıcı etkenler işinize yarayabilir:

-   Bu güvenlik açığından başarıyla yararlanan bir saldırgan, yerel kullanıcı ile aynı haklara sahip olabilir. Hesapları, sistemde az sayıda kullanıcı hakkıyla yapılandırılmış olan kullanıcılar, yönetici haklarıyla çalışan kullanıcılardan daha az etkilenebilir.

#### Cabview'de Bozulma Doğrulaması Güvenlik Açığı - CVE-2010-0487 için Geçici Çözümler

Microsoft bu güvenlik açığı için herhangi bir geçici çözüm belirleyememiştir.

#### Cabview'de Bozulma Doğrulaması Güvenlik Açığı - CVE-2010-0487 Hakkında SSS

**Bu güvenlik açığının kapsamı nedir?**  
Bu bir uzaktan kod yürütme güvenlik açığıdır. Bu güvenlik açığından başarıyla yararlanan bir saldırgan, açıktan etkilenen sistemlerde yükseltilmiş ayrıcalıklarla rasgele kod çalıştırabilir. Saldırgan, program yükleyebilir; verileri görüntüleyebilir, değiştirebilir veya silebilir; tüm kullanıcı haklarına sahip olan yeni hesaplar oluşturabilir.

**Güvenlik açığına ne neden olmaktadır?**  
Güvenlik açığı, Windows Kabin Dosyası Görüntüleyici'nin bir dolap dosyası imzalanırken ve doğrulanırken dosya özetindeki alanları atlaması nedeniyle ortaya çıkar.

**Windows Kabin Dosyası Görüntüleyici nedir?**  
Windows Kabin Dosyası Görüntüleyici (cabview.dll), Windows işletim sisteminin dolap dosyaları için görüntüleyici kabuk uzantısı olarak hizmet verir. Bu bileşen, dolap dosyalarının ve arşivlerin görüntülenmesine, açılmasına, ayıklanmasına ve bu öğelere gözatılmasına olanak verir.
...
**Bir saldırgan güvenlik açığından nasıl yararlanabilir?**  
Bu güvenlik açığından yararlanılabilmesi için kullanıcının özel hazırlanmış bir dolap dosyasını açması gerekir. Saldırgan, varolan bir imzalı dolap dosyasını imzanın doğrulanmamış bölümleri kötü amaçlı koda işaret edecek şekilde değiştirebilir. Bu kod, başlatıldığı ayrıcalık düzeyinin bağlamında yürütülür.

**Bu güvenlik açığından birincil derecede hangi sistemler etkileniyor?**  
Tüm etkilenen işletim sistemleri risk altındadır.

**Güncelleştirme ne yapıyor?**  
Güncelleştirme, bir dolap dosyası imzalanırken ve doğrulanırken dosya özetindeki tüm alanların işlenmesini zorlayarak bu güvenlik açığını giderir.
...
Windows2000-KB978601-x86-trk /quiet<br />
<br />
Cabinet File Viewer Shell Extension 5.1:<br />
Windows2000-KB979309-x86-trk /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">Authenticode Signature Verification 5.1:<br />
Windows2000-KB978601-x86-trk /norestart<br />
<br />
Cabinet File Viewer Shell Extension 5.1:<br />
Windows2000-KB979309-x86-trk /norestart</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">Authenticode Signature Verification 5.1:<br />
Evet, bu güvenlik güncelleştirmesini uyguladıktan sonra sisteminizi yeniden başlatmanız gerekir.<br />
<br />
Cabinet File Viewer Shell Extension 5.1:<br />
Bu güncelleştirme yeniden başlatma gerektirmez. Ancak, gereken dosyalar o sırada kullanılıyorsa, bu güncelleştirme için bilgisayarın yeniden başlatılması gerekir. Bu durumda, yeniden başlatmanızı öneren bir ileti görüntülenir.</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">Authenticode Signature Verification 5.1:<br />
Denetim Masası'ndaki <strong>Program Ekle veya Kaldır</strong> aracını veya %Windir%\$NTUninstallKB978601$\Spuninst klasöründe bulunan Spuninst.exe yardımcı programını kullanın<br />
<br />
Cabinet File Viewer Shell Extension 5.1:<br />
Denetim Masası'ndaki <strong>Program Ekle veya Kaldır</strong> aracını veya %Windir%\$NTUninstallKB979309$\Spuninst klasöründe bulunan Spuninst.exe yardımcı programını kullanın</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Dosya Bilgileri</strong></td>
<td style="border:1px solid black;">Authenticode Signature Verification 5.1:<br />
Bkz: <a href="http://support.microsoft.com/kb/978601">Microsoft Bilgi Bankası makalesi 978601</a><br />
<br />
Cabinet File Viewer Shell Extension 5.1:<br />
Bkz: <a href="http://support.microsoft.com/kb/979309">Microsoft Bilgi Bankası makalesi 979309</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;">Kullanıcı araya girmeden yükleme</td>
<td style="border:1px solid black;">Windows XP Service Pack 2 ve Windows XP Service Pack 3 üzerinde Authenticode Signature Verification 5.1:<br />
WindowsXP-KB978601-x86-TRK /quiet<br />
<br />
Windows XP Service Pack 2 ve Windows XP Service Pack 3 üzerinde Cabinet File Viewer Shell Extension 6.0:<br />
WindowsXP-KB979309-x86-TRK /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition Service Pack 2 üzerinde Authenticode Signature Verification 5.1:<br />
WindowsServer2003.WindowsXP-KB978601-x64-TRK /quiet  
<br />
Windows XP Professional x64 Edition Service Pack 2 üzerinde Cabinet File Viewer Shell Extension 6.0:<br />
WindowsServer2003.WindowsXP-KB979309-x64-TRK /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">Windows XP Service Pack 2 ve Windows XP Service Pack 3 üzerinde Authenticode Signature Verification 5.1:<br />
WindowsXP-KB978601-x86-TRK / norestart<br />
<br />
Windows XP Service Pack 2 ve Windows XP Service Pack 3 üzerinde Cabinet File Viewer Shell Extension 6.0:<br />
WindowsXP-KB979309-x86-TRK /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition Service Pack 2 üzerinde Authenticode Signature Verification 5.1:<br />
WindowsServer2003.WindowsXP-KB978601-x64-TRK /norestart<br />
<br />
Windows XP Professional x64 Edition Service Pack 2 üzerinde Cabinet File Viewer Shell Extension 6.0:<br />
WindowsServer2003.WindowsXP-KB979309-x64-TRK /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Güncelleştirme günlük dosyası</td>
<td style="border:1px solid black;">Authenticode Signature Verification 5.1:<br />
...
<tr class="odd">
<td style="border:1px solid black;">Kullanıcı araya girmeden yükleme</td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen 32-bit sürümleri üzerinde Authenticode Signature Verification 5.1:<br />
WindowsServer2003-KB978601-x86-TRK /quiet<br />
<br />
Windows Server 2003'ün tüm desteklenen 32-bit sürümleri üzerinde Cabinet File Viewer Shell Extension 6.0:<br />
WindowsServer2003-KB979309-x86-TRK /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen x64 tabanlı sürümleri üzerinde Authenticode Signature Verification 5.1:<br />
WindowsServer2003.WindowsXP-KB978601-x64-TRK /quiet<br />
<br />
Windows Server 2003'ün tüm desteklenen x64 tabanlı sürümleri üzerinde Cabinet File Viewer Shell Extension 6.0:<br />
WindowsServer2003.WindowsXP-KB979309-x64-TRK /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen Itanium tabanlı sürümleri üzerinde Authenticode Signature Verification 5.1:<br />
WindowsServer2003-KB978601-ia64-TRK /quiet<br />
<br />
Windows Server 2003'ün tüm desteklenen Itanium tabanlı sürümleri üzerinde Cabinet File Viewer Shell Extension 6.0:<br />
WindowsServer2003-KB979309-ia64-TRK /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen 32-bit sürümleri üzerinde Authenticode Signature Verification 5.1:<br />
WindowsServer2003-KB978601-x86-TRK /norestart<br />
<br />
Windows Server 2003'ün tüm desteklenen 32-bit sürümleri üzerinde Cabinet File Viewer Shell Extension 6.0:<br />
WindowsServer2003-KB979309-x86-TRK /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen x64 tabanlı sürümleri üzerinde Authenticode Signature Verification 5.1:<br />
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen Itanium tabanlı sürümleri üzerinde Authenticode Signature Verification 5.1:<br />
WindowsServer2003-KB978601-ia64-TRK /norestart<br />
<br />
Windows Server 2003'ün tüm desteklenen Itanium tabanlı sürümleri üzerinde Cabinet File Viewer Shell Extension 6.0:<br />
WindowsServer2003-KB979309-ia64-TRK /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Güncelleştirme günlük dosyası</td>
<td style="border:1px solid black;">Authenticode Signature Verification 5.1:<br />
...
<tr class="odd">
<td style="border:1px solid black;">Kullanıcı araya girmeden yükleme</td>
<td style="border:1px solid black;">Windows Vista'nın tüm desteklenen 32-bit sürümleri üzerinde Authenticode Signature Verification 6.0:<br />
Windows6.0-KB978601-x86 /quiet<br />
<br />
Windows Vista'nın tüm desteklenen 32-bit sürümleri üzerinde Cabinet File Viewer Shell Extension 6.0:<br />
Windows6.0-KB979309-x86 /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Vista'nın tüm desteklenen x64 tabanlı sürümleri üzerinde Authenticode Signature Verification 6.0:<br />
Windows6.0-KB978601-x64 /quiet<br />
<br />
Windows Vista'nın tüm desteklenen x64 tabanlı sürümleri üzerinde Cabinet File Viewer Shell Extension 6.0:<br />
...
<tr class="odd">
<td style="border:1px solid black;">Kullanıcı araya girmeden yükleme</td>
<td style="border:1px solid black;">Windows Server 2008'in tüm desteklenen 32-bit sürümleri üzerinde Authenticode Signature Verification 6.0:<br />
Windows6.0-KB978601-x86 /quiet<br />
<br />
Windows Server 2008'in tüm desteklenen 32-bit sürümleri üzerinde Cabinet File Viewer Shell Extension 6.0:<br />
Windows6.0-KB979309-x86 /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2008'in tüm desteklenen x64 tabanlı sürümleri üzerinde Authenticode Signature Verification 6.0:<br />
Windows6.0-KB978601-x64 /quiet<br />
<br />
Windows Server 2008'in tüm desteklenen x64 tabanlı sürümleri üzerinde Cabinet File Viewer Shell Extension 6.0:<br />
Windows6.0-KB979309-x64 /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2008'in tüm desteklenen Itanium tabanlı sürümleri üzerinde Authenticode Signature Verification 6.0:<br />
Windows6.0-KB978601-ia64 /quiet<br />
<br />
Windows Server 2008'in tüm desteklenen Itanium tabanlı sürümleri üzerinde Cabinet File Viewer Shell Extension 6.0:<br />
...
<tr class="odd">
<td style="border:1px solid black;">Kullanıcı araya girmeden yükleme</td>
<td style="border:1px solid black;">Windows 7'nin tüm desteklenen 32-bit sürümleri üzerinde Authenticode Signature Verification 6.1:<br />
Windows6.1-KB978601-x86 /quiet<br />
<br />
Windows 7'nin tüm desteklenen 32-bit sürümleri üzerinde Cabinet File Viewer Shell Extension 6.1:<br />
Windows6.1-KB979309-x86 /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows 7'nin tüm desteklenen x64 tabanlı sürümleri üzerinde Authenticode Signature Verification 6.1:<br />
Windows6.1-KB978601-x64 /quiet<br />
<br />
Windows 7'nin tüm desteklenen x64 tabanlı sürümleri üzerinde Cabinet File Viewer Shell Extension 6.1:<br />
...
<tr class="odd">
<td style="border:1px solid black;">Kullanıcı araya girmeden yükleme</td>
<td style="border:1px solid black;">Windows Server 2008 R2'nin tüm desteklenen x64 tabanlı sürümleri üzerinde Authenticode Signature Verification 6.1:<br />
Windows6.1-KB978601-x64 /quiet<br />
<br />
Windows Server 2008 R2'nin tüm desteklenen x64 tabanlı sürümleri üzerinde Cabinet File Viewer Shell Extension 6.1:<br />
Windows6.1-KB979309-x64 /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2008 R2'nin tüm desteklenen Itanium tabanlı sürümleri üzerinde Authenticode Signature Verification 6.1:<br />
Windows6.1-KB978601-ia64 /quiet<br />
<br />
Windows Server 2008 R2'nin tüm desteklenen Itanium tabanlı sürümleri üzerinde Cabinet File Viewer Shell Extension 6.1:<br />
...
-   V1.1 (14 Nisan 2010): Windows Server 2008 ve Windows Server 2008 R2 için sunucu çekirdeği bölümü yalnızca KB978601 güncelleştirmesine uygulanacak şekilde düzeltildi.  
-   V1.2 (15 Nisan 2010): Sunucu Çekirdeği yükleme seçeneğiyle yüklenmiş Windows Server 2008 ve Windows Server 2008 R2 güncelleştirmelerinde bir algılama değişikliğini duyurmak üzere Güncelleştirme Hakkında SSS bölümüne bir girdi eklendi. Bu, yalnızca bir algılama değişikliğidir. Bu bültendeki güvenlik güncelleştirmesi dosyalarında hiçbir değişiklik yapılmamıştır. Güncelleştirmeyi başarıyla yüklemiş olan müşterilerin yeniden yüklemeleri gerekmez. Bunun yanı sıra, Yürütmeyle İlgili Özet altındaki Bilinen Sorunlar bölümüne Microsoft Bilgi Bankası makalesi 981210 için bir bağlantı eklendi.  
-   V1.3 (21 Nisan 2010): 15 Nisan tarihli algılama değişikliği ile giderilen yükleme sorunlarının kapsamını açıklığa kavuşturmak üzere Güncelleştirme Hakkında SSS bölümü yeniden düzenlendi. Ayrıca Windows XP Professional x64 Edition Service Pack 2 için kayıt defteri anahtarı doğrulama girdileri düzeltildi.
