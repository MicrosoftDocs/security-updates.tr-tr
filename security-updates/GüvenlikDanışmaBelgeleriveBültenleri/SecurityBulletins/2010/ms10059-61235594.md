---
TOCTitle: 'MS10-059'
Title: 'Microsoft Güvenlik Bülteni MS10-059 - Önemli'
ms:assetid: 'ms10-059'
ms:contentKeyID: 61235594
ms:mtpsurl: 'https://technet.microsoft.com/tr-TR/library/ms10-059(v=Security.10)'
---
...
Hizmet İzleme Özelliğindeki Güvenlik Açıkları Ayrıcalık Yükselmesine İzin Verebilir (982799)
--------------------------------------------------------------------------------------------
...
Güvenlik güncelleştirmesi, belirteçlerin edinilme ve kayıt defterinden okunan bir dizenin uzunluğunun hesaplanma biçimini düzelterek bu güvenlik açıklarını giderir. Bu güvenlik açıkları hakkında daha fazla bilgi için, bir sonraki bölüm olan **Güvenlik Açığı Bilgileri** altında, ilgili güvenlik açığı girdisinin Sık Sorulan Sorular (SSS) alt bölümüne bakın.
...
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------|----------------------|---------------------------------------------|
| [Windows Vista Service Pack 1 ve Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=dfb31aa2-7457-4581-9e28-7984a360edf4)                                                            | Ayrıcalık Yükselmesi      | Önemli               | Yok                                         |
| [Windows Vista x64 Edition Service Pack 1 ve Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=110f932f-d13c-4486-a295-e6068d5d8d7a)                                    | Ayrıcalık Yükselmesi      | Önemli               | Yok                                         |
| [32-bit sistemler için Windows Server 2008 ve 32-bit sistemler için Windows Server 2008 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=4c9b3e60-e166-40c9-8938-3cba0a399c47)\*                 | Ayrıcalık Yükselmesi      | Önemli               | Yok                                         |
| [x64 tabanlı sistemler için Windows Server 2008 ve x64 tabanlı sistemler için Windows Server 2008 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=fa84e547-2190-402f-9467-2450deeff565)\*       | Ayrıcalık Yükselmesi      | Önemli               | Yok                                         |
| [Itanium tabanlı sistemler için Windows Server 2008 ve Itanium tabanlı sistemler için Windows Server 2008 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=84f89dca-108c-4956-9aa2-866e17a872fc) | Ayrıcalık Yükselmesi      | Önemli               | Yok                                         |
| [32-bit sistemler için Windows 7](http://www.microsoft.com/downloads/details.aspx?familyid=ce6233f3-2ee5-4329-908d-ba9b28ecc553)                                                                                         | Ayrıcalık Yükselmesi      | Önemli               | Yok                                         |
| [x64 tabanlı sistemler için Windows 7](http://www.microsoft.com/downloads/details.aspx?familyid=146270fa-cd6f-440a-aa3e-e93af0bff447)                                                                                    | Ayrıcalık Yükselmesi      | Önemli               | Yok                                         |
| [x64 tabanlı sistemler için Windows Server 2008 R2](http://www.microsoft.com/downloads/details.aspx?familyid=333fb6e4-f867-4dcb-beb3-2d88e428ca2e)\*                                                                     | Ayrıcalık Yükselmesi      | Önemli               | Yok                                         |
| [Itanium tabanlı sistemler için Windows Server 2008 R2](http://www.microsoft.com/downloads/details.aspx?familyid=62034ecb-a6bd-46c5-a03d-9642880bc2d6)                                                                   | Ayrıcalık Yükselmesi      | Önemli               | Yok                                         |
...
<th style="border:1px solid black;" >İzleme Kayıt Defteri Anahtarı ACL'sinde Güvenlik Açığı - CVE-2010-2554</th>
<th style="border:1px solid black;" >İzleme Sırasında Bellek Bozulması Güvenlik Açığı - CVE-2010-2555</th>
...
İzleme Kayıt Defteri Anahtarı ACL'sinde Güvenlik Açığı - CVE-2010-2554  
----------------------------------------------------------------------
  
<span></span>
Windows'un Hizmet İzleme Özelliği için kayıt defteri anahtarlarına hatalı erişim denetim listeleri (ACL) yerleştirmesi nedeniyle bir ayrıcalık yükselmesi güvenlik açığı bulunmaktadır. Güvenlik açığı bir saldırganın yükseltilmiş ayrıcalıklarla kod çalıştırılmasına izin verebilir. Bu güvenlik açığından başarıyla yararlanan bir saldırgan rasgele kod yürütebilir ve etkilenen sistemin tüm denetimini ele geçirebilir. Saldırgan, program yükleyebilir; verileri görüntüleyebilir, değiştirebilir veya silebilir; tüm kullanıcı haklarına sahip olan yeni hesaplar oluşturabilir.
  
Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz. [CVE-2010-2554](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2554).
  
#### İzleme Kayıt Defteri Anahtarı ACL'sinde Güvenlik Açığı - CVE-2010-2554 için Azaltıcı Etkenler
...
#### İzleme Kayıt Defteri Anahtarı ACL'sinde Güvenlik Açığı - CVE-2010-2554 için Geçici Çözümler
  
Microsoft bu güvenlik açığı için herhangi bir geçici çözüm belirleyememiştir.
  
#### İzleme Kayıt Defteri Anahtarı ACL'sinde Güvenlik Açığı - CVE-2010-2554 Hakkında SSS
...
Güvenlik açığı, Windows'un Hizmet İzleme Özelliği için kayıt defteri anahtarlarına hatalı erişim denetim listeleri (ACL) yerleştirmesi nedeniyle oluşur. Bu durum, bir saldırganın adlandırılmış kanal izleme dizinini değiştirmesine ve bir adlandırılmış kanal dinleyicisi oluşturmasına olanak verir. Adlandırılmış kanal oluşturulduktan sonra, saldırgan bunun kimliğine bürünerek, adlandırılmış kanalı oluşturan hizmetin belirteçlerini edinebilir. Oluşturan hizmet Yerel Sistem bağlamında çalışıyorsa (örneğin, IpHlpSvc hizmeti), saldırgan Yerel Sistem belirteçlerini edinip kullanabilir.
  
**Erişim Denetim Listesi (ACL) nedir?**    
Erişim denetim listesi (ACL), bir nesneye uygulanan güvenlik korumalarının listesidir. Bu nesne bir dosya, işlem, olay veya güvenlik tanımlayıcısı olan bir varlık olabilir. ACL'deki bir girdiye erişim denetim girdisi (ACE) adı verilir. İki tür erişim denetim listesi vardır: isteğe bağlı ve sistem. ACL'deki her bir ACE, güvenilen öğe için izin verilen, reddedilen veya denetlenen erişim haklarını tanımlar. Ek bilgi için, [Erişim Denetim Listeleri](http://msdn.microsoft.com/en-us/library/aa374872(vs.85).aspx) adlı MSDN makalesine bakın.
  
**Adlandırılmış kanal nedir?**    
Adlandırılmış kanal, yöneltme sunucusu ve bir veya daha fazla yöneltme istemcisi arasındaki iletişim için adlandırılmış tek yönlü veya çift yönlü bir kanaldır. Adlandırılmış kanalın tüm örnekleri aynı kanal adını kullanır, ancak her örneğin kendi arabellek ve tanıtıcıları vardır ve istemci/sunucu iletişimi için ayrı bir kanal sağlar. Örneklerin kullanılması, birden çok yöneltme istemcisinin aynı adlandırılmış kanalı eşzamanlı olarak kullanmasına olanak verir. Tüm işlemler güvenlik denetimi yapılarak adlandırılmış kanallara erişebileceği için, adlandırılmış kanallar ilişkili veya ilişkisiz işlemler arasında kolay bir iletişim şekli oluşturur. Daha fazla bilgi için, [Adlandırılmış Kanallar](http://msdn.microsoft.com/en-us/library/aa365590(vs.85).aspx) adlı MSDN makalesine bakın.
  
**Yönlendirme Yardımcı Programları Bileşeni (rtutils.dll) nedir?**    
Yönlendirme yardımcı programları bileşeni (rtutils.dll), izleme amacıyla kullanılan işlevleri içeren bir modüldür ve çeşitli hizmet bileşenleri için tanılama çıktısı üretmek üzere benzersiz bir mekanizma sağlar. Bir bileşen Rtutils izleme mekanizmasını kullandığında, izleme verilerini depolamak için kayıt defterinde HKLM\\Software\\Microsoft\\Tracing\\ anahtarının altında depolanan bileşene özel izleme ayarlarını kullanılır.
...
Güncelleştirme, belirteçlerin kimliğe bürünme aracılığıyla edinilme şeklini düzelterek bu güvenlik açığını giderir.
  
**Bu güvenlik bülteni yayımlandığında bu güvenlik açığı genel olarak duyurulmuş muydu?**    
Evet. Bu güvenlik açığı genel olarak duyurulmuştur. Ortak Güvenlik Açığı ve Etkilenme (Common Vulnerability and Exposure) numarası olarak [CVE-2010-2554](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2554) atanmıştır.
...
İzleme Sırasında Bellek Bozulması Güvenlik Açığı - CVE-2010-2555  
----------------------------------------------------------------
  
<span></span>
Hizmet İzleme Özelliği'nin kayıt defterindeki uzun olacak şekilde özel hazırlanmış dizeleri işlerken belleği ayırma biçimi nedeniyle bir ayrıcalık yükselmesi güvenlik açığı bulunmaktadır. Bu güvenlik açığından başarıyla yararlanan bir saldırgan, sistem düzeyinde ayrıcalıklarla rasgele kod çalıştırabilir. Saldırgan, program yükleyebilir; verileri görüntüleyebilir, değiştirebilir veya silebilir; tüm kullanıcı haklarına sahip olan yeni hesaplar oluşturabilir.
  
Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz. [CVE-2010-2555](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2555).
  
#### İzleme Sırasında Bellek Bozulması Güvenlik Açığı - CVE-2010-2555 için Azaltıcı Etkenler
  
Azaltıcı etken, varolan bir durumda bulunan ve güvenlik açığından yararlanılmasının önem derecesini azaltabilecek bir ayar, genel yapılandırma ya da en iyi uygulama anlamına gelir. Sizin durumunuzda aşağıdaki azaltıcı etkenler işinize yarayabilir:
  
-   Saldırganın bu güvenlik açığından yararlanabilmesi için geçerli oturum açma kimlik bilgilerine sahip olması ve yerel olarak oturum açabilmesi gerekir. Bu güvenlik açığı uzaktan veya anonim kullanıcılar tarafından kullanılamaz.
  
#### İzleme Sırasında Bellek Bozulması Güvenlik Açığı - CVE-2010-2555 için Geçici Çözümler
  
Microsoft bu güvenlik açığı için herhangi bir geçici çözüm belirleyememiştir.
  
#### İzleme Sırasında Bellek Bozulması Güvenlik Açığı - CVE-2010-2555 Hakkında SSS
  
**Bu güvenlik açığının kapsamı nedir?**    
Bu bir ayrıcalık yükselmesi güvenlik açığıdır. Bu güvenlik açığından başarıyla yararlanan bir saldırgan rasgele kod yürütebilir ve etkilenen sistemin tüm denetimini ele geçirebilir. Saldırgan, program yükleyebilir; verileri görüntüleyebilir, değiştirebilir veya silebilir; tüm kullanıcı haklarına sahip olan yeni hesaplar oluşturabilir.
  
**Güvenlik açığına ne neden olmaktadır?**    
Güvenlik açığı, Hizmet İzleme Özelliği'nin kayıt defterinden okunan belirli dizelerin uzunluğunu hatalı hesaplaması nedeniyle ortaya çıkar.
...
**Güncelleştirme ne yapıyor?**    
Güncelleştirme, Hizmet İzleme Özelliği'nin kayıt defterinden okunan bir dizenin uzunluğunu hesaplama biçimini düzelterek bu güvenlik açığını giderir.
...
<td style="border:1px solid black;">Bkz: <a href="http://support.microsoft.com/kb/982799">Microsoft Bilgi Bankası makalesi 982799</a></td>
</tr>
<tr class="odd">
...
-   [Argeniss](http://www.argeniss.com/) için çalışan Cesar Cerrudo, İzleme Kayıt Defteri Anahtarı ACL'sinde Güvenlik Açığı'nı (CVE-2010-2554) bildirdiği için  
-   [Argeniss](http://www.argeniss.com/) için çalışan Cesar Cerrudo, İzleme Sırasında Bellek Bozulması Güvenlik Açığı'nı (CVE-2010-2555) bildirdiği için
