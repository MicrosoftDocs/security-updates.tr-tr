---
TOCTitle: 'MS10-084'
Title: 'Microsoft Güvenlik Bülteni MS10-084 - Önemli'
ms:assetid: 'ms10-084'
ms:contentKeyID: 61235619
ms:mtpsurl: 'https://technet.microsoft.com/tr-TR/library/ms10-084(v=Security.10)'
---

Security Bulletin

Microsoft Güvenlik Bülteni MS10-084 - Önemli
============================================

Windows Yerel Yordam Çağrısı'ndaki Güvenlik Açığı Ayrıcalık Yükselmesine Neden Olabilir (2360937)
-------------------------------------------------------------------------------------------------
...
|---------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------|----------------------|-----------------------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=6049c879-b81a-4d10-b96b-b2837cb24834)                              | Ayrıcalık Yükselmesi      | Önemli               | [MS10-066](http://go.microsoft.com/fwlink/?linkid=197105) |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=d690846c-5e0b-4216-84cd-d17e366dd16d)     | Ayrıcalık Yükselmesi      | Önemli               | [MS10-066](http://go.microsoft.com/fwlink/?linkid=197105) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=b31e18b0-da9f-4b3b-82c6-603e08b3b241)                     | Ayrıcalık Yükselmesi      | Önemli               | [MS10-066](http://go.microsoft.com/fwlink/?linkid=197105) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=1d73f0f1-6ec8-4304-a20e-345d8b6c225a)         | Ayrıcalık Yükselmesi      | Önemli               | [MS10-066](http://go.microsoft.com/fwlink/?linkid=197105) |
| [Itanium tabanlı sistemler için Windows Server 2003 SP2](http://www.microsoft.com/downloads/details.aspx?familyid=8fad4f77-7c89-4684-b957-9c00ced248d3) | Ayrıcalık Yükselmesi      | Önemli               | [MS10-066](http://go.microsoft.com/fwlink/?linkid=197105) |
...
<th style="border:1px solid black;" >LPC İletisinde Arabellek Taşması Güvenlik Açığı - CVE-2010-3222</th>
...
LPC İletisinde Arabellek Taşması Güvenlik Açığı - CVE-2010-3222  
---------------------------------------------------------------
  
<span></span>
NetworkService hesabı bağlamında çalışan Uzaktan Yordam Çağrısı Alt Sistemi'nde (RPCSS), yerel bir uygulamanın LPC kullanarak LPC sunucusunun istemciye geri bağlanmasını istemesine olanak veren bir ayrıcalık yükselmesi güvenlik açığı bulunmaktadır. Bu istek, yığına dayalı bir arabellek taşmasına neden olacak şekilde özel olarak tasarlanmış veriler içerebilir ve böylece kimliği doğrulanmış bir kullanıcının NetworkService hesabı bağlamında çalışan kaynaklara erişim sağlamasına olanak verebilir.
  
Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2010-3222](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3222).
  
#### LPC İletisinde Arabellek Taşması Güvenlik Açığı - CVE-2010-3222 için Azaltıcı Etkenler
...
#### LPC İletisinde Arabellek Taşması Güvenlik Açığı - CVE-2010-3222 için Geçici Çözümler
  
Microsoft bu güvenlik açığı için herhangi bir geçici çözüm belirleyememiştir.
  
#### LPC İletisinde Arabellek Taşması Güvenlik Açığı - CVE-2010-3222 Hakkında SSS
  
**Bu güvenlik açığının kapsamı nedir?**    
Bu bir ayrıcalık yükselmesi güvenlik açığıdır. Bu güvenlik açığından başarıyla yararlanılan kullanıcı kimlik bilgilerine sahip olan bir saldırgan, NetworkService hesabı bağlamında kod yürütebilir.
  
**Güvenlik açığına ne neden olmaktadır?**    
Bu güvenlik açığı, RPCSS içinde bulunan LPC ve LRPC Sunucusu (RPC Bitiş Noktası Eşleştiricisi) arasındaki bağlantı noktası iletilerinin alış verişi sırasında oluşan yığına dayalı bir arabellek taşması nedeniyle ortaya çıkar.
  
**Güvenlik açığından etkilenen bileşen hangisidir?**    
Bu güvenlik açığından etkilenen bileşen, Uzaktan Yordam Çağrısı'nın (RPC) bir bileşeni olan Microsoft Yerel Yordam Çağrısı'dır (LPC).
  
**LPC nedir?**  
Yerel Yordam Çağrısı (LPC), Windows ile birlikte gelen bir ileti geçirme hizmetidir. Bu hizmet, iş parçacıklarının ve işlemlerin birbiriyle iletişim kurmasına olanak verir. Bir istemci işleminin sunucu işleminden bir hizmet istemesi gerektiğinde, iki işlemin birbiriyle iletişim kurabilmesinin bir yolu olmalıdır. İstemci işleminin sunucudan istekte bulunabilmesi, sunucunun istemciye yanıt gönderebilmesi ve bu iki öğenin birbirlerinin durumlarını belirleyebilmesi gerekir. İstemci ve sunucu işlemleri farklı sistemlerde bulunduğunda, Uzaktan Yordam Çağrısı (RPC) kullanılır. Aynı sistemde bulunduklarında, LPC kullanılabilir.
  
**RPC nedir?**  
Uzaktan Yordam Çağrısı (RPC), veri değişimine ve farklı bir işlemde bulunan işlevselliğe çağrıda bulunulmasına olanak veren bir işlemler arası iletişim (IPC) mekanizmasıdır. Bu işlem aynı bilgisayarda, yerel ağda (LAN) veya Internet üzerinde olabilir. Microsoft RPC mekanizması, istemci ile sunucu arasındaki iletişimi sağlamak için adlandırılmış kanallar, NetBIOS veya Winsock gibi diğer IPC mekanizmalarını kullanır. RPC sayesinde, önemli program mantığı ve ilgili yordam kodu farklı bilgisayarlarda bulunabilir; bu özellik, dağıtılmış uygulamalar açısından önemlidir. Daha fazla bilgi için, [RPC Nedir?](http://technet.microsoft.com/en-us/library/cc787851(ws.10).aspx) adlı TechNet makalesine bakın.
  
**LRPC nedir?**  
Yerel RPC (LRPC), yerel sistemde gerçekleşen RPC iletişimi anlamına gelir.
  
**Bir saldırgan bu güvenlik açığından yararlanarak neler yapabilir?**    
Bu güvenlik açığından başarıyla yararlanan bir saldırgan NetworkService hesabı bağlamında özel hazırlanmış kod çalıştırarak, NetworkService altında çalışan kaynaklara erişim sağlayabilir. Bu işlemlerin bazıları ayrıcalık düzeylerini LocalSystem bağlamına yükselterek, NetworkService işlemlerinin de ayrıcalık düzeylerini LocalSystem bağlamına yükseltmelerine izin verebilir. Saldırgan, program yükleyebilir; verileri görüntüleyebilir, değiştirebilir veya silebilir; tüm kullanıcı haklarına sahip olan yeni hesaplar oluşturabilir.
  
**Bir saldırgan güvenlik açığından nasıl yararlanabilir?**    
Geçerli kimlik bilgileriyle yerel olarak oturum açan bir saldırgan, yerel LRPC sunucusuna bir LPC iletisi gönderen özel hazırlanmış kod çalıştırarak bu güvenlik açığından yararlanabilir. Bu ileti daha sonra kimliği doğrulanmış bir kullanıcının NetworkService hesabı bağlamında kod yürütmesine olanak verebilir.
...
Güncelleştirme, LPC bağlantı noktası iletilerinin RPCSS içinde işlenme biçimini değiştirerek bu güvenlik açığını giderir.
  
**Bu güvenlik bülteni yayımlandığında bu güvenlik açığı genel olarak duyurulmuş muydu?**    
Evet. Bu güvenlik açığı genel olarak duyurulmuştur. Ortak Güvenlik Açığı ve Etkilenme (Common Vulnerability and Exposure) numarası olarak [CVE-2010-3222](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3222) atanmıştır.
...
WindowsXP-KB2360937-x86-trk.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition Service Pack 2:<br />
WindowsServer2003.WindowsXP-KB2360937-x64-trk.exe /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">Windows XP Service Pack 3 için:<br />
WindowsXP-KB2360937-x86-trk.exe /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition Service Pack 2:<br />
WindowsServer2003.WindowsXP-KB2360937-x64-trk.exe /norestart</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">Denetim Masası'ndaki <strong>Program Ekle veya Kaldır</strong> aracını veya %Windir%\$NTUninstallKB2360937$\Spuninst klasöründe bulunan Spuninst.exe yardımcı programını kullanın</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Dosya Bilgileri</strong></td>
<td style="border:1px solid black;">Bkz: <a href="http://support.microsoft.com/kb/2360937">Microsoft Bilgi Bankası makalesi 2360937</a></td>
</tr>
<tr class="even">
...
WindowsServer2003-KB2360937-x86-trk.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
WindowsServer2003-KB2360937-ia64-trk.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen 32 bit sürümleri:<br />
WindowsServer2003-KB2360937-x86-trk.exe /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen x64 tabanlı sürümleri:<br />
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen Itanium tabanlı sürümleri:<br />
WindowsServer2003-KB2360937-ia64-trk.exe /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Güncelleştirme günlük dosyası</td>
<td style="border:1px solid black;">KB2360937.log</td>
