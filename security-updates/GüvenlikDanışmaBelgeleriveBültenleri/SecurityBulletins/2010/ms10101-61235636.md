---
TOCTitle: 'MS10-101'
Title: 'Microsoft Güvenlik Bülteni MS10-101 - Önemli'
ms:assetid: 'ms10-101'
ms:contentKeyID: 61235636
ms:mtpsurl: 'https://technet.microsoft.com/tr-TR/library/ms10-101(v=Security.10)'
---

Security Bulletin

Microsoft Güvenlik Bülteni MS10-101 - Önemli
============================================

Windows Netlogon Hizmeti'ndeki Güvenlik Açığı Hizmet Reddine Olanak Verebilir (2207559)
---------------------------------------------------------------------------------------
...
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------|----------------------|---------------------------------------------|
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=ad843b97-2f6e-4406-a17a-627b7db8a926)                                                                                | Hizmet Reddi              | Önemli               | Yok                                         |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=0b0a06e7-0ae5-41f4-9ff5-d524fc0afbfa)                                                                    | Hizmet Reddi              | Önemli               | Yok                                         |
| [Itanium tabanlı sistemler için Windows Server 2003 SP2](http://www.microsoft.com/downloads/details.aspx?familyid=7c0c2850-e81d-4347-aeb3-47036caa7c1b)                                                            | Hizmet Reddi              | Önemli               | Yok                                         |
| [32-bit sistemler için Windows Server 2008 ve 32-bit sistemler için Windows Server 2008 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=6793f75b-cdf4-42ef-a53e-a1acb5b662d1)\*           | Hizmet Reddi              | Önemli               | Yok                                         |
| [x64 tabanlı sistemler için Windows Server 2008 ve x64 tabanlı sistemler için Windows Server 2008 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=85add876-ca5a-4a92-984e-188a72e349fc)\* | Hizmet Reddi              | Önemli               | Yok                                         |
| [x64 tabanlı sistemler için Windows Server 2008 R2](http://www.microsoft.com/downloads/details.aspx?familyid=d7307afd-84a0-434e-9658-bf9f8ae4b938)\*                                                               | Hizmet Reddi              | Önemli               | Yok                                         |
...
<th style="border:1px solid black;" >Netlogon RPC'de Boş Başvuru DOS Güvenlik Açığı - CVE-2010-2742</th>
...
Netlogon RPC'de Boş Başvuru DOS Güvenlik Açığı - CVE-2010-2742  
--------------------------------------------------------------
  
<span></span>
Windows Server'ın etkilenen sürümleri üzerinde Netlogon RPC Hizmeti uygulamalarında kimliği doğrulanmış uzaktan hizmet reddi güvenlik açığı bulunmaktadır. Bu güvenlik açığından başarıyla yararlanan bir saldırgan Windows Server'ın etkilenen sürümlerinin yeniden başlatılmasına neden olabilir.
  
Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2010-2742](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2742).
  
#### Netlogon RPC'de Boş Başvuru DOS Güvenlik Açığı - CVE-2010-2742 için Azaltıcı Etkenler
  
Azaltıcı etken, varolan bir durumda bulunan ve güvenlik açığından yararlanılmasının önem derecesini azaltabilecek bir ayar, genel yapılandırma ya da en iyi uygulama anlamına gelir. Sizin durumunuzda aşağıdaki azaltıcı etkenler işinize yarayabilir:
  
-   Bu güvenlik açığı yalnızca etki alanı denetleyicisi olarak yapılandırılmış olan Windows sunucularını etkiler.  
-   Saldırganın bu güvenlik açığından yararlanabilmesi için, etkilenen etki alanı denetleyicisi ile aynı etki alanına katılmış bir makinede yönetici ayrıcalıklarına sahip olması gerekir.
  
#### Netlogon RPC'de Boş Başvuru DOS Güvenlik Açığı - CVE-2010-2742 için Geçici Çözümler
  
Microsoft bu güvenlik açığı için herhangi bir geçici çözüm belirleyememiştir.
  
#### Netlogon RPC'de Boş Başvuru DOS Güvenlik Açığı - CVE-2010-2742 Hakkında SSS
  
**Bu güvenlik açığının kapsamı nedir?**    
Bu bir hizmet reddi güvenlik açığıdır. Bu güvenlik açığından yararlanan bir saldırgan, etkilenen sistemin yeniden başlatılmasına neden olabilir. Hizmet reddi güvenlik açığının, bir saldırganın kod yürütmesine veya kullanıcı haklarını yükseltmesine izin vermeyeceğini, ancak etkilenen sistemin yeniden başlatılmasına neden olabileceğini unutmayın.
  
**Güvenlik açığına ne neden olmaktadır?**    
Güvenlik açığı, Netlogon RPC Hizmeti'nin kullanıcı tarafından sağlanan verileri hatalı doğrulaması nedeniyle ortaya çıkar.
  
**Netlogon RPC nedir?**    
Netlogon Uzak Protokolü, etki alanı tabanlı ağlarda kullanıcı ve makine kimliğini doğrulamak için kullanılan bir uzaktan yordam çağrısı (RPC) arabirimidir. Netlogon RPC hakkında daha fazla bilgi için, [Netlogon Uzak Protokolü Belirtimi](http://msdn.microsoft.com/en-us/library/cc237009(v=prot.10).aspx) adlı MSDN makalesine bakın.
  
**Bir saldırgan bu güvenlik açığından yararlanarak neler yapabilir?**    
Bu güvenlik açığından başarıyla yararlanan bir saldırgan, etki alanı denetleyicilerinin yeniden başlatılmasına neden olabilir.
  
**Bir saldırgan güvenlik açığından nasıl yararlanabilir?**    
Saldırgan, Netlogon RPC Hizmeti arabirimine özel hazırlanmış bir RPC paketi göndererek bu güvenlik açığından yararlanabilir. Tüm etkilenen platformlarda, saldırganın bu güvenlik açığından yararlanabilmesi için yönetici ayrıcalıkları olan geçerli kimlik doğrulama bilgilerine sahip olması gerekir.
  
**Bu güvenlik açığından birincil derecede hangi sistemler etkileniyor?**    
Etki alanı denetleyicisi olarak yapılandırılmış olan ve Netlogon hizmetini barındıran Windows Server'lar bu güvenlik açığından etkilenir. Windows istemci işletim sistemleri bu güvenlik açığından etkilenmez.
  
**Windows Server'ın bir etki alanı denetleyicisi olarak yapılandırılmış olup olmadığını nasıl anlayabilirim?**    
HKLM\\SYSTEM\\CurrentControlSet\\Control\\ProductOptions\\ProductType kayıt defteri anahtarı LanmanNT olarak ayarlanmışsa, sisteminiz bir etki alanı denetleyicisi olarak yapılandırılmış demektir.
  
**Güncelleştirme ne yapıyor?**    
Güncelleştirme, Netlogon RPC Hizmeti arabirimindeki kullanıcı tarafından sağlanan verilerin düzgün şekilde doğrulanmasını sağlayarak bu güvenlik açığını giderir.
...
WindowsServer2003-KB2207559-x86-trk.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen x64 tabanlı sürümleri:<br />
WindowsServer2003.WindowsXP-KB2207559-x64-trk.exe /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen Itanium tabanlı sürümleri:<br />
WindowsServer2003-KB2207559-ia64-trk.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen 32 bit sürümleri:<br />
WindowsServer2003-KB2207559-x86-trk.exe /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen x64 tabanlı sürümleri:<br />
WindowsServer2003.WindowsXP-KB2207559-x64-trk.exe /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen Itanium tabanlı sürümleri:<br />
WindowsServer2003-KB2207559-ia64-trk.exe /norestart</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">Denetim Masası'ndaki <strong>Program Ekle veya Kaldır</strong> aracını veya %Windir%\$NTUninstallKB2207559$\Spuninst klasöründe bulunan Spuninst.exe yardımcı programını kullanın</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Dosya Bilgileri</strong></td>
<td style="border:1px solid black;">Bkz: <a href="http://support.microsoft.com/kb/2207559">Microsoft Bilgi Bankası makalesi 2207559</a></td>
</tr>
<tr class="even">
...
-   The Samba Team için çalışan Matthias Dieter Wallnöfer ve Andrew Bartlett, Netlogon RPC'de Boş Başvuru DOS Güvenlik Açığı'nı (CVE-2010-2742) bildirdikleri için
