---
TOCTitle: 'MS09-002'
Title: 'Microsoft Güvenlik Bülteni MS09-002 - Kritik'
ms:assetid: 'ms09-002'
ms:contentKeyID: 61235463
ms:mtpsurl: 'https://technet.microsoft.com/tr-TR/library/ms09-002(v=Security.10)'
---

Security Bulletin

Microsoft Güvenlik Bülteni MS09-002 - Kritik
============================================

Internet Explorer için Toplu Güvenlik Güncelleştirmesi (961260)
---------------------------------------------------------------

Yayım Tarihi: 10 Şubat 2009 Salı | Güncelleştirme Tarihi: 16 Şubat 2009 Pazartesi
...
Bu güvenlik güncelleştirmesi Windows XP ve Windows Vista'nın desteklenen sürümleri üzerinde çalıştırıldığında Internet Explorer 7 için Kritik olarak derecelendirilmiştir. Windows Server 2003 ve Windows Server 2008'in desteklenen sürümleri üzerinde çalıştırıldığında Internet Explorer 7 için, bu güvenlik güncelleştirmesi Orta olarak derecelendirilmiştir. Daha fazla bilgi için, bu bölümdeki **Etkilenen ve Etkilenmeyen Yazılımlar** alt bölümüne bakın.
...
**Bilinen Sorunlar.** [Microsoft Bilgi Bankası makalesi 961260](http://support.microsoft.com/kb/961260), bu güvenlik güncelleştirmesini yükleyen müşterilerin karşılaşabileceği bilinen sorunları belgelemektedir. Bu makale ayrıca, bu sorunlar için önerilen çözümleri de içermektedir. Bilinen sorunlar ve önerilen çözümler bu yazılımın yalnızca belirli sürümlerine yöneliktir, ancak bu makalede başka makalelere bağlantılar da sağlanır.
...
| Windows XP Service Pack 2 ve Windows XP Service Pack 3                                                           | Microsoft Internet Explorer 6                   |
| Windows XP Professional x64 Edition ve Windows XP Professional x64 Edition Service Pack 2                        | Microsoft Internet Explorer 6                   |
| Windows Server 2003 Service Pack 1 ve Windows Server 2003 Service Pack 2                                         | Microsoft Internet Explorer 6                   |
| Windows Server 2003 x64 Edition ve Windows Server 2003 x64 Edition Service Pack 2                                | Microsoft Internet Explorer 6                   |
| Itanium tabanlı sistemler için Windows Server 2003 SP1 ve Itanium tabanlı sistemler için Windows Server 2003 SP2 | Microsoft Internet Explorer 6                   |
...
Dosya bilgileri ayrıntıları [Microsoft Bilgi Bankası makalesi 961260](http://support.microsoft.com/kb/961260)'ta bulunabilir.
...
<th style="border:1px solid black;" >
Başlatılmamış Belleğin Bozulması Güvenlik Açığı - CVE-2009-0075
</th>
<th style="border:1px solid black;" >
CSS Bellek Bozulması Güvenlik Açığı - CVE-2009-0076
</th>
<th style="border:1px solid black;" >
Toplam Önem Derecesi
</th>
...
Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2009-0075](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0075).

#### Başlatılmamış Belleğin Bozulması Güvenlik Açığı - CVE-2009-0075 için Azaltıcı Etkenler
...
-   Bu güvenlik açığı yalnızca Windows Internet Explorer 7'yi etkiler. Microsoft Internet Explorer 5 ve Microsoft Internet Explorer 6'nın desteklenen sürümlerini etkilemez.

#### Başlatılmamış Belleğin Bozulması Güvenlik Açığı - CVE-2009-0075 için Geçici Çözümler
...
#### Başlatılmamış Belleğin Bozulması Güvenlik Açığı - CVE-2009-0075 Hakkında SSS
...
<span></span>
Internet Explorer'ın, Basamaklı Stil Sayfaları'nı (CSS) işleme biçiminde bir uzaktan kod yürütme güvenlik açığı bulunmaktadır. Saldırgan, özel hazırlanmış bir Web sayfası oluşturarak bu güvenlik açığından yararlanabilir. Bir kullanıcı bu Web sayfasını görüntülediğinde, güvenlik açığı uzaktan kod yürütülmesine izin verebilir. Bu güvenlik açığından başarıyla yararlanan bir saldırgan, oturum açan kullanıcı ile aynı haklara sahip olabilir.

Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2009-0076](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0076).

#### CSS Bellek Bozulması Güvenlik Açığı - CVE-2009-0076 için Azaltıcı Etkenler
...
#### CSS Bellek Bozulması Güvenlik Açığı - CVE-2009-0076 için Geçici Çözümler
...
#### CSS Bellek Bozulması Güvenlik Açığı - CVE-2009-0076 Hakkında SSS
...
**Güvenlik açığına ne neden olmaktadır? **
Internet Explorer belirli CSS stilleri içeren bir Web sayfasını görüntülerken, bir saldırganın oturum açan kullanıcının bağlamında rasgele kod yürütmesine olanak verecek biçimde belleği bozabilir.
...
**CSS nedir?**  
Basamaklı Stil Sayfaları veya kısaca CSS, HTML kullanan Web sayfaları için bir biçimlendirme yöntemidir. CSS hakkında daha fazla bilgi için [Microsoft TechNet Web sitesini](http://www.microsoft.com/technet/prodtechnol/windows2000serv/reskit/iisbook/c06_cascading_style_sheets.mspx?mfr=true) ziyaret edin.

**Güncelleştirme ne yapıyor? **
Güncelleştirme, Internet Explorer'ın Basamaklı Stil Sayfaları'nı işleme biçimini değiştirir.
...
| Windows Server 2003 Service Pack 1 ve Microsoft Windows Server 2003 Service Pack 2                               | Hayır   | Hayır                       | Evet                                                                       | Evet                       |
...
IE7-WindowsXP-KB961260-x86-trk /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
IE7-WindowsServer2003.WindowsXP-KB961260-x64-trk /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme </td>
<td style="border:1px solid black;">Windows XP Service Pack 2 ve Windows XP Service Pack 3 için Internet Explorer 7:<br />
IE7-WindowsXP-KB961260-x86-trk /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition ve Windows XP Professional x64 Edition Service Pack 2 için Internet Explorer 7:<br />
IE7-WindowsServer2003.WindowsXP-KB961260-x64-trk /norestart</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">Windows XP'nin tüm desteklenen sürümleri için Internet Explorer 7:<br />
Denetim Masası'ndaki Program Ekle veya Kaldır aracını veya %Windir%\ie7updates\KB961260-IE7\spuninst klasöründe bulunan Spuninst.exe yardımcı programını kullanın</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Dosya Bilgileri</strong></td>
<td style="border:1px solid black;">Bkz: <a href="http://support.microsoft.com/kb/961260">Microsoft Bilgi Bankası makalesi 961260</a></td>
</tr>
<tr class="even">
...
IE7-WindowsServer2003-KB961260-x86-trk /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
IE7-WindowsServer2003-KB961260-ia64-trk /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme </td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen 32-bit sürümleri için Internet Explorer 7:<br />
IE7-WindowsServer2003-KB961260-x86-trk /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen x64 tabanlı sürümleri için Internet Explorer 7:<br />
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen Itanium tabanlı sürümleri için Internet Explorer 7:<br />
IE7-WindowsServer2003-KB961260-ia64-trk /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Güncelleştirme günlük dosyası </td>
...
-   [TippingPoint](http://www.tippingpoint.com/) ve [Zero Day Initiative](http://www.zerodayinitiative.com/), Başlatılmamış Belleğin Bozulması Güvenlik Açığı'nı (CVE-2009-0075) bildirdikleri için  
-   Sam Thomas (<http://eshu.co.uk/>), [TippingPoint](http://www.tippingpoint.com/) ve [Zero Day Initiative](http://www.zerodayinitiative.com/) ile birlikte çalışarak CSS Bellek Bozulması Güvenlik Açığı'nı (CVE-2009-0076) bildirdikleri için
...
-   V1.1 (16 Şubat 2009): **Yürütmeyle İlgili Özet** altındaki Bilinen Sorunlar bölümüne Microsoft Bilgi Bankası makalesi 961260 için bir bağlantı eklendi.
