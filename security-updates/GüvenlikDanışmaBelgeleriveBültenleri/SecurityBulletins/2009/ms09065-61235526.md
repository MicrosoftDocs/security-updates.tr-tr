---
TOCTitle: 'MS09-065'
Title: 'Microsoft Güvenlik Bülteni MS09-065 - Kritik'
ms:assetid: 'ms09-065'
ms:contentKeyID: 61235526
ms:mtpsurl: 'https://technet.microsoft.com/tr-TR/library/ms09-065(v=Security.10)'
---

Security Bulletin

Microsoft Güvenlik Bülteni MS09-065 - Kritik
============================================

Windows Çekirdek Modu Sürücülerindeki Güvenlik Açıkları Uzaktan Kod Yürütülmesine İzin Verebilir (969947)
---------------------------------------------------------------------------------------------------------
...
Bu güvenlik güncelleştirmesi Windows çekirdeğindeki özel olarak bildirilen birkaç güvenlik açığını giderir. Bu güvenlik açıklarının önem düzeyi en yüksek olanları, bir kullanıcı özel hazırlanmış bir Katıştırılmış OpenType (EOT) yazı tipinde işlenmiş içeriği görüntülerse uzaktan kod yürütülmesine izin verebilir. Web tabanlı saldırı senaryosunda, saldırganın, bu açıktan yararlanma girişimi için özel hazırlanan katıştırılmış yazı tiplerinin bulunduğu bir Web sitesi barındırması gerekir. Ayrıca, kullanıcı tarafından sağlanan içeriği kabul eden ya da barındıran güvenliği aşılmış Web sitelerinde, bu güvenlik açığından yararlanılabilecek özel hazırlanmış içerik bulunabilir. Saldırganın, bir kullanıcıyı özel hazırlanmış bir Web sitesini ziyaret etmeye zorlama yolu yoktur. Bunun yerine, saldırganın kullanıcıyı bir e-posta iletisindeki veya Instant Messenger iletisindeki kendi Web sitesine götüren bir bağlantıyı tıklatmaya ikna ederek onu bu siteye çekmesi gerekir.

Bu güvenlik güncelleştirmesi Microsoft Windows 2000, Windows XP ve Windows Server 2003'ün tüm desteklenen sürümleri için Kritik ve Windows Vista ve Windows Server 2008'in tüm desteklenen sürümleri için Önemli olarak derecelendirilmiştir. Daha fazla bilgi için, bu bölümdeki **Etkilenen ve Etkilenmeyen Yazılımlar** alt bölümüne bakın.

Güvenlik güncelleştirmesi, sistem çağrısına geçirilen bağımsız değişkeni doğrulamak için kullanılan yöntemi düzelterek, GDI'nın çekirdek bileşeni aracılığıyla kullanıcı modundan geçirilen girişi doğrulayarak ve Windows çekirdek modu sürücülerinin yazı tipi kodunu ayrıştırma biçimini düzelterek bu güvenlik açıklarını giderir. Bu güvenlik açıkları hakkında daha fazla bilgi için, bir sonraki bölüm olan **Güvenlik Açığı Bilgileri** altında, ilgili güvenlik açığı girdisinin Sık Sorulan Sorular (SSS) alt bölümüne bakın.
...
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------|----------------------|-----------------------------------------------------------|
| [Microsoft Windows 2000 Service Pack 4](http://www.microsoft.com/downloads/details.aspx?familyid=45db8bb1-c81b-4d3f-a658-74f5fa445f81)                                                                                   | Uzaktan Kod Yürütme       | Kritik               | [MS09-025](http://go.microsoft.com/fwlink/?linkid=150248) |
| [Windows XP Service Pack 2 ve Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=916abdad-44b7-4f9d-986a-0c3558fb8e06)                                                                  | Uzaktan Kod Yürütme       | Kritik               | [MS09-025](http://go.microsoft.com/fwlink/?linkid=150248) |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=1d0464c6-5ed8-4064-887e-618a2db09236)                                                                      | Uzaktan Kod Yürütme       | Kritik               | [MS09-025](http://go.microsoft.com/fwlink/?linkid=150248) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=5cd62750-e269-44ae-8c7c-c335e8545b9a)                                                                                      | Uzaktan Kod Yürütme       | Kritik               | [MS09-025](http://go.microsoft.com/fwlink/?linkid=150248) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=04a7f817-f330-4003-8b25-d3e744905b12)                                                                          | Uzaktan Kod Yürütme       | Kritik               | [MS09-025](http://go.microsoft.com/fwlink/?linkid=150248) |
| [Itanium Tabanlı Sistemler için Windows Server 2003 SP2](http://www.microsoft.com/downloads/details.aspx?familyid=b95daac0-4c99-47a4-b0ca-9429997ea3d9)                                                                  | Uzaktan Kod Yürütme       | Kritik               | [MS09-025](http://go.microsoft.com/fwlink/?linkid=150248) |
| [Windows Vista, Windows Vista Service Pack 1 ve Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=54562103-1d99-42d7-8f7f-c0cbcdce90db)                                             | Ayrıcalık Yükselmesi      | Önemli               | [MS09-025](http://go.microsoft.com/fwlink/?linkid=150248) |
| [Windows Vista x64 Edition, Windows Vista x64 Edition Service Pack 1 ve Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=fcb87cc8-6fd7-4f16-93d6-552999462fb1)         | Ayrıcalık Yükselmesi      | Önemli               | [MS09-025](http://go.microsoft.com/fwlink/?linkid=150248) |
| [32-bit sistemler için Windows Server 2008 ve 32-bit sistemler için Windows Server 2008 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=b97d48de-0f6d-4bca-b990-acf543fdb8b7)\*                 | Ayrıcalık Yükselmesi      | Önemli               | [MS09-025](http://go.microsoft.com/fwlink/?linkid=150248) |
| [x64 tabanlı sistemler için Windows Server 2008 ve x64 tabanlı sistemler için Windows Server 2008 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=0e2b8607-10fa-406a-96a5-18290f479c48)\*       | Ayrıcalık Yükselmesi      | Önemli               | [MS09-025](http://go.microsoft.com/fwlink/?linkid=150248) |
| [Itanium tabanlı sistemler için Windows Server 2008 ve Itanium tabanlı sistemler için Windows Server 2008 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=28eba3f3-99a5-424c-bc8d-a718c716699e) | Ayrıcalık Yükselmesi      | Önemli               | [MS09-025](http://go.microsoft.com/fwlink/?linkid=150248) |
...
<th style="border:1px solid black;" >Win32k'de BOŞ İşaretçi Başvurusu Güvenlik Açığı - CVE-2009-1127</th>
<th style="border:1px solid black;" >Win32k'de Yetersiz Veri Doğrulaması Güvenlik Açığı - CVE-2009-2513</th>
<th style="border:1px solid black;" >Win32k'de EOT Ayrıştırma Güvenlik Açığı - CVE-2009-2514</th>
...
Win32k'de BOŞ İşaretçi Başvurusu Güvenlik Açığı - CVE-2009-1127  
---------------------------------------------------------------
  
<span></span>
Windows çekirdeğinin bir Windows çekirdeği sistem çağrısına geçirilen bağımsız değişkeni düzgün biçimde doğrulamaması nedeniyle bir ayrıcalık yükselmesi güvenlik açığı bulunmaktadır. Bu güvenlik açığından başarıyla yararlanan bir saldırgan çekirdek modunda rasgele kod çalıştırabilir. Saldırgan, program yükleyebilir; verileri görüntüleyebilir, değiştirebilir veya silebilir; tüm kullanıcı haklarına sahip olan yeni hesaplar oluşturabilir.
  
Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2009-1127](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1127).
  
#### Win32k'de BOŞ İşaretçi Başvurusu Güvenlik Açığı - CVE-2009-1127 için Azaltıcı Etkenler
...
#### Win32k'de BOŞ İşaretçi Başvurusu Güvenlik Açığı - CVE-2009-1127 için Geçici Çözümler
  
Microsoft bu güvenlik açığı için herhangi bir geçici çözüm belirleyememiştir.
  
#### Win32k'de BOŞ İşaretçi Başvurusu Güvenlik Açığı - CVE-2009-1127 Hakkında SSS
...
**Win32k çekirdek modu sürücüsü nedir?**    
...
Win32k'de Yetersiz Veri Doğrulaması Güvenlik Açığı - CVE-2009-2513  
------------------------------------------------------------------
  
<span></span>
Windows çekirdek modu sürücülerinde, GDI'nın çekirdek bileşeni aracılığıyla kullanıcı modundan geçirilen girişin düzgün doğrulanmaması nedeniyle bir ayrıcalık yükselmesi güvenlik açığı bulunmaktadır. Bu güvenlik açığından başarıyla yararlanan bir saldırgan çekirdek modunda rasgele kod çalıştırabilir. Saldırgan, program yükleyebilir; verileri görüntüleyebilir, değiştirebilir veya silebilir; tüm kullanıcı haklarına sahip olan yeni hesaplar oluşturabilir.
  
Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2009-2513](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2513).
  
#### Win32k'de Yetersiz Veri Doğrulaması Güvenlik Açığı - CVE-2009-2513 için Azaltıcı Etkenler
  
Azaltıcı etken, varolan bir durumda bulunan ve güvenlik açığından yararlanılmasının önem derecesini azaltabilecek bir ayar, genel yapılandırma ya da en iyi uygulama anlamına gelir. Sizin durumunuzda aşağıdaki azaltıcı etkenler işinize yarayabilir:
  
-   Saldırganın bu güvenlik açığından yararlanabilmesi için geçerli oturum açma kimlik bilgilerine sahip olması ve yerel olarak oturum açabilmesi gerekir. Bu güvenlik açığı uzaktan veya anonim kullanıcılar tarafından kullanılamaz.
  
#### Win32k'de Yetersiz Veri Doğrulaması Güvenlik Açığı - CVE-2009-2513 için Geçici Çözümler
  
Microsoft bu güvenlik açığı için herhangi bir geçici çözüm belirleyememiştir.
  
#### Win32k'de Yetersiz Veri Doğrulaması Güvenlik Açığı - CVE-2009-2513 Hakkında SSS
  
**Bu güvenlik açığının kapsamı nedir?**    
Bu bir ayrıcalık yükselmesi güvenlik açığıdır. Bu güvenlik açığından başarıyla yararlanan bir saldırgan rasgele kod yürütebilir ve etkilenen sistemin tüm denetimini ele geçirebilir. Saldırgan, program yükleyebilir; verileri görüntüleyebilir, değiştirebilir veya silebilir; tüm kullanıcı haklarına sahip olan yeni hesaplar oluşturabilir.
  
**Güvenlik açığına ne neden olmaktadır?**    
Windows çekirdek modu sürücüleri GDI'nın çekirdek bileşeni aracılığıyla kullanıcı modundan geçirilen girişi düzgün doğrulamaz.
...
Win32k'de EOT Ayrıştırma Güvenlik Açığı - CVE-2009-2514  
-------------------------------------------------------
  
<span></span>
Windows çekirdek modu sürücülerinde, dizin girdileri tablosu oluşturulurken yazı tipi kodunun düzgün ayrıştırılmaması nedeniyle bir uzaktan kod yürütme güvenlik açığı bulunmaktadır. Bu güvenlik açığından başarıyla yararlanan bir saldırgan çekirdek modunda rasgele kod çalıştırabilir. Saldırgan, program yükleyebilir; verileri görüntüleyebilir, değiştirebilir veya silebilir; tüm kullanıcı haklarına sahip olan yeni hesaplar oluşturabilir.
  
Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2009-2514](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2514).
  
#### Win32k'de EOT Ayrıştırma Güvenlik Açığı - CVE-2009-2514 için Azaltıcı Etkenler
...
#### Win32k'de EOT Ayrıştırma Güvenlik Açığı - CVE-2009-2514 için Geçici Çözümler
...
-   **Internet Explorer'da katıştırılmış yazı tiplerini ayrıştırma desteğini devre dışı bırakın**
    ...
    **Not** Bu geçici çözümü etkinleştirmek veya devre dışı bırakmak üzere otomatik Microsoft Düzelt çözümünü kullanmak için, bkz. [Microsoft Bilgi Bankası makalesi 969947](http://support.microsoft.com/kb/969947).
...
#### Win32k'de EOT Ayrıştırma Güvenlik Açığı - CVE-2009-2514 Hakkında SSS
...
**Güvenlik açığına ne neden olmaktadır?**    
Windows çekirdek modu sürücüleri, dizin girdileri tablosunu oluştururken yazı tipi kodunu düzgün ayrıştırmaz.
...
**Güncelleştirme ne yapıyor?**    
Güncelleştirme, Windows çekirdek modu sürücülerinin yazı tipi kodunu ayrıştırma biçimini düzelterek bu güvenlik açığını giderir.
...
| **Dağıtım**                                  |                                                                                                                                                                       |  
| Kullanıcı araya girmeden yükleme             | Windows2000-kb969947-x86-trk /quiet                                                                                                                                   |  
| Yeniden başlatmadan yükleme                  | Windows2000-kb969947-x86-trk /norestart                                                                                                                               |  
| Güncelleştirme günlük dosyası                | kb969947.log                                                                                                                                                          |  
...
| **Kaldırma Bilgileri**                       | Denetim Masası'ndaki **Program Ekle veya Kaldır** aracını veya %Windir%\\$NTUninstallKB969947$\\Spuninst klasöründe bulunan Spuninst.exe yardımcı programını kullanın |  
| **Dosya Bilgileri**                          | Bkz: [Microsoft Bilgi Bankası makalesi 969947](http://support.microsoft.com/kb/969947)                                                                                |  
| **Kayıt Defteri Anahtarı Doğrulaması**       | HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows 2000\\SP5\\KB969947\\Filelist                                                                             |
...
Windowsxp-kb969947-x86-trk /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
WindowsServer2003.WindowsXP-kb969947-x64-trk /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">Windows XP Service Pack 2 ve Windows XP Service Pack 3:<br />
Windowsxp-kb969947-x86-trk /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition ve Windows XP Professional x64 Edition Service Pack 2 için:<br />
WindowsServer2003.WindowsXP-kb969947-x64-trk /norestart</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">Denetim Masası'ndaki <strong>Program Ekle veya Kaldır</strong> aracını veya %Windir%\$NTUninstallKB969947$\Spuninst klasöründe bulunan Spuninst.exe yardımcı programını kullanın</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Dosya Bilgileri</strong></td>
<td style="border:1px solid black;">Bkz: <a href="http://support.microsoft.com/kb/969947">Microsoft Bilgi Bankası makalesi 969947</a></td>
</tr>
<tr class="even">
...
Windowsserver2003-kb969947-x86-trk /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
Windowsserver2003-KB969947-ia64-trk /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen 32 bit sürümleri:<br />
Windowsserver2003-kb969947-x86-trk /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen x64 tabanlı sürümleri:<br />
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen Itanium tabanlı sürümleri:<br />
Windowsserver2003-KB969947-ia64-trk /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Güncelleştirme günlük dosyası</td>
<td style="border:1px solid black;">KB969947.log</td>
...
-   Agin Sun, Win32k'de BOŞ İşaretçi Başvurusu Güvenlik Açığı'nı (CVE-2009-1127) bildirdiği için  
-   [Google Inc.](http://www.google.com/) için çalışan Tavis Ormandy, Win32k'de EOT Ayrıştırma Güvenlik Açığı'nı (CVE-2009-2514) bildirdiği için
