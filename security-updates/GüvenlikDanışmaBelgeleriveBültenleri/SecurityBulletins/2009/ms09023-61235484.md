---
TOCTitle: 'MS09-023'
Title: 'Microsoft Güvenlik Bülteni MS09-023 - Orta'
ms:assetid: 'ms09-023'
ms:contentKeyID: 61235484
ms:mtpsurl: 'https://technet.microsoft.com/tr-TR/library/ms09-023(v=Security.10)'
---

Security Bulletin

Microsoft Güvenlik Bülteni MS09-023 - Orta
==========================================
...
Güvenlik güncelleştirmesi Windows XP'nin ve Windows Server 2003'ün tüm desteklenen sürümleri üzerine yüklendiğinde Windows Search için Orta olarak derecelendirilmiştir. Daha fazla bilgi için, bu bölümdeki **Etkilenen ve Etkilenmeyen Yazılımlar** alt bölümüne bakın.

Güvenlik güncelleştirmesi, komut dosyalarının yürütüldüğü ortamın Windows Search tarafından kısıtlanma biçimini değiştirerek bu güvenlik açığını giderir. Bu güvenlik açığı hakkında daha fazla bilgi için, bir sonraki bölüm olan **Güvenlik Açığı Bilgileri** altında, ilgili güvenlik açığı girdisinin Sık Sorulan Sorular (SSS) alt bölümüne bakın.
...
**Bilinen Sorunlar.** [Microsoft Bilgi Bankası makalesi 963093](http://support.microsoft.com/kb/963093), bu güvenlik güncelleştirmesini yükleyen müşterilerin karşılaşabileceği bilinen sorunları belgelemektedir. Bu makale ayrıca, bu sorunlar için önerilen çözümleri de içermektedir.
...
|--------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------|---------------------------|----------------------|---------------------------------------------|
| Windows XP Service Pack 2 ve Windows XP Service Pack 3 | [Windows Search 4.0](http://www.microsoft.com/downloads/details.aspx?familyid=759f22cb-ea7f-49dd-a200-19cb83fffd8d) | Bilginin Açığa Çıkması    | Orta                 | Yok                                         |
| Windows XP Professional x64 Edition Service Pack 2     | [Windows Search 4.0](http://www.microsoft.com/downloads/details.aspx?familyid=50c56dd6-c34d-4632-a779-8bcf8fdb341b) | Bilginin Açığa Çıkması    | Orta                 | Yok                                         |
| Windows Server 2003 Service Pack 2                     | [Windows Search 4.0](http://www.microsoft.com/downloads/details.aspx?familyid=e72ef31f-5161-4fe6-8ed3-6206e02cef31) | Bilginin Açığa Çıkması    | Orta                 | Yok                                         |
| Windows Server 2003 x64 Edition Service Pack 2         | [Windows Search 4.0](http://www.microsoft.com/downloads/details.aspx?familyid=7ffc3680-f9bf-423b-96a7-102f4cc9c240) | Bilginin Açığa Çıkması    | Orta                 | Yok                                         |
...
| Windows Vista, Windows Vista Service Pack 1 ve Windows Vista Service Pack 2                                     | Windows Search 4.0 |
| Windows Vista x64 Edition, Windows Vista x64 Edition Service Pack 1 ve Windows Vista x64 Edition Service Pack 2 | Windows Search 4.0 |
| 32-bit sistemler için Windows Server 2008 ve 32-bit sistemler için Windows Server 2008 Service Pack 2           | Windows Search 4.0 |
| x64 tabanlı sistemler için Windows Server 2008 ve x64 tabanlı sistemler için Windows Server 2008 Service Pack 2 | Windows Search 4.0 |
...
<th style="border:1px solid black;" >Windows Search'te Komut Dosyası Yürütülmesi Güvenlik Açığı - CVE-2009-0239</th>
<th style="border:1px solid black;" >Toplam Önem Derecesi</th>
</tr>
</thead>
<tbody>
<tr class="odd">
<td style="border:1px solid black;">Windows XP Service Pack 2 üzerine yüklendiğinde Windows Search 4.0</td>
...
<tr class="even">
<td style="border:1px solid black;">Windows XP Service Pack 3 üzerine yüklendiğinde Windows Search 4.0</td>
<td style="border:1px solid black;"><strong>Orta</strong> <br />
Bilginin Açığa Çıkması</td>
<td style="border:1px solid black;"><strong>Orta</strong></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Windows XP Professional x64 Edition Service Pack 2 üzerine yüklendiğinde Windows Search 4.0</td>
<td style="border:1px solid black;"><strong>Orta</strong> <br />
Bilginin Açığa Çıkması</td>
<td style="border:1px solid black;"><strong>Orta</strong></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Windows Server 2003 Service Pack 2 üzerine yüklendiğinde Windows Search 4.0</td>
<td style="border:1px solid black;"><strong>Orta</strong> <br />
Bilginin Açığa Çıkması</td>
<td style="border:1px solid black;"><strong>Orta</strong></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Windows Server 2003 x64 Edition Service Pack 2 üzerine yüklendiğinde Windows Search 4.0</td>
<td style="border:1px solid black;"><strong>Orta</strong> <br />
Bilginin Açığa Çıkması</td>
<td style="border:1px solid black;"><strong>Orta</strong></td>
</tr>
...
Windows Search'te Komut Dosyası Yürütülmesi Güvenlik Açığı - CVE-2009-0239  
--------------------------------------------------------------------------
  
<span></span>
Windows Search'te, dosya önizlemelerinin oluşturulma biçimi nedeniyle bilginin açığa çıkması güvenlik açığı bulunmaktadır. Bu güvenlik açığından yararlanmaya yönelik girişimler kullanıcı etkileşimi gerektirir. Bu güvenlik açığından başarıyla yararlanan bir saldırgan kötü amaçlı bir HTML komut dosyası çalıştırarak bilginin açığa çıkmasına, kullanıcı verilerinin üçüncü tarafa iletilmesine veya oturum açmış kullanıcının erişebildiği etkilenen sistemler üzerindeki tüm verilere erişilmesine neden olabilir. Bu güvenlik açığının, bir saldırganın doğrudan kod yürütmesine veya kullanıcı haklarını yükseltmesine izin vermeyeceğini unutmayın; ancak, etkilenen sistemden daha fazla yararlanmak amacıyla kullanılacak bilgileri üretmek için kullanılabilir.
  
Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2009-0239](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0239).
  
#### Windows Search'te Komut Dosyası Yürütülmesi Güvenlik Açığı - CVE-2009-0239 için Azaltıcı Etkenler
  
Azaltıcı etken, varolan bir durumda bulunan ve güvenlik açığından yararlanılmasının önem derecesini azaltabilecek bir ayar, genel yapılandırma ya da en iyi uygulama anlamına gelir. Sizin durumunuzda aşağıdaki azaltıcı etkenler işinize yarayabilir:
  
-   Windows Search bileşeni varsayılan olarak Microsoft Windows XP ve Windows Server 2003'te önceden yüklenmiş değildir. Bu, isteğe bağlı olarak karşıdan yüklenebilen bir bileşendir.  
-   Windows Vista'nın ve Windows Server 2008'in desteklenen sürümleri üzerine yüklendiğinde Windows Search bu güvenlik açığından etkilenmez.
  
#### Windows Search'te Komut Dosyası Yürütülmesi Güvenlik Açığı - CVE-2009-0239 için Geçici Çözümler
  
Microsoft bu güvenlik açığı için herhangi bir geçici çözüm belirleyememiştir.
  
#### Windows Search'te Komut Dosyası Yürütülmesi Güvenlik Açığı - CVE-2009-0239 Hakkında SSS
...
Windows Search, komut dosyalarının yürütüldüğü ortamı düzgün biçimde kısıtlamamaktadır.
  
**Windows Arama nedir?**    
Windows Arama e-posta, kişiler, takvim randevuları, belgeler, fotoğraflar, multimedya ve üçüncü taraflar tarafından genişletilen diğer biçimler gibi yaygın olarak kullanılan dosya ve veri türlerinin anında aranabilmesini sağlar. Bu özellikler, tüketicilerin ve bilişim çalışanlarının ev ve kuruluş ortamlarında her geçen gün daha da artan miktardaki verileri daha verimli şekilde bulmasına, yönetmesine ve düzene koymasına olanak verir. Daha fazla bilgi için, bkz: [Microsoft Bilgi Bankası makalesi 940157](http://support.microsoft.com/kb/940157).
  
**Bir saldırgan bu güvenlik açığından yararlanarak neler yapabilir?**    
Bu güvenlik açığından başarıyla yararlanan bir saldırgan kötü amaçlı bir istemci tarafı komut dosyası çalıştırabilir. Bu kötü amaçlı komut dosyası çalıştırılırsa, normalde Internet'teki bir Web sayfasında çalıştırılan komut dosyasına atanan özel izin düzeyiyle çalıştırılmış olur. Bu izinler önemli bilgilerin açığa çıkmasına, kullanıcı verilerinin üçüncü taraflara iletilmesine veya oturum açmış kullanıcının erişebildiği etkilenen sistemler üzerindeki tüm verilere erişilmesine neden olabilir.
  
**Bir saldırgan güvenlik açığından nasıl yararlanabilir?**    
Bu güvenlik açığı, özel hazırlanmış bir dosyanın sisteme veya dizin oluşturulmuş bir posta kutusundaki e-posta iletisine yerleştirilmesini gerektirir. Kullanıcı birinci sonuç olarak bu dosyayı döndüren bir arama gerçekleştirirse, rasgele HTML komut dosyası yürütülebilir. Özel hazırlanmış dosya birinci sonuç değilse, yararlanmanın gerçekleşmesi için kullanıcının bu dosyası seçmesi ve önizleme yapması gerekir.
...
Güvenlik güncelleştirmesi, komut dosyalarının yürütüldüğü ortamın Windows Search tarafından kısıtlanma biçimini değiştirerek bu güvenlik açığını giderir.
...
| Yazılım                                                                                         | MBSA 2.1 |  
|-------------------------------------------------------------------------------------------------|----------|  
| Windows XP Service Pack 2 ve Windows XP Service Pack 3 üzerine yüklendiğinde Windows Search 4.0 | Evet     |  
| Windows XP Professional x64 Edition Service Pack 2 üzerine yüklendiğinde Windows Search 4.0     | Evet     |  
| Windows Server 2003 Service Pack 2 üzerine yüklendiğinde Windows Search 4.0                     | Evet     |  
| Windows Server 2003 x64 Edition Service Pack 2 üzerine yüklendiğinde Windows Search 4.0         | Evet     |
...
|-------------------------------------------------------------------------------------------------|---------|-----------------------------|----------------------------|----------------------------|  
| Windows XP Service Pack 2 ve Windows XP Service Pack 3 üzerine yüklendiğinde Windows Search 4.0 | Hayır   | Hayır                       | Evet                       | Evet                       |  
| Windows XP Professional x64 Edition Service Pack 2 üzerine yüklendiğinde Windows Search 4.0     | Hayır   | Hayır                       | Evet                       | Evet                       |  
| Windows Server 2003 Service Pack 2 üzerine yüklendiğinde Windows Search 4.0                     | Hayır   | Hayır                       | Evet                       | Evet                       |  
| Windows Server 2003 x64 Edition Service Pack 2 üzerine yüklendiğinde Windows Search 4.0         | Hayır   | Hayır                       | Evet                       | Evet                       |
...
WindowsServer2003.WindowsXP-KB963093-x86-TRK /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition Service Pack 2:<br />
WindowsServer2003.WindowsXP-KB963093-x64-TRK /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">Windows XP Service Pack 2 ve Windows XP Service Pack 3:<br />
WindowsServer2003.WindowsXP-KB963093-x86-TRK /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition Service Pack 2:<br />
WindowsServer2003.WindowsXP-KB963093-x64-TRK /norestart</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">Denetim Masası'ndaki <strong>Program Ekle veya Kaldır</strong> aracını veya %Windir%\$NTUninstallKB963093$\Spuninst klasöründe bulunan Spuninst.exe yardımcı programını kullanın</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Dosya Bilgileri</strong></td>
<td style="border:1px solid black;">Bkz: <a href="http://support.microsoft.com/kb/963093">Microsoft Bilgi Bankası makalesi 963093</a></td>
</tr>
<tr class="even">
...
-   [IBM Rational Application Security](http://www-01.ibm.com/software/rational/offerings/websecurity/webappsecurity.html) için çalışan Yair Amit, Windows Search'te Komut Dosyası Yürütülmesi Güvenlik Açığı'nı (CVE-2009-0239) bildirdiği için
