---
TOCTitle: 'MS09-066'
Title: 'Microsoft Güvenlik Bülteni MS09-066 - Önemli'
ms:assetid: 'ms09-066'
ms:contentKeyID: 61235527
ms:mtpsurl: 'https://technet.microsoft.com/tr-TR/library/ms09-066(v=Security.10)'
---

Security Bulletin

Microsoft Güvenlik Bülteni MS09-066 - Önemli
============================================

Active Directory'deki Güvenlik Açığı Hizmet Reddine Olanak Verebilir (973309)
-----------------------------------------------------------------------------
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=cbe09780-f288-457a-b254-58c9c8744055">Active Directory Uygulama Modu (ADAM)</a><br />
(KB973039)</td>
<td style="border:1px solid black;">Hizmet Reddi</td>
<td style="border:1px solid black;">Önemli</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=151361">MS09-018</a></td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=b65ddf36-a02d-4aa2-9b4f-7416dbf59e2a">Active Directory Uygulama Modu (ADAM)</a><br />
(KB973039)</td>
<td style="border:1px solid black;">Hizmet Reddi</td>
<td style="border:1px solid black;">Önemli</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=151361">MS09-018</a></td>
...
(KB973037)<br />
<br />
<a href="http://www.microsoft.com/downloads/details.aspx?familyid=44cb9029-4b19-4bad-8fc9-3efe285adb0e">Active Directory Uygulama Modu (ADAM)</a><br />
(KB973039)</td>
<td style="border:1px solid black;">Hizmet Reddi</td>
<td style="border:1px solid black;">Önemli</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=151361">MS09-018</a></td>
...
(KB973037)<br />
<br />
<a href="http://www.microsoft.com/downloads/details.aspx?familyid=87f2109e-5129-467c-930f-70af31ebf5de">Active Directory Uygulama Modu (ADAM)</a><br />
(KB973039)</td>
<td style="border:1px solid black;">Hizmet Reddi</td>
<td style="border:1px solid black;">Önemli</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=151361">MS09-018</a></td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=701abf15-7f93-41de-8d09-13404fd79a7e">Active Directory ve Active Directory Basit Dizin Hizmeti (AD LDS)</a><br />
(KB973037)</td>
<td style="border:1px solid black;">Hizmet Reddi</td>
<td style="border:1px solid black;">Önemli</td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=17f5f9e0-5869-41da-9b3b-6e67540af1f0">Active Directory ve Active Directory Basit Dizin Hizmeti (AD LDS)</a><br />
(KB973037)</td>
<td style="border:1px solid black;">Hizmet Reddi</td>
<td style="border:1px solid black;">Önemli</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=111953">MS08-035</a></td>
...
<th style="border:1px solid black;" >
LSASS'de Yinelenen Yığın Taşması Güvenlik Açığı - CVE-2009-1928  
</th>
<th style="border:1px solid black;" >
...
<span></span>
Microsoft Windows 2000 Server, Windows Server 2003 ve Windows Server 2008 üzerinde Active Directory uygulamalarında bir hizmet reddi güvenlik açığı bulunmaktadır. Güvenlik açığı ayrıca Windows XP ve Windows Server 2003 üzerine yüklendiğinde Active Directory Uygulama Modu (ADAM) ve Windows Server 2008 üzerinde Active Directory Basit Dizin Hizmeti (AD LDS) uygulamalarında da bulunmaktadır. Bu güvenlik açığı, belirli türde LDAP veya LDAPS isteklerinin yürütülmesi sırasında yığın alanının tükenmesi nedeniyle oluşur. Bu güvenlik açığından yararlanan saldırgan, etkilenen sistemin yanıt vermemesine neden olabilir.

Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2009-1928](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1928).

#### LSASS'de Yinelenen Yığın Taşması Güvenlik Açığı - CVE-2009-1928 için Azaltıcı Etkenler
...
#### LSASS'de Yinelenen Yığın Taşması Güvenlik Açığı - CVE-2009-1928 için Geçici Çözümler
...
#### LSASS'de Yinelenen Yığın Taşması Güvenlik Açığı - CVE-2009-1928 Hakkında SSS
...
LDAP hizmeti, belirli LDAP veya LDAPS isteklerini yığın alanının tükenmesine yol açabilecek şekilde hatalı işler.
...
Active Directory Basit Dizin Hizmeti (AD LDS), uygulamalar için adanmış dizin hizmetleri sağlayan bağımsız bir Active Directory modudur. AD LDS, Windows Server 2008 ve sonrasında kullanılabilir ve Windows XP ve Windows Server 2003'te kullanılabilen Active Directory Uygulama Modu'nun (ADAM) yerine geçer.
...
LDAP trafiği varsayılan olarak güvenli olmayan şekilde iletilir. Ancak, Güvenli Yuva Katmanı (SSL)/Aktarım Katmanı Güvenliği (TLS) teknolojisi kullanılarak LDAP trafiği gizlenebilir ve değişikliklere karşı korunması sağlanabilir. Yöneticiler, [Microsoft Bilgi Bankası makalesi 321051](http://support.microsoft.com/kb/321051)'de açıklanan yönergelere uygun olarak bir Microsoft sertifika yetkilisinden (CA) veya Microsoft dışındaki bir CA'dan edindikleri düzgün şekilde biçimlendirilmiş bir dijital sertifika yükleyerek SSL üzerinden LDAP (LDAPS) özelliğini etkinleştirebilir.
...
Bu güvenlik açığından başarıyla yararlanan bir saldırgan, bir kullanıcı sisteminin yanıt vermemeye başlamasına ve yeniden başlatılması gerekmesine neden olabilir.

**Bir saldırgan güvenlik açığından nasıl yararlanabilir?**  
Saldırgan ADAM'ye, AD LDS'ye veya Active Directory sunucusuna özel hazırlanmış bir LDAP ya da LDAPS paketi göndererek bu güvenlik açığından yararlanmaya çalışabilir. Microsoft Windows 2000 Server için, hedef ağa erişimi olan bir anonim kullanıcı etkilenen sisteme özel hazırlanmış bir ağ paketi teslim ederek bu güvenlik açığından yararlanabilir. Diğer tüm etkilenen platformlarda, saldırganın bu güvenlik açığından yararlanabilmesi için geçerli kimlik doğrulama bilgilerine sahip olması gerekir.

**Bu güvenlik açığından birincil derecede hangi sistemler etkileniyor?**  
Active Directory, ADAM ve AD LDS için, Basit Dizin Erişim Protokolü (LDAP) gerekmektedir. Dolayısıyla ADAM, AD LDS veya Active Directory sunucusu olarak çalışan tüm sistemler bu güvenlik açığından etkilenir.

**Güncelleştirme ne yapıyor?**  
Bu güncelleştirme, hatalı biçimlendirilmiş LDAP veya LDAPS isteklerini doğru şekilde işleyerek güvenlik açığını giderir.
...
<td style="border:1px solid black;">Microsoft Windows 2000 Server üzerinde Active Directory:<br />
Windows2000-KB973037-x86-trk /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">Microsoft Windows 2000 Server üzerinde Active Directory:<br />
Windows2000-KB973037-x86-trk /norestart</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">Microsoft Windows 2000 Server üzerinde Active Directory için, Denetim Masası'ndaki <strong>Program Ekle veya Kaldır</strong> aracını veya %Windir%\$NTUninstallKB973037$\Spuninst klasöründe bulunan Spuninst.exe yardımcı programını kullanın</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Dosya Bilgileri</strong></td>
<td style="border:1px solid black;">Bkz: <a href="http://support.microsoft.com/kb/973037">Microsoft Bilgi Bankası makalesi 973037</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;">Kullanıcı araya girmeden yükleme</td>
<td style="border:1px solid black;">Windows XP Service Pack 2 ve Windows XP Service Pack 3 üzerinde Active Directory Uygulama Modu (ADAM):<br />
WindowsXP-KB973039-x86-trk /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
WindowsServer2003.WindowsXP-KB973039-x64-trk /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">Windows XP Service Pack 2 ve Windows XP Service Pack 3 üzerinde Active Directory Uygulama Modu (ADAM):<br />
WindowsXP-KB973039-x86-trk /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition Service Pack 2 üzerinde Active Directory Uygulama Modu (ADAM):<br />
WindowsServer2003.WindowsXP-KB973039-x64-trk /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Güncelleştirme günlük dosyası</td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>Kaldırma Bilgileri</strong></td>
<td style="border:1px solid black;">Denetim Masası'ndaki <strong>Program Ekle veya Kaldır</strong> aracını veya %Windir%\$NTUninstallKB973039$\Spuninst klasöründe bulunan Spuninst.exe yardımcı programını kullanın</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Dosya Bilgileri</strong></td>
<td style="border:1px solid black;">Bkz: <a href="http://support.microsoft.com/kb/973039">Microsoft Bilgi Bankası makalesi 973039</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Kayıt Defteri Anahtarı Doğrulaması</strong></td>
...
WindowsServer2003-KB973037-ia64-trk /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">Windows Server 2003 Service Pack 2 üzerinde Active Directory:<br />
WindowsServer2003-KB973037-x86-trk /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003 Service Pack 2 üzerinde Active Directory Uygulama Modu (ADAM):<br />
WindowsServer2003-KB973039-x86-trk /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003 x64 Edition Service Pack 2 üzerinde Active Directory:<br />
WindowsServer2003.WindowsXP-KB973037-x64-trk /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003 x64 Edition Service Pack 2 üzerinde Active Directory Uygulama Modu (ADAM):<br />
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Itanium tabanlı sistemler için Windows Server 2003 SP2 üzerinde Active Directory:<br />
WindowsServer2003-KB973037-ia64-trk /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Güncelleştirme günlük dosyası</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Kaldırma Bilgileri</strong></td>
<td style="border:1px solid black;">Active Directory için, Denetim Masası'ndaki <strong>Program Ekle veya Kaldır</strong> aracını veya %Windir%\$NTUninstallKB973037$\Spuninst klasöründe bulunan Spuninst.exe yardımcı programını kullanın</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Active Directory Uygulama Modu (ADAM) için, Denetim Masası'ndaki <strong>Program Ekle veya Kaldır</strong> aracını veya %Windir%\$NTUninstallKB973039$\Spuninst klasöründe bulunan Spuninst.exe yardımcı programını kullanın</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Dosya Bilgileri</strong></td>
<td style="border:1px solid black;">Windows Server 2003 üzerinde Active Directory için, bkz. <a href="http://support.microsoft.com/kb/973037">Microsoft Bilgi Bankası makalesi 973037</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003 üzerinde Active Directory Uygulama Modu (ADAM) için, bkz. <a href="http://support.microsoft.com/kb/973039">Microsoft Bilgi Bankası makalesi 973039</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Kayıt Defteri Anahtarı Doğrulaması</strong></td>
<td style="border:1px solid black;">Windows Server 2003 üzerinde Active Directory:<br />
