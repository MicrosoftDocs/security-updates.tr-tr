---
TOCTitle: 'MS09-068'
Title: 'Microsoft Güvenlik Bülteni MS09-068 - Önemli'
ms:assetid: 'ms09-068'
ms:contentKeyID: 61235529
ms:mtpsurl: 'https://technet.microsoft.com/tr-TR/library/ms09-068(v=Security.10)'
---

Security Bulletin

Microsoft Güvenlik Bülteni MS09-068 - Önemli
============================================

Microsoft Office Word'deki Güvenlik Açığı Uzaktan Kod Yürütülmesine İzin Verebilir (976307)
-------------------------------------------------------------------------------------------
...
Bu güvenlik güncelleştirmesi Microsoft Office Word 2002 ve Microsoft Office Word 2003'ün tüm desteklenen sürümleri, Mac için Microsoft Office 2004, Mac için Microsoft Office 2008, Mac için Açık XML Dosya Biçimi Dönüştürücüsü ve Microsoft Office Word Viewer'ın tüm desteklenen sürümleri için Önemli olarak derecelendirilmiştir. Daha fazla bilgi için, bu bölümdeki **Etkilenen ve Etkilenmeyen Yazılımlar** alt bölümüne bakın.

Güvenlik güncelleştirmesi, Microsoft Office Word'ün özel hazırlanmış Word dosyalarını açma biçimini değiştirerek bu güvenlik açığını giderir. Bu güvenlik açığı hakkında daha fazla bilgi için, bir sonraki bölüm olan **Güvenlik Açığı Bilgileri** altında, ilgili güvenlik açığı girdisinin Sık Sorulan Sorular (SSS) alt bölümüne bakın.
...
**MS09-067'de aynı zamanda Mac için Microsoft Office 2004, Mac için Microsoft Office 2008 ve Mac için Açık XML Dosya Biçimi Dönüştürücüsü'ndeki güvenlik açıkları anlatılmaktadır. MS09-067 ile bu bülten (MS09-068) arasında nasıl bir ilişki vardır?**  
Mac için Microsoft Office 2004 (KB976830), Mac için Microsoft Office 2008 (KB976828) ve Mac için Açık XML Dosya Biçimi Dönüştürücüsü (KB976831) için bu bültende (MS09-068) bulunan güvenlik güncelleştirmesi paketleri MS09-067'de açıklanan güvenlik açıklarını da giderir. Mac için Microsoft Office 2004, Mac için Microsoft Office 2008 veya Mac için Açık XML Dosya Biçimi Dönüştürücüsü'nü yüklemiş olan kullanıcıların bu güvenlik güncelleştirmesi paketlerini bir kez yüklemeleri yeterlidir.
...
**Bu güncelleştirme tüm etkilenen Word sürümleri için neden yalnızca Önemli olarak derecelendirildi?**  
...
<th style="border:1px solid black;" >
Microsoft Office Word Dosya Bilgilerinde Bellek Bozulması Güvenlik Açığı - CVE-2009-3135
</th>
<th style="border:1px solid black;" >
Toplam Önem Derecesi
</th>
...
Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2009-3135](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3135).

#### Microsoft Office Word Dosya Bilgilerinde Bellek Bozulması Güvenlik Açığı - CVE-2009-3135 için Azaltıcı Etkenler
...
#### Microsoft Office Word Dosya Bilgilerinde Bellek Bozulması Güvenlik Açığı - CVE-2009-3135 için Geçici Çözümler
...
-   **Bilinmeyen veya güvenilir olmayan kaynaklardan gelen dosyaları açarken Microsoft Office Yalıtılmış Dönüştürme Ortamı'nı (MOICE) kullanın**
    ...
    MOICE özelliğini etkinleştirmek için .doc dosya biçiminin kayıtlı işleyicisini değiştirin. Aşağıdaki tabloda .doc dosya biçimi için MOICE özelliğini etkinleştirme veya devre dışı bırakma komutları yer almaktadır:
...
#### Microsoft Office Word Dosya Bilgilerinde Bellek Bozulması Güvenlik Açığı - CVE-2009-3135 Hakkında SSS
...
Güvenlik açığı, Microsoft Office Word'ün özel hazırlanmış bir Word belgesini ayrıştırma biçiminin sistem belleğini bir saldırganın rasgele kod yürütmesine olanak verecek şekilde bozması nedeniyle ortaya çıkar.
...
| Office 2003 Service Pack 3                                                       | Hayır   | Hayır                      | Evet                       | Evet                       |
...
| Microsoft Office Word Viewer 2003 Service Pack 3 ve Microsoft Office Word Viewer | Hayır   | Hayır                      | Evet                       | Evet                       |
...
<td style="border:1px solid black;">OfficeXP-kb973444-fullfile-trk /q:a</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">OfficeXP-kb973444-fullfile-trk /r:n</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">Bkz: <a href="http://support.microsoft.com/kb/973444">Microsoft Bilgi Bankası makalesi 973444</a></td>
</tr>
<tr class="even">
...
Office2003-kb973443-fullfile-trk /q:a<br />
<br />
Word Viewer 2003 ve Word Viewer için:<br />
Office2003-kb973866-fullfile-trk /q:a</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">Word 2003:<br />
Office2003-kb973443-fullfile-trk /r:n<br />
<br />
Word Viewer 2003 ve Word Viewer için:<br />
Office2003-kb973866-fullfile-trk /r:n</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Güncelleştirme günlük dosyası</td>
<td style="border:1px solid black;">Uygulanamaz</td>
...
<td style="border:1px solid black;"><strong>Dosya Bilgileri</strong></td>
<td style="border:1px solid black;">Word 2003:<br />
Bkz: <a href="http://support.microsoft.com/kb/973443">Microsoft Bilgi Bankası makalesi 973443</a><br />
<br />
Word Viewer 2003 ve Word Viewer için:<br />
Bkz: <a href="http://support.microsoft.com/kb/973866">Microsoft Bilgi Bankası makalesi 973866</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Kayıt Defteri Anahtarı Doğrulaması</strong></td>
<td style="border:1px solid black;">Uygulanamaz</td>
...
-   [VeriSign iDefense Labs](http://labs.idefense.com/) için çalışan Jun Mao, Microsoft Office Word Dosya Bilgilerinde Bellek Bozulması Güvenlik Açığı'nı (CVE-2009-3135) bildirdiği için.
