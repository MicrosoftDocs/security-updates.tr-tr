...
#### Excel'de Ayarlanmış Yazı Tipi Güvenlik Açığı - CVE-2007-1203:
...
#### Excel'de Filtre Kaydı Güvenlik Açığı CVE-2007-1214 için Geçici Çözümler:
...
1.  [Excel 2007](http://download.microsoft.com/download/5/b/a/5ba5060d-8195-4040-812e-16a1d228cd73/excel2007-kb934670-fullfile-x86-glb.exe) ve [Office Uyumluluk Paketi](http://download.microsoft.com/download/07.03.2006/37626e29-c845-4976-b7ad-ac44e68391e0/office2007-kb933688-fullfile-x86-glb.exe) güvenlik güncelleştirmesini karşıdan yükleyin.  
2.  **Bu programı diske kaydet**'i tıklatın ve **Tamam**'ı tıklatın.  
3.  **Kaydet**'i tıklatın.  
4.  Windows Gezgini'ni kullanarak, kaydedilen dosyayı içeren klasörü bulun ve dosyayı çift tıklatın.  
5.  Güncelleştirmeyi yüklemeniz istenirse **Evet**'i tıklatın.  
...
-   [TippingPoint](http://www.tippingpoint.com) için çalışan Manuel Santamarina Suarez ve [Zero Day Initiative](http://www.zerodayinitiative.com/), Excel'de BIFF Kaydı Güvenlik Açığı'nı (CVE-2007-0215) bildirdikleri için  
-   [IDefense Labs](http://labs.idefense.com/) için çalışan Greg MacManus, Excel'de Filtre Kaydı Güvenlik Açığı'nı (CVE-2007-1214) bildirdiği için
...
-   V1.1 (16 Mayıs 2007): Bültenin “Yükleme Dosyası Bilgileri” bölümü, Office 2007 Uyumluluk Paketi için doğru dosya adını içerecek biçimde güncelleştirildi.  
-   V1.2 (17 Mayıs 2007): Bu bülten ayrıca [Microsoft Bilgi Bankası makalesi 934233](http://support.microsoft.com/?kbid=934233)'de açıklandığı üzere güvenlik güncelleştirmesinde keşfedilen yeni sorunlar nedeniyle yeniden düzenlendi.
