---
TOCTitle: 'MS07-044'
Title: 'Microsoft Güvenlik Bülteni MS07-044 - Kritik'
ms:assetid: 'ms07-044'
ms:contentKeyID: 61235357
ms:mtpsurl: 'https://technet.microsoft.com/tr-TR/library/ms07-044(v=Security.10)'
---

Security Bulletin

Microsoft Güvenlik Bülteni MS07-044 - Kritik
============================================

Microsoft Excel'deki Güvenlik Açığı Uzaktan Kod Yürütülmesine İzin Verebilir (940965)
-------------------------------------------------------------------------------------
...
Bu güncelleştirme, özel olarak bildirilen bir güvenlik açığının yanı sıra, araştırma çalışmaları sırasında belirlenen iki güvenlik sorununu da giderir. Bu güvenlik açıkları, bir kullanıcı özel hazırlanmış bir Excel dosyasını açarsa uzaktan kod yürütülmesine izin verebilir. Hesapları, sistemde az sayıda kullanıcı hakkıyla yapılandırılmış olan kullanıcılar, yönetici haklarıyla çalışan kullanıcılardan daha az etkilenebilir.

Bu, Microsoft Office 2000'in desteklenen sürümleri için kritik bir güvenlik güncelleştirmesidir. Microsoft Office XP, Microsoft Office 2003 ve 2007 Microsoft Office 2004 for Mac'in desteklenen sürümleri için, bu güncelleştirme önemli olarak derecelendirilmiştir. Bu güncelleştirme Excel Viewer 2003 için de önemli olarak derecelendirilmiştir. Daha fazla bilgi için, bu bölümdeki **Etkilenen ve Etkilenmeyen Yazılımlar** alt bölümüne bakın.
...
<a href="http://www.microsoft.com/downloads/details.aspx?familyid=c4a87572-3128-44f7-8069-95535a78500a">Microsoft Excel Görüntüleyicisi 2003</a></td>
<td style="border:1px solid black;">Uzaktan Kod Yürütme</td>
<td style="border:1px solid black;">Önemli</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=93447">MS07-036</a></td>
</tr>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/mac/downloads.aspx">Mac için Microsoft Office 2004</a></td>
<td style="border:1px solid black;">Uzaktan Kod Yürütme</td>
<td style="border:1px solid black;">Önemli</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=93447">MS07-036</a></td>
</tr>
...
<th style="border:1px solid black;" >Çalışma Alanında Bellek Bozulması Güvenlik Açığı – CVE-2007-3890</th>
<th style="border:1px solid black;" >Toplam Önem Derecesi</th>
</tr>
</thead>
<tbody>
...
Çalışma Alanında Bellek Bozulması Güvenlik Açığı – CVE-2007-3890  
----------------------------------------------------------------
...
Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2007-3890](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-3890).
  
#### Çalışma Alanında Bellek Bozulması Güvenlik Açığı – CVE-2007-3890 için Azaltıcı Etkenler
...
#### Çalışma Alanında Bellek Bozulması Güvenlik Açığı – CVE-2007-3890 için Geçici Çözümler
...
-   **Bilinmeyen veya güvenilmeyen kaynaklardan gelen Office 2003 veya önceki sürümlerinde oluşturulmuş belgelerin açılmasını engellemek üzere Microsoft Office Dosya Engelleme ilkesini kullanın.**
    ...
    **Not** Office 2003'te 'FileOpenBlock' işlevinin kullanılabilmesi için, Mayıs 2007'ye kadar olan tüm yeni Office 2003 güvenlik güncelleştirmelerinin uygulanmış olması gerekir.
...
#### Çalışma Alanında Bellek Bozulması Güvenlik Açığı – CVE-2007-3890 Hakkında SSS
...
Excel, bir Çalışma Alanının dizin değerini gösterirken yeterli doğrulama yapmamaktadır.
...
Güncelleştirme, Microsoft Excel'in Çalışma Alanıyla ilişkili dizin değerini doğrulama biçimini değiştirerek güvenlik açığını ortadan kaldırır.
...
**Not** MBSA 1.2.1, Office Algılama Aracı'nın (ODT) bu güvenlik güncelleştirmesinin uzaktan taranmasını desteklemeyen tümleşik bir sürümünü kullanır.
...
<td style="border:1px solid black;">office2000-kb940596-fullfile-trk.exe /q:a</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">office2000-kb940596-fullfile-trk.exe /r:n</td>
</tr>
<tr class="odd">
...
|-----------|------------|-------------|-------|-----------|  
| Excel.exe | 9.0.0.8964 | 24-Tem-2007 | 06:54 | 7.233.581 |
...
<tr class="odd">
<td style="border:1px solid black;">Kullanıcı araya girmeden yükleme</td>
<td style="border:1px solid black;">officexp-kb940601-fullfile-trk.exe /q:a</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">officexp-kb940601-fullfile-trk.exe /r:n</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Güncelleştirme günlük dosyası</td>
<td style="border:1px solid black;">Uygulanamaz</td>
...
| Dosya Adı | Sürüm       | Tarih       | Saat  | Boyut     |  
|-----------|-------------|-------------|-------|-----------|  
| Excel.exe | 10.0.6834.0 | 24-Tem-2007 | 15:56 | 9.360.728 |
...
<tr class="odd">
<td style="border:1px solid black;">Kullanıcı araya girmeden yükleme</td>
<td style="border:1px solid black;">office2003-KB940602-FullFile-TRK.exe /q:a</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">office2003-KB940602-FullFile-TRK.exe /r:n</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Güncelleştirme günlük dosyası</td>
<td style="border:1px solid black;">Uygulanamaz</td>
...
| Dosya Adı | Sürüm       | Tarih       | Saat  | Boyut      |  
|-----------|-------------|-------------|-------|------------|  
| Excel.exe | 11.0.8146.0 | 23-Tem-2007 | 08:02 | 10.290.008 |
  
Excel Viewer 2003'ün tüm sürümleri:
  
| Dosya Adı  | Sürüm       | Tarih       | Saat  | Boyut     |  
|------------|-------------|-------------|-------|-----------|  
| Xlview.exe | 11.0.8146.0 | 23-Tem-2007 | 08:00 | 5.242.208 |
...
-   [Secunia](http://secunia.com/) için çalışan Dyon Balding, Çalışma Alanında Bellek Bozulması Güvenlik Açığı'nı (CVE-2007-3890) bildirdiği için
...
-   V1.1 (29 Ağustos 2007): Bülten, Etkilenen Yazılımlar tablosunda Office bileşenleri için karşıdan yükleme bağlantısı görüntü metni değiştirilerek güncelleştirildi.
