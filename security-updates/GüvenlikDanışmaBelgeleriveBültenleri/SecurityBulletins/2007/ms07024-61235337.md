...
-   [McAfee Avert Labs](http://www.avertlabs.com/) için çalışan Craig Schmugar, Word Belgesi Akışı Güvenlik Açığı (CVE-2007-0870) konusunda bizimle çalıştığı için  
-   [AV-Test](http://www.av-test.org/) için çalışan Andreas Marx, Word Belgesi Akışı Güvenlik Açığı (CVE-2007-0870) konusunda bizimle çalıştığı için  
-   [iDefense Labs](http://labs.idefense.com/) VCP, Word'de RTF Ayrıştırma Güvenlik Açığı'nı (CVE-2007-1202) bildirdiği için
