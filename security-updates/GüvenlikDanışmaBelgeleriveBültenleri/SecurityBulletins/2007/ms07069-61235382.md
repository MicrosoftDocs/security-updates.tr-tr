---
TOCTitle: 'MS07-069'
Title: 'Microsoft Güvenlik Bülteni MS07-069 - Kritik'
ms:assetid: 'ms07-069'
ms:contentKeyID: 61235382
ms:mtpsurl: 'https://technet.microsoft.com/tr-TR/library/ms07-069(v=Security.10)'
---

Security Bulletin

Microsoft Güvenlik Bülteni MS07-069 - Kritik
============================================

Internet Explorer için Toplu Güvenlik Güncelleştirmesi (942615)
---------------------------------------------------------------

Yayım Tarihi: 11 Aralık 2007 Salı | Güncelleştirme Tarihi: 20 Aralık 2007 Perşembe
...
Bu güvenlik güncelleştirmesi, Internet Explorer'ın serbest bırakılan belleğe erişimi işleme biçimini değiştirerek güvenlik açıklarını giderir. Bu güvenlik açıkları hakkında daha fazla bilgi için, bir sonraki bölüm olan **Güvenlik Açığı Bilgileri** altında, ilgili güvenlik açığı girdisinin Sık Sorulan Sorular (SSS) alt bölümüne bakın.

**Öneri.** Microsoft, müşterilerinin güncelleştirmeyi hemen uygulamasını önerir.

**Bilinen Sorunlar.** [Microsoft Bilgi Bankası makalesi 942615](http://support.microsoft.com/kb/942615) bu güvenlik güncelleştirmesini yükleyen müşterilerin karşılaşabileceği bilinen sorunları belgelemektedir. Bu makale ayrıca, bu sorunlar için önerilen çözümleri de içermektedir
...
Bazı müşteriler dosya bilgileri bölümünün boyutu nedeniyle bülteni görüntülerken uzun gecikmeler yaşıyordu. Bu gecikmeyi önlemek için, dosya bilgileri ayrıntıları [Microsoft Bilgi Bankası makalesi 942615](http://support.microsoft.com/kb/942615)'e taşınmıştır.
...
[Microsoft Bilgi Bankası makalesi 942615](http://support.microsoft.com/kb/942615) bu güvenlik güncelleştirmesini yükleyen müşterilerin karşılaşabileceği bilinen sorunları belgelemektedir. Bu makale ayrıca, bu sorunlar için önerilen çözümleri de içermektedir

Bültenin orijinali yayınlandıktan sonra bilinen sorunlar:

-   [KB946627](http://support.microsoft.com/kb/946627): Windows XP Service Pack 2 çalıştıran bir bilgisayara güvenlik güncelleştirmesi 942615'i yükledikten sonra Internet Explorer 6 kilitleniyor.

**KB946627 ile bu yayım arasında nasıl bir ilişki vardır?**  
[KB946627](http://support.microsoft.com/kb/946627) bu güvenlik güncelleştirmesinde bilinen bir sorunu giderir. Paket, şu kayıt defteri alt anahtarına \* adında ve 1 değerine sahip bir DWORD değeri ekler:
...
-   Bu güncelleştirme, desteklenmeyen DXTLIPI.DLL ActiveX denetimi için bir [kill biti](http://support.microsoft.com/kb/240797) ayarlar:
    -   {201ea564-a6f6-11d1-811d-00c04fb6db36}
-   Bu güncelleştirme, artık desteklenmeyen HRTBEAT.OCX ActiveX denetiminin eski sürümleri için bir [kill biti](http://support.microsoft.com/kb/240797) ayarlar:
...
-   Bu güvenlik güncelleştirmesi, Intuit ürünü ActiveX denetimleri için [kill bitini](http://support.microsoft.com/kb/240797) ayarlar. Intuit, etkilenen bileşenlerdeki güvenlik açığına yönelik olarak bir güvenlik bülteni ve bir güncelleştirme yayımlamıştır. Daha fazla bilgi ve karşıdan yükleme konumları için [Intuit](http://go.microsoft.com/fwlink/?linkid=102009)'in güvenlik bültenine bakın. Bu kill biti ActiveX denetimi sahibinin isteği üzerine ayarlanmıştır. Bu ActiveX denetiminin sınıf tanımlayıcıları (CLSID) şu şekildedir:
...
-   Bu güvenlik güncelleştirmesi, Vantage ürünü ActiveX denetimleri için [kill bitini](http://support.microsoft.com/kb/240797) ayarlar. Vantage, etkilenen bileşenlerdeki güvenlik açığına yönelik olarak bir güvenlik bülteni ve bir güncelleştirme yayımlamıştır. Daha fazla bilgi ve karşıdan yükleme konumları için [Vantage](http://go.microsoft.com/fwlink/?linkid=102010)'ın güvenlik bültenine bakın. Bu kill biti ActiveX denetimi sahibinin isteği üzerine ayarlanmıştır. Bu ActiveX denetiminin sınıf tanımlayıcıları (CLSID) şu şekildedir:
    -   {c1908682-7b2c-4ab0-b98e-183649a0bf84}
    -   {0f6a72b9-d3c5-4fce-89a3-4e3d19c3580a}
    -   {66b4546f-c263-11d1-b1c9-444553540000}

**Bu güvenlik güncelleştirmesi KB921090, ‘Windows Server 2003 veya Windows XP çalışan bir bilgisayarda Internet Explorer sayfanın görüntülenemediğini bildiren bir hata iletisi oluşturuyor’ başlıklı makalede açıklanan güncelleştirmeyi içeriyor mu?**    
Evet, bu güvenlik güncelleştirmesi [KB921090](http://support.microsoft.com/kb/921090)'da açıklanan güncelleştirmeyi içermektedir.

**Bu güvenlik güncelleştirmesi KB945007, ‘IE Otomatik Bileşen Etkinleştirme Önizlemesi’ başlıklı makalede açıklanan güncelleştirmeyi içeriyor mu?**    
Hayır, bu güvenlik güncelleştirmesi [KB945007](http://support.microsoft.com/kb/945007)'de açıklanan güncelleştirmeyi içermemektedir.  Ancak gelecekte hazırlanacak bir Internet Explorer Toplu Güncelleştirmesi [KB945007](http://support.microsoft.com/kb/945007)'yi içerecektir. Internet Explorer şimdilik kullanıcıların “Etkinleştirmek için tıklatın” araç ipucunun gösterildiği bazı Web sayfalarındaki denetimleri el ile etkinleştirmelerini gerektirmektedir. “Etkinleştirmek için tıklatın” davranışı Nisan 2008'de kalıcı olarak kaldırılacaktır.

**Bu değişikliğe hazırlanmak için ne yapmalıyım?**    
Müşterilerin, IE Otomatik Bileşen Etkinleştirme (IE ACA) Önizlemesi'ni kullanarak kendi Web sitelerini ve uygulamalarını sınamaları önerilir. IE ACA Önizlemesi ([KB945007](http://support.microsoft.com/kb/945007)) yalnızca bu güvenlik güncelleştirmesi yüklendikten sonra uygulanmalıdır. Bu değişikliğe hazırlanma konusunda daha ayrıntılı bilgi ve yönergeler isteyen müşterilerin, müşterileri yapılacak bu değişiklik konusunda bilgilendirmek üzere güncelleştirilecek IE Otomatik Bileşen Etkinleştirme makalesine bakmaları önerilir.
...
<th style="border:1px solid black;" >
Başlatılmamış Belleğin Bozulması Güvenlik Açığı - CVE-2007-3902
</th>
<th style="border:1px solid black;" >
Başlatılmamış Belleğin Bozulması Güvenlik Açığı - CVE-2007-3903
</th>
<th style="border:1px solid black;" >
Başlatılmamış Belleğin Bozulması Güvenlik Açığı - CVE-2007-5344
</th>
<th style="border:1px solid black;" >
DHTML Nesnelerinde Bellek Bozulması Güvenlik Açıkları - CVE- 2007-5347
</th>
<th style="border:1px solid black;" >
Toplam Önem Derecesi
</th>
...
Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2007-3902](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-3902).

#### Başlatılmamış Belleğin Bozulması Güvenlik Açığı - CVE-2007-3902 için Azaltıcı Etkenler
...
#### Başlatılmamış Belleğin Bozulması Güvenlik Açığı - CVE-2007-3902 için Geçici Çözümler
...
#### Başlatılmamış Belleğin Bozulması Güvenlik Açığı - CVE-2007-3902 Hakkında SSS
...
Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2007-3903](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-3903).

#### Başlatılmamış Belleğin Bozulması Güvenlik Açığı - CVE-2007-3903 için Azaltıcı Etkenler
...
#### Başlatılmamış Belleğin Bozulması Güvenlik Açığı - CVE-2007-3903 için Geçici Çözümler
...
#### Başlatılmamış Belleğin Bozulması Güvenlik Açığı - CVE-2007-3903 Hakkında SSS
...
Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2007-5344](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-5344).

#### Başlatılmamış Belleğin Bozulması Güvenlik Açığı - CVE-2007-5344 için Azaltıcı Etkenler
...
#### Başlatılmamış Belleğin Bozulması Güvenlik Açığı - CVE-2007-5344 için Geçici Çözümler
...
#### Başlatılmamış Belleğin Bozulması Güvenlik Açığı - CVE-2007-5344 Hakkında SSS
...
DHTML Nesnesinde Bellek Bozulması Güvenlik Açığı - CVE-2007-5347
----------------------------------------------------------------
...
Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2007-5347](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-5347).

#### DHTML Nesnesi Bellek Bozulması Güvenlik Açığı - CVE-2007-5347 için Azaltıcı Etkenler
...
#### DHTML Nesnesi Bellek Bozulması Güvenlik Açığı - CVE-2007-5347 için Geçici Çözümler
...
#### DHTML Nesnesi Bellek Bozulması Güvenlik Açığı - CVE-2007-5347 Hakkında SSS
...
**Güvenlik açığına ne neden olmaktadır? **
Internet Explorer HTML nesnelerine yönelik bazı beklenmeyen yöntem çağrıları için bir Web sayfasını görüntülediğinde, sistem belleği bir saldırganın rasgele kod yürütmesine olanak verebilecek bir şekilde bozulabilir.
...
**Güncelleştirme ne yapıyor? **
Güncelleştirme, Internet Explorer'ın belleği kullanmadan önce örneğini oluşturma biçimini değiştirmek yoluyla güvenlik açığını giderir.
...
IE5.01sp4-KB942615-Windows2000sp4-x86-trk /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
IE6.0sp1-KB942615-Windows2000-x86-trk /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">Windows 2000'in tüm desteklenen sürümleri üzerinde Internet Explorer 5.01 Service Pack 4 için:<br />
IE5.01sp4-KB942615-Windows2000sp4-x86-trk /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows 2000'in tüm desteklenen sürümleri üzerine yüklendiğinde Internet Explorer 6 Service Pack 1 için:<br />
IE6.0sp1-KB942615-Windows2000-x86-trk /norestart</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">Windows 2000'in tüm desteklenen sürümleri üzerinde Internet Explorer 5.01 Service Pack 4 için:<br />
Denetim Masası'ndaki Program Ekle veya Kaldır aracını veya %Windir%\$NTUninstallKB942615-IE501SP4- 20071012.120000$\Spuninst klasöründe bulunan Spuninst.exe yardımcı programını kullanın</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows 2000'in tüm desteklenen sürümleri üzerine yüklendiğinde Internet Explorer 6 Service Pack 1 için:<br />
Denetim Masası'ndaki Program Ekle veya Kaldır aracını veya %Windir%\$NTUninstallKB942615-IE6SP1- 20071029.120000$\Spuninst klasöründe bulunan Spuninst.exe yardımcı programını kullanın</td>
</tr>
<tr class="odd">
...
Bu güvenlik güncelleştirmesinin İngilizce sürümündeki dosyalar [KB942615](http://support.microsoft.com/kb/942615)'te listelenmektedir. Bu dosyalarla ilgili tarihler ve saatler UTC (eşgüdümlü evrensel saat) kullanılarak listelenmiştir. Dosya bilgilerini görüntülediğinizde yerel saate dönüştürülür. UTC ve yerel saat arasındaki farkı bulmak için, Denetim Masası'ndaki Tarih ve Saat aracında **Saat Dilimi** sekmesini kullanın.

Windows 2000'in tüm desteklenen sürümleri üzerinde Internet Explorer 5.01 Service Pack 4 için, bkz: [KB942615](http://support.microsoft.com/kb/942615)

Windows 2000'in tüm desteklenen sürümleri üzerine yüklendiğinde Internet Explorer 6 Service Pack 1 için, bkz: [KB942615](http://support.microsoft.com/kb/942615)
...
Windowsxp-kb942615-x86-trk /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
WindowsServer2003.WindowsXP-KB942615-x64-trk /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Service Pack 2 için Internet Explorer 7:<br />
IE7-WindowsXP-KB942615-x86-trk /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
IE7-WindowsServer2003.WindowsXP-KB942615-x64-trk /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">Windows XP Service Pack 2 için Internet Explorer 6:<br />
Windowsxp-kb942615-x86-trk /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition ve Windows XP Professional x64 Edition Service Pack 2 için Internet Explorer 6:<br />
WindowsServer2003.WindowsXP-KB942615-x64-trk / norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Service Pack 2 için Internet Explorer 7:<br />
IE7-WindowsXP-KB942615-x86-trk /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition ve Windows XP Professional x64 Edition Service Pack 2 için Internet Explorer 7:<br />
IE7-WindowsServer2003.WindowsXP-KB942615-x64-trk /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Güncelleştirme günlük dosyası</td>
...
Denetim Masası'ndaki Program Ekle veya Kaldır aracını veya %Windir%\$NTUninstallKB942615$\Spuninst klasöründe bulunan Spuninst.exe yardımcı programını kullanın</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP için Internet Explorer 7:<br />
Denetim Masası'ndaki Program Ekle veya Kaldır aracını veya %Windir%\ie7updates\KB942615-IE7\spuninst klasöründe bulunan Spuninst.exe yardımcı programını kullanın</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Dosya Bilgileri</strong></td>
<td style="border:1px solid black;">Bir sonraki bölüm olan <strong>Dosya Bilgileri'ne bakın.</strong></td>
...
Windows XP'nin tüm desteklenen sürümleri üzerinde Internet Explorer 6 ve Internet Explorer 7 için, bkz: [KB942615](http://support.microsoft.com/kb/942615)
...
Windowsserver2003-kb942615-x86-trk /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
IE7-WindowsServer2003-KB942615-ia64-trk /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen 32-bit sürümleri için Internet Explorer 6:<br />
Windowsserver2003-kb942615-x86-trk /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen x64 tabanlı sürümleri için Internet Explorer 6:<br />
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen Itanium tabanlı sürümleri için Internet Explorer 6:<br />
Windowsserver2003-kb942615-ia64-trk /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen 32-bit sürümleri için Internet Explorer 7:<br />
IE7-WindowsServer2003-KB942615-x86-trk /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen x64 tabanlı sürümleri için Internet Explorer 7:<br />
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen Itanium tabanlı sürümleri için Internet Explorer 7:<br />
IE7-WindowsServer2003-KB942615-ia64-trk /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Güncelleştirme günlük dosyası</td>
...
Windows Server 2003'ün tüm desteklenen sürümleri üzerinde Internet Explorer 6 ve Internet Explorer 7 için, bkz: [KB942615](http://support.microsoft.com/kb/942615)
...
Windows Vista'nın tüm desteklenen sürümlerinde Internet Explorer 7 için, bkz: [KB942615](http://support.microsoft.com/kb/942615)
...
-   [iDefense VCP](http://idefense.com/) için çalışan Peter Vreugdenhil, Başlatılmamış Belleğin Bozulması Güvenlik Açığı'nı – (CVE-2007-3902) bildirdiği için  
-   [TippingPoint](http://www.tippingpoint.com/) için çalışan anonim bir araştırmacı ve [Zero Day Initiative](http://www.zerodayinitiative.com/), Başlatılmamış Belleğin Bozulması Güvenlik Açığı – (CVE-2007-3902) konusunda Microsoft ile birlikte çalıştığı için  
-   [TippingPoint](http://www.tippingpoint.com/) için çalışan Sam Thomas ve [Zero Day Initiative](http://www.zerodayinitiative.com/), Başlatılmamış Belleğin Bozulması Güvenlik Açığı'nı – (CVE-2007-3903) bildirdiği için  
-   [TippingPoint](http://www.tippingpoint.com/) için çalışan Peter Vreugdenhil ve [Zero Day Initiative](http://www.zerodayinitiative.com/), Başlatılmamış Belleğin Bozulması Güvenlik Açığı'nı – (CVE-2007-5344) bildirdiği için
...
-   V1.1 (12 Aralık 2007): Bülten, işleme sorunları giderilerek yeniden düzenlendi.  
-   V1.2 (18 Aralık 2007): Bülten, bilinen bir sorunla ilgili bilgileri içerecek şekilde güncelleştirildi; Güvenlik Güncelleştirmesi Dağıtım bölümünde Windows Vista Başvuru Tablosundaki Kaldırma Bilgileri metninde ve etkilenen tüm işletim sistemlerinin Güvenlik Güncelleştirmesi Dağıtım bölümünde Başvuru Tablosu'ndaki Dosya Bilgileri metninde değişiklik yapıldı.  
-   V1.3 (20 Aralık 2007): Bülten, KB946627'de belgelenen bilinen bir soruna yönelik yeni bir Güvenlik Güncelleştirmesiyle ilgili bilgileri içerecek şekilde gözden geçirildi.
