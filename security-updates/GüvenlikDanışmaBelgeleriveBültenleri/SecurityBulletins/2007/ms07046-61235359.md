---
TOCTitle: 'MS07-046'
Title: 'Microsoft Güvenlik Bülteni MS07-046 - Kritik'
ms:assetid: 'ms07-046'
ms:contentKeyID: 61235359
ms:mtpsurl: 'https://technet.microsoft.com/tr-TR/library/ms07-046(v=Security.10)'
---

Security Bulletin

Microsoft Güvenlik Bülteni MS07-046 - Kritik
============================================

GDI'daki Güvenlik Açığı Uzaktan Kod Yürütülmesine İzin Verebilir (938829)
-------------------------------------------------------------------------

Yayım Tarihi: 14 Ağustos 2007 Salı | Güncelleştirme Tarihi: 29 Ağustos 2007 Çarşamba
...
Bu güncelleştirme, Windows 2003 Server Service Pack 2 ve Windows Vista dışındaki tüm desteklenen Windows sürümleri için kritik bir güvenlik güncelleştirmesidir. Daha fazla bilgi için, bu bölümdeki **Etkilenen ve Etkilenmeyen Yazılımlar** alt bölümüne bakın.

Grafik Oluşturma Makinesi'nin resimleri işleme biçimini değiştirerek bu güncelleştirme güvenlik açığını giderir. Bu güvenlik açığı hakkında daha fazla bilgi için, bir sonraki bölüm olan **Güvenlik Açığı Bilgileri** altında, ilgili güvenlik açığı girdisinin Sık Sorulan Sorular (SSS) alt bölümüne bakın.

**Öneriler:** Microsoft, müşterilerinin güvenlik güncelleştirmesini hemen uygulamasını önerir.
...
|---------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------|----------------------|---------------------------------------------------------------------|
| [Microsoft Windows 2000 Service Pack 4](http://www.microsoft.com/downloads/details.aspx?familyid=8fc8340b-c2b3-4559-835c-caa00cf086b9)                  | Uzaktan Kod Yürütme       | Kritik               | [MS06-001](http://technet.microsoft.com/security/bulletin/ms06-001) |
| [Windows XP Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=dc29475d-c0bb-4d35-8dd6-4ca1cac32315)                              | Uzaktan Kod Yürütme       | Kritik               | [MS06-001](http://technet.microsoft.com/security/bulletin/ms06-001) |
| [Windows XP Professional x64 Edition](http://www.microsoft.com/downloads/details.aspx?familyid=3c81730a-981a-4649-b2d9-45144230d512)                    | Uzaktan Kod Yürütme       | Kritik               | [MS06-001](http://technet.microsoft.com/security/bulletin/ms06-001) |
| [Windows Server 2003 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=5374583d-de68-4d65-bca8-598d6b98b8b3)                     | Uzaktan Kod Yürütme       | Kritik               | [MS06-001](http://technet.microsoft.com/security/bulletin/ms06-001) |
| [Windows Server 2003 x64 Edition](http://www.microsoft.com/downloads/details.aspx?familyid=c3359f27-e03e-4a4f-b896-3bda39f69f7e)                        | Uzaktan Kod Yürütme       | Kritik               | [MS06-001](http://technet.microsoft.com/security/bulletin/ms06-001) |
| [Itanium tabanlı sistemler için Windows Server 2003 SP1](http://www.microsoft.com/downloads/details.aspx?familyid=92822479-2060-4357-a340-ed096f180b2b) | Uzaktan Kod Yürütme       | Kritik               | [MS06-001](http://technet.microsoft.com/security/bulletin/ms06-001) |
...
<th style="border:1px solid black;" >GDI'daki Uzaktan Kod Yürütme Güvenlik Açığı – CVE-2007-3034</th>
...
GDI'daki Uzaktan Kod Yürütme Güvenlik Açığı – CVE-2007-3034  
-----------------------------------------------------------
...
Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2007-3034](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-3034).
  
#### GDI'daki Uzaktan Kod Yürütme Güvenlik Açığı – CVE-2007-3034 için Azaltıcı Etkenler
...
-   Bu güvenlik açığından başarıyla yararlanan bir saldırgan, yerel kullanıcı ile aynı haklara sahip olabilir. Hesapları, sistemde az sayıda kullanıcı hakkıyla yapılandırılmış olan kullanıcılar, yönetici haklarıyla çalışan kullanıcılardan daha az etkilenebilir.  
-   Microsoft Windows Vista ve Windows Server 2003 Service Pack 2 bu sorundan etkilenmez.
  
#### GDI'daki Uzaktan Kod Yürütme Güvenlik Açığı – CVE-2007-3034 için Geçici Çözümler
...
-   **Kayıt defterini değiştirerek meta dosya işlemeyi kapatın**
    ...
    [MS07-017](http://go.microsoft.com/fwlink/?linkid=84687)'yi uygulayan veya Windows Vista kullanan müşteriler kayıt defterini değiştirerek meta dosya işlemeyi kapatabilir. Bu ayar, etkilenen sistemin bu güvenlik açığından yararlanma girişimlerine karşı korunmasına yardımcı olur.
...
#### GDI'daki Uzaktan Kod Yürütme Güvenlik Açığı – CVE-2007-3034 Hakkında SSS
...
Güvenlik açığı, Grafik Oluşturma Makinesi'nin özel hazırlanmış resimleri işleme biçiminden kaynaklanmakta ve rasgele kod yürütülmesine olanak vermektedir.
  
**Bir saldırgan bu güvenlik açığından yararlanarak neler yapabilir? **  
Bu güvenlik açığından başarıyla yararlanan bir saldırgan etkilenen sistemde kod yürütebilir.
  
**Bir saldırgan güvenlik açığından nasıl yararlanabilir? **  
Saldırgan, bir e-postada özel hazırlanmış bir ek oluşturup kullanıcıyı bu eki açmaya ikna ederek bu açıktan yararlanabilir. Kullanıcı eki açarsa, saldırgan, saldırgan yerel olarak oturum açmış olan kullanıcının güvenlik bağlamında rasgele kod yürütülmesini sağlayabilir.
  
**GDI nedir? **  
Microsoft Windows grafik aygıt arabirimi (GDI), uygulamaların video görüntüsünde ve yazıcıda grafikler ve biçimlendirilmiş metin kullanabilmesini sağlar. Windows tabanlı uygulamalar grafik donanımına doğrudan erişmez. Bunun yerine, GDI, uygulamalar adına aygıt sürücüleriyle etkileşim kurar. GDI hakkında daha fazla bilgi için, lütfen Windows GDI Başlangıç Sayfasını ziyaret edin.
  
**Bu güvenlik açığından birincil derecede hangi sistemler etkileniyor? **  
İş istasyonları ve terminal sunucuları birincil derecede risk altındadır.
  
**Güncelleştirme ne yapıyor?**    
Güncelleştirme, resim işleme yöntemine taşma doğrulaması eklemek suretiyle güvenlik açığını ortadan kaldırır.
...
| Windows Server 2003 Service Pack 1                     | Evet       | Evet       |  
| Windows Server 2003 x64 Edition                        | Hayır      | Evet       |  
| Itanium tabanlı sistemler için Windows Server 2003 SP1 | Hayır      | Evet       |
...
Windows2000-kb938829-x86-trk /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">Windows 2000 Service Pack 4:<br />
Windows2000-kb938829-Windows2000sp4-x86-trk /norestart</td>
</tr>
<tr class="odd">
...
Windows 2000 Service Pack 4'ün tüm desteklenen sürümleri:

| Dosya Adı  | Sürüm         | Tarih       | Saat  | Boyut   |
|------------|---------------|-------------|-------|---------|
| gdi32.dll  | 5.0.2195.7138 | 26-Haz-2007 | 09:57 | 235.280 |
...
Windowsxp-kb938829-x86-trk /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition:<br />
Windowsserver2003-kb938829-x86-trk /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">Windows XP Service Pack 2:<br />
Windowsxp-kb938829-x86-trk /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition:<br />
Windowsserver2003-kb938829-x86-trk /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Güncelleştirme günlük dosyası</td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>Kaldırma Bilgileri</strong></td>
<td style="border:1px solid black;">Denetim Masası'ndaki Program Ekle veya Kaldır aracını veya %Windir%\$NTUninstallKB938829$\Spuninst klasöründe bulunan Spuninst.exe yardımcı programını kullanın</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Dosya Bilgileri</strong></td>
<td style="border:1px solid black;">Tam dosya listesi için aşağıdaki <strong>Dosya Bilgileri</strong> başlığına bakın</td>
...
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP'nin tüm desteklenen x64 sürümleri:<br />
...
|-----------|---------------|-------------|-------|---------|--------|
| gdi32.dll | 5.1.2600.3159 | 19-Haz-2007 | 01:01 | 282.112 | SP2GDR |
| gdi32.dll | 5.1.2600.3159 | 19-Haz-2007 | 01:07 | 282.112 | SP2QFE |

Windows XP Professional x64 Edition'ın tüm desteklenen sürümleri:

| Dosya Adı  | Sürüm         | Tarih       | Saat  | Boyut   | CPU | Klasör      |
|------------|---------------|-------------|-------|---------|-----|-------------|
| wgdi32.dll | 5.2.3790.2960 | 21-Haz-2007 | 18:10 | 288.256 | X86 | SP1QFE\\wow |
| gdi32.dll  | 5.2.3790.2960 | 21-Haz-2007 | 18:10 | 617.472 | X64 | SP1QFE      |
| wgdi32.dll | 5.2.3790.2960 | 21-Haz-2007 | 18:16 | 287.744 | X86 | SP1GDR\\wow |
| gdi32.dll  | 5.2.3790.2960 | 21-Haz-2007 | 18:16 | 616.960 | X64 | SP1GDR      |
...
<tr class="odd">
<td style="border:1px solid black;">Kullanıcı araya girmeden yükleme</td>
<td style="border:1px solid black;">Windows Server 2003 Service Pack 1, Windows Server 2003 x64 Edition ve Itanium Tabanlı Sistemler için Windows Server 2003 SP1'in tüm desteklenen sürümleri:<br />
Windowsserver2003-kb938829-x86-trk /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
...
<td style="border:1px solid black;"><strong>Kaldırma Bilgileri</strong></td>
<td style="border:1px solid black;">Windows Server 2003 Service Pack 1, Windows Server 2003 x64 Edition ve Itanium Tabanlı Sistemler için Windows Server 2003 SP1'in tüm desteklenen sürümleri:<br />
Denetim Masası'ndaki Program Ekle veya Kaldır aracını veya %Windir%\$NTUninstallKB938829$\Spuninst klasöründe bulunan Spuninst.exe yardımcı programını kullanın</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Dosya Bilgileri</strong></td>
<td style="border:1px solid black;">Tam dosya listesi için aşağıdaki <strong>Dosya Bilgileri</strong> başlığına bakın</td>
...
Windows Server 2003 Service Pack 1'in tüm desteklenen sürümleri::

| Dosya Adı | Sürüm         | Tarih       | Saat  | Boyut   | Klasör |
|-----------|---------------|-------------|-------|---------|--------|
| gdi32.dll | 5.2.3790.2960 | 21-Haz-2007 | 15:41 | 283.648 | SP1GDR |
| gdi32.dll | 5.2.3790.2960 | 21-Haz-2007 | 16:35 | 284.672 | SP1QFE |
...
Itanium Tabanlı Sistemler için Windows Server 2003 SP1'in tüm desteklenen sürümleri:

| Dosya Adı  | Sürüm         | Tarih       | Saat  | Boyut   | CPU   | Klasör      |
|------------|---------------|-------------|-------|---------|-------|-------------|
| wgdi32.dll | 5.2.3790.2960 | 21-Haz-2007 | 18:13 | 288.256 | X86   | SP1QFE\\wow |
| gdi32.dll  | 5.2.3790.2960 | 21-Haz-2007 | 18:13 | 909.312 | IA-64 | SP1QFE      |
| wgdi32.dll | 5.2.3790.2960 | 21-Haz-2007 | 18:16 | 287.744 | X86   | SP1GDR\\wow |
| gdi32.dll  | 5.2.3790.2960 | 21-Haz-2007 | 18:16 | 908.800 | IA-64 | SP1GDR      |
...
-   **Kayıt Defteri Anahtarı Doğrulaması**
    ...
    Bu kayıt defteri anahtarları yüklü dosyaların tam bir listesini içermeyebilir. Ayrıca bir yönetici veya OEM, bu güvenlik güncelleştirmesini Windows kurulum kaynağıyla tümleştirdiğinde veya eklediğinde, bu kayıt defteri anahtarları doğru oluşturulmayabilir.
...
-   [eEye Digital Security](http://www.eeye.com/html/index.html), GDI'daki Uzaktan Kod Yürütme Güvenlik Açığı'nı (CVE-2007-3034) bildirdiği için.
...
-   V1.0 (14 Ağustos 2007): Bülten yayımlandı.
    ...
    V1.1 (29 Ağustos 2007): Bülten Güncelleştirildi: Bu güvenlik açığına yönelik geçici çözümleri içeren ek bilgiler eklenmiştir.
