---
TOCTitle: 'MS07-060'
Title: 'Microsoft Güvenlik Bülteni MS07-060 - Kritik'
ms:assetid: 'ms07-060'
ms:contentKeyID: 61235373
ms:mtpsurl: 'https://technet.microsoft.com/tr-TR/library/ms07-060(v=Security.10)'
---

Security Bulletin

Microsoft Güvenlik Bülteni MS07-060 - Kritik
============================================

Microsoft Word'deki Güvenlik Açığı Uzaktan Kod Yürütülmesine İzin Verebilir (942695)
------------------------------------------------------------------------------------
...
Bu güncelleştirme Microsoft Office 2000, Microsoft Office XP ve Mac için Microsoft Office 2004'ün desteklenen sürümleri için kritik bir güvenlik güncelleştirmesidir. Daha fazla bilgi için, bu bölümdeki **Etkilenen ve Etkilenmeyen Yazılımlar** alt bölümüne bakın.
...
| Office Paketi                                                                 | Bileşen                                                                                                                             | En Yüksek Güvenlik Etkisi | Toplam Önem Derecesi | Bu Güncelleştirmeyle Değiştirilen Bültenler              |
|-------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------|---------------------------|----------------------|----------------------------------------------------------|
| Microsoft Office 2000 Service Pack 3                                          | [Microsoft Word 2000 Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=8b3072fb-5933-47f7-a498-13a93e268e57) | Uzaktan Kod Yürütme       | Kritik               | [MS07-024](http://go.microsoft.com/fwlink/?linkid=85636) |
| Microsoft Office XP Service Pack 3                                            | [Microsoft Word 2002 Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=d6b787bb-03ff-4f67-8b69-6011fb18ba75) | Uzaktan Kod Yürütme       | Önemli               | [MS07-024](http://go.microsoft.com/fwlink/?linkid=85636) |
| [Mac için Microsoft Office 2004](http://www.microsoft.com/mac/downloads.aspx) |                                                                                                                                     | Uzaktan Kod Yürütme       | Önemli               | [MS07-024](http://go.microsoft.com/fwlink/?linkid=85636) |
...
<th style="border:1px solid black;" >Word'de Bellek Bozulması Güvenlik Açığı – CVE-2007-3899</th>
...
Word'de Bellek Bozulması Güvenlik Açığı – CVE-2007-3899  
-------------------------------------------------------
...
Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2007-3899](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-3899).
  
#### Word'de Bellek Bozulması Güvenlik Açığı – CVE-2007-3899 için Azaltıcı Etkenler
  
Azaltıcı etken, varolan bir durumda bulunan ve güvenlik açığından yararlanılmasının önem derecesini azaltabilecek bir ayar, genel yapılandırma ya da en iyi uygulama anlamına gelir. Sizin durumunuzda aşağıdaki azaltıcı etkenler işinize yarayabilir:
  
-   Bu güvenlik açığından 2007 Microsoft Office sisteminde yararlanılamaz.  
-   Bu açıktan Microsoft Office 2003'te uzaktan kod yürütme güvenlik açığı olarak yararlanılamaz. Ancak Microsoft Office 2003 beklenmedik biçimde sonlandırılabilir.  
...
#### Word'de Bellek Bozulması Güvenlik Açığı – CVE-2007-3899 için Geçici Çözümler
...
#### Word'de Bellek Bozulması Güvenlik Açığı – CVE-2007-3899 Hakkında SSS
  
**Bu güvenlik açığının kapsamı nedir? **  
Bu bir uzaktan kod yürütme güvenlik açığıdır. Bu güvenlik açığından başarıyla yararlanan bir saldırgan oturum açan kullanıcıyla aynı ayrıcalıklara sahip olarak rasgele kod çalıştırabilir. Saldırgan, program yükleyebilir; verileri görüntüleyebilir, değiştirebilir veya silebilir; tüm kullanıcı haklarına sahip olan yeni hesaplar oluşturabilir.
...
Güncelleştirme, Microsoft Word'ün özel hazırlanmış dosyaları açarken rasgele kod yürütülmesine izin verecek şekilde sonlandırılmasını engelleyerek güvenlik açığını ortadan kaldırır. Bu güncelleştirme uygulandıktan sonra, kullanıcılar özel hazırlanmış dosyaları açmayı denediklerinde Word yine de beklenmedik biçimde sonlandırılabilir. Ancak bu güncelleştirme ile açık giderilir.
  
**Yine de varolan kararlılık sorunlarını gidermek için ne yapılacak? **  
Microsoft bu kararlılık sorununun benzer kararlılık sorunlarına göre önceliğini belirlerken, Windows Hata Bildirimi hizmetindeki verileri kullanarak uygun teslim mekanizmasını belirleyecektir.
...
|------------------------------------|---------|----------|  
| Microsoft Word 2000 Service Pack 3 | Evet    | Evet     |  
| Microsoft Word 2002 Service Pack 3 | Evet    | Evet     |  
| Mac için Microsoft Office 2004     | Hayır   | Hayır    |
...
<td style="border:1px solid black;">office2000-kb942669-fullfile-trk.exe /q:a</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">office2000-kb942669-fullfile-trk.exe /r:n</td>
</tr>
<tr class="odd">
...
|-------------|------------|-------------|-------|-----------|  
| Winword.exe | 9.0.0.8965 | 23 Ağu 2007 | 02:07 | 8.835.124 |
...
<tr class="odd">
<td style="border:1px solid black;">Kullanıcı araya girmeden yükleme</td>
<td style="border:1px solid black;">officexp-kb942670-fullfile-trk.exe /q:a</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">officexp-kb942670-fullfile-trk.exe /r:n</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Güncelleştirme günlük dosyası</td>
<td style="border:1px solid black;">Uygulanamaz</td>
...
| Dosya Adı   | Sürüm       | Tarih       | Saat  | Boyut      |  
|-------------|-------------|-------------|-------|------------|  
| Winword.exe | 10.0.6835.0 | 23 Ağu 2007 | 03:22 | 10.745.184 |
...
-   Bilgisayarınızda [Mac 11.3.7 için Microsoft Office 2004 Güncelleştirmesi](http://www.microsoft.com/downloads/details.aspx?familyid=f151bc90-e985-4cdf-aea7-285920693f26) yüklü olmalıdır.  
...
Mac 11.3.8 için Microsoft Office 2004 Güncelleştirmesi'nin uygun dil sürümünü [Microsoft Mactopia Web sitesinden](http://www.microsoft.com/mac/downloads.aspx?pid=download&location=/mac/download/office2004/office2004_1138.xml&secid=4&ssid=35&flgnosysreq=true) yükleyip kurun.
...
-   Information and Communication Security Technology Center için çalışan Liu Kun-Hao, Word'de Bellek Bozulması Güvenlik Açığı'nı (CVE-2007-3899) bildirdiği için.
...
-   V1.1 (10 Ekim 2007): Bülten güncelleştirildi: "Dağıtım Bilgileri" bölümündeki köprü, Microsoft Mactopia Web sitesi için 11.3.8 Güncelleştirmesi'nin karşıdan yükleme konumunu doğru gösterecek biçimde güncelleştirildi.  
-   V1.2 (17 Ekim 2007): Bülten güncelleştirildi: Güvenlik Açığı Hakkında SSS bölümü, güncelleştirmenin niteliği ve benzer kararlılık sorunlarını gidermeye yönelik planlar açıklanarak güncelleştirildi.
