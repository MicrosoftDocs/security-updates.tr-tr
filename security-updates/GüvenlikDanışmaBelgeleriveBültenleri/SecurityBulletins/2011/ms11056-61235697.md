---
TOCTitle: 'MS11-056'
Title: 'Microsoft Güvenlik Bülteni MS11-056 - Önemli'
ms:assetid: 'ms11-056'
ms:contentKeyID: 61235697
ms:mtpsurl: 'https://technet.microsoft.com/tr-TR/library/ms11-056(v=Security.10)'
---

Security Bulletin

Microsoft Güvenlik Bülteni MS11-056 - Önemli
============================================

Windows İstemci Sunucu Çalışma Zamanı Alt Sistemi'ndeki Güvenlik Açıkları Ayrıcalık Yükselmesine İzin Verebilir (2507938)
-------------------------------------------------------------------------------------------------------------------------

Yayım Tarihi: 12 Temmuz 2011 Salı | Güncelleştirme Tarihi: 21 Temmuz 2011 Perşembe
...
Güvenlik güncelleştirmesi, bir işlemle birden çok konsol nesnesinin ilişkilendirilmesine izin vermeyerek, CSRSS'nin belleği başlatma biçimini değiştirerek, kullanıcı girişini bir dizenin dizini olarak kullanmadan önce doğrulayarak ve bellek bozulmasını önlemek üzere sınır denetimini değiştirerek bu güvenlik açıklarını giderir. Bu güvenlik açıkları hakkında daha fazla bilgi için, bir sonraki bölüm olan **Güvenlik Açığı Bilgileri** altında, ilgili güvenlik açığı girdisinin Sık Sorulan Sorular (SSS) alt bölümüne bakın.
...
**Bilinen Sorunlar.** [Microsoft Bilgi Bankası makalesi 2507938](http://support.microsoft.com/kb/2507938), bu güvenlik güncelleştirmesini yükleyen müşterilerin karşılaşabileceği bilinen sorunları belgelemektedir. Bu makale ayrıca, bu sorunlar için önerilen çözümleri de içermektedir. Bilinen sorunlar ve önerilen çözümler bu yazılımın yalnızca belirli sürümlerine yöneliktir, ancak bu makalede başka makalelere bağlantılar da sağlanır.
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=a81c011d-eeea-4383-9efb-df70515ab357">Itanium tabanlı sistemler için Windows Server 2003 SP2</a></td>
<td style="border:1px solid black;">Ayrıcalık Yükseltmesi</td>
<td style="border:1px solid black;">Önemli</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=207840">MS11-010</a><em>,</em><br />
<a href="http://go.microsoft.com/fwlink/?linkid=197093">MS10-069</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=a5e192af-dae5-47ef-a9d0-f761a8caa974">Windows Vista Service Pack 1 ve Windows Vista Service Pack 2</a></td>
<td style="border:1px solid black;">Ayrıcalık Yükseltmesi</td>
<td style="border:1px solid black;">Önemli</td>
<td style="border:1px solid black;">Yok</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=1007f5d3-9be1-4f03-a3f0-12ddb555653c">Windows Vista x64 Edition Service Pack 1 ve Windows Vista x64 Edition Service Pack 2</a></td>
<td style="border:1px solid black;">Ayrıcalık Yükseltmesi</td>
<td style="border:1px solid black;">Önemli</td>
<td style="border:1px solid black;">Yok</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=36e3dbaf-36f5-4c74-8f11-ecbef46f58e1">32-bit sistemler için Windows Server 2008 ve 32-bit sistemler için Windows Server 2008 Service Pack 2</a>*</td>
<td style="border:1px solid black;">Ayrıcalık Yükseltmesi</td>
<td style="border:1px solid black;">Önemli</td>
<td style="border:1px solid black;">Yok</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=b43d2ab5-e281-4c6b-bb37-1f1b5d86ac82">x64 tabanlı sistemler için Windows Server 2008 ve x64 tabanlı sistemler için Windows Server 2008 Service Pack 2</a>*</td>
<td style="border:1px solid black;">Ayrıcalık Yükseltmesi</td>
<td style="border:1px solid black;">Önemli</td>
<td style="border:1px solid black;">Yok</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=b70209f2-1c51-45af-b3c4-3473aebcdb35">Itanium tabanlı sistemler için Windows Server 2008 ve Itanium tabanlı sistemler için Windows Server 2008 Service Pack 2</a></td>
<td style="border:1px solid black;">Ayrıcalık Yükseltmesi</td>
<td style="border:1px solid black;">Önemli</td>
<td style="border:1px solid black;">Yok</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=ac3b435c-8caf-40cc-8f13-b52261b3b9e6">32-bit sistemler için Windows 7 ve 32-bit sistemler için Windows 7 Service Pack 1</a></td>
<td style="border:1px solid black;">Ayrıcalık Yükseltmesi</td>
<td style="border:1px solid black;">Önemli</td>
<td style="border:1px solid black;">Yok</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=64e5f889-fa46-4884-9b22-3ba4e2fba1b9">x64 tabanlı sistemler için Windows 7 ve x64 tabanlı sistemler için Windows 7 Service Pack 1</a></td>
<td style="border:1px solid black;">Ayrıcalık Yükseltmesi</td>
<td style="border:1px solid black;">Önemli</td>
<td style="border:1px solid black;">Yok</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=b99a40cf-8a31-43d9-bd0b-a458a533068b">x64 tabanlı sistemler için Windows Server 2008 R2 ve x64 tabanlı sistemler için Windows Server 2008 R2 Service Pack 1</a>*</td>
<td style="border:1px solid black;">Ayrıcalık Yükseltmesi</td>
<td style="border:1px solid black;">Önemli</td>
<td style="border:1px solid black;">Yok</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=784efc20-3a41-42ab-b48d-51fd59d71523">Itanium tabanlı sistemler için Windows Server 2008 R2 ve Itanium tabanlı sistemler için Windows Server 2008 R2 Service Pack 1</a></td>
<td style="border:1px solid black;">Ayrıcalık Yükseltmesi</td>
<td style="border:1px solid black;">Önemli</td>
<td style="border:1px solid black;">Yok</td>
</tr>
...
<th style="border:1px solid black;" >CSRSS'de Yerel EOP AllocConsole Güvenlik Açığı - CVE-2011-1281</th>
<th style="border:1px solid black;" >CSRSS'de Yerel EOP SrvSetConsoleLocalEUDC Güvenlik Açığı - CVE-2011-1282</th>
<th style="border:1px solid black;" >CSRSS'de Yerel EOP SrvSetConsoleNumberOfCommand Güvenlik Açığı - CVE-2011-1283</th>
<th style="border:1px solid black;" >CSRSS'de Yerel EOP SrvWriteConsoleOutput Güvenlik Açığı - CVE-2011-1284</th>
<th style="border:1px solid black;" >CSRSS'de Yerel EOP SrvWriteConsoleOutputString Güvenlik Açığı - CVE-2011-1870</th>
<th style="border:1px solid black;" >Toplam Önem Derecesi</th>
</tr>
</thead>
<tbody>
...
CSRSS'de Yerel EOP AllocConsole Güvenlik Açığı - CVE-2011-1281  
--------------------------------------------------------------
  
<span></span>
Windows CSRSS alt sisteminin belirli kullanıcı işlemleri için belleği ayırma biçimi nedeniyle bir ayrıcalık yükselmesi güvenlik açığı bulunmaktadır. Bu güvenlik açığından başarıyla yararlanan bir saldırgan çekirdek modunda rasgele kod çalıştırabilir. Saldırgan, program yükleyebilir; verileri görüntüleyebilir, değiştirebilir veya silebilir; tüm kullanıcı haklarına sahip olan yeni hesaplar oluşturabilir.
  
Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2011-1281](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1281).
  
#### CSRSS'de Yerel EOP AllocConsole Güvenlik Açığı - CVE-2011-1281 için Azaltıcı Etkenler
...
#### CSRSS'de Yerel EOP AllocConsole Güvenlik Açığı - CVE-2011-1281 için Geçici Çözümler
  
Microsoft bu güvenlik açığı için herhangi bir geçici çözüm belirleyememiştir.
  
#### CSRSS'de Yerel EOP AllocConsole Güvenlik Açığı - CVE-2011-1281 Hakkında SSS
  
**Bu güvenlik açığının kapsamı nedir?**    
Bu bir ayrıcalık yükseltmesi güvenlik açığıdır. Bu açığı başarıyla kullanan bir saldırgan, etkilenen sistemin tüm denetimini ele geçirebilir. Saldırgan, program yükleyebilir; verileri görüntüleyebilir, değiştirebilir veya silebilir; tüm kullanıcı haklarına sahip olan yeni hesaplar oluşturabilir. Saldırganın bu güvenlik açığından yararlanmaya çalışması için, sistemde oturum açabilmesi ve bir programı çalıştırabilmesi gerekir.
  
**Güvenlik açığına ne neden olmaktadır?**    
Bu güvenlik açığı, bir işlemle birden çok konsol nesnesi ilişkilendirildiğinde oluşan bir bellek bozulması koşulu nedeniyle ortaya çıkar. Bu tür bir işlem bulunduğunda, diğer konsol nesneleri bırakılır ve bu nesne tanıtıcısı amaçlanandan daha yüksek bir ayrıcalığa sahip olan başka bir işlem tarafından edinilebilir.
  
**Windows İstemci Sunucu Çalışma Zamanı Alt Sistemi (CSRSS) nedir?**    
İstemci Sunucu Çalışma Zamanı Alt Sistemi (CSRSS), Win32 alt sisteminin kullanıcı modu bölümüdür (çekirdek modu bölümü de Win32.sys dosyasıdır). CSRSS, sürekli çalışması gereken önemli bir alt sistemdir. CSRSS, konsol pencerelerinin yanı sıra iş parçacıklarını oluşturma ve/veya silme işlemlerinden sorumludur.
  
**Bir saldırgan bu güvenlik açığından yararlanarak neler yapabilir?**    
Bu güvenlik açığından başarıyla yararlanan bir saldırgan, bir sistemin bağlamında rasgele kod çalıştırabilir. Saldırgan, program yükleyebilir; verileri görüntüleyebilir, değiştirebilir veya silebilir; tüm kullanıcı haklarına sahip olan yeni hesaplar oluşturabilir.
...
Güncelleştirme, bir işlemle birden çok konsol nesnesinin ilişkilendirilmesine izin vermeyerek bu güvenlik açığını giderir.
...
CSRSS'de Yerel EOP SrvSetConsoleLocalEUDC Güvenlik Açığı - CVE-2011-1282  
------------------------------------------------------------------------
  
<span></span>
Windows CSRSS alt sisteminin belirli kullanıcı işlemleri için belleği ayırma biçimi nedeniyle bir ayrıcalık yükselmesi güvenlik açığı bulunmaktadır. Bu güvenlik açığından başarıyla yararlanan bir saldırgan çekirdek modunda rasgele kod çalıştırabilir. Saldırgan, program yükleyebilir; verileri görüntüleyebilir, değiştirebilir veya silebilir; tüm kullanıcı haklarına sahip olan yeni hesaplar oluşturabilir
  
Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2011-1282](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1282).
  
#### CSRSS'de Yerel EOP SrvSetConsoleLocalEUDC Güvenlik Açığı - CVE-2011-1282 için Azaltıcı Etkenler
  
Azaltıcı etken, varolan bir durumda bulunan ve güvenlik açığından yararlanılmasının önem derecesini azaltabilecek bir ayar, genel yapılandırma ya da en iyi uygulama anlamına gelir. Sizin durumunuzda aşağıdaki azaltıcı etkenler işinize yarayabilir:
  
-   Saldırganın bu güvenlik açığından yararlanabilmesi için geçerli oturum açma kimlik bilgilerine sahip olması ve yerel olarak oturum açabilmesi gerekir.
  
#### CSRSS'de Yerel EOP SrvSetConsoleLocalEUDC Güvenlik Açığı - CVE-2011-1282 için Geçici Çözümler
  
Microsoft bu güvenlik açığı için herhangi bir geçici çözüm belirleyememiştir.
  
#### CSRSS'de Yerel EOP SrvSetConsoleLocalEUDC Güvenlik Açığı - CVE-2011-1282 Hakkında SSS
  
**Bu güvenlik açığının kapsamı nedir?**    
Bu bir ayrıcalık yükseltmesi güvenlik açığıdır. Bu açığı başarıyla kullanan bir saldırgan, etkilenen sistemin tüm denetimini ele geçirebilir. Saldırgan, program yükleyebilir; verileri görüntüleyebilir, değiştirebilir veya silebilir; tüm kullanıcı haklarına sahip olan yeni hesaplar oluşturabilir. Saldırganın bu güvenlik açığından yararlanmaya çalışması için, sistemde oturum açabilmesi ve bir programı çalıştırabilmesi gerekir.
  
**Güvenlik açığına ne neden olmaktadır?**    
Bu, sistem bağlamında kod yürütülmesine izin verebilecek bir bellek bozulması güvenlik açığıdır. CSRSS'deki bir işleve doğrulama olmadan bir BOŞ işaretçi geçirilir. Bu, CSRSS'nin kendi işlem alanına bir BOŞ sayfa yazmasına neden olur. Windows XP tabanlı sistemlerde belirli koşullar altında, bu sayfa artırılmış izinlerle kod yürütmek üzere bir saldırgan tarafından kullanılabilir.
...
**Güncelleştirme ne yapıyor?**    
Güncelleştirme, CSRSS'nin sistem bağlamında rasgele kod yürütülmesini önlemek üzere belleği başlatma biçimini değiştirerek bu güvenlik açığını giderir.
...
CSRSS'de Yerel EOP SrvSetConsoleNumberOfCommand Güvenlik Açığı - CVE-2011-1283  
------------------------------------------------------------------------------
  
<span></span>
Windows CSRSS alt sisteminin belirli kullanıcı işlemleri için belleği ayırma biçimi nedeniyle bir ayrıcalık yükselmesi güvenlik açığı bulunmaktadır. Bu güvenlik açığından başarıyla yararlanan bir saldırgan çekirdek modunda rasgele kod çalıştırabilir. Saldırgan, program yükleyebilir; verileri görüntüleyebilir, değiştirebilir veya silebilir; tüm kullanıcı haklarına sahip olan yeni hesaplar oluşturabilir.
  
Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2011-1283](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1283).
  
#### CSRSS'de Yerel EOP SrvSetConsoleNumberOfCommand Güvenlik Açığı - CVE-2011-1283 için Azaltıcı Etkenler
  
Azaltıcı etken, varolan bir durumda bulunan ve güvenlik açığından yararlanılmasının önem derecesini azaltabilecek bir ayar, genel yapılandırma ya da en iyi uygulama anlamına gelir. Sizin durumunuzda aşağıdaki azaltıcı etkenler işinize yarayabilir:
  
-   Saldırganın bu güvenlik açığından yararlanabilmesi için geçerli oturum açma kimlik bilgilerine sahip olması ve yerel olarak oturum açabilmesi gerekir.
  
#### CSRSS'de Yerel EOP SrvSetConsoleNumberOfCommand Güvenlik Açığı - CVE-2011-1283 için Geçici Çözümler
  
Microsoft bu güvenlik açığı için herhangi bir geçici çözüm belirleyememiştir.
  
#### CSRSS'de Yerel EOP SrvSetConsoleNumberOfCommand Güvenlik Açığı - CVE-2011-1283 Hakkında SSS
  
**Bu güvenlik açığının kapsamı nedir?**    
Bu bir ayrıcalık yükseltmesi güvenlik açığıdır. Bu açığı başarıyla kullanan bir saldırgan, etkilenen sistemin tüm denetimini ele geçirebilir. Saldırgan, program yükleyebilir; verileri görüntüleyebilir, değiştirebilir veya silebilir; tüm kullanıcı haklarına sahip olan yeni hesaplar oluşturabilir. Saldırganın bu güvenlik açığından yararlanmaya çalışması için, sistemde oturum açabilmesi ve bir programı çalıştırabilmesi gerekir.
  
**Güvenlik açığına ne neden olmaktadır?**    
Bu güvenlik açığı, kullanıcı girişi öncelikle bir negatif değere sahip olup olmadığı denetlenmeden bir dizenin dizini olarak kullanıldığında ortaya çıkar. Bu, bir saldırganın bellek alanlarındaki verileri okumasına veya kod yürütülmesine izin verecek biçimde belleği bozmasına olanak verebilir.
...
**Güncelleştirme ne yapıyor?**    
Güncelleştirme, kullanıcı girişini bir dizenin dizini olarak kullanmadan önce doğrulayarak bu güvenlik açığını giderir.
...
CSRSS'de Yerel EOP SrvWriteConsoleOutput Güvenlik Açığı - CVE-2011-1284  
-----------------------------------------------------------------------
  
<span></span>
Windows CSRSS alt sisteminin belirli kullanıcı işlemleri için belleği ayırma biçimi nedeniyle bir ayrıcalık yükselmesi güvenlik açığı bulunmaktadır. Bu güvenlik açığından başarıyla yararlanan bir saldırgan çekirdek modunda rasgele kod çalıştırabilir. Saldırgan, program yükleyebilir; verileri görüntüleyebilir, değiştirebilir veya silebilir; tüm kullanıcı haklarına sahip olan yeni hesaplar oluşturabilir.
  
Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2011-1284](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1284).
  
#### CSRSS'de Yerel EOP SrvWriteConsoleOutput Güvenlik Açığı - CVE-2011-1284 için Azaltıcı Etkenler
  
Azaltıcı etken, varolan bir durumda bulunan ve güvenlik açığından yararlanılmasının önem derecesini azaltabilecek bir ayar, genel yapılandırma ya da en iyi uygulama anlamına gelir. Sizin durumunuzda aşağıdaki azaltıcı etkenler işinize yarayabilir:
  
-   Saldırganın bu güvenlik açığından yararlanabilmesi için geçerli oturum açma kimlik bilgilerine sahip olması ve yerel olarak oturum açabilmesi gerekir.
  
#### CSRSS'de Yerel EOP SrvWriteConsoleOutput Güvenlik Açığı - CVE-2011-1284 için Geçici Çözümler
  
Microsoft bu güvenlik açığı için herhangi bir geçici çözüm belirleyememiştir.
  
#### CSRSS'de Yerel EOP SrvWriteConsoleOutput Güvenlik Açığı - CVE-2011-1284 Hakkında SSS
  
**Bu güvenlik açığının kapsamı nedir?**    
Bu bir ayrıcalık yükseltmesi güvenlik açığıdır. Bu açığı başarıyla kullanan bir saldırgan, etkilenen sistemin tüm denetimini ele geçirebilir. Saldırgan, program yükleyebilir; verileri görüntüleyebilir, değiştirebilir veya silebilir; tüm kullanıcı haklarına sahip olan yeni hesaplar oluşturabilir.
  
**Güvenlik açığına ne neden olmaktadır?**    
Bu güvenlik açığı, bir saldırganın sistem hesabı bağlamında kod yürütmesine izin verebilecek bir tamsayı taşması koşulu nedeniyle ortaya çıkar.
...
**Güncelleştirme ne yapıyor?**    
Güncelleştirme, bellek bozulmasını ve kod yürütülmesini önlemek üzere sınır denetimini değiştirerek bu güvenlik açığını giderir.
...
CSRSS'de Yerel EOP SrvWriteConsoleOutputString Güvenlik Açığı - CVE-2011-1870  
-----------------------------------------------------------------------------
  
<span></span>
Windows CSRSS alt sisteminin belirli kullanıcı işlemleri için belleği ayırma biçimi nedeniyle bir ayrıcalık yükselmesi güvenlik açığı bulunmaktadır. Bu güvenlik açığından başarıyla yararlanan bir saldırgan çekirdek modunda rasgele kod çalıştırabilir. Saldırgan, program yükleyebilir; verileri görüntüleyebilir, değiştirebilir veya silebilir; tüm kullanıcı haklarına sahip olan yeni hesaplar oluşturabilir.
  
Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2011-1870](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1870).
  
#### CSRSS'de Yerel EOP SrvWriteConsoleOutputString Güvenlik Açığı - CVE-2011-1870 için Azaltıcı Etkenler
  
Azaltıcı etken, varolan bir durumda bulunan ve güvenlik açığından yararlanılmasının önem derecesini azaltabilecek bir ayar, genel yapılandırma ya da en iyi uygulama anlamına gelir. Sizin durumunuzda aşağıdaki azaltıcı etkenler işinize yarayabilir:
  
-   Saldırganın bu güvenlik açığından yararlanabilmesi için geçerli oturum açma kimlik bilgilerine sahip olması ve yerel olarak oturum açabilmesi gerekir.
  
#### CSRSS'de Yerel EOP SrvWriteConsoleOutputString Güvenlik Açığı - CVE-2011-1870 için Geçici Çözümler
  
Microsoft bu güvenlik açığı için herhangi bir geçici çözüm belirleyememiştir.
  
#### CSRSS'de Yerel EOP SrvWriteConsoleOutputString Güvenlik Açığı - CVE-2011-1870 Hakkında SSS
...
**Güncelleştirme ne yapıyor?**    
Güncelleştirme, bellek bozulmasını önlemek üzere sınır denetimini değiştirerek bu güvenlik açığını giderir.
...
WindowsXP-KB2507938-x86-trk.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition Service Pack 2:<br />
WindowsServer2003.WindowsXP-KB2507938-x64-trk.exe /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">Windows XP Service Pack 3 için:<br />
WindowsXP-KB2507938-x86-trk.exe /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition Service Pack 2:<br />
WindowsServer2003.WindowsXP-KB2507938-x64-trk.exe /norestart</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">Denetim Masası'ndaki <strong>Program Ekle veya Kaldır</strong> aracını veya %Windir%\$NTUninstallKB2507938$\Spuninst klasöründe bulunan Spuninst.exe yardımcı programını kullanın</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Dosya Bilgileri</strong></td>
<td style="border:1px solid black;">Bkz: <a href="http://support.microsoft.com/kb/2507938">Microsoft Bilgi Bankası makalesi 2507938</a></td>
</tr>
<tr class="even">
...
WindowsServer2003-KB2507938-x86-trk.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
WindowsServer2003-KB2507938-ia64-trk.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen 32 bit sürümleri:<br />
WindowsServer2003-KB2507938-x86-trk.exe /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen x64 tabanlı sürümleri:<br />
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen Itanium tabanlı sürümleri:<br />
WindowsServer2003-KB2507938-ia64-trk.exe /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Güncelleştirme günlük dosyası</td>
<td style="border:1px solid black;">KB2507938.log</td>
...
-   [Hispasec](http://www.hispasec.com/) [Virustotal](http://www.virustotal.com/) için çalışan Matthew 'j00ru' Jurczyk, CSRSS'de Yerel EOP AllocConsole Güvenlik Açığı'nı (CVE-2011-1281) bildirdiği için  
-   [Hispasec](http://www.hispasec.com/) [Virustotal](http://www.virustotal.com/) için çalışan Matthew 'j00ru' Jurczyk, CSRSS'de Yerel EOP SrvSetConsoleLocalEUDC Güvenlik Açığı'nı (CVE-2011-1282) bildirdiği için  
-   [Hispasec](http://www.hispasec.com/) [Virustotal](http://www.virustotal.com/) için çalışan Matthew 'j00ru' Jurczyk, CSRSS'de Yerel EOP SrvSetConsoleNumberOfCommand Güvenlik Açığı'nı (CVE-2011-1283) bildirdiği için  
-   [Hispasec](http://www.hispasec.com/) [Virustotal](http://www.virustotal.com/) için çalışan Matthew 'j00ru' Jurczyk, CSRSS'de Yerel EOP SrvWriteConsoleOutput Güvenlik Açığı'nı (CVE-2011-1284) bildirdiği için  
-   [Hispasec](http://www.hispasec.com/) [Virustotal](http://www.virustotal.com/) için çalışan Matthew 'j00ru' Jurczyk, CSRSS'de Yerel EOP SrvWriteConsoleOutputString Güvenlik Açığı'nı (CVE-2011-1870) bildirdiği için
...
-   V1.1 (21 Temmuz 2011): Yürütmeyle İlgili Özet altındaki Bilinen Sorunlar bölümüne Microsoft Bilgi Bankası makalesi 2507938 için bir bağlantı eklendi.
