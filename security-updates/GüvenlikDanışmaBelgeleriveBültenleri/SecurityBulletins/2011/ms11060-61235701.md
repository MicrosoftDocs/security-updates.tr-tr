---
TOCTitle: 'MS11-060'
Title: 'Microsoft Güvenlik Bülteni MS11-060 - Önemli'
ms:assetid: 'ms11-060'
ms:contentKeyID: 61235701
ms:mtpsurl: 'https://technet.microsoft.com/tr-TR/library/ms11-060(v=Security.10)'
---

Security Bulletin

Microsoft Güvenlik Bülteni MS11-060 - Önemli
============================================

Microsoft Visio'daki Güvenlik Açıkları Uzaktan Kod Yürütülmesine İzin Verebilir (2560978)
-----------------------------------------------------------------------------------------
...
Bu güvenlik güncelleştirmesi Microsoft Visio 2003, Microsoft Visio 2007 ve Microsoft Visio 2010'un tüm desteklenen sürümleri için Önemli olarak derecelendirilmiştir. Daha fazla bilgi için, bu bölümdeki **Etkilenen ve Etkilenmeyen Yazılımlar** alt bölümüne bakın.

Güvenlik güncelleştirmesi, Microsoft Visio'nun özel hazırlanmış Visio dosyalarını ayrıştırırken bellekteki nesneleri doğrulama biçimini düzelterek bu güvenlik açıklarını giderir. Bu güvenlik açığı hakkında daha fazla bilgi için, bir sonraki bölüm olan **Güvenlik Açığı Bilgileri** altında, ilgili güvenlik açığı girdisinin Sık Sorulan Sorular (SSS) alt bölümüne bakın.
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=6da236c2-0ef5-4c13-8393-673b70298a77">Microsoft Visio 2010 ve Microsoft Visio 2010 Service Pack 1 (32-bit sürümler)</a><br />
(KB2553008)</td>
<td style="border:1px solid black;">Uzaktan Kod Yürütme</td>
<td style="border:1px solid black;">Önemli</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=b7f5f2a9-116a-41ef-a19e-a7dd0947d2cb">Microsoft Visio 2010 ve Microsoft Visio 2010 Service Pack 1 (64-bit sürümler)</a><br />
(KB2553008)</td>
<td style="border:1px solid black;">Uzaktan Kod Yürütme</td>
<td style="border:1px solid black;">Önemli</td>
<td style="border:1px solid black;">Yok</td>
...
<th style="border:1px solid black;" >pStream Sürümünde RCE Güvenlik Açığı - CVE-2011-1972</th>
<th style="border:1px solid black;" >Deneyim Kazanma RCE Güvenlik Açığı - CVE-2011-1979</th>
<th style="border:1px solid black;" >Toplam Önem Derecesi</th>
</tr>
</thead>
<tbody>
...
<tr class="odd">
<td style="border:1px solid black;">Microsoft Visio 2010 (32-bit sürümler) ve Microsoft Visio 2010 (32-bit sürümler) Service Pack 1</td>
<td style="border:1px solid black;"><strong>Önemli</strong> <br />
Uzaktan Kod Yürütme</td>
...
<tr class="even">
<td style="border:1px solid black;">Microsoft Visio 2010 (64-bit sürümler) ve Microsoft Visio 2010 (64-bit sürümler) Service Pack 1</td>
<td style="border:1px solid black;"><strong>Önemli</strong> <br />
Uzaktan Kod Yürütme</td>
<td style="border:1px solid black;">Uygulanamaz</td>
<td style="border:1px solid black;"><strong>Önemli</strong></td>
...
pStream Sürümünde RCE Güvenlik Açığı - CVE-2011-1972  
----------------------------------------------------
...
Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2011-1972](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1972).
  
#### pStream Sürümünde RCE Güvenlik Açığı - CVE-2011-1972 için Azaltıcı Etkenler
...
#### pStream Sürümünde RCE Güvenlik Açığı - CVE-2011-1972 için Geçici Çözümler
...
#### pStream Sürümünde RCE Güvenlik Açığı - CVE-2011-1972 Hakkında SSS
...
Deneyim Kazanma RCE Güvenlik Açığı - CVE-2011-1979  
--------------------------------------------------
  
<span></span>
Microsoft Visio'nun özel hazırlanmış Visio dosyalarını ayrıştırırken bellekteki nesneleri doğrulama biçiminde bir uzaktan kod yürütme güvenlik açığı bulunmaktadır. Bu açığı başarıyla kullanan bir saldırgan, etkilenen sistemin tüm denetimini ele geçirebilir. Saldırgan, program yükleyebilir; verileri görüntüleyebilir, değiştirebilir veya silebilir; tüm kullanıcı haklarına sahip olan yeni hesaplar oluşturabilir. Hesapları, sistemde az sayıda kullanıcı hakkıyla yapılandırılmış olan kullanıcılar, yönetici haklarıyla çalışan kullanıcılardan daha az etkilenebilir.
  
Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2011-1979](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1979).
  
#### Deneyim Kazanma RCE Güvenlik Açığı - CVE-2011-1979 için Azaltıcı Etkenler
...
#### Deneyim Kazanma RCE Güvenlik Açığı - CVE-2011-1979 için Geçici Çözümler
...
#### Deneyim Kazanma RCE Güvenlik Açığı - CVE-2011-1979 Hakkında SSS
...
| Microsoft Visio 2010 (32-bit sürümler) ve Microsoft Visio 2010 (32-bit sürümler) Service Pack 1 | Evet |  
| Microsoft Visio 2010 (64-bit sürümler) ve Microsoft Visio 2010 (64-bit sürümler) Service Pack 1 | Evet |
...
| Microsoft Visio 2007 Service Pack 2                                                             | Evet                       | Evet                       |  
| Microsoft Visio 2010 (32-bit sürümler) ve Microsoft Visio 2010 (32-bit sürümler) Service Pack 1 | Evet                       | Evet                       |  
| Microsoft Visio 2010 (64-bit sürümler) ve Microsoft Visio 2010 (64-bit sürümler) Service Pack 1 | Evet                       | Evet                       |
...
#### Microsoft Visio 2003 (tüm sürümler)
...
<td style="border:1px solid black;">visio2003-kb2553009-FullFile-TRK.exe /q:a</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">visio2003-kb2553009-FullFile-TRK.exe /r:n</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">Bkz: <a href="http://support.microsoft.com/kb/2553009">Microsoft Bilgi Bankası makalesi 2553009</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Dosya Bilgileri</strong></td>
<td style="border:1px solid black;">Bkz: <a href="http://support.microsoft.com/kb/2553010">Microsoft Bilgi Bankası makalesi 2553010</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Kayıt Defteri Anahtarı Doğrulaması</strong></td>
<td style="border:1px solid black;">Uygulanamaz</td>
...
#### Microsoft Visio 2010 (tüm sürümler)
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Dosya Bilgileri</strong></td>
<td style="border:1px solid black;">Bkz: <a href="http://support.microsoft.com/kb/2553008">Microsoft Bilgi Bankası makalesi 2553008</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Kayıt Defteri Anahtarı Doğrulaması</strong></td>
<td style="border:1px solid black;">Uygulanamaz</td>
...
-   [Baidu Security Team](http://www.baidu.com) için çalışan Linlin Zhao, pStream Sürümünde RCE Güvenlik Açığı'nı (CVE-2011-1972) bildirdiği için  
-   [Baidu Security Team](http://www.baidu.com) için çalışan Linlin Zhao, Deneyim Kazanma RCE Güvenlik Açığı'nı (CVE-2011-1979) bildirdiği için
