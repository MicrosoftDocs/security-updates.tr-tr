---
TOCTitle: 'MS11-078'
Title: 'Microsoft Güvenlik Bülteni MS11-078 - Kritik'
ms:assetid: 'ms11-078'
ms:contentKeyID: 61235719
ms:mtpsurl: 'https://technet.microsoft.com/tr-TR/library/ms11-078(v=Security.10)'
---

Security Bulletin

Microsoft Güvenlik Bülteni MS11-078 - Kritik
============================================

.NET Framework ve Microsoft Silverlight'taki Güvenlik Açığı Uzaktan Kod Yürütülmesine İzin Verebilir (2604930)
--------------------------------------------------------------------------------------------------------------
...
Bu güvenlik güncelleştirmesi Microsoft Windows'un tüm desteklenen sürümleri üzerinde Microsoft .NET Framework 1.0 Service Pack 3, Microsoft .NET Framework 1.1 Service Pack 1, Microsoft .NET Framework 2.0 Service Pack 2, Microsoft .NET Framework 3.5.1 ve Microsoft .NET Framework 4 ile Microsoft Silverlight 4 için Kritik olarak derecelendirilmiştir. Daha fazla bilgi için, bu bölümdeki **Etkilenen ve Etkilenmeyen Yazılımlar** alt bölümüne bakın.

Güvenlik güncelleştirmesi, .NET Framework'ün sınıflar içinde devralmayı kısıtlama biçimini düzelterek bu güvenlik açığını giderir. Bu güvenlik açığı hakkında daha fazla bilgi için, bir sonraki bölüm olan **Güvenlik Açığı Bilgileri** altında, ilgili güvenlik açığı girdisinin Sık Sorulan Sorular (SSS) alt bölümüne bakın.
...
**Bilinen Sorunlar.**[Microsoft Bilgi Bankası makalesi 2604930](http://support.microsoft.com/kb/2604930), bu güvenlik güncelleştirmesini yükleyen müşterilerin karşılaşabileceği bilinen sorunları belgelemektedir. Bu makale ayrıca, bu sorunlar için önerilen çözümleri de içermektedir.
...
<td style="border:1px solid black;">
[MS09-061](http://go.microsoft.com/fwlink/?linkid=160527)'deki KB953295'in yerini KB2572066 almıştır  
[MS10-070](http://go.microsoft.com/fwlink/?linkid=202409)'teki KB2416447'nin yerini KB2572067 almıştır  
[MS10-060](http://go.microsoft.com/fwlink/?linkid=179830)'daki KB983583'ün yerini KB2572073 almıştır  
KB2572078 yerine hiçbir bülten sunulmamaktadır
</td>
</tr>
...
<td style="border:1px solid black;">
[MS09-061](http://go.microsoft.com/fwlink/?linkid=?????)'deki KB953298'in yerini KB2572069 almıştır  
[MS10-060](http://go.microsoft.com/fwlink/?linkid=179830)'daki KB983583'ün yerini KB2572073 almıştır  
KB2572078 yerine hiçbir bülten sunulmamaktadır
</td>
</tr>
...
<td style="border:1px solid black;">
[MS10-070](http://go.microsoft.com/fwlink/?linkid=202409)'teki KB2416447'nin yerini KB2572067 almıştır  
[MS10-060](http://go.microsoft.com/fwlink/?linkid=179830)'daki KB983589'un yerini KB2572075 almıştır  
KB2572078 yerine hiçbir bülten sunulmamaktadır
</td>
</tr>
<tr>
...
<td style="border:1px solid black;">
KB2572076 yerine hiçbir bülten sunulmamaktadır  
KB2572078 yerine hiçbir bülten sunulmamaktadır
</td>
</tr>
<tr class="alternateRow">
...
<td style="border:1px solid black;">
KB2572077 yerine hiçbir bülten sunulmamaktadır  
KB2572078 yerine hiçbir bülten sunulmamaktadır
</td>
</tr>
<tr>
...
Bu bültenin ilk yayımlandığı tarihteki güncel Microsoft Silverlight yapısı olan Microsoft Silverlight yapı 4.0.60831 bu güvenlik açığını giderir ve sorundan etkilenmez. 4.0.60831 öncesindeki Microsoft Silverlight yapıları sorundan etkilenir.
...
Bu güvenlik güncelleştirmesi ile birlikte yüklenen sürüm 4.0.60831 sürümüdür. Sürüm numaranız bundan büyük veya buna eşitse sisteminizden bu açıktan etkilenmez.
...
**Silverlight 5 Beta veya Sürüm Adayı (RC) sürümleri bu güvenlik açığından etkileniyor mu?**
Hayır, Silverlight 5'in hiçbir sürümü bu sorundan etkilenmemektedir.
...
Bu bültende .NET Framework 1.1, .NET Framework 2.0 ve .NET Framework 4 özellik katmanlarındaki bir güvenlik açığı açıklanır. .NET Framework 3.0 Service Pack 2 yükleyicisi, .NET Framework 2.0 Service Pack 2 kurulumu için zincir oluşturarak bir sürümün daha önceki sürümü de yüklemesini sağlar. Bu nedenle, .NET Framework 3.0 Service Pack 2'nin yüklü olduğu müşterilerin .NET Framework 2.0 Service Pack 2 güvenlik güncelleştirmelerini yüklemeleri gerekmektedir.

**.NET Framework 3.5 Service Pack 1 yüklü. Herhangi bir güncelleştirme yüklemem gerekiyor mu?**
Bu bültende .NET Framework 1.1'de, .NET Framework 2.0 özellik katmanında ve .NET Framework 4'te bulunan bir güvenlik açığı açıklanır. .NET Framework 3.5 Service Pack 1 yükleyicisi hem .NET Framework 2.0 Service Pack 2 kurulumunu hem de .NET Framework 3.0 Service Pack 2 kurulumunu art arda yükler. Bu nedenle, .NET Framework 3.5 Service Pack 1'in yüklü olduğu müşterilerin .NET Framework 2.0 Service Pack 2 güvenlik güncelleştirmelerini yüklemeleri gerekmektedir.
...
<th style="border:1px solid black;" >
.NET Framework'te Sınıf Devralma Güvenlik Açığı - CVE-2011-1253
</th>
<th style="border:1px solid black;" >
Toplam Önem Derecesi
</th>
...
<span></span>
Microsoft .NET Framework ve Silverlight altyapısının sınıflar içinde devralmayı kısıtlama biçiminde bir uzaktan kod yürütme güvenlik açığı bulunmaktadır. Bu güvenlik açığından başarıyla yararlanan bir saldırgan, oturum açmış kullanıcının güvenlik bağlamında rasgele kod çalıştırabilir. Saldırgan, program yükleyebilir; verileri görüntüleyebilir, değiştirebilir veya silebilir; tüm kullanıcı haklarına sahip olan yeni hesaplar oluşturabilir. Hesapları, sistemde az sayıda kullanıcı hakkıyla yapılandırılmış olan kullanıcılar, yönetici haklarıyla çalışan kullanıcılardan daha az etkilenebilir.

Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2011-1253](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1253).

#### .NET Framework'te Sınıf Devralma Güvenlik Açığı - CVE-2011-1253 için Azaltıcı Etkenler
...
#### .NET Framework'te Sınıf Devralma Güvenlik Açığı - CVE-2011-1253 için Geçici Çözümler
...
#### .NET Framework'te Sınıf Devralma Güvenlik Açığı - CVE-2011-1253 Hakkında SSS
...
Güvenlik açığı, .NET Framework'ün sınıflar içinde devralmayı düzgün kısıtlamaması nedeniyle ortaya çıkar.
...
**Windows Server** **2003,Windows Server 2008veya Windows Server 2008 R2 için Internet Explorer çalıştırıyorum. Bu durum, bu güvenlik açığının etkisini azaltır mı?**
Evet. Windows Server 2003, Windows Server 2008 ve Windows Server 2008 R2 üzerinde Internet Explorer varsayılan olarak [Artırılmış Güvenlik Yapılandırması](http://technet.microsoft.com/en-us/library/dd883248(ws.10).aspx) adı verilen kısıtlı bir modda çalışır. Artırılmış Güvenlik Yapılandırması, bir kullanıcının veya yöneticinin bir sunucudaki özel hazırlanmış Web içeriğini yükleme ve çalıştırma olasılığını azaltan, bir grup önceden yapılandırılmış Internet Explorer ayarıdır. Bu, Internet Explorer'ın Güvenilen siteler bölgesine eklenmemiş Web siteleri için bir azaltıcı etkendir. CVE-2011-1253 için, Artırılmış Güvenlik Yapılandırması bu güvenlik açığının etkilerini yalnızca Windows Server 2008 ve Windows Server 2008 R2 üzerinde ve yalnızca bir Web'de gezinme tabanlı saldırı senaryosunda azaltır.

**Güncelleştirme ne yapıyor?**
Güncelleştirme, .NET Framework'ün sınıflar içinde devralmayı kısıtlama biçimini düzelterek bu güvenlik açığını giderir.
...
<td style="border:1px solid black;">Bkz: <a href="http://support.microsoft.com/kb/2604930">Microsoft Bilgi Bankası makalesi 2604930</a></td>
</tr>
<tr class="odd">
...
**Microsoft .NET Framework 1.0 Service Pack 3 Güncelleştirmesi'ni (KB2572066) yükleme**
...
**Microsoft .NET Framework 1.1 Service Pack 1 Güncelleştirmesi'ni (KB2572067) yükleme**
...
**Microsoft** **.NET Framework 2.0 Service Pack 2(KB2572073)ve** **Microsoft .NET Framework 4(KB2572078) Güncelleştirmesi'ni yükleme**
...
**Microsoft .NET Framework 1.0 Service Pack 3 Güncelleştirmesi'ni** **(KB2572066) kaldırma**
...
**Microsoft .NET Framework 1.1 Service Pack 1 Güncelleştirmesi'ni (KB2572067) kaldırma**
...
**Microsoft .NET Framework 2.0 Service Pack 2 (KB2572073** **ve Microsoft .NET Framework 4.0 (KB2572078) Güncelleştirmesi'ni kaldırma**
...
WindowsServer2003-KB2572069-x86-trk.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003 Service Pack 2 üzerine yüklendiğinde Microsoft .NET Framework 2.0 Service Pack 2:<br />
NDP20SP2-KB2572073-x86.exe /q</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
...
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003 x64 Edition Service Pack 2 üzerine yüklendiğinde Microsoft .NET Framework 1.1 Service Pack 1:<br />
NDP1.1sp1-KB2572067-X86.exe /q</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003 x64 Edition Service Pack 2 üzerine yüklendiğinde Microsoft .NET Framework 2.0 Service Pack 2:<br />
NDP20SP2-KB2572073-x64.exe /q</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Itanium tabanlı sistemler için Windows Server 2003 Service Pack 2 üzerine yüklendiğinde Microsoft .NET Framework 1.1 Service Pack 1:<br />
NDP1.1sp1-KB2572067-X86.exe /q</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Itanium tabanlı sistemler için Windows Server 2003 SP2 üzerine yüklendiğinde Microsoft .NET Framework 2.0 Service Pack 2:<br />
...
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">Windows Server 2003 Service Pack 2 üzerinde Microsoft .NET Framework 1.1 Service Pack 1:<br />
WindowsServer2003-KB2572069-x86-trk.exe /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003 Service Pack 2 üzerine yüklendiğinde Microsoft .NET Framework 2.0 Service Pack 2:<br />
...
**Windows Server 2003 Service Pack 2** **üzerine** **Microsoft .NET Framework 1.1 Service Pack 1 Güncelleştirmesi'ni** **(KB2572069) yükleme**

Bu güvenlik güncelleştirmesi Windows Server 2003 Service Pack 2 üzerinde Microsoft .NET Framework 1.1 Service Pack 1 (KB2572069) için aşağıdaki kurulum anahtarlarını destekler.
...
**Windows Server 2003 x64 Edition Service Pack 2** **ve Itanium tabanlı sistemler için Windows Server 2003 Service Pack 2** **üzerinde** **Microsoft .NET Framework 1.1 Service Pack 1 Güncelleştirmesi'ni** **(KB2572067) yükleme**
...
**Windows Server 2003 Service Pack 2** **üzerinde Microsoft .NET Framework 1.1 Service Pack 1 Güncelleştirmesi'ni (KB2572069) kaldırma**
...
**Windows Server 2003 x64 Edition Service Pack 2** **ve Itanium tabanlı sistemler için Windows Server 2003 Service Pack 2** **üzerinde Microsoft .NET Framework 1.1 Service Pack 1 Güncelleştirmesi'ni (KB2572067) kaldırma**
...
**Microsoft .NET Framework 2.0 Service Pack 2 Güncelleştirmesi'ni (KB2572075) kaldırma**
...
<td style="border:1px solid black;">
Durum veya hata iletilerinin görüntülenmesini bastırır.
</td>
</tr>
<tr>
<th colspan="2">
...
<td style="border:1px solid black;">
/quiet anahtarıyla birlikte kullanılırsa, yükleme işlemini tamamlamak için yeniden başlatma gerekse de yükleme sonrasında sistem yeniden başlatılmaz.
</td>
</tr>
</table>
...
**Microsoft .NET Framework 4 Güncelleştirmesi'ni (KB2572078) yükleme**
...
-   Anonim bir katılımcı, [Beyond Security bünyesindeki SecuriTeam Secure Disclosure](http://www.beyondsecurity.com/ssd.html) programı ile birlikte çalışarak .NET Framework'te Sınıf Devralma Güvenlik Açığı'nı (CVE-2011-1253) bildirdikleri için
...
-   V1.1 (19 Ekim 2011): Microsoft .NET Framework 1.1 Service Pack 1 için yeniden başlatmadan yükleme anahtarı bilgileri düzeltildi. Bu yalnızca bilgilendirme amaçlı bir değişikliktir. Güvenlik güncelleştirmesi dosyalarında veya algılama mantığında herhangi bir değişiklik yapılmamıştır.
