---
TOCTitle: 'MS11-059'
Title: 'Microsoft Güvenlik Bülteni MS11-059 - Önemli'
ms:assetid: 'ms11-059'
ms:contentKeyID: 61235700
ms:mtpsurl: 'https://technet.microsoft.com/tr-TR/library/ms11-059(v=Security.10)'
---

Security Bulletin

Microsoft Güvenlik Bülteni MS11-059 - Önemli
============================================

Data Access Components'taki Güvenlik Açığı Uzaktan Kod Yürütülmesine İzin Verebilir (2560656)
---------------------------------------------------------------------------------------------
...
Bu güvenlik güncelleştirmesi, Windows 7 ve Windows Server 2008 R2'nin tüm desteklenen sürümleri için Önemli olarak derecelendirilmiştir. Daha fazla bilgi için, bu bölümdeki **Etkilenen ve Etkilenmeyen Yazılımlar** alt bölümüne bakın.

Güvenlik güncelleştirmesi, Windows Veri Erişimi İzleme bileşeninin dış kitaplıkları yükleme biçimini düzelterek bu güvenlik açığını giderir. Bu güvenlik açığı hakkında daha fazla bilgi için, bir sonraki bölüm olan **Güvenlik Açığı Bilgileri** altında, ilgili güvenlik açığı girdisinin Sık Sorulan Sorular (SSS) alt bölümüne bakın.
...
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------|----------------------|---------------------------------------------|
| [32-bit sistemler için Windows 7 ve 32-bit sistemler için Windows 7 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=6bc168d9-6664-41fb-914f-dbd7514a4b0e)                                             | Uzaktan Kod Yürütme       | Önemli               | Yok                                         |
| [x64 tabanlı sistemler için Windows 7 ve x64 tabanlı sistemler için Windows 7 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=aafeff2d-db9a-4b3b-b620-be4ec5f5bdcc)                                   | Uzaktan Kod Yürütme       | Önemli               | Yok                                         |
| [x64 tabanlı sistemler için Windows Server 2008 R2 ve x64 tabanlı sistemler için Windows Server 2008 R2 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=c29deec3-4672-4658-a550-dce244434cd4)\*       | Uzaktan Kod Yürütme       | Önemli               | Yok                                         |
| [Itanium tabanlı sistemler için Windows Server 2008 R2 ve Itanium tabanlı sistemler için Windows Server 2008 R2 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=1d6b8036-d38f-408a-a36c-027553faefc1) | Uzaktan Kod Yürütme       | Önemli               | Yok                                         |
...
<th style="border:1px solid black;" >Data Access Components'ta Güvenli Olmayan Şekilde Kitaplık Yükleme Güvenlik Açığı - CVE-2011-1975</th>
...
Data Access Components'ta Güvenli Olmayan Şekilde Kitaplık Yükleme Güvenlik Açığı - CVE-2011-1975  
-------------------------------------------------------------------------------------------------
  
<span></span>
Windows Veri Erişimi İzleme bileşeninin DLL dosyalarını yükleme biçiminde bir uzaktan kod yürütme güvenlik açığı bulunmaktadır. Bu açığı başarıyla kullanan bir saldırgan, etkilenen sistemin tüm denetimini ele geçirebilir. Saldırgan, program yükleyebilir; verileri görüntüleyebilir, değiştirebilir veya silebilir; tüm kullanıcı haklarına sahip olan yeni hesaplar oluşturabilir. Hesapları, sistemde az sayıda kullanıcı hakkıyla yapılandırılmış olan kullanıcılar, yönetici haklarıyla çalışan kullanıcılardan daha az etkilenebilir.
  
Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2011-1975](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1975).
  
#### Data Access Components'ta Güvenli Olmayan Şekilde Kitaplık Yükleme Güvenlik Açığı - CVE-2011-1975 için Azaltıcı Etkenler
  
Azaltıcı etken, varolan bir durumda bulunan ve güvenlik açığından yararlanılmasının önem derecesini azaltabilecek bir ayar, genel yapılandırma ya da en iyi uygulama anlamına gelir. Sizin durumunuzda aşağıdaki azaltıcı etkenler işinize yarayabilir:
  
-   Saldırının başarılı olması için, kullanıcının güvenilir olmayan bir uzak dosya sistemi konumunu veya WebDAV paylaşımını ziyaret edip bir Excel dosyasını (örneğin bir .xlsx dosyasını) açması gerekir.  
...
#### Data Access Components'ta Güvenli Olmayan Şekilde Kitaplık Yükleme Güvenlik Açığı - CVE-2011-1975 için Geçici Çözümler
...
#### Data Access Components'ta Güvenli Olmayan Şekilde Kitaplık Yükleme Güvenlik Açığı - CVE-2011-1975 Hakkında SSS
...
Güvenlik açığı, Windows Veri Erişimi İzleme bileşeninin dış kitaplıkları yüklemek için kullanılan yolu hatalı şekilde kısıtlaması nedeniyle ortaya çıkar.
  
**Windows Data Access Components (Windows DAC) nedir?**    
Windows Data Access Components (Windows DAC) 6.0, bilgilere kuruluş genelinde erişim sağlamak üzere Windows Vista, Windows 7, Windows Server 2008 ve Windows Server 2008 R2'de bulunan bir dizi teknolojidir. Bu teknolojiler arasında Microsoft ActiveX Data Objects (ADO), OLE DB ve Microsoft Open Database Connectivity (ODBC) bulunmaktadır. Web üzerinden veya bir LAN üzerinden dağıtılan veri yönelimli istemci/sunucu uygulamaları bu bileşenleri kullanarak, hem ilişkili (SQL) hem de ilişkili olmayan çeşitli kaynaklarda yer alan bilgileri kolayca tümleştirebilir. Daha fazla bilgi için, [Windows Data Access Components SDK](http://msdn.microsoft.com/en-us/library/aa968814(v=vs.85).aspx) adlı MSDN makalesine bakın.
...
Saldırgan bir kullanıcıyı özel hazırlanmış bir dinamik bağlantı kitaplığı (DLL) dosyasıyla aynı ağ dizininde bulunan meşru bir Excel dosyasını (örneğin bir .xlsx dosyasını) açmaya ikna edebilir. Daha sonra, meşru dosyanın açıldığı sırada Microsoft Office bu DLL dosyasını yüklemeyi ve içerdiği kodu yürütmeyi deneyebilir.
  
E-posta tabanlı saldırı senaryosunda, saldırgan bir kullanıcıya meşru bir Excel dosyası eki (örneğin bir .xlsx dosyası) gönderip kullanıcıyı bu eki özel hazırlanmış bir DLL dosyası içeren bir dizine yerleştirmeye ve meşru dosyayı açmaya ikna ederek bu güvenlik açığından yararlanabilir. Daha sonra, meşru dosyanın açıldığı sırada Microsoft Office bu DLL dosyasını yüklemeyi ve içerdiği kodu yürütmeyi deneyebilir.
...
Bilinen saldırı vektörlerinde Microsoft Excel gibi Microsoft Office yazılımları kullanılabilir, ancak güvenlik açığından etkilenen kod Microsoft Windows'un bir paylaşılan bileşeninde bulunmaktadır.
...
Güncelleştirme, Windows Veri Erişimi İzleme bileşeninin dış kitaplıkları yükleme biçimini düzelterek bu güvenlik açığını giderir.
...
<td style="border:1px solid black;">Bkz: <a href="http://support.microsoft.com/kb/2560656">Microsoft Bilgi Bankası makalesi 2560656</a></td>
</tr>
<tr class="odd">
...
-   V1.1 (10 Ağustos 2011): Tüm etkilenen işletim sistemleri üzerinde bu güncelleştirme için yeniden başlatma gereksinimleri düzeltildi.
