---
TOCTitle: 'MS11-017'
Title: 'Microsoft Güvenlik Bülteni MS11-017 - Önemli'
ms:assetid: 'ms11-017'
ms:contentKeyID: 61235658
ms:mtpsurl: 'https://technet.microsoft.com/tr-TR/library/ms11-017(v=Security.10)'
---

Security Bulletin

Microsoft Güvenlik Bülteni MS11-017 - Önemli
============================================

Uzak Masaüstü İstemcisi'ndeki Güvenlik Açığı Uzaktan Kod Yürütülmesine İzin Verebilir (2508062)
-----------------------------------------------------------------------------------------------

Yayım Tarihi: 8 Mart 2011 Salı | Güncelleştirme Tarihi: 4 Mayıs 2011 Çarşamba
...
Bu güvenlik güncelleştirmesi Uzak Masaüstü Bağlantısı 5.2 İstemcisi, Uzak Masaüstü Bağlantısı 6.0 İstemcisi, Uzak Masaüstü Bağlantısı 6.1 İstemcisi ve Uzak Masaüstü Bağlantısı 7.0 İstemcisi için Önemli olarak derecelendirilmiştir. Daha fazla bilgi için, bu bölümdeki **Etkilenen ve Etkilenmeyen Yazılımlar** alt bölümüne bakın.

Güvenlik güncelleştirmesi, Windows Uzak Masaüstü İstemcisi'nin dış kitaplıkları yükleme biçimini düzelterek bu güvenlik açığını giderir. Bu güvenlik açığı hakkında daha fazla bilgi için, bir sonraki bölüm olan **Güvenlik Açığı Bilgileri** altında, ilgili güvenlik açığı girdisinin Sık Sorulan Sorular (SSS) alt bölümüne bakın.
...
**Bilinen Sorunlar.** [Microsoft Bilgi Bankası makalesi 2508062](http://support.microsoft.com/kb/2508062), bu güvenlik güncelleştirmesini yükleyen müşterilerin karşılaşabileceği bilinen sorunları belgelemektedir. Bu makale ayrıca, bu sorunlar için önerilen çözümleri de içermektedir.
...
<tr>
<th colspan="5">
Uzak Masaüstü Bağlantısı 5.2 İstemcisi
</th>
</tr>
<tr>
...
<tr>
<th colspan="5">
Uzak Masaüstü Bağlantısı 6.0 İstemcisi ve Uzak Masaüstü Bağlantısı 6.1 İstemcisi
</th>
</tr>
...
<tr>
<th colspan="5">
Uzak Masaüstü Bağlantısı 7.0 İstemcisi
</th>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
|----------------------------------------------------------------------|----------------------------------------|
| Windows XP Professional x64 Edition Service Pack 2                   | Uzak Masaüstü Bağlantısı 5.2 İstemcisi |
| Windows Server 2003 Service Pack 2                                   | Uzak Masaüstü Bağlantısı 5.2 İstemcisi |
| Windows Server 2003 x64 Edition Service Pack 2                       | Uzak Masaüstü Bağlantısı 5.2 İstemcisi |
| Itanium Tabanlı Sistemler için Windows Server 2003 SP2               | Uzak Masaüstü Bağlantısı 5.2 İstemcisi |
| 32-bit sistemler için Windows 7 Service Pack 1                       | Uzak Masaüstü Bağlantısı 7.1 İstemcisi |
| x64 tabanlı sistemler için Windows 7 Service Pack 1                  | Uzak Masaüstü Bağlantısı 7.1 İstemcisi |
| x64 tabanlı sistemler için Windows Server 2008 R2 Service Pack 1     | Uzak Masaüstü Bağlantısı 7.1 İstemcisi |
| Itanium tabanlı sistemler için Windows Server 2008 R2 Service Pack 1 | Uzak Masaüstü Bağlantısı 7.1 İstemcisi |
...
<th style="border:1px solid black;" >
Uzak Masaüstü'nde Güvenli Olmayan Şekilde Kitaplık Yükleme Güvenlik Açığı - CVE-2011-0029
</th>
<th style="border:1px solid black;" >
Toplam Önem Derecesi
</th>
...
<tr>
<td style="border:1px solid black;">
Windows XP Service Pack 3 üzerinde Uzak Masaüstü Bağlantısı 5.2
</td>
<td style="border:1px solid black;">
**Önemli**   
Uzaktan Kod Yürütme
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows XP Service Pack 3 üzerinde Uzak Masaüstü Bağlantısı 6.1
</td>
<td style="border:1px solid black;">
**Önemli**   
Uzaktan Kod Yürütme
...
<tr>
<td style="border:1px solid black;">
Windows XP Professional x64 Edition Service Pack 2 üzerinde Uzak Masaüstü Bağlantısı 6.0
</td>
<td style="border:1px solid black;">
**Önemli**   
Uzaktan Kod Yürütme
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Server 2003 Service Pack 2 üzerinde Uzak Masaüstü Bağlantısı 6.0
</td>
<td style="border:1px solid black;">
**Önemli**   
Uzaktan Kod Yürütme
...
<tr>
<td style="border:1px solid black;">
Windows Server 2003 Service Pack 2 üzerinde Uzak Masaüstü Bağlantısı 6.0 İstemcisi Çok Dilde Kullanıcı Arabirimi (MUI)
</td>
<td style="border:1px solid black;">
**Önemli**   
Uzaktan Kod Yürütme
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Server 2003 x64 Edition Service Pack 2 üzerinde Uzak Masaüstü Bağlantısı 6.0
</td>
<td style="border:1px solid black;">
**Önemli**   
Uzaktan Kod Yürütme
...
<tr>
<td style="border:1px solid black;">
Windows Vista Service Pack 1 ve Windows Vista Service Pack 2 üzerinde Uzak Masaüstü Bağlantısı 6.1
</td>
<td style="border:1px solid black;">
**Önemli**   
Uzaktan Kod Yürütme
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Vista x64 Edition Service Pack 1 ve Windows Vista x64 Edition Service Pack 2 üzerinde Uzak Masaüstü Bağlantısı 6.1
</td>
<td style="border:1px solid black;">
**Önemli**   
Uzaktan Kod Yürütme
...
<tr>
<td style="border:1px solid black;">
32-bit sistemler için Windows Server 2008 ve 32-bit sistemler için Windows Server 2008 Service Pack 2 üzerinde Uzak Masaüstü Bağlantısı 6.1\*\*
</td>
<td style="border:1px solid black;">
**Önemli**   
Uzaktan Kod Yürütme
...
<tr class="alternateRow">
<td style="border:1px solid black;">
x64 tabanlı sistemler için Windows Server 2008 ve x64 tabanlı sistemler için Windows Server 2008 Service Pack 2 üzerinde Uzak Masaüstü Bağlantısı 6.1\*\*
</td>
<td style="border:1px solid black;">
**Önemli**   
Uzaktan Kod Yürütme
...
<tr>
<td style="border:1px solid black;">
Itanium tabanlı sistemler için Windows Server 2008 ve Itanium tabanlı sistemler için Windows Server 2008 Service Pack 2 üzerinde Uzak Masaüstü Bağlantısı 6.1
</td>
<td style="border:1px solid black;">
**Önemli**   
Uzaktan Kod Yürütme
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows XP Service Pack 3 üzerinde Uzak Masaüstü Bağlantısı 7.0
</td>
<td style="border:1px solid black;">
**Önemli**   
Uzaktan Kod Yürütme
...
<tr>
<td style="border:1px solid black;">
Windows Vista Service Pack 1 ve Windows Vista Service Pack 2 üzerinde Uzak Masaüstü Bağlantısı 7.0
</td>
<td style="border:1px solid black;">
**Önemli**   
Uzaktan Kod Yürütme
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Vista x64 Edition Service Pack 1 ve Windows Vista x64 Edition Service Pack 2 üzerinde Uzak Masaüstü Bağlantısı 7.0
</td>
<td style="border:1px solid black;">
**Önemli**   
Uzaktan Kod Yürütme
...
<tr>
<td style="border:1px solid black;">
32-bit sistemler için Windows 7 üzerinde Uzak Masaüstü Bağlantısı 7.0
</td>
<td style="border:1px solid black;">
**Önemli**   
Uzaktan Kod Yürütme
...
<tr class="alternateRow">
<td style="border:1px solid black;">
x64 tabanlı sistemler için Windows 7 üzerinde Uzak Masaüstü Bağlantısı 7.0
</td>
<td style="border:1px solid black;">
**Önemli**   
Uzaktan Kod Yürütme
...
<tr>
<td style="border:1px solid black;">
x64 tabanlı sistemler için Windows Server 2008 R2 üzerinde Uzak Masaüstü Bağlantısı 7.0\*\*
</td>
<td style="border:1px solid black;">
**Önemli**   
Uzaktan Kod Yürütme
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Itanium tabanlı sistemler için Windows Server 2008 R2 üzerinde Uzak Masaüstü Bağlantısı 7.0
</td>
<td style="border:1px solid black;">
**Önemli**   
Uzaktan Kod Yürütme
...
<span></span>
Windows Uzak Masaüstü İstemcisi'nin DLL dosyalarını yükleme biçiminde bir uzaktan kod yürütme güvenlik açığı bulunmaktadır. Bu açığı başarıyla kullanan bir saldırgan, etkilenen sistemin tüm denetimini ele geçirebilir. Saldırgan, program yükleyebilir; verileri görüntüleyebilir, değiştirebilir veya silebilir; tüm kullanıcı haklarına sahip olan yeni hesaplar oluşturabilir. Hesapları, sistemde az sayıda kullanıcı hakkıyla yapılandırılmış olan kullanıcılar, yönetici haklarıyla çalışan kullanıcılardan daha az etkilenebilir.

Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2011-0029](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0029).

#### Uzak Masaüstü'nde Güvenli Olmayan Şekilde Kitaplık Yükleme Güvenlik Açığı - CVE-2011-0029 için Azaltıcı Etkenler

Azaltıcı etken, varolan bir durumda bulunan ve güvenlik açığından yararlanılmasının önem derecesini azaltabilecek bir ayar, genel yapılandırma ya da en iyi uygulama anlamına gelir. Sizin durumunuzda aşağıdaki azaltıcı etkenler işinize yarayabilir:

-   Saldırının başarılı olması için, kullanıcının güvenilir olmayan bir uzak dosya sistemi konumunu veya WebDAV paylaşımını ziyaret edip bir .rdp dosyasını açması gerekir.
...
#### Uzak Masaüstü'nde Güvenli Olmayan Şekilde Kitaplık Yükleme Güvenlik Açığı - CVE-2011-0029 için Geçici Çözümler
...
#### Uzak Masaüstü'nde Güvenli Olmayan Şekilde Kitaplık Yükleme Güvenlik Açığı - CVE-2011-0029 Hakkında SSS
...
Güvenlik açığı, Windows Uzak Masaüstü İstemcisi'nin dış kitaplıkları yüklemek için kullanılan yolu hatalı şekilde kısıtlaması nedeniyle ortaya çıkar.

**Windows Uzak Masaüstü İstemcisi nedir?**  
Windows'daki Uzak Masaüstü özelliği, kullanıcının bilgisayarındaki tüm programlara, kaynaklara ve donatılara başka bir Windows tabanlı bilgisayardan erişilebilmesini sağlar. Bağlantı oluşturulduktan sonra, Uzak Masaüstü ilk bilgisayarda fare ve klavye denetimi sağlar ve gerçekleştirilen tüm işlemleri ekranda görüntüler.
...
Saldırgan bir kullanıcıyı özel hazırlanmış bir dinamik bağlantı kitaplığı (DLL) dosyasıyla aynı ağ dizininde bulunan meşru bir Uzak Masaüstü yapılandırma dosyasını (.rdp) açmaya ikna edebilir. Daha sonra, .rdp dosyasının açıldığı sırada Windows Uzak Masaüstü İstemcisi bu DLL dosyasını yüklemeyi ve içerdiği kodu yürütmeyi deneyebilir.

E-posta tabanlı saldırı senaryosunda, saldırgan bir kullanıcıya meşru bir .rdp eki gönderip kullanıcıyı bu eki özel hazırlanmış bir DLL dosyası içeren bir dizine yerleştirmeye ve .rdp dosyasını açmaya ikna ederek bu güvenlik açığından yararlanabilir. Daha sonra, .rdp dosyasının açıldığı sırada Windows Uzak Masaüstü İstemcisi bu DLL dosyasını yüklemeyi ve içerdiği kodu yürütmeyi deneyebilir.

Ağ senaryosunda, saldırgan bir UNC veya WebDAV konumuna meşru bir .rdp dosyasıyla birlikte özel hazırlanmış bir DLL dosyası yerleştirebilir ve kullanıcıyı bu .rdp dosyasını açmaya ikna edebilir.
...
Güncelleştirme, Windows Uzak Masaüstü İstemcisi'nin dış kitaplıkları yükleme biçimini düzelterek bu güvenlik açığını giderir.

**Bu güvenlik açığı Microsoft Güvenlik Danışma Belgesi 2269637 ile ilişkili mi?**  
Evet; bu güncelleştirme tarafından giderilen güvenlik açığı, [Microsoft Güvenlik Danışma Belgesi 2269637](http://technet.microsoft.com/security/advisory/2269637)'de açıklanan ve uygulamaların dış kitaplıkları yükleme şeklini etkileyen güvenlik açıkları sınıfıyla ilişkilidir. Bu güvenlik güncelleştirmesi, bu güvenlik açığı türünün belirli bir örneğine yöneliktir.

**Bu güvenlik bülteni yayımlandığında bu güvenlik açığı genel olarak duyurulmuş muydu?**  
Evet. Bu güvenlik açığı genel olarak duyurulmuştur. Ortak Güvenlik Açığı ve Etkilenme (Common Vulnerability and Exposure) numarası olarak [CVE-2011-0029](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0029) atanmıştır.
...
| 32-bit sistemler için Windows 7 Service Pack 1                                                                          | Hayır   | Hayır                      | Evet                       | Evet                       |
...
<td style="border:1px solid black;">Windows XP Service Pack 3 üzerinde Uzak Masaüstü Bağlantısı 5.2:<br />
WindowsXP-KB2483618-x86-trk.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Service Pack 3 üzerinde Uzak Masaüstü Bağlantısı 6.1:<br />
WindowsXP-KB2481109-x86-trk.exe /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Service Pack 3 üzerinde Uzak Masaüstü Bağlantısı 7.0:<br />
WindowsXP-KB2483614-x86-trk.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition Service Pack 2 üzerinde Uzak Masaüstü Bağlantısı 6.0:<br />
WindowsServer2003.WindowsXP-KB2481109-x64-trk.exe /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">Windows XP Service Pack 3 üzerinde Uzak Masaüstü Bağlantısı 5.2:<br />
WindowsXP-KB2483618-x86-trk.exe /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Service Pack 3 üzerinde Uzak Masaüstü Bağlantısı 6.1:<br />
WindowsXP-KB2481109-x86-trk.exe /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Service Pack 3 üzerinde Uzak Masaüstü Bağlantısı 7.0:<br />
WindowsXP-KB2483614-x86-trk.exe /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition Service Pack 2 üzerinde Uzak Masaüstü Bağlantısı 6.0:<br />
WindowsServer2003.WindowsXP-KB2481109-x64-trk.exe /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Güncelleştirme günlük dosyası</td>
<td style="border:1px solid black;">Uzak Masaüstü Bağlantısı 5.2:<br />
KB2483618.log</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Uzak Masaüstü Bağlantısı 6.0 ve Uzak Masaüstü Bağlantısı 6.1:<br />
KB2481109.log</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Uzak Masaüstü Bağlantısı 7.0:<br />
KB2483614.log</td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;">Uzak Masaüstü Bağlantısı 5.2:<br />
Denetim Masası'ndaki <strong>Program Ekle veya Kaldır</strong> aracını veya %Windir%\$NTUninstallKB2483618$\Spuninst klasöründe bulunan Spuninst.exe yardımcı programını kullanın</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Uzak Masaüstü Bağlantısı 6.0 ve Uzak Masaüstü Bağlantısı 6.1:<br />
Denetim Masası'ndaki <strong>Program Ekle veya Kaldır</strong> aracını veya %Windir%\$NTUninstallKB2481109$\Spuninst klasöründe bulunan Spuninst.exe yardımcı programını kullanın</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Uzak Masaüstü Bağlantısı 7.0:<br />
Denetim Masası'ndaki <strong>Program Ekle veya Kaldır</strong> aracını veya %Windir%\$NTUninstallKB2483614$\Spuninst klasöründe bulunan Spuninst.exe yardımcı programını kullanın</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Dosya Bilgileri</strong></td>
<td style="border:1px solid black;">Uzak Masaüstü Bağlantısı 5.2:<br />
Bkz: <a href="http://support.microsoft.com/kb/2483618">Microsoft Bilgi Bankası makalesi 2483618</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Uzak Masaüstü Bağlantısı 6.0 ve Uzak Masaüstü Bağlantısı 6.1:<br />
Bkz: <a href="http://support.microsoft.com/kb/2481109">Microsoft Bilgi Bankası makalesi 2481109</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Uzak Masaüstü Bağlantısı 7.0:<br />
Bkz: <a href="http://support.microsoft.com/kb/2483614">Microsoft Bilgi Bankası makalesi 2483614</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;">Kullanıcı araya girmeden yükleme</td>
<td style="border:1px solid black;">Windows Server 2003 Service Pack 2 üzerinde Uzak Masaüstü Bağlantısı 6.0:<br />
WindowsServer2003-KB2481109-x86-trk.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003 Service Pack 2 üzerinde Uzak Masaüstü Bağlantısı 6.0 İstemcisi Çok Dilde Kullanıcı Arabirimi (MUI):<br />
WindowsServer2003-KB2483619-x86-trk.exe /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003 x64 Edition Service Pack 2 üzerinde Uzak Masaüstü Bağlantısı 6.0:<br />
WindowsServer2003.WindowsXP-KB2481109-x64-trk.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">Windows Server 2003 Service Pack 2 üzerinde Uzak Masaüstü Bağlantısı 6.0:<br />
WindowsServer2003-KB2481109-x86-trk.exe /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003 Service Pack 2 üzerinde Uzak Masaüstü Bağlantısı 6.0 İstemcisi Çok Dilde Kullanıcı Arabirimi (MUI):<br />
WindowsServer2003-KB2483619-x86-trk.exe /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003 x64 Edition Service Pack 2 üzerinde Uzak Masaüstü Bağlantısı 6.0:<br />
...
<tr class="odd">
<td style="border:1px solid black;">Güncelleştirme günlük dosyası</td>
<td style="border:1px solid black;">Uzak Masaüstü Bağlantısı 6.0:<br />
KB2481109.log</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Uzak Masaüstü Bağlantısı 6.0 İstemcisi Çok Dilde Kullanıcı Arabirimi (MUI):<br />
KB2483619.log</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Diğer bilgiler</td>
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Uzak Masaüstü Bağlantısı 6.0 İstemcisi Çok Dilde Kullanıcı Arabirimi (MUI):<br />
Denetim Masası'ndaki <strong>Program Ekle veya Kaldır</strong> aracını veya %Windir%\$NTUninstallKB2483619$\Spuninst klasöründe bulunan Spuninst.exe yardımcı programını kullanın</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Dosya Bilgileri</strong></td>
<td style="border:1px solid black;">Uzak Masaüstü Bağlantısı 6.0:<br />
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Uzak Masaüstü Bağlantısı 6.0 İstemcisi Çok Dilde Kullanıcı Arabirimi (MUI):<br />
Bkz: <a href="http://support.microsoft.com/kb/2483619">Microsoft Bilgi Bankası makalesi 2483619</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Kayıt Defteri Anahtarı Doğrulaması</strong></td>
<td style="border:1px solid black;">Uzak Masaüstü Bağlantısı 6.0:<br />
...
<tr class="odd">
<td style="border:1px solid black;">Kullanıcı araya girmeden yükleme</td>
<td style="border:1px solid black;">Windows Vista Service Pack 1 ve Windows Vista Service Pack 2 üzerinde Uzak Masaüstü Bağlantısı 6.1:<br />
Windows6.0-KB2481109-x86.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Vista Service Pack 1 ve Windows Vista Service Pack 2 üzerinde Uzak Masaüstü Bağlantısı 7.0:<br />
Windows6.0-KB2483614-x86.msu /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Vista x64 Edition Service Pack 1 ve Windows Vista x64 Edition Service Pack 2 üzerinde Uzak Masaüstü Bağlantısı 6.1:<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>Dosya Bilgileri</strong></td>
<td style="border:1px solid black;">Uzak Masaüstü Bağlantısı 6.1:<br />
Bkz: <a href="http://support.microsoft.com/kb/2481109">Microsoft Bilgi Bankası makalesi 2481109</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
...
<tr class="odd">
<td style="border:1px solid black;">Kullanıcı araya girmeden yükleme</td>
<td style="border:1px solid black;">Windows Server 2008'in tüm desteklenen 32-bit sürümleri üzerinde Uzak Masaüstü Bağlantısı 6.1:<br />
Windows6.0-KB2481109-x86.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2008'in tüm desteklenen x64 tabanlı sürümleri üzerinde Uzak Masaüstü Bağlantısı 6.1:<br />
Windows6.0-KB2481109-x64.msu /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2008'in tüm desteklenen Itanium tabanlı sürümleri üzerinde Uzak Masaüstü Bağlantısı 6.1:<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>Dosya Bilgileri</strong></td>
<td style="border:1px solid black;">Bkz: <a href="http://support.microsoft.com/kb/2481109">Microsoft Bilgi Bankası makalesi 2481109</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Kayıt Defteri Anahtarı Doğrulaması</strong></td>
<td style="border:1px solid black;"><strong>Not</strong> Bu güncelleştirmenin varlığını doğrulayan bir kayıt defteri anahtarı yoktur.</td>
...
<tr class="odd">
<td style="border:1px solid black;">Kullanıcı araya girmeden yükleme</td>
<td style="border:1px solid black;">Windows 7'nin özgün olarak yayımlanmış tüm desteklenen 32-bit sürümleri üzerinde Uzak Masaüstü Bağlantısı 7.0:<br />
Windows6.1-KB2483614-x86.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows 7'nin özgün olarak yayımlanmış tüm desteklenen x64 tabanlı sürümleri üzerinde Uzak Masaüstü Bağlantısı 7.0:<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>Dosya Bilgileri</strong></td>
<td style="border:1px solid black;">Bkz: <a href="http://support.microsoft.com/kb/2483614">Microsoft Bilgi Bankası makalesi 2483614</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Kayıt Defteri Anahtarı Doğrulaması</strong></td>
<td style="border:1px solid black;"><strong>Not</strong> Bu güncelleştirmenin varlığını doğrulayan bir kayıt defteri anahtarı yoktur.</td>
...
<tr class="odd">
<td style="border:1px solid black;">Kullanıcı araya girmeden yükleme</td>
<td style="border:1px solid black;">Windows Server 2008 R2'nin özgün olarak yayımlanmış tüm desteklenen x64 tabanlı sürümleri üzerinde Uzak Masaüstü Bağlantısı 7.0:<br />
Windows6.1-KB2483614-x64.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2008 R2'nin özgün olarak yayımlanmış tüm desteklenen Itanium tabanlı sürümleri üzerinde Uzak Masaüstü Bağlantısı 7.0:<br />
...
-   [Versafe Anti Fraud](http://www.versafe-login.com/) için çalışan Eyal Gruner, Uzak Masaüstü'nde Güvenli Olmayan Şekilde Kitaplık Yükleme Güvenlik Açığı'nı (CVE-2011-0029) bildirdiği için
...
-   V1.1 (8 Mart 2011): Windows XP Service Pack 3 ve Windows Server 2003 Service Pack 2 için Systems Management Server tablosundaki SMS 2.0 ve SUIT ile SMS 2003 girdileri düzeltildi. Bunlar yalnızca bilgilendirme amaçlı değişikliklerdir. Güvenlik güncelleştirmesi dosyalarında veya algılama mantığında herhangi bir değişiklik yapılmamıştır.  
-   V1.2 (9 Mart 2011): Windows 7 ve Windows Server 2008 R2'nin Service Pack 1 sürümleri için **Etkilenmeyen Yazılımlar** bileşeni girdileri Uzak Masaüstü Bağlantısı 7.0 İstemcisi yerine Uzak Masaüstü Bağlantısı 7.1 İstemcisi olarak düzeltildi. Bunlar yalnızca bilgilendirme amaçlı değişikliklerdir. Güvenlik güncelleştirmesi dosyalarında veya algılama mantığında herhangi bir değişiklik yapılmamıştır.  
-   V1.3 (13 Nisan 2011): Windows Server 2003'ün desteklenen sürümleri üzerinde Uzak Masaüstü Bağlantısı 6.0 İstemcisi ve Windows Vista'nın desteklenen sürümleri üzerinde Uzak Masaüstü Bağlantısı 6.1 İstemcisi için bülten değişikliği bilgileri düzeltildi. Bu yalnızca bir bülten değişikliğidir. Algılama mantığında veya güvenlik güncelleştirmesi dosyalarında herhangi bir değişiklik yapılmamıştır.  
-   V1.4 (15 Nisan 2011): Windows Server 2003'ün desteklenen sürümleri üzerinde Uzak Masaüstü Bağlantısı 6.0 İstemcisi ve Windows Server 2008'in desteklenen sürümleri üzerinde Uzak Masaüstü Bağlantısı 6.1 İstemcisi için bülten değişikliği bilgileri düzeltildi. Bu, yalnızca bir bülten değişikliğidir. Algılama mantığında veya güvenlik güncelleştirmesi dosyalarında herhangi bir değişiklik yapılmamıştır.  
-   V1.5 (4 Mayıs 2011): Windows XP Service Pack 3'ün desteklenen sürümleri üzerinde Uzak Masaüstü Bağlantısı 5.2 İstemcisi için bülten değişikliği bilgileri düzeltildi. Bu, yalnızca bir bülten değişikliğidir. Algılama mantığında veya güvenlik güncelleştirmesi dosyalarında herhangi bir değişiklik yapılmamıştır.
