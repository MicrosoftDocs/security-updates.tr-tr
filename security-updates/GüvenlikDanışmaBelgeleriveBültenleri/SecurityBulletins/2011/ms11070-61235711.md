---
TOCTitle: 'MS11-070'
Title: 'Microsoft Güvenlik Bülteni MS11-070 - Önemli'
ms:assetid: 'ms11-070'
ms:contentKeyID: 61235711
ms:mtpsurl: 'https://technet.microsoft.com/tr-TR/library/ms11-070(v=Security.10)'
---

Security Bulletin

Microsoft Güvenlik Bülteni MS11-070 - Önemli
============================================

WINS'deki Güvenlik Açığı Ayrıcalık Yükselmesine İzin Verebilir (2571621)
------------------------------------------------------------------------
...
Bu güvenlik güncelleştirmesi Windows Internet Ad Hizmeti'nde (WINS) özel olarak bildirilen bir güvenlik açığını giderir. Güvenlik açığı, bir kullanıcı WINS hizmetinin çalıştırıldığı etkilenen bir sistemde özel hazırlanmış bir WINS çoğaltma paketi alırsa ayrıcalık yükselmesine izin verebilir. Saldırganın bu güvenlik açığından yararlanabilmesi için geçerli oturum açma kimlik bilgilerine sahip olması ve yerel olarak oturum açabilmesi gerekir.

Bu güvenlik güncelleştirmesi Windows Server 2003, Windows Server 2008 (Itanium dışında) ve Windows Server 2008 R2'nin (Itanium dışında) desteklenen sürümlerini çalıştıran ve WINS'nin yüklü olduğu sunucular için Önemli olarak derecelendirilmiştir. Daha fazla bilgi için, bu bölümdeki **Etkilenen ve Etkilenmeyen Yazılımlar** alt bölümüne bakın.

Güvenlik güncelleştirmesi, WINS'nin geri döngü adresindeki iç iletişimi işleme biçimini düzelterek bu güvenlik açığını giderir. Bu güvenlik açığı hakkında daha fazla bilgi için, bir sonraki bölüm olan **Güvenlik Açığı Bilgileri** altında, ilgili güvenlik açığı girdisinin Sık Sorulan Sorular (SSS) alt bölümüne bakın.
...
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------|----------------------|-----------------------------------------------------------|
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=1e6ac3b2-752e-49a0-84e5-5a8dfe955299)                                                                                      | Ayrıcalık Yükseltmesi     | Önemli               | [MS11-035](http://go.microsoft.com/fwlink/?linkid=214807) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=f9378339-c58e-4e84-9427-85aeb35b0d99)                                                                          | Ayrıcalık Yükseltmesi     | Önemli               | [MS11-035](http://go.microsoft.com/fwlink/?linkid=214807) |
| [Itanium Tabanlı Sistemler için Windows Server 2003 SP2](http://www.microsoft.com/downloads/details.aspx?familyid=c35c71a8-13b4-47a6-9763-06f6f65327b1)                                                                  | Ayrıcalık Yükseltmesi     | Önemli               | [MS11-035](http://go.microsoft.com/fwlink/?linkid=214807) |
| [32-bit sistemler için Windows Server 2008 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=a9039660-3cc2-470d-a0a5-a70f78074495)\*                                                              | Ayrıcalık Yükseltmesi     | Önemli               | [MS11-035](http://go.microsoft.com/fwlink/?linkid=214807) |
| [x64 tabanlı sistemler için Windows Server 2008 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=5ea78a9b-b1f7-4e94-b69e-c984e1622ae9)\*                                                         | Ayrıcalık Yükseltmesi     | Önemli               | [MS11-035](http://go.microsoft.com/fwlink/?linkid=214807) |
| [x64 tabanlı sistemler için Windows Server 2008 R2 ve x64 tabanlı sistemler için Windows Server 2008 R2 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=f58cf343-946c-4e74-bd9c-40ac934a4986)\* | Ayrıcalık Yükseltmesi     | Önemli               | [MS11-035](http://go.microsoft.com/fwlink/?linkid=214807) |
...
<th style="border:1px solid black;" >WINS'de Yerel Olarak Ayrıcalık Yükselmesi Güvenlik Açığı - CVE-2011-1984</th>
...
WINS'de Yerel Olarak Ayrıcalık Yükselmesi Güvenlik Açığı - CVE-2011-1984  
------------------------------------------------------------------------
  
<span></span>
WINS'de, yerel sistem bağlamında rasgele kod yürütülmesine olanak verebilecek bir ayrıcalık yükselmesi güvenlik açığı bulunmaktadır. Bu güvenlik açığı, WINS sunucusunun geri döngü arabiriminde alınan özel hazırlanmış paketlerin sırasını hatalı işlemesi nedeniyle ortaya çıkar. Bu güvenlik açığından yerel olarak başarıyla yararlanan bir saldırgan rasgele kod yürütebilir ve etkilenen sistemin tüm denetimini ele geçirebilir. Saldırgan, program yükleyebilir; verileri görüntüleyebilir, değiştirebilir veya silebilir; tüm kullanıcı haklarına sahip olan yeni hesaplar oluşturabilir.
  
Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2011-1984](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1984).
  
#### WINS'de Yerel Olarak Ayrıcalık Yükselmesi Güvenlik Açığı - CVE-2011-1984 için Azaltıcı Etkenler
...
#### WINS'de Yerel Olarak Ayrıcalık Yükselmesi Güvenlik Açığı - CVE-2011-1984 için Geçici Çözümler
  
Microsoft bu güvenlik açığı için herhangi bir geçici çözüm belirleyememiştir.
  
#### WINS'de Yerel Olarak Ayrıcalık Yükselmesi Güvenlik Açığı - CVE-2011-1984 Hakkında SSS
  
**Bu güvenlik açığının kapsamı nedir?**  
Bu bir yerel ayrıcalık yükselmesi güvenlik açığıdır.
  
**Güvenlik açığına ne neden olmaktadır?**  
Bu güvenlik açığı, WINS sunucusunun geri döngü arabiriminde alınan özel hazırlanmış paketlerin sırasını hatalı işlemesi nedeniyle ortaya çıkar.
...
Windows Server 2003'te bu güvenlik açığından başarıyla yararlanan bir saldırgan, yerel sistemin bağlamında rasgele kod yürütebilir. Windows Server 2008 veya Windows Server 2008 R2'de bu güvenlik açığından başarıyla yararlanan bir saldırgan, yerel hizmetin bağlamında rasgele kod yürütebilir. Saldırgan, program yükleyebilir; verileri görüntüleyebilir, değiştirebilir veya silebilir; tüm kullanıcı haklarına sahip olan yeni hesaplar oluşturabilir.
  
**Bir saldırgan güvenlik açığından nasıl yararlanabilir?**  
Saldırganın bu güvenlik açığından yararlanabilmesi için öncelikle sistemde oturum açması gerekir. Böylece saldırgan, geri döngü arabirimine özel hazırlanmış paketler göndererek bu güvenlik açığından yararlanan özel hazırlanmış bir uygulama çalıştırabilir ve etkilenen sistemin tüm denetimini ele geçirebilir.
...
Güncelleştirme, WINS'nin geri döngü adresindeki iç iletişimi işleme biçimini düzelterek bu güvenlik açığını giderir.
...
WindowsServer2003-KB2571621-x86-trk.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen x64 tabanlı sürümleri:<br />
WindowsServer2003.WindowsXP-KB2571621-x64-trk.exe /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen Itanium tabanlı sürümleri:<br />
WindowsServer2003-KB2571621-ia64-trk.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen 32-bit sürümleri:<br />
WindowsServer2003-KB2571621-x86-trk.exe /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen x64 tabanlı sürümleri:<br />
WindowsServer2003.WindowsXP-KB2571621-x64-trk.exe /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003'ün tüm desteklenen Itanium tabanlı sürümleri:<br />
WindowsServer2003-KB2571621-ia64-trk.exe /norestart</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">Denetim Masası'ndaki <strong>Program Ekle veya Kaldır</strong> aracını veya %Windir%\$NTUninstallKB2571621$\Spuninst klasöründe bulunan Spuninst.exe yardımcı programını kullanın</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Dosya Bilgileri</strong></td>
<td style="border:1px solid black;">Bkz: <a href="http://support.microsoft.com/kb/2571621">Microsoft Bilgi Bankası makalesi 2571621</a></td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">Windows Server 2008'in tüm desteklenen 32-bit sürümleri:<br />
Windows6.0-KB2571621-x86.msu /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2008'in tüm desteklenen x64 tabanlı sürümleri:<br />
Windows6.0-KB2571621-x64.msu /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Diğer bilgiler</td>
<td style="border:1px solid black;"><strong>Algılama ve Dağıtım Araçları ve Kılavuzu</strong> alt bölümüne bakın</td>
...
<td style="border:1px solid black;">Yeniden başlatmadan yükleme</td>
<td style="border:1px solid black;">Windows Server 2008 R2'nin tüm desteklenen x64 tabanlı sürümleri:<br />
Windows6.1-KB2571621-x64.msu /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Diğer bilgiler</td>
<td style="border:1px solid black;"><strong>Algılama ve Dağıtım Araçları ve Kılavuzu</strong> alt bölümüne bakın</td>
...
-   [Core Security Technologies](http://www.coresecurity.com/) için çalışan Nicolas Economou, WINS'de Yerel Olarak Ayrıcalık Yükselmesi Güvenlik Açığı'nı (CVE-2011-1984) bildirdiği için
