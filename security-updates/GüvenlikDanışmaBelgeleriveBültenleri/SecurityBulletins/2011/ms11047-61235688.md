---
TOCTitle: 'MS11-047'
Title: 'Microsoft Güvenlik Bülteni MS11-047 - Önemli'
ms:assetid: 'ms11-047'
ms:contentKeyID: 61235688
ms:mtpsurl: 'https://technet.microsoft.com/tr-TR/library/ms11-047(v=Security.10)'
---

Security Bulletin

Microsoft Güvenlik Bülteni MS11-047 - Önemli
============================================
...
Güvenlik güncelleştirmesi, Hyper-V Server'ın sanal makinelerden gönderilen hatalı biçimlendirilmiş istekleri işleme biçimini düzelterek bu güvenlik açığını giderir. Bu güvenlik açığı hakkında daha fazla bilgi için, bir sonraki bölüm olan **Güvenlik Açığı Bilgileri** altında, ilgili güvenlik açığı girdisinin Sık Sorulan Sorular (SSS) alt bölümüne bakın.
...
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------|----------------------|-----------------------------------------------------------|
| [x64 tabanlı sistemler için Windows Server 2008 ve x64 tabanlı sistemler için Windows Server 2008 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=24789423-72b7-48d1-bdc1-f0e5174d99bb)\* | Hizmet Reddi              | Önemli               | [MS10-102](http://go.microsoft.com/fwlink/?linkid=205309) |
| [x64 tabanlı sistemler için Windows Server 2008 R2](http://www.microsoft.com/downloads/details.aspx?familyid=c9c6c36d-a455-42f7-b7d4-9fb9824c07cb)\*                                                               | Hizmet Reddi              | Önemli               | [MS10-102](http://go.microsoft.com/fwlink/?linkid=205309) |
| [x64 tabanlı sistemler için Windows Server 2008 R2 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=c9c6c36d-a455-42f7-b7d4-9fb9824c07cb)\*                                                | Hizmet Reddi              | Önemli               | Yok                                                       |
...
<th style="border:1px solid black;" >VMBus Kalıcı DoS Güvenlik Açığı - CVE-2011-1872</th>
...
VMBus Kalıcı DoS Güvenlik Açığı - CVE-2011-1872  
-----------------------------------------------
  
<span></span>
Windows Server 2008 ve Windows Server 2008 R2 üzerindeki Hyper-V'de bir hizmet reddi güvenlik açığı bulunmaktadır. Güvenlik açığı, makine yönergelerinin belirli sıralarının Hyper-V sunucuları tarafından yeterli düzeyde doğrulanmaması nedeniyle ortaya çıkar. Bu güvenlik açığından yararlanan bir saldırgan, etkilenen Hyper-V sisteminin yanıt vermemeye başlamasına neden olabilir. Bu durum, ilgili sistem tarafından barındırılan tüm sanal makineleri etkiler.
  
Bu güvenlik açığını Ortak Güvenlik Açıkları ve Etkilenmeler listesinde standart girdi olarak görüntülemek için, bkz: [CVE-2011-1872](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1872).
  
#### VMBus Kalıcı DoS Güvenlik Açığı - CVE-2011-1872 için Azaltıcı Etkenler
...
#### VMBus Kalıcı DoS Güvenlik Açığı - CVE-2011-1872 için Geçici Çözümler
  
Microsoft bu güvenlik açığı için herhangi bir geçici çözüm belirleyememiştir.
  
#### VMBus Kalıcı DoS Güvenlik Açığı - CVE-2011-1872 Hakkında SSS
  
**Bu güvenlik açığının kapsamı nedir?**    
Bu bir hizmet reddi güvenlik açığıdır. Bu güvenlik açığından yararlanan bir saldırgan, etkilenen Hyper-V sunucusunun yanıt vermemeye başlamasına ve yeniden başlatma gerektirmesine neden olabilir. Hizmet reddi güvenlik açığının, bir saldırganın Hyper-V sunucusunda kod yürütmesine veya kullanıcı haklarını yükseltmesine izin vermeyeceğini, ancak etkilenen sistemin istekleri kabul etmeyi durdurmasına neden olabileceğini unutmayın.
  
**Güvenlik açığına ne neden olmaktadır?**    
Güvenlik açığı, konuk makineden ana makineye gönderilen belirli paketlerin yeterli düzeyde doğrulanmaması nedeniyle ortaya çıkar. Yetersiz doğrulama nedeniyle, bu yönergelerin işlenmesi Hyper-V sunucu uygulamasının aşırı kaynak tüketimine yol açar.
  
**Hyper-V nedir?**    
Hyper-V, Windows Server 2008 ve Windows Server 2008 R2'nin önemli bir özelliği olan hiper yönetici tabanlı bir teknolojidir. Ölçeklenebilir, güvenilir ve oldukça yüksek kullanılabilirliğe sahip bir sanallaştırma platformu sunar. Bu ortam türü, sanal makineler oluşturup bunları yönetmenize, tek bir fiziksel bilgisayarda birden çok işletim sistemi çalıştırmanıza ve bu işletim sistemlerini birbirinden ayırmanıza olanak verdiği için kullanışlıdır.
  
**Bir saldırgan bu güvenlik açığından yararlanarak neler yapabilir?**    
Bu güvenlik açığından başarıyla yararlanan bir saldırgan, bir kullanıcı sisteminin yanıt vermemeye başlamasına ve yeniden başlatılması gerekmesine neden olabilir. Bu güvenlik açığının Hyper-V sunucusunda barındırılan tüm konuk sanal makineler de dahil olmak üzere sunucunun tüm kaynaklarının tüketilmesine yol açabileceğini unutmayın.
  
**Bir saldırgan güvenlik açığından nasıl yararlanabilir?**    
Saldırganın Hyper-V sunucusunda barındırılan konuk sanal makinelerden birinde kimliği doğrulanmış bir yönetici olması gerekir. Saldırganın sistemde güvenilir olmayan bir yürütülebilir dosya çalıştırarak rasgele kod yürütebilmesi gerekir. Bu yürütülebilir dosya, makine yönergelerini hatalı biçimlendirilmiş bir sırayla çağırarak kaynak tüketimine yol açabilir ve Hyper-V sunucusunda sonsuz bir döngü oluşturarak diğer sanal makinelerden gönderilen isteklerin işlenmesini engeller.
  
**Bir saldırganın bu Hizmet Reddi Saldırısı'nı gerçekleştirebilmesi için hangi izinler gerekmektedir?**    
Saldırganın Hyper-V sunucusunda ve bu sunucuda çalıştırılan tüm sanal makinelerde bu hizmet reddi saldırısını gerçekleştirebilmesi için, Hyper-V sunucusunda barındırılan sanal makinelerden birinde yönetici ayrıcalıkları olmalıdır. Saldırganın, Hyper-V sunucusunda Administrator erişimi olması gerekmemektedir.
...
Bu güncelleştirme, Hyper-V Server'ın sanal makinelerden gönderilen hatalı biçimlendirilmiş istekleri işleme biçimini düzeltir. Bu düzeltme, Hyper-V sunucusu uygulamasının konuk makineden ana makineye gönderilen VMBus paketlerini düzgün şekilde doğrulamasına olanak verir.
...
<td style="border:1px solid black;">Windows Server 2008'in tüm desteklenen x64 tabanlı sürümleri üzerine yüklendiğinde Hyper-V Server:<br />
...
<td style="border:1px solid black;">Bkz: <a href="http://support.microsoft.com/kb/2525835">Microsoft Bilgi Bankası makalesi 2525835</a></td>
</tr>
<tr class="odd">
...
<tr class="odd">
<td style="border:1px solid black;">Kullanıcı araya girmeden yükleme</td>
<td style="border:1px solid black;">Windows Server 2008 R2'nin tüm desteklenen x64 tabanlı sürümleri üzerine yüklendiğinde Hyper-V Server:<br />
...
-   [Core Security Technologies](http://www.coresecurity.com/) için çalışan Nicolas Economou, VMBus Kalıcı DoS Güvenlik Açığı'nı (CVE-2011-1872) bildirdiği için
