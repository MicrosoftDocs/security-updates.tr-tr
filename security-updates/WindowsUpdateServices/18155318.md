...
ms:contentKeyID: 18155318
ms:mtpsurl: 'https://technet.microsoft.com/tr-tr/library/Cc708536(v=WS.10)'
---
...
| ![](/security-updates/images/Cc708536.Important(WS.10).gif)Önemli                            |
|---------------------------------------------------------------------------------------------------------|
