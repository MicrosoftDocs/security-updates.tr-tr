...
ms:contentKeyID: 18155203
ms:mtpsurl: 'https://technet.microsoft.com/tr-tr/library/Cc708483(v=WS.10)'
---

Determine WSUS Capacity Requirements
====================================

Uygulama Alanı: Windows Server 2003, Windows Server 2003 R2, Windows Server 2003 with SP1, Windows Server 2003 with SP2, Windows Server 2008, Windows Server Update Services
