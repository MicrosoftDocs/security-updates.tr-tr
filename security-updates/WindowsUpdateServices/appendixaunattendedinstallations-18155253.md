...
ms:contentKeyID: 18155253
ms:mtpsurl: 'https://technet.microsoft.com/tr-tr/library/Cc708476(v=WS.10)'
---
...
<td style="border:1px solid black;">Uninstall the product. Also uninstalls the Windows İç Veritabanı instance if it is installed.</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">Path to Windows İç Veritabanı data directory.</td>
</tr>
<tr class="even">
