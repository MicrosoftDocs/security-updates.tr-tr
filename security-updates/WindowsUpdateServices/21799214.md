...
ms:contentKeyID: 21799214
ms:mtpsurl: 'https://technet.microsoft.com/tr-tr/library/Dd939824(v=WS.10)'
---
...
-   **MSSQLSERVER** (if you are using Windows İç Veritabanı, or if you are using SQL Server and are using the default instance name for the instance name).
