...
ms:contentKeyID: 18155202
ms:mtpsurl: 'https://technet.microsoft.com/tr-tr/library/Cc708482(v=WS.10)'
---
...
-   For step-by-step guidance for getting started, including installing WSUS, setting up a client computer, and deploying your first set of updates, see [Microsoft Windows Server Update Services 3.0'a Adım Adım Başlangıç Kılavuzu](https://technet.microsoft.com/a68a19d2-630e-45d6-b596-d24dac987b64)(http://go.microsoft.com/fwlink/?LinkID=41774).
