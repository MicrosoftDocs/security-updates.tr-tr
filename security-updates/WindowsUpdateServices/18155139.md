...
ms:contentKeyID: 18155139
ms:mtpsurl: 'https://technet.microsoft.com/tr-tr/library/Cc720542(v=WS.10)'
---
...
| ![](/security-updates/images/Cc720542.note(WS.10).gif)Not          |
|-------------------------------------------------------------------------------|
...
The [Windows Server Update Services 3.0 Operations Guide](http://go.microsoft.com/fwlink/?linkid=81072) (http://go.microsoft.com/fwlink/?LinkId=81072) includes other types of migration documentation, such as migrating from Windows İç Veritabanı to Microsoft SQL Server.
