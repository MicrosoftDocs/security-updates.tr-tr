...
ms:contentKeyID: 21799210
ms:mtpsurl: 'https://technet.microsoft.com/tr-tr/library/Dd939818(v=WS.10)'
---
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;">Uninstalling Windows İç Veritabanı is not recommended, because it may affect other applications that may be using the same database instance (such as Windows SharePoint Services).
</td>
</tr>
</tbody>
</table>
