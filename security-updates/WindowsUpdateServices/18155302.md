...
ms:contentKeyID: 18155302
ms:mtpsurl: 'https://technet.microsoft.com/tr-tr/library/Cc708592(v=WS.10)'
---
...
| ![](/security-updates/images/Cc708592.note(WS.10).gif)Not                                                                                                                                                                                                                                                                                                                       |
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
If you are using Windows İç Veritabanı as the WSUS database, use the following string in place of *SqlServerName* in the above command:
