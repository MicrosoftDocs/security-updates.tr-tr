...
ms:contentKeyID: 18155358
ms:mtpsurl: 'https://technet.microsoft.com/tr-tr/library/Cc708578(v=WS.10)'
---
...
| ![](/security-updates/images/Cc708578.Important(WS.10).gif)Önemli                                                                                                                                                                                  |
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
