...
ms:contentKeyID: 21799168
ms:mtpsurl: 'https://technet.microsoft.com/tr-tr/library/Dd939833(v=WS.10)'
---

Issues with the Database
========================

If you have problems with the SQL Server database or Windows İç Veritabanı, make sure that the WSUS database in question is in the correct SQL instance before starting to troubleshoot SQL issues.
...
<thead>
<tr class="header">
<th style="border:1px solid black;" ><img src="/security-updates/images/Dd939833.note(WS.10).gif" />Not</th>
</tr>
</thead>
<tbody>
<tr class="odd">
...
2.  Type the following:
    ...
    If you are using Windows İç Veritabanı as the WSUS database, use the following string in place of *SqlServerName* in the command:
