...
ms:contentKeyID: 18155001
ms:mtpsurl: 'https://technet.microsoft.com/tr-tr/library/Cc720471(v=WS.10)'
---
...
| ![](/security-updates/images/Cc720471.Important(WS.10).gif)Önemli                                      |
|-------------------------------------------------------------------------------------------------------------------|
