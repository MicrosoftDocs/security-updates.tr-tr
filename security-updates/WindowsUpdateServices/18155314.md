...
ms:contentKeyID: 18155314
ms:mtpsurl: 'https://technet.microsoft.com/tr-tr/library/Cc708604(v=WS.10)'
---
...
| ![](/security-updates/images/Cc708604.note(WS.10).gif)Not                     |
|------------------------------------------------------------------------------------------|
...
| ![](/security-updates/images/Cc708604.Important(WS.10).gif)Önemli                                                                       |  
|----------------------------------------------------------------------------------------------------------------------------------------------------|  
